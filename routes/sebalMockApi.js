...
var response = {'status': undefined, 'code': undefined, 'data': undefined}
...
var startApi =
  ...
  var loadFileInfo =
      function(fileName, isJson, callbackFunction) {
  ...
  var api = {
    authenticate: function(userInfo, callbackFunction) {
      loadFileInfo(userFile, true, function(content) {
         ...
         * 404 - User not found
         */
        var userValidation = {valid: false, code: 404, msg: 'User not found.'};
