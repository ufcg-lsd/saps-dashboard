...
dashboardControllers.controller('ListSubmissionsController', function ($scope, $rootScope, $log, $timeout, $filter,
  ...
  $scope.tableCompleted = new NgTableParams({
    ...
    getData: function (params) {
      const paginationParams = {
        ...
        "sort": camelCaseToSnakeCase(JSON.stringify(params._params.sorting))
      }
