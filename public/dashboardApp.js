var app = angular.module('schedulerDashboard', [
  'dashboardControllers', 'dashboardServices', 'ngSanitize', 'ngRoute'
  //'ui.bootstrap'
]);
...
app.run(function($rootScope) {
  ...
  $rootScope.parseDate = function(date) {
    ...
    var d = parseInt(arrDate[0], 10), m = parseInt(arrDate[1], 10),
  ...
  $rootScope.parseDateUS = function(date) {
    ...
    var d = parseInt(arrDate[2], 10), m = parseInt(arrDate[1], 10),
  ...
  function loadDefaultLang() {
    ...
    if (lang !== undefined) {
      console.log(
          'Lang chosen ' +
          JSON.stringify($rootScope.languageOptions[langLoader.defaultIndex]))
      $rootScope.languageContent = lang.content;
      $rootScope.languageChosen =
          $rootScope.languageOptions[langLoader.defaultIndex];
    }
  }
  loadDefaultLang();
