...
!function(a, b) {
  ...
  function c(a, b, c, d) {
    ...
    return l[e] ||
               (m.insertRule(
                    '@' + i + 'keyframes ' + e + '{0%{opacity:' + g + '}' + f +
                        '%{opacity:' + a + '}' + (f + .01) + '%{opacity:1}' +
                        (f + b) % 100 + '%{opacity:' + a +
                        '}100%{opacity:' + g + '}}',
                    m.cssRules.length),
                l[e] = 1),
  ...
  function i() {
    ...
    m.addRule('.spin-vml', 'behavior:url(#default#VML)'),
        h.prototype.lines = function(a, d) {
          ...
          function h(a, h, i) {
            b(m,
              b(e(f(), {rotation: 360 / d.lines * a + 'deg', left: ~~h}),
          ...
          var i, j = d.length + d.width, k = 2 * j,
          ...
          e && b + d < e.childNodes.length &&
              (e = e.childNodes[b + d], e = e && e.firstChild,
               e = e && e.firstChild, e && (e.opacity = c))
        }
  }
  ...
  h.defaults = {}, f(h.prototype, {
    spin: function(b) {
      this.stop();
      {
        var c = this, d = c.opts,
            f = c.el =
                e(a(0, {className: d.className}),
                  {position: d.position, width: 0, zIndex: d.zIndex});
        d.radius + d.length + d.width
      }
      if (e(f, {left: d.left, top: d.top}),
          b && b.insertBefore(f, b.firstChild || null),
          f.setAttribute('role', 'progressbar'), c.lines(f, c.opts), !j) {
        var g, h = 0, i = (d.lines - 1) * (1 - d.direction) / 2, k = d.fps,
               l = k / d.speed, m = (1 - d.opacity) / (l * d.trail / 100),
               n = l / d.lines;
        !function o() {
          h++;
    ...
    lines: function(d, f) {
      function h(b, c) {
        return e(a(), {
          ...
          transform: 'rotate(' + ~~(360 / f.lines * k + f.rotate) +
              'deg) translate(' + f.radius + 'px,0)',
          borderRadius: (f.corners * f.width >> 1) + 'px'
        })
      }
      for (var i, k = 0, l = (f.lines - 1) * (1 - f.direction) / 2; k < f.lines;
           k++)
        i = e(a(), {
          position: 'absolute',
          top: 1 + ~(f.width / 2) + 'px',
