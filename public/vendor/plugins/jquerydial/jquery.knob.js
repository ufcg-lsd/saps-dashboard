...
k.o = function() {
  ...
  this.run = function() {
    ...
    if (this.$.is('fieldset')) {
      ...
      this.v = {};
      this.i = this.$.find('input') this.i.each(function(k) {
        var $this = $(this);
        s.i[k] = $this;
        s.v[k] = $this.val();
    ...
    this.scale = (window.devicePixelRatio || 1) /
        (this.c.webkitBackingStorePixelRatio ||
         ...
         this.c.oBackingStorePixelRatio || this.c.backingStorePixelRatio || 1);
...
k.Dial = function() {
  ...
  this.init = function() {
    ...
    this.o.angleOffset &&
        (this.o.angleOffset =
             isNaN(this.o.angleOffset) ? 0 : this.o.angleOffset);
    ...
    var s = max(String(Math.abs(this.o.max)).length,
                String(Math.abs(this.o.min)).length, 2) +
        2;
