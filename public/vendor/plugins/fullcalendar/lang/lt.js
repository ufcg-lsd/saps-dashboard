...
function s(e, t, n, s) {
  var o = e + ' ';
  return 1 === e ? o + r(e, t, n[0], s) :
                   t ? o + (i(e) ? a(n)[1] : a(n)[0]) :
                       s ? o + a(n)[1] : o + (i(e) ? a(n)[1] : a(n)[2])
}
function o(e, t) {
...
var l = {
  ...
  yy: 'metai_metų_metus'
    ...
    d = 'sekmadienis_pirmadienis_antradienis_trečiadienis_ketvirtadienis_penktadienis_šeštadienis'
            .split('_');
(t.defineLocale || t.lang).call(t, 'lt', {
  ...
  week: {dow: 1, doy: 4}
    ...
    e.fullCalendar.datepickerLang('lt', 'lt', {
      ...
      monthNamesShort: [
        'Sau', 'Vas', 'Kov', 'Bal', 'Geg', 'Bir', 'Lie', 'Rugp', 'Rugs', 'Spa',
        'Lap', 'Gru'
      ],
      dayNames: [
