...
function r(e, t, r, i) {
  ...
  switch (r) {
    ...
    case 'mm':
      return n(e) ? a + (t || i ? 'mínútur' : 'mínútum') :
                    t ? a + 'mínúta' : a + 'mínútu';
    case 'hh':
      return n(e) ? a + (t || i ? 'klukkustundir' : 'klukkustundum') :
                    a + 'klukkustund';
    case 'd':
      return t ? 'dagur' : i ? 'dag' : 'degi';
    case 'dd':
      return n(e) ? t ? a + 'dagar' : a + (i ? 'daga' : 'dögum') :
                    t ? a + 'dagur' : a + (i ? 'dag' : 'degi');
    case 'M':
      return t ? 'mánuður' : i ? 'mánuð' : 'mánuði';
    case 'MM':
      return n(e) ? t ? a + 'mánuðir' : a + (i ? 'mánuði' : 'mánuðum') :
                    t ? a + 'mánuður' : a + (i ? 'mánuð' : 'mánuði');
    case 'y':
      return t || i ? 'ár' : 'ári';
    case 'yy':
