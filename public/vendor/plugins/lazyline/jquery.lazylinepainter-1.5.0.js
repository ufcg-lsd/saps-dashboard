...
var methods = {
  ...
  init: function(_options) {
    return this.each(function() {
      ...
      if (!data) {
        ...
        // if overrideKey has been defined - use overrideKey as key within the
        // svgData object. else - use the elements id as key within the svgData
        // object.
        var target = options.overrideKey ? options.overrideKey :
  ...
  paint: function() {
    return this.each(function() {
      ...
      var init = function() {
        ...
        data.totalDuration =
            (data.drawSequential) ? data.playhead : data.longestDuration;
  ...
  */
  stamp: function() {
    return this.each(function() {
      var $this = $(this), d = $this.data(dataKey);
...
var draw =
  ...
  for (var i = 0; i < o.paths.length; i++) {
    ...
    if (path_elapsed_time < o.paths[i].duration && path_elapsed_time > 0) {
      var frame_length =
          path_elapsed_time / o.paths[i].duration * o.paths[i].length;
...
var applyStyles = function(data, value) {
  var styles = {
    ...
    'fill-opacity': 0,
    'stroke-dasharray': (!value.strokeDash) ? data.strokeDash :
                                              value.strokeDash,
    'stroke-opacity': (!value.strokeOpacity) ? data.strokeOpacity :
                                               value.strokeOpacity,
