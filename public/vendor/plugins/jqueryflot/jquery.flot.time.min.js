...
(function(e) {
  ...
  function r(e, t, n, r) {
    ...
    n == null &&
        ...
        r == null && (r = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']);
    var f;
  ...
  function i(e) {
    ...
    e.strftime != undefined && t(n, 'strftime', e, 'strftime'),
        t(n, 'getTime', e, 'getTime'), t(n, 'setTime', e, 'setTime');
    var r = [
            ...
            (t.tickGenerator =
                 function(e) {
                   ...
                   if (p == 'year') {
                     if (i.minTickSize != null && i.minTickSize[1] == 'year')
                       ...
                       var d = Math.pow(
                               10,
                               Math.floor(
                                   Math.log(e.delta / o.year) / Math.LN10)),
                           v = e.delta / o.year / d;
                       v < 1.5 ? h = 1 :
                                 v < 3 ? h = 2 : v < 7.5 ? h = 5 : h = 10,
                                 h *= d
                     }
                     h < 1 && (h = 1)
                   }
                   ...
                   p == 'second' ?
                       ...
                       p == 'year' && r.setFullYear(n(r.getFullYear(), m)),
                       r.setMilliseconds(0), g >= o.minute && r.setSeconds(0),
                       g >= o.hour && r.setMinutes(0),
                       g >= o.day && r.setHours(0),
                       g >= o.day * 4 && r.setDate(1),
                       g >= o.month * 2 && r.setMonth(n(r.getMonth(), 3)),
                       g >= o.quarter * 2 && r.setMonth(n(r.getMonth(), 6)),
                       g >= o.year && r.setMonth(0);
                     ...
                     if (p == 'month' || p == 'quarter')
                       if (m < 1) {
                         ...
                         r.setTime(b + y * o.hour + (S - E) * m),
                             y = r.getHours(), r.setHours(0)
                       } else
                         r.setMonth(
                             r.getMonth() + m * (p == 'quarter' ? 3 : 1));
                     else
                       p == 'year' ? r.setFullYear(r.getFullYear() + m) :
                                     r.setTime(b + g)
                   } while (b < e.max && b != w);
                   return t
                 },
             t.tickFormatter =
                 function(e, t) {
                   ...
                   var u = t.options.tickSize &&
                           t.options.tickSize[1] == 'quarter' ||
                       t.options.minTickSize &&
                           t.options.minTickSize[1] == 'quarter',
                       a = t.tickSize[0] * o[t.tickSize[1]], f = t.max - t.min,
                       l = i.twelveHourClock ? ' %p' : '',
                       c = i.twelveHourClock ? '%I' : '%H', h;
                   a < o.minute ?
                       h = c + ':%M:%S' + l :
                       a < o.day ?
                       f < 2 * o.day ? h = c + ':%M' + l :
                       ...
                       a < o.month ?
                       h = '%b %d' :
                       u&& a < o.quarter || !u&& a < o.year ?
                       f < o.year ? h = '%b' : h = '%b %Y' :
                       u&& a < o.year ? f < o.year ? h = 'Q%q' : h = 'Q%q %Y' :
                                        h = '%Y';
    ...
    xaxis: {
      ...
      u =
          [
            ...
            [30, 'second'], [1, 'minute'],  [2, 'minute'],  [5, 'minute'],
            [10, 'minute'], [30, 'minute'], [1, 'hour'],    [2, 'hour'],
            [4, 'hour'],    [8, 'hour'],    [12, 'hour'],   [1, 'day'],
            [2, 'day'],     [3, 'day'],     [.25, 'month'], [.5, 'month'],
            [1, 'month'],   [2, 'month']
          ],
