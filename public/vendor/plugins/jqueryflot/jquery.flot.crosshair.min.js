...
(function(e) {
  function n(e) {
    ...
    function r(n) {
      ...
      var r = e.offset();
      t.x = Math.max(0, Math.min(n.pageX - r.left, e.width())),
      t.y = Math.max(0, Math.min(n.pageY - r.top, e.height())),
    ...
    e.setCrosshair =
      ...
      if (!r)
        ...
        var i = e.p2c(r);
        t.x = Math.max(0, Math.min(i.left, e.width())),
        t.y = Math.max(0, Math.min(i.top, e.height()))
      }
      e.triggerRedrawOverlay()
    },
    ...
    e.hooks.drawOverlay.push(function(e, n) {
      ...
      if (t.x != -1) {
        ...
        n.strokeStyle = r.color, n.lineWidth = r.lineWidth,
        n.lineJoin = 'round', n.beginPath();
