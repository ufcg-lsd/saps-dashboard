...
(function(e) {
  e.color = {}, e.color.make = function(t, n, r, i) {
    var s = {};
    return s.r = t || 0, s.g = n || 0, s.b = r || 0, s.a = i != null ? i : 1,
           s.add = function(e, t) {
             ...
             return s.a >= 1 ? 'rgb(' + [s.r, s.g, s.b].join(',') + ')' :
             ...
             return s.r = e(0, parseInt(s.r), 255),
                    ...
                    s.b = e(0, parseInt(s.b), 255), s.a = e(0, s.a, 1), s
           }, s.clone = function() {
    ...
    if (r = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/
                .exec(n))
      return i(parseInt(r[1], 10), parseInt(r[2], 10), parseInt(r[3], 10));
    if (r = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]+(?:\.[0-9]+)?)\s*\)/
                .exec(n))
      return i(
          parseInt(r[1], 10), parseInt(r[2], 10), parseInt(r[3], 10),
          parseFloat(r[4]));
    if (r = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/
                .exec(n))
      return i(
          parseFloat(r[1]) * 2.55, parseFloat(r[2]) * 2.55,
          parseFloat(r[3]) * 2.55);
    if (r = /rgba\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\s*\)/
                .exec(n))
      return i(
          parseFloat(r[1]) * 2.55, parseFloat(r[2]) * 2.55,
          parseFloat(r[3]) * 2.55, parseFloat(r[4]));
    ...
    if (r = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(n))
      return i(
          parseInt(r[1] + r[1], 16), parseInt(r[2] + r[2], 16),
          parseInt(r[3] + r[3], 16));
    var s = e.trim(n).toLowerCase();
    return s == 'transparent' ? i(255, 255, 255, 0) :
  ...
  var t = {
    ...
    function(e) {
      function n(t, n) {
        ...
        if (r == null) {
          r = document.createElement('canvas'), r.className = t,
          e(r).css({direction: 'ltr', position: 'absolute', left: 0, top: 0})
              .appendTo(n);
          if (!r.getContext) {
        ...
        var i = this.context = r.getContext('2d'),
            ...
            o = i.webkitBackingStorePixelRatio || i.mozBackingStorePixelRatio ||
            i.msBackingStorePixelRatio || i.oBackingStorePixelRatio ||
            i.backingStorePixelRatio || 1;
        this.pixelRatio = s / o, this.resize(n.width(), n.height()),
      ...
      function r(t, r, s, o) {
        ...
        function x(n) {
          e.extend(!0, a, n), n && n.colors && (a.colors = n.colors),
              a.xaxis.color == null &&
              (a.xaxis.color =
                   e.color.parse(a.grid.color).scale('a', .22).toString()),
              a.yaxis.color == null &&
              (a.yaxis.color =
                   e.color.parse(a.grid.color).scale('a', .22).toString()),
          ...
          var r, i, s, o = {
            ...
            size:
                Math.round(.8 * (+t.css('font-size').replace('px', '') || 13)),
          ...
          for (r = 0; r < s; ++r)
            i = a.xaxes[r], i && !i.tickColor && (i.tickColor = i.color),
            i = e.extend(!0, {}, a.xaxis, i), a.xaxes[r] = i,
            i.font &&
                (i.font = e.extend({}, o, i.font),
                 i.font.color || (i.font.color = i.color));
          s = a.yaxes.length || 1;
          for (r = 0; r < s; ++r)
            i = a.yaxes[r], i && !i.tickColor && (i.tickColor = i.color),
            i = e.extend(!0, {}, a.yaxis, i), a.yaxes[r] = i,
            i.font &&
                (i.font = e.extend({}, o, i.font),
                 i.font.color || (i.font.color = i.color));
          a.xaxis.noTicks && a.xaxis.ticks == null &&
              (a.xaxis.ticks = a.xaxis.noTicks),
              a.yaxis.noTicks && a.yaxis.ticks == null &&
        ...
        function N(t) {
          ...
          for (var r = 0; r < t.length; ++r) {
            ...
            t[r].data != null ? (i.data = t[r].data, delete t[r].data,
                                 e.extend(!0, i, t[r]), t[r].data = i.data) :
                                i.data = t[r],
                                n.push(i)
          }
          return n
        ...
        function M() {
          ...
          for (r = 0; r < u.length; ++r) {
            ...
            p.lines.zero == null && (p.lines.zero = !!p.lines.fill),
                p.xaxis = O(d, C(p, 'x')), p.yaxis = O(v, C(p, 'y'))
          }
        }
        function _() {
          function x(e, t, n) {
            t<e.datamin && t != -r && (e.datamin = t), n>e.datamax && n != r &&
                (e.datamax = n)
          }
          var t = Number.POSITIVE_INFINITY, n = Number.NEGATIVE_INFINITY,
              r = Number.MAX_VALUE, i, s, o, a, f, l, c, h, p, d, v, m, g, y, w,
              S;
          e.each(k(), function(e, r) {
            r.datamin = t, r.datamax = n, r.used = !1
          });
          for (i = 0; i < u.length; ++i)
            l = u[i], l.datapoints = {points: []},
            E(b.processRawData, [l, l.data, l.datapoints]);
          for (i = 0; i < u.length; ++i) {
            l = u[i], w = l.data, S = l.datapoints.format;
            if (!S) {
              S = [], S.push({x: !0, number: !0, required: !0}),
              S.push({y: !0, number: !0, required: !0});
              if (l.bars.show || l.lines.show && l.lines.fill) {
                var T = !!(
                    l.bars.show && l.bars.zero || l.lines.show && l.lines.zero);
                S.push({
                  y: !0,
                  number: !0,
                  required: !1,
            ...
            l.datapoints.pointsize = S.length, h = l.datapoints.pointsize,
          ...
          for (i = 0; i < u.length; ++i) {
            l = u[i], c = l.datapoints.points, h = l.datapoints.pointsize,
            ...
            if (l.bars.show) {
              ...
              l.bars.horizontal ? (A += _, M += _ + l.bars.barWidth) :
        ...
        function D() {
          t.css('padding', 0)
              ...
              f = new n('flot-base', t), l = new n('flot-overlay', t),
              h = f.context, p = l.context, c = e(l.element).unbind();
          var r = t.data('plot');
          r && (r.shutdown(), l.clear()), t.data('plot', w)
        }
        function P() {
          a.grid.hoverable && (c.mousemove(at), c.bind('mouseleave', ft)),
              a.grid.clickable && c.click(lt), E(b.bindEvents, [c])
        }
        function H() {
          ot && clearTimeout(ot), c.unbind('mousemove', at),
              c.unbind('mouseleave', ft), c.unbind('click', lt),
              E(b.shutdown, [c])
        }
        function B(e) {
          function t(e) {
          ...
          e.direction == 'x' ? (n = e.scale = g / Math.abs(i(e.max) - i(e.min)),
                                r = Math.min(i(e.max), i(e.min))) :
                               (n = e.scale = y / Math.abs(i(e.max) - i(e.min)),
                                n = -n, r = Math.max(i(e.max), i(e.min))),
        ...
        function j(e) {
          var t = e.options, n = e.ticks || [], r = t.labelWidth || 0,
              i = t.labelHeight || 0,
              s = r || e.direction == 'x' ?
              Math.floor(f.width / (n.length || 1)) :
              null;
          legacyStyles = e.direction + 'Axis ' + e.direction + e.n + 'Axis',
          layer = 'flot-' + e.direction + '-axis flot-' + e.direction + e.n +
              '-axis ' + legacyStyles,
        ...
        function F(t) {
          var n = t.labelWidth, r = t.labelHeight, i = t.options.position,
              s = t.options.tickLength, o = a.grid.axisMargin,
              u = a.grid.labelMargin, l = t.direction == 'x' ? d : v, c, h,
          ...
          isNaN(+s) || (u += +s),
              ...
              t.position = i, t.tickLength = s, t.box.padding = u,
              t.innermost = h
        }
        function I(e) {
          e.direction == 'x' ?
        ...
        function q() {
          ...
          if (t == null) {
            ...
            for (r = 0; r < u.length; ++r)
              t = Math.max(
                  t, 2 * (u[r].points.radius + u[r].points.lineWidth / 2))
          }
          n.x = n.y = Math.ceil(t),
          e.each(
              k(),
              function(e, t) {
                var r = t.direction;
                t.reserveSpace &&
                    (n[r] = Math.ceil(Math.max(
                         n[r], (r == 'x' ? t.labelWidth : t.labelHeight) / 2)))
              }),
          m.left = Math.max(n.x, m.left), m.right = Math.max(n.x, m.right),
          m.top = Math.max(n.y, m.top), m.bottom = Math.max(n.y, m.bottom)
        }
        function R() {
          ...
          e.each(n, function(e, t) {
            t.show = t.options.show, t.show == null && (t.show = t.used),
            t.reserveSpace = t.show || t.options.reserveSpace, U(t)
          });
          if (r) {
          ...
          g = f.width - m.left - m.right, y = f.height - m.bottom - m.top,
          e.each(n, function(e, t) {
            B(t)
          }), r && G(), it()
        }
        function U(e) {
          var t = e.options, n = +(t.min != null ? t.min : e.datamin),
              r = +(t.max != null ? t.max : e.datamax), i = r - n;
          if (i == 0) {
            var s = r == 0 ? 1 : .01;
            t.min == null && (n -= s);
        ...
        function z(t) {
          ...
          typeof n.ticks == 'number' && n.ticks > 0 ?
              r = n.ticks :
              r = .3 * Math.sqrt(t.direction == 'x' ? f.width : f.height);
          var s = (t.max - t.min) / r, o = -Math.floor(Math.log(s) / Math.LN10),
              u = n.tickDecimals;
          u != null && o > u && (o = u);
          ...
          l < 1.5 ?
              ...
              t.delta = s, t.tickDecimals = Math.max(0, u != null ? u : o),
          ...
          t.tickGenerator ||
              (t.tickGenerator =
                   function(e) {
                     var t = [], n = i(e.min, e.tickSize), r = 0,
                         s = Number.NaN, o;
                     do
        ...
        function W(t) {
          ...
          for (i = 0; i < r.length; ++i) {
            var o = null, u = r[i];
            typeof u == 'object' ? (s = +u[0], u.length > 1 && (o = u[1])) :
                                   s = +u,
        ...
        function X(e, t) {
          e.options.autoscaleMargin && t.length > 0 &&
              (e.options.min == null && (e.min = Math.min(e.min, t[0].v)),
               e.options.max == null && t.length > 1 &&
        ...
        function K() {
          h.save(), h.translate(m.left, m.top),
              h.fillStyle =
                  bt(a.grid.backgroundColor, y, 0, 'rgba(255, 255, 255, 0)'),
              h.fillRect(0, 0, g, y), h.restore()
        }
        function Q() {
          var t, n, r, i;
          h.save(), h.translate(m.left, m.top);
          ...
          if (s) {
            e.isFunction(s) &&
                (n = w.getAxes(), n.xmin = n.xaxis.min, n.xmax = n.xaxis.max,
                 n.ymin = n.yaxis.min, n.ymax = n.yaxis.max, s = s(n));
            for (t = 0; t < s.length; ++t) {
              ...
              if (u.to < u.axis.min || u.from > u.axis.max ||
                  f.to < f.axis.min || f.from > f.axis.max)
                continue;
              ...
              u.from = u.axis.p2c(u.from), u.to = u.axis.p2c(u.to),
              f.from = f.axis.p2c(f.from), f.to = f.axis.p2c(f.to),
              u.from == u.to || f.from == f.to ?
                  (h.beginPath(),
                   h.strokeStyle = o.color || a.grid.markingsColor,
                   h.lineWidth = o.lineWidth || a.grid.markingsLineWidth,
                   h.moveTo(u.from, f.from), h.lineTo(u.to, f.to), h.stroke()) :
          ...
          for (var l = 0; l < n.length; ++l) {
            ...
            c.direction == 'x' ?
                ...
                (b = 0,
                 d == 'full' ? v = c.position == 'left' ? 0 : g :
                               v = p.left - m.left +
                         (c.position == 'left' ? p.width : 0)),
            c.innermost ||
                (h.strokeStyle = c.options.color, h.beginPath(), E = S = 0,
                 c.direction == 'x' ? E = g + 1 : S = y + 1,
                 h.lineWidth == 1 &&
                     (c.direction == 'x' ? b = Math.floor(b) + .5 :
                                           v = Math.floor(v) + .5),
                 h.moveTo(v, b), h.lineTo(v + E, b + S), h.stroke()),
            h.strokeStyle = c.options.tickColor, h.beginPath();
            for (t = 0; t < c.ticks.length; ++t) {
              var x = c.ticks[t].v;
              E = S = 0;
              if (isNaN(x) || x < c.min || x > c.max ||
                  d == 'full' &&
                      (typeof r == 'object' && r[c.position] > 0 || r > 0) &&
                      (x == c.min || x == c.max))
                continue;
              c.direction == 'x' ? (v = c.p2c(x), S = d == 'full' ? -y : d,
                                    c.position == 'top' && (S = -S)) :
                                   (b = c.p2c(x), E = d == 'full' ? -g : d,
                                    c.position == 'left' && (E = -E)),
                  h.lineWidth == 1 &&
                  (c.direction == 'x' ? v = Math.floor(v) + .5 :
                                        b = Math.floor(b) + .5),
                  h.moveTo(v, b), h.lineTo(v + E, b + S)
            }
            h.stroke()
          }
          r &&
              (i = a.grid.borderColor,
               typeof r == 'object' || typeof i == 'object' ?
                   (typeof r != 'object' &&
                    ...
                    r.top > 0 &&
                        (h.strokeStyle = i.top, h.lineWidth = r.top,
                         h.beginPath(), h.moveTo(0 - r.left, 0 - r.top / 2),
                         h.lineTo(g, 0 - r.top / 2), h.stroke()),
                    r.right > 0 &&
                        (h.strokeStyle = i.right, h.lineWidth = r.right,
                         h.beginPath(), h.moveTo(g + r.right / 2, 0 - r.top),
                         h.lineTo(g + r.right / 2, y), h.stroke()),
                    r.bottom > 0 &&
                        (h.strokeStyle = i.bottom, h.lineWidth = r.bottom,
                         h.beginPath(), h.moveTo(g + r.right, y + r.bottom / 2),
                         h.lineTo(0, y + r.bottom / 2), h.stroke()),
                    r.left > 0 &&
                        (h.strokeStyle = i.left, h.lineWidth = r.left,
                         h.beginPath(), h.moveTo(0 - r.left / 2, y + r.bottom),
                         h.lineTo(0 - r.left / 2, 0), h.stroke())) :
                   (h.lineWidth = r, h.strokeStyle = a.grid.borderColor,
        ...
        function G() {
          e.each(k(), function(e, t) {
            ...
            var n = t.box,
                ...
                i = 'flot-' + t.direction + '-axis flot-' + t.direction + t.n +
                '-axis ' + r,
                s = t.options.font || 'flot-tick-label tickLabel', o, u, a, l,
                c;
            f.removeText(i);
            for (var h = 0; h < t.ticks.length; ++h) {
              ...
              t.direction == 'x' ?
                  (l = 'center', u = m.left + t.p2c(o.v),
                   t.position == 'bottom' ?
                       a = n.top + n.padding :
                       (a = n.top + n.height - n.padding, c = 'bottom')) :
                  (c = 'middle', a = m.top + t.p2c(o.v),
                   t.position == 'left' ?
        ...
        function Z(e) {
          function t(e, t, n, r, i) {
            ...
            for (var f = o; f < s.length; f += o) {
              ...
              (l != u || c != a) && h.moveTo(r.p2c(l) + t, i.p2c(c) + n),
                  u = p, a = d, h.lineTo(r.p2c(p) + t, i.p2c(d) + n)
            }
            h.stroke()
          }
          function n(e, t, n) {
            var r = e.points, i = e.pointsize,
                s = Math.min(Math.max(0, n.min), n.max), o = 0, u, a = !1,
                f = 1, l = 0, c = 0;
            for (;;) {
              ...
              d <= m &&
                  ...
                  h.lineTo(t.p2c(p), n.p2c(d)), h.lineTo(t.p2c(v), n.p2c(m)),
                  v != y &&
          ...
          if (r > 0 && i > 0) {
            ...
            var s = Math.PI / 18;
            t(e.datapoints, Math.sin(s) * (r / 2 + i / 2),
              Math.cos(s) * (r / 2 + i / 2), e.xaxis, e.yaxis),
                h.lineWidth = i / 2,
                t(e.datapoints, Math.sin(s) * (r / 2 + i / 4),
                  Math.cos(s) * (r / 2 + i / 4), e.xaxis, e.yaxis)
          }
          h.lineWidth = r, h.strokeStyle = e.color;
          var o = rt(e.lines, e.color, 0, y);
          o && (h.fillStyle = o, n(e.datapoints, e.xaxis, e.yaxis)),
              r > 0 && t(e.datapoints, 0, 0, e.xaxis, e.yaxis), h.restore()
        }
        function et(e) {
          function t(e, t, n, r, i, s, o, u) {
            ...
            for (var l = 0; l < a.length; l += f) {
              ...
              if (c == null || c < s.min || c > s.max || p < o.min || p > o.max)
                continue;
              h.beginPath(), c = s.p2c(c), p = o.p2c(p) + r,
                             u == 'circle' ?
                  h.arc(c, p, t, 0, i ? Math.PI : Math.PI * 2, !1) :
                  u(h, c, p, t, i),
                             h.closePath(), n && (h.fillStyle = n, h.fill()),
                             h.stroke()
            }
          }
          h.save(), h.translate(m.left, m.top);
          var n = e.points.lineWidth, r = e.shadowSize, i = e.points.radius,
              s = e.points.symbol;
          n == 0 && (n = 1e-4);
          if (n > 0 && r > 0) {
            var o = r / 2;
          ...
          h.lineWidth = n, h.strokeStyle = e.color,
          t(e.datapoints, i, rt(e.points, e.color), 0, !1, e.xaxis, e.yaxis, s),
          h.restore()
        }
        function tt(e, t, n, r, i, s, o, u, a, f, l, c) {
          var h, p, d, v, m, g, y, b, w;
          l ? (b = g = y = !0, m = !1, h = n, p = e, v = t + r, d = t + i,
               p < h && (w = p, p = h, h = w, m = !0, g = !1)) :
              (m = g = y = !0, b = !1, h = e + r, p = e + i, d = n, v = t,
               v < d && (w = v, v = d, d = w, b = !0, y = !1));
          if (p < u.min || h > u.max || v < a.min || d > a.max) return;
          h<u.min && (h = u.min, m = !1), p>u.max && (p = u.max, g = !1),
              d<a.min && (d = a.min, b = !1), v>a.max && (v = a.max, y = !1),
              h = u.p2c(h), d = a.p2c(d), p = u.p2c(p), v = a.p2c(v),
              o &&
              (f.beginPath(), f.moveTo(h, d), f.lineTo(h, v), f.lineTo(p, v),
               f.lineTo(p, d), f.fillStyle = o(d, v), f.fill()),
              c > 0 && (m || g || y || b) &&
              (f.beginPath(), f.moveTo(h, d + s),
               m ? f.lineTo(h, v + s) : f.moveTo(h, v + s),
               y ? f.lineTo(p, v + s) : f.moveTo(p, v + s),
               g ? f.lineTo(p, d + s) : f.moveTo(p, d + s),
               b ? f.lineTo(h, d + s) : f.moveTo(h, d + s), f.stroke())
        }
        function nt(e) {
          function t(t, n, r, i, s, o, u) {
            ...
            for (var l = 0; l < a.length; l += f) {
              ...
              tt(a[l], a[l + 1], a[l + 2], n, r, i, s, o, u, h,
                 e.bars.horizontal, e.bars.lineWidth)
            }
          }
          h.save(), h.translate(m.left, m.top), h.lineWidth = e.bars.lineWidth,
        ...
        function rt(t, n, r, i) {
          ...
          return o.a = typeof s == 'number' ? s : .4, o.normalize(),
                 o.toString()
        }
        function it() {
          ...
          for (var l = 0; l < r.length; ++l) {
            ...
            l % a.legend.noColumns == 0 &&
                ...
                n.push(
                    ...
                    h.color + ';overflow:hidden"></div></div></td>' +
                    '<td class="legendLabel">' + h.label + '</td>')
          }
          i && n.push('</tr>');
          if (n.length == 0) return;
          var p = '<table style="font-size:smaller;color:' + a.grid.color +
              '">' + n.join('') + '</table>';
          if (a.legend.container != null)
            ...
            g[0] == null && (g = [g, g]),
                v.charAt(0) == 'n' ? d += 'top:' + (g[1] + m.top) + 'px;' :
                                     v.charAt(0) == 's' &&
            ...
            if (a.legend.backgroundOpacity != 0) {
              ...
              b == null &&
                  (b = a.grid.backgroundColor,
                   ...
                   b.a = 1, b = b.toString());
              var w = y.children();
              e('<div style="position:absolute;width:' + w.width() +
                'px;height:' + w.height() + 'px;' + d +
                'background-color:' + b + ';"> </div>')
                  .prependTo(y)
        ...
        function ut(e, t, n) {
          var r = a.grid.mouseActiveRadius, i = r * r + 1, s = null, o = !1, f,
              l, c;
          for (f = u.length - 1; f >= 0; --f) {
            if (!n(u[f])) continue;
            var h = u[f], p = h.xaxis, d = h.yaxis, v = h.datapoints.points,
                m = p.c2p(e), g = d.c2p(t), y = r / p.scale, b = r / d.scale;
            ...
            if (h.lines.show || h.points.show)
              for (l = 0; l < v.length; l += c) {
                ...
                if (w - m > y || w - m < -y || E - g > b || E - g < -b)
                  continue;
                var S = Math.abs(p.p2c(w) - e), x = Math.abs(d.p2c(E) - t),
                    T = S * S + x * x;
                T < i && (i = T, s = [f, l / c])
              }
            if (h.bars.show && !s) {
              ...
              for (l = 0; l < v.length; l += c) {
                ...
                if (w == null) continue;
                if (u[f].bars.horizontal ? m <= Math.max(k, w) &&
                            m >= Math.min(k, w) && g >= E + N && g <= E + C :
                                           m >= w + N && m <= w + C &&
                            g >= Math.min(k, E) && g <= Math.max(k, E))
                  s = [f, l / c]
              }
            }
          }
        ...
        function ct(e, n, r) {
          var i = c.offset(), s = n.pageX - i.left - m.left,
              o = n.pageY - i.top - m.top, u = L({left: s, top: o});
          u.pageX = n.pageX, u.pageY = n.pageY;
          var f = ut(s, o, r);
          f &&
              (f.pageX = parseInt(
                   f.series.xaxis.p2c(f.datapoint[0]) + i.left + m.left, 10),
               f.pageY = parseInt(
                   f.series.yaxis.p2c(f.datapoint[1]) + i.top + m.top, 10));
          if (a.grid.autoHighlight) {
            for (var l = 0; l < st.length; ++l) {
              var h = st[l];
              h.auto == e &&
                  (!f || h.series != f.series || h.point[0] != f.datapoint[0] ||
        ...
        function dt(e, t, n) {
          ...
          var i = mt(e, t);
          i == -1 ? (st.push({series: e, point: t, auto: n}), ht()) :
                    n || (st[i].auto = !1)
        }
        function vt(e, t) {
          if (e == null && t == null) {
        ...
        function gt(t, n) {
          var r = n[0], i = n[1], s = t.xaxis, o = t.yaxis,
              u = typeof t.highlightColor == 'string' ?
              t.highlightColor :
              e.color.parse(t.color).scale('a', .5).toString();
          if (r < s.min || r > s.max || i < o.min || i > o.max) return;
          var a = t.points.radius + t.points.lineWidth / 2;
          p.lineWidth = a, p.strokeStyle = u;
          var f = 1.5 * a;
          r = s.p2c(r), i = o.p2c(i), p.beginPath(),
          t.points.symbol == 'circle' ? p.arc(r, i, f, 0, 2 * Math.PI, !1) :
                                        t.points.symbol(p, r, i, f, !1),
          p.closePath(), p.stroke()
        }
        function yt(t, n) {
          var r = typeof t.highlightColor == 'string' ?
              t.highlightColor :
              e.color.parse(t.color).scale('a', .5).toString(),
              i = r, s = t.bars.align == 'left' ? 0 : -t.bars.barWidth / 2;
          p.lineWidth = t.bars.lineWidth, p.strokeStyle = r,
          ...
          for (var o = 0, u = t.colors.length; o < u; ++o) {
            ...
            if (typeof a != 'string') {
              ...
              a.brightness != null && (f = f.scale('rgb', a.brightness)),
                  a.opacity != null && (f.a *= a.opacity), a = f.toString()
            }
        ...
        var u = [], a = {
          ...
          hooks: {}
            ...
            f = null, l = null, c = null, h = null, p = null, d = [], v = [],
            m = {left: 0, right: 0, top: 0, bottom: 0}, g = 0, y = 0, b = {
              processOptions: [],
              processRawData: [],
              processDatapoints: [],
              processOffset: [],
            ...
            w = this;
        w.setData = T, w.setupGrid = R, w.draw = V,
        w.getPlaceholder =
            function() {
          return t
        },
        ...
        w.highlight = dt, w.unhighlight = vt, w.triggerRedrawOverlay = ht,
      ...
      n.prototype.getTextInfo =
          function(t, n, r, i, s) {
        var o, u, a, f;
        n = '' + n,
        typeof r == 'object' ? o = r.style + ' ' + r.variant + ' ' + r.weight +
                ' ' + r.size + 'px/' + r.lineHeight + 'px ' + r.family :
                               o = r,
        u = this._textCache[t], u == null && (u = this._textCache[t] = {}),
        a = u[o], a == null && (a = u[o] = {}), f = a[n];
        if (f == null) {
          var l = e('<div></div>')
                      .html(n)
                      .css({position: 'absolute', 'max-width': s, top: -9999})
                      .appendTo(this.getTextLayer(t));
          typeof r == 'object' ? l.css({font: o, color: r.color}) :
      ...
      n.prototype.addText =
        ...
        l.push(h),
        h.element.css(
            {top: Math.round(n), left: Math.round(t), 'text-align': u})
      },
      n.prototype.removeText =
      ...
      e.plot.version = '0.8.1', e.plot.plugins = [],
