...
(function(e, t, n) {
  ...
  var r = e([]), i = e.resize = e.extend(e.resize, {}), s, o = 'setTimeout',
      u = 'resize', a = u + '-special-event', f = 'delay', l = 'throttleWindow';
  i[f] = 250, i[l] = !0, e.event.special[u] = {
    setup: function() {
      if (!i[l] && this[o]) return !1;
      var t = e(this);
      r = r.add(t), e.data(this, a, {w: t.width(), h: t.height()}),
      r.length === 1 && c()
    },
    teardown: function() {
      if (!i[l] && this[o]) return !1;
    ...
    add: function(t) {
      function s(t, i, s) {
        ...
        u.w = i !== n ? i : o.width(), u.h = s !== n ? s : o.height(),
