...
!function(a, b) {
  ...
  a.MixItUp.prototype = {
    ...
    _addHook: function(b, c, d, e, f) {
      ...
      f = 1 === f || 'post' === f ? 'post' : 'pre', h[c] = {}, h[c][f] = {},
      h[c][f][d] = e, a.extend(!0, g, h)
    },
    _init: function(b, c) {
      var d = this;
      if (d._execAction('_init', 0, arguments), c && a.extend(!0, d, c),
          d._$body = a('body'), d._domNode = b, d._$container = a(b),
          d._$container.addClass(d.layout.containerClass), d._id = b.id,
          d._platformDetect(),
          d._brake = d._getPrefixedCSS('transition', 'none'), d._refresh(!0),
          d._$parent = d._$targets.parent().length ? d._$targets.parent() :
                                                     d._$container,
          d.load.sort &&
              (d._newSort = d._parseSort(d.load.sort),
               d._newSortString = d.load.sort, d._activeSort = d.load.sort,
               d._sort(), d._printSort()),
          d._activeFilter = 'all' === d.load.filter ?
              d.selectors.target :
              'none' === d.load.filter ? '' : d.load.filter,
          d.controls.enable && d._bindHandlers(),
          d.controls.toggleFilterButtons) {
        d._buildToggleArray();
        for (var e = 0; e < d._toggleArray.length; e++)
          d._updateControls(
              {filter: d._toggleArray[e], sort: d._activeSort}, !0)
      } else
        d.controls.enable &&
            d._updateControls({filter: d._activeFilter, sort: d._activeSort});
      d._filter(), d._init = !0, d._$container.data('mixItUp', d),
                   d._execAction('_init', 1, arguments), d._buildState(),
                   d._$targets.css(d._brake), d._goMix(d.animation.enable)
    },
    _platformDetect: function() {
      ...
      a._execAction('_platformDetect', 0),
          ...
          !1,
          a._prefix = h.prefix, a._vendor = h.vendor,
    ...
    _bindHandlers: function() {
      var c = this, d = a.MixItUp.prototype._bound._filter,
          e = a.MixItUp.prototype._bound._sort;
      c._execAction('_bindHandlers', 0),
          c.controls.live ?
          c._$body
              .on('click.mixItUp.' + c._id, c.selectors.sort,
                  function() {
      ...
      if (e._execAction('_processClick', 0, arguments),
        ...
        if (e._clicking = !0, 'sort' === d) {
          ...
          (!c.hasClass(e.controls.activeClass) || g.indexOf('random') > -1) &&
              (a(e.selectors.sort).removeClass(e.controls.activeClass), f(c, d),
               e.sort(g))
        }
        if ('filter' === d) {
          ...
          e.controls.toggleFilterButtons ?
              (e._buildToggleArray(),
               c.hasClass(e.controls.activeClass) ?
                   (f(c, d, !0), h = e._toggleArray.indexOf(i),
    ...
    _filter: function() {
      ...
      for (var c = 0; c < b._$targets.length; c++) {
        ...
        d.is(b._activeFilter) ? b._$show = b._$show.add(d) :
    ...
    _compare: function(a, b, c) {
      c = c ? c : 0;
      var d = this, e = d._newSort[c].order,
          f =
              function(a) {
      ...
      return h > g ?
          ...
          g > h ?
          'asc' === e ? 1 : -1 :
          g === h && d._newSort.length > c + 1 ? d._compare(a, b, c + 1) : 0
    },
    _printSort: function(a) {
      var b = this, c = a ? b._startOrder : b._newOrder,
      ...
      for (var g = 0; g < c.length; g++) {
        var j = c[g];
        if ('default' !== b._newSort[0].sortBy ||
            'desc' !== b._newSort[0].order || a)
    ...
    _parseEffects: function() {
      ...
      return b.opacity = c('fade') ? c('fade', !0).val || '0' : '1',
             e('transformIn'),
             a.animation.reverseOut ? e('transformOut', !0) :
                                      b.transformOut = b.transformIn,
             b.transition = {},
             b.transition = a._getPrefixedCSS(
                 'transition',
                 'all ' + a.animation.duration + 'ms ' + a.animation.easing +
                     ', opacity ' + a.animation.duration + 'ms linear'),
    ...
    _goMix: function(a) {
      var b = this, c = function() {
        ...
        document.documentElement.scrollHeight, b._getInterMixData(),
            b._setFinal(), b._getFinalMixData(),
            window.pageYOffset !== a && window.scrollTo(c, a), b._prepTargets(),
        ...
        var b = a.parentElement, c = document.createElement('div'),
    ...
    _getOrigMixData: function() {
      ...
      a._startHeight =
          a._incPadding ? a._$parent.outerHeight() : a._$parent.height();
    ...
    _setInter: function() {
      ...
      a._execAction('_setInter', 0),
          ...
          (a._$toShow.css('display', a._newDisplay),
           a._changingClass &&
               a._$container.removeClass(a.layout.containerClass)
    ...
    _setFinal: function() {
      var a = this;
      a._execAction('_setFinal', 0), a._sorting && a._printSort(),
    ...
    _getFinalMixData: function() {
      ...
      a._newHeight =
          a._incPadding ? a._$parent.outerHeight() : a._$parent.height(),
      a._sorting && a._printSort(!0), a._$toShow.removeStyle('display'),
      a._$pre.css('display', a.layout.display),
      a._changingClass && a.animation.animateChangeLayout &&
          a._$container.removeClass(a._newClass)
        ...
        b.animation.animateResizeTargets &&
            (e.style.width = e.dataset.finalWidth + 'px',
             ...
             e.style.marginRight =
                 ...
                 1 * e.dataset.finalMarginRight + 'px',
            ...
            (e.style.width = e.dataset.origWidth + 'px',
             ...
             e.dataset.origHeight - e.dataset.finalHeight &&
                 (e.style.marginBottom =
                      ...
                      1 * e.dataset.origMarginBottom + 'px'))
      }
    ...
    _animateTargets: function() {
      ...
      b._execAction('_animateTargets', 0),
          b._targetsDone = 0, b._targetsBound = 0,
          b._$parent
              .css(b._getPrefixedCSS(
                  'perspective', b.animation.perspectiveDistance + 'px'))
              .css(b._getPrefixedCSS(
                  'perspective-origin', b.animation.perspectiveOrigin)),
          b.animation.animateResizeContainer &&
          b._$parent
              .css(b._getPrefixedCSS(
                  'transition', 'height ' + b.animation.duration + 'ms ease'))
      ...
      for (var c = 0; c < b._$pre.length; c++) {
        ...
        (d.dataset.finalPosX !== d.dataset.origPosX ||
         d.dataset.finalPosY !== d.dataset.origPosY) &&
            b._bindTargetDone(e),
            e.css(b._getPrefixedCSS(
                'transition',
                'all ' + b.animation.duration + 'ms ' + b.animation.easing +
                    ' ' + g + 'ms')),
            e.css(b._getPrefixedCSS(
            ...
            (d.dataset.origWidth - d.dataset.finalWidth &&
                 ...
                 (d.style.width = d.dataset.finalWidth + 'px',
                  d.style.marginRight =
                      ...
                      1 * d.dataset.finalMarginRight + 'px'),
             d.dataset.origHeight - d.dataset.finalHeight &&
                 ...
                 (d.style.height = d.dataset.finalHeight + 'px',
                  d.style.marginBottom =
                      ...
                      1 * d.dataset.finalMarginBottom + 'px'))
      }
      b._changingClass &&
          b._$container.removeClass(b.layout.containerClass)
              .addClass(b._newClass);
      for (var c = 0; c < b._$toHide.length; c++) {
        for (var d = b._$toHide[c], e = a(d), g = b._getDelay(c), k = {}, i = 0;
             2 > i; i++) {
          var j = 0 === i ? j = b._prefix : '';
    ...
    _bindTargetDone: function(b) {
      ...
      c._execAction('_bindTargetDone', 0, arguments),
          d.dataset.bound ||
          (d.dataset.bound = !0, c._targetsBound++,
           b.on(
               ...
               function(e) {
                 (e.originalEvent.propertyName.indexOf('transform') > -1 ||
                  e.originalEvent.propertyName.indexOf('opacity') > -1) &&
                     ...
                     (b.off('.mixItUp'), delete d.dataset.bound,
                      c._targetDone())
               })),
    ...
    _targetDone: function() {
      var a = this;
      a._execAction('_targetDone', 0), a._targetsDone++,
    ...
    _cleanUp: function() {
      ...
      b._changingLayout ? b._$show.css('display', b._newDisplay) :
                          b._$show.css('display', b.layout.display),
      b._$targets.css(b._brake),
      b._$targets.removeStyle(c, b._prefix)
          .removeAttr(
      ...
      b._changingLayout &&
          (b._changingDisplay &&
           ...
           b._changingClass &&
               (b._$parent.removeClass(b.layout.containerClass)
                    .addClass(b._newClass),
                b.layout.containerClass = b._newClass, b._changingClass = !1),
           b._changingLayout = !1),
      b._refresh(), b._buildState(),
      b._state.fail && b._$container.addClass(b.layout.containerClassFail),
      b._$show = a(), b._$hide = a(),
    ...
    multiMix: function() {
      ...
      if (a._execAction('multiMix', 0, arguments), a._mixing)
        ...
        var d = c.command.sort, e = c.command.filter,
            f = c.command.changeLayout;
        a._refresh(),
            d &&
            (a._newSort = a._parseSort(d), a._newSortString = d,
             a._sorting = !0, a._sort()),
            e !== b &&
            (e = 'all' === e ? a.selectors.target : e, a._activeFilter = e),
            a._filter(),
            f &&
            (a._newDisplay =
            ...
            a._goMix(
                c.animate ^ a.animation.enable ? c.animate :
                                                 a.animation.enable),
    ...
    getOption: function(a) {
      var c = this, d = function(a, c) {
        for (var d = c.split('.'), e = d.pop(), f = d.length, g = 1,
                 h = d[0] || c;
             (a = a[h]) && f > g;)
          h = d[g], g++;
    ...
    destroy: function(b) {
      ...
      c._execAction('destroy', 0, arguments),
          c._$body.add(a(c.selectors.sort))
    ...
    return d = d ? d : '', this.each(function() {
      for (var e = this, f = c.split(' '), g = 0; g < f.length; g++)
        for (var h = 0; 4 > h; h++) {
          ...
          if (e.style[i] !== b && 'unknown' != typeof e.style[i] &&
                  e.style[i].length > 0 && (e.style[i] = ''),
              !d && 1 === h)
            break
        }
