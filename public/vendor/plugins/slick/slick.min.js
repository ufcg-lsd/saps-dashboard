  ...
  b = function() {
    function c(c, d) {
      ...
      if (e.defaults = {
          ...
          e.cssTransitions = !1, e.paused = !1, e.positionProp = null,
          e.respondTo = null, e.shouldClick = !0, e.$slider = a(c),
          e.$slidesCache = null, e.transformType = null,
          e.transitionType = null, e.windowWidth = 0, e.windowTimer = null,
          e.options = a.extend({}, e.defaults, d),
          e.currentSlide = e.options.initialSlide,
          e.originalSettings = e.options, f = e.options.responsive || null,
          f && f.length > -1) {
      ...
      e.htmlExpr = /^(?:\s*(<[\w\W]+>)[^>]*)$/, e.init(), e.checkResponsive()
    }
    var b = 0;
    return c
    ...
    var c = this,
        d = null != c.options.asNavFor ? a(c.options.asNavFor).getSlick() :
                                         null;
    ...
    var c, d, e, b = this, f = b.$slider.width(),
                 g = window.innerWidth || a(window).width();
    if ('window' === b.respondTo ?
            e = g :
            'slider' === b.respondTo ?
            e = f :
      ...
      for (c in b.breakpoints)
        b.breakpoints.hasOwnProperty(c) && e < b.breakpoints[c] &&
            (d = b.breakpoints[c]);
      null !== d ? null !== b.activeBreakpoint ?
                   d !== b.activeBreakpoint &&
                  (b.activeBreakpoint = d,
                   b.options = a.extend(
                       {}, b.originalSettings, b.breakpointSettings[d]),
                   b.refresh()) :
                   (b.activeBreakpoint = d,
                    b.options = a.extend(
                        {}, b.originalSettings, b.breakpointSettings[d]),
              ...
              (b.activeBreakpoint = null, b.options = b.originalSettings,
               b.refresh())
    }
    ...
    d.cssTransitions === !1 ?
        (d.$slides.eq(b).css({zIndex: 1e3}),
         d.$slides.eq(b).animate(
             {opacity: 1}, d.options.speed, d.options.easing, c),
         d.$slides.eq(a).animate(
             {opacity: 0}, d.options.speed, d.options.easing)) :
        (d.applyTransition(b), d.applyTransition(a),
    ...
    return b.slideOffset = 0, d = b.$slides.first().outerHeight(),
                ...
                0 !== b.slideCount % b.options.slidesToScroll &&
                    ...
                    (a > b.slideCount ?
                         ...
                         (b.slideOffset = -1 * b.slideCount %
                              b.options.slidesToScroll * b.slideWidth,
           ...
           b.options.variableWidth === !0 &&
               (g = b.slideCount <= b.options.slidesToShow ||
    ...
    b.initArrowEvents(), b.initDotEvents(),
        ...
        b.$list.on(
            ...
            b.swipeHandler),
        b.$list.on(
            'touchend.slick mouseup.slick', {action: 'end'}, b.swipeHandler),
        b.$list.on(
            'touchcancel.slick mouseleave.slick', {action: 'end'},
            b.swipeHandler),
        b.$list.on('click.slick', b.clickHandler),
        b.options.pauseOnHover === !0 && b.options.autoplay === !0 &&
        (b.$list.on(
             'mouseenter.slick',
             function() {
               b.paused = !0, b.autoPlayClear()
              ...
              a(window).width() !== b.windowWidth &&
                  (clearTimeout(b.windowDelay),
                   b.windowDelay = window.setTimeout(function() {
                     b.windowWidth = a(window).width(), b.checkResponsive(),
                     b.setPosition()
                   }, 50))
            }),
    ...
    return 'boolean' == typeof a ?
               ...
               (d.unload(),
                ...
                d.$slideTrack.append(d.$slides), d.$slidesCache = d.$slides,
                d.reinit(), void 0)
  }, b.prototype.setCSS = function(a) {
    var d, e, b = this, c = {};
    b.options.rtl === !0 && (a = -a),
        d = 'left' == b.positionProp ? a + 'px' : '0px',
        e = 'top' == b.positionProp ? a + 'px' : '0px', c[b.positionProp] = a,
    ...
    b.$slides.each(function(d, e) {
      ...
      b.options.rtl === !0 ?
          ...
          a(e).css(
              {position: 'relative', left: c, top: 0, zIndex: 800, opacity: 0})
    }),
    ...
    b.$slider.find('.slick-slide')
        ...
        (f = b.slideCount % b.options.slidesToShow,
         ...
         b.options.slidesToShow == b.options.slidesToScroll &&
             ...
             d.slice(e - (b.options.slidesToShow - f), e + f)
                 .addClass('slick-active') :
    ...
    return b = b || !1,
           j.animating === !0 && j.options.waitForAnimate === !0 ||
               ...
               void 0 :
               (b === !1 && j.asNavFor(a), d = a, i = j.getLeft(d),
                g = j.getLeft(j.currentSlide),
                j.currentLeft = null === j.swipeLeft ? g : j.swipeLeft,
                j.options.infinite === !1 && j.options.centerMode === !1 &&
                        (0 > a ||
                    ...
                    (j.options.fade === !1 &&
                         (d = j.currentSlide,
                          c !== !0 ? j.animateSlide(
                                     ...
                                     j.postSlide(d)),
                     void 0) :
                    j.options.infinite === !1 && j.options.centerMode === !0 &&
                            (0 > a ||
                    ...
                    (j.options.autoplay === !0 &&
                     ...
                     e = 0 > d ? 0 !== j.slideCount % j.options.slidesToScroll ?
                                 j.slideCount -
                     ...
                     null !== j.options.onBeforeChange &&
                         ...
                         j.options.onBeforeChange.call(
                             this, j, j.currentSlide, e),
                     f = j.currentSlide, j.currentSlide = e,
                     j.setSlideClasses(j.currentSlide), j.updateDots(),
                     j.updateArrows(),
                     j.options.fade === !0 ?
                         (c !== !0 ? j.fadeSlide(
                                         f, e,
    ...
    return a = e.touchObject.startX - e.touchObject.curX,
           ...
           45 >= d && d >= 0 ?
               ...
               360 >= d && d >= 315 ?
               e.options.rtl === !1 ? 'left' : 'right' :
               d >= 135 && 225 >= d ? e.options.rtl === !1 ? 'right' : 'left' :
                                      'vertical'
