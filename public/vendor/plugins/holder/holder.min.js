...
!function(a, b, c) {
  ...
  function(a) {
    ...
    var g = a.document, h = g.documentElement, i = 'load', j = !1, k = 'on' + i,
        l = 'complete', m = 'readyState', n = 'attachEvent', o = 'detachEvent',
        p = 'addEventListener', q = 'DOMContentLoaded',
        r = 'onreadystatechange', s = 'removeEventListener', t = p in g, u = j,
        v = j, w = [];
    if (g[m] === l)
      e(b);
    else if (t)
    ...
    (document.querySelectorAll =
         function(a) {
           ...
           for (
               ...
               window.scrollBy(0, 0), c.parentNode.removeChild(c);
               document._qsa.length;)
             b = document._qsa.shift(), b.style.removeAttribute('x-qsa'),
             d.push(b);
    ...
    function(a) {
      ...
      a.atob = a.atob || function(a) {
        ...
        for (; d < a.length;)
          c = b.indexOf(a.charAt(d)), f = f << 6 | c, g += 6,
          24 === g &&
              (e.push(String.fromCharCode(f >> 16 & 255)),
               e.push(String.fromCharCode(f >> 8 & 255)),
               e.push(String.fromCharCode(255 & f)), g = 0, f = 0),
          d += 1;
        return 12 === g ? (f >>= 4, e.push(String.fromCharCode(255 & f))) :
                          18 === g &&
                       (f >>= 2, e.push(String.fromCharCode(f >> 8 & 255)),
        ...
        for (; j < a.length;)
          c = a.charCodeAt(j++), d = a.charCodeAt(j++), e = a.charCodeAt(j++),
          f = c >> 2, g = (3 & c) << 4 | d >> 4, h = (15 & d) << 2 | e >> 6,
          i = 63 & e,
          j === a.length + 2 ? (h = 64, i = 64) :
                               j === a.length + 1 && (i = 64),
    ...
    function() {
      function a(b, c, d) {
        ...
        var e,
            ...
            [0, 0, ''],
            g = f[1], h = f[2];
        return d = d ? /%|em/.test(h) && b.parentElement ?
      ...
      function b(a, b) {
        var c = 'border' == b ? 'Width' : '', d = b + 'Top' + c,
            e = b + 'Right' + c, f = b + 'Bottom' + c, g = b + 'Left' + c;
        a[b] =
            (a[d] == a[e] && a[d] == a[f] && a[d] == a[g] ?
                 [a[d]] :
                 a[d] == a[f] && a[g] == a[e] ?
                 [a[d], a[e]] :
                 a[g] == a[e] ? [a[d], a[e], a[f]] : [a[d], a[e], a[f], a[g]])
                .join(' ')
      }
      function c(c) {
        var d, e = this, f = c.currentStyle, g = a(c, 'fontSize'),
               h = function(a) {
                 return '-' + a.toLowerCase()
               };
        for (d in f)
          if (Array.prototype.push.call(
                  e, 'styleFloat' == d ? 'float' : d.replace(/[A-Z]/, h)),
              'width' == d)
            ...
            try {
              ...
              e.outline =
                  [e.outlineColor, e.outlineWidth, e.outlineStyle].join(' ')
            }
          else
            e[d] = f[d];
        b(e, 'margin'), b(e, 'padding'), b(e, 'border'),
      ...
      function() {
        ...
        var a = function() {}, b = Array.prototype.slice, c = function(c, d) {
          var e = a.prototype = 'function' == typeof c ? c.prototype : c,
              f = new a, g = d.apply(f, b.call(arguments, 2).concat(e));
          if ('object' == typeof g)
    ...
    function(a, b) {
      ...
      function d(a, b) {
        for (var c = {
          ...
          if (A.flags.dimensions.match(j))
            ...
            d = !0, c.dimensions = A.flags.fluid.output(j), c.fluid = !0,
            l = !0;
        ...
        return c.holderURL.unshift(b.domain),
               c.holderURL = c.holderURL.join('/'), d ? c : !1
      }
      function e(a, b, c, d) {
        ...
        c.font &&
            (g.font = c.font,
             !o.noFontFallback && 'img' === b.nodeName.toLowerCase() &&
                 A.setup.supportsCanvas && 'svg' === o.renderer &&
                 (o = p(o, {renderer: 'canvas'}))),
            c.font && 'canvas' == o.renderer && (o.reRender = !0),
            'background' == a ? null == b.getAttribute('data-background-src') &&
                m(b, {'data-background-src': n}) :
                                m(b, {'data-src': n}),
            c.theme = g, b.holderData = {flags: c, renderSettings: o},
            ('image' == a || 'fluid' == a) && m(b, {
              alt: g.text ?
                  (g.text.length > 16 ? g.text.substring(0, 16) + '…' :
                                        g.text) +
                      ' [' + h + ']' :
                  h
            }),
            ...
            ('html' != o.renderer && c.auto ||
             ...
             'html' == o.renderer ?
                 ...
                 (f(a, {dimensions: e, theme: g, flags: c}, b, o),
                  c.textmode && 'exact' == c.textmode &&
                      (A.vars.resizableImages.push(b), i(b)))) :
            'background' == a && 'html' != o.renderer ?
            f(a, {dimensions: e, theme: g, flags: c}, b, o) :
            'fluid' == a &&
                    ('%' == e.height.slice(-1) ? b.style.height = e.height :
                                                 null != c.auto && c.auto ||
                             (b.style.height = e.height + 'px'),
                     '%' == e.width.slice(-1) ? b.style.width = e.width :
                                                null != c.auto && c.auto ||
                             (b.style.width = e.width + 'px'),
                     ('inline' == b.style.display || '' === b.style.display ||
      ...
      function f(a, b, c, d) {
        ...
        if (f = e(), null == f) throw 'Holder: couldn\'t render placeholder';
        'background' == a ?
      ...
      function g(a) {
        function b(a, b, c, d) {
          b.width = c, b.height = d, a.width = Math.max(a.width, b.width),
          a.height += b.height, a.add(b)
        }
        switch (a.font = {
          family: a.theme.font ? a.theme.font :
                                 'Arial, Helvetica, Open Sans, sans-serif',
          size: h(
              a.width, a.height, a.theme.size ? a.theme.size : A.defaults.size),
          ...
          case 'exact':
            ...
            a.text = Math.floor(a.flags.exactDimensions.width) + 'x' +
        ...
        if (g.lineCount > 1) {
          ...
          for (var o = 0; o < g.words.length; o++) {
            ...
            var q = '\\n' == p.text;
            (k + p.width >= m || q === !0) &&
                (b(f, j, k, f.properties.leading), k = 0,
                 l += f.properties.leading, n += 1, j = new d.Group('line' + n),
                 j.y = l),
                q !== !0 &&
          ...
          i = new d.Text(a.text), j = new d.Group('line0'), j.add(i), f.add(j),
          f.moveTo(
      ...
      function h(a, b, c) {
        ...
        var d = Math.max(b, a), e = Math.min(b, a), f = A.defaults.scale,
        ...
        if (a.holderData) {
          ...
          if (b) {
            ...
            d.fluidWidth && !d.fluidHeight ?
                (d.mode = 'width',
                 d.ratio = d.initialDimensions.width /
                     parseFloat(c.dimensions.height)) :
                !d.fluidWidth && d.fluidHeight &&
                    (d.mode = 'height',
                     d.ratio = parseFloat(c.dimensions.width) /
      ...
      function o(a, c) {
        if (b.XMLSerializer) {
          ...
          if (c.svgXMLStylesheet) {
            for (var g = (new DOMParser)
                             .parseFromString('<xml />', 'application/xml'),
                     h = f.length - 1;
                 h >= 0; h--) {
              var i = g.createProcessingInstruction(
                  'xml-stylesheet', 'href="' + f[h] + '" rel="stylesheet"');
              g.insertBefore(i, g.firstChild)
            }
            var j = g.createProcessingInstruction(
                'xml', 'version="1.0" encoding="UTF-8" standalone="yes"');
            g.insertBefore(j, g.firstChild), g.removeChild(g.documentElement),
        ...
        run: function(a) {
          ...
          -1 === A.setup.renderers.join(',').indexOf(f.renderer) &&
              (f.renderer = A.setup.supportsSVG ?
                   'svg' :
                   A.setup.supportsCanvas ? 'canvas' : 'html'),
          g.use_canvas ? f.renderer = 'canvas' :
                         g.use_svg && (f.renderer = 'svg');
          var h = t(g.images), i = t(g.bgnodes), j = t(g.stylenodes),
              k = t(g.objects);
          f.stylesheets = [], f.svgXMLStylesheet = !0,
          f.noFontFallback = g.noFontFallback ? g.noFontFallback : !1;
          for (var m = 0; m < j.length; m++) {
            var n = j[m];
            if (n.attributes.rel && n.attributes.href &&
          ...
          for (m = 0; m < i.length; m++) {
            var s = b.getComputedStyle(i[m], null)
          ...
          for (m = 0; m < h.length; m++) {
            ...
            K ? 0 === J.src.indexOf(g.domain) ? c(g, f, J.src, I) :
                                                L &&
                        (M ? c(g, f, J.dataSrc, I) :
                             !function(a, b, d, e, f) {
                               u(a, function(a) {
      ...
      z.add_theme = z.addTheme, z.add_image = z.addImage,
        ...
        flags: {
          ...
          B = function() {
            ...
            return function(d) {
              ...
              if (A.setup.supportsSVG) {
                ...
                null == a && (f = !0),
                    ...
                    f &&
                    (b = l('text', x), c = g(null), m(b, {x: 0}),
                     b.appendChild(c), a.appendChild(b), y.body.appendChild(a),
                     a.style.visibility = 'hidden',
                     a.style.position = 'absolute', a.style.top = '-100%',
                     a.style.left = '-100%');
                ...
                var r = b.getComputedTextLength(), s = j.width - r,
                    t = Math.round(s / Math.max(1, o.length - 1)), u = [];
                if (k > 1) {
                  c.nodeValue = '';
                ...
                return {
                  spaceWidth: t, lineCount: k, boundingBox: j, words: u
                }
              }
              return !1
            }
            ...
            return function(c) {
              ...
              a.height = A.dpr(d.properties.height), b.textBaseline = 'middle',
              b.fillStyle = d.children.holderBg.properties.fill,
              b.fillRect(
                  0, 0, A.dpr(d.children.holderBg.width),
                  A.dpr(d.children.holderBg.height));
              {
                var e = d.children.holderTextGroup;
                e.properties
              }
              b.font = e.properties.font.weight + ' ' +
                  A.dpr(e.properties.font.size) + e.properties.font.units +
                  ' ' + e.properties.font.family + ', monospace',
              ...
              return a.appendChild(c), function(b, d) {
                ...
                for (var k in h.children) {
                  ...
                  for (var r in p.children) {
                    var s = p.children[r], t = h.x + p.x + s.x,
                    ...
                    m(v, {
                      ...
                      style: q({
                        ...
                        w.nodeValue = s.properties.text, v.appendChild(w),
                        j.appendChild(v)
                  }
                }
            ...
            var c = 1, d = augment.defclass({
              constructor: function(a) {
                c++, this.parent = null, this.children = {}, this.id = c,
                     this.name = 'n' + c, null != a && (this.name = a),
                     this.x = 0, this.y = 0, this.z = 0, this.width = 0,
                     this.height = 0
              },
              resize: function(a, b) {
              ...
              moveTo: function(a, b, c) {
                ...
                this.y = null != b ? b : this.y, this.z = null != c ? c : this.z
              },
              add: function(a) {
                var b = a.name;
                    ...
                    b.constructor.call(this, 'root'), this.properties = a
                      ...
                      function c(c, d) {
                        if (a.constructor.call(this, c),
                            this.properties = {fill: '#000'}, null != d)
                          b(this.properties, d);
                        else if (null != c && 'string' != typeof c)
                          throw 'SceneGraph: invalid node name'
                      }
                      this.Group =
                          augment.extend(this, {constructor: c, type: 'group'}),
                      this.Rect =
                          augment.extend(this, {constructor: c, type: 'rect'}),
      ...
      A.vars =
          {preempted: !1, resizableImages: [], debounceTimer: null, cache: {}},
      function() {
        var a = 1, c = 1, d = l('canvas'), e = null;
        d.getContext &&
            -1 != d.toDataURL('image/png').indexOf('data:image/png') &&
            (A.setup.renderer = 'canvas', e = d.getContext('2d'),
             A.setup.supportsCanvas = !0),
            A.setup.supportsCanvas &&
            (a = b.devicePixelRatio || 1,
             c = e.webkitBackingStorePixelRatio ||
                 e.mozBackingStorePixelRatio || e.msBackingStorePixelRatio ||
                 e.oBackingStorePixelRatio || e.backingStorePixelRatio || 1),
            A.setup.ratio = a / c,
            y.createElementNS && y.createElementNS(x, 'svg').createSVGRect &&
