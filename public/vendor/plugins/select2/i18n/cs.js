...
return e.define('select2/i18n/cs', [], function() {
  ...
  return {
    errorLoading: function() {
      ...
      return n == 1 ? 'Prosím zadejte o jeden znak méně' :
                      n <= 4 ? 'Prosím zadejte o ' + e(n, !0) + ' znaky méně' :
                               'Prosím zadejte o ' + n + ' znaků méně'
    }, inputTooShort: function(t) {
      var n = t.minimum - t.input.length;
      return n == 1 ?
          'Prosím zadejte ještě jeden znak' :
          n <= 4 ? 'Prosím zadejte ještě další ' + e(n, !0) + ' znaky' :
      ...
      return n == 1 ?
          ...
          n <= 4 ? 'Můžete zvolit maximálně ' + e(n, !1) + ' položky' :
