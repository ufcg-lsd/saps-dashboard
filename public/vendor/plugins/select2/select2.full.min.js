        ...
        !function(b) {
          ...
          function f(a, b) {
            var c, d, e, f, g, h, i, j, k, l, m,
                n = b && b.split('/'), o = s.map, p = o && o['*'] || {};
            if (a && '.' === a.charAt(0))
              if (b) {
                for (n = n.slice(0, n.length - 1), a = a.split('/'),
                    g = a.length - 1,
                    s.nodeIdCompat && w.test(a[g]) &&
                         (a[g] = a[g].replace(w, '')),
                    a = n.concat(a), k = 0;
                     k < a.length; k += 1)
                  if (m = a[k], '.' === m)
          ...
          var m, n, o, p, q = {}, r = {}, s = {}, t = {},
                          u = Object.prototype.hasOwnProperty, v = [].slice,
                          w = /\.js$/;
          o =
              function(a, b) {
            var c, d = k(a), e = d[0];
            return a = d[1], e && (e = f(e, b), c = j(e)),
                   e ? a = c && c.normalize ? c.normalize(a, h(b)) : f(a, b) :
                       (a = f(a, b), d = k(a), e = d[0], a = d[1],
                        e && (c = j(e))),
            {
          ...
          m = function(a, c, d, f) {
           ...
           b.define(
               ...
               function() {
                 var b = a || $;
                 return null == b && console && console.error &&
                            console.error(
           ...
           b.define(
               ...
               function(a) {
                 ...
                 return d.prototype.on = function(a, b) {
                   ...
                   a in this.listeners ? this.listeners[a].push(b) :
                                         this.listeners[a] = [b]
           ...
           b.define(
               ...
               function(a, b) {
                 function c(a, b, d) {
                   this.$element = a, this.data = d, this.options = b,
                 ...
                 return b.Extend(c, b.Observable), c.prototype.render = function() {
                   ...
                   this.data.current(function(c) {
                     ...
                     f.length > 0 ? f.first().trigger('mouseenter') :
                   ...
                   b.disabled &&
                       ...
                       b.children &&
                       (d.role = 'group', d['aria-label'] = b.text,
                       ...
                       this.$results.on(
                           ...
                           function(a) {
                             var b = c.$results.scrollTop(),
                                 d = c.$results.get(0).scrollHeight -
                                 c.$results.scrollTop() + a.deltaY,
                                 e = a.deltaY > 0 && b - a.deltaY <= 0,
                                 f = a.deltaY < 0 && d <= c.$results.height();
                             e ? (c.$results.scrollTop(0), a.preventDefault(),
                                  a.stopPropagation()) :
                                 f &&
                                     (c.$results.scrollTop(
                             ...
                             return 'true' === d.attr('aria-selected') ?
                                 void (
                                     c.options.get('multiple') ?
                                         c.trigger(
                                             'unselect',
                                             {originalEvent: b, data: e}) :
                                         c.trigger('close')) :
                                 void c.trigger(
                                     'select', {originalEvent: b, data: e})
                           }),
                       this.$results.on(
                           'mouseenter',
                           '.select2-results__option[aria-selected]',
                   ...
                   if (0 !== a.length) {
                     var b = this.$results.find('[aria-selected]'),
                         c = b.index(a), d = this.$results.offset().top,
                         e = a.offset().top,
                         f = this.$results.scrollTop() + (e - d), g = e - d;
                     f -= 2 * a.outerHeight(!1),
                         2 >= c ? this.$results.scrollTop(0) :
                   ...
                   null == f ? c.style.display = 'none' :
                               'string' == typeof f ? c.innerHTML = e(f) :
                                                      a(c).append(f)
                 }, c
               }),
           b.define(
                 ...
                 return b.Extend(d, b.Observable), d.prototype.render = function() {
                   ...
                   this.container = a, this.$selection.on('focus', function(a) {
                     ...
                     b.$selection.attr('aria-expanded', 'false'),
                         ...
                         b.$selection.focus(), b._detachCloseHandler(a)
                 ...
                 return c.Extend(d, b), d.prototype.render = function() {
                   ...
                   if (this.clear(), 0 !== b.length) {
                     for (var c = a(), d = 0; d < b.length; d++) {
                       var e = b[d], f = this.display(e),
                           g = this.selectionContainer();
                       g.append(f), g.prop('title', e.title || e.text),
                           g.data('data', e), c = c.add(g)
                     }
                     this.$selection.find('.select2-selection__rendered')
                         .append(c)
                   }
               ...
               function() {
                 ...
                 return a.prototype.normalizePlaceholder = function(a, b) {
                   ...
                   return c.html(this.display(b)),
                          c.addClass('select2-selection__placeholder')
           ...
           b.define(
               'select2/selection/allowClear', ['jquery'],
               function(a) {
                 function b() {}
                 return b.prototype.bind = function(b, c, d) {
                   var e = this;
                   b.call(this, c, d),
                       null == e.placeholder && e.options.get('debug') &&
                       ...
                       this.$selection.on(
                           ...
                           function(b) {
                             if (!e.options.get('disabled')) {
                               b.stopPropagation();
                               for (var c = a(this).data('data'), d = 0;
                                    d < c.length; d++) {
                                 var f = {data: c[d]};
               ...
               function(a, b, c) {
                 ...
                 return d.prototype.render = function(b) {
                   ...
                   a.call(this, b, d),
                       ...
                       this.$selection.on(
                           'focusout', '.select2-search--inline',
                           function(a) {
                             e.trigger('blur', a)
                           }),
                       this.$selection.on(
                           ...
                           function(a) {
                             a.stopPropagation(), e.trigger('keypress', a),
                   ...
                   this.trigger('unselect', {data: b}), this.trigger('open'),
               ...
               function(a) {
                 ...
                 return b.prototype.bind = function(b, c, d) {
                   var e = this,
                       f =
                           [
                             'open', 'opening', 'close', 'closing', 'select',
                             'selecting', 'unselect', 'unselecting'
                           ],
           ...
           b.define(
               ...
               function(a, b, c) {
                 ...
                 return b.Extend(d, a), d.prototype.current = function(a) {
                   ...
                   return b = this._normalizeItem(b), b.element = a[0],
                          c.data(a[0], 'data', b), b
                   ...
                   return null != a.id && (a.id = a.id.toString()),
                          ...
                          null == a._resultId && a.id &&
                              null != this.container &&
                              (a._resultId =
                                   this.generateResultId(this.container, a)),
                          c.extend({}, b, a)
           ...
           b.define(
               ...
               function(a, b, c) {
                 ...
                 return b.Extend(d, a), d.prototype.select = function(a) {
                   ...
                   for (var d = this, e = this.$element.find('option'),
                            f = e.map(function() {
                     ...
                     if (c.inArray(i.id, f) >= 0) {
                       var j = e.filter(b(i)), k = this.item(j),
                   ...
                   function d() {
                     var d = f.transport(
                         ...
                         function(d) {
                           ...
                           e.options.get('debug') && window.console &&
                               console.error &&
               ...
               function(a) {
                 function b(b, c, d) {
                   ...
                   if (void 0 !== f && (this.createTag = f), b.call(this, c, d),
                     ...
                     for (var g = 0; g < e.length; g++) {
                       var h = e[g], i = this._normalizeItem(h),
                           j = this.option(i);
                 ...
                 return b.prototype.query = function(a, b, c) {
                   function d(a, f) {
                     ...
                     if (null != l) {
                       var m = e.option(l);
                       m.attr('data-select2-tag', !0), e.addOptions(m),
                           e.insertTag(g, l)
                     }
                     a.results = g, c(a)
                   }
           ...
           b.define(
               ...
               function(a) {
                 ...
                 return b.prototype.bind = function(a, b, c) {
                   ...
                   for (var f = d.get('tokenSeparators') || [], g = c.term,
                            h = 0,
                            i = this.createTag ||
                            function(a) {
                              return {
                     ...
                     var j = g[h];
                     if (-1 !== a.inArray(j, f)) {
                       var k = g.substr(0, h), l = a.extend({}, c, {term: k}),
                           m = i(l);
               ...
               function(a) {
                 ...
                 return b.prototype.render = function(b) {
                   ...
                   return this.$searchContainer = d,
                          this.$search = d.find('input'), c.prepend(d), c
                   ...
                   b.call(this, c, d), this.$search.on('keydown', function(a) {
                     ...
                     if (null == a.query.term || '' === a.query.term) {
                       ...
                       b ? e.$searchContainer.removeClass(
                               'select2-search--hide') :
               ...
               function(a) {
                 ...
                 return b.prototype.append = function(a, b) {
                   ...
                   b.call(this, c, d), c.on('query', function(a) {
                     ...
                     var b = a.contains(
                         document.documentElement, e.$loadingMore[0]);
                     if (!e.loading && b) {
                       var c = e.$results.offset().top +
                           e.$results.outerHeight(!1),
                           d = e.$loadingMore.offset().top +
               ...
               function(a, b) {
                 ...
                 return c.prototype.bind = function(a, b, c) {
                   ...
                   a.call(this, b, c), b.on('open', function() {
                     d._showDropdown(), d._attachPositioningHandler(b),
                   ...
                   var h = {height: this.$dropdown.outerHeight(!1)}, i = {
                     ...
                     bottom: b.scrollTop() + b.height()
                       ...
                       j = i.top<f.top - h.height, k = i.bottom>f.bottom +
                       h.height,
                 ...
                 D.prototype.apply = function(l) {
                   if (l = a.extend({}, this.defaults, l),
                     ...
                     if (l.dataAdapter =
                         ...
                         l.tags &&
                             (l.dataAdapter = j.Decorate(l.dataAdapter, p)),
                   ...
                   if (null == l.resultsAdapter &&
                           (l.resultsAdapter = c,
                            null != l.ajax &&
                                (l.resultsAdapter =
                                     j.Decorate(l.resultsAdapter, x)),
                            null != l.placeholder &&
                                (l.resultsAdapter =
                                     j.Decorate(l.resultsAdapter, w)),
                            l.selectOnClose &&
                                (l.resultsAdapter =
                                     j.Decorate(l.resultsAdapter, A))),
                   ...
                   if (null == l.selectionAdapter &&
                           (l.selectionAdapter = l.multiple ? e : d,
                            null != l.placeholder &&
                                (l.selectionAdapter =
                                     j.Decorate(l.selectionAdapter, f)),
                            l.allowClear &&
                                (l.selectionAdapter =
                                     j.Decorate(l.selectionAdapter, g)),
                            l.multiple &&
                                (l.selectionAdapter =
                                     j.Decorate(l.selectionAdapter, h)),
                            l.selectionAdapter =
                                j.Decorate(l.selectionAdapter, i)),
                       ...
                       try {
                         ...
                         try {
                           ...
                           l.debug && window.console && console.warn &&
                               console.warn(
                                   'Select2: The language file for "' + K +
               ...
               function(a, b, c) {
                 ...
                 return d.prototype.fromElement = function(b) {
                   ...
                   null == this.options.multiple &&
                       ...
                       (b.prop('lang') ? this.options.language =
                                             b.prop('lang').toLowerCase() :
                   ...
                   var e = {};
                   e = a.fn.jquery && '1.' == a.fn.jquery.substr(0, 2) &&
                           b[0].dataset ?
                   ...
                   function(a, b, c, d) {
                     var e = function(a, c) {
                       null != a.data('select2') && a.data('select2').destroy(),
                           this.$element = a, this.id = this._generateId(a),
                           c = c || {}, this.options = new b(c, a),
                     ...
                     e.prototype._placeContainer = function(a) {
                       ...
                       var b = this._resolveWidth(
                           this.$element, this.options.get('width'));
                       ...
                       if ('style' == b) {
                         ...
                         for (var g = f.split(';'), h = 0, i = g.length; i > h;
                              h += 1) {
                       ...
                       this.on('open', function() {
                         ...
                         a.isOpen() ?
                             ...
                             (c === d.ESC ||
                              c === d.TAB) && (a.close(), b.preventDefault()) :
                             (c === d.ENTER || c === d.SPACE ||
                       ...
                       this.$container.remove(),
                           ...
                           this.$element[0].removeEventListener &&
                               this.$element[0].removeEventListener(
                                   'DOMAttrModified', this._sync, !1),
                           this._sync = null, this.$element.off('.select2'),
                           this.$element.attr(
                               'tabindex', this.$element.data('old-tabindex')),
                           this.$element.show(),
                           this.$element.removeData('select2'),
                           this.dataAdapter.destroy(), this.selection.destroy(),
                           this.dropdown.destroy(), this.results.destroy(),
                           this.dataAdapter = null, this.selection = null,
           ...
           function(c) {
             ...
             function b(b) {
               var g = b || window.event, h = i.call(arguments, 1), j = 0,
                   l = 0, m = 0, n = 0, o = 0, p = 0;
               if (b = a.event.fix(g), b.type = 'mousewheel',
                 ...
                 return b.deltaX = l, b.deltaY = m, b.deltaFactor = f,
                        b.offsetX = o, b.offsetY = p, b.deltaMode = 0,
                        h.unshift(b, j, l, m), e && clearTimeout(e),
                        e = setTimeout(c, 200),
             ...
             var k = a.event.special.mousewheel = {
               ...
               getLineHeight: function(b) {
                 var c = a(b),
                     d =
                         c['offsetParent' in a.fn ? 'offsetParent' :
                                                    'parent']();
             ...
             a.fn.extend({
               mousewheel: function(a) {
                 return a ? this.bind('mousewheel', a) :
           ...
           b.define(
               ...
               function(a) {
                 function b(a, b, c) {
                   c.get('debug') && window.console && console.warn &&
                       console.warn(
                 ...
                 return b.prototype.current = function(b, c) {
                   ...
                   return this._isInitialized ?
                       ...
                       void this.initSelection.call(
                           null, this.$element, function(b) {
                             d._isInitialized = !0, a.isArray(b) || (b = [b]),
                             c(b)
                           })
                 }, b
               }),
           b.define(
               'select2/compat/inputData', ['jquery'],
               function(a) {
                 function b(a, b, c) {
                   this._currentData = [],
                   this._valueSeparator = c.get('valueSeparator') || ',',
                   'hidden' === b.prop('type') && c.get('debug') && console &&
                       console.warn &&
                       console.warn(
                 ...
                 return b.prototype.current = function(b, c) {
                   ...
                   if (this.options.get('multiple')) {
                     ...
                     d += this._valueSeparator + c.id, this.$element.val(d),
           ...
           b.define(
               ...
               function() {
                 ...
                 return a.prototype.position = function(a, b, c) {
                   ...
                   d.append(b), b.addClass('select2-dropdown--below'),
                 ...
                 return null == a.fn.select2 &&
                            (a.fn.select2 =
                                 function(c) {
                                   ...
                                   throw new Error(
                                       'Invalid arguments for Select2: ' + c)
                                 }),
