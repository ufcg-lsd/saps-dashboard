/*
 RequireJS 2.1.11 Copyright (c) 2010-2014, The Dojo Foundation All Rights
...
function ha(b) {
  ...
  function d(a) {
    z && v(document.getElementsByTagName('script'), function(e) {
      if (e.getAttribute('data-requiremodule') === a &&
  ...
  function m(a, e, b, f) {
    ...
    g && (g = c(g, h, f), d = j(p, g));
    a &&
        (g ? k = d && d.normalize ? d.normalize(
                                        a,
                                        function(a) {
                                          return c(a, h, f)
                                        }) :
                                    c(a, h, f) :
             (k = c(a, h, f), a = u(k), g = a[0], k = a[1], b = !0,
              n = i.nameToUrl(k)));
    b = g && !d && !b ? '_unnormalized' + (Q += 1) : '';
    return {
      prefix: g, name: k, parentMap: e, unnormalized: !!b, url: n,
          originalName: l, isDefine: m, id: (g ? g + '!' + k : k) + b
    }
  }
  function q(a) {
    var e = a.id, b = j(k, e);
  ...
  function F(a, e, b) {
    var f = a.map.id;
    a.error ? a.emit('error', a.error) :
              (e[f] = !0, v(a.depMaps, function(f, c) {
                 var d = f.id, g = j(k, d);
                 g && (!a.depMatched[c] && !b[d]) &&
        ...
        if (a.enabled && (i.isDefine || c.push(a), !a.error))
          if (!a.inited && b)
            g(m) ? h = e = !0 : (f.push(m), d(m));
              ...
              !a.inited && (a.fetched && i.isDefine) && (h = !0, !i.prefix))
            return k = !1
      });
      if (b && f.length)
  ...
  function K(a) {
    ...
    a.detachEvent && !Z ? a.detachEvent('onreadystatechange', e) :
  ...
  N = {
    ...
    exports: function(a) {
      a.usingExports = !0;
      if (a.map.isDefine)
        return a.exports ? p[a.map.id] = a.exports :
  ...
  $.prototype = {
    ...
    callPlugin: function() {
      ...
      r(d, 'defined', t(this, function(f) {
          ...
          if (this.map.unnormalized) {
            ...
            g ? (this.map.url = i.nameToUrl(g), this.load()) :
                (d = t(this, function(a) {
                   this.init([], function() {
                     return a
                   }, null, {enabled: !0})
    ...
    enable: function() {
      ...
      v(this.depMaps, t(this, function(a, b) {
          ...
          if ('string' === typeof a) {
            a =
                m(a, this.map.isDefine ? this.map : this.map.parentMap, !1,
                  !this.skipMap);
            this.depMaps[b] = a;
            if (c = j(N, a.id)) {
  ...
  i = {
    ...
    nameToUrl: function(a, b, c) {
      ...
      return l.urlArgs ? f + ((-1 === f.indexOf('?') ? '?' : '&') + l.urlArgs) :
                         f
    },
    load: function(a, b) {
      h.load(i, a, b)
...
var h, x, y, D, K, E, P, L, q, Q,
    la = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/mg,
    ma = /[^.]\s*require\s*\(\s*["']([^'"\s]+)["']\s*\)/g, R = /\.js$/,
    ja = /^\.\//;
x = Object.prototype;
...
if ('undefined' === typeof define) {
  ...
  'undefined' !== typeof require && !G(require) &&
  ...
  h.load = function(b, c, d) {
    ...
    if (z)
      return g = h.createNode(g, c, d),
             ...
             g.src = d, L = g, D ? y.insertBefore(g, D) : y.appendChild(g),
             L = null, g;
    if (fa) try {
        importScripts(d), b.completeLoad(c)
      } catch (j) {
        b.onError(
            C('importscripts', 'importScripts failed for ' + c + ' at ' + d, j,
              [c]))
      }
  };
  z && !r.skipDataMain &&
      U(document.getElementsByTagName('script'), function(b) {
        ...
        if (K = b.getAttribute('data-main'))
          return q = K,
                 r.baseUrl ||
                     (E = q.split('/'), q = E.pop(),
                      Q = E.length ? E.join('/') + '/' : './', r.baseUrl = Q),
                 q = q.replace(R, ''), h.jsExtRegExp.test(q) && (q = K),
                 r.deps = r.deps ? r.deps.concat(q) : [q], !0
      });
