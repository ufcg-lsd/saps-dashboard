...
describe('c3 chart grid', function() {
  ...
  describe('y grid', function() {
    ...
    it('should show grids depending on y axis ticks', function() {
      ...
      chart.internal.main.select('.c3-axis-y')
          .selectAll('.tick')
          .each(function(d, i) {
  ...
  describe('x grid lines', function() {
    describe('on category axis', function() {
      it('should update args', function() {
        args = {
          ...
          grid: {
            x: {
              lines: [
                {value: 3, text: 'Label 3'}, {value: 'a', text: 'Label a'}
              ]
            }
          }
        };
      ...
      it('should show x grid lines', function() {
        var lines =
                chart.internal.main.selectAll('.c3-xgrid-lines .c3-xgrid-line'),
            expectedX1 = [515, 74], expectedText = ['Label 3', 'Label a'];
        lines.each(function(id, i) {
          var line = d3.select(this), l = line.select('line'),
              t = line.select('text');
