...
describe('c3 chart data', function() {
  ...
  describe('function in data.order', function() {
    it('should return false in isOrderAsc and isOrderDesc functions',
       function() {
         expect(chart.internal.isOrderAsc() || chart.internal.isOrderDesc())
             .toBe(false);
       });
  });
        ...
        args = {
          data: {
            ...
            columns: [
              ...
              ['data1', 30, 200, 100], ['data2', 130, 300, 200]
            ]
          },
    ...
    describe('milliseconds timeseries x', function() {
      describe('as date string', function() {
          ...
          args = {
            data: {
              ...
              columns: [
                ...
                ['data1', 30, 200], ['data2', 130, 300]
              ]
            },
            axis: {
              x: {
                type: 'timeseries',
                tick: {format: '%Y-%m-%d %H:%M:%S.%L', multiline: false}
              }
            }
          };
          expect(true).toBeTruthy();
        ...
        it('should have milliseconds tick format', function() {
          ...
          chart.internal.main.selectAll('.c3-axis-x g.tick text')
              .each(function(d, i) {
        ...
        it('should update args', function() {
          args = {
            data: {
              x: 'date',
              columns: [
                ['date', 1417622461123, 1417622522345], ['data1', 30, 200],
                ['data2', 130, 300]
              ]
            },
            axis: {
              x: {type: 'timeseries', tick: {format: '%Y-%m-%d %H:%M:%S.%L'}}
            }
          };
          expect(true).toBeTruthy();
        });
  ...
  describe('data.label', function() {
    describe('with small values', function() {
      it('should update args to show data label', function() {
        args = {
          data: {
            columns: [['data1', 0.03, 0.2, 0.1, 0.4, 0.15, 0.250]],
            labels: true
          }
        };
        expect(true).toBeTruthy();
    ...
    describe('with positive values and null', function() {
      describe('on not rotated axis', function() {
        ...
        it('should locate labels above each data point', function() {
          var texts = chart.internal.main.selectAll('.c3-texts-data1 text'),
              expectedYs = [67, 49, 67, 423], expectedXs = [74, 221, 368, 515];
        ...
        it('should locate labels above each data point', function() {
          var texts = chart.internal.main.selectAll('.c3-texts-data1 text'),
              expectedYs = [375, 40, 375, 422], expectedXs = [6, 198, 391, 583];
          texts.each(function(d, i) {
            var text = d3.select(this);
            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
      ...
      describe('on rotated axis', function() {
        ...
        it('should locate labels above each data point', function() {
          var texts = chart.internal.main.selectAll('.c3-texts-data1 text'),
              expectedYs = [57, 163, 269, 375], expectedXs = [490, 516, 490, 4];
          texts.each(function(d, i) {
            var text = d3.select(this);
            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
        ...
        it('should locate labels above each data point', function() {
          var texts = chart.internal.main.selectAll('.c3-texts-data1 text'),
              expectedYs = [9, 147, 286, 424], expectedXs = [76, 526, 76, 4];
          texts.each(function(d, i) {
            var text = d3.select(this);
            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
    ...
    describe('with positive values and null', function() {
      describe('on not rotated axis', function() {
        ...
        it('should locate labels above each data point', function() {
          var texts = chart.internal.main.selectAll('.c3-texts-data1 text'),
              expectedYs = [58, 392, 58, 12], expectedXs = [6, 198, 391, 583];
          texts.each(function(d, i) {
            var text = d3.select(this);
            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
      ...
      describe('on rotated axis', function() {
        ...
        it('should locate labels above each data point', function() {
          var texts = chart.internal.main.selectAll('.c3-texts-data1 text'),
              expectedYs = [9, 147, 286, 424], expectedXs = [511, 67, 511, 526];
          texts.each(function(d, i) {
            var text = d3.select(this);
            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
    ...
    describe('with positive and negative values and null', function() {
      describe('on non rotated axis', function() {
        ...
        it('should locate labels above each data point', function() {
          var texts = chart.internal.main.selectAll('.c3-texts-data1 text'),
              expectedYs = [392, 43, 52, 215], expectedXs = [74, 221, 368, 515];
          texts.each(function(d, i) {
            var text = d3.select(this);
            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
        ...
        it('should locate labels above each data point', function() {
          var texts = chart.internal.main.selectAll('.c3-texts-data1 text'),
              expectedYs = [392, 40, 49, 212], expectedXs = [6, 198, 391, 583];
          texts.each(function(d, i) {
            var text = d3.select(this);
            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
      ...
      describe('on rotated axis', function() {
        ...
        it('should locate labels above each data point', function() {
          var texts = chart.internal.main.selectAll('.c3-texts-data1 text'),
              expectedYs = [9, 147, 286, 424], expectedXs = [67, 527, 515, 297];
          texts.each(function(d, i) {
            var text = d3.select(this);
            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
    ...
    describe('with positive grouped values', function() {
      ...
      describe('on rotated axis', function() {
        ...
        it('should locate labels above each data point', function() {
          var texts = chart.internal.main.selectAll('.c3-texts-data1 text'),
              expectedYs = [57, 163, 269, 375], expectedXs = [57, 150, 77, 363];
          texts.each(function(d, i) {
            var text = d3.select(this);
            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
      ...
      describe('on non rotated axis', function() {
        it('should update args', function() {
          args = {
            data: {
              columns: [
                ['data1', -30, -200, -100, -500], ['data2', -50, -20, -10, -40],
                ['data3', -250, -220, -210, -240]
              ],
              groups: [['data1', 'data2', 'data3']],
              labels: true,
        ...
        it('should locate labels above each data point', function() {
          var texts = chart.internal.main.selectAll('.c3-texts-data1 text'),
              expectedYs = [51, 118, 65, 272], expectedXs = [74, 221, 368, 515];
          texts.each(function(d, i) {
            var text = d3.select(this);
            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
        ...
        it('should locate labels above each data point', function() {
          var texts = chart.internal.main.selectAll('.c3-texts-data1 text'),
              expectedYs = [88, 149, 101, 288], expectedXs = [6, 198, 391, 583];
          texts.each(function(d, i) {
            var text = d3.select(this);
            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
