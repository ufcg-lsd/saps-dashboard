...
describe('c3 api data', function() {
  ...
  var args = {
    data: {
      ...
      names: {data1: 'Data Name 1', data2: 'Data Name 2'},
      colors: {data1: '#FF0000', data2: '#00FF00'},
  ...
  describe('data.names()', function() {
    ...
    it('should return data.names specified as api', function() {
      var results = chart.data.names(
          {data1: 'New Data Name 1', data2: 'New Data Name 2'});
    ...
    it('should set data.names specified as api', function() {
      expect(d3.select('.c3-legend-item-data1 text').text())
          .toBe('New Data Name 1');
      expect(d3.select('.c3-legend-item-data2 text').text())
          .toBe('New Data Name 2');
    });
  });
  ...
  describe('data.colors()', function() {
    ...
    it('should return data.colors specified as api', function() {
      var results = chart.data.colors({data1: '#00FF00', data2: '#FF0000'});
    ...
    it('should set data.colors specified as api', function() {
      ...
      expect(
          d3.select('.c3-legend-item-data1 .c3-legend-item-tile').style('fill'))
          .toBe('#00ff00');
      expect(
          d3.select('.c3-legend-item-data2 .c3-legend-item-tile').style('fill'))
          .toBe('#ff0000');
    });
  });
  ...
  describe('data.axes()', function() {
    ...
    it('should return data.axes specified as api', function() {
      var results = chart.data.axes({data1: 'y2', data2: 'y'});
