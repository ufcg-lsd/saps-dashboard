!function() {
  ...
  function D(n) {
    return 'function' == typeof n ?
        n :
        (n = ta.ns.qualify(n)).local ? function() {
  ...
  function X() {
    var n = '.dragsuppress-' + ++qa, t = 'click' + n,
        e = ta.select(oa)
                .on('touchmove' + n, b)
                .on('dragstart' + n, b)
                .on('selectstart' + n, b);
  ...
  function $(n, t) {
    ...
    if (e.createSVGPoint) {
      ...
      return La ? (r.x = t.pageX, r.y = t.pageY) :
  ...
  function ot(n, t, e) {
    return this instanceof ot ?
        ...
        arguments.length < 2 ?
        n instanceof ot ? new ot(n.h, n.s, n.l) : xt('' + n, bt, ot) :
        new ot(n, t, e)
  }
  function at(n, t, e) {
    function r(n) {
      return n > 360 ? n -= 360 : 0 > n && (n += 360),
             60 > n ? i + (o - i) * n / 60 :
                      180 > n ? o : 240 > n ? i + (o - i) * (240 - n) / 60 : i
    }
    function u(n) {
  ...
  function st(n, t, e) {
    return this instanceof st ?
        ...
        n instanceof st ?
        new st(n.l, n.a, n.b) :
        n instanceof ct ? lt(n.h, n.c, n.l) : _t((n = dt(n)).r, n.g, n.b) :
        new st(n, t, e)
  }
  function ft(n, t, e) {
    var r = (n + 16) / 116, u = r + t / 500, i = r - e / 200;
    return u = gt(u) * Ja, r = gt(r) * Ga, i = gt(i) * Ka,
           new dt(
               vt(3.2404542 * u - 1.5371385 * r - .4985314 * i),
               vt(-.969266 * u + 1.8760108 * r + .041556 * i),
               vt(.0556434 * u - .2040259 * r + 1.0572252 * i))
  }
  function ht(n, t, e) {
    return n > 0 ? new ct(Math.atan2(e, t) * Ha, Math.sqrt(t * t + e * e), n) :
                   new ct(0 / 0, 0 / 0, n)
  }
  function gt(n) {
  ...
  function dt(n, t, e) {
    return this instanceof dt ?
        ...
        arguments.length < 2 ?
        n instanceof dt ? new dt(n.r, n.g, n.b) : xt('' + n, dt, at) :
        new dt(n, t, e)
  }
  function mt(n) {
  ...
  function xt(n, t, e) {
    ...
    return (i = tc.get(n)) ?
        ...
        (null == n || '#' !== n.charAt(0) ||
             ...
             (4 === n.length ?
                  (o = (3840 & i) >> 4, o = o >> 4 | o, a = 240 & i,
                   a = a >> 4 | a, c = 15 & i, c = c << 4 | c) :
                  7 === n.length &&
                      (o = (16711680 & i) >> 16, a = (65280 & i) >> 8,
                       c = 255 & i)),
         t(o, a, c))
  }
  function bt(n, t, e) {
    var r, u, i = Math.min(n /= 255, t /= 255, e /= 255), o = Math.max(n, t, e),
              a = o - i, c = (o + i) / 2;
  ...
  function Nt(n, t, e, r) {
    ...
    var i = {}, o = ta.dispatch('beforesend', 'progress', 'load', 'error'),
        a = {}, c = new XMLHttpRequest, l = null;
    return !oa.XDomainRequest || 'withCredentials' in c ||
               !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest),
           'onload' in c ?
  ...
  function Pt(n) {
    var t = n.decimal, e = n.thousands, r = n.grouping, u = n.currency,
        i = r && e ? function(n, t) {
          for (var u = n.length, i = [], o = 0, a = r[0], c = 0; u > 0 &&
               a > 0 &&
               (c + a + 1 > t && (a = Math.max(1, t - c)),
                i.push(n.substring(u -= a, u + a)), !((c += a + 1) > t));)
            a = r[o = (o + 1) % r.length];
          return i.reverse().join(e)
        } : Et;
    return function(n) {
      var e = lc.exec(n), r = e[1] || ' ', o = e[2] || '>', a = e[3] || '-',
          c = e[4] || '', l = e[5], s = +e[6], f = e[7], h = e[8], g = e[9],
          p = 1, v = '', d = '', m = !1, y = !0;
  ...
  function Ft(n, t, e) {
    ...
    var c = n.utc = Ht(n);
    return c.floor = c, c.round = Ht(r), c.ceil = Ht(u), c.offset = Ht(i),
           c.range = a, n
  }
  function Ht(n) {
    return function(t, e) {
  ...
  function Ot(n) {
    ...
    function e(n, t, e, r) {
      for (var u, i, o, a = 0, c = t.length, l = e.length; c > a;) {
        ...
        if (u = t.charCodeAt(a++), 37 === u) {
          if (o = t.charAt(a++), i = C[o in pc ? t.charAt(a++) : o],
              !i || (r = i(n, e, r)) < 0)
            return -1
    ...
    var M = ta.map(), x = It(v), b = Zt(v), _ = It(d), w = Zt(d), S = It(m),
        k = Zt(m), E = It(y), A = Zt(y);
  ...
  function ie(n) {
    var t = n.getTimezoneOffset(), e = t > 0 ? '-' : '+', r = 0 | va(t) / 60,
        u = va(t) % 60;
  ...
  function ge() {
    function n(n, t) {
      n *= Fa, t = t * Fa / 2 + Da / 4;
      var e = n - r, o = e >= 0 ? 1 : -1, a = o * e, c = Math.cos(t),
          l = Math.sin(t), s = i * l, f = u * c + s * Math.cos(a),
          h = s * o * Math.sin(a);
    ...
    wc.point = function(o, a) {
      wc.point = n, r = (t = o) * Fa,
      u = Math.cos(a = (e = a) * Fa / 2 + Da / 4), i = Math.sin(a)
    }, wc.lineEnd = function() {
      n(t, e)
    }
  }
  ...
  function Se() {
    function n(n, u) {
      n *= Fa;
      var i = Math.cos(u *= Fa), o = i * Math.cos(n), a = i * Math.sin(n),
          c = Math.sin(u),
          l = Math.atan2(
              Math.sqrt(
                  (l = e * c - r * a) * l + (l = r * o - t * c) * l +
                  (l = t * a - e * o) * l),
              t * o + e * a + r * c);
      kc += l, Cc += l * (t + (t = o)), zc += l * (e + (e = a)),
          qc += l * (r + (r = c)), we(t, e, r)
    }
    var t, e, r;
    Dc.point = function(u, i) {
      u *= Fa;
      var o = Math.cos(i *= Fa);
      t = o * Math.cos(u), e = o * Math.sin(u), r = Math.sin(i), Dc.point = n,
      we(t, e, r)
    }
  }
  function ke() {
  ...
  function Ee() {
    function n(n, t) {
      n *= Fa;
      var e = Math.cos(t *= Fa), o = e * Math.cos(n), a = e * Math.sin(n),
          c = Math.sin(t), l = u * c - i * a, s = i * o - r * c,
          f = r * a - u * o, h = Math.sqrt(l * l + s * s + f * f),
          g = r * o + u * a + i * c, p = h && -Q(g) / h, v = Math.atan2(h, g);
      Lc += p * l, Tc += p * s, Rc += p * f, kc += v, Cc += v * (r + (r = o)),
          zc += v * (u + (u = a)), qc += v * (i + (i = c)), we(r, u, i)
    }
    var t, e, r, u, i;
  ...
  function Ce(n, t, e, r, u) {
    ...
    if (n.forEach(function(n) {
          if (!((t = n.length - 1) <= 0)) {
            ...
            c.o = l, i.push(c), o.push(l), c = new qe(r, n, null, !1),
            l = new qe(r, null, c, !0), c.o = l, i.push(c), o.push(l)
          }
        }),
    ...
    return function(u, i) {
      ...
      var g, p, v, d = t(i), m = u.invert(r[0], r[1]), y = {
        ...
        polygonEnd: function() {
          ...
          var n = Fe(m, p);
          g.length ? (b || (i.polygonStart(), b = !0), Ce(g, De, n, e, i)) :
                     n &&
  ...
  function De(n, t) {
    return ((n = n.x)[0] < 0 ? n[1] - ja - Ta : ja - n[1]) -
  ...
  function Pe(n) {
    ...
    return {
      lineStart: function() {
        ...
        va(c - Da) < Ta ?
            (n.point(e, r = (r + o) / 2 > 0 ? ja : -ja), n.point(u, r),
             n.lineEnd(), n.lineStart(), n.point(a, r), n.point(i, r), t = 0) :
            u !== a && c >= Da &&
                (va(e - u) < Ta && (e -= u * Ta),
                 va(i - a) < Ta && (i -= a * Ta), r = Ue(e, r, i, o),
                 n.point(u, r), n.lineEnd(), n.lineStart(), n.point(a, r),
                 t = 0),
            n.point(e = i, r = o), u = a
      }, lineEnd: function() {
        n.lineEnd(), e = r = 0 / 0
  ...
  function je(n, t, e, r) {
    var u;
    if (null == n)
      u = e * ja, r.point(-Da, u), r.point(0, u), r.point(Da, u),
      r.point(Da, 0), r.point(Da, -u), r.point(0, -u), r.point(-Da, -u),
      r.point(-Da, 0), r.point(-Da, u);
  ...
  function Fe(n, t) {
    ...
    for (var a = 0, c = t.length; c > a; ++a) {
      ...
      if (s)
        for (var f = l[0], h = f[0], g = f[1] / 2 + Da / 4, p = Math.sin(g),
                 v = Math.cos(g), d = 1;
             ;) {
          d === s && (d = 0), n = l[d];
          var m = n[0], y = n[1] / 2 + Da / 4, M = Math.sin(y), x = Math.cos(y),
              b = m - h, _ = b >= 0 ? 1 : -1, w = _ * b, S = w > Da, k = p * M;
          if (_c.add(Math.atan2(k * _ * Math.sin(w), v * x + k * Math.cos(w))),
              i += S ? b + _ * Pa : b, S ^ h >= e ^ m >= e) {
            var E = de(pe(f), pe(n));
            Me(E);
            var A = de(u, E);
            Me(A);
  ...
  function He(n) {
      ...
      return {
        lineStart: function() {
          ...
          if (!e && (l = c = v) && n.lineStart(),
            ...
            d&i || !(m = r(p, e, !0)) ||
                (s = 0,
                 o ? (n.lineStart(), n.point(m[0][0], m[0][1]),
    ...
    function r(n, t, e) {
      var r = pe(n), u = pe(t), o = [1, 0, 0], a = de(r, u), c = ve(a, a),
          l = a[0], s = c - l * l;
      if (!s) return !e && n;
      var f = i * c / s, h = -i * l / s, g = de(o, a), p = ye(o, f),
          v = ye(a, h);
      me(p, v);
      ...
      if (!(0 > M)) {
        ...
        if (!N && k > E && (_ = k, k = E, E = _),
            C ? N ? k + E > 0 ^ b[1] < (va(b[0] - w) < Ta ? k : E) :
                    k <= b[1] && b[1] <= E :
                A > Da ^ (w <= b[0] && b[0] <= S)) {
          var z = ye(d, (-m + x) / y);
  ...
  function Oe(n, t, e, r) {
    return function(u) {
      var i, o = u.a, a = u.b, c = o.x, l = o.y, s = a.x, f = a.y, h = 0, g = 1,
             p = s - c, v = f - l;
      if (i = n - c, p || !(i > 0)) {
        if (i /= p, 0 > p) {
          if (h > i) return;
        ...
        if (i = e - c, p || !(0 > i)) {
          ...
          if (i = t - l, v || !(i > 0)) {
            ...
            if (i = r - l, v || !(0 > i)) {
              ...
              return h > 0 && (u.a = {x: c + h * p, y: l + h * v}),
  ...
  function Ye(n, t, e, r) {
    ...
    return function(a) {
      ...
      function l(i, a, c, l) {
        var s = 0, f = 0;
        if (null == i || (s = u(i, c)) !== (f = u(a, c)) ||
            o(i, a) < 0 ^ c > 0) {
          do
            l.point(0 === s || 3 === s ? n : e, s > 1 ? r : t);
          while ((s = (s + c + 4) % 4) !== f) } else
          l.point(a[0], a[1])
      }
      function s(u, i) {
      ...
      function p(n, t) {
        ...
        if (d && m.push([n, t]), S)
          ...
          N(r) ? (w || (a.lineStart(), a.point(r.a.x, r.a.y)),
                  a.point(r.b.x, r.b.y), e || a.lineEnd(), k = !1) :
                 e && (a.lineStart(), a.point(n, t), k = !1)
        }
        b = n, _ = t, w = e
      }
      var v, d, m, y, M, x, b, _, w, S, k,
          E = a, A = Re(), N = Oe(n, t, e, r), C = {
            point: f,
            lineStart: h,
            lineEnd: g,
            polygonStart: function() {
  ...
  function Ie(n) {
    ...
    return u.parallels = function(n) {
      return arguments.length ? r(t = n[0] * Da / 180, e = n[1] * Da / 180) :
                                [180 * (t / Da), 180 * (e / Da)]
    }, u
  }
  function Ze(n, t) {
  ...
  function Ke() {
    function n(n, t) {
      ...
      Cc += o * (r + n) / 2, zc += o * (u + t) / 2, qc += o,
          o = u * n - r * t, Lc += o * (r + n), Tc += o * (u + t), Rc += 3 * o,
          We(r = n, u = t)
    }
    var t, e, r, u;
  ...
  function nr(n) {
    ...
    function r(t) {
      ...
      function i(e, r) {
        ...
        u(M, x, y, b, _, w, M = o[0], x = o[1], y = e, b = i[0], _ = i[1],
          w = i[2], a, t),
            t.point(M, x)
      }
      function o() {
    ...
    function u(t, e, r, a, c, l, s, f, h, g, p, v, d, m) {
      ...
      if (x > 4 * i && d--) {
        var b = a + g, _ = c + p, w = l + v,
            S = Math.sqrt(b * b + _ * _ + w * w), k = Math.asin(w /= S),
            E = va(va(w) - 1) < Ta || va(r - h) < Ta ? (r + h) / 2 :
                                                       Math.atan2(_, b),
            A = n(E, k), N = A[0], C = A[1], z = N - t, q = C - e,
            L = M * z - y * q;
        (L * L / x > i || va((y * z + M * q) / x - .5) > .3 ||
         o > a * g + c * p + l * v) &&
  ...
  function ir(n) {
    ...
    var i, o, a, c, l, s, f = nr(function(n, t) {
                          ...
                          h = 150, g = 480, p = 250, v = 0, d = 0, m = 0, y = 0,
                          M = 0, x = Pc, b = Et, _ = null, w = null;
    return t.stream = function(n) {
      ...
      return arguments.length ?
          (w = n, b = n ? Ye(n[0][0], n[0][1], n[1][0], n[1][1]) : Et, u()) :
          w
    }, t.scale = function(n) {
      ...
      return arguments.length ? (m = n[0] % 360 * Fa, y = n[1] % 360 * Fa,
                                 M = n.length > 2 ? n[2] % 360 * Fa : 0, r()) :
                                [m * Ha, y * Ha, M * Ha]
  ...
  function Mr(n, t, e, r) {
    var u = Math.cos(t), i = Math.sin(t), o = Math.cos(r), a = Math.sin(r),
        c = u * Math.cos(n), l = u * Math.sin(n), s = o * Math.cos(e),
        f = o * Math.sin(e),
        h = 2 * Math.asin(Math.sqrt(ut(r - t) + u * o * ut(e - n))),
        g = 1 / Math.sin(h), p = h ? function(n) {
          var t = Math.sin(n *= h) * g, e = Math.sin(h - n) * g,
              r = e * c + t * s, u = e * l + t * f, o = e * i + t * a;
          return [
            Math.atan2(u, r) * Ha, Math.atan2(o, Math.sqrt(r * r + u * u)) * Ha
          ]
        } : function() {
          return [n * Ha, t * Ha]
        };
  ...
  function xr() {
    function n(n, u) {
      var i = Math.sin(u *= Fa), o = Math.cos(u), a = va((n *= Fa) - t),
          c = Math.cos(a);
      $c += Math.atan2(
  ...
  function Lr(n, t, e, r) {
    var u = n[0], i = e[0], o = t[0] - u, a = r[0] - i, c = n[1], l = e[1],
        s = t[1] - c, f = r[1] - l,
  ...
  function Ur(n) {
    var t = n.circle, e = t.x, r = t.cy, u = {x: e, y: r}, i = n.P, o = n.N,
        a = [n];
    Pr(n);
    for (var c = i;
  ...
  function jr(n) {
    ...
    if (rl.insert(t, c), t || e) {
      if (t === e)
        return Xr(t), e = Dr(t.site), rl.insert(c, e),
                      c.edge = e.edge = Jr(t.site, c.site), Vr(t), Vr(e),
                      void 0;
      if (!e) return c.edge = Jr(t.site, c.site), void 0;
      Xr(t), Xr(e);
      var l = t.site, s = l.x, f = l.y, h = n.x - s, g = n.y - f, p = e.site,
          v = p.x - s, d = p.y - f, m = 2 * (h * d - g * v), y = h * h + g * g,
          M = v * v + d * d,
          x = {x: (d * y - g * M) / m + s, y: (h * M - v * y) / m + f};
      Kr(e.edge, l, p, x), c.edge = Jr(l, n, null, x),
                           e.edge = Jr(n, p, null, x), Vr(t), Vr(e)
    }
  }
  function Fr(n, t) {
  ...
  function Yr(n) {
    for (var t, e, r, u, i, o, a, c, l, s, f = n[0][0], h = n[1][0],
                                           g = n[0][1], p = n[1][1], v = el,
                                           d = v.length;
         d--;)
      if (i = v[d], i && i.prepare())
        for (a = i.edges, c = a.length, o = 0; c > o;)
          s = a[o].end(), r = s.x, u = s.y, l = a[++o % c].start(), t = l.x,
          e = l.y,
          (va(r - t) > Ta || va(u - e) > Ta) &&
              (a.splice(
                   o, 0,
  ...
  function Vr(n) {
    ...
    if (t && e) {
      ...
      if (r !== i) {
        var o = u.x, a = u.y, c = r.x - o, l = r.y - a, s = i.x - o,
            f = i.y - a, h = 2 * (c * f - l * s);
        if (!(h >= -Ra)) {
          var g = c * c + l * l, p = s * s + f * f, v = (f * g - l * p) / h,
              d = (c * p - s * g) / h, f = d + a, m = al.pop() || new Zr;
          m.arc = n, m.site = u, m.x = v + o,
  ...
  function $r(n) {
    for (var t, e = tl, r = Oe(n[0][0], n[0][1], n[1][0], n[1][1]),
                u = e.length;
         u--;)
      t = e[u],
      (!Br(t, n) || !r(t) ||
  ...
  function Br(n, t) {
    var e = n.b;
    if (e) return !0;
    var r, u, i = n.a, o = t[0][0], a = t[1][0], c = t[0][1], l = t[1][1],
  ...
  function Jr(n, t, e, r) {
    var u = new Wr(n, t);
    return tl.push(u), e && Kr(u, n, t, e), r && Kr(u, t, n, r),
           el[n.i].edges.push(new Qr(u, n, t)),
           el[t.i].edges.push(new Qr(u, t, n)), u
  }
  function Gr(n, t, e) {
    var r = new Wr(n, null);
  ...
  function fu(n, t, e, r, u, i) {
    if (!n(t, e, r, u, i)) {
      ...
      c[0] && fu(n, c[0], e, r, o, a), c[1] && fu(n, c[1], o, r, u, a),
          c[2] && fu(n, c[2], e, a, o, i), c[3] && fu(n, c[3], o, a, u, i)
    }
  }
  ...
  function gu(n, t) {
    ...
    return function(n) {
      return '#' + Mt(Math.round(e + i * n)) + Mt(Math.round(r + o * n)) +
          Mt(Math.round(u + a * n))
    }
  }
  function pu(n, t) {
  ...
  function mu(n, t) {
    for (var e, r = ta.interpolators.length;
         --r >= 0 && !(e = ta.interpolators[r](n, t));)
      ;
    return e
  }
  function yu(n, t) {
    var e, r = [], u = [], i = n.length, o = t.length,
  ...
  function Cu(n, t) {
    ...
    return arguments.length < 2 && (t = .45),
           arguments.length ?
               ...
               function(r) {
                 return 1 +
                     n * Math.pow(2, -10 * r) * Math.sin((r - e) * Pa / t)
               }
  }
  function zu(n) {
  ...
  function Pu(n) {
    var t = [n.a, n.b], e = [n.c, n.d], r = ju(t), u = Uu(t, e),
        i = ju(Fu(e, t, -u)) || 0;
  ...
  function Hu(n, t) {
    var e, r = [], u = [], i = ta.transform(n), o = ta.transform(t),
           a = i.translate, c = o.translate, l = i.rotate, s = o.rotate,
           f = i.skew, h = o.skew, g = i.scale, p = o.scale;
    return a[0] != c[0] || a[1] != c[1] ?
               (r.push('translate(', null, ',', null, ')'),
                u.push({i: 1, x: vu(a[0], c[0])}, {i: 3, x: vu(a[1], c[1])})) :
               c[0] || c[1] ? r.push('translate(' + c + ')') : r.push(''),
           l != s ?
               (l - s > 180 ? s += 360 : s - l > 180 && (l += 360), u.push({
  ...
  function Ju(n, t, e) {
    ...
    if (n.charge = 0, !n.leaf)
      for (var i, o = n.nodes, a = o.length, c = -1; ++c < a;)
        i = o[c],
        null != i &&
            (Ju(i, t, e), n.charge += i.charge, r += i.charge * i.cx,
             u += i.charge * i.cy);
    if (n.point) {
      n.leaf ||
  ...
  function Gu(n, t) {
    return ta.rebind(n, t, 'sort', 'children', 'value'), n.nodes = n,
                                                         n.links = ri, n
  }
  function Ku(n, t) {
  ...
  function Mi(n) {
    ...
    if ((e = n.children) && (l = e.length)) {
      ...
      if (e.forEach(xi), r = e[0], r.x = -r.r, r.y = 0, t(r),
          l > 1 && (u = e[1], u.x = u.r, u.y = 0, t(u), l > 2))
        for (i = e[2], wi(r, u, i), t(i), di(r, i), r._pack_prev = i, di(i, u),
            u = r._pack_next, o = 3;
             l > o; o++) {
          wi(r, u, i = e[o]);
          var p = 0, v = 1, d = 1;
          ...
          if (1 == p)
            for (c = r._pack_prev; c !== a._pack_prev && !yi(c, i);
                 c = c._pack_prev, d++)
              ;
    ...
    if (e) {
      ...
      if (u.shift(), 's' === u[8]) {
        ...
        return u[7] || (u[7] = '.' + Bi(i.scale(r[2]))),
               u[8] = 'f', e = ta.format(u.join('')), function(n) {
  ...
  function Ji(n, t, e, r) {
    ...
    return o.invert = function(t) {
      ...
      var n = Pi(r), o = [], a = n[0], c = n[1], l = Math.floor(u(a)),
          s = Math.ceil(u(c)), f = t % 1 ? 2 : t;
      if (isFinite(s - l)) {
        if (e) {
          for (; s > l; l++)
  ...
  function Qi(n, t) {
    ...
    return e.domain = function(r) {
      ...
      return i = r(s + Math.round((f - s - (n.length - a) * h) / 2), h),
             l && i.reverse(), o = Math.round(h * (1 - a)),
  ...
  function fo(n, t, e, r, u) {
    var i = n[0] - t[0], o = n[1] - t[1],
        a = (u ? r : -r) / Math.sqrt(i * i + o * o), c = a * o, l = -a * i,
        s = n[0] + c, f = n[1] + l, h = t[0] + c, g = t[1] + l, p = (s + h) / 2,
        v = (f + g) / 2, d = h - s, m = g - f, y = d * d + m * m, M = e - r,
        x = s * g - h * f, b = (0 > m ? -1 : 1) * Math.sqrt(M * M * y - x * x),
        _ = (x * m - d * b) / y, w = (-x * d - m * b) / y,
        S = (x * m + d * b) / y, k = (-x * d + m * b) / y, E = _ - p, A = w - v,
        N = S - p, C = k - v;
  ...
  function ho(n) {
    function t(t) {
      ...
      for (var c, l = [], s = [], f = -1, h = t.length, g = kt(e), p = kt(r);
           ++f < h;)
        u.call(this, c = t[f], f) ?
    ...
    return t.x = function(n) {
      ...
      return arguments.length ?
          (o = 'function' == typeof n ? i = n : (i = zl.get(n) || go).key, t) :
          o
  ...
  function _o(n, t) {
    if (t.length < 1 || n.length != t.length && n.length != t.length + 2)
      return go(n);
    var e = n.length != t.length, r = '', u = n[0], i = n[1], o = t[0], a = o,
        c = 1;
    if (e &&
  ...
  function wo(n, t) {
    for (var e, r = [], u = (1 - t) / 2, i = n[0], o = n[1], a = 1,
                c = n.length;
         ++a < c;)
  ...
  function Eo(n) {
    ...
    for (t = [No(Tl, o), ',', No(Tl, a)], --r; ++r < i;)
      e = n[r % u], o.shift(), o.push(e[0]), a.shift(), a.push(e[1]),
      Co(t, o, a);
    return t.join('')
  }
  function Ao(n, t) {
    var e = n.length - 1;
    if (e)
      for (var r, u, i = n[0][0], o = n[0][1], a = n[e][0] - i, c = n[e][1] - o,
                     l = -1;
           ++l <= e;)
        r = n[l], u = l / e, r[0] = t * r[0] + (1 - t) * (i + u * a),
        r[1] = t * r[1] + (1 - t) * (o + u * c);
    return So(n)
  }
  function No(n, t) {
  ...
  function Co(n, t, e) {
    n.push(
        'C', No(ql, t), ',', No(ql, e), ',', No(Ll, t), ',', No(Ll, e), ',',
        No(Tl, t), ',', No(Tl, e))
  }
  function zo(n, t) {
  ...
  function Lo(n) {
    ...
    for (a = -1; ++a <= c;)
      u = (n[Math.min(c, a + 1)][0] - n[Math.max(0, a - 1)][0]) /
          (6 * (1 + o[a] * o[a])),
      i.push([u || 0, o[a] * u || 0]);
    return i
  }
  ...
  function Ro(n) {
    for (var t, e, r, u = -1, i = n.length; ++u < i;)
      t = n[u], e = t[0], r = t[1] - ja, t[0] = e * Math.cos(r),
      t[1] = e * Math.sin(r);
    return n
  }
  function Do(n) {
    function t(t) {
      ...
      for (var h, g, p, v = [], d = [], m = [], y = -1, M = t.length, x = kt(e),
                        b = kt(u),
                        _ = e === r ?
               function() {
                 return g
    ...
    var e = Ar, r = Ar, u = 0, i = Nr, o = Ne, a = go, c = a.key, l = a,
        s = 'L', f = .7;
    return t.x = function(n) {
      ...
      return arguments.length ?
          (c = 'function' == typeof n ? a = n : (a = zl.get(n) || go).key,
           l = a.reverse || a, s = a.closed ? 'M' : 'L', t) :
          c
    }, t.tension = function(n) {
  ...
  function Yo(n) {
    return function() {
      var t, e;
      (t = this[n]) && (e = t[t.active]) &&
          (--t.count ? (delete t[t.active], t.active += .5) : delete this[n],
    ...
    if (!o) {
      ...
      u = null, ++i.count, ta.timer(function(u) {
        function a(e) {
          ...
          var u = i[i.active];
          u &&
              (--i.count, delete i[i.active],
               u.event && u.event.interrupt.call(n, n.__data__, u.index)),
              i.active = r, o.event && o.event.start.call(n, n.__data__, t),
  ...
  function Go(n, t, e) {
    ...
    function u(n, e) {
      ...
      return i == Wl.length ?
          ...
          i ? t[u / Wl[i - 1] < Wl[i] / u ? i - 1 : i] : [Kl, Vi(n, e)[2]]
    }
    return r.invert = function(t) {
      ...
      var e = Pi(r.domain()),
          i = null == n ?
          u(e, 10) :
          'number' == typeof n ? u(e, n) : !n.range && [{range: n}, t];
  ...
  try {
    ...
    var la = oa.Element.prototype, sa = la.setAttribute, fa = la.setAttributeNS,
        ha = oa.CSSStyleDeclaration.prototype, ga = ha.setProperty;
  ...
  var pa = r(n);
  ta.bisectLeft = pa.left, ta.bisect = ta.bisectRight = pa.right,
  ta.bisector = function(t) {
    ...
    for (var r, u, i = e - t; i;)
      u = 0 | Math.random() * i--, r = n[i + t], n[i + t] = n[u + t],
      n[u + t] = r;
    return n
    ...
    forEach: function(n) {
      ...
      ta.nest =
        ...
        function n(t, o, c) {
          ...
          for (var l, s, f, h, g = -1, p = o.length, v = i[c++], d = new a;
               ++g < p;)
  ...
  ka.attr = function(n, t) {
    ...
    function e(n, e) {
      var r, u, i, o = n.length, f = e.length, h = Math.min(o, f),
                   g = new Array(f), p = new Array(f), v = new Array(o);
      if (t) {
  ...
  var Aa = [];
  ta.selection.enter = O, ta.selection.enter.prototype = Aa,
  Aa.append = ka.append, Aa.empty = ka.empty, Aa.node = ka.node,
  Aa.call = ka.call, Aa.size = ka.size, Aa.select = function(n) {
  ...
  ta.touch = function(n, t, e) {
    ...
    function t(n, t, u, i, o) {
      return function() {
        ...
        function c() {
          t(h, v) &&
              (m.on(i + d, null).on(o + d, null), y(p && ta.event.target === f),
               g({type: 'dragend'}))
        }
        var l, s = this, f = ta.event.target, h = s.parentNode,
               g = e.of(s, arguments), p = 0, v = n(),
               d = '.drag' + (null == v ? '' : '-' + v),
               m = ta.select(u()).on(i + d, a).on(o + d, c), y = X(),
               M = t(h, v);
        r ? (l = r.apply(s, arguments), l = [l.x - M[0], l.y - M[1]]) :
            l = [0, 0],
            g({type: 'dragstart'})
      }
    }
    var e = w(n, 'drag', 'dragstart', 'dragend'), r = null,
  ...
  var Ta = 1e-6, Ra = Ta * Ta, Da = Math.PI, Pa = 2 * Da, Ua = Pa - Ta,
      ja = Da / 2, Fa = Da / 180, Ha = 180 / Da, Oa = Math.SQRT2, Ya = 2,
      Ia = 4;
  ta.interpolateZoom = function(n, t) {
    ...
    var r = n[0], u = n[1], i = n[2], o = t[0], a = t[1], c = t[2], l = o - r,
        s = a - u, f = l * l + s * s, h = Math.sqrt(f),
        g = (c * c - i * i + Ia * f) / (2 * i * Ya * h),
        p = (c * c - i * i - Ia * f) / (2 * c * Ya * h),
        v = Math.log(Math.sqrt(g * g + 1) - g),
        d = Math.log(Math.sqrt(p * p + 1) - p), m = d - v,
        y = (m || Math.log(c / i)) / Oa;
    ...
    function i(t, e, i, o) {
      t.__chart__ = {x: k.x, y: k.y, k: k.k}, r(Math.pow(2, o)), u(v = e, i),
      t = ta.select(t), N > 0 && (t = t.transition().duration(N)),
      t.call(n.event)
    }
    function o() {
      x &&
    ...
    function s() {
      ...
      var r = this, i = ta.event.target, o = R.of(r, arguments), s = 0,
          f = ta.select(oa).on(q, n).on(L, e), h = t(ta.mouse(r)), g = X();
      Fl.call(r), a(o)
    }
    function f() {
      function n() {
      ...
      var g, p = this, v = R.of(p, arguments), d = {}, m = 0,
             M = '.zoom-' + ta.event.changedTouches[0].identifier,
             x = 'touchmove' + M, _ = 'touchend' + M, w = [], S = ta.select(p),
             E = X();
    ...
    var p, v, d, m, y, M, x, _, S,
        k = {x: 0, y: 0, k: 1}, E = [960, 500], A = Va, N = 250, C = 0,
        z = 'mousedown.zoom', q = 'mousemove.zoom', L = 'mouseup.zoom',
        T = 'touchstart.zoom', R = w(n, 'zoomstart', 'zoom', 'zoomend');
    return n.event = function(n) {
      ...
      return arguments.length ? (k = {x: +t[0], y: +t[1], k: k.k}, o(), n) :
                                [k.x, k.y]
    }, n.scale = function(t) {
  ...
  Ba.brighter = function(n) {
    return new ct(
        this.h, this.c, Math.min(100, this.l + Wa * (arguments.length ? n : 1)))
  }, Ba.darker = function(n) {
    return new ct(
        this.h, this.c, Math.max(0, this.l - Wa * (arguments.length ? n : 1)))
  }, Ba.rgb = function() {
  ...
  Qa.brighter = function(n) {
    return new st(
        Math.min(100, this.l + Wa * (arguments.length ? n : 1)), this.a, this.b)
  }, Qa.darker = function(n) {
    return new st(
        Math.max(0, this.l - Wa * (arguments.length ? n : 1)), this.a, this.b)
  }, Qa.rgb = function() {
  ...
  fc.days = fc.day.range, fc.days.utc = fc.day.utc.range,
  fc.dayOfYear =
      function(n) {
    var t = fc.year(n);
    return Math.floor(
  ...
  fc.week = fc.sunday, fc.weeks = fc.sunday.range,
  fc.weeks.utc = fc.sunday.utc.range, fc.weekOfYear = fc.sundayOfYear;
  var pc = {'-': '', _: ' ', 0: '0'}, vc = /^\s*\d+/, dc = /^%/;
  ta.locale = function(n) {
    return {
      numberFormat: Pt(n), timeFormat: Ot(n)
    }
  };
  var mc = ta.locale({
    decimal: '.',
  ...
  ta.format = mc.numberFormat, ta.geo = {}, ce.prototype = {
    ...
    t: 0,
    add: function(n) {
      le(n, this.t, yc), le(yc.s, this.s, this),
  ...
  ta.geo.bounds = function() {
    ...
    function o() {
      u(v, d), wc.lineEnd(), va(y) > Ta && (s = -(h = 180)), x[0] = s, x[1] = h,
                                                             m = null
    }
    function a(n, t) {
    ...
    var s, f, h, g, p, v, d, m, y, M, x, b = {
      ...
      polygonEnd: function() {
        wc.polygonEnd(), b.point = n, b.lineStart = e, b.lineEnd = r,
                         0 > _c ? (s = -(h = 180), f = -(g = 90)) :
                                  y > Ta ? g = 90 : -Ta > y && (f = -90),
                         x[0] = s, x[1] = h
      }
      ...
      if (t) {
        ...
        for (var e, r = 1, u = M[0], i = [u]; t > r; ++r)
          ...
          l(e[0], u) || l(e[1], u) ?
              ...
              i.push(u = e);
        for (var o, e, p = -1 / 0, t = i.length - 1, r = 0, u = i[t]; t >= r;
             u = e, ++r)
          e = i[r], (o = a(u[1], e[0])) > p && (p = o, s = e[0], h = u[1])
      }
      return M = x = null,
             1 / 0 === s || 1 / 0 === f ? [[0 / 0, 0 / 0], [0 / 0, 0 / 0]] :
                                          [[s, f], [h, g]]
    }
    ...
    return Ra > u &&
            (t = Cc, e = zc, r = qc, Ta > kc && (t = Ec, e = Ac, r = Nc),
             u = t * t + e * e + r * r, Ra > u) ?
        [0 / 0, 0 / 0] :
  ...
  ta.geo.clipExtent = function() {
    var n, t, e, r, u, i, o = {
      ...
      extent: function(a) {
        return arguments.length ?
            (i = Ye(n = +a[0][0], t = +a[0][1], e = +a[1][0], r = +a[1][1]),
             u && (u.valid = !1, u = null), o) :
            [[n, t], [e, r]]
      }
    };
    ...
    var t, e, r, u, i = ta.geo.albers(),
                    o = ta.geo.conicEqualArea()
                            .rotate([154, 0])
                            .center([-2, 58.5])
                            .parallels([55, 65]),
                    a = ta.geo.conicEqualArea()
                            .rotate([157, 0])
                            .center([-3, 19.9])
                            .parallels([8, 18]),
                    c = {
    ...
    return n.invert = function(n) {
      ...
      return arguments.length ? (i.scale(t), o.scale(.35 * t), a.scale(t),
  ...
  var jc, Fc, Hc, Oc, Yc, Ic,
      ...
      Vc =
          {point: Xe, lineStart: y, lineEnd: y, polygonStart: y, polygonEnd: y},
      Xc = {
        point: We,
        lineStart: Je,
        lineEnd: Ge,
    ...
    function n(n) {
      return n &&
                 ('function' == typeof a &&
                  ...
                  o && o.valid || (o = u(i)), ta.geo.stream(n, o)),
             i.result()
    }
    function t() {
      return o = null, n
    ...
    return n.area = function(n) {
      ...
      return arguments.length ?
          (i = null == (r = n) ? new $e : new Qe(n),
           'function' != typeof a && i.pointRadius(a), t()) :
          r
  ...
  ta.geo.projection = ur, ta.geo.projectionMutator = ir,
  (ta.geo.equirectangular = function() {
    ...
    return n = lr(n[0] % 360 * Fa, n[1] * Fa, n.length > 2 ? n[2] * Fa : 0),
           t.invert = function(t) {
             return t = n.invert(t[0] * Fa, t[1] * Fa), t[0] *= Ha, t[1] *= Ha,
                    t
           }, t
  }, cr.invert = ar, ta.geo.circle = function() {
    function n() {
      var n = 'function' == typeof r ? r.apply(this, arguments) : r,
          t = lr(-n[0] * Fa, -n[1] * Fa, 0).invert, u = [];
    ...
    var e, r = (t[0] - n[0]) * Fa, u = n[1] * Fa, i = t[1] * Fa,
           o = Math.sin(r), a = Math.cos(r), c = Math.sin(u), l = Math.cos(u),
    ...
    function t() {
      return ta.range(Math.ceil(i / d) * d, u, d)
          .map(h)
          .concat(ta.range(Math.ceil(l / m) * m, c, m).map(g))
          .concat(ta.range(Math.ceil(r / p) * p, e, p)
                      .filter(function(n) {
                        return va(n % d) > Ta
                      })
                      .map(s))
          .concat(ta.range(Math.ceil(a / v) * v, o, v)
                      .filter(function(n) {
                        return va(n % m) > Ta
                      })
                      .map(f))
    }
    var e, r, u, i, o, a, c, l, s, f, h, g, p = 10, v = p, d = 90, m = 360,
                                            y = 2.5;
    return n.lines =
               function() {
        ...
        return {
          type: 'LineString', coordinates: n
           ...
           n.outline =
             ...
             return {
               type: 'Polygon', coordinates: [h(i).concat(
                                    g(c).slice(1), h(u).reverse().slice(1),
                                    g(l).reverse().slice(1))]
             }
           },
           n.extent =
           ...
           n.majorExtent =
               function(t) {
             return arguments.length ?
                 (i = +t[0][0], u = +t[1][0], l = +t[0][1], c = +t[1][1],
                  i > u && (t = i, i = u, u = t),
           ...
           n.minorExtent =
               function(t) {
             return arguments.length ?
                 (r = +t[0][0], e = +t[1][0], a = +t[0][1], o = +t[1][1],
                  r > e && (t = r, r = e, e = t),
           ...
           n.precision =
               function(t) {
             return arguments.length ?
                 (y = +t, s = vr(a, o, 90), f = dr(r, e, y), h = vr(l, c, 90),
                  g = dr(i, u, y), n) :
                 y
           },
           n.majorExtent([[-180, -90 + Ta], [180, 90 - Ta]]).minorExtent([
             [-180, -80 - Ta], [180, 80 + Ta]
           ])
  ...
  (ta.geo.stereographic = function() {
    ...
    function t(n) {
      ...
      var l = Cr(a), s = Cr(c), f = s[0] === l[0],
          h = s[s.length - 1] === l[l.length - 1], g = [];
  ...
  nl.area = function() {
    ...
    for (arguments.length || (n = -1 / (6 * this.area())); ++r < u;)
      t = a, a = this[r], e = t[0] * a[1] - a[0] * t[1], i += (t[0] + a[0]) * e,
      o += (t[1] + a[1]) * e;
    return [i * n, o * n]
  }, nl.clip = function(n) {
    for (var t, e, r, u, i, o, a = Tr(n), c = -1, l = this.length - Tr(this),
                               s = this[l - 1];
         ++c < l;) {
      for (t = n.slice(), n.length = 0, u = this[c],
          i = t[(r = t.length - a) - 1], e = -1;
           ++e < r;)
        o = t[e],
        qr(o, s, u) ? (qr(i, s, u) || n.push(Lr(i, o, s, u)), n.push(o)) :
  ...
  nu.prototype = {
    insert: function(n, t) {
      ...
      if (n) {
        ...
        this._ ? (n = uu(this._), t.P = null, t.N = n, n.P = n.L = t, e = n) :
        ...
        e === r.L ? (u = r.R,
                     u && u.C ? (e.C = u.C = !1, r.C = !0, n = r) :
                                (n === e.R && (eu(this, e), n = e, e = n.U),
                                 e.C = !1, r.C = !0, ru(this, r))) :
                    (u = r.L,
                     u && u.C ? (e.C = u.C = !1, r.C = !0, n = r) :
                                (n === e.L && (ru(this, e), n = e, e = n.U),
                                 e.C = !1, r.C = !0, eu(this, r))),
        e = n.U;
      this._.C = !1
    },
    remove: function(n) {
      ...
      if (e = i ? o ? uu(o) : i : o,
          ...
          i && o ? (r = e.C, e.C = n.C, e.L = i, i.U = e,
                    e !== o ? (u = e.U, e.U = n.U, n = e.R, u.L = n, e.R = o,
                               o.U = e) :
                              (e.U = u, u = e, n = e.R)) :
                   (r = n.C, n = e),
          n && (n.U = u), !r) {
        ...
        do {
          if (n === this._) break;
          if (n === u.L) {
            if (t = u.R, t.C && (t.C = !1, u.C = !0, eu(this, u), t = u.R),
                t.L && t.L.C || t.R && t.R.C) {
              t.R && t.R.C || (t.L.C = !1, t.C = !0, ru(this, t), t = u.R),
                  t.C = u.C, u.C = t.R.C = !1, eu(this, u), n = this._;
              break
            }
          } else if (
              t = u.L, t.C && (t.C = !1, u.C = !0, ru(this, u), t = u.L),
              t.L && t.L.C || t.R && t.R.C) {
            t.L && t.L.C || (t.R.C = !1, t.C = !0, eu(this, t), t = u.L),
                t.C = u.C, u.C = t.L.C = !1, ru(this, u), n = this._;
            break
          }
          t.C = !0, n = u, u = u.U
        } while (!n.C);
  ...
  ta.geom.voronoi = function(n) {
    function t(n) {
      var t = new Array(n.length), r = a[0][0], u = a[0][1], i = a[1][0],
          o = a[1][1];
      return iu(e(n), a).cells.forEach(function(e, a) {
        var c = e.edges, l = e.site,
    ...
    function e(n) {
      return n.map(function(n, t) {
        return {
          x: Math.round(i(n, t) / Ta) * Ta, y: Math.round(o(n, t) / Ta) * Ta,
              i: t
        }
      })
    }
    ...
    return n ? t(n) :
               (t.links =
                ...
                t.triangles =
                    function(n) {
                      ...
                      return iu(e(n)).cells.forEach(function(e, r) {
                        for (var u, i, o = e.site, a = e.edges.sort(Ir), c = -1,
                                       l = a.length, s = a[l - 1].edge,
                                       f = s.l === o ? s.r : s.l;
                             ++c < l;)
                          u = s, i = f, s = a[c].edge,
                          f = s.l === o ? s.r : s.l,
                          r < i.i && r < f.i && au(o, i, f) < 0 &&
                ...
                t.clipExtent =
                    function(n) {
                      return arguments.length ? (a = null == n ? cl : n, t) :
                                                a === cl ? null : a
                    },
                t.size =
                    function(n) {
  ...
  ta.geom.quadtree =
    ...
    function i(n) {
          ...
          if (n.leaf) {
            ...
            if (null != c)
              if (va(c - e) + va(s - r) < .01)
                ...
                var f = n.point;
                n.x = n.y = n.point = null, l(n, f, c, s, u, i, o, a),
                l(n, t, e, r, u, i, o, a)
              }
            else
      ...
      function l(n, t, e, r, u, o, a, c) {
        var l = .5 * (u + a), s = .5 * (o + c), f = e >= l, h = r >= s,
            g = h << 1 | f;
        n.leaf = !1, n = n.nodes[g] || (n.nodes[g] = su()), f ? u = l : a = l,
        h ? o = s : c = s, i(n, t, e, r, u, o, a, c)
      }
  ...
  ta.interpolators = [function(n, t) {
    ...
    return (
        'string' === e ?
            tc.has(t) || /^(#|rgb\(|hsl\()/.test(t) ? gu : du :
            t instanceof it ?
            gu :
            Array.isArray(t) ? yu : 'object' === e && isNaN(t) ? pu : vu)(n, t)
  }],
  ...
  ta.ease =
    ...
    return e = hl.get(e) || fl, r = gl.get(r) || Et,
           Mu(r(e.apply(null, ea.call(arguments, 1))))
  },
  ta.interpolateHcl = Lu, ta.interpolateHsl = Tu, ta.interpolateLab = Ru,
  ta.interpolateRound = Du, ta.transform = function(n) {
  ...
  ta.interpolateTransform = Hu, ta.layout = {}, ta.layout.bundle = function() {
    ...
    var e, r, u, i, o, a = {}, c = ta.dispatch('start', 'tick', 'end'),
                       l = [1, 1], s = .9, f = vl, h = dl, g = -30, p = ml,
                       v = .1, d = .64, m = [], y = [];
    return a.tick = function() {
      if ((r *= .99) < .005) return c.end({type: 'end', alpha: r = 0}), !0;
      var t, e, a, f, h, p, d, M, x, b = m.length, _ = y.length;
      for (e = 0; _ > e; ++e)
        a = y[e], f = a.source, h = a.target, M = h.x - f.x, x = h.y - f.y,
        (p = M * M + x * x) &&
            (p = r * i[e] * ((p = Math.sqrt(p)) - u[e]) / p, M *= p, x *= p,
             h.x -= M * (d = f.weight / (h.weight + f.weight)), h.y -= x * d,
             f.x += M * (d = 1 - d), f.y += x * d);
      ...
      for (t = 0; s > t; ++t)
        r = y[t], 'number' == typeof r.source && (r.source = m[r.source]),
        'number' == typeof r.target && (r.target = m[r.target]),
        ++r.source.weight, ++r.target.weight;
      for (t = 0; c > t; ++t)
        r = m[t], isNaN(r.x) && (r.x = n('x', p)),
      ...
      return e ||
                 (e = ta.behavior.drag()
                          ...
                          .on('drag.force', t)
                          .on('dragend.force', $u)),
             arguments.length ? (this.on('mouseover.force', Bu)
  ...
  var Ml = ta.map({
    'inside-out': function(n) {
      var t, e, r = n.length, u = n.map(li), i = n.map(si),
    ...
    'default': ai
      ...
      xl = ta.map({
        ...
        wiggle: function(n) {
          var t, e, r, u, i, o, a, c, l, s = n.length, f = n[0], h = f.length,
                                         g = [];
          for (g[0] = c = l = 0, e = 1; h > e; ++e) {
            for (t = 0, u = 0; s > t; ++t) u += n[t][e][1];
            for (t = 0, i = 0, a = f[e][0] - f[e - 1][0]; s > t; ++t) {
              for (r = 0, o = (n[t][e][1] - n[t][e - 1][1]) / (2 * a); t > r;
                   ++r)
  ...
  ta.layout
      ...
      function() {
    function n(n, i) {
      for (var o, a, c = [], l = n.map(e, this), s = r.call(this, l, i),
                     f = u.call(this, s, l, i), i = -1, h = l.length,
 ...
 ta.layout.tree =
   ...
   function n(n, u) {
     ...
     if (Qu(h, e), h.parent.m = -h.z, Ku(h, r), l)
       ...
       var d = a(g, p) / 2 - g.x, m = c[0] / (p.x + a(p, g) / 2 + d),
           y = c[1] / (v.depth || 1);
       Ku(f, function(n) {
   ...
   function u(n, t, e) {
     if (t) {
       for (var r, u = n, i = n, o = t, c = u.parent.children[0], l = u.m,
                   s = i.m, f = o.m, h = c.m;
            o = Ei(o), u = ki(u), o && u;)
         c = ki(c), i = Ei(i), i.a = n, r = o.z + f - u.z - l + a(o._, u._),
         r > 0 && (Ai(Ci(o, n, e), n, r), l += r, s += r), f += o.m, l += u.m,
         h += c.m, s += i.m;
   ...
   var o = ta.layout.hierarchy().sort(null).value(null), a = Si, c = [1, 1],
       l = null;
   return n.separation = function(t) {
     return arguments.length ? (a = t, n) : a
   }, n.size = function(t) {
     return arguments.length ? (l = null == (c = t) ? i : null, n) :
                               l ? null : c
   }, n.nodeSize = function(t) {
     return arguments.length ? (l = null == (c = t) ? null : i, n) :
                               l ? c : null
   }, Gu(n, o)
 },
 ta.layout.cluster =
   ...
   var t = ta.layout.hierarchy().sort(null).value(null), e = Si, r = [1, 1],
       u = !1;
   return n.separation = function(t) {
     return arguments.length ? (e = t, n) : e
   }, n.size = function(t) {
 ...
 ta.layout.treemap =
   ...
   function t(e) {
     ...
     if (i && i.length) {
       var o, a, c, l = f(e), s = [], h = i.slice(), p = 1 / 0,
           ...
           l.dx :
           'dice' === g ? l.dy :
                          'slice-dice' === g ? 1 & e.depth ? l.dy : l.dx :
                                               Math.min(l.dx, l.dy);
       for (n(h, l.dx * l.dy / e.value), s.area = 0; (c = h.length) > 0;)
         s.push(o = h[c - 1]), s.area += o.area,
             'squarify' !== g || (a = r(s, v)) <= p ?
             (h.pop(), p = a) :
             (s.area -= s.pop().area, u(s, v, l, !1), v = Math.min(l.dx, l.dy),
   ...
   function i(r) {
     var u = o || a(r), i = u[0];
     return i.x = 0, i.y = 0, i.dx = l[0], i.dy = l[1], o && a.revalue(i),
            n([i], i.dx * i.dy / i.value), (o ? e : t)(i), h && (o = u), u
   }
   var o, a = ta.layout.hierarchy(), c = Math.round, l = [1, 1], s = null,
          f = Ri, h = !1, g = 'squarify', p = .5 * (1 + Math.sqrt(5));
 ...
 ta.scale = {};
  ...
  ta.scale.quantile = function() {
    ...
    function n() {
      var n = Math.max(0, +e.apply(this, arguments)),
          ...
          s = o.apply(this, arguments) - ja, f = a.apply(this, arguments) - ja,
          h = Math.abs(f - s), g = s > f ? 0 : 1;
      if (n > l && (p = l, l = n, n = p), h >= Ua)
        return t(l, g) + (n ? t(n, 1 - g) : '') + 'Z';
      var p, v, d, m, y, M, x, b, _, w, S, k, E = 0, A = 0, N = [];
      if ((m = (+c.apply(this, arguments) || 0) / 2) &&
              (d = i === Cl ? Math.sqrt(n * n + l * l) :
                              +i.apply(this, arguments),
               g || (A *= -1), l && (A = nt(d / l * Math.sin(m))),
               n && (E = nt(d / n * Math.sin(m)))),
          l) {
        y = l * Math.cos(s + A), M = l * Math.sin(s + A),
        x = l * Math.cos(f - A), b = l * Math.sin(f - A);
        ...
        y = M = 0;
      if (n) {
        _ = n * Math.cos(f - E), w = n * Math.sin(f - E),
        S = n * Math.cos(s + E), k = n * Math.sin(s + E);
        ...
        _ = w = 0;
      if ((p = Math.min(Math.abs(l - n) / 2, +u.apply(this, arguments))) >
          .001) {
        v = l > n ^ g ? 0 : 1;
        var T = null == S ?
            [_, w] :
            null == x ? [y, M] : Lr([y, M], [S, k], [x, b], [_, w]),
            R = y - T[0], D = M - T[1], P = x - T[0], U = b - T[1],
            j = 1 /
            Math.sin(
                Math.acos(
                    (R * P + D * U) /
        ...
        if (null != x) {
          ...
          p === H ?
              N.push(
                  'M', O[0], 'A', H, ',', H, ' 0 0,', v, ' ', O[1], 'A', l, ',',
                  l, ' 0 ', 1 - g ^ so(O[1][0], O[1][1], Y[1][0], Y[1][1]), ',',
                  g, ' ', Y[1], 'A', H, ',', H, ' 0 0,', v, ' ', Y[0]) :
        ...
        if (null != S) {
          ...
          p === I ?
              N.push(
                  'L', V[0], 'A', I, ',', I, ' 0 0,', v, ' ', V[1], 'A', n, ',',
                  n, ' 0 ', g ^ so(V[1][0], V[1][1], Z[1][0], Z[1][1]), ',',
                  1 - g, ' ', Z[1], 'A', I, ',', I, ' 0 0,', v, ' ', Z[0]) :
  ...
  var ql = [0, 2 / 3, 1 / 3, 0], Ll = [0, 1 / 3, 2 / 3, 0],
      Tl = [0, 1 / 6, 2 / 3, 1 / 6];
  ta.svg.line.radial = function() {
    ...
    function n(n, a) {
      ...
      return 'M' + c.p0 + r(c.r, c.p1, c.a1 - c.a0) +
          (e(c, l) ? u(c.r, c.p1, c.r, c.p0) :
                     u(c.r, c.p1, l.r, l.p0) + r(l.r, l.p1, l.a1 - l.a0) +
                   u(l.r, l.p1, c.r, c.p0)) +
          'Z'
    }
    function t(n, t, e, r) {
      var u = t.call(n, e, r), i = a.call(n, u, r), o = c.call(n, u, r) - ja,
          s = l.call(n, u, r) - ja;
      return {
        r: i, a0: o, a1: s, p0: [i * Math.cos(o), i * Math.sin(o)],
  ...
  Hl.call = ka.call, Hl.empty = ka.empty, Hl.node = ka.node, Hl.size = ka.size,
  ta.transition = function(n, t) {
    ...
    function r(r, u) {
      var i = t.call(
          this, r, u, oa.getComputedStyle(this, null).getPropertyValue(n));
      return i && function(t) {
    ...
    return arguments.length < 1 ?
        this.node()[e][t].delay :
        H(this, 'function' == typeof n ? function(r, u, i) {
    ...
    if (arguments.length < 2) {
      ...
      H(this, function(u) {
        var i = u[r][e];
        (i.event || (i.event = ta.dispatch('start', 'end', 'interrupt')))
            .on(n, t)
      });
    return this
  }, Hl.transition = function() {
    for (var n, t, e, r, u = this.id, i = ++Ol, o = this.namespace, a = [],
                         c = 0, l = this.length;
         l > c; c++) {
      a.push(n = []);
    ...
    function n(n) {
      n.each(function() {
        var n, l = ta.select(this), s = this.__chart__ || e,
               ...
               y = Math.max(u, 0) + o, M = Ui(f),
               x = l.selectAll('.domain').data([0]),
               b =
                   (x.enter().append('path').attr('class', 'domain'),
                    ta.transition(x));
        v.append('line'), v.append('text');
        var _, w, S, k, E = v.select('line'), A = m.select('line'),
                        N = p.select('text').text(g), C = v.select('text'),
                        z = m.select('text'),
                        q = 'top' === r || 'left' === r ? -1 : 1;
        if ('bottom' === r || 'top' === r ?
                (n = Bo, _ = 'x', S = 'y', w = 'x2', k = 'y2',
                 N.attr('dy', 0 > q ? '0em' : '.71em')
                     .style('text-anchor', 'middle'),
                 b.attr(
                     'd',
                     'M' + M[0] + ',' + q * i + 'V0H' + M[1] + 'V' + q * i)) :
                (n = Wo, _ = 'y', S = 'x', w = 'y2', k = 'x2',
                 N.attr('dy', '.32em')
                     .style('text-anchor', 0 > q ? 'end' : 'start'),
                 b.attr(
                     'd',
                     'M' + q * i + ',' + M[0] + 'H0V' + M[1] + 'H' + q * i)),
            E.attr(k, q * u), C.attr(S, q * y), A.attr(w, 0).attr(k, q * u),
            z.attr(_, 0).attr(S, q * y), f.rangeBand) {
    ...
    var t, e = ta.scale.linear(), r = Yl, u = 6, i = 6, o = 3, a = [10],
           c = null;
  ...
  ta.svg.brush = function() {
    ...
    function u() {
      ...
      function d(n, t, e) {
        var r, u, a = Ui(t), c = a[0], l = a[1], p = z[e], v = e ? f : s,
                  d = v[1] - v[0];
        return N && (c -= p, l -= d + p),
      ...
      var y, M, x = this, _ = ta.select(ta.event.target),
                w = a.of(x, arguments), S = ta.select(x), k = _.datum(),
                E = !/^(n|s)$/.test(k) && c, A = !/^(e|w)$/.test(k) && l,
                N = _.classed('extent'), C = X(), z = ta.mouse(x),
                q = ta.select(oa).on('keydown.brush', u).on('keyup.brush', p);
      if (ta.event.changedTouches ?
              q.on('touchmove.brush', v).on('touchend.brush', m) :
              q.on('mousemove.brush', v).on('mouseup.brush', m),
          S.interrupt().selectAll('*').interrupt(), N)
    ...
    var i, o, a = w(n, 'brushstart', 'brush', 'brushend'), c = null, l = null,
              s = [0, 0], f = [0, 0], h = !0, g = !0, p = Vl[0];
    return n.event = function(n) {
      n.each(function() {
        var n = a.of(this, arguments), t = {x: s, y: f, i: i, j: o},
            e = this.__chart__ || t;
        this.__chart__ = t,
        Ul ? ta.select(this)
                 .transition()
                 ...
                 .each(
                     'end.brush',
                     function() {
                       i = t.i, o = t.j, n({type: 'brush', mode: 'resize'}),
                       n({type: 'brushend'})
                     }) :
      ...
      return arguments.length ?
          (c && l ? (h = !!t[0], g = !!t[1]) : c ? h = !!t : l && (g = !!t),
           n) :
          c && l ? [h, g] : c ? h : l ? g : null
    }, n.extent = function(t) {
      var e, r, u, a, h;
      return arguments.length ?
          (c &&
               (e = t[0], r = t[1], l && (e = e[0], r = r[0]), i = [e, r],
                c.invert && (e = c(e), r = c(r)),
                e > r && (h = e, e = r, r = h),
                (e != s[0] || r != s[1]) && (s = [e, r])),
           l &&
               (u = t[0], a = t[1], c && (u = u[1], a = a[1]), o = [u, a],
  ...
  var Zl = {
    ...
    sw: 'nesw-resize'
      ...
      Xl = fc.format = mc.timeFormat, $l = Xl.utc,
      Bl = $l('%Y-%m-%dT%H:%M:%S.%LZ');
  Xl.iso = Date.prototype.toISOString && +new Date('2000-01-01T00:00:00.000Z') ?
      Jo :
      Bl,
  Jo.parse =
      function(n) {
  ...
  fc.seconds = fc.second.range, fc.seconds.utc = fc.second.utc.range,
  fc.minute = Ft(
      function(n) {
  ...
  fc.minutes = fc.minute.range, fc.minutes.utc = fc.minute.utc.range,
  fc.hour = Ft(
      function(n) {
  ...
  fc.hours = fc.hour.range, fc.hours.utc = fc.hour.utc.range,
  fc.month = Ft(
      function(n) {
  ...
  var Wl =
      ...
      Jl =
          [
            [fc.second, 1], [fc.second, 5], [fc.second, 15], [fc.second, 30],
            [fc.minute, 1], [fc.minute, 5], [fc.minute, 15], [fc.minute, 30],
            [fc.hour, 1], [fc.hour, 3], [fc.hour, 6], [fc.hour, 12],
            [fc.day, 1], [fc.day, 2], [fc.week, 1], [fc.month, 1],
            [fc.month, 3], [fc.year, 1]
          ],
      Gl = Xl.multi([
        [
          '.%L',
