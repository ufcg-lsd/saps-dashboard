!function(a) {
  ...
  function c(b) {
    ...
    c.api = b, c.config = c.getDefaultConfig(), c.data = {}, c.cache = {},
    c.axes = {}
  }
  function d(a, b) {
    function c(a, b) {
    ...
    function i(a) {
      ...
      return a.select('text')
                 .text(h)
                 .each(function(a) {
                   var c = this.getBoundingClientRect(), d = h(a), e = c.height,
    ...
    function j(j) {
      j.each(function() {
        function j(a, c) {
          function d(a, b) {
            ...
            for (var h = 1; h < b.length; h++)
              if (' ' === b.charAt(h) && (f = h), e = b.substr(0, h + 1),
                  g = O.w * e.length, g > c)
                return d(
                    a.concat(b.substr(0, f ? f : h)), b.slice(f ? f + 1 : h));
            return a.concat(b)
          }
          var e, f, g, i = h(a), j = [];
          return '[object Array]' === Object.prototype.toString.call(i) ?
              ...
              ((!c || 0 >= c) &&
                   (c = R ?
                        95 :
                        b.isCategory ? Math.ceil(z(A[1]) - z(A[0])) - 12 : 110),
               d(j, i + ''))
        }
        function l(a, b) {
          var c = O.h;
        ...
        var u, v, w, x = a.select(this), y = this.__chart__ || o,
                     z = this.__chart__ = g(), A = s ? s : f(z),
        ...
        var I = C.select('line'), J = E.select('line'), K = C.select('text'),
            L = E.select('text');
        b.isCategory ?
            (t = Math.ceil((z(1) - z(0)) / 2), v = n ? 0 : t, w = n ? t : 0) :
            t = v = 0;
        var M, N, O = i(x.select('.tick')), P = [], Q = Math.max(q, 0) + r,
                  R = 'left' === p || 'right' === p;
        switch (
            M = B.select('text'), N = M.selectAll('tspan').data(function(a, c) {
            ...
            p) {
          case 'bottom':
            u = c, I.attr('y2', q), K.attr('y', Q),
            J.attr('x1', v).attr('x2', v).attr('y2', m),
            L.attr('x', 0).attr('y', Q), M.style('text-anchor', 'middle'),
            N.attr('x', 0).attr('dy', l),
            H.attr('d', 'M' + F[0] + ',' + k + 'V0H' + F[1] + 'V' + k);
            break;
          case 'top':
            u = c, I.attr('y2', -q), K.attr('y', -Q),
            J.attr('x2', 0).attr('y2', -q), L.attr('x', 0).attr('y', -Q),
            M.style('text-anchor', 'middle'), N.attr('x', 0).attr('dy', '0em'),
            H.attr('d', 'M' + F[0] + ',' + -k + 'V0H' + F[1] + 'V' + -k);
            break;
          case 'left':
            u = d, I.attr('x2', -q), K.attr('x', -Q),
            J.attr('x2', -q).attr('y1', w).attr('y2', w),
            L.attr('x', -Q).attr('y', t), M.style('text-anchor', 'end'),
            N.attr('x', -Q).attr('dy', l),
            H.attr('d', 'M' + -k + ',' + F[0] + 'H0V' + F[1] + 'H' + -k);
            break;
          case 'right':
            u = d, I.attr('x2', q), K.attr('x', Q),
            J.attr('x2', q).attr('y2', 0), L.attr('x', Q).attr('y', 0),
            M.style('text-anchor', 'start'), N.attr('x', Q).attr('dy', l),
            H.attr('d', 'M' + k + ',' + F[0] + 'H0V' + F[1] + 'H' + k)
        }
        if (z.rangeBand) {
          ...
          y.rangeBand ? y = z : D.call(u, z);
        C.call(u, y), E.call(u, z)
      })
    }
    var k, l, m, n, o = a.scale.linear(), p = 'bottom', q = 6, r = 3, s = null,
                    t = 0, u = !0;
    return b = b || {}, k = b.withOuterTick ? 6 : 0, j.scale = function(a) {
      return arguments.length ? (o = a, j) : o
    }, j.orient = function(a) {
      return arguments.length ?
          (p = a in {top: 1, right: 1, bottom: 1, left: 1} ? a + '' : 'bottom',
           j) :
          p
  ...
  g.chart = {fn: b.prototype, internal: {fn: c.prototype}}, e = g.chart.fn,
  f = g.chart.internal.fn, f.init = function() {
    var a = this, b = a.config;
    if (a.initParams(), b.data_url)
      a.convertUrlToData(
          b.data_url, b.data_mimeType, b.data_keys, a.initWithData);
    else if (b.data_json)
    ...
    a.dragStart = null, a.dragging = !1, a.flowing = !1, a.cancelClick = !1,
    a.mouseover = !1, a.transiting = !1, a.color = a.generateColor(),
    ...
    a.defocusedTargetIds = [], a.xOrient = c.axis_rotated ? 'left' : 'bottom',
    a.yOrient = c.axis_rotated ? c.axis_y_inner ? 'top' : 'bottom' :
                                 c.axis_y_inner ? 'right' : 'left',
    a.y2Orient = c.axis_rotated ? c.axis_y2_inner ? 'bottom' : 'top' :
                                  c.axis_y2_inner ? 'left' : 'right',
    a.subXOrient = c.axis_rotated ? 'left' : 'bottom',
    a.isLegendRight = 'right' === c.legend_position,
    a.isLegendInset = 'inset' === c.legend_position,
    a.isLegendTop = 'top-left' === c.legend_inset_anchor ||
        'top-right' === c.legend_inset_anchor,
    a.isLegendLeft = 'top-left' === c.legend_inset_anchor ||
        'bottom-left' === c.legend_inset_anchor,
    a.legendStep = 0, a.legendItemWidth = 0, a.legendItemHeight = 0,
    a.currentMaxTickWidths = {x: 0, y: 0, y2: 0}, a.rotated_padding_left = 30,
    a.rotated_padding_right = c.axis_rotated && !c.axis_x_show ? 0 : 30,
    a.rotated_padding_top = 5, a.withoutFadeIn = {},
    a.intervalForObserveInserted = void 0, a.axes.subx = b.selectAll([])
  }, f.initChartElements = function() {
    this.initBar && this.initBar(), this.initLine && this.initLine(),
        this.initArc && this.initArc(), this.initGauge && this.initGauge(),
        this.initText && this.initText()
  }, f.initWithData = function(b) {
    var c, d, e = this, f = e.d3, g = e.config, h = !0;
    e.initPie && e.initPie(), e.initBrush && e.initBrush(),
        e.initZoom && e.initZoom(),
        e.selectChart =
            'function' == typeof g.bindto.node ? g.bindto : f.select(g.bindto),
        e.selectChart.empty() &&
        (e.selectChart =
             f.select(document.createElement('div')).style('opacity', 0),
         e.observeInserted(e.selectChart), h = !1),
        e.selectChart.html('').classed('c3', !0), e.data.xs = {},
        ...
        e.hasType('gauge') && (g.legend_show = !1), e.updateSizes(),
        e.updateScales(), e.x.domain(f.extent(e.getXDomain(e.data.targets))),
        e.y.domain(e.getYDomain(e.data.targets, 'y')),
        e.y2.domain(e.getYDomain(e.data.targets, 'y2')),
        e.subX.domain(e.x.domain()), e.subY.domain(e.y.domain()),
        e.subY2.domain(e.y2.domain()), e.orgXDomain = e.x.domain(),
        e.brush && e.brush.scale(e.subX), g.zoom_enabled && e.zoom.scale(e.x),
        e.svg = e.selectChart.append('svg')
        ...
        c = e.svg.append('defs'), e.clipChart = e.appendClip(c, e.clipId),
        ...
        e.initSubchart && e.initSubchart(), e.initTooltip && e.initTooltip(),
        e.initLegend && e.initLegend(),
        d.append('text')
            .attr('class', i.text + ' ' + i.empty)
            .attr('text-anchor', 'middle')
            .attr('dominant-baseline', 'middle'),
        e.initRegion(), e.initGrid(),
        d.append('g').attr('clip-path', e.clipPath).attr('class', i.chart),
        g.grid_lines_front && e.initGridLines(), e.initEventRect(),
        e.initChartElements(),
        d.insert('rect', g.zoom_privileged ? null : 'g.' + i.regions)
            .attr('class', i.zoomRect)
            .attr('width', e.width)
            .attr('height', e.height)
            .style('opacity', 0)
            .on('dblclick.zoom', null),
        g.axis_x_extent && e.brush.extent(e.getDefaultExtent()), e.initAxis(),
        e.updateTargets(e.data.targets),
        h && (e.updateDimension(), e.config.oninit.call(e), e.redraw({
          withTransform: !0,
          withUpdateXDomain: !0,
    ...
    'grid' === b && a.each(function() {
      var a = c.d3.select(this), b = a.attr('x1'), d = a.attr('x2'),
          e = a.attr('y1'), f = a.attr('y2');
      a.attr({
        x1: Math.ceil(b),
        x2: Math.ceil(d),
        y1: Math.ceil(e),
    ...
    var a = this, b = a.config, c = a.legend ? a.getLegendHeight() : 0,
    ...
    a.margin = b.axis_rotated ? {
      ...
      left: h + (f ? 0 : a.getCurrentPaddingLeft())
    } :
                                {
                                  ...
                                  right: f ? 0 : a.getCurrentPaddingRight(),
                                  bottom:
                                      g + h + e + a.getCurrentPaddingBottom(),
    ...
    a.width < 0 && (a.width = 0), a.height < 0 && (a.height = 0),
    ...
    a.width2 < 0 && (a.width2 = 0), a.height2 < 0 && (a.height2 = 0),
    ...
    b.updateTargetsForText(a), b.updateTargetsForBar(a),
        b.updateTargetsForLine(a),
        b.updateTargetsForArc && b.updateTargetsForArc(a),
        b.updateTargetsForSubchart && b.updateTargetsForSubchart(a),
        b.svg.selectAll('.' + i.target)
            .filter(function(a) {
    ...
    var c, d, e, f, g, h, j, k, l, m, n, o, p, q, r, s, u, v, w, x, y, z, A, B,
        C, D, E, F, G,
        H = this, I = H.main, J = H.d3, K = H.config,
        L = H.getShapeIndices(H.isAreaType), M = H.getShapeIndices(H.isBarType),
        N = H.getShapeIndices(H.isLineType), O = H.hasArcType(),
        P = H.filterTargetsToShow(H.data.targets), Q = H.xv.bind(H);
    if (a = a || {}, c = t(a, 'withY', !0), d = t(a, 'withSubchart', !0),
        e = t(a, 'withTransition', !0), h = t(a, 'withTransform', !1),
        j = t(a, 'withUpdateXDomain', !1), k = t(a, 'withUpdateOrgXDomain', !1),
        l = t(a, 'withTrimXDomain', !0), p = t(a, 'withUpdateXAxis', j),
        m = t(a, 'withLegend', !1), n = t(a, 'withEventRect', !0),
        o = t(a, 'withDimension', !0), f = t(a, 'withTransitionForExit', e),
        g = t(a, 'withTransitionForAxis', e), w = e ? K.transition_duration : 0,
        x = f ? w : 0, y = g ? w : 0, b = b || H.generateAxisTransitions(y),
        m && K.legend_show ? H.updateLegend(H.mapToIds(H.data.targets), a, b) :
                             o && H.updateDimension(!0),
        H.isCategorized() && 0 === P.length &&
            H.x.domain([0, H.axes.x.selectAll('.tick').size()]),
        P.length ? (H.updateXDomain(P, j, k, l),
                    K.axis_x_tick_values ||
                        (B = K.axis_x_tick_fit || K.axis_x_tick_count ?
                             H.generateTickValues(
                                 H.mapTargetsToUniqueXs(P), K.axis_x_tick_count,
                                 H.isTimeSeries()) :
                             void 0,
                         H.xAxis.tickValues(B), H.subXAxis.tickValues(B))) :
        ...
        !K.axis_y_tick_values && K.axis_y_tick_count &&
            H.yAxis.tickValues(
                H.generateTickValues(H.y.domain(), K.axis_y_tick_count)),
        !K.axis_y2_tick_values && K.axis_y2_tick_count &&
            H.y2Axis.tickValues(
                H.generateTickValues(H.y2.domain(), K.axis_y2_tick_count)),
        H.redrawAxis(b, O), H.updateAxisLabels(e), (j || p) && P.length)
      if (K.axis_x_tick_culling && B) {
        ...
        H.svg.selectAll('.' + i.axisX + ' .tick text')
            .style('display', 'block');
    ...
    u = H.generateXYForText(L, M, N, !0), v = H.generateXYForText(L, M, N, !1),
    c &&
        (H.subY.domain(H.getYDomain(P, 'y')),
         H.subY2.domain(H.getYDomain(P, 'y2'))),
    H.tooltip.style('display', 'none'), H.updateXgridFocus(),
    ...
    H.redrawGrid(w), H.redrawRegion(w), H.redrawBar(x), H.redrawLine(x),
    H.redrawArea(x), H.redrawCircle(), H.hasDataLabel() && H.redrawText(x),
    ...
    I.selectAll('.' + i.selectedCircles)
        ...
        .selectAll('circle')
        .remove(),
    K.interaction_enabled && !a.flow && n &&
    ...
    J.transition()
        ...
        .each(function() {
          var b = [];
          H.addTransitionForBar(b, r), H.addTransitionForLine(b, s),
              H.addTransitionForArea(b, q), H.addTransitionForCircle(b, F, G),
              H.addTransitionForText(b, u, v, a.flow),
              H.addTransitionForRegion(b), H.addTransitionForGrid(b),
              a.flow &&
    ...
    return b.isTimeSeries() ? c = b.parseDate(a.value) :
                              b.isCategorized() && 'string' == typeof a.value &&
    ...
    a.svg.attr('width', a.currentWidth).attr('height', a.currentHeight),
        a.svg.selectAll(['#' + a.clipId, '#' + a.clipIdForGrid])
            .select('rect')
            .attr('width', a.width)
            .attr('height', a.height),
        a.svg.select('#' + a.clipIdForXAxis)
            .select('rect')
        ...
        a.svg.select('#' + a.clipIdForSubchart)
            .select('rect')
            .attr('width', a.width)
            .attr('height', b.size() ? b.attr('height') : 0),
        a.svg.select('.' + i.zoomRect)
            .attr('width', a.width)
            .attr('height', a.height),
    ...
    function b() {
      var a = d.shift();
      return a && c && 'object' == typeof c && a in c ? (c = c[a], b()) :
                                                        a ? void 0 : c
    }
    ...
    var e, f = this, g = f.getScale(a, b, f.isTimeSeries()),
           h = c ? g.domain(c) : g;
    f.isCategorized() ? (d = d ||
                             function() {
                               return 0
    ...
    return g.orgDomain = function() {
      return h.domain()
         ...
         return arguments.length ? (h.domain(a), g) :
    ...
    a.yMax = b.axis_rotated ? a.width : 1, a.subXMin = a.xMin,
    a.subXMax = a.xMax, a.subYMin = b.axis_rotated ? 0 : a.height2,
    a.subYMax = b.axis_rotated ? a.width2 : 1,
    a.x = a.getX(
        a.xMin, a.xMax, c ? void 0 : a.x.orgDomain(),
        function() {
    ...
    a.subX = a.getX(
        a.xMin, a.xMax, a.orgXDomain,
        function(b) {
          return b % 1 ? 0 : a.subXAxis.tickOffset()
        }),
    a.subY =
        a.getY(a.subYMin, a.subYMax, c ? b.axis_y_default : a.subY.domain()),
    a.subY2 =
        a.getY(a.subYMin, a.subYMax, c ? b.axis_y2_default : a.subY2.domain()),
    ...
    a.xAxis = a.getXAxis(
        a.x, a.xOrient, a.xAxisTickFormat, a.xAxisTickValues,
        b.axis_x_tick_outer),
    a.subXAxis = a.getXAxis(
        a.subX, a.subXOrient, a.xAxisTickFormat, a.xAxisTickValues,
        b.axis_x_tick_outer),
    a.yAxis = a.getYAxis(
        a.y, a.yOrient, b.axis_y_tick_format, a.yAxisTickValues,
        b.axis_y_tick_outer),
    a.y2Axis = a.getYAxis(
        a.y2, a.y2Orient, b.axis_y2_tick_format, a.y2AxisTickValues,
        b.axis_y2_tick_outer),
    c ||
        (a.brush && a.brush.scale(a.subX), b.zoom_enabled && a.zoom.scale(a.x)),
    a.updateArc && a.updateArc()
  }, f.getYDomainMin = function(a) {
    var b, c, d, e, f, g, h = this, i = h.config, j = h.mapToIds(a),
                          k = h.getValuesAsIdKeyed(a);
    if (i.data_groups.length > 0)
      for (g = h.hasNegativeValueInTargets(a), b = 0; b < i.data_groups.length;
           b++)
        if (e = i.data_groups[b].filter(function(a) {
          ...
          for (d = e[0], g && k[d] && k[d].forEach(function(a, b) {
            ...
            f = e[c], k[f] && k[f].forEach(function(a, b) {
              h.getAxisId(f) !== h.getAxisId(d) || !k[d] || g && +a > 0 ||
                  (k[d][b] += +a)
            });
    ...
    var b, c, d, e, f, g, h = this, i = h.config, j = h.mapToIds(a),
                          k = h.getValuesAsIdKeyed(a);
    if (i.data_groups.length > 0)
      for (g = h.hasPositiveValueInTargets(a), b = 0; b < i.data_groups.length;
           b++)
        if (e = i.data_groups[b].filter(function(a) {
              return j.indexOf(a) >= 0
            }),
          ...
          for (d = e[0], g && k[d] && k[d].forEach(function(a, b) {
              ...
              c = 1;
               c < e.length; c++)
            f = e[c], k[f] && k[f].forEach(function(a, b) {
              h.getAxisId(f) !== h.getAxisId(d) || !k[d] || g && 0 > +a ||
                  (k[d][b] += +a)
            });
    ...
    var d, e, f, g, h, i, k, l, m, n,
        o = this, p = o.config, r = a.filter(function(a) {
          return o.getAxisId(a.id) === b
        }),
        t = c ? o.filterByXDomain(r, c) : r,
        u = 'y2' === b ? p.axis_y2_min : p.axis_y_min,
        v = 'y2' === b ? p.axis_y2_max : p.axis_y_max,
        w = j(u) ? u : o.getYDomainMin(t), x = j(v) ? v : o.getYDomainMax(t),
        y = 'y2' === b ? p.axis_y2_center : p.axis_y_center,
        z = o.hasType('bar', t) && p.bar_zerobased ||
        o.hasType('area', t) && p.area_zerobased,
        A = o.hasDataLabel() && p.axis_rotated,
        B = o.hasDataLabel() && !p.axis_rotated;
    return w > x && (j(u) ? x = w + 10 : w = x - 10),
           0 === t.length ?
               'y2' === b ? o.y2.domain() : o.y.domain() :
               (isNaN(w) && (w = 0), isNaN(x) && (x = w),
                w === x && (0 > w ? x = 0 : w = 0), m = w >= 0 && x >= 0,
                n = 0 >= w && 0 >= x, (j(u) && m || j(v) && n) && (z = !1),
                z && (m && (w = 0), n && (x = 0)), d = Math.abs(x - w),
                e = f = g = .1 * d,
                'undefined' != typeof y &&
                    (h = Math.max(Math.abs(w), Math.abs(x)), x = y + h,
                     w = y - h),
                A ? (i = o.getDataLabelLength(w, x, b, 'width'),
                     k = q(o.y.range()), l = [i[0] / k, i[1] / k],
                     f += d * (l[1] / (1 - l[0] - l[1])),
                     g += d * (l[0] / (1 - l[0] - l[1]))) :
                    B &&
                        (i = o.getDataLabelLength(w, x, b, 'height'),
                         f += this.convertPixelsToAxisPadding(i[1], d),
                         g += this.convertPixelsToAxisPadding(i[0], d)),
                'y' === b && s(p.axis_y_padding) &&
                    (f = o.getAxisPadding(p.axis_y_padding, 'top', f, d),
                     g = o.getAxisPadding(p.axis_y_padding, 'bottom', g, d)),
                'y2' === b && s(p.axis_y2_padding) &&
                    (f = o.getAxisPadding(p.axis_y2_padding, 'top', f, d),
                     g = o.getAxisPadding(p.axis_y2_padding, 'bottom', g, d)),
                z && (m && (g = w), n && (f = -x)), [w - g, x + f])
  }, f.getXDomainMin = function(a) {
    var b = this, c = b.config;
    return n(c.axis_x_min) ?
        b.isTimeSeries() ? this.parseDate(c.axis_x_min) : c.axis_x_min :
    ...
    return n(c.axis_x_max) ?
        b.isTimeSeries() ? this.parseDate(c.axis_x_max) : c.axis_x_max :
    ...
    return f.isCategorized() ?
               c = 0 :
               f.hasType('bar') ?
               (b = f.getMaxDataCount(), c = b > 1 ? h / (b - 1) / 2 : .5) :
               c = .01 * h,
    ...
    var b = this, c = [b.getXDomainMin(a), b.getXDomainMax(a)], d = c[0],
        e = c[1], f = b.getXDomainPadding(c), g = 0, h = 0;
    return d - e !== 0 || b.isCategorized() ||
               (b.isTimeSeries() ?
                    (d = new Date(.5 * d.getTime()),
                     e = new Date(1.5 * e.getTime())) :
                    (d = 0 === d ? 1 : .5 * d, e = 0 === e ? -1 : 1.5 * e)),
           (d || 0 === d) &&
               (g = b.isTimeSeries() ? new Date(d.getTime() - f.left) :
                                       d - f.left),
           (e || 0 === e) &&
               (h = b.isTimeSeries() ? new Date(e.getTime() + f.right) :
                                       e + f.right),
           [g, h]
    ...
    return c &&
               (f.x.domain(e ? e : f.d3.extent(f.getXDomain(a))),
                ...
                f.subX.domain(f.x.domain()), f.brush && f.brush.scale(f.subX)),
           b &&
               (f.x.domain(
                    e ? e :
                        !f.brush || f.brush.empty() ? f.orgXDomain :
                                                      f.brush.extent()),
                g.zoom_enabled && f.zoom.scale(f.x).updateScaleExtent()),
           d && f.x.domain(f.trimXDomain(f.x.orgDomain())), f.x.domain()
  }, f.trimXDomain = function(a) {
    var b = this;
    return a[0] <= b.orgXDomain[0] &&
    ...
    return this.d3
               .set(Object.keys(a).map(function(b) {
                 return a[b]
               }))
               .size() > 1
  }, f.isMultipleX = function() {
    return s(this.config.data_xs) || !this.config.data_xSort ||
    ...
    return d = e.isTimeSeries() ?
        ...
        e.isCustomX() && !e.isCategorized() ? j(a) ? +a : e.getXValue(b, c) : c
  }, f.cloneTarget = function(a) {
    return {
      id: a.id, id_org: a.id_org, values: a.values.map(function(a) {
        return {
          x: a.x, value: a.value, id: a.id
        }
      })
    }
  }, f.updateXs = function() {
    ...
    a.data.targets.length &&
        (a.xs = [], a.data.targets[0].values.forEach(function(b) {
          a.xs[b.index] = b.x
        }))
    ...
    var a = this.config;
    return 'string' == typeof a.data_order &&
    ...
    return 'boolean' == typeof a.data_labels && a.data_labels ?
        !0 :
        'object' == typeof a.data_labels && s(a.data_labels) ? !0 : !1
  }, f.getDataLabelLength = function(a, b, c, d) {
    var e = this, f = [0, 0], g = 1.3;
    return e.selectChart.select('svg')
               .selectAll('.dummy')
               .data([a, b])
               .enter()
               .append('text')
    ...
    return a.filter(function(a) {
      ...
      var b = d.main
                  .select(
                      '.' + i.bars + d.getTargetSelectorSuffix(a.id) + ' .' +
                      i.bar + '-' + a.index)
                  .node();
    ...
    var c = this, d = c.config, e = d.axis_rotated ? 1 : 0,
        f = d.axis_rotated ? 0 : 1, g = c.circleY(a, a.index), h = c.x(a.x);
    ...
    return c[0] = {x: c[0].x - 1, value: c[0].value, id: c[0].id},
           c[a.length + 1] = {
             x: c[a.length].x + 1,
    ...
    e.d3.xhr(a, function(a, b) {
      var g;
      g = 'json' === f ? e.convertJsonToData(JSON.parse(b.response), c) :
                         'tsv' === f ? e.convertTsvToData(b.response) :
    ...
    var c, d, e = this, f = [];
    return b ? (c = b.value, b.x && (c.push(b.x), e.config.data_x = b.x),
    ...
    var c, d = this, e = d.config, f = d.d3.keys(a[0]).filter(d.isNotX, d),
           g = d.d3.keys(a[0]).filter(d.isX, d);
    return f.forEach(function(c) {
      var f = d.getXKey(c);
      d.isCustomX() || d.isTimeSeries() ?
          g.indexOf(f) >= 0 ?
          d.data.xs[c] = (b && d.data.xs[c] ? d.data.xs[c] : [])
          ...
          e.data_x ? d.data.xs[c] = d.getOtherTargetXs() :
                     s(e.data_xs) &&
           ...
           c = f.map(function(b, c) {
             ...
             return {
               id: f, id_org: b,
                   values:
                       a.map(function(a, g) {
                          var h = d.getXKey(b), i = a[h],
                              j = d.generateTargetX(i, b, g);
                          return d.isCustomX() && d.isCategorized() &&
                                     0 === c && i &&
                                     (0 === g && (e.axis_x_categories = []),
                                      e.axis_x_categories.push(i)),
                                 (m(a[b]) || d.data.xs[b].length <= g) &&
                                     (j = void 0),
                          {
                            x: j,
                                value: null === a[b] || isNaN(a[b]) ? null :
                                                                      +a[b],
                                id: f
                          }
                        }).filter(function(a) {
    ...
    a &&
        (b.filter && (a = a.filter(b.filter)),
         (b.type || b.types) && a.forEach(function(a) {
    ...
    f.selectAll('.' + i.eventRect).remove(),
        ...
        (a = c.eventRect.data([0]),
         c.generateEventRectsForMultipleXs(a.enter()), c.updateEventRect(a)) :
        (b = c.getMaxDataCountTarget(c.data.targets),
         ...
         c.generateEventRectsForSingleX(a.enter()), c.updateEventRect(a),
         a.exit().remove())
    ...
    h.isMultipleX() ?
        ...
        (!h.isCustomX() && !h.isTimeSeries() || h.isCategorized() ?
              ...
              f =
                  function(a) {
                    ...
                    return null === b && null === c ?
                        i.axis_rotated ? h.height : h.width :
         ...
         b = i.axis_rotated ? 0 : g, c = i.axis_rotated ? g : 0,
         d = i.axis_rotated ? h.width : f, e = i.axis_rotated ? f : h.height),
    a.attr('class', h.classEvent.bind(h))
        .attr('x', b)
        .attr('y', c)
        .attr('width', d)
        .attr('height', e)
    ...
    a.append('rect')
        ...
        .style(
            'cursor',
            d.data_selection_enabled && d.data_selection_grouped ? 'pointer' :
                                                                   null)
        .on('mouseover',
            function(a) {
              var c, e, f = a.index;
              b.dragging || b.flowing || b.hasArcType() ||
        ...
        .on('mouseout',
            function(a) {
              var c = a.index;
              b.hasArcType() ||
                  (b.hideXGridFocus(), b.hideTooltip(), b.unexpandCircles(),
                   b.unexpandBars(),
            ...
            function(a) {
              ...
              b.dragging || b.flowing || b.hasArcType() ||
                  (b.isStepType(a) &&
                       ...
                       c.mouse(this)[0] < b.x(b.getXValue(a.id, f)) && (f -= 1),
                   e = b.filterTargetsToShow(b.data.targets).map(function(a) {
                     return b.addName(b.getValueOnIndex(a.values, f))
                   }),
                   d.tooltip_grouped &&
                       (b.showTooltip(e, c.mouse(this)), b.showXGridFocus(e)),
                   (!d.tooltip_grouped ||
                    d.data_selection_enabled && !d.data_selection_grouped) &&
                       b.main.selectAll('.' + i.shape + '-' + f)
                           .each(function() {
                             c.select(this).classed(i.EXPANDED, !0),
                                 d.data_selection_enabled &&
                                 g.style(
                                     'cursor',
                                     d.data_selection_grouped ? 'pointer' :
                                                                null),
                                 d.tooltip_grouped ||
                                 (b.hideXGridFocus(), b.hideTooltip(),
        ...
        .on('click',
            function(a) {
              ...
              if (!b.hasArcType() && b.toggleShape) {
                ...
                b.isStepType(a) && 'step-after' === d.line_step_type &&
                    c.mouse(this)[0] < b.x(b.getXValue(a.id, e)) && (e -= 1),
    ...
    function b() {
      c.svg.select('.' + i.eventRect).style('cursor', null), c.hideXGridFocus(),
          c.hideTooltip(), c.unexpandCircles(), c.unexpandBars()
    }
    ...
    a.append('rect')
        ...
        .on('mousemove',
            function() {
              ...
              if (!c.dragging && !c.hasArcType(j)) {
                if (a = d.mouse(this), f = c.findClosestFromTargets(j, a),
                    !c.mouseover || f && f.id === c.mouseover.id ||
                        (e.data_onmouseout.call(c.api, c.mouseover),
                         c.mouseover = void 0),
                    !f)
                  return void b();
                g = c.isScatterType(f) || !e.tooltip_grouped ?
                    [f] :
                    c.filterByX(j, f.x),
                h = g.map(function(a) {
                  return c.addName(a)
                ...
                c.expandBars(f.index, f.id, !0), c.showXGridFocus(h),
        ...
        .on('click',
            function() {
              ...
              c.hasArcType(f) ||
                  (a = d.mouse(this), b = c.findClosestFromTargets(f, a),
                   b && (c.isBarType(b.id) || c.dist(b, a) < 100) &&
                       c.main
                           .selectAll(
                               '.' + i.shapes + c.getTargetSelectorSuffix(b.id))
    ...
    var e = this, f = '.' + i.eventRect + (e.isMultipleX() ? '' : '-' + c),
        g = e.main.select(f).node(), h = g.getBoundingClientRect(),
        j = h.left + (d ? d[0] : 0), k = h.top + (d ? d[1] : 0),
    ...
    return j(c.padding_left) ?
        c.padding_left :
        c.axis_rotated ?
        c.axis_x_show ? Math.max(o(b.getAxisWidthByAxisId('x', a)), 40) : 1 :
        !c.axis_y_show || c.axis_y_inner ?
        b.getYAxisLabelPosition().isOuter ? 30 : 1 :
        o(b.getAxisWidthByAxisId('y', a))
  }, f.getCurrentPaddingRight = function() {
    var a = this, b = a.config, c = 10,
    ...
    for (var b, c = this.selectChart.node();
    ...
    var b = this, c = b.config,
        ...
        h = b.selectChart.node().getBoundingClientRect(), j = b.hasArcType(),
    ...
    return 'x' !== a || c.axis_x_show ?
        ...
        ('x' === a && !c.axis_rotated && c.axis_x_tick_rotate &&
             (d = b.getMaxTickWidth(a) *
                  Math.cos(Math.PI * (90 - c.axis_x_tick_rotate) / 180)),
         d + (b.getAxisLabelPositionById(a).isInner ? 0 : 10) +
             ('y2' === a ? -10 : 0)) :
        b.rotated_padding_top :
        !c.legend_show || b.isLegendRight || b.isLegendInset ? 1 : 10 :
        8
  }, f.getEventRectWidth = function() {
    var a, b, c, d, e, f, g = this, h = g.getMaxDataCountTarget(g.data.targets);
    return h ? (a = h.values[0], b = h.values[h.values.length - 1],
                c = g.x(b.x) - g.x(a.x),
                0 === c ? g.config.axis_rotated ? g.height : g.width :
                          (d = g.getMaxDataCount(),
                           e = g.hasType('bar') ?
                               (d - (g.isCategorized() ? .25 : 1)) / d :
                               1,
                           f = d > 1 ? c * e / (d - 1) : c, 1 > f ? 1 : f)) :
               0
  }, f.getShapeIndices = function(a) {
    var b, c, d = this, e = d.config, f = {}, g = 0;
    return d.filterTargetsToShow(d.data.targets.filter(a, d))
               .forEach(function(a) {
    ...
    return function(a, g) {
      ...
      return e.forEach(function(c) {
        ...
        c.id !== a.id && b[c.id] === b[a.id] &&
            f.indexOf(c.id) < f.indexOf(a.id) && e[g].value * a.value >= 0 &&
            (j += h(e[g].value) - i)
      }),
             j
    }
    ...
    return b.isSplineType(a) ?
        'cardinal' :
        b.isStepType(a) ? b.config.line_step_type : 'linear'
  }, f.initLine = function() {
    var a = this;
    a.main.select('.' + i.chart).append('g').attr('class', i.chartLines)
  }, f.updateTargetsForLine = function(a) {
    var b, c, d = this, e = d.config, f = d.classChartLine.bind(d),
              g = d.classLines.bind(d), h = d.classAreas.bind(d),
              j = d.classCircles.bind(d), k = d.classFocus.bind(d);
    b = d.main.select('.' + i.chartLines)
    ...
    c.append('g').attr('class', g), c.append('g').attr('class', h),
    c.append('g').attr('class', function(a) {
      ...
      d.main
          .selectAll('.' + i.selectedCircles + d.getTargetSelectorSuffix(a.id))
    ...
    var b = this;
    b.mainLine = b.main.selectAll('.' + i.lines)
                     .selectAll('.' + i.line)
    ...
    b.mainLine.style('opacity', b.initialOpacity.bind(b))
        .style(
            'shape-rendering',
            function(a) {
    ...
    var c = this;
    a.push(c.mainLine.transition()
               .attr('d', b)
               .style('stroke', c.color)
               .style('opacity', 1))
  }, f.generateDrawLine = function(a, b) {
    var c = this, d = c.config, e = c.d3.svg.line(),
        f = c.generateGetLinePoints(a, b), g = b ? c.getSubYScale : c.getYScale,
        h = function(a) {
          return (b ? c.subxx : c.xx).call(c, a)
        }, i = function(a, b) {
          return d.data_groups.length > 0 ? f(a, b)[0][1] :
                                            g.call(c, a.id)(a.value)
        };
    return e = d.axis_rotated ? e.x(i).y(h) : e.x(h).y(i),
           d.line_connectNull || (e = e.defined(function(a) {
             return null != a.value
           })),
           function(a) {
             var f,
                 h = d.line_connectNull ? c.filterRemoveNull(a.values) :
                                          a.values,
                 i = b ? c.x : c.subX, j = g.call(c, a.id), k = 0, l = 0;
             return c.isLineType(a) ?
                        d.data_regions[a.id] ?
                        ...
                        (h[0] && (k = i(h[0].x), l = j(h[0].value)),
                         f = d.axis_rotated ? 'M ' + l + ' ' + k :
                                              'M ' + k + ' ' + l),
                        f ? f : 'M 0 0'
           }
  }, f.generateGetLinePoints = function(a, b) {
    var c = this, d = c.config, e = a.__max__ + 1,
        f = c.getShapeX(0, e, a, !!b), g = c.getShapeY(!!b),
        h = c.getShapeOffset(c.isLineType, a, !!b),
        i = b ? c.getSubYScale : c.getYScale;
    return function(a, b) {
      var e = i.call(c, a.id)(0), j = h(a, b) || e, k = f(a), l = g(a);
      return d.axis_rotated && (0 < a.value && e > l || a.value < 0 && l > e) &&
                 (l = e),
             [
               [k, l - (e - j)], [k, l - (e - j)], [k, l - (e - j)],
               [k, l - (e - j)]
             ]
    }
    ...
    var f, g, h, i, j, k, l, o, p, q, r, s, t = this, u = t.config, v = -1,
                                            w = 'M', x = [];
    if (n(d))
      for (f = 0; f < d.length; f++)
        ...
        x[f].start = m(d[f].start) ?
            a[0].x :
            t.isTimeSeries() ? t.parseDate(d[f].start) : d[f].start,
        x[f].end = m(d[f].end) ?
            a[a.length - 1].x :
            t.isTimeSeries() ? t.parseDate(d[f].end) : d[f].end;
    for (r = u.axis_rotated ?
             function(a) {
               return c(a.value)
             } :
             function(a) {
        ...
        h = t.isTimeSeries() ?
             function(a, d, e, f) {
               var g = a.x.getTime(), h = d.x - a.x, i = new Date(g + h * e),
                   k = new Date(g + h * (e + f));
               return 'M' + b(i) + ' ' + c(j(e)) + ' ' + b(k) + ' ' +
                   c(j(e + f))
             } :
             function(a, d, e, f) {
               return 'M' + b(i(e), !0) + ' ' + c(j(e)) + ' ' +
                   b(i(e + f), !0) + ' ' + c(j(e + f))
             },
        f = 0;
         f < a.length; f++) {
      if (m(x) || !e(a[f].x, x))
        ...
        for (i = t.getScale(a[f - 1].x, a[f].x, t.isTimeSeries()),
            j = t.getScale(a[f - 1].value, a[f].value),
            k = b(a[f].x) - b(a[f - 1].x),
            l = c(a[f].value) - c(a[f - 1].value),
            o = Math.sqrt(Math.pow(k, 2) + Math.pow(l, 2)), p = 2 / o,
            q = 2 * p, g = p;
             1 >= g; g += q)
          w += h(a[f - 1], a[f], g, p);
      v = a[f].x
    ...
    var b = this, c = b.d3;
    b.mainArea = b.main.selectAll('.' + i.areas)
                     .selectAll('.' + i.area)
                     .data(b.lineData.bind(b)),
    b.mainArea.enter()
        .append('path')
    ...
    var c = this;
    a.push(c.mainArea.transition()
               .attr('d', b)
               .style('fill', c.color)
               .style('opacity', c.orgAreaOpacity))
  }, f.generateDrawArea = function(a, b) {
    var c = this, d = c.config, e = c.d3.svg.area(),
        f = c.generateGetAreaPoints(a, b), g = b ? c.getSubYScale : c.getYScale,
        h = function(a) {
          return (b ? c.subxx : c.xx).call(c, a)
        }, i = function(a, b) {
          return d.data_groups.length > 0 ? f(a, b)[0][1] : g.call(c, a.id)(0)
        }, j = function(a, b) {
          return d.data_groups.length > 0 ? f(a, b)[1][1] :
                                            g.call(c, a.id)(a.value)
        };
    return e = d.axis_rotated ? e.x0(i).x1(j).y(h) : e.x(h).y0(i).y1(j),
           d.line_connectNull || (e = e.defined(function(a) {
             return null !== a.value
           })),
           function(a) {
             var b,
                 f = d.line_connectNull ? c.filterRemoveNull(a.values) :
                                          a.values,
                 g = 0, h = 0;
             return c.isAreaType(a) ?
                        (c.isStepType(a) && (f = c.convertValuesToStep(f)),
                         b = e.interpolate(c.getInterpolate(a))(f)) :
                        (f[0] &&
                             (g = c.x(f[0].x),
                              h = c.getYScale(a.id)(f[0].value)),
                         b = d.axis_rotated ? 'M ' + h + ' ' + g :
                                              'M ' + g + ' ' + h),
                    b ? b : 'M 0 0'
           }
    ...
    var a = this;
    a.mainCircle = a.main.selectAll('.' + i.circles)
                       .selectAll('.' + i.circle)
    ...
    var d = this;
    a.push(d.mainCircle.transition()
               .style('opacity', d.opacityForCircle.bind(d))
               .style('fill', d.color)
               .attr('cx', b)
               .attr('cy', c)),
        a.push(d.main.selectAll('.' + i.selectedCircle)
                   .transition()
                   .attr('cx', b)
                   .attr('cy', c))
    ...
    c.config.data_groups.length > 0 ?
        (a = c.getShapeIndices(c.isLineType), b = c.generateGetLinePoints(a),
         c.circleY =
             function(a, c) {
               return b(a, c)[0][1]
             }) :
    ...
    var c = this;
    return (b ? c.main.selectAll(
                    '.' + i.circles + c.getTargetSelectorSuffix(b)) :
                c.main)
    ...
    return c.point_focus_expand_enabled ?
        c.point_focus_expand_r ? c.point_focus_expand_r : 1.75 * b.pointR(a) :
        b.pointR(a)
  }, f.pointSelectR = function(a) {
    var b = this, c = b.config;
    return c.point_select_r ? c.point_select_r : 4 * b.pointR(a)
  }, f.isWithinCircle = function(a, b) {
    var c = this.d3, d = c.mouse(a), e = c.select(a), f = +e.attr('cx'),
        g = +e.attr('cy');
    ...
    var b, c, d = this, e = d.config, f = d.classChartBar.bind(d),
              g = d.classBars.bind(d), h = d.classFocus.bind(d);
    b = d.main.select('.' + i.chartBars)
    ...
    var b = this, c = b.barData.bind(b), d = b.classBar.bind(b),
        e = b.initialOpacity.bind(b), f = function(a) {
          return b.color(a.id)
        };
    b.mainBar = b.main.selectAll('.' + i.bars).selectAll('.' + i.bar).data(c),
    b.mainBar.enter()
        .append('path')
        .attr('class', d)
        .style('stroke', f)
    ...
    var c = this;
    a.push(c.mainBar.transition()
               .attr('d', b)
               .style('fill', c.color)
               .style('opacity', 1))
  }, f.getBarW = function(a, b) {
    var c = this, d = c.config,
        e = 'number' == typeof d.bar_width ?
        d.bar_width :
        b ? 2 * a.tickOffset() * d.bar_width_ratio / b : 0;
    return d.bar_width_max && e > d.bar_width_max ? d.bar_width_max : e
  }, f.getBars = function(a, b) {
    var c = this;
    return (b ? c.main.selectAll('.' + i.bars + c.getTargetSelectorSuffix(b)) :
                c.main)
    ...
    return function(a, b) {
      var c = e(a, b), f = d.axis_rotated ? 1 : 0, g = d.axis_rotated ? 0 : 1,
          h = 'M ' + c[0][f] + ',' + c[0][g] + ' L' + c[1][f] + ',' + c[1][g] +
          ' L' + c[2][f] + ',' + c[2][g] + ' L' + c[3][f] + ',' + c[3][g] +
          ' z';
      return h
    }
  }, f.generateGetBarPoints = function(a, b) {
    var c = this, d = b ? c.subXAxis : c.xAxis, e = a.__max__ + 1,
        f = c.getBarW(d, e), g = c.getShapeX(f, e, a, !!b),
        h = c.getShapeY(!!b), i = c.getShapeOffset(c.isBarType, a, !!b),
        j = b ? c.getSubYScale : c.getYScale;
    return function(a, b) {
      var d = j.call(c, a.id)(0), e = i(a, b) || d, k = g(a), l = h(a);
      return c.config.axis_rotated &&
                 (0 < a.value && d > l || a.value < 0 && l > d) && (l = d),
             [[k, e], [k, l - (d - e)], [k + f, l - (d - e)], [k + f, e]]
    }
  }, f.isWithinBar = function(a) {
    var b = this.d3.mouse(a), c = a.getBoundingClientRect(),
        d = a.pathSegList.getItem(0), e = a.pathSegList.getItem(1),
        f = Math.min(d.x, e.x), g = Math.min(d.y, e.y), h = c.width,
        i = c.height, j = 2, k = f - j, l = f + h + j, m = g + i + j, n = g - j;
    return k < b[0] && b[0] < l && n < b[1] && b[1] < m
  }, f.initText = function() {
    var a = this;
    a.main.select('.' + i.chart).append('g').attr('class', i.chartTexts),
        a.mainText = a.d3.selectAll([])
  }, f.updateTargetsForText = function(a) {
    var b, c, d = this, e = d.classChartText.bind(d), f = d.classTexts.bind(d),
              g = d.classFocus.bind(d);
    b = d.main.select('.' + i.chartTexts)
    ...
    var b = this, c = b.config, d = b.barOrLineData.bind(b),
        e = b.classText.bind(b);
    b.mainText =
        b.main.selectAll('.' + i.texts).selectAll('.' + i.text).data(d),
    b.mainText.enter()
        .append('text')
        .attr('class', e)
        .attr(
    ...
    var e = this, f = e.generateGetAreaPoints(b, !1),
        g = e.generateGetBarPoints(b, !1), h = e.generateGetLinePoints(c, !1),
    ...
    return d = e.config.axis_rotated ?
               (a[0][0] + a[2][0] + .6 * f.height) / 2 :
               a[2][1] + (b.value < 0 ? f.height : e.isBarType(b) ? -3 : -6),
           null !== b.value || e.config.axis_rotated ||
               (d < f.height ? d = f.height :
    ...
    var b = l(a) ? a : a.id;
    return ['area', 'area-spline', 'area-step'].indexOf(
               this.config.data_types[b]) >= 0
    ...
    b.xgrid = b.main.select('.' + i.xgrids).selectAll('.' + i.xgrid).data(e),
    ...
    a.ygrid = a.main.select('.' + i.ygrids).selectAll('.' + i.ygrid).data(c),
    a.ygrid.enter().append('line').attr('class', i.ygrid),
    a.ygrid.attr('x1', b.axis_rotated ? a.y : 0)
    ...
    e.grid.style('visibility', e.hasArcType() ? 'hidden' : 'visible'),
        ...
        e.xgridLines = f.select('.' + i.xgridLines)
                           .selectAll('.' + i.xgridLine)
                           .data(g.grid_x_lines),
        b = e.xgridLines.enter().append('g').attr(
            'class',
            function(a) {
        ...
        e.ygridLines = f.select('.' + i.ygridLines)
                           .selectAll('.' + i.ygridLine)
                           .data(g.grid_y_lines),
        c = e.ygridLines.enter().append('g').attr(
            'class',
            function(a) {
    ...
    a.push(b.xgridLines.select('line')
               .transition()
               .attr('x1', c.axis_rotated ? 0 : d)
               .attr('x2', c.axis_rotated ? b.width : d)
               .attr('y1', c.axis_rotated ? d : b.margin.top)
               .attr('y2', c.axis_rotated ? d : b.height)
               .style('opacity', 1)),
        a.push(b.xgridLines.select('text')
                   .transition()
    ...
    c.tooltip_show &&
        (b.hasType('scatter') || b.hasArcType() ||
    ...
    var a = this, b = a.config;
    a.main.select('line.' + i.xgridFocus)
    ...
    if ('year' === a)
      for (c = g.getXDomain(), d = c[0].getFullYear(), e = c[1].getFullYear(),
          f = d;
           e >= f; f++)
        h.push(new Date(f + '-01-01 00:00:00'));
    else
      h = b.ticks(10), h.length > j && (h = h.filter(function(a) {
                         return ('' + a).indexOf('.') < 0
                       }));
    return h
    ...
    var c = this, d = c.config, e = c.getGridFilterToRemove(a),
        f =
            function(a) {
          return !e(a)
        },
    ...
    c.main.select('.' + g)
        ...
        .style('opacity', 0)
        .remove(),
        b ? d.grid_x_lines = d.grid_x_lines.filter(f) :
            d.grid_y_lines = d.grid_y_lines.filter(f)
  }, f.initTooltip = function() {
    var a, b = this, c = b.config;
    if (b.tooltip = b.selectChart.style('position', 'relative')
                        .append('div')
      ...
      if (b.isTimeSeries() && l(c.tooltip_init_x)) {
        for (c.tooltip_init_x = b.parseDate(c.tooltip_init_x), a = 0;
      ...
      b.tooltip.html(c.tooltip_contents.call(
          b, b.data.targets.map(function(a) {
            return b.addName(a.values[c.tooltip_init_x])
          }),
          b.getXAxisTickFormat(), b.getYFormat(b.hasArcType()), b.color)),
          b.tooltip.style('top', c.tooltip_init_position.top)
              .style('left', c.tooltip_init_position.left)
              .style('display', 'block')
    }
  }, f.getTooltipContent = function(a, b, c, d) {
    var e, f, g, h, j, k, l = this, m = l.config,
                          n = m.tooltip_format_title || b,
                          o = m.tooltip_format_name || function(a) {
                            return a
                          }, p = m.tooltip_format_value || c;
    for (f = 0; f < a.length; f++)
      a[f] && (a[f].value || 0 === a[f].value) &&
          (e ||
               (g = n ? n(a[f].x) : a[f].x,
           ...
           e += '<tr class=\'' + i.tooltipName + '-' + a[f].id + '\'>',
           e += '<td class=\'name\'><span style=\'background-color:' + k +
               '\'></span>' + j + '</td>',
           e += '<td class=\'value\'>' + h + '</td>', e += '</tr>');
    return e + '</table>'
  }, f.showTooltip = function(a, b) {
    var c, d, e, f, g, h, i, k = this, l = k.config, m = k.hasArcType(),
                             n = a.filter(function(a) {
                               return a && j(a.value)
                             });
    0 !== n.length && l.tooltip_show &&
        (k.tooltip
             .html(l.tooltip_contents.call(
                 k, a, k.getXAxisTickFormat(), k.getYFormat(m), k.color))
             .style('display', 'block'),
         c = k.tooltip.property('offsetWidth'),
         d = k.tooltip.property('offsetHeight'),
         m ? (f = k.width / 2 + b[0], h = k.height / 2 + b[1] + 20) :
             (e = k.getSvgLeft(!0),
              l.axis_rotated ?
                  (f = e + b[0] + 100, g = f + c,
                   i = k.currentWidth - k.getCurrentPaddingRight(),
                   h = k.x(n[0].x) + 20) :
                  (f = e + k.getCurrentPaddingLeft(!0) + k.x(n[0].x) + 20,
                   g = f + c,
                   i = e + k.currentWidth - k.getCurrentPaddingRight(),
                   h = b[1] + 15),
              g > i && (f -= g - i), h + d > k.currentHeight && (h -= d + 30)),
         0 > h && (h = 0),
         k.tooltip.style('top', h + 'px').style('left', f + 'px'))
  }, f.hideTooltip = function() {
    this.tooltip.style('display', 'none')
  }, f.initLegend = function() {
    var a = this;
    return a.legendHasRendered = !1,
           a.legend =
               a.svg.append('g').attr('transform', a.getTranslate('legend')),
    ...
    a.updateLegend(
        ...
        {withTransform: !1, withTransitionForTransform: !1, withTransition: !1})
    ...
    var c = this, d = c.config, e = {
      ...
      left: c.isLegendLeft ? c.getCurrentPaddingLeft() + d.legend_inset_x + .5 :
                             c.currentWidth - b - c.getCurrentPaddingRight() -
              d.legend_inset_x + .5
    };
    c.margin3 = {
    ...
    var b = this;
    (a ? b.legend.transition() : b.legend)
        .attr('transform', b.getTranslate('legend'))
    ...
    var a = this;
    return a.config.legend_show ? a.isLegendRight || a.isLegendInset ?
    ...
    c.legend.selectAll('.' + i.legendItem)
        .filter(function(b) {
          return a.indexOf(b) >= 0
        })
    ...
    var a = this, b = a.d3;
    a.legend.selectAll('.' + i.legendItem)
    ...
    var b = this, c = b.config;
    c.legend_show ||
        (c.legend_show = !0, b.legend.style('visibility', 'visible'),
         b.legendHasRendered || b.updateLegendWithDefaults()),
        b.removeHiddenLegendIds(a),
        b.legend.selectAll(b.selectorLegends(a))
  ...
  f.clearLegendItemTextBoxCache = function() {
    ...
    function e(b, c, e) {
      function f(a, b) {
        b || (g = (o - E - n) / 2, C > g && (g = (o - n) / 2, E = 0, K++)),
            J[a] = K, I[K] = w.isLegendInset ? 10 : g, F[a] = E, E += n
      }
      var g, h,
          i = 0 === e, j = e === a.length - 1, k = d(b, c),
          l = k.width + D + (!j || w.isLegendRight || w.isLegendInset ? z : 0),
          m = k.height + y, n = w.isLegendRight || w.isLegendInset ? m : l,
          o = w.isLegendRight || w.isLegendInset ? w.getLegendHeight() :
                                                   w.getLegendWidth();
      return i && (E = 0, K = 0, A = 0, B = 0),
             x.legend_show && !w.isLegendToShow(c) ?
                 void (G[c] = H[c] = J[c] = F[c] = 0) :
                 (G[c] = l, H[c] = m, (!A || l >= A) && (A = l),
                  (!B || m >= B) && (B = m),
                  ...
                  void (
                      x.legend_equally ?
                          (Object.keys(G).forEach(function(a) {
                           ...
                           g = (o - h * a.length) / 2,
                           C > g ? (E = 0, K = 0, a.forEach(function(a) {
                             f(a)
                           })) :
                                   f(c, !0)) :
                          f(c)))
    }
    var f, g, j, k, l, m, o, p, q, r, s, u, v,
        w = this, x = w.config, y = 4, z = 10, A = 0, B = 0, C = 10, D = 15,
        E = 0, F = {}, G = {}, H = {}, I = [0], J = {}, K = 0,
        L = w.legend.selectAll('.' + i.legendItemFocused).size();
    b = b || {}, p = t(b, 'withTransition', !0),
    ...
    o = w.legend.selectAll('.' + i.legendItem)
            .data(a)
            .enter()
            .append('g')
            .attr(
            ...
            .on('mouseover',
                function(a) {
                  w.d3.select(this).classed(i.legendItemFocused, !0),
                      ...
                      x.legend_item_onmouseover &&
                      x.legend_item_onmouseover.call(w, a)
                })
            .on('mouseout',
                function(a) {
                  w.d3.select(this).classed(i.legendItemFocused, !1),
                      w.api.revert(),
                      x.legend_item_onmouseout &&
                      x.legend_item_onmouseout.call(w, a)
                }),
    o.append('text')
        .text(function(a) {
    ...
    w.isLegendInset && A > 0 && 0 === v.size() &&
        (v = w.legend.insert('g', '.' + i.legendItem)
                 .attr('class', i.legendBackground)
                 .append('rect')),
    r = w.legend.selectAll('text')
            .data(a)
            .text(function(a) {
              return n(x.data_names[a]) ? x.data_names[a] : a
            })
    ...
    (p ? u.transition() : u).style('fill', w.color).attr('x', f).attr('y', k),
    v &&
        (p ? v.transition() : v)
            .attr('height', w.getLegendHeight() - 12)
            .attr('width', A * (K + 1) + 10),
    w.legend.selectAll('.' + i.legendItem)
        .classed(
            i.legendItemHidden,
            function(a) {
    ...
    w.updateLegendItemWidth(A), w.updateLegendItemHeight(B),
    w.updateLegendStep(K), w.updateSizes(), w.updateScales(), w.updateSvgSize(),
    w.transformAll(q, c), w.legendHasRendered = !0
  }, f.initAxis = function() {
    ...
    return g.isTimeSeries() && e && (e = e.map(function(a) {
           ...
           j.tickFormat(c).tickValues(e),
           g.isCategorized() ?
               (j.tickCentered(h.axis_x_tick_centered),
                r(h.axis_x_tick_culling) && (h.axis_x_tick_culling = !1)) :
               j.tickOffset =
                   function() {
                 var a = this.scale(), b = g.getEdgeX(g.data.targets),
                     c = a(b[1]) - a(b[0]),
                     d = c ? c : h.axis_rotated ? g.height : g.width;
    ...
    var a = this, b = a.config,
        ...
        a.isCategorized() ? a.categoryName : function(a) {
          return 0 > a ? a.toFixed(0) : a
        };
    return b.axis_x_tick_format &&
               (k(b.axis_x_tick_format) ? c = b.axis_x_tick_format :
                                          a.isTimeSeries() &&
                        (c =
                             function(c) {
                               return c ?
    ...
    var b, c = this, d = c.config;
    return 'y' === a ? b = d.axis_y_label :
                       'y2' === a ? b = d.axis_y2_label :
    ...
    l(e) ? 'y' === a ? d.axis_y_label = b :
                       'y2' === a ? d.axis_y2_label = b :
    ...
    return {
      isInner: d.indexOf('inner') >= 0, isOuter: d.indexOf('outer') >= 0,
          isLeft: d.indexOf('left') >= 0, isCenter: d.indexOf('center') >= 0,
          isRight: d.indexOf('right') >= 0, isTop: d.indexOf('top') >= 0,
          isMiddle: d.indexOf('middle') >= 0, isBottom: d.indexOf('bottom') >= 0
    }
  }, f.getXAxisLabelPosition = function() {
    return this.getAxisLabelPosition(
        'x', this.config.axis_rotated ? 'inner-top' : 'inner-right')
  }, f.getYAxisLabelPosition = function() {
    return this.getAxisLabelPosition(
        'y', this.config.axis_rotated ? 'inner-right' : 'inner-top')
  }, f.getY2AxisLabelPosition = function() {
    return this.getAxisLabelPosition(
        'y2', this.config.axis_rotated ? 'inner-right' : 'inner-top')
  }, f.getAxisLabelPositionById = function(a) {
    return 'y2' === a ?
        this.getY2AxisLabelPosition() :
        'y' === a ? this.getYAxisLabelPosition() : this.getXAxisLabelPosition()
    ...
    var c = this;
    return a ? b.isLeft ? 0 : b.isCenter ? c.width / 2 : c.width :
               b.isBottom ? -c.height : b.isMiddle ? -c.height / 2 : 0
  }, f.dxForAxisLabel = function(a, b) {
    return a ? b.isLeft ? '0.5em' : b.isRight ? '-0.5em' : '0' :
               b.isTop ? '-0.5em' : b.isBottom ? '0.5em' : '0'
  }, f.textAnchorForAxisLabel = function(a, b) {
    return a ? b.isLeft ? 'start' : b.isCenter ? 'middle' : 'end' :
               b.isBottom ? 'start' : b.isMiddle ? 'middle' : 'end'
  }, f.xForXAxisLabel = function() {
    return this.xForAxisLabel(
        !this.config.axis_rotated, this.getXAxisLabelPosition())
  }, f.xForYAxisLabel = function() {
    return this.xForAxisLabel(
        this.config.axis_rotated, this.getYAxisLabelPosition())
  }, f.xForY2AxisLabel = function() {
    return this.xForAxisLabel(
        this.config.axis_rotated, this.getY2AxisLabelPosition())
    ...
    return b.axis_rotated ?
        c.isInner ? '1.2em' : -25 - a.getMaxTickWidth('x') :
        c.isInner ? '-0.5em' : b.axis_x_height ? b.axis_x_height - 10 : '3em'
    ...
    return a.textAnchorForAxisLabel(
        !a.config.axis_rotated, a.getXAxisLabelPosition())
  }, f.textAnchorForYAxisLabel = function() {
    var a = this;
    return a.textAnchorForAxisLabel(
        a.config.axis_rotated, a.getYAxisLabelPosition())
  }, f.textAnchorForY2AxisLabel = function() {
    var a = this;
    return a.textAnchorForAxisLabel(
        a.config.axis_rotated, a.getY2AxisLabelPosition())
    ...
    return b && f.currentMaxTickWidths[a] ?
        f.currentMaxTickWidths[a] :
        (f.svg &&
             (c = f.filterTargetsToShow(f.data.targets),
              'y' === a ?
                  (d = f.y.copy().domain(f.getYDomain(c, 'y')),
                   e = f.getYAxis(
                       d, f.yOrient, g.axis_y_tick_format, f.yAxisTickValues)) :
                  'y2' === a ?
                  (d = f.y2.copy().domain(f.getYDomain(c, 'y2')),
                   e = f.getYAxis(
                       d, f.y2Orient, g.axis_y2_tick_format,
                       f.y2AxisTickValues)) :
                  (d = f.x.copy().domain(f.getXDomain(c)),
                   e = f.getXAxis(
              ...
              f.d3.select('body')
                  ...
                  .remove()),
         f.currentMaxTickWidths[a] = 0 >= h ? f.currentMaxTickWidths[a] : h,
         f.currentMaxTickWidths[a])
    ...
    if (b)
      if (d = k(b) ? b() : b, 1 === d)
        ...
        for (g = d - 2, e = a[0], f = a[a.length - 1], h = (f - e) / (g + 1),
            l = [e], i = 0;
             g > i; i++)
    ...
    var c = this, d = c.config;
    c.axes.x.style('opacity', b ? 0 : 1), c.axes.y.style('opacity', b ? 0 : 1),
        c.axes.y2.style('opacity', b ? 0 : 1),
        c.axes.subx.style('opacity', b ? 0 : 1), a.axisX.call(c.xAxis),
        a.axisY.call(c.yAxis), a.axisY2.call(c.y2Axis),
        a.axisSubX.call(c.subXAxis),
        !d.axis_rotated && d.axis_x_tick_rotate &&
    ...
    var b = this, c = Math.max(30, b.margin.left),
    ...
    a.radius = .95 * a.radiusExpanded,
    a.innerRadiusRatio = c ? (a.radius - c) / a.radius : .6,
    a.innerRadius = a.hasType('donut') || a.hasType('gauge') ?
        a.radius * a.innerRadiusRatio :
        0
  }, f.updateArc = function() {
    var a = this;
    a.svgArc = a.getSvgArc(), a.svgArcExpanded = a.getSvgArcExpanded(),
    a.svgArcExpandedSub = a.getSvgArcExpanded(.98)
  }, f.updateAngle = function(a) {
    var b, c, d = this, e = d.config, f = !1, g = 0, h = e.gauge_min,
              i = e.gauge_max;
    ...
    return h && !g.hasType('gauge') &&
               (b = this.svgArc.centroid(h), c = isNaN(b[0]) ? 0 : b[0],
                d = isNaN(b[1]) ? 0 : b[1], e = Math.sqrt(c * c + d * d),
                f = g.radius && e ?
                    (36 / g.radius > .375 ? 1.175 - 36 / g.radius : .8) *
                        g.radius / e :
                    0,
                i = 'translate(' + c * f + ',' + d * f + ')'),
           i
    ...
    return g.shouldShowArcLabel() ?
        (b = g.updateAngle(a), c = b ? b.value : null, d = g.getArcRatio(b),
         e = a.data.id,
    ...
    return d.transiting ?
        ...
        (b = d.mapToTargetIds(b),
         void d.svg.selectAll(d.selectorTargets(b, '.' + i.chartArc))
             .each(function(a) {
    ...
    b.transiting ||
        (a = b.mapToTargetIds(a),
         b.svg.selectAll(b.selectorTargets(a, '.' + i.chartArc))
             .selectAll('path')
             .transition()
             .duration(50)
             .attr('d', b.svgArc),
    ...
    var b = this, c = b.config;
    return b.isDonutType(a) && c.donut_expand ||
        b.isGaugeType(a) && c.gauge_expand || b.isPieType(a) && c.pie_expand
  }, f.shouldShowArcLabel = function() {
    var a = this, b = a.config, c = !0;
    return a.hasType('donut') ? c = b.donut_label_show :
                                a.hasType('pie') && (c = b.pie_label_show),
                                c
  }, f.meetsArcLabelThreshold = function(a) {
    var b = this, c = b.config,
        d = b.hasType('donut') ? c.donut_label_threshold :
                                 c.pie_label_threshold;
    return a >= d
  }, f.getArcLabelFormat = function() {
    var a = this, b = a.config, c = b.pie_label_format;
    return a.hasType('gauge') ?
    ...
    var b, c, d = this, e = d.main, f = d.classChartArc.bind(d),
              g = d.classArcs.bind(d), h = d.classFocus.bind(d);
    b = e.select('.' + i.chartArcs)
    ...
    d.attr(
        ...
        .on('mouseover',
            g.interaction_enabled ?
                function(a) {
                  var b, c;
                  e.transiting ||
                      (b = e.updateAngle(a), c = e.convertToArcData(b),
                       e.expandArc(b.data.id), e.api.focus(b.data.id),
        ...
        .on('mouseout',
            g.interaction_enabled ?
                function(a) {
                  ...
                  e.transiting ||
                      (b = e.updateAngle(a), c = e.convertToArcData(b),
                       e.unexpandArc(b.data.id), e.api.revert(),
                       e.revertLegend(), e.hideTooltip(),
            ...
            function(a) {
              ...
              return c ?
                  (isNaN(this._current.endAngle) &&
                   ...
                   b = f.interpolate(this._current, c), this._current = b(0),
                   function(c) {
                     var d = b(c);
        ...
        .style(
            'fill',
            function(a) {
              return e.levelColor ? e.levelColor(a.data.values[0].value) :
                                    e.color(a.data.id)
            })
        .style('opacity', 1)
        .call(
    ...
    h.select('.' + i.chartArcsTitle)
        .style('opacity', e.hasType('donut') || e.hasType('gauge') ? 1 : 0),
    e.hasType('gauge') &&
        (e.arcs.select('.' + i.chartArcsBackground)
             .attr(
                 'd',
                 function() {
                   var a = {
    ...
    b.region.style('visibility', b.hasArcType() ? 'hidden' : 'visible'),
        b.mainRegion = b.main.select('.' + i.regions)
                           .selectAll('.' + i.region)
                           .data(c.regions),
        b.mainRegion.enter()
            .append('g')
    ...
    var b = this, c = b.regionX.bind(b), d = b.regionY.bind(b),
        e = b.regionWidth.bind(b), f = b.regionHeight.bind(b);
    a.push(b.mainRegion.selectAll('rect')
               .transition()
               .attr('x', c)
               .attr('y', d)
               .attr('width', e)
    ...
    return b = 'y' === a.axis || 'y2' === a.axis ?
        d.axis_rotated && 'start' in a ? e(a.start) : 0 :
        d.axis_rotated ?
        0 :
        'start' in a ? c.x(c.isTimeSeries() ? c.parseDate(a.start) : a.start) :
                       0
  }, f.regionY = function(a) {
    var b, c = this, d = c.config, e = 'y' === a.axis ? c.y : c.y2;
    return b = 'y' === a.axis || 'y2' === a.axis ?
        d.axis_rotated ? 0 : 'end' in a ? e(a.end) : 0 :
        d.axis_rotated && 'start' in a ?
        c.x(c.isTimeSeries() ? c.parseDate(a.start) : a.start) :
        0
  }, f.regionWidth = function(a) {
    var b, c = this, d = c.config, e = c.regionX(a),
           f = 'y' === a.axis ? c.y : c.y2;
    return b = 'y' === a.axis || 'y2' === a.axis ?
               d.axis_rotated && 'end' in a ? f(a.end) : c.width :
               d.axis_rotated ?
               c.width :
               'end' in a ? c.x(c.isTimeSeries() ? c.parseDate(a.end) : a.end) :
                            c.width,
           e > b ? 0 : b - e
  }, f.regionHeight = function(a) {
    var b, c = this, d = c.config, e = this.regionY(a),
           f = 'y' === a.axis ? c.y : c.y2;
    return b = 'y' === a.axis || 'y2' === a.axis ?
               d.axis_rotated ? c.height :
                                'start' in a ? f(a.start) : c.height :
    ...
    k.hasArcType() ||
        l.data_selection_enabled && (!l.zoom_enabled || k.zoom.altDomain) &&
            l.data_selection_multiple &&
            (b = k.dragStart[0], c = k.dragStart[1], d = a[0], e = a[1],
             f = Math.min(b, d), g = Math.max(b, d),
             ...
             m.selectAll('.' + i.shapes)
                 ...
                 .each(function(a, b) {
                   var c, d, e, l, m, o, p = n.select(this),
                                         ...
                                         r = p.classed(i.INCLUDED), s = !1;
                   if (p.classed(i.circle))
                     c = 1 * p.attr('cx'), d = 1 * p.attr('cy'),
                     m = k.togglePoint, s = c > f && g > c && d > h && j > d;
                   else {
                     if (!p.classed(i.bar)) return;
                     o = v(this), c = o.x, d = o.y, e = o.width, l = o.height,
                     m = k.togglePath,
                     s = !(c > g || f > c + e || d > j || h > d + l)
                   }
                   s ^ r &&
                       (p.classed(i.INCLUDED, !r), p.classed(i.SELECTED, !q),
                        m.call(k, !q, p, a, b))
                 }))
    ...
    b.hasArcType() ||
        c.data_selection_enabled &&
            (b.dragStart = a,
             b.main.select('.' + i.chart)
                 .append('rect')
                 .attr('class', i.dragarea)
                 .style('opacity', .1),
             b.dragging = !0, b.config.data_ondragstart.call(b.api))
  }, f.dragend = function() {
    var a = this, b = a.config;
    a.hasArcType() ||
        b.data_selection_enabled &&
            (a.main.select('.' + i.dragarea)
                 .transition()
                 .duration(100)
                 .style('opacity', 0)
                 .remove(),
             a.main.selectAll('.' + i.shape).classed(i.INCLUDED, !1),
             a.dragging = !1, a.config.data_ondragend.call(a.api))
    ...
    e.data_onselected.call(d.api, b, a.node()),
        d.main.select('.' + i.selectedCircles + d.getTargetSelectorSuffix(b.id))
    ...
    c.config.data_onselected.call(c, b, a.node()),
        a.transition().duration(100).style('fill', function() {
    ...
    var c, d = this;
    return 'circle' === a.nodeName ?
               c = d.isStepType(b) ? function() {} : d.togglePoint :
               'path' === a.nodeName && (c = d.togglePath),
               c
  }, f.toggleShape = function(a, b, c) {
    var d = this, e = d.d3, f = d.config, g = e.select(a),
        h = g.classed(i.SELECTED), j = d.getToggle(a, b).bind(d);
    f.data_selection_enabled && f.data_selection_isselectable(b) &&
        (f.data_selection_multiple ||
             d.main
                 ...
                 .each(function(a, b) {
                   var c = e.select(this);
                   c.classed(i.SELECTED) &&
                       j(!1, c.classed(i.SELECTED, !1), a, b)
                 }),
    ...
    var a = this, b = a.config,
        c = a.context =
            a.svg.append('g').attr('transform', a.getTranslate('context'));
    b.subchart_show || c.style('visibility', 'hidden'),
        c.append('g')
            .attr('clip-path', a.clipPathForSubchart)
            .attr('class', i.chart),
        c.select('.' + i.chart).append('g').attr('class', i.chartBars),
        c.select('.' + i.chart).append('g').attr('class', i.chartLines),
        c.append('g')
            .attr('clip-path', a.clipPath)
            .attr('class', i.brush)
            .call(a.brush)
            .selectAll('rect')
            .attr(
                b.axis_rotated ? 'width' : 'height',
                b.axis_rotated ? a.width2 : a.height2),
        a.axes.subx =
            c.append('g')
                .attr('class', i.axisX)
    ...
    var b, c, d, e, f = this, g = f.context, h = f.config,
                    j = f.classChartBar.bind(f), k = f.classBars.bind(f),
                    l = f.classChartLine.bind(f), m = f.classLines.bind(f),
                    n = f.classAreas.bind(f);
    h.subchart_show &&
        (e = g.select('.' + i.chartBars)
                 .selectAll('.' + i.chartBar)
                 .data(a)
                 .attr('class', j),
         d = e.enter().append('g').style('opacity', 0).attr('class', j),
         d.append('g').attr('class', k),
         c = g.select('.' + i.chartLines)
                 .selectAll('.' + i.chartLine)
                 .data(a)
                 .attr('class', l),
         b = c.enter().append('g').style('opacity', 0).attr('class', l),
         b.append('g').attr('class', m), b.append('g').attr('class', n))
  }, f.redrawSubchart = function(a, b, c, d, e, f, g) {
    var h, j, k, l, m, n, o = this, p = o.d3, q = o.context, r = o.config,
                          s = o.barData.bind(o), t = o.lineData.bind(o),
                          u = o.classBar.bind(o), v = o.classLine.bind(o),
                          w = o.classArea.bind(o), x = o.initialOpacity.bind(o);
    r.subchart_show &&
        (p.event && 'zoom' === p.event.type &&
             o.brush.extent(o.x.orgDomain()).update(),
         a &&
             (o.brush.empty() || o.brush.extent(o.x.orgDomain()).update(),
              l = o.generateDrawArea(e, !0), m = o.generateDrawBar(f, !0),
              n = o.generateDrawLine(g, !0),
              k = q.selectAll('.' + i.bars).selectAll('.' + i.bar).data(s),
              k.enter()
                  .append('path')
                  .attr('class', u)
                  .style('stroke', 'none')
              ...
              k.style('opacity', x)
                  ...
                  .attr('d', m)
                  .style('opacity', 1),
              k.exit().transition().duration(c).style('opacity', 0).remove(),
              h = q.selectAll('.' + i.lines).selectAll('.' + i.line).data(t),
              h.enter()
                  .append('path')
                  .attr('class', v)
              ...
              h.style('opacity', x)
                  ...
                  .attr('d', n)
                  .style('opacity', 1),
              h.exit().transition().duration(c).style('opacity', 0).remove(),
              j = q.selectAll('.' + i.areas).selectAll('.' + i.area).data(t),
              j.enter()
                  .append('path')
                  .attr('class', w)
                  .style('fill', o.color)
                  .style(
                      'opacity',
                      function() {
                        return o.orgAreaOpacity =
                                   +p.select(this).style('opacity'),
                               0
                      }),
              j.style('opacity', 0)
                  .transition()
                  ...
                  .attr('d', l)
                  .style('fill', o.color)
                  .style('opacity', o.orgAreaOpacity),
              j.exit().transition().duration(d).style('opacity', 0).remove()))
    ...
    var a = this, b = a.config,
        c = k(b.axis_x_extent) ? b.axis_x_extent(a.getXDomain(a.data.targets)) :
                                 b.axis_x_extent;
        ...
        c.behavior.zoom()
            .on('zoomstart',
                function() {
                  ...
                  b.zoom.altDomain =
                      c.event.sourceEvent.altKey ? b.x.orgDomain() : null,
            ...
            .on('zoomend',
                function() {
                  ...
                  e && a.clientX === e.clientX && a.clientY === e.clientY ||
                      (b.redrawEventRect(), b.updateZoom(),
    ...
    a.main.select('.' + i.zoomRect).call(b).on('dblclick.zoom', null),
        a.main.selectAll('.' + i.eventRect).call(b).on('dblclick.zoom', null)
    ...
    if (c.zoom_enabled && 0 !== a.filterTargetsToShow(a.data.targets).length) {
      ...
      a.isCategorized() && e.orgDomain()[0] === a.orgXDomain[0] &&
    ...
    return function(a) {
      var b, c = a.id || a;
      return d[c] instanceof Function ?
                 b = d[c](a) :
                 d[c] ? b = d[c] :
                        (g.indexOf(c) < 0 && g.push(c),
                         b = e[g.indexOf(c) % e.length], d[c] = b),
                 f instanceof Function ? f(b, a) : b
    }
  }, f.generateLevelColor = function() {
    var a = this, b = a.config, c = b.color_pattern, d = b.color_threshold,
        e = 'value' === d.unit, f = d.values && d.values.length ? d.values : [],
        g = d.max || 100;
    ...
    var b = this, c = b.config,
        d = c.axis_y2_tick_format ? c.axis_y2_tick_format :
    ...
    return 'function' == typeof c.format ?
               d = c.format :
               'object' == typeof c.format && c.format[a] && (d = c.format[a]),
               d
  ...
  f.generateClass = function(a, b) {
    ...
    return this.generateClass(i.region, b) + ' ' +
        ('class' in a ? a['class'] : '')
  ...
  var j = f.isValue = function(a) {
    ...
    var b = a.getBoundingClientRect(),
        c = [a.pathSegList.getItem(0), a.pathSegList.getItem(1)], d = c[0].x,
  ...
  e.focus = function(a) {
    ...
    c.hasArcType() && c.expandArc(a), c.toggleFocusLegend(a, !0),
    ...
    a = c.mapToTargetIds(a),
    b = c.svg.selectAll(c.selectorTargets(a.filter(c.isTargetToShow, c))),
    this.revert(), b.classed(i.focused, !1).classed(i.defocused, !0),
    c.hasArcType() && c.unexpandArc(a), c.toggleFocusLegend(a, !1),
    ...
    var b, c = this.internal;
    a = c.mapToTargetIds(a), b = c.svg.selectAll(c.selectorTargets(a)),
    b.classed(i.focused, !1).classed(i.defocused, !1),
    c.hasArcType() && c.unexpandArc(a),
    c.config.legend_show && c.showLegend(a.filter(c.isLegendToShow.bind(c))),
    c.focusedTargetIds = [], c.defocusedTargetIds = []
  }, e.show = function(a, b) {
    ...
    var b = this.internal;
    return a &&
               (b.isTimeSeries() && (a = a.map(function(a) {
    ...
    var b, c, d, e, f, g, h, i, k = this.internal, l = [],
                                m = k.getMaxDataCount(), o = 0, p = 0;
    if (a.json)
      c = k.convertJsonToData(a.json, a.keys);
    else if (a.rows)
      c = k.convertRowsToData(a.rows);
    else {
      if (!a.columns) return;
    ...
    k.data.targets.forEach(function(a) {
      ...
      for (b = 0; b < l.length; b++)
        if (a.id === l[b])
          for (p = a.values[a.values.length - 1].index + 1, c = 0; o > c; c++)
            a.values.push({
              id: a.id,
              index: p + c,
    ...
    k.data.targets = k.data.targets.concat(b), d = k.getMaxDataCount(),
    f = k.data.targets[0], g = f.values[0],
    n(a.to) ? (o = 0, i = k.isTimeSeries() ? k.parseDate(a.to) : a.to,
               f.values.forEach(function(a) {
                 a.x < i && o++
               })) :
              n(a.length) && (o = a.length),
    m ? 1 === m && k.isTimeSeries() &&
            (h = (f.values[f.values.length - 1].x - g.x) / 2,
             e = [new Date(+g.x - h), new Date(+g.x + h)],
             k.updateXDomain(null, !0, !0, !1, e)) :
        (h = k.isTimeSeries() ? f.values.length > 1 ?
                                f.values[f.values.length - 1].x - g.x :
                                g.x - k.getXDomain(k.data.targets)[0] :
                                1,
         e = [g.x - h, g.x], k.updateXDomain(null, !0, !0, !1, e)),
    k.updateTargets(k.data.targets), k.redraw({
      flow: {
        index: g.index,
        length: o,
    ...
    return function() {
      var e, f, g,
          h = a.targets, j = a.flow, k = a.drawBar, l = a.drawLine,
          m = a.drawArea, n = a.cx, o = a.cy, p = a.xv, r = a.xForText,
          s = a.yForText, t = a.duration, u = 1, v = j.index, w = j.length,
          x = b.getValueOnIndex(b.data.targets[0].values, v),
          y = b.getValueOnIndex(b.data.targets[0].values, v + w),
          z = b.x.domain(), A = j.duration || t, B = j.done || function() {},
          C = b.generateWait(), D = b.xgrid || d.selectAll([]),
          E = b.xgridLines || d.selectAll([]),
          F = b.mainRegion || d.selectAll([]),
          G = b.mainText || d.selectAll([]), H = b.mainBar || d.selectAll([]),
          I = b.mainLine || d.selectAll([]), J = b.mainArea || d.selectAll([]),
          K = b.mainCircle || d.selectAll([]);
      b.flowing = !0, b.data.targets.forEach(function(a) {
        a.values.splice(0, w)
      }),
      g = b.updateXDomain(h, !0, !0), b.updateXGrid && b.updateXGrid(!0),
      j.orgDataCount ?
          e = 1 === j.orgDataCount || x.x === y.x ?
          b.x(z[0]) - b.x(g[0]) :
          b.isTimeSeries() ? b.x(z[0]) - b.x(g[0]) : b.x(x.x) - b.x(y.x) :
          1 !== b.data.targets[0].values.length ?
          e = b.x(z[0]) - b.x(g[0]) :
          b.isTimeSeries() ?
          (x = b.getValueOnIndex(b.data.targets[0].values, 0),
           y = b.getValueOnIndex(
               b.data.targets[0].values, b.data.targets[0].values.length - 1),
           e = b.x(x.x) - b.x(y.x)) :
          e = q(g) / 2,
      u = q(z) / q(g), f = 'translate(' + e + ',0) scale(' + u + ',1)',
      b.hideXGridFocus(), b.hideTooltip(),
      d.transition()
          .ease('linear')
          .duration(A)
          ...
          .call(C, function() {
            ...
            if (w) {
              ...
              b.svg.selectAll('.' + i.shapes).selectAll(d).remove(),
                  b.svg.selectAll('.' + i.texts).selectAll(e).remove(),
                  b.svg.selectAll('.' + i.eventRects).selectAll(f).remove(),
            ...
            D.attr('transform', null).attr(b.xgridAttr),
                ...
                c.interaction_enabled && b.redrawEventRect(), B(),
                b.flowing = !1
          })
    }
    ...
    return c.merge(
        b.main.selectAll('.' + i.shapes + b.getTargetSelectorSuffix(a))
            .selectAll('.' + i.shape)
            .filter(function() {
    ...
    f.data_selection_enabled &&
        d.main.selectAll('.' + i.shapes)
            .selectAll('.' + i.shape)
            .each(function(g, h) {
              var j = e.select(this), k = g.data ? g.data.id : g.id,
                  l = d.getToggle(this, g).bind(d),
                  m = f.data_selection_grouped || !a || a.indexOf(k) >= 0,
                  o = !b || b.indexOf(h) >= 0, p = j.classed(i.SELECTED);
              j.classed(i.line) || j.classed(i.area) ||
                  (m && o ?
                       f.data_selection_isselectable(g) && !p &&
    ...
    e.data_selection_enabled &&
        c.main.selectAll('.' + i.shapes)
            .selectAll('.' + i.shape)
            .each(function(f, g) {
              var h = d.select(this), j = f.data ? f.data.id : f.id,
                  k = c.getToggle(this, f).bind(c),
                  l = e.data_selection_grouped || !a || a.indexOf(j) >= 0,
                  m = !b || b.indexOf(g) >= 0, n = h.classed(i.SELECTED);
              h.classed(i.line) || h.classed(i.area) ||
                  l && m && e.data_selection_isselectable(f) && n &&
    ...
    f.withTransitionForTransform = !1, d.transiting = !1, d.setTargetType(a, b),
    d.updateAndRedraw(f)
  }, e.groups = function(a) {
    var b = this.internal, c = b.config;
    ...
    var b = this.internal, c = b.config;
    return a ? (c.grid_x_lines = a, b.redrawWithoutRescale(), c.grid_x_lines) :
               c.grid_x_lines
    ...
    var b = this.internal, c = b.config;
    return a ? (c.grid_y_lines = a, b.redrawWithoutRescale(), c.grid_y_lines) :
               c.grid_y_lines
    ...
    return a = a || {}, b = e.getOption(a, 'duration', f.transition_duration),
           c = e.getOption(a, 'classes', [i.region]),
           d = e.main.select('.' + i.regions).selectAll(c.map(function(a) {
             return '.' + a
           })),
    ...
    return a &&
               (b = this.data(a),
                c = b[0] ? b[0].values.map(function(a) {
                  return a.value
                }) :
                           null),
           c
    ...
    return arguments.length > 1 && (d.axis_x_categories[a] = b, c.redraw()),
    ...
    return arguments.length ?
        ('object' == typeof a ?
             (j(a.x) && (c.axis_x_max = a.x), j(a.y) && (c.axis_y_max = a.y),
    ...
    return arguments.length ?
        ('object' == typeof a ?
             (j(a.x) && (c.axis_x_min = a.x), j(a.y) && (c.axis_y_min = a.y),
    ...
    return arguments.length ? (n(a.max) && this.axis.max(a.max),
    ...
    var b = this.internal, c = b.config;
    c.size_width = a ? a.width : null, c.size_height = a ? a.height : null,
    this.flush()
  }, e.flush = function() {
    var a = this.internal;
    a.updateAndRedraw(
        {withLegend: !0, withTransition: !1, withTransitionForTransform: !1})
  }, e.destroy = function() {
    var b = this.internal;
    b.data.targets = void 0, b.data.xs = {},
    b.selectChart.classed('c3', !1).html(''),
    a.clearInterval(b.intervalForObserveInserted), a.onresize = null
    ...
    a.mouse && (c = a.mouse),
        ...
        d.dispatchEvent('mouseover', b, c), d.dispatchEvent('mousemove', b, c)
