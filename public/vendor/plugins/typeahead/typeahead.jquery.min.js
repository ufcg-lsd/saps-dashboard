...
!function(a) {
  var b = function() {
    ...
    function c(c) {
      ...
      g = b.bind(this._onKeydown, this), i = b.bind(this._onInput, this),
      this.$hint = a(c.hint),
      this.$input =
          a(c.input).on('blur.tt', e).on('focus.tt', f).on('keydown.tt', g),
      0 === this.$hint.length &&
    ...
    'use strict';
    function e(d) {
      d = d || {}, d.templates = d.templates || {},
      d.source || a.error('missing source'),
      d.name && !j(d.name) && a.error('invalid dataset name: ' + d.name),
      this.query = null, this.highlight = !!d.highlight,
      this.name = d.name || b.getUniqueId(), this.source = d.source,
           ...
           b.mixin(e.prototype, f, {
             _render: function(e, f) {
               ...
               function i() {
                 function h(b) {
                   var e;
                   return e = a(c.suggestion)
                                  .append(p.templates.suggestion(b))
                                  .data(k, p.name)
                                  .data(l, p.displayFn(b))
                                  .data(m, b),
                 ...
                 return i = a(c.suggestions).css(d.suggestions),
                        j = b.map(f, h), i.append.apply(i, j),
                        p.highlight && g({
    ...
    function c(c) {
      ...
      this.isEmpty = !0, this.datasets = b.map(c.datasets, e),
    ...
    function f(c) {
      ...
      f = this.$node.find('.tt-input'), i = this.$node.find('.tt-hint'),
      f.on(
          'blur.tt',
          function(a) {
            var c, e, g;
            c = document.activeElement, e = d.is(c), g = d.has(c).length > 0,
            b.isMsie() && (e || g) &&
      ...
      this.dropdown =
          new j({menu: d, datasets: c.datasets})
    ...
    function g(b, e) {
      var f, g, h, j;
      f = a(b), g = a(c.wrapper).css(d.wrapper),
      h = a(c.dropdown).css(d.dropdown), j = f.clone().css(d.hint).css(i(f)),
      j.val('')
          .removeData()
          .addClass('tt-hint')
    ...
    return b.mixin(f.prototype, {
      ...
      _updateHint: function() {
        ...
        a && this.dropdown.isVisible() && !this.input.hasOverflow() ?
            (c = this.input.getInputValue(), d = h.normalizeQuery(c),
      ...
      destroy: function() {
        this.input.destroy(), this.dropdown.destroy(), k(this.$node),
            this.$node = null
      }
    }),
           f
  ...
  !function() {
    ...
    c = a.fn.typeahead, d = 'ttTypeahead', f = {
      initialize: function(c, f) {
        ...
        return f = b.isArray(f) ? f : [].slice.call(arguments, 1), c = c || {},
               this.each(g)
      },
      open: function() {
        function b() {
