  ...
  var b = function() {
    ...
    return {
      isMsie:
          ...
          isArray: a.isArray, isFunction: a.isFunction,
          isObject: a.isPlainObject, isUndefined: function(a) {
            ...
            return function() {
              ...
              return f =
                ...
                d = null, c || (e = a.apply(h, i))
                     ...
                     g = c && !d, clearTimeout(d), d = setTimeout(f, b),
                     g && (e = a.apply(h, i)), e
            }
    ...
    return {
      nonword: c, whitespace: a, obj: {nonword: d(c), whitespace: d(a)}
    }
  }(), e = function() {
    'use strict';
    function c(c) {
      this.maxSize = b.isNumber(c) ? c : 100, this.reset(),
           ...
           b.mixin(d.prototype, {
             add: function(a) {
               this.head && (a.next = this.head, this.head.prev = a),
                   this.head = a, this.tail = this.tail || a
             },
             remove: function(a) {
    ...
    'use strict';
    function a(a) {
      this.prefix = ['__', a, '__'].join(''), this.ttlKey = '__ttl__',
    ...
    return g = f && window.JSON ? {
      ...
      set: function(a, e, g) {
        return b.isNumber(g) ? f.setItem(this._ttlKey(a), d(c() + g)) :
    ...
    'use strict';
    function c(b) {
      b = b || {}, this.cancelled = !1, this.lastUrl = null,
    ...
    return c.setMaxPendingRequests =
               function(a) {
      h = a
    },
           c.resetCache =
           ...
           b.mixin(c.prototype, {
             _get: function(a, b, c) {
               ...
               var j, k = this;
               this.cancelled || a !== this.lastUrl ||
                   ((j = g[a]) ?
                        j.done(d).fail(e) :
                        h > f ?
                        (f++,
                         g[a] = this._send(a, b).done(d).fail(e).always(i)) :
                        this.onDeckRequestArgs = [].slice.call(arguments, 0))
             },
             get: function(a, c, d) {
               var e;
               return b.isFunction(c) && (d = c, c = {}),
                      this.cancelled = !1, this.lastUrl = a,
    ...
    function c(b) {
      ...
      this.queryTokenizer = b.queryTokenizer, this.reset()
    }
    function d(a) {
    ...
    return b.mixin(c.prototype, {
      ...
      add: function(a) {
        ...
        a = b.isArray(a) ? a : [a], b.each(a, function(a) {
          var f, g;
          f = c.datums.push(a) - 1, g = d(c.datumTokenizer(a)),
          b.each(g, function(a) {
            var b, d, g;
    ...
    function e(d) {
      ...
      return f = {
        ...
        ajax: {}
             ...
             (e = d.prefetch || null) &&
                 (e = b.isString(e) ? {url: e} : e, e = b.mixin(f, e),
  ...
  !function(c) {
    ...
    function e(b) {
      b && (b.local || b.prefetch || b.remote) ||
          ...
          this.limit = b.limit || 5, this.sorter = j(b.sorter),
          this.dupDetector = b.dupDetector || k, this.local = i.local(b),
          this.prefetch = i.prefetch(b), this.remote = i.remote(b),
    ...
    return l = c.Bloodhound,
           ...
           e.tokenizers = d, b.mixin(e.prototype, {
             _loadPrefetch: function(b) {
               function c(a) {
                 f.clear(), f.add(b.filter ? b.filter(a) : a),
             ...
             _getFromRemote: function(a, b) {
               ...
               var d, e, f = this;
               if (this.transport)
                 return a = a || '', e = encodeURIComponent(a),
             ...
             _initialize: function() {
               ...
               return d = this.prefetch ? this._loadPrefetch(this.prefetch) :
                                          a.Deferred().resolve(),
                      f && d.done(c),
             ...
             initialize: function(a) {
               return !this.initPromise || a ? this._initialize() :
                                               this.initPromise
             },
             add: function(a) {
               this.index.add(a)
             ...
             get: function(a, c) {
               ...
               var e = this, f = [], g = !1;
               f = this.index.get(a), f = this.sorter(f).slice(0, this.limit),
               f.length < this.limit ? g = this._getFromRemote(a, d) :
  ...
  var j = function() {
    ...
    function e(a) {
      ...
      for (a = a.split(i), d = [].slice.call(arguments, 1);
        ...
        e = f(c.sync, this, [b].concat(d)), g = f(c.async, this, [b].concat(d)),
        e() && j(g);
      return this
    }
    function f(a, b, c) {
      ...
      function f(b) {
        ...
        return (c = h.exec(b.data)) &&
                   (f = a.createElement(e.tagName),
                    ...
                    d = b.splitText(c.index), d.splitText(c[0].length),
    ...
    function c(c) {
      var e, f, h, i, j = this;
      c = c || {}, c.input || a.error('input is missing'),
      e = b.bind(this._onBlur, this), f = b.bind(this._onFocus, this),
      h = b.bind(this._onKeydown, this), i = b.bind(this._onInput, this),
      this.$hint = a(c.hint),
      this.$input =
          a(c.input).on('blur.tt', e).on('focus.tt', f).on('keydown.tt', h),
      0 === this.$hint.length &&
          (this.setHint = this.getHint = this.clearHint =
               this.clearHintIfInvalid = b.noop),
      b.isMsie() ?
          this.$input.on(
      ...
      this.query = this.$input.val(), this.$overflowHelper = d(this.$input)
    }
    function d(b) {
      ...
      40: 'down'
           ...
           b.mixin(c.prototype, m, {
             ...
             _managePreventDefault: function(a, b) {
               ...
               switch (a) {
                 case 'tab':
                   d = this.getHint(), e = this.getInputValue(),
                   c = d && d !== e && !f(b);
                   break;
                 case 'up':
                 case 'down':
             ...
             _checkInputValue: function() {
               var a, b, c;
               a = this.getInputValue(), b = e(a, this.query),
               c = b ? this.query.length !== a.length : !1, this.query = a,
               b ? c && this.trigger('whitespaceChanged', this.query) :
             ...
             clearHintIfInvalid: function() {
               var a, b, c, d;
               a = this.getInputValue(), b = this.getHint(),
               c = a !== b && 0 === b.indexOf(a),
             ...
             destroy: function() {
               this.$hint.off('.tt'), this.$input.off('.tt'),
    ...
    function c(c) {
      ...
      this.query = null, this.highlight = !!c.highlight,
      this.name = c.name || b.getUniqueId(), this.source = c.source,
             ...
             _render: function(c, d) {
               ...
               function f() {
                 ...
                 return f = a(j.suggestions).css(k.suggestions),
                        l = b.map(d, e), f.append.apply(f, l),
                        p.highlight && n({
    ...
    function c(c) {
      var e, f, g, h = this;
      c = c || {}, c.menu || a.error('menu is required'), this.isOpen = !1,
      this.isEmpty = !0, this.datasets = b.map(c.datasets, d),
    ...
    return b.mixin(c.prototype, m, {
      ...
      _moveCursor: function(a) {
        var b, c, d, e;
        if (this.isOpen) {
          if (c = this._getCursor(), b = this._getSuggestions(),
              this._removeCursor(), d = b.index(c) + a,
              d = (d + 1) % (b.length + 1) - 1, -1 === d)
            return void this.trigger('cursorRemoved');
          -1 > d && (d = b.length - 1), this._setCursor(e = b.eq(d)),
              this._ensureVisible(e)
        }
      },
      _ensureVisible: function(a) {
        var b, c, d, e;
        b = a.position().top, c = b + a.outerHeight(!0),
        d = this.$menu.scrollTop(),
        e = this.$menu.height() + parseInt(this.$menu.css('paddingTop'), 10) +
            parseInt(this.$menu.css('paddingBottom'), 10),
        0 > b ? this.$menu.scrollTop(d + b) :
                c > e && this.$menu.scrollTop(d + (c - e))
      },
      close: function() {
        this.isOpen &&
            (this.isOpen = !1, this._removeCursor(), this._hide(),
             this.trigger('closed'))
      },
      open: function() {
        this.isOpen ||
            (this.isOpen = !0, !this.isEmpty && this._show(),
             this.trigger('opened'))
      },
    ...
    function c(c) {
      var e, f, g;
      c = c || {}, c.input || a.error('missing input'), this.isActivated = !1,
      ...
      f = this.$node.find('.tt-input'), g = this.$node.find('.tt-hint'),
      f.on(
          'blur.tt',
          function(a) {
            var c, d, g;
            c = document.activeElement, d = e.is(c), g = e.has(c).length > 0,
            b.isMsie() && (d || g) &&
      ...
      this.dropdown =
          new q({menu: e, datasets: c.datasets})
    ...
    function d(b, c) {
      var d, f, h, i;
      d = a(b), f = a(j.wrapper).css(k.wrapper),
      h = a(j.dropdown).css(k.dropdown), i = d.clone().css(k.hint).css(e(d)),
      i.val('')
          .removeData()
          .addClass('tt-hint')
    ...
    return b.mixin(c.prototype, {
      ...
      _onEnterKeyed: function(a, b) {
        ...
        c ? (this._select(c), b.preventDefault()) :
      ...
      _setLanguageDirection: function() {
        ...
        this.dir !== (a = this.input.getLanguageDirection()) &&
            (this.dir = a, this.$node.css('direction', a),
      ...
      _updateHint: function() {
        ...
        a && this.dropdown.isVisible() && !this.input.hasOverflow() ?
            (c = this.input.getInputValue(), d = o.normalizeQuery(c),
             e = b.escapeRegExChars(d),
             f = new RegExp('^(?:' + e + ')(.+$)', 'i'), g = f.exec(a.value),
             g ? this.input.setHint(c + g[1]) : this.input.clearHint()) :
            this.input.clearHint()
      },
      _autocomplete: function(a) {
        var b, c, d, e;
        b = this.input.getHint(), c = this.input.getQuery(),
      ...
      destroy: function() {
        this.input.destroy(), this.dropdown.destroy(), f(this.$node),
            this.$node = null
      }
    }),
           c
  ...
  !function() {
    ...
    c = a.fn.typeahead, d = 'ttTypeahead', e = {
      initialize: function(c, e) {
        ...
        return e = b.isArray(e) ? e : [].slice.call(arguments, 1), c = c || {},
               this.each(f)
      },
      open: function() {
        function b() {
