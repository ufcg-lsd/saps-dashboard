...
function Bloodhound(o) {
  ...
  this.cacheKey =
      this.prefetch ? this.prefetch.cacheKey || this.prefetch.url : null;
  this.index = new SearchIndex(
      {datumTokenizer: o.datumTokenizer, queryTokenizer: o.queryTokenizer});
...
var highlight = function(doc) {
  ...
  function getRegex(patterns, caseSensitive, wordsOnly) {
    ...
    regexStr = wordsOnly ? '\\b(' + escapedPatterns.join('|') + ')\\b' :
  ...
  _.mixin(Input.prototype, EventEmitter, {
    ...
    _checkInputValue: function checkInputValue() {
      ...
      hasDifferentWhitespace =
          areEquivalent ? this.query.length !== inputValue.length : false;
  ...
  _.mixin(Dataset.prototype, EventEmitter, {
    _render: function render(query, suggestions) {
      ...
      function getHeaderHtml() {
        return that.templates.header({query: query, isEmpty: !hasSuggestions});
      }
      function getFooterHtml() {
        return that.templates.footer({query: query, isEmpty: !hasSuggestions});
      }
    },
...
var Typeahead = function() {
  ...
  function Typeahead(o) {
    ...
    this.dropdown =
        new Dropdown({menu: $menu, datasets: o.datasets})
    ...
    this.input =
        new Input({input: $input, hint: $hint})
