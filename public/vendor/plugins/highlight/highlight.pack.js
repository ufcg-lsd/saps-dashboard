var hljs = new function() {
  ...
  function c(T, L, J, R) {
    ...
    function w(aa, Y, X, W) {
      var U = W ? '' : b.classPrefix, V = '<span class="' + U,
          Z = X ? '' : '</span>';
      V += aa + '">';
      return V + Y + Z
    }
...
hljs.registerLanguage('ruby', function(f) {
  ...
  var k = {
    cN: 'comment',
    v: [
      {b: '#', e: '$', c: [b]}, {b: '^\\=begin', e: '^\\=end', c: [b], r: 10},
      {b: '^__END__', e: '\\n$'}
    ]
  };
  ...
  return {
    aliases: ['rb', 'gemspec', 'podspec', 'thor', 'irb'], k: i,
  ...
  return {
    aliases: ['js'], k: {
      ...
      built_in:
        ...
        c: [
          {cN: 'pi', b: /^\s*('|")use strict('|")/, r: 10}, a.ASM, a.QSM,
          a.CLCM, a.CBCM, a.CNM, {
...
hljs.registerLanguage('php', function(b) {
  ...
  var c = {
    ...
    c: [b.BE, a],
    v: [
      {b: 'b"', e: '"'}, {b: 'b\'', e: '\''}, b.inherit(b.ASM, {i: null}),
      b.inherit(b.QSM, {i: null})
    ]
  };
  var d = {v: [b.BNM, b.CNM]};
  return {
    aliases: ['php3', 'php4', 'php5', 'php6'], cI: true,
...
hljs.registerLanguage('coffeescript', function(c) {
  ...
  var d = [
    c.BNM, c.inherit(c.CNM, {starts: {e: '(\\s*/)?', r: 0}}), {
      cN: 'string',
      v: [
        {b: /'''/, e: /'''/, c: [c.BE]}, {b: /'/, e: /'/, c: [c.BE]},
        {b: /"""/, e: /"""/, c: [c.BE, e]}, {b: /"/, e: /"/, c: [c.BE, e]}
      ]
    },
    {
      cN: 'regexp',
      v: [
        {b: '///', e: '///', c: [e, c.HCM]}, {b: '//[gim]*', r: 0},
        {b: /\/(?![ *])(\\\/|.)*?\/[gim]*(?=\W|$)/}
      ]
    },
    {cN: 'property', b: '@' + a},
  ...
  e.c = d;
  return {
    aliases: ['coffee', 'cson', 'iced'], k: b, i: /\/\*/, c: d.concat([
