...
jQuery.validator.addMethod('iban', function(value, element) {
  ...
  if (!(/^([a-zA-Z0-9]{4} ){2,8}[a-zA-Z0-9]{1,4}|[a-zA-Z0-9]{12,34}$/.test(
          value))) {
    return false;
  }
  ...
  var iban =
      value.replace(/ /g, '').toUpperCase();  // remove spaces and to upper case
...
//  $prefix to '0' Extract $2 and remove hyphens, spaces and parentheses. Phone
//  number is combined $prefix and $2.
...
// http://www.apache.org/licenses/LICENSE-2.0 Valid Types: mastercard, visa,
// amex, dinersclub, enroute, discover, jcb, unknown, all (overrides all other
// settings)
...
jQuery.validator.addMethod(
    'require_from_group', function(value, element, options) {
      ...
      var validOrNot = $(selector, element.form)
                           .filter(function() {
...
jQuery.validator.addMethod(
    ...
    function(value, element, options) {
      ...
      var numberFilled = $(selector, element.form)
                             .filter(function() {
                               return validator.elementValue(this);
                             })
                             .length;
...
jQuery.validator.addMethod('accept', function(value, element, param) {
  ...
  var typeParam = typeof param === 'string' ?
