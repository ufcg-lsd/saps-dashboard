  ...
  t.extend(t.fn, {
    validate: function(e) {
      ...
      return i ?
          ...
          (this.attr('novalidate', 'novalidate'),
           i = new t.validator(e, this[0]), t.data(this[0], 'validator', i),
           i.settings.onsubmit &&
    ...
    rules: function(e, i) {
      ...
      var o = t.validator.normalizeRules(
          t.extend(
              {}, t.validator.classRules(s), t.validator.attributeRules(s),
                   ...
                   prototype:
                       {
                         init:
                             function() {
                               function e(e) {
                                 ...
                                 i.settings[s] &&
                                     i.settings[s].call(i, this[0], e)
                               }
                               this.labelContainer =
                                   t(this.settings.errorLabelContainer),
                         ...
                         showErrors: function(e) {
                           if (e) {
                             ...
                             this.successList =
                                 t.grep(this.successList, function(t) {
                                   return !(t.name in e)
                                 })
                           }
                         ...
                         findLastActive: function() {
                           ...
                           return e &&
                               1 === t.grep(this.errorList, function(t) {
                         ...
                         check: function(e) {
                           e = this.validationTargetFor(this.clean(e));
                           var i, s = t(e).rules(), r = !1,
                                  n = this.elementValue(e);
                           for (var a in s) {
                             var u = {method: a, parameters: s[a]};
                             try {
                               if (i = t.validator.methods[a].call(
                                       this, n, e, u.parameters),
                         ...
                         addWrapper: function(t) {
                           return this.settings.wrapper &&
                                      (t = t.add(
                                           t.parent(this.settings.wrapper))),
                                  t
                         },
                         ...
                         validElements: function() {
                           return this.currentElements.not(
                         ...
                         optional: function(e) {
                           ...
                           return !t.validator.methods.required.call(
                                      this, i, e) &&
                               'dependency-mismatch'
                         },
