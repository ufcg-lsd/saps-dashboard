  ...
  ajax: function(origSettings) {
    ...
    $.each(mockHandlers, function(k, v) {
          ...
          if (m.data && s.data) {
            ...
            (function ident(mock, live) {
              ...
              if (typeof live === 'string') {
                ...
                identical =
                    $.isFunction(mock.test) ? mock.test(live) : mock == live;
                return identical;
              }
      ...
      if (m) {
        ...
        // jQuery core here because there isn't an easy hook for the cross
        // domain script tag of jsonp
        if (s.dataType === 'jsonp') {
          ...
          xhr: function() {
            ...
            return {
              ...
              send: function() {
                ...
                var process = (function(that) {
                  return function() {
                    return (function() {
                             ...
                             // Copy over our mock to our xhr object before
                             // passing control back to jQuery's
                             // onreadystatechange callback
                             if (s.dataType == 'json' &&
                                 (typeof m.responseText == 'object')) {
                               this.responseText =
                                   JSON.stringify(m.responseText);
                             ...
                             // jQuery < 1.4 doesn't have onreadystate change
                             // for xhr
                             if ($.isFunction(this.onreadystatechange)) {
                               this.onreadystatechange(
                                   m.isTimeout ? 'timeout' : undefined);
                             }
                           })
                        .apply(that);
                  };
                ...
                if (m.proxy) {
                  // We're proxying this request and loading in an external file
                  // instead
                  _ajax({
                    global: false,
                    url: m.proxy,
                    ...
                    complete: function(xhr, txt) {
                      ...
                      this.responseTimer =
                          setTimeout(process, m.responseTime || 0);
                    }
                  });
                } else {
                  ...
                  if (s.async === false) {
                    ...
                    this.responseTimer =
                        setTimeout(process, m.responseTime || 50);
                  }
                }
              },
              abort: function() {
