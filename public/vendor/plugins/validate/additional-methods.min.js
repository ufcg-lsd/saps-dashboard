  ...
  jQuery.validator.addMethod(
    ...
    jQuery.validator.addMethod(
        ...
        function(t, e) {
          ...
          if (a.test(t)) {
            var r = t.split('/'), n = parseInt(r[0], 10),
                s = parseInt(r[1], 10), u = parseInt(r[2], 10),
                d = new Date(u, s - 1, n);
            i = d.getFullYear() === u && d.getMonth() === s - 1 &&
                    d.getDate() === n ?
                !0 :
                !1
          } else
    ...
    jQuery.validator.addMethod(
        ...
        function(t, e) {
          ...
          if (!/^([a-zA-Z0-9]{4} ){2,8}[a-zA-Z0-9]{1,4}|[a-zA-Z0-9]{12,34}$/
                   .test(t))
            return !1;
          var i = t.replace(/ /g, '').toUpperCase(), a = i.substring(0, 2),
              r = {
                AL: '\\d{8}[\\dA-Z]{16}',
                AD: '\\d{8}[\\dA-Z]{12}',
                AT: '\\d{16}',
          ...
          for (var u, d = i.substring(4, i.length) + i.substring(0, 4), o = '',
                      l = !0, h = 0;
               d.length > h; h++)
            u = d.charAt(h), '0' !== u && (l = !1),
    ...
    jQuery.validator.addMethod(
        ...
        function(t, e) {
          ...
          for (var i = t.replace(/ /g, ''), a = 0, r = i.length, n = 0; r > n;
               n++) {
    ...
    jQuery.validator.addMethod(
        ...
        function(t, e, i) {
          ...
          t = t.replace(/\D/g, '');
          var a = 0;
          return i.mastercard && (a |= 1), i.visa && (a |= 2),
                 i.amex && (a |= 4), i.dinersclub && (a |= 8),
                 i.enroute && (a |= 16), i.discover && (a |= 32),
                 i.jcb && (a |= 64), i.unknown && (a |= 128),
                 i.all && (a = 255),
                 1 & a && /^(5[12345])/.test(t) ?
                     16 === t.length :
                     2 & a && /^(4)/.test(t) ?
                     ...
                     64 & a && /^(3)/.test(t) ?
                     16 === t.length :
                     64 & a && /^(2131|1800)/.test(t) ? 15 === t.length :
                                                        128 & a ? !0 : !1
        },
    ...
    jQuery.validator.addMethod(
        ...
        function(t, e, i) {
          ...
          if (!$(e).data('being_validated')) {
            var s = $(r, e.form);
            s.data('being_validated', !0), s.valid(),
    ...
    jQuery.validator.addMethod(
        ...
        function(t, e, i) {
          ...
          if (!$(e).data('being_validated')) {
            var d = $(n, e.form);
            d.data('being_validated', !0), d.valid(),
