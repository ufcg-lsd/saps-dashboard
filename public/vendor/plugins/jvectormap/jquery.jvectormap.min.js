...
(function(e) {
  ...
  e.fn.vectorMap = function(e) {
    ...
    function(e) {
      function r(t) {
        var n = t || window.event, r = [].slice.call(arguments, 1), i = 0,
            s = !0, o = 0, u = 0;
        return t = e.event.fix(n), t.type = 'mousewheel',
               n.wheelDelta && (i = n.wheelDelta / 120),
               n.detail && (i = -n.detail / 3), u = i,
               n.axis !== undefined && n.axis === n.HORIZONTAL_AXIS &&
                   (u = 0, o = -1 * i),
...
jvm
 ...
 jvm.AbstractElement =
     function(e, t) {
   this.node = this.createElement(e), this.name = e, this.properties = {},
   t && this.set(t)
 },
 jvm.AbstractElement.prototype.set =
     function(e, t) {
   var n;
   if (typeof e == 'object')
 ...
 jvm.AbstractElement.prototype.get =
     function(e) {
   return this.properties[e]
 },
 jvm.AbstractElement.prototype.applyAttr =
     function(e, t) {
   this.node.setAttribute(e, t)
 },
 jvm.AbstractElement.prototype.remove =
     function() {
   jvm.$(this.node).remove()
 },
 jvm.AbstractCanvasElement =
     function(e, t, n) {
   this.container = e, this.setSize(t, n),
 ...
 jvm.AbstractCanvasElement.prototype.addPath =
     function(e, t, n) {
   var r = new jvm[this.classPrefix + 'PathElement'](e, t);
   return this.add(r, n), r
 },
 jvm.AbstractCanvasElement.prototype.addCircle =
     function(e, t, n) {
   var r = new jvm[this.classPrefix + 'CircleElement'](e, t);
   return this.add(r, n), r
 },
 jvm.AbstractCanvasElement.prototype.addGroup =
     function(e) {
   var t = new jvm[this.classPrefix + 'GroupElement'];
   return e ? e.node.appendChild(t.node) : this.node.appendChild(t.node),
          t.canvas = this, t
 },
 jvm.AbstractShapeElement =
     function(e, t, n) {
   this.style = n || {}, this.style.current = {}, this.isHovered = !1,
   this.isSelected = !1, this.updateStyle()
 },
 jvm.AbstractShapeElement.prototype.setHovered =
     function(e) {
   this.isHovered !== e && (this.isHovered = e, this.updateStyle())
 },
 jvm.AbstractShapeElement.prototype.setSelected =
     function(e) {
   this.isSelected !== e &&
       (this.isSelected = e, this.updateStyle(),
        jvm.$(this.node).trigger('selected', [e]))
 },
 jvm.AbstractShapeElement.prototype.setStyle =
     function(e, t) {
   var n = {};
   typeof e == 'object' ? n = e : n[e] = t, jvm.$.extend(this.style.current, n),
                          this.updateStyle()
 },
 jvm.AbstractShapeElement.prototype.updateStyle =
     function() {
   var e = {};
 ...
 jvm.SVGElement.prototype.createElement =
     function(e) {
   return document.createElementNS(jvm.SVGElement.svgns, e)
 },
 jvm.SVGElement.prototype.addClass =
     function(e) {
   this.node.setAttribute('class', e)
 },
 jvm.SVGElement.prototype.getElementCtr =
     function(e) {
   return jvm['SVG' + e]
 },
 jvm.SVGElement.prototype.getBBox =
     function() {
 ...
 jvm.SVGGroupElement.prototype.add =
     function(e) {
   this.node.appendChild(e.node)
 },
 jvm.SVGCanvasElement =
     function(e, t, n) {
   this.classPrefix = 'SVG', jvm.SVGCanvasElement.parentClass.call(this, 'svg'),
   jvm.AbstractCanvasElement.apply(this, arguments)
 },
 jvm.inherits(jvm.SVGCanvasElement, jvm.SVGElement),
 jvm.mixin(jvm.SVGCanvasElement, jvm.AbstractCanvasElement),
 jvm.SVGCanvasElement.prototype.setSize =
     function(e, t) {
   this.width = e, this.height = t, this.node.setAttribute('width', e),
 ...
 jvm.SVGCanvasElement.prototype.applyTransformParams =
   ...
   this.rootElement.node.setAttribute(
       'transform', 'scale(' + e + ') translate(' + t + ', ' + n + ')')
 },
 jvm.SVGShapeElement =
     function(e, t, n) {
 ...
 jvm.VMLElement.prototype.getElementCtr =
     function(e) {
   return jvm['VML' + e]
 },
 jvm.VMLElement.prototype.addClass =
     function(e) {
   jvm.$(this.node).addClass(e)
 },
 jvm.VMLElement.prototype.applyAttr =
     function(e, t) {
   this.node[e] = t
 },
 jvm.VMLElement.prototype.getBBox =
     function() {
   var e = jvm.$(this.node);
   return {
 ...
 jvm.VMLGroupElement =
   ...
   jvm.VMLGroupElement.parentClass.call(this, 'group'),
       this.node.style.left = '0px', this.node.style.top = '0px',
       this.node.coordorigin = '0 0'
 },
 jvm.inherits(jvm.VMLGroupElement, jvm.VMLElement),
 jvm.VMLGroupElement.prototype.add =
     function(e) {
   this.node.appendChild(e.node)
 },
 ...
 jvm.VMLCanvasElement.prototype.setSize =
     function(e, t) {
   var n, r, i, s;
   this.width = e, this.height = t, this.node.style.width = e + 'px',
   this.node.style.height = t + 'px', this.node.coordsize = e + ' ' + t,
   this.node.coordorigin = '0 0';
   if (this.rootElement) {
     n = this.rootElement.node.getElementsByTagName('shape');
     for (i = 0, s = n.length; i < s; i++)
       n[i].coordsize = e + ' ' + t, n[i].style.width = e + 'px',
       n[i].style.height = t + 'px';
     r = this.node.getElementsByTagName('group');
     for (i = 0, s = r.length; i < s; i++)
       r[i].coordsize = e + ' ' + t, r[i].style.width = e + 'px',
       r[i].style.height = t + 'px'
   }
 },
 jvm.VMLCanvasElement.prototype.applyTransformParams =
     function(e, t, n) {
   this.scale = e, this.transX = t, this.transY = n,
   this.rootElement.node.coordorigin = this.width - t - this.width / 100 + ',' +
 ...
 jvm.VMLShapeElement =
   ...
   jvm.VMLShapeElement.parentClass.call(this, e, t),
       ...
       this.node.appendChild(this.strokeElement.node), this.node.stroked = !1,
       jvm.AbstractShapeElement.apply(this, arguments)
 },
 jvm.inherits(jvm.VMLShapeElement, jvm.VMLElement),
 jvm.mixin(jvm.VMLShapeElement, jvm.AbstractShapeElement),
 jvm.VMLShapeElement.prototype.applyAttr =
     function(e, t) {
   switch (e) {
     case 'fill':
 ...
 jvm.VMLPathElement =
   ...
   jvm.VMLPathElement.parentClass.call(this, 'shape', e, t),
       this.node.coordorigin = '0 0', n.node.on = !0,
       n.node.matrix = '0.01,0,0,0.01,0,0', n.node.offset = '0,0',
       this.node.appendChild(n.node)
 },
 jvm.inherits(jvm.VMLPathElement, jvm.VMLShapeElement),
 jvm.VMLPathElement.prototype.applyAttr =
     function(e, t) {
   e === 'd' ? this.node.path = jvm.VMLPathElement.pathSvgToVml(t) :
               jvm.VMLShapeElement.prototype.applyAttr.call(this, e, t)
 },
 jvm.VMLPathElement.pathSvgToVml =
     function(e) {
   var t = '', n = 0, r = 0, i, s;
               ...
               function(e, t, o, u) {
                 ...
                 switch (t) {
                   ...
                   case 'V':
                     return r = o[0], 'l' + n + ',' + r;
                   case 'c':
                     return i = n + o[o.length - 4], s = r + o[o.length - 3],
                            n += o[o.length - 2], r += o[o.length - 1],
                            'v' + o.join(',');
                   case 'C':
                     return i = o[o.length - 4], s = o[o.length - 3],
                            n = o[o.length - 2], r = o[o.length - 1],
                            'c' + o.join(',');
                   case 's':
                     return o.unshift(r - s), o.unshift(n - i),
                            i = n + o[o.length - 4], s = r + o[o.length - 3],
                            n += o[o.length - 2], r += o[o.length - 1],
                            'v' + o.join(',');
                   case 'S':
                     return o.unshift(r + r - s), o.unshift(n + n - i),
                            i = o[o.length - 4], s = o[o.length - 3],
                            n = o[o.length - 2], r = o[o.length - 1],
                            'c' + o.join(',')
                 }
                 return ''
 ...
 jvm.VMLCircleElement.prototype.applyAttr =
     function(e, t) {
   switch (e) {
     case 'r':
 ...
 jvm.VectorCanvas =
   ...
   return this.mode = window.SVGAngle ? 'svg' : 'vml',
          this.mode == 'svg' ? this.impl = new jvm.SVGCanvasElement(e, t, n) :
 ...
 jvm.SimpleScale.prototype.getValue =
     function(e) {
   return e
 },
 jvm.OrdinalScale =
 ...
 jvm.OrdinalScale.prototype.getValue =
     function(e) {
   return this.scale[e]
 },
 jvm.NumericScale =
     function(e, t, n, r) {
   this.scale = [], t = t || 'linear', e && this.setScale(e),
   t && this.setNormalizeFunction(t), n && this.setMin(n), r && this.setMax(r)
 },
 jvm.NumericScale.prototype = {
   setMin: function(e) {
     this.clearMinValue = e,
     typeof this.normalize == 'function' ? this.minValue = this.normalize(e) :
                                           this.minValue = e
   },
   setMax: function(e) {
     this.clearMaxValue = e,
     typeof this.normalize == 'function' ? this.maxValue = this.normalize(e) :
                                           this.maxValue = e
   },
   setScale: function(e) {
     var t;
   ...
   getValue: function(e) {
     ...
     return i == this.scale.length - 1 ?
                ...
                e = this.vectorToNum(this.vectorAdd(
                    this.scale[i],
                    this.vectorMult(
                        this.vectorSubtract(this.scale[i + 1], this.scale[i]),
                        e / t[i]))),
 ...
 jvm.ColorScale.numToRgb =
     function(e) {
   e = e.toString(16);
   while (e.length < 6) e = '0' + e;
   return '#' + e
 },
 jvm.ColorScale.rgbToArray =
     function(e) {
   return e = e.substr(1), [
     parseInt(e.substr(0, 2), 16), parseInt(e.substr(2, 2), 16),
 ...
 jvm.DataSeries =
     function(e, t) {
   var n;
   e = e || {}, e.attribute = e.attribute || 'fill', this.elements = t,
   this.params = e, e.attributes && this.setAttributes(e.attributes),
   jvm.$.isArray(e.scale) ?
       (n = e.attribute === 'fill' || e.attribute === 'stroke' ?
            jvm.ColorScale :
            jvm.NumericScale,
        this.scale = new n(e.scale, e.normalizeFunction, e.min, e.max)) :
       e.scale ? this.scale = new jvm.OrdinalScale(e.scale) :
     ...
     if (this.scale instanceof jvm.OrdinalScale ||
       ...
       if (!this.params.min || !this.params.max) {
         ...
         this.params.min || this.scale.setMin(n),
             this.params.max || this.scale.setMax(t), this.params.min = n,
                                                      this.params.max = t
       }
       for (i in e)
         r = parseFloat(e[i]),
 ...
 jvm.Proj = {
   ...
   mill_inv: function(e, t, n) {
     return {
       lat: (
           2.5 * Math.atan(Math.exp(.8 * t / this.radius)) - 5 * Math.PI / 8) *
           this.degRad,
   ...
   aea: function(e, t, n) {
     var r = 0, i = n * this.radDeg, s = 29.5 * this.radDeg,
         o = 45.5 * this.radDeg, u = e * this.radDeg, a = t * this.radDeg,
     ...
     return {
       x: h * Math.sin(c) * this.radius, y: -(p - h * Math.cos(c)) * this.radius
     }
   },
   aea_inv: function(e, t, n) {
     var r = e / this.radius, i = t / this.radius, s = 0, o = n * this.radDeg,
         u = 29.5 * this.radDeg, a = 45.5 * this.radDeg,
   ...
   lcc: function(e, t, n) {
     var r = 0, i = n * this.radDeg, s = t * this.radDeg, o = 33 * this.radDeg,
         u = 45 * this.radDeg, a = e * this.radDeg,
         f = Math.log(Math.cos(o) * (1 / Math.cos(u))) /
         Math.log(
   ...
   lcc_inv: function(e, t, n) {
     var r = e / this.radius, i = t / this.radius, s = 0, o = n * this.radDeg,
         u = 33 * this.radDeg, a = 45 * this.radDeg,
         f = Math.log(Math.cos(u) * (1 / Math.cos(a))) /
         Math.log(
 ...
 jvm.WorldMap =
   ...
   this.mapData = jvm.WorldMap.maps[this.params.map], this.markers = {},
   this.regions = {}, this.regionsColors = {}, this.regionsData = {},
   ...
   for (n in jvm.WorldMap.apiEvents)
     this.params[n] &&
         this.container.bind(
             jvm.WorldMap.apiEvents[n] + '.jvectormap', this.params[n]);
   this.canvas =
   ...
   this.bindElementEvents(), this.createLabel(),
   this.params.zoomButtons && this.bindZoomButtons(), this.createRegions(),
   this.createMarkers(this.params.markers || {}), this.setSize(),
   this.params.focusOn &&
 ...
 jvm.WorldMap.prototype = {
     ...
     this.width / this.height > this.defaultWidth / this.defaultHeight ?
         ...
         (this.baseScale = this.width / this.defaultWidth,
          this.baseTransY =
              ...
              (2 * this.baseScale)),
         this.scale *= this.baseScale / e, this.transX *= this.baseScale / e,
         this.transY *= this.baseScale / e
   },
   setSize: function() {
     this.width = this.container.width(), this.height = this.container.height(),
     this.resize(), this.canvas.setSize(this.width, this.height),
     this.applyTransform()
   },
   reset: function() {
     var e, t;
     ...
     this.scale = this.baseScale, this.transX = this.baseTransX,
     this.transY = this.baseTransY, this.applyTransform()
   },
   applyTransform: function() {
     var e, t, n, r;
     this.defaultWidth * this.scale <= this.width ?
         (e = (this.width - this.defaultWidth * this.scale) / (2 * this.scale),
          n = (this.width - this.defaultWidth * this.scale) /
              (2 * this.scale)) :
         (e = 0,
         ...
         (t = (this.height - this.defaultHeight * this.scale) /
              (2 * this.scale),
          r = (this.height - this.defaultHeight * this.scale) /
              (2 * this.scale)) :
         (t = 0,
   ...
   bindContainerEvents: function() {
     ...
     this.container
         .mousemove(function(i) {
           return e &&
                      (r.transX -= (t - i.pageX) / r.scale,
                       r.transY -= (n - i.pageY) / r.scale, r.applyTransform(),
                       t = i.pageX, n = i.pageY),
                  !1
         })
         ...
         this.container.mousewheel(function(e, t, n, i) {
           var s = jvm.$(r.container).offset(), o = e.pageX - s.left,
               u = e.pageY - s.top, a = Math.pow(1.3, i);
       ...
       a.type == 'touchstart' && (u = 0),
           ...
           (u == 1 &&
                (h = n.transX, p = n.transY,
                 ...
                 n.transY -= (i - f[0].pageY) / n.scale, n.applyTransform(),
                 n.label.hide(),
                 (h != n.transX || p != n.transY) && a.preventDefault()),
            r = f[0].pageX, i = f[0].pageY) :
           f.length == 2 &&
               (u == 2 ? (c = Math.sqrt(
                                  Math.pow(f[0].pageX - f[1].pageX, 2) +
                                  Math.pow(f[0].pageY - f[1].pageY, 2)) /
                              t,
                          n.setScale(e * c, s, o), n.label.hide(),
                          a.preventDefault()) :
     ...
     this.container.mousemove(function() {
       t = !0
         ...
         this.container.delegate(
             '[class~=\'jvectormap-element\']', 'mouseover mouseout',
             function(t) {
               var n = this,
                   r = jvm.$(this).attr('class').baseVal ?
                   jvm.$(this).attr('class').baseVal :
                   jvm.$(this).attr('class'),
                   i = r.indexOf('jvectormap-region') === -1 ? 'marker' :
                                                               'region',
                   s = i == 'region' ? jvm.$(this).attr('data-code') :
                                       jvm.$(this).attr('data-index'),
                   o = i == 'region' ? e.regions[s].element :
                                       e.markers[s].element,
                   u = i == 'region' ? e.mapData.paths[s].name :
                                       e.markers[s].config.name || '',
                   a = jvm.$.Event(i + 'LabelShow.jvectormap'),
                   f = jvm.$.Event(i + 'Over.jvectormap');
               t.type == 'mouseover' ?
                   (e.container.trigger(f, [s]),
                    f.isDefaultPrevented() || o.setHovered(!0), e.label.text(u),
                    e.container.trigger(a, [e.label, s]),
                    a.isDefaultPrevented() ||
                        (e.label.show(), e.labelWidth = e.label.width(),
                         e.labelHeight = e.label.height())) :
                   (o.setHovered(!1), e.label.hide(),
                    e.container.trigger(i + 'Out.jvectormap', [s]))
             }),
         this.container.delegate(
             '[class~=\'jvectormap-element\']', 'mousedown',
             function(e) {
               t = !1
             }),
         this.container.delegate(
             '[class~=\'jvectormap-element\']', 'mouseup', function(n) {
               var r = this,
                   i = jvm.$(this).attr('class').baseVal ?
                   jvm.$(this).attr('class').baseVal :
                   jvm.$(this).attr('class'),
                   s = i.indexOf('jvectormap-region') === -1 ? 'marker' :
                                                               'region',
                   o = s == 'region' ? jvm.$(this).attr('data-code') :
                                       jvm.$(this).attr('data-index'),
                   u = jvm.$.Event(s + 'Click.jvectormap'),
                   a = s == 'region' ? e.regions[o].element :
                                       e.markers[o].element;
               if (!t) {
   ...
   createLabel: function() {
     ...
     this.container.mousemove(function(t) {
       ...
       n < 5 && (n = t.pageX + 15), r < 5 && (r = t.pageY + 15),
   ...
   setScale: function(e, t, n, r) {
     ...
     e > this.params.zoomMax *this.baseScale ?
         ...
         e < this.params.zoomMin * this.baseScale &&
             (e = this.params.zoomMin * this.baseScale),
         typeof t != 'undefined' && typeof n != 'undefined' &&
         (i = e / this.scale,
          r ? (this.transX = t +
              ...
              i &&
                  (typeof r == 'undefined' ?
                       ...
                       (s = {
                         x: Math.min(r.x, i.x),
                         y: Math.min(r.y, i.y),
                         width: Math.max(r.x + r.width, i.x + i.width) -
                             Math.min(r.x, i.x),
                         height: Math.max(r.y + r.height, i.y + i.height) -
                             Math.min(r.y, i.y)
                       },
                        r = s)));
       this.setScale(
       ...
       jvm.$(t.node).bind(
           ...
           function(e, t) {
             n.container.trigger(
                 ...
                 [jvm.$(this).attr('data-code'), t, n.getSelectedRegions()])
           }),
   ...
   latLngToPoint: function(e, t) {
     var n, r = jvm.WorldMap.maps[this.params.map].projection,
            ...
            o = this.height - this.baseTransY * 2 * this.baseScale, u, a,
            f = this.scale / this.baseScale;
     return t < -180 + i && (t += 360),
            n = jvm.Proj[r.type](e, t, i), u = this.getInsetForPoint(n.x, n.y),
            u ? (a = u.bbox,
                 n.x =
   ...
   pointToLatLng: function(e, t) {
     var n = jvm.WorldMap.maps[this.params.map].projection,
         r = n.centralMeridian, i = jvm.WorldMap.maps[this.params.map].insets,
         s, o, u, a, f;
   ...
   createSeries: function() {
     ...
     for (t in this.params.series)
       for (e = 0; e < this.params.series[t].length; e++)
         this.series[t][e] =
             new jvm.DataSeries(this.params.series[t][e], this[t])
   },
   remove: function() {
     this.label.remove(), this.container.remove(),
