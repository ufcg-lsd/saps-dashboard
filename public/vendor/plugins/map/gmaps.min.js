...
var GMaps = function(e) {
  ...
  var n = function(e) {
    ...
    var r = this, i,
        ...
        a = e.el || e.div, f = e.markerClusterer,
        l = google.maps.MapTypeId[e.mapType.toUpperCase()],
        c = new google.maps.LatLng(e.lat, e.lng), h = e.zoomControl || true,
        p = e.zoomControlOpt || {style: 'DEFAULT', position: 'TOP_LEFT'},
        d = p.style || 'DEFAULT', v = p.position || 'TOP_LEFT',
        m = e.panControl || true, g = e.mapTypeControl || true,
        y = e.scaleControl || true, b = e.streetViewControl || true,
        w = w || true, E = {}, S = {zoom: this.zoom, center: c, mapTypeId: l},
        x = {
          panControl: m,
          zoomControl: h,
          zoomControlOptions: {
            style: google.maps.ZoomControlStyle[d],
    ...
    var T = function(e, t) {
      ...
      var h = findAbsolutePosition.apply(this, [r.el]),
          p = h[0] + t.pixel.x - 15, d = h[1] + t.pixel.y - 15;
      u.style.left = p + 'px';
      u.style.top = d + 'px';
    ...
    this.setContextMenu = function(e) {
      ...
      for (n in e.options) {
        if (e.options.hasOwnProperty(n)) {
          var s = e.options[n];
          window.context_menu[r.el.id][e.control][s.name] = {
            title: s.title,
            action: s.action
          }
        }
...
GMaps.prototype.createMarker = function(e) {
  ...
  var t = this, n = e.details, r = e.fences, i = e.outside,
...
GMaps.prototype.drawOverlay = function(e) {
  ...
  t.onAdd = function() {
    ...
    var r = this.getPanes(), i = r[e.layer],
...
GMaps.prototype.drawCircle = function(e) {
  e = extend_object(
      {map: this.map, center: new google.maps.LatLng(e.lat, e.lng)}, e);
  delete e.lat;
  delete e.lng;
  var t = new google.maps.Circle(e), n = [
    'click', 'dblclick', 'mousedown', 'mousemove', 'mouseout', 'mouseover',
    'mouseup', 'rightclick'
  ];
...
GMaps.prototype.drawRectangle = function(e) {
  ...
  e.bounds = t;
  var n = new google.maps.Rectangle(e), r = [
    'click', 'dblclick', 'mousedown', 'mousemove', 'mouseout', 'mouseover',
    'mouseup', 'rightclick'
  ];
...
GMaps.prototype.drawPolygon = function(e) {
  ...
  var n = new google.maps.Polygon(e), r = [
    'click', 'dblclick', 'mousedown', 'mousemove', 'mouseout', 'mouseover',
    'mouseup', 'rightclick'
  ];
  for (var i = 0; i < r.length; i++) {
...
GMaps.prototype.toImage = function(e) {
  ...
  if (this.polylines.length > 0) {
    ...
    t['polyline'] = {};
    t['polyline']['path'] =
        google.maps.geometry.encoding.encodePath(r.getPath());
...
GMaps.createPanorama = function(e) {
  ...
  var n =
      ...
      r = extend_object({visible: true}, e);
...
GMaps.fire = function(e, t, n) {
  if (GMaps.custom_events.indexOf(e) == -1) {
    google.maps.event.trigger(
        t, e, Array.prototype.slice.apply(arguments).slice(2))
  } else {
  ...
  google.maps.Polygon.prototype.containsLatLng = function(e) {
    ...
    for (var i = 0; i < r; i++) {
      ...
      for (var a = 0; a < o; a++) {
        var f = s.getAt(a);
        var l = s.getAt(u);
        if (f.lng() < e.lng() && l.lng() >= e.lng() ||
            l.lng() < e.lng() && f.lng() >= e.lng()) {
          if (f.lat() +
                  (e.lng() - f.lng()) / (l.lng() - f.lng()) *
                      (l.lat() - f.lat()) <
              e.lat()) {
            n = !n
          }
