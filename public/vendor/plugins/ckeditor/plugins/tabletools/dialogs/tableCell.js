...
CKEDITOR.dialog.add('cellProperties', function(g) {
  function d(a) {
    return function(b) {
      ...
      'undefined' != typeof c &&
          (this.setValue(c),
           CKEDITOR.env.gecko && ('select' == this.type && !c) &&
  ...
  var h = g.lang.table, c = h.cell, e = g.lang.common,
      i = CKEDITOR.dialog.validate, l = /^(\d+(?:\.\d+)?)(px|%)$/,
      f = {type: 'html', html: '&nbsp;'}, m = 'rtl' == g.lang.dir,
  ...
  return {
    title: c.title,
            ...
            children: [
              {
                ...
                children: [
                  ...
                  f, {
                    ...
                    'default': '',
                    items: [
                      [e.notSet, ''], [e.alignLeft, 'left'],
                      [e.alignCenter, 'center'], [e.alignRight, 'right'],
                  ...
                  },
                  {
                    ...
                    'default': '',
                    items: [
                      [e.notSet, ''], [e.alignTop, 'top'],
                      [e.alignMiddle, 'middle'], [e.alignBottom, 'bottom'],
              ...
              f, {
                ...
                children: [
                  ...
                  f, {
                    ...
                    setup: d(function(a) {
                      if ((a = parseInt(a.getAttribute('rowSpan'), 10)) &&
                          1 != a)
                        return a
                    }),
                    commit: function(a) {
                  ...
                  },
                  {
                    ...
                    setup: d(function(a) {
                      if ((a = parseInt(a.getAttribute('colSpan'), 10)) &&
                          1 != a)
                        return a
                    }),
                    commit: function(a) {
                      var b = parseInt(this.getValue(), 10);
                      b && 1 != b ? a.setAttribute('colSpan', this.getValue()) :
        ...
        onShow: function() {
          ...
          for (var a = this._.editor.getSelection(), b = a.createBookmarks(),
                   c = this.cells, d = 0;
               d < c.length; d++)
