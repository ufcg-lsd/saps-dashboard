...
function A(a) {
  for (var a = a.toUpperCase(), c = B.length, b = 1, f = 1; 0 < a.length;
       f *= c)
...
var H = /^([.\d]*)+(em|ex|px|gd|rem|vw|vh|vm|ch|mm|cm|in|pt|pc|deg|rad|ms|s|hz|khz){1}?/i,
    ...
    z =
        [
          [1E3, 'M'], [900, 'CM'], [500, 'D'], [400, 'CD'], [100, 'C'],
          [90, 'XC'], [50, 'L'], [40, 'XL'], [10, 'X'], [9, 'IX'], [5, 'V'],
          [4, 'IV'], [1, 'I']
        ],
    B = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', s = 0, t = null, w,
    E = CKEDITOR.plugins.pastefromword = {
        ...
        resolveList: function(a) {
          ...
          if ((b = a.removeAnyChildWithName('cke:listbullet')) && b.length &&
            ...
            return a.name = 'cke:li',
                   ...
                   CKEDITOR.tools.extend(c, b.attributes), !0;
          w = t = s = null;
          return !1
        },
      ...
      filters: {
        ...
        assembleList: function(a) {
          for (var c = a.children, b, f, d, e, h, j, a = [], g, m, i, l, k, p,
                   n = 0;
               n < c.length; n++)
            if (b = c[n], 'cke:li' == b.name)
              if (b.name = 'li', f = b.attributes,
                  i = (i = f['cke:listsymbol']) &&
                      i.match(/^(?:[(]?)([^\s]+?)([.)]?)$/),
                  l = k = p = null, f['cke:ignored'])
                c.splice(n--, 1);
              else {
                ...
                if (j) {
                  if (d > e)
                    a.push(j = new CKEDITOR.htmlParser.element(l)), j.add(b),
                        h.add(j);
                  else {
                    if (d < e) {
                      e -= d;
          ...
          for (n = 0; n < a.length; n++)
            if (j = a[n], q = j.children, g = g = void 0, u = j.children.length,
                r = g = void 0, c = /list-style-type:(.*?)(?:;|$)/,
                e = CKEDITOR.plugins.pastefromword.filters.stylesFilter,
                g = j.attributes, !c.exec(g.style)) {
              for (h = 0; h < u; h++)
                if (g = q[h],
                    g.attributes.value && Number(g.attributes.value) == h + 1 &&
        ...
        elementMigrateFilter: function(a, c) {
          return a ? function(b) {
            ...
            CKEDITOR.tools.extend(
                b.attributes, CKEDITOR.tools.clone(f.attributes));
      ...
      getRules: function(a, c) {
        var b = CKEDITOR.dtd,
            ...
            d = a.config, e = this.filters, h = e.falsyFilter,
            j = e.stylesFilter, g = e.elementMigrateFilter,
            m = CKEDITOR.tools.bind(
                this.filters.styleMigrateFilter, this.filters),
            i = this.utils.createListBulletMarker, l = e.flattenList,
            k = e.assembleList, p = this.utils.isListBulletIndicator,
            n = this.utils.isContainingOnlySpaces, q = this.utils.resolveList,
            u =
                function(a) {
              a = CKEDITOR.tools.convertToPx(a);
              return isNaN(a) ? a : a + 'px'
            },
            r = this.utils.getStyleComponents, t = this.utils.listDtdParents,
                ...
                style:
                    function(a) {
                      if (CKEDITOR.env.gecko) {
                        var a = (a = a.onlyChild().value.match(
                        ...
                        a &&
                            (a.replace(/[\n\r]/g, '')
                                 .replace(
                                     /(.+?)\{(.+?)\}/g,
                                     function(a, b, F) {
                                       for (var b = b.split(','), a = b.length,
                                                d = 0;
                                            d < a; d++)
                                         CKEDITOR.tools.trim(b[d]).replace(
                                             /^(\w+)(\.[\w-]+)?$/g,
                                             function(a, b, d) {
                                               b = b || '*';
                    ...
                    function(a) {
                      ...
                      q(a) ||
                          (d.enterMode == CKEDITOR.ENTER_BR ?
                               ...
                               g(d['format_' +
                                   (d.enterMode == CKEDITOR.ENTER_P ? 'p' :
                                                                      'div')])(
                                   a))
                    },
                div:
                            ...
                            (d = (d || '').split(';'),
                             ...
                             b.size &&
                                 (d.push(
                                      ...
                                      (3 < b.size ?
                                           'large' :
                                           3 > b.size ? 'small' : 'medium')),
                                  delete b.size),
                             a.name = 'span', a.addStyle(d.join(';')))
                      }
                    },
                span:
                    function(a) {
                        ...
                        [
                          ...
                          [
                            ...
                            function(a) {
                              ...
                              if (CKEDITOR.env.gecko)
                                return a.replace(
                                    /-moz-use-text-color/g, 'transparent')
                            }
                          ],
                          [/^margin$/, D], ['text-indent', '0cm'],
                          ['page-break-before'], ['tab-stops'],
