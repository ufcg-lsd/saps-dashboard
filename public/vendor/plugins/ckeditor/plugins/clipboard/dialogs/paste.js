...
CKEDITOR.dialog.add('paste', function(c) {
  function h(a) {
    var b = new CKEDITOR.dom.document(a.document), f = b.getBody(),
  ...
  return {
    title: e.title,
        ...
        minHeight: CKEDITOR.env.quirks ? 250 : 245, onShow: function() {
          ...
          elements: [
            ...
            },
            {
              ...
              focus: function() {
                ...
                !b || b.isReadOnly() ? a.setCustomData('pendingFocus', 1) :
                                       b.focus()
              },
              setup: function() {
                var a = this.getDialog(),
                    b = '<html dir="' + c.config.contentsLangDirection +
                    '" lang="' + (c.config.contentsLanguage || c.langCode) +
                    ...
                    d = CKEDITOR.dom.element.createFromHtml(
                        ...
                        f + '" role="region" aria-label="' + e.pasteArea +
                        '" aria-describedby="' +
