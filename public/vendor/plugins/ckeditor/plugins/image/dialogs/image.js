...
var r = function(c, j) {
  ...
  var f = 1, k = /^\s*(\d+)((px)|\%)?\s*$/i,
      ...
      l =
        ...
        if ('check' == b) {
          if (!a.userlockRatio && 'true' == d.getCustomData('isReady')) {
            ...
            !e && !c ? a.lockRatio = !0 :
                       !isNaN(d) && !isNaN(f) &&
                    Math.round(d) == Math.round(f) && (a.lockRatio = !0)
          }
        } else
          void 0 != b ? a.lockRatio = b :
                        (a.userlockRatio = 1, a.lockRatio = !a.lockRatio);
        e = CKEDITOR.document.getById(p);
        a.lockRatio ? e.removeClass('cke_btn_unlocked') :
                      e.addClass('cke_btn_unlocked');
        e.setAttribute('aria-checked', a.lockRatio);
        CKEDITOR.env.hc &&
            e.getChild(0).setHtml(
                a.lockRatio ? CKEDITOR.env.ie ? '■' : '▣' :
                              CKEDITOR.env.ie ? '□' : '▢');
        return a.lockRatio
      },
      x =
      ...
      p = n('btnLockSizes'), u = n('btnResetSize'), m = n('ImagePreviewLoader'),
      A = n('previewLink'), z = n('previewImage');
  return {
    title: c.lang.image['image' == j ? 'title' : 'titleButton'], minWidth: 420,
        minHeight: 360,
        onShow:
            function() {
            ...
            function() {
              ...
              this.originalElement &&
                  (this.originalElement.removeListener('load', q),
                   ...
                   this.originalElement.remove(), this.originalElement = !1);
                        ...
                        if (0 < b.length) {
                          ...
                          a.preview &&
                              (t.setAttribute('src', b),
                               a.preview.setAttribute('src', t.$.src), g(a))
                        } else
                          a.preview &&
                ...
                commit: function(a, b) {
                  a == f ? (this.getValue() || this.isChanged()) &&
                          b.setAttribute('alt', this.getValue()) :
                           4 == a ? b.setAttribute('alt', this.getValue()) :
                        ...
                        children: [
                          ...
                          },
                          {
                            ...
                            html:
                                ...
                                '" class="cke_btn_reset" id="' + u +
                                '" role="button"><span class="cke_label">' +
                                c.lang.image.resetSize + '</span></a></div>'
                          }
                        ]
                      },
                      {
                  ...
                  },
                  {
                    ...
                    commit: function(a, b) {
                      a == f ?
                          ...
                          4 == a ? b.setAttribute('title', this.getValue()) :
