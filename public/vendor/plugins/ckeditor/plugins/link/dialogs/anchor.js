...
CKEDITOR.dialog.add('anchor', function(c) {
  ...
  return {
    title: c.lang.link.anchor.title, minWidth: 300, minHeight: 60,
        onOk: function() {
          ...
          if (this._.selectedElement)
            this._.selectedElement.data('cke-realelement') ?
                (a = d(c, a), a.replace(this._.selectedElement),
          ...
          var a = c.getSelection(), b = a.getSelectedElement(),
              ...
              e = d ? CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, b) :
                      CKEDITOR.plugins.link.getSelectedLink(c);
          e &&
              (this._.selectedElement = e,
               this.setValueOf(
                   'info', 'txtName', e.data('cke-saved-name') || ''),
               !d && a.selectElement(e), b && (this._.selectedElement = b));
