...
CKEDITOR.dialog.add('link', function(g) {
  ...
  return {
    title:b.title,minWidth:350,minHeight:230,contents:[{id:'info',label:b.info,title:b.info,elements:[{id:'linkType',type:'select',label:b.type,'default':'url',items:[[b.toUrl,'url'],
