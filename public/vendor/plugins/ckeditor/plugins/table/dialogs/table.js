...
function n(a, e) {
  ...
  return {
    title: a.lang.table.title, minWidth: 310,
        ...
        onShow:
            function() {
              var g = a.getSelection(), d = g.getRanges(), c,
                  ...
                  ((g = g.getSelectedElement()) && g.is('table') ?
                       ...
                       0 < d.length &&
                           (CKEDITOR.env.webkit &&
                            ...
                            c = a.elementPath(d[0].getCommonAncestor(!0))
                                    .contains('table', 1)),
                   this._.selectedElement = c);
              c ? (this.setupContent(c), b && b.disable(), h && h.disable()) :
        ...
        onOk:
            function() {
              var g = a.getSelection(),
                  ...
                  c = this._.selectedElement || l('table'), b = {};
                  ...
                  for (i = 0; i < c.$.rows.length; i++)
                    ...
                    'tbody' == j.getParent().getName() &&
                        (f = new CKEDITOR.dom.element(j.$.cells[0]),
                         f.renameNode('td'), f.removeAttribute('scope'));
                b.txtHeight ? c.setStyle('height', b.txtHeight) :
                              c.removeStyle('height');
                b.txtWidth ? c.setStyle('width', b.txtWidth) :
                             c.removeStyle('width');
                ...
                children: [
                  {
                    ...
                    setup: function(a) {
                      ...
                      if (0 < a.count()) {
                        var a = a.getItem(0),
                            d = a.getFirst(CKEDITOR.dom.walker.nodeType(
                    ...
                    commit: function(e, d) {
                      if (this.isEnabled()) {
                        ...
                        if (c)
                          0 < b.count() ? (b = b.getItem(0), b.setHtml('')) :
