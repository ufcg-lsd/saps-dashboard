...
(function() {
function q(a) {
  return a && a.domId && a.getInputElement().$ ? a.getInputElement() :
                                                 a && a.$ ? a : !1
}
function z(a) {
  ...
  return {
    getCurrentLangGroup: function(c) {
      a: {
        for (var d in a) for (var f in
                              a[d]) if (f.toUpperCase() === c.toUpperCase()) {
          c = d;
          break a
        } c = ''
      } return c
...
var e = function() {
  ...
  return {
    postMessage: {
      ...
      send:
          function(a) {
            var b = Object.prototype.toString, f = a.fn || null, g = a.id || '',
                e = a.target || window, i = a.message || {id: g};
            a.message && '[object Object]' == b.call(a.message) &&
                (a.message.id || (a.message.id = g), i = a.message);
                    ...
                    'none' ===
                        (document.defaultView &&
                             ...
                             document.defaultView.getComputedStyle(a, null)
                                 .display :
                             a.currentStyle ? a.currentStyle.display :
                                              a.style.display))
              },
          hasClass:
              function(a, b) {
                return !(
                    !a.className ||
                    !a.className.match(RegExp('(\\s|^)' + b + '(\\s|$)')))
              }
        }
  }
}(), a = a || {};
...
var A = function(b) {
  var c, d;
  for (d in b)
    c = b[d].instance.getElement().getFirst() || b[d].instance.getElement(),
...
a.framesetHtml = function(b) {
  return '<iframe id=' + a.iframeNumber + '_' + b +
...
a.setIframe = function(b, c) {
  ...
  d = d.contentWindow ?
      d.contentWindow :
      d.contentDocument.document ? d.contentDocument.document :
                                   d.contentDocument;
  d.document.open();
  d.document.write(
...
a.setHeightFrame = function() {
  document.getElementById(a.iframeNumber + '_' + a.dialog._.currentTabId)
      .style.height = '240px'
};
a.sendData = function(b) {
  ...
  var e = function(e) {
    e = e || window.event;
    e.data.getTarget().is('a') && c != b._.currentTabId &&
        (c = b._.currentTabId, d = b._.contents[c].Content,
         f = a.iframeNumber + '_' + c, a.div_overlay.setEnable(),
         d.getElement().getChildCount() ?
             v(a.targetFromFrame[f], a.cmd[c]) :
             (a.setIframe(d, c), g = document.getElementById(f),
...
a.buildSelectLang = function(a) {
  var c = new CKEDITOR.dom.element('div'),
      d = new CKEDITOR.dom.element('select'), a = 'wscLang' + a;
...
a.buildOptionLang = function(b, c) {
  var d = document.getElementById('wscLang' + c),
      f = document.createDocumentFragment(), g, e, i = [];
  if (0 === d.options.length) {
    for (g in b) i.push([g, b[g]]);
    i.sort();
    for (var k = 0; k < i.length; k++)
      g = document.createElement('option'), g.setAttribute('value', i[k][1]),
      e = document.createTextNode(i[k][0]), g.appendChild(e),
      i[k][1] == a.selectingLang && g.setAttribute('selected', 'selected'),
      f.appendChild(g);
    d.appendChild(f)
  }
};
...
var s =
        function(a) {
  var c = document, d = a.target || c.body, f = a.id || 'overlayBlock',
      g = a.opacity || '0.9', a = a.background || '#f1f1f1',
      e = c.getElementById(f), i = e || c.createElement('div');
  i.style.cssText =
      'position: absolute;top:30px;bottom:41px;left:1px;right:1px;z-index: 10020;padding:0;margin:0;background:' +
      a + ';opacity: ' + g + ';filter: alpha(opacity=' + 100 * g +
      ');display: none;';
  i.id = f;
  e || d.appendChild(i);
  return {
    ...
    C =
      ...
      e.setAttributes(
          {type: 'radio', value: c, name: 'wscGrammerSuggest', id: i});
    ...
    n =
        function(b) {
      var c = new z(b), b = 'wscLang' + a.dialog.getParentEditor().name,
    ...
    D =
      ...
      if ('no_any_suggestions' == b) {
        ...
        a.LocalizationButton.ChangeTo.instance.enable(),
            ...
            a.LocalizationButton.ChangeTo.instance.getElement().setStyle(
                'color', '#333'),
            a.LocalizationButton.ChangeAll.instance.getElement().setStyle(
                'color', '#333');
      return b
    },
    F = {
      ...
      grammerSuggest: function(b) {
        ...
        for (var b = b.grammSuggest, c = b.length, d = !0, f = 0; f < c; f++)
          a.grammerSuggest.getElement().append(C(b[f], b[f], d)), d = !1;
        l();
        a.div_overlay.setDisable()
      },
      ...
      finish: function(b) {
        ...
        b = a.dialog
                .getContentElement(
                    a.dialog._.currentTabId, 'BlockFinishChecking')
                .getElement();
      ...
      getOptions: function(b) {
        ...
        if (a.bnr = b.bannerId) {
          ...
          var d = b.banner;
          a.dialog.getContentElement(a.dialog._.currentTabId, 'banner')
              .getElement()
              .setHtml(d)
        } else
          a.setHeightFrame();
        'undefined' == c &&
            (a.userDictionaryName ?
                 (c = a.userDictionaryName, d = {
                  ...
                  e.postMessage.send(
                      {message: d, target: a.targetFromFrame[void 0]})) :
                 c = '');
    ...
    G = function(b) {
      ...
      var b = a.dialog.getContentElement(a.dialog._.currentTabId, 'bottomGroup')
                  .getElement();
      b.removeStyle('display');
      b.removeStyle('position');
      b.removeStyle('left');
      ...
      setTimeout(function() {
        ...
        if (!e.misc.hasClass(c, 'cke_dialog_tab') &&
...
CKEDITOR.dialog.add('checkspell', function(b) {
  var c = function() {
    ...
    a.div_overlay.setEnable();
    var c = a.dialog._.currentTabId, f = a.iframeNumber + '_' + c,
  ...
  return {
    title: b.config.wsc_dialogTitle || b.lang.wsc.title, minWidth: 560,
        minHeight: 444, buttons: [CKEDITOR.dialog.cancelButton],
        onLoad:
            function() {
              a.dialog = this;
              u();
              ...
              if (CKEDITOR && CKEDITOR.config) {
                ...
                CKEDITOR.scriptLoader.load(
                    b.config.wsc_customLoaderScript ||
                        c + '//loader.webspellchecker.net/sproxy_fck/sproxy.php?plugin=fck2&customerid=' +
                            a.wsc_customerId + '&cmd=script&doc=wsc&schema=22',
                    function(c) {
                      CKEDITOR.config && CKEDITOR.config.wsc &&
                          ...
                          (a.serverLocationHash =
                           ...
                           a.loadIconEmptyEditor =
                               CKEDITOR.config.wsc.DefaultParams
                                   .iconPathEmptyEditor,
                           a.LangComparer =
                               new CKEDITOR.config.wsc.DefaultParams
                                   ._SP_FCK_LangCompare) :
                      ...
                      a.div_overlay = new s({
                        opacity: '1',
                        background:
                            '#fff url(' + a.loadIcon + ') no-repeat 50% 50%',
                      ...
                      d.getElementsByTag('DIV').count() ||
                          d.append(a.buildSelectLang(
                              a.dialog.getParentEditor().name));
                      a.div_overlay_no_check = new s({
                        opacity: '1',
                        id: 'no_check_over',
                        background: '#fff url(' + a.loadIconEmptyEditor +
                            ') no-repeat 50% 50%',
                        target: a.OverlayPlace
                      });
        ...
        onHide:
            function() {
              ...
              b.unlockSelection();
              c && (f && c.state[b.name] && f.setMarkupPaused) &&
                  f.setMarkupPaused(!1);
              a.dataTemp = '';
                        ...
                        children: [
                          ...
                          },
                          {
                            ...
                            onLoad: function() {
                              this.getElement().setAttribute(
                                  'title-cmd', this.id);
                              a.LocalizationButton.FinishChecking.instance =
                                  this
                            },
                            onClick: c
                          }
...
CKEDITOR.dialog.add('options', function() {
  ...
  return {
    title: a.LocalizationComing.Options, minWidth: 430, minHeight: 130,
        resizable: CKEDITOR.DIALOG_RESIZE_NONE, contents: [{
          id: 'OptionsTab',
          label: 'Options',
          accessKey: 'O',
          elements: [
              ...
              children: [
                ...
                },
                {
                  ...
                  children: [{
                    ...
                    html: '<div>' + a.LocalizationComing.OptionsTextIntro +
                        '</div>',
                    onShow: function() {
        ...
        onOk: function() {
          ...
          b = this;
          c.IgnoreAllCapsWords =
              b.getContentElement('OptionsTab', 'IgnoreAllCapsWords');
...
CKEDITOR.on('dialogDefinition', function(b) {
  if ('checkspell' === b.data.name) {
    ...
    c.dialog.on('cancel', function() {
      c.dialog.getParentEditor().config.wsc_onClose.call(
