...
window.CKEDITOR || (window.CKEDITOR = function() {
  var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, e = {
    ...
    basePath: function() {
      ...
      if (!f)
        for (var d = document.getElementsByTagName('script'), c = 0;
             c < d.length; c++) {
      ...
      -1 == f.indexOf(':/') && '//' != f.slice(0, 2) &&
          (f = 0 === f.indexOf('/') ?
               location.href.match(/^.*?:\/\/[^\/]*/)[0] + f :
               location.href.match(/^[^\?]*\/(?:)/)[0] + f);
      if (!f)
      ...
      function a() {
        try {
          document.addEventListener ?
              ...
              document.attachEvent && 'complete' === document.readyState &&
                  (document.detachEvent('onreadystatechange', a), d())
        } catch (c) {
        }
      }
      function d() {
...
CKEDITOR.env || (CKEDITOR.env = function() {
  ...
  e.version = b;
  e.isCompatible = e.iOS && b >= 534 ||
      !e.mobile &&
          (e.ie && b > 6 || e.gecko && b >= 2E4 || e.air && b >= 1 ||
           e.webkit && b >= 522 || false);
  e.hidpi = window.devicePixelRatio >= 2;
  e.needsBrFiller = e.gecko || e.webkit || e.ie && b > 10;
  e.needsNbspFiller = e.ie && b < 11;
  e.cssClass = 'cke_browser_' +
      (e.ie ? 'ie' : e.gecko ? 'gecko' : e.webkit ? 'webkit' : 'unknown');
  if (e.quirks) e.cssClass = e.cssClass + ' cke_browser_quirks';
  if (e.ie)
    e.cssClass = e.cssClass +
        (' cke_browser_ie' + (e.quirks ? '6 cke_browser_iequirks' : e.version));
...
var a = [],
    ...
    '-moz-' :
    CKEDITOR.env.webkit ? '-webkit-' : CKEDITOR.env.ie ? '-ms-' : '',
    b = /&/g, c = />/g, f = /</g, d = /"/g, h = /&amp;/g, l = /&gt;/g,
    i = /&lt;/g, g = /&quot;/g;
...
CKEDITOR.tools = {
  ...
  clone: function(a) {
    ...
    if (a === null || typeof a != 'object' || a instanceof String ||
        a instanceof Number || a instanceof Boolean || a instanceof Date ||
        a instanceof RegExp || a.nodeType || a.window === a)
      return a;
    f = new a.constructor;
  ...
  buildStyleHtml: function(a) {
    for (var a = [].concat(a), f, d = [], b = 0; b < a.length; b++)
      if (f = a[b])
        / @import|[{}] /.test(f) ?
            d.push('<style>' + f + '</style>') :
            d.push('<link type="text/css" rel=stylesheet href="' + f + '">');
    return d.join('')
  },
  ...
  parseCssText: function(a, f, d) {
    ...
    if (!a || a == ';') return b;
    a.replace(/&quot;/g, '"')
        .replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function(a, d, m) {
          if (f) {
            d = d.toLowerCase();
            d == 'font-family' &&
                (m = m.toLowerCase()
  ...
  enableHtml5Elements: function(a, f) {
    for (var d =
                 [
                   'abbr',    'article', 'aside',    'audio',    'bdi',
                   'canvas',  'data',    'datalist', 'details',  'figcaption',
...
CKEDITOR.dtd = function() {
  var a = CKEDITOR.tools.extend,
      e =
          function(a, f) {
        for (var d = CKEDITOR.tools.clone(a), b = 1; b < arguments.length;
             b++) {
          var f = arguments[b], c;
      ...
      h = {}, l = {'#': 1}, i = {center: 1, dir: 1, noframes: 1};
  a(b, {
    a: 1,
    abbr: 1,
    area: 1,
...
CKEDITOR.dom.domObject.prototype = function() {
  ...
  return {
    getPrivate: function() {
      ...
      for (b in a) {
        var c = a[b];
        this.$.detachEvent ? this.$.detachEvent('on' + b, c) :
                             this.$.removeEventListener &&
...
CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
  ...
  getAddress: function(a) {
    for (var e = [], b = this.getDocument().$.documentElement, c = this.$;
         c && c != b;) {
      var f = c.parentNode;
  ...
  getIndex: function(a) {
    function e(a, f) {
      ...
      return !b || b.nodeType != CKEDITOR.NODE_TEXT ? null :
                                                      b.nodeValue ? b : e(b, f)
    }
    var b = this.$, c = -1, f;
    if (!this.$.parentNode ||
        a && b.nodeType == CKEDITOR.NODE_TEXT && !b.nodeValue && !e(b) &&
            !e(b, true))
      return -1;
    do
      if (!a ||
          !(b != this.$ && b.nodeType == CKEDITOR.NODE_TEXT &&
            (f || !b.nodeValue))) {
        c++;
  ...
  getNextSourceNode: function(a, e, b) {
    ...
    return !a || b && b(a) === false ?
        null :
        e && e != a.type ? a.getNextSourceNode(false, e, b) : a
  },
  getPreviousSourceNode: function(a, e, b) {
    ...
    return !a || b && b(a) === false ?
        null :
        e && a.type != e ? a.getPreviousSourceNode(false, e, b) : a
  },
  getPrevious: function(a) {
    var e = this.$, b;
    do
      b = (e = e.previousSibling) && e.nodeType != 10 &&
  ...
  getPosition: function(a) {
    ...
    if (this.type == CKEDITOR.NODE_ELEMENT && a.type == CKEDITOR.NODE_ELEMENT) {
      ...
      if ('sourceIndex' in e)
        return e.sourceIndex < 0 || b.sourceIndex < 0 ?
            CKEDITOR.POSITION_DISCONNECTED :
            e.sourceIndex < b.sourceIndex ? CKEDITOR.POSITION_PRECEDING :
                                            CKEDITOR.POSITION_FOLLOWING
    }
    for (var e = this.getAddress(), a = a.getAddress(),
             b = Math.min(e.length, a.length), c = 0;
         c <= b - 1; c++)
      if (e[c] != a[c]) {
        if (c < b)
          return e[c] < a[c] ? CKEDITOR.POSITION_PRECEDING :
                               CKEDITOR.POSITION_FOLLOWING;
        break
      }
  ...
  getViewPaneSize: function() {
    ...
    return {
      width: (e ? a.documentElement.clientWidth : a.body.clientWidth) || 0,
          height: (e ? a.documentElement.clientHeight : a.body.clientHeight) ||
          0
    }
  },
    ...
    for (var b = this.$.documentElement, c = 0; b && c < a.length; c++) {
      ...
      if (e)
        for (var d = -1, h = 0; h < b.childNodes.length; h++) {
          ...
          if (!(e === true && l.nodeType == 3 && l.previousSibling &&
...
CKEDITOR.dom.element.setMarker = function(a, e, b, c) {
  var f = e.getCustomData('list_marker_id') ||
      e.setCustomData('list_marker_id', CKEDITOR.tools.getNextNumber())
          .getCustomData('list_marker_id'),
      d = e.getCustomData('list_marker_names') ||
      e.setCustomData('list_marker_names', {})
...
CKEDITOR.dom.element.clearMarkers = function(a, e, b) {
  var c = e.getCustomData('list_marker_names'),
      f = e.getCustomData('list_marker_id'), d;
...
CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
        ...
        function(a) {
          switch (a) {
            ...
            case 'checked':
              ...
              return (a.specified ? a.nodeValue : this.$.checked) ? 'checked' :
                                                                    null;
            case 'hspace':
            case 'value':
              return this.$[a];
  ...
  getLast: function(a) {
    ...
    (d = d && new CKEDITOR.dom.node(d)) && (a && !a(d)) &&
        (d = d.getPrevious(a));
    return d
  },
  getStyle: function(a) {
  ...
  isEditable: function(a) {
    ...
    if (this.isReadOnly() || this.getComputedStyle('display') == 'none' ||
        ...
        CKEDITOR.dtd.$nonEditable[d] || CKEDITOR.dtd.$empty[d] ||
        this.is('a') &&
  ...
  isEmptyInlineRemoveable: function() {
    ...
    for (var a = this.getChildren(), d = 0, b = a.count(); d < b; d++) {
      var c = a.getItem(d);
      if (!(c.type == CKEDITOR.NODE_ELEMENT && c.data('cke-bookmark')) &&
  ...
  hasAttributes:
      ...
      function() {
        var a = this.$.attributes, d = a.length,
            b = {'data-cke-expando': 1, _moz_dirty: 1};
        return d > 0 &&
            (d > 2 || !b[a[0].nodeName] || d == 2 && !b[a[1].nodeName])
      },
    ...
    function a(d) {
      ...
      if (this.getName() == 'input') switch (d) {
          ...
          case 'value':
            ...
            return d == 'checkbox' || d == 'radio' ? this.$.value != 'on' :
                                                     !!this.$.value
        }
  ...
  mergeSiblings: function() {
    ...
    return function(d) {
      if (d === false || CKEDITOR.dtd.$removeEmpty[this.getName()] ||
          this.is('a')) {
  ...
  setAttribute: function() {
    ...
    return CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks) ?
        function(d, b) {
          d == 'class' ? this.$.className = b :
                         d == 'style' ?
                         this.$.style.cssText = b :
                         d == 'tabindex' ?
                         this.$.tabIndex = b :
                         d == 'checked' ? this.$.checked = b :
                                          d == 'contenteditable' ?
                                          a.call(this, 'contentEditable', b) :
  ...
  unselectable: function() {
    ...
    if (CKEDITOR.env.ie) {
      ...
      for (var a, b = this.getElementsByTag('*'), c = 0, e = b.count(); c < e;
           c++) {
        a = b.getItem(c);
  ...
  getDocumentPosition: function(a) {
    var b = 0, c = 0, e = this.getDocument(), i = e.getBody(),
        g = e.$.compatMode == 'BackCompat';
    if (document.documentElement.getBoundingClientRect) {
      var m = this.$.getBoundingClientRect(), t = e.$.documentElement,
    ...
    if (!document.documentElement.getBoundingClientRect && CKEDITOR.env.gecko &&
        !g) {
      ...
      do {
        (b.$.clientWidth && b.$.clientWidth < b.$.scrollWidth ||
         b.$.clientHeight && b.$.clientHeight < b.$.scrollHeight) &&
            !b.is('body') && this.scrollIntoParent(b, a, 1);
        if (b.is('html')) {
          var c = b.getWindow();
          try {
  ...
  scrollIntoParent: function(a, b, c) {
    ...
    a instanceof CKEDITOR.dom.window &&
        (a = p ? g.getBody() : g.getDocumentElement());
    g = a.getWindow();
    i = s(this, g);
  ...
  getDirection: function(a) {
    return a ? this.getComputedStyle('direction') || this.getDirection() ||
            this.getParent() && this.getParent().getDirection(1) ||
            this.getDocument().$.dir || 'ltr' :
  ...
  forEach: function(a, b, c) {
    ...
    if (e !== false)
      for (var c = this.getChildren(), i = 0; i < c.count(); i++) {
        e = c.getItem(i);
        e.type == CKEDITOR.NODE_ELEMENT ? e.forEach(a, b) :
                                          (!b || e.type == b) && a(e)
      }
  }
});
...
CKEDITOR.tools.extend(
    CKEDITOR.dom.documentFragment.prototype, CKEDITOR.dom.element.prototype, {
...
function a(a, b) {
  ...
  if (!a && !this._.guardLTR) {
    ...
    this._.guardLTR = function(a, b) {
      return (!b || !r.equals(a)) && (!o || !a.equals(o)) &&
          (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
    }
  }
  if (a && !this._.guardRTL) {
    var g = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(),
        D = f.type == CKEDITOR.NODE_ELEMENT ? m ? f.getChild(m - 1) : null :
                                              f.getPrevious();
    this._.guardRTL = function(a, b) {
      return (!b || !g.equals(a)) && (!D || !a.equals(D)) &&
          (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
    }
  }
    ...
    if (a)
      d.type == CKEDITOR.NODE_ELEMENT &&
          (d = e > 0 ?
               d.getChild(e - 1) :
               h(d, true) === false ? null :
                                      d.getPreviousSourceNode(true, k, h));
    else {
      d = f;
...
function b(a) {
  ...
  if (a.type == CKEDITOR.NODE_ELEMENT) {
    if (a.is(CKEDITOR.dtd.$inline) || a.is('hr') ||
...
CKEDITOR.dom.element.prototype.isBlockBoundary = function(a) {
  return this.getComputedStyle('float') == 'none' &&
          !(this.getComputedStyle('position') in f) &&
...
CKEDITOR.dom.walker.whitespaces = function(a) {
  return function(b) {
    ...
    b && b.type == CKEDITOR.NODE_TEXT &&
        (c = !CKEDITOR.tools.trim(b.getText()) ||
...
CKEDITOR.dom.walker.bogus = function(a) {
  ...
  return function(c) {
    var f = CKEDITOR.env.needsBrFiller ? c.is && c.is('br') :
                                         c.getText && d.test(c.getText());
    if (f) {
      f = c.getParent();
      c = c.getNext(b);
      f = f.isBlockBoundary() &&
...
CKEDITOR.dom.element.prototype.getBogus = function() {
  ...
  while (l(a) || h(a) ||
         a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) &&
             !a.is(CKEDITOR.dtd.$empty));
  return a &&
          (CKEDITOR.env.needsBrFiller ? a.is && a.is('br') :
...
(function() {
function a() {
  var a = false, b = CKEDITOR.dom.walker.whitespaces(),
      c = CKEDITOR.dom.walker.bookmark(true), f = CKEDITOR.dom.walker.bogus();
  return function(e) {
    if (c(e) || b(e)) return true;
    if (f(e) && !a) return a = true;
    return e.type == CKEDITOR.NODE_TEXT &&
                (e.hasAscendant('pre') ||
                 CKEDITOR.tools.trim(e.getText()).length) ||
            e.type == CKEDITOR.NODE_ELEMENT && !e.is(d) ?
        false :
        true
  }
}
...
var c =
        function(a) {
  a.collapsed = a.startContainer && a.endContainer &&
      a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset
},
    f =
        function(a, b, c, d) {
      a.optimizeBookmark();
      var f = a.startContainer, e = a.endContainer, j = a.startOffset,
          u = a.endOffset, h, g;
    ...
    i = CKEDITOR.dom.walker.editable(), g = CKEDITOR.dom.walker.ignored(true);
CKEDITOR.dom.range.prototype = {
  ...
  createBookmark: function(a) {
    ...
    return {
      startNode: a ? d + (e ? 'C' : 'S') : b, endNode: a ? d + 'E' : c,
          serializable: a, collapsed: e
    }
  },
  createBookmark2: function() {
    function a(c) {
      ...
      e = d;
      var m = f;
      e = e.type != CKEDITOR.NODE_ELEMENT || m === 0 || m == e.getChildCount() ?
          0 :
          e.getChild(m - 1).type == CKEDITOR.NODE_TEXT &&
              e.getChild(m).type == CKEDITOR.NODE_TEXT;
      if (e) {
        d = d.getChild(f - 1);
        f = d.getLength()
      }
      d.type == CKEDITOR.NODE_ELEMENT && f > 1 &&
          (f = d.getChild(f - 1).getIndex(true) + 1);
    ...
    return function(b) {
      ...
      return {
        start: d.container.getAddress(b),
            end: c ? null : f.container.getAddress(b), startOffset: d.offset,
            endOffset: f.offset, normalized: b, collapsed: c, is2: true
      }
    }
  }(),
  ...
  getBoundaryNodes: function() {
    var a = this.startContainer, b = this.endContainer, c = this.startOffset,
        d = this.endOffset, f;
    if (a.type == CKEDITOR.NODE_ELEMENT) {
      f = a.getChildCount();
      if (f > c)
  ...
  getCommonAncestor: function(a, b) {
    var c = this.startContainer, d = this.endContainer,
        c = c.equals(d) ? a && c.type == CKEDITOR.NODE_ELEMENT &&
  ...
  optimize: function() {
    ...
    a.type != CKEDITOR.NODE_ELEMENT &&
        (b ? b >= a.getLength() && this.setStartAfter(a) :
  ...
  enlarge: function(a, b) {
    ...
    switch (a) {
      ...
      case CKEDITOR.ENLARGE_ELEMENT:
        ...
        var e = this.getCommonAncestor(), j = this.root, h, i, g, k, n,
            r = false, o, l;
            ...
            if (k.type == CKEDITOR.NODE_COMMENT)
              ...
              if (k.type == CKEDITOR.NODE_TEXT) {
                ...
                o = /[\s\ufeff]$/.test(l)
                  ...
                  (k.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) ||
                   b && k.is('br')) &&
                  !k.data('cke-bookmark'))
                if (r && CKEDITOR.dtd.$removeEmpty[k.getName()]) {
                  ...
                  if (d.test(l))
                    ...
                    for (var D = k.$.getElementsByTagName('*'), J = 0, z;
                         z = D[J++];)
                      if (!CKEDITOR.dtd
                               .$removeEmpty[z.nodeName.toLowerCase()]) {
                        k = null;
                        break
                      }
                  k && (o = !!l.length)
      ...
      case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
        ...
        var B, w,
            H = CKEDITOR.dom.walker.blockBoundary(
        ...
        this.setStartAt(
            B,
            !B.is('br') &&
                    (!g && this.checkStartOfBlock() || g && B.contains(g)) ?
        ...
        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
          ...
          if ((g = g.previous()) && g.type == CKEDITOR.NODE_ELEMENT &&
              g.is('br'))
            break
        }
        g = this.clone();
        ...
        this.setEndAt(
            B,
            !g && this.checkEndOfBlock() || g && B.contains(g) ?
  ...
  shrink: function(a, b, c) {
    if (!this.collapsed) {
      var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(),
          f = this.startContainer, e = this.endContainer, j = this.startOffset,
          g = this.endOffset, h = 1, i = 1;
      ...
      d.evaluator = function(b) {
        return b.type ==
            (a == CKEDITOR.SHRINK_ELEMENT ? CKEDITOR.NODE_ELEMENT :
                                            CKEDITOR.NODE_TEXT)
      };
      var n;
      ...
      if (h)
        (f = d[a == CKEDITOR.SHRINK_ELEMENT ? 'lastForward' : 'next']()) &&
            this.setStartAt(
                f,
                b ? CKEDITOR.POSITION_AFTER_START :
                    CKEDITOR.POSITION_BEFORE_START);
      if (i) {
        d.reset();
  ...
  selectNodeContents: function(a) {
    this.setStart(a, 0);
    this.setEnd(
        a, a.type == CKEDITOR.NODE_TEXT ? a.getLength() : a.getChildCount())
  },
  ...
  setStartAt: function(a, b) {
    switch (b) {
      ...
      case CKEDITOR.POSITION_BEFORE_END:
        a.type == CKEDITOR.NODE_TEXT ? this.setStart(a, a.getLength()) :
  ...
  setEndAt: function(a, b) {
    switch (b) {
      case CKEDITOR.POSITION_AFTER_START:
        ...
        break;
      case CKEDITOR.POSITION_BEFORE_END:
        a.type == CKEDITOR.NODE_TEXT ? this.setEnd(a, a.getLength()) :
  ...
  splitBlock: function(a) {
    ...
    return {
      previousBlock: d, nextBlock: f, wasStartOfBlock: a, wasEndOfBlock: b,
          elementPath: e
    }
  },
  ...
  checkBoundaryOfElement: function(a, b) {
    ...
    d.collapse(c);
    d[c ? 'setStartAt' : 'setEndAt'](
        a, c ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_END);
  ...
  moveToElementEditablePosition: function(a, b) {
    ...
    for (var c = 0; a;) {
      if (a.type == CKEDITOR.NODE_TEXT) {
        b && this.endContainer && this.checkEndOfBlock() &&
                l.test(a.getText()) ?
      ...
      if (a.type == CKEDITOR.NODE_ELEMENT)
        if (a.isEditable()) {
          ...
          c = 1
            ...
            b && a.is('br') && this.endContainer && this.checkEndOfBlock())
          this.moveToPosition(a, CKEDITOR.POSITION_BEFORE_START);
        else if (
            a.getAttribute('contenteditable') == 'false' &&
      ...
      d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(false) &&
          (e = d[b ? 'getLast' : 'getFirst'](g));
  ...
  moveToClosestEditablePosition: function(a, b) {
    ...
    if (a.is(CKEDITOR.dtd.$block)) {
      if (f = c[b ? 'getNextEditableNode' : 'getPreviousEditableNode']()) {
        d = 1;
        if (f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) &&
...
function b(a, c, d, f) {
  a: {
    f == null && (f = e(d)); for (var h; h = f.shift();) if (h.getDtd().p) {
  ...
  a._.nestedEditable =
      {element: f.element, container: d, remaining: f.remaining, iterator: c};
  return 1
}
function c(a, b, c) {
  if (!b) return false;
...
a.prototype = {
  getNextParagraph: function(a) {
    ...
    if (this._.nestedEditable) {
      ...
      if (b(this, a, this._.nestedEditable.container,
    ...
    if (!this._.started) {
      ...
      h = q.startPath();
      var j = q.endPath(), u = !q.collapsed && c(q, h.block),
      ...
      h = q.endContainer.hasAscendant('pre', true) ||
    ...
    for (this._.nextNode = null; j;) {
      var u = 0, v = j.hasAscendant('pre'), E = j.type != CKEDITOR.NODE_ELEMENT,
          k = 0;
      if (E)
        j.type == CKEDITOR.NODE_TEXT && f.test(j.getText()) && (E = 0);
      else {
        var n = j.getName();
        if (CKEDITOR.dtd.$block[n] &&
    ...
    if (!e) {
      ...
      u = {div: 1, th: 1, td: 1};
      e = e.block;
      if (!e && j && !this.enforceRealBlocks && u[j.getName()] &&
          h.checkStartOfBlock() && h.checkEndOfBlock() && !j.equals(h.root))
        e = j;
        ...
        this._.nextNode = e.equals(q) ?
            null :
            this._getNextSourceNode(h.getBoundaryNodes().endNode, 1, q)
    }
    if (y)
      (y = e.getPrevious()) && y.type == CKEDITOR.NODE_ELEMENT &&
          (y.getName() == 'br' ?
               y.remove() :
               y.getLast() && y.getLast().$.nodeName.toLowerCase() == 'br' &&
                   y.getLast().remove());
    if (p)
      (y = e.getLast()) && y.type == CKEDITOR.NODE_ELEMENT &&
          y.getName() == 'br' &&
          (!CKEDITOR.env.needsBrFiller || y.getPrevious(d) || y.getNext(d)) &&
          y.remove();
    if (!this._.nextNode)
      this._.nextNode =
          s || e.equals(q) || !q ? null : this._getNextSourceNode(e, 1, q);
    return e
  },
...
CKEDITOR.command = function(a, e) {
  ...
  this.exec = function(b) {
    ...
    return this.fire('exec') === false ? true :
                                         e.exec.call(this, a, b) !== false
  };
  this.refresh = function(a, b) {
    ...
    return this.fire('refresh', {editor: a, path: b}) === false ?
        true :
        e.refresh && e.refresh.apply(this, arguments) !== false
  };
  var b;
  this.checkAllowed = function(c) {
    return !c && typeof b == 'boolean' ? b :
...
CKEDITOR.command.prototype = {
  enable: function() {
    this.state == CKEDITOR.TRISTATE_DISABLED && this.checkAllowed() &&
        this.setState(
...
CKEDITOR.config = {
  ...
  baseFloatZIndex: 1E4,
  blockedKeystrokes:
      [CKEDITOR.CTRL + 66, CKEDITOR.CTRL + 73, CKEDITOR.CTRL + 85]
};
(function() {
function a(a, b, c, d, f) {
  ...
  for (e in b) {
    ...
    for (r in C) {
      j[r] = h(j[r], k) || null;
      var x = j, o = A[r], w = h(j[A[r]], k), p = j[r], g = [], i = true,
          F = void 0;
      w ? i = false : w = {};
      for (F in p)
        if (F.charAt(0) == '!') {
...
function y(a, b, d, f) {
  ...
  if (f.doCallbacks && a.elementCallbacks) {
    a: for (var x = a.elementCallbacks, h = 0, o = x.length, w; h < o;
            ++h) if (w = x[h](b)) {
      r = w;
      break a
    }
  ...
  if (f.doFilter) {
    a: {
      x = b.name; h = a._; a = h.allowedRules.elements[x];
      ...
      if (!a && !r) a = null;
        ...
        if (a) {
          p = 0;
          for (g = a.length; p < g; ++p) e(a[p], b, w, o)
        }
        if (r) {
          p = 0;
    ...
    var i = a.validStyles;
    r = a.validClasses;
    var x = b.attributes, F = b.styles, h = b.classes, o = b.classBackup,
        C = b.styleBackup, u, A, D = [];
    w = [];
    var v = /^data-cke-/;
    p = false;
    delete x.style;
...
function k(a, b, c) {
  ...
  if (J.$empty[d] || !a.children.length)
    ...
    if (b == 'br') {
      ...
      var d = a.children, f;
      b: {
        f = J[b]; for (var e = 0, n = d.length, j; e < n; ++e) {
          j = d[e];
        ...
        f = a.parent;
        for (var e = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT ||
                 f.name == 'body',
                 k, r, n = d.length;
             n > 0;) {
          j = d[--n];
          if (e &&
              (j.type == CKEDITOR.NODE_TEXT ||
               j.type == CKEDITOR.NODE_ELEMENT && J.$inline[j.name])) {
            if (!k) {
            ...
            f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                (j.type == CKEDITOR.NODE_ELEMENT && !r[j.name]) &&
                c.push({check: 'el-up', el: j})
          }
        }
        a.remove()
      }
...
var J = CKEDITOR.dtd, z = 1, L = CKEDITOR.tools.copy, B = CKEDITOR.tools.trim,
    w = 'cke-test', H = ['', 'p', 'br', 'div'];
...
CKEDITOR.filter.prototype = {
  allow: function(b, c, f) {
    ...
    if (typeof b == 'string')
      ...
      for (e = 0; e < b.length; ++e) n = this.allow(b[e], c, f);
      return n
    }
  ...
  applyTo: function(a, b, c, d) {
    ...
    var f = this, e = [], n = this.editor && this.editor.config.protectedSource,
        r, x = false,
    ...
    a.forEach(function(a) {
      if (a.type == CKEDITOR.NODE_ELEMENT) {
        ...
        a: {
          ...
          c = [];
          var j, k, o;
          if (n) for (k = 0; k < n.length;
                      ++k) if ((o = d.match(n[k])) && o[0].length == d.length) {
            c = true;
            break a
          } d = CKEDITOR.htmlParser.fragment.fromHtml(d);
          d.children.length == 1 &&
          (j = d.children[0]).type == CKEDITOR.NODE_ELEMENT && y(f, j, c, h);
          c = !c.length
        } c ||
            e.push(a)
      }
    ...
    for (; o = a.pop();) {
      ...
      if (c.parent) {
        ...
        switch (o.check) {
          case 'it':
            J.$removeEmpty[c.name] && !c.children.length ? k(c, d, a) :
                                                           j(c) || k(c, d, a);
            break;
          case 'el-up':
            c.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && !p[c.name] &&
                k(c, d, a);
            break;
          case 'parent-down':
            c.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && !p[c.name] &&
  ...
  addContentForms: function(a) {
    if (!this.disabled && a) {
      ...
      for (b = 0; b < a.length && !f; ++b) {
        c = a[b];
        if ((typeof c == 'string' || c instanceof CKEDITOR.style) &&
            this.check(c))
          f = c
      }
      if (f) {
        for (b = 0; b < a.length; ++b) d.push(o(a[b], f));
  ...
  addTransformations: function(a) {
    ...
    if (!this.disabled && a) {
      ...
      for (f = 0; f < a.length; ++f) {
        b = a[f];
        var e = void 0, n = void 0, j = void 0, k = void 0, r = void 0,
            x = void 0;
        c = [];
        for (n = 0; n < b.length; ++n) {
          ...
          if (!e) {
            ...
            e = e.element ?
                e.element :
                k ? k.match(/^([a-z0-9]+)/i)[0] : e.left.getDefinition().element
          }
  ...
  check: function(a, b, c) {
    ...
    b = k.length > 0 ?
        false :
        CKEDITOR.tools.objectCompare(f.attributes, j.attributes, true) ? true :
                                                                         false;
...
var C = {styles: 1, attributes: 1, classes: 1}, A = {
  ...
  classes: 'requiredClasses'
    ...
    G = /^cke:(object|embed|param)$/, $ = /^(object|embed|param)$/,
...
(function() {
var a, e = function(b) {
  var b = b.data, f = b.getKeystroke(), d = this.keystrokes[f],
      e = this._.editor;
  ...
  load: function(a, e, b) {
    ...
    this[a] ? e() :
              CKEDITOR.scriptLoader.load(
                  CKEDITOR.getUrl('lang/' + a + '.js'), e, this)
  },
  detect: function(a, e) {
...
CKEDITOR.resourceManager.prototype = {
  add: function(a, e) {
    if (this.registered[a])
      throw '[CKEDITOR.resourceManager.add] The resource name "' + a +
  ...
  load: function(a, e, b) {
    ...
    for (var c = this.loaded, f = this.registered, d = [], h = {}, l = {},
             i = 0;
         i < a.length; i++) {
      var g = a[i];
      if (g)
    ...
    CKEDITOR.scriptLoader.load(d, function(a, d) {
      if (d.length)
        throw '[CKEDITOR.resourceManager.load] Resource name "' +
            h[d[0]].join(',') + '" was not found at "' + d[0] + '".';
...
CKEDITOR.plugins.setLang = function(a, e, b) {
  var c = this.get(a), a = c.langEntries || (c.langEntries = {}),
      c = c.lang || (c.lang = []);
  c.split && (c = c.split(','));
...
function h(a, b) {
  a.on('customConfigLoaded', function() {
    ...
    a.readOnly =
        !(!c.readOnly &&
          !(a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ?
                a.element.is('textarea') ? a.element.hasAttribute('disabled') :
    ...
    a.activeEnterMode = a.enterMode =
        a.blockless ? CKEDITOR.ENTER_BR : c.enterMode;
    a.activeShiftEnterMode = a.shiftEnterMode =
        a.blockless ? CKEDITOR.ENTER_BR : c.shiftEnterMode;
...
function i(a) {
  CKEDITOR.lang.load(
      a.config.language, a.config.defaultLanguage, function(b, c) {
        var d = a.config.title;
        a.langCode = b;
        a.lang = CKEDITOR.tools.prototypedCopy(c);
        a.title = typeof d == 'string' || d === false ?
            d :
...
function m(a) {
  ...
  if (d)
    var e = RegExp('(?:^|,)(?:' + d.replace(/\s*,\s*/g, '|') + ')(?=,|$)', 'g'),
        c = c.replace(e, ''), c = c + (',' + d);
  if (f)
    var k = RegExp('(?:^|,)(?:' + f.replace(/\s*,\s*/g, '|') + ')(?=,|$)', 'g'),
        c = c.replace(k, '');
  ...
  CKEDITOR.plugins.load(c.split(','), function(c) {
    ...
    for (var j in c) {
      ...
      if (g && !a.lang[j]) {
        ...
        if (CKEDITOR.tools.indexOf(g, a.langCode) >= 0)
          ...
          i = i != a.langCode && CKEDITOR.tools.indexOf(g, i) >= 0 ?
              i :
              CKEDITOR.tools.indexOf(g, 'en') >= 0 ? 'en' : g[0]
        }
    ...
    CKEDITOR.scriptLoader.load(e, function() {
      for (var c = ['beforeInit', 'init', 'afterInit'], e = 0; e < c.length;
           e++)
        for (var n = 0; n < d.length; n++) {
          var j = d[n];
          e === 0 && (f[n] && j.lang && j.langEntries) &&
              (a.lang[j.name] = j.langEntries[f[n]]);
          if (j[c[e]]) j[c[e]](a)
        }
...
CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
  ...
  _attachToForm: function() {
    function a(d) {
      b.updateElement();
      b._.required && (!c.getValue() && b.fire('required') === false) &&
  ...
  execCommand: function(a, b) {
    ...
    if (c && c.state != CKEDITOR.TRISTATE_DISABLED &&
        this.fire('beforeCommandExec', d) !== false) {
  ...
  setActiveFilter: function(a) {
    ...
    if (this.activeFilter !== a) {
      ...
      a === this.filter ? this.setActiveEnterMode(null, null) :
...
CKEDITOR.htmlParser.node.prototype = {
  remove: function() {
    var a = this.parent.children, e = CKEDITOR.tools.indexOf(a, this),
        b = this.previous, c = this.next;
    b && (b.next = c);
    c && (c.previous = b);
    a.splice(e, 1);
    this.parent = null
  ...
  replaceWith: function(a) {
    var e = this.parent.children, b = CKEDITOR.tools.indexOf(e, this),
        c = a.previous = this.previous, f = a.next = this.next;
    c && (c.next = a);
    f && (f.previous = a);
    e[b] = a;
...
var e = CKEDITOR.tools.extend(
        {table: 1, ul: 1, ol: 1, dl: 1}, CKEDITOR.dtd.table, CKEDITOR.dtd.ul,
        CKEDITOR.dtd.ol, CKEDITOR.dtd.dl),
    b = {ol: 1, ul: 1},
    c = CKEDITOR.tools.extend(
        {}, {html: 1}, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head,
        {style: 1, script: 1}),
    f = {
      ul: 'li',
      ol: 'li',
...
CKEDITOR.htmlParser.fragment.fromHtml = function(d, h, l) {
  function i(a) {
    ...
    if (j.length > 0)
      for (var c = 0; c < j.length; c++) {
        var d = j[c], f = d.name, e = CKEDITOR.dtd[f],
  ...
  function m(a) {
    if (a._.isBlockLike && a.name != 'pre' && a.name != 'textarea') {
      ...
      if (c && c.type == CKEDITOR.NODE_TEXT)
        (d = CKEDITOR.tools.rtrim(c.value)) ? c.value = d :
  ...
  function s(a, b) {
    if ((a == q || a.name == 'body') && l &&
        (!a.name || CKEDITOR.dtd[a.name][l])) {
      var c, d;
      return (c = b.attributes &&
                      (d = b.attributes['data-cke-real-element-type']) ?
                  d :
                  b.name) &&
          c in CKEDITOR.dtd.$inline && !(c in CKEDITOR.dtd.head) &&
          !b.isOrphan ||
  ...
  var p = new CKEDITOR.htmlParser,
      q = h instanceof CKEDITOR.htmlParser.element ?
      h :
      typeof h == 'string' ? new CKEDITOR.htmlParser.element(h) :
          ...
          if (!f.isUnknown && !v.isUnknown && !l[d])
            if (v.isOptionalClose)
              ...
              (h = h[h.length - 1]) && h.name == 'li' ||
                  t(h = new CKEDITOR.htmlParser.element('li'), v);
  ...
  forEach: function(a, b, c) {
    ...
    if (f !== false)
      for (var c = this.children, e = 0; e < c.length; e++) {
        f = c[e];
        f.type == CKEDITOR.NODE_ELEMENT ? f.forEach(a, b) :
                                          (!b || f.type == b) && a(f)
      }
  },
  getFilterContext: function(a) {
...
CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
  ...
  proto: {
    ...
    onElement: function(a, c) {
      for (var f =
                   [
                     this.elementsRules['^'], this.elementsRules[c.name],
                     this.elementsRules.$
                   ],
               d, e = 0;
           e < 3; e++)
    ...
    onNode: function(a, c) {
      var f = c.type;
      return f == CKEDITOR.NODE_ELEMENT ?
          this.onElement(a, c) :
          f == CKEDITOR.NODE_TEXT ?
          new CKEDITOR.htmlParser.text(this.onText(a, c.value)) :
          f == CKEDITOR.NODE_COMMENT ?
...
a.prototype = {
  ...
  addMany: function(a, c, f) {
    for (var d = [this.findIndex(c), 0], e = 0, l = a.length; e < l; e++)
      d.push({value: a[e], priority: c, options: f});
  ...
  exec: function(a, c) {
    var f = c instanceof CKEDITOR.htmlParser.node ||
        c instanceof CKEDITOR.htmlParser.fragment,
        d = Array.prototype.slice.call(arguments, 1), e = this.rules,
        l = e.length, i, g, m, t;
    for (t = 0; t < l; t++) {
      if (f) {
        i = c.type;
...
function a(a, e) {
        ...
        if (j = (typeof f == 'function' ? f(e) : f) !== false)
          if (!o && !CKEDITOR.env.needsBrFiller &&
            ...
            j = false;
              ...
              !o && !CKEDITOR.env.needsBrFiller &&
              (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr ||
  ...
  function w(a, b) {
    if ((!o || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT &&
        a.name == 'br' && !a.attributes['data-cke-eol'])
      return true;
    var c;
    if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(j))) {
      if (c.index) {
        (new CKEDITOR.htmlParser.text(a.value.substring(0, c.index)))
            .insertBefore(a);
        a.value = c[0]
      }
    ...
    return function(b) {
      if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
        ...
        if ('data-cke-bogus' in e || 'data-cke-eol' in e)
          ...
          var j = c(b);
          !e && d(b.parent) ? h(b.parent, n(a)) :
                              d(e) && (j && !d(j)) && n(a).insertBefore(e)
        }
      }
    }
  }(o);
...
function d(a) {
  return a &&
      (a.type == CKEDITOR.NODE_ELEMENT && a.name in k ||
...
function g(a) {
  return a.replace(D, function(a, b, c) {
    return '<' + b + c.replace(J, function(a, b) {
      return z.test(b) && c.indexOf('data-cke-saved-' + b) == -1 ?
...
function y(a) {
  return a.replace(
      /<\!--\{cke_protected\}\{C\}([\s\S]+?)--\>/g, function(a, b) {
        return decodeURIComponent(b)
      })
}
function p(a, b) {
...
function q(a, b) {
  for (var c = [], d = b.config.protectedSource,
           f = b._.dataStore || (b._.dataStore = {id: 1}),
           e = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g,
           d =
               [
                 /<script[\s\S]*?<\/script>/gi,
                 /<noscript[\s\S]*?<\/noscript>/gi, /<meta[\s\S]*?\/?>/gi
               ].concat(d),
           a = a.replace(
               /<\!--[\s\S]*?--\>/g,
               function(a) {
...
CKEDITOR.htmlDataProcessor = function(b) {
  ...
  b.on('toHtml', function(a) {
    var a = a.data, c = a.dataValue, d, c = q(c, b), c = m(c, B), c = g(c),
        c = m(c, L), c = c.replace(H, '$1cke:$2'),
  ...
  b.on('toHtml', function(a) {
    a.data.filter.applyTo(
        a.data.dataValue, true, a.data.dontFilter, a.data.enterMode) &&
        b.fire('dataFiltered')
  }, null, null, 6);
  b.on('toHtml', function(a) {
  ...
  b.on('toDataFormat', function(a) {
    ...
    a.data.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(
        c, a.data.context, e(a.data.enterMode, b.config.autoParagraph))
  }, null, null, 5);
  b.on('toDataFormat', function(a) {
...
var j = /(?:&nbsp;|\xa0)$/, u = '{cke_protected}', v = CKEDITOR.dtd,
    ...
    n = {elements: {input: l, textarea: l}}, r = {
    ...
    M = {
      ...
      attributeNames: [
        [/^data-cke-(saved|pa)-/, ''], [/^data-cke-.*/, ''], ['hidefocus', '']
      ],
      elements: {
        $: function(a) {
          var b = a.attributes;
...
CKEDITOR.htmlParser.element = function(a, e) {
  ...
  c && (b = c[1]);
  b =
      !(!CKEDITOR.dtd.$nonBodyContent[b] && !CKEDITOR.dtd.$block[b] &&
        !CKEDITOR.dtd.$listItem[b] && !CKEDITOR.dtd.$tableContent[b] &&
    ...
    rules: e, populate: function(a) {
      ...
      if (c)
        a instanceof CKEDITOR.dom.element ?
            ...
            a instanceof CKEDITOR.htmlParser.element ? a.attributes.style = c :
                                                       a.style = c
    }, toString: function() {
      var a = [], c;
    ...
    new CKEDITOR.htmlParser.node, {
      ...
      filter: function(a, b) {
        ...
        for (i in e) {
          ...
          g &&
              ((l = a.onAttribute(b, d, g, l)) === false ? delete e[g] :
                                                           e[g] = l)
        }
      ...
      getFilterContext: function(a) {
        ...
        !a.off && this.attributes['data-cke-processor'] == 'off' &&
            b.push('off', true);
...
CKEDITOR.inline = function(a, e) {
  ...
  if (a.getEditor())
    throw 'The editor instance "' + a.getEditor().name +
  ...
  if (c) {
    ...
    a = CKEDITOR.dom.element.createFromHtml(
        '<div contenteditable="' + !!b.readOnly +
            '" class="cke_textarea_inline">' + c.getValue() + '</div>',
        CKEDITOR.document);
    a.insertAfter(c);
    c.hide();
...
CKEDITOR.inlineAll = function() {
  ...
  for (b in CKEDITOR.dtd.$editable)
    for (var c = CKEDITOR.document.getElementsByTag(b), f = 0, d = c.count();
         f < d; f++) {
      a = c.getItem(f);
      if (a.getAttribute('contenteditable') == 'true') {
        e = {element: a, config: {}};
...
function a(a, f, d, h) {
  ...
  l.on('loaded', function() {
    ...
    h == CKEDITOR.ELEMENT_MODE_REPLACE &&
        (l.config.autoUpdateElement && a.$.form) && l._attachToForm();
...
function b(a) {
  var b = a.name, d = a.element, e = a.elementMode,
      ...
      g = new CKEDITOR.template(
          '<{outerEl} id="cke_{name}" class="{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' +
          CKEDITOR.env.cssClass +
          '"  dir="{langDir}" lang="{langCode}" role="application"' +
          (a.title ? ' aria-labelledby="cke_{name}_arialbl"' : '') + '>' +
          (a.title ?
      ...
      b = CKEDITOR.dom.element.createFromHtml(g.output({
        ...
        langCode: a.langCode,
        voiceLabel: a.title,
        topHtml: l ? '<span id="' + a.ui.spaceId('top') +
                '" class="cke_top cke_reset_all" role="presentation" style="height:auto">' +
                l + '</span>' :
                     '',
        contentId: a.ui.spaceId('contents'),
        bottomHtml: i ? '<span id="' + a.ui.spaceId('bottom') +
                '" class="cke_bottom cke_reset_all" role="presentation">' + i +
                '</span>' :
                        '',
...
CKEDITOR.replaceAll = function() {
  for (var a = document.getElementsByTagName('textarea'), b = 0; b < a.length;
       b++) {
    var d = null, e = a[b];
    if (e.name || e.id) {
...
CKEDITOR.editor.prototype.resize = function(a, b, d, e) {
  var l = this.container, i = this.ui.space('contents'),
      g = CKEDITOR.env.webkit && this.document &&
  ...
  i.setStyle(
      'height',
      Math.max(
          b - (d ? 0 : (e.$.offsetHeight || 0) - (i.$.clientHeight || 0)), 0) +
          'px');
  g && (g.style.width = '100%');
  this.fire('resize')
};
...
(function() {
function a(a) {
  var b = a.editor, d = a.data.path, f = d.blockLimit, k = a.data.selection,
      n = k.getRanges()[0], r;
  ...
  if (h(b, d.block, f) && n.collapsed && !n.getCommonAncestor().isReadOnly()) {
    ...
    if (!f.checkForward() || d.checkStartOfBlock() && d.checkEndOfBlock()) {
      b = n.fixBlock(
          true, b.activeEnterMode == CKEDITOR.ENTER_DIV ? 'div' : 'p');
      if (!CKEDITOR.env.needsBrFiller)
        (b = b.getFirst(c)) &&
            (b.type == CKEDITOR.NODE_TEXT &&
...
function d(a) {
  ...
  var d, e = a.getRanges()[0], a = a.root, f = {table: 1, ul: 1, ol: 1, dl: 1};
...
function h(a, b, c) {
  return a.config.autoParagraph !== false &&
      a.activeEnterMode != CKEDITOR.ENTER_BR && a.editable().equals(c) && !b ||
      b && b.getAttribute('contenteditable') == 'true'
}
function l(a) {
  a.editor.focus();
  ...
  proto: {
    ...
    insertText: function(a) {
      ...
      var b = this.editor,
          ...
          CKEDITOR.ENTER_BR :
          b.activeEnterMode,
          b = c == CKEDITOR.ENTER_BR, d = CKEDITOR.tools,
    ...
    insertElementIntoRange: function(a, b) {
      ...
      b.startContainer.type == CKEDITOR.NODE_ELEMENT &&
          b.startContainer.is(
              {tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1}) &&
          q(b);
      var r, g;
      if (f)
        for (; (r = b.getCommonAncestor(0, 1)) &&
             (g = CKEDITOR.dtd[r.getName()]) && (!g || !g[e]);)
    ...
    insertElementIntoSelection: function(a) {
      ...
      var b = this.editor, d = b.activeEnterMode, b = b.getSelection(),
          e = b.getRanges()[0], f = a.getName(), f = CKEDITOR.dtd.$block[f];
      if (this.insertElementIntoRange(a, e)) {
        ...
        if (f)
          if ((f = a.getNext(function(a) {
            ...
            f.getDtd()['#'] ? e.moveToElementEditStart(f) :
    ...
    fixInitialSelection: function() {
      ...
      function b() {
        var a = c.getDocument().$, d = a.selection,
    ...
    setup: function() {
      ...
      if (!this.is('textarea')) {
        ...
        this.setCustomData(
            'cke_includeReadonly', !a.config.disableReadonlyStyling);
        this.attachListener(this, 'click', function(a) {
          var a = a.data,
              b = (new CKEDITOR.dom.elementPath(a.getTarget(), this))
                      .contains('a');
        ...
        this.attachListener(a, 'key', function(b) {
          ...
          if (c in k) {
            var b = a.getSelection(), f, g = b.getRanges()[0],
                h = g.startPath(), i, m, l, c = c == 8;
            if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 &&
              ...
              if ((i = h.block) && (l = i[c ? 'getPrevious' : 'getNext'](s)) &&
                  l.type == CKEDITOR.NODE_ELEMENT && l.is('table') &&
                ...
                e = 1
                  ...
                  h.blockLimit && h.blockLimit.is('td') &&
                  (m = h.blockLimit.getAscendant('table')) &&
                  g.checkBoundaryOfElement(
                      m, c ? CKEDITOR.START : CKEDITOR.END) &&
                  (l = m[c ? 'getPrevious' : 'getNext'](s))) {
                a.fire('saveSnapshot');
                g['moveToElementEdit' + (c ? 'End' : 'Start')](l);
                g.checkStartOfBlock() && g.checkEndOfBlock() ? l.remove() :
                                                               g.select();
                a.fire('saveSnapshot');
                e = 1
              } else if (
                  (m = h.contains(['td', 'th', 'caption'])) &&
                  g.checkBoundaryOfElement(
                      m, c ? CKEDITOR.START : CKEDITOR.END))
                e = 1
          }
        ...
        CKEDITOR.env.webkit && this.attachListener(a, 'key', function(b) {
          ...
          if (b in k) {
            ...
            if (d.collapsed) {
              ...
              a: {
                var f = b.block;
                if (f) if (d[c ? 'checkStartOfBlock' : 'checkEndOfBlock']()) if (
                    !d.moveToClosestEditablePosition(f, !c) || !d.collapsed) e =
                    false;
                else {
                  if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) {
                    var h =
                        d.startContainer.getChild(d.startOffset - (c ? 1 : 0));
...
CKEDITOR.on('instanceLoaded', function(b) {
  ...
  c.on('insertElement', function(a) {
    ...
    if (a.type == CKEDITOR.NODE_ELEMENT &&
      ...
      a.getAttribute('contentEditable') != 'false' &&
          a.data(
              'cke-editable', a.hasAttribute('contenteditable') ? 'true' : '1');
      ...
      if (d)
        if (c = this.ui.space(
          ...
          var e = CKEDITOR.tools.getNextId(),
              d = CKEDITOR.dom.element.createFromHtml(
                  '<span id="' + e + '" class="cke_voice_label">' + d +
                  '</span>');
          c.append(d);
...
var p = function() {
  ...
  function b(c, d) {
    ...
    e = d.range.startPath();
    for (var i = g[i.getName()], o = 0, l = c.getChildren(), m = l.count(),
             D = -1, p = -1, M = 0, s = e.contains(g.$list);
         o < m; ++o) {
      e = l.getItem(o);
      if (a(e)) {
        k = e.getName();
        if (s && k in CKEDITOR.dtd.$list)
          ...
          if (k == 'br' && e.data('cke-eol') && (!o || o == m - 1)) {
            M = (f = o ? h[o - 1].node : l.getItem(o + 1)) &&
                (!a(f) || !f.is('br'));
  ...
  function d(b, c) {
    var e = [], f = b.getChildren(), k = f.count(), n, h = 0, i = g[c],
  ...
  function e(b) {
    return b && a(b) &&
        (b.is(g.$removeEmpty) || b.is('a') && !b.isBlockBoundary())
  }
  function f(b, c, d, e) {
    var n = b.clone(), g, h;
    n.setEndAt(c, CKEDITOR.POSITION_BEFORE_END);
    if ((g = (new CKEDITOR.dom.walker(n)).next()) && a(g) && o[g.getName()] &&
        (h = g.getPrevious()) && a(h) &&
        !h.getParent().equals(b.startContainer) && d.contains(h) &&
        e.contains(g) && g.isIdentical(h)) {
      g.moveChildren(h);
      g.remove();
      f(b, c, d, e)
    }
  ...
  return function(o, z, p) {
    ...
    if (!w.checkReadOnly()) {
      var C = (new CKEDITOR.dom.elementPath(w.startContainer, w.root))
                  .blockLimit ||
          w.root,
          z = {
            type: z,
      ...
      if (!B.collapsed) {
        ...
        C && (!C.equals(s) && !C.contains(s) && B.checkEndOfBlock()) &&
            z.zombies.push(C);
        B.deleteContents()
      }
      for (; (G = a(B.startContainer) &&
                  B.startContainer.getChild(B.startOffset - 1)) &&
           a(G) && G.isBlockBoundary() && x.contains(G);)
      ...
      if (A = p) {
        ...
        if ((y = A.startPath().block) &&
            !(y.getChildCount() == 1 && y.getBogus()))
          a: {
            var t;
      ...
      if (A) {
        ...
        F = C.getPosition(x);
        s = !!C.getCommonAncestor(x) && F != CKEDITOR.POSITION_IDENTICAL &&
            !(F & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
        x = b(z.dataWrapper, z);
        for (n(x, t); A < x.length; A++) {
          ...
          if (q = F.isLineBreak) {
            ...
            if (F.hasBlockSibling)
              ...
              if (!P || !P.is({div: 1, p: 1}))
                ...
                V = P.getPosition(N);
                if (V == CKEDITOR.POSITION_IDENTICAL ||
          ...
          if (q)
            ...
            q = t.startPath();
            if (!F.isBlock && h(z.editor, q.block, q.blockLimit) &&
                (Q = z.editor.activeEnterMode != CKEDITOR.ENTER_BR &&
                         z.editor.config.autoParagraph !== false ?
                     z.editor.activeEnterMode == CKEDITOR.ENTER_DIV ? 'div' :
                                                                      'p' :
                     false)) {
              Q = y.createElement(Q);
              Q.appendBogus();
            ...
            if (B && F.isElement) {
              ...
              if (q) {
                ...
                q = A == x.length - 1;
                N = d(F.node, N);
                for (var P = [], V = N.length, W = 0, Y = void 0, Z = 0, U = -1;
                     W < V; W++) {
                  Y = N[W];
                  if (Y == ' ') {
                    if (!Z && (!T || W)) {
      ...
      if (S)
        for (; I = S.pop();)
          CKEDITOR.env.needsBrFiller ? I.appendBogus() :
                                       I.append(K.document.createText(' '));
      for (; I = z.mergeCandidates.pop();) I.mergeSiblings();
      K.moveToBookmark(T);
      if (!z.dontMoveCaret) {
        for (I = a(K.startContainer) &&
                 K.startContainer.getChild(K.startOffset - 1);
             I && a(I) && !I.is(g.$empty);) {
  ...
  return function(d) {
    ...
    if (f.is('table')) {
      ...
      d.moveToPosition(
          f, g ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_END)
    }
  }
}()
})();
...
function c(a) {
  return q(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ?
      true :
      false
}
function f(a) {
  ...
  var d = a.startContainer, e = a.getPreviousNode(c, null, d),
      f = a.getNextNode(c, null, d);
  return b(e) || b(f, 1) ||
          !e && !f &&
              !(d.type == CKEDITOR.NODE_ELEMENT && d.isBlockBoundary() &&
                d.getBogus()) ?
      true :
      false
}
...
function i(a) {
  return [
    {node: a.anchorNode, offset: a.anchorOffset},
...
function m(a) {
  var b = CKEDITOR.dom.element.createFromHtml(
      '<div data-cke-hidden-sel="1" data-cke-temp="1" style="' +
          (CKEDITOR.env.ie ? 'display:none' :
                             'position:fixed;top:0;left:-1000px') +
          '">&nbsp;</div>',
      a.document);
  a.fire('lockSnapshot');
  a.editable().append(b);
  var c = a.getSelection(1), d = a.createRange(),
  ...
  return function(c) {
    ...
    if (b[d]) {
      ...
      if (e.length == 1 && f.collapsed)
        if ((d =
                 f[d < 38 ? 'getPreviousEditableNode' :
                            'getNextEditableNode']()) &&
            d.type == CKEDITOR.NODE_ELEMENT &&
    ...
    if (!c.collapsed) {
      if (c.startContainer.isReadOnly())
        for (var d = c.startContainer, e; d;) {
          if ((e = d.type == CKEDITOR.NODE_ELEMENT) && d.is('body') ||
              !d.isReadOnly())
            break;
          e && d.getAttribute('contentEditable') == 'false' &&
              c.setStartAfter(d);
          d = d.getParent()
        }
      d = c.startContainer;
...
CKEDITOR.on('instanceCreated', function(b) {
  ...
  d.on('contentDom', function() {
    ...
    var f = d.document, g = CKEDITOR.document, k = d.editable(),
        i = f.getBody(), n = f.getDocumentElement(), w = k.isInline(), j, C;
    CKEDITOR.env.gecko && k.attachListener(k, 'focus', function(a) {
      a.removeListener();
      if (j !== 0)
        if ((a = d.getSelection().getNative()) && a.isCollapsed &&
            a.anchorNode == k.$) {
          a = d.createRange();
    ...
    k.attachListener(
        k, CKEDITOR.env.webkit ? 'DOMFocusIn' : 'focus', function() {
          j && CKEDITOR.env.webkit &&
              (j = d._.previousActive &&
    ...
    if (CKEDITOR.env.ie || w) {
      u ? k.attachListener(k, 'beforedeactivate', b, null, null, -1) :
          k.attachListener(d, 'selectionCheck', b, null, null, -1);
      k.attachListener(
          k, CKEDITOR.env.webkit ? 'DOMFocusOut' : 'blur', function() {
            d.lockSelection(C);
            j = 1
          }, null, null, -1);
      k.attachListener(k, 'mousedown', function() {
          ...
          n.on('mousedown', function(a) {
            function b(a) {
              ...
              if (d) {
                ...
                d.setEndPoint(
                    f.compareEndPoints('StartToStart', c) < 0 ? 'EndToEnd' :
                                                                'StartToStart',
                    c);
                d.select()
              }
            ...
            a = a.data;
            if (a.getTarget().is('html') && a.$.y < n.$.clientHeight &&
                a.$.x < n.$.clientWidth) {
    ...
    if (w && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
      ...
      k.attachListener(
          CKEDITOR.env.ie ? k : f.getDocumentElement(), 'mouseup', e, d);
    ...
    if (b && b.hasAttribute('data-cke-hidden-sel')) {
      ...
      if (CKEDITOR.env.gecko)
        (a = d.editable().getFirst(a)) &&
            (a.is('br') && a.getAttribute('_moz_editor_bogus_node')) &&
            a.remove()
    }
  }, null, null, 100);
  d.on('key', function(a) {
...
CKEDITOR.dom.selection = function(a) {
  ...
  if (a)
    if (a.getRangeAt)
      d = (e = a.rangeCount && a.getRangeAt(0)) &&
      ...
      d = e &&
          CKEDITOR.dom.element.get(e.item && e.item(0) || e.parentElement())
    }
  if (!d ||
...
CKEDITOR.dom.selection.prototype = {
  getNative: function() {
    return this._.cache.nativeSel !== void 0 ?
        ...
        this._.cache.nativeSel = u ? this.document.$.selection :
  ...
  getType: u ?
      ...
      function() {
        ...
        if (!c || !c.rangeCount)
          ...
          if (d == c.endContainer && d.nodeType == 1 &&
  ...
  getRanges: function() {
    var a = u ? function() {
      ...
      var b = function(b, c) {
        ...
        return {
          container: x, offset: A > 0 ? -h : x.nodeValue.length + h
        }
      };
      return function() {
        ...
        if (d == CKEDITOR.SELECTION_TEXT) {
          ...
          a.endContainer.getPosition(a.startContainer)&
              ...
              a.endOffset <= a.startContainer.getIndex() && a.collapse();
          return [a]
        }
        if (d == CKEDITOR.SELECTION_ELEMENT) {
          for (var d = [], e = 0; e < c.length; e++) {
            for (var f = c.item(e), g = f.parentNode, h = 0,
                     a = new CKEDITOR.dom.range(this.root);
                 h < g.childNodes.length && g.childNodes[h] != f; h++)
              ;
  ...
  getSelectedElement: function() {
    ...
    var b = this,
        c = CKEDITOR.tools.tryThese(
            ...
            function() {
              for (var a = b.getRanges()[0].clone(), c, d, e = 2; e &&
                   (!(c = a.getEnclosedNode()) ||
                    !(c.type == CKEDITOR.NODE_ELEMENT && E[c.getName()] &&
                      (d = c)));
                   e--)
  ...
  selectRanges: function(a) {
    ...
    if (a.length)
      if (this.isLocked) {
        ...
        a: {
          var i, j;
          if (a.length == 1 && !(j = a[0]).collapsed &&
              (g = j.getEnclosedNode()) && g.type == CKEDITOR.NODE_ELEMENT) {
            j = j.clone();
          ...
          if (u) {
            ...
            if ((c = g.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT &&
                c.getName() in E && (!c.is('a') || !c.getText()))
              try {
            ...
            if (g.startContainer.type == CKEDITOR.NODE_ELEMENT &&
            ...
            if (e) {
              ...
              l = !(l && l.getText && l.getText().match(i)) &&
                  (m || !b.hasPrevious() ||
...
function e(b) {
  ...
  if (b.collapsed) {
    ...
    var f = this.element, g = this._.definition, h, i = g.ignoreReadonly,
    ...
    for (o.getPosition(p) == CKEDITOR.POSITION_FOLLOWING && (o = 0); o;) {
      ...
      if (o.equals(p)) {
        ...
        if (t && k && CKEDITOR.dtd.$block[s])
          for (var v = o, u = c(v), z = void 0, D = u.length, E = 0,
                   v = D && new CKEDITOR.dom.range(v.getDocument());
               E < D; ++E) {
        ...
        u = s ? !l[s] || r ? 0 :
                             t && !k ? 0 :
                                       (o.getPosition(p) | L) == L &&
                        (!g.childRule || g.childRule(o)) :
                1;
        if (u)
          if ((u = o.getParent()) &&
              ((u.getDtd() || CKEDITOR.dtd.span)[f] || h) &&
              (!g.parentRule || g.parentRule(u))) {
            if (!q &&
                (!s || !CKEDITOR.dtd.$removeEmpty[s] ||
                 (o.getPosition(p) | L) == L)) {
              q = b.clone();
              q.setStartBefore(o)
            }
            s = o.type;
            if (s == CKEDITOR.NODE_TEXT || t ||
                s == CKEDITOR.NODE_ELEMENT && !o.getChildCount()) {
              for (var s = o, U; (i = !s.getNext(J)) &&
                   (U = s.getParent(), l[U.getName()]) &&
                   (U.getPosition(n) | B) == B &&
                   (!g.childRule || g.childRule(U));)
                s = U;
              q.setEndAfter(s)
            }
          } else
      ...
      if (i && q && !q.collapsed) {
        for (var i = j(this, d), t = i.hasAttributes(),
                 r = q.getCommonAncestor(), s = {}, u = {}, z = {}, D = {}, O,
                 R, X;
             i && r;) {
          if (r.getName() == f) {
...
function b(a) {
  function b() {
    for (var a = new CKEDITOR.dom.elementPath(d.getParent()),
             c = new CKEDITOR.dom.elementPath(j.getParent()), e = null,
             f = null, g = 0;
         g < a.elements.length; g++) {
      var h = a.elements[g];
  ...
  if (a.collapsed) {
    for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, g = 0,
             h;
         g < e.elements.length && (h = e.elements[g]); g++) {
    ...
    for (e = d; !e.equals(j);) {
      ...
      if (e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e)) {
        e.getName() == this.element ? s.call(this, e) :
                                      p(e, E(this)[e.getName()]);
...
function l(a) {
  ...
  for (var d, e; d = c.getNextParagraph();)
    if (this.checkElementRemovable(d))
      if (d.is('pre')) {
        (e = this._.enterMode == CKEDITOR.ENTER_BR ?
             null :
...
function i(a, b) {
  ...
  if (d) {
    var c = b, i;
    if ((i = c.getPrevious(z)) && i.type == CKEDITOR.NODE_ELEMENT &&
        i.is('pre')) {
      d = m(i.getHtml(), /\n$/, '') + '\n\n' + m(c.getHtml(), /^\n/, '');
        ...
        e =
            m(e, /^[ \t]+|[ \t]+$/g,
              function(a, b) {
                return a.length == 1 ?
                    '&nbsp;' :
                    b ? ' ' + CKEDITOR.tools.repeat('&nbsp;', a.length - 1) :
...
function s(a, b) {
  var c = this._.definition, d = c.attributes, c = c.styles,
      e = E(this)[a.getName()],
      f = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), g;
  for (g in d)
    if (!((g == 'class' || this._.definition.fullMatch) &&
          a.getAttribute(g) != k(g, d[g])) &&
        !(b && g.slice(0, 5) == 'data-')) {
      f = a.hasAttribute(g);
      a.removeAttribute(g)
    }
...
function y(a) {
  for (var b = E(this), c = a.getElementsByTag(this.element), d, e = c.count();
       --e >= 0;) {
    d = c.getItem(e);
...
function n(a, b, c) {
  for (var d = a.document, e = a.getRanges(),
           b = b ? this.removeFromRange : this.applyToRange, f,
           g = e.createIterator();
       f = g.getNextRange();)
    b.call(this, f, c);
  a.selectRanges(e);
...
CKEDITOR.style = function(a, b) {
  ...
  c = this.element = a.element ?
      typeof a.element == 'string' ? a.element.toLowerCase() : a.element :
      '*';
  this.type = a.type ||
      (r[c] ? CKEDITOR.STYLE_BLOCK :
              o[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
...
CKEDITOR.style.prototype = {
  ...
  applyToRange: function(a) {
    this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ?
        e :
        this.type == CKEDITOR.STYLE_BLOCK ?
        h :
        this.type == CKEDITOR.STYLE_OBJECT ? f : null;
    return this.applyToRange(a)
  },
  removeFromRange: function(a) {
    this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ?
        b :
        this.type == CKEDITOR.STYLE_BLOCK ?
        l :
        this.type == CKEDITOR.STYLE_OBJECT ? d : null;
  ...
  checkElementMatch: function(a, b) {
    ...
    var d = a.getName();
    if (typeof this.element == 'string' ? d == this.element :
                                          d in this.element) {
...
CKEDITOR.style.addCustomHandler = function(a) {
  ...
  b.prototype = CKEDITOR.tools.extend(
      ...
      {assignedTo: CKEDITOR.STYLE_OBJECT}, a, true);
  return this.customHandlers[a.type] = b
};
var L = CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL |
    CKEDITOR.POSITION_IS_CONTAINED,
    B = CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL |
    CKEDITOR.POSITION_IS_CONTAINED
})();
...
CKEDITOR.addStylesSet =
    CKEDITOR.tools.bind(CKEDITOR.stylesSet.add, CKEDITOR.stylesSet);
    ...
    if (!b) {
      ...
      this.on('selectionChange', function(a) {
        for (var e = 0; e < b.length; e++) {
          var d = b[e],
              h = d.style.checkActive(a.data.path, this) ?
    ...
    if (this._.stylesDefinitions)
      ...
      if (b === false)
        ...
        CKEDITOR.stylesSet.addExternal(
            c, b[1] ? b.slice(1).join(':') : CKEDITOR.getUrl('styles.js'), '');
    ...
    if (i.type == CKEDITOR.NODE_ELEMENT) {
      ...
      if (!this.lastElement) {
        ...
        if (i.is(CKEDITOR.dtd.$object) ||
            i.getAttribute('contenteditable') == 'false')
          continue
      }
      if (i.equals(f)) break;
      if (!h) {
        g = i.getName();
        i.getAttribute('contenteditable') == 'true' ? h = i :
                                                      !d && e[g] && (d = i);
        if (a[g]) {
          var m;
          if (m = !d) {
...
CKEDITOR.dom.elementPath.prototype = {
  ...
  isContextFor: function(a) {
    ...
    if (a in CKEDITOR.dtd.$block) {
      e = this.contains(CKEDITOR.dtd.$intermediate) ||
          this.root.equals(this.block) && this.block || this.blockLimit;
      return !!e.getDtd()[a]
    }
    return true
  },
...
CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
  ...
  split: function(a) {
    var e = this.$.parentNode, b = e.childNodes.length, c = this.getLength(),
        f = this.getDocument(),
  ...
  substring: function(a, e) {
    return typeof e != 'number' ? this.$.nodeValue.substr(a) :
                                  this.$.nodeValue.substring(a, e)
  }
});
(function() {
function a(a, c, e) {
  var d = a.serializable, h = c[e ? 'endContainer' : 'startContainer'],
    ...
    return {
      getNextRange: function(h) {
        ...
        if (l && a.length > 1) {
          ...
          if (h)
            for (var g = 0; a[d + g + 1];) {
              for (var m = l.document, h = 0, i = m.getById(e[g].endNode),
                       m = m.getById(e[g + 1].startNode);
                   ;) {
...
CKEDITOR.plugins.add('dialogui', {
  onLoad: function() {
        ...
        CKEDITOR.ui.dialog, {
          labeledElement: function(b, a, d, f) {
            if (!(4 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.uiElement.call(
                  this, b, a, d, 'div', null, e, function() {
                    var e = [], g = a.required ? ' cke_required' : '';
                    if (a.labelLayout != 'horizontal')
                      e.push(
                          '<label class="cke_dialog_ui_labeled_label' + g +
                              '" ',
                          ' id="' + c.labelId + '"',
                          ...
                          a.controlStyle ? ' style="' + a.controlStyle + '"' :
                                           '',
                          ' role="presentation">', f.call(this, b, a),
                          '</div>');
                    else {
                      g = {
                        type: 'hbox',
          ...
          textInput: function(b, a, d) {
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function() {
                var b = [
                  '<div class="cke_dialog_ui_input_', a.type,
                  '" role="presentation"'
                ];
          ...
          checkbox: function(b, a, d) {
            if (!(3 > arguments.length)) {
              ...
              a.validate && (this.validate = a.validate);
              CKEDITOR.ui.dialog.uiElement.call(
                  this, b, a, d, 'span', null, null, function() {
          ...
          radio: function(b, a, d) {
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function() {
                for (var e = [], d = [],
                         g = (a.id ? a.id : CKEDITOR.tools.getNextId()) +
                         '_radio',
                         i = 0;
                     i < a.items.length; i++) {
                  var j = a.items[i], h = j[2] !== void 0 ? j[2] : j[0],
                      ...
                      m = CKEDITOR.tools.extend(
                          {}, a, {id: m, title: null, type: null}, true),
                  ...
                  f.push(new CKEDITOR.ui.dialog.uiElement(
                      b, m, q, 'input', null, o));
                  q.push(' ');
                  new CKEDITOR.ui.dialog.uiElement(
                      b, h, q, 'label', null, {id: n, 'for': o.id}, j[0]);
                  e.push(q.join(''))
                }
          ...
          button: function(b, a, d) {
            if (arguments.length) {
              ...
              CKEDITOR.ui.dialog.uiElement.call(
                  ...
                  '<span id="' + e + '" class="cke_dialog_ui_button">' +
          ...
          file: function(b, a, d) {
            if (!(3 > arguments.length)) {
              ...
              var f = CKEDITOR.tools.extend(
                  h.call(this, a), {definition: a, buttons: []});
              a.validate && (this.validate = a.validate);
              b.on('load', function() {
                CKEDITOR.document.getById(f.frameId).getParent().addClass(
              ...
              CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function() {
                ...
                b.push(
                    CKEDITOR.env.ie ?
                        '(function(){' +
                            encodeURIComponent(
                                'document.open();(' + CKEDITOR.tools.fixDomain +
                                ')();document.close();') +
                            '})()' :
                        '0');
                b.push(')"></iframe>');
          ...
          fieldset: function(b, a, d, f, c) {
            ...
            this._ = {children: a};
            CKEDITOR.ui.dialog.uiElement.call(
                this, b, c, f, 'fieldset', null, null, function() {
                  var a = [];
                  e &&
                      a.push(
                          '<legend' +
        ...
        new CKEDITOR.ui.dialog.labeledElement, {
          ...
          add: function(b, a, d) {
            var f = new CKEDITOR.dom.element(
                    'option', this.getDialog().getParentEditor().document),
                c = this.getInputElement().$;
            f.$.text = b;
            f.$.value = void 0 === a || null === a ? b : a;
            void 0 === d || null === d ?
                CKEDITOR.env.ie ? c.add(f.$) : c.add(f.$, null) :
                c.add(f.$, d);
            return this
          },
          remove: function(b) {
    ...
    CKEDITOR.ui.dialog.radio.prototype = CKEDITOR.tools.extend(
        new CKEDITOR.ui.dialog.uiElement, {
          setValue: function(b, a) {
            for (var d = this._.children, f, c = 0; c < d.length && (f = d[c]);
                 c++)
          ...
          eventProcessors: {
            onChange: function(b, a) {
              if (CKEDITOR.env.ie)
                b.on('load', function() {
                  for (var a = this._.children, b = this, c = 0; c < a.length;
                       c++)
    ...
    CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(
        new CKEDITOR.ui.dialog.labeledElement, n, {
          getInputElement: function() {
            var b =
          ...
          reset: function() {
            function b() {
              ...
              d.$.write([
                ...
                '<form enctype="multipart/form-data" method="POST" dir="' + g +
                    '" lang="' + i + '" action="',
            ...
            var a = this._,
                ...
                f = a.definition, c = a.buttons, e = this.formLoadedNumber,
                k = this.formUnloadNumber, g = a.dialog._.editor.lang.dir,
    ...
    CKEDITOR.dialog.addUIElement('fieldset', {
      build: function(b, a, d) {
        for (var f = a.children, c, e = [], h = [], g = 0;
             g < f.length && (c = f[g]); g++) {
          var i = [];
          e.push(i);
...
function G(a, b) {
  for (var c = a.$.getElementsByTagName('input'), e = 0, d = c.length; e < d;
       e++) {
    var g = new CKEDITOR.dom.element(c[e]);
    'text' == g.getAttribute('type').toLowerCase() &&
        (b ? (g.setAttribute('value', g.getCustomData('fake_value') || ''),
...
function P(a, b) {
  ...
  c &&
      (a ? c.removeAttribute('aria-invalid') :
...
function R(a) {
  ...
  if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
    var d = 'javascript:void(function(){' +
        encodeURIComponent(
                'document.open();(' + CKEDITOR.tools.fixDomain +
                ')();document.close();') +
        '}())';
    CKEDITOR.dom.element
        .createFromHtml(
            '<iframe frameBorder="0" class="cke_iframe_shim" src="' + d +
            '" tabIndex="-1"></iframe>')
...
function U(a) {
  function b(b) {
    var c = a.getSize(), i = CKEDITOR.document.getWindow().getViewPaneSize(),
        o = b.data.$.screenX, j = b.data.$.screenY, n = o - e.x, l = j - e.y;
    e = {x: o, y: j};
    d.x += n;
    d.y += l;
    a.move(
        d.x + h[3] < f ? -h[3] :
                         d.x - h[1] > i.width - c.width - f ?
                         i.width - c.width + ('rtl' == g.lang.dir ? 0 : h[1]) :
                         d.x,
        d.y + h[0] < f ?
            -h[0] :
            d.y - h[2] > i.height - c.height - f ? i.height - c.height + h[2] :
                                                   d.y,
        1);
  ...
  var g = a.getParentEditor(), f = g.config.dialog_magnetDistance,
...
function V(a) {
  ...
  function e(d) {
    var e = 'rtl' == h.lang.dir, j = o.width, C = o.height,
        ...
        x = a._.element.getFirst(), x = e && x.getComputedStyle('right'),
        y = a.getPosition();
  ...
  if (f != CKEDITOR.DIALOG_RESIZE_NONE) {
    var h = a.getParentEditor(), m, k, i, o, j,
        n = CKEDITOR.tools.addFunction(function(f) {
          o = a.getSize();
          var h = a.parts.contents;
          h.$.getElementsByTagName('iframe').length &&
          ...
          CKEDITOR.env.ie6Compat &&
              (h = q.getChild(0).getFrameDocument(), h.on('mousemove', e),
               h.on('mouseup', d));
    ...
    a.on('load', function() {
      ...
      b = CKEDITOR.dom.element.createFromHtml(
          '<div class="cke_resizer' + b + ' cke_resizer_' + h.lang.dir +
          '" title="' + CKEDITOR.tools.htmlEncode(h.lang.common.resize) +
          '" onmousedown="CKEDITOR.tools.callFunction(' + n + ', event )">' +
          ('ltr' == h.lang.dir ? '◢' : '◣') + '</div>');
...
function J(a) {
  var b = CKEDITOR.document.getWindow(), c = a.config,
      e = c.dialog_backgroundCoverColor || 'white',
      d = c.dialog_backgroundCoverOpacity, g = c.baseFloatZIndex,
      c = CKEDITOR.tools.genKey(e, d, g), f = w[c];
  f ? f.show() :
      (g =
           [
             '<div tabIndex="-1" style="position: ',
             CKEDITOR.env.ie6Compat ? 'absolute' : 'fixed', '; z-index: ', g,
             '; top: 0px; left: 0px; ',
             !CKEDITOR.env.ie6Compat ? 'background-color: ' + e : '',
             '" class="cke_dialog_background_cover">'
           ],
       CKEDITOR.env.ie6Compat &&
           (e = '<html><body style=\\\'background-color:' + e +
                ';\\\'></body></html>',
            g.push(
       ...
       g.push('</div>'), f = CKEDITOR.dom.element.createFromHtml(g.join('')),
       f.setOpacity(void 0 != d ? d : 0.5), f.on('keydown', E),
       f.on('keypress', E), f.on('keyup', E),
       f.appendTo(CKEDITOR.document.getBody()), w[c] = f);
...
function K(a) {
  q &&
      (a.focusManager.remove(q), a = CKEDITOR.document.getWindow(), q.hide(),
...
var r = CKEDITOR.tools.cssLength,
    S = '<div class="cke_reset_all {editorId} {editorDialogClass} {hidpi}" dir="{langDir}" lang="{langCode}" role="dialog" aria-labelledby="cke_dialog_title_{id}"><table class="cke_dialog ' +
    CKEDITOR.env.cssClass +
...
CKEDITOR.dialog = function(a, b) {
  function c() {
    var a = l._.focusList;
    a.sort(function(a, b) {
      return a.tabIndex != b.tabIndex ? b.tabIndex - a.tabIndex :
  ...
  function e(a) {
    ...
    if (!(1 > b.length)) {
      ...
      for (var d = c = (c + a + b.length) % b.length; a &&
           !b[d].isFocusable() && !(d = (d + a + b.length) % b.length, d == c);)
        ;
      b[d].focus();
  ...
  function d(b) {
    if (l == CKEDITOR.dialog._.currentTop) {
      ...
      if (9 == c || c == CKEDITOR.SHIFT + 9)
        ...
        l._.tabBarMode ? (c = c ? t.call(l) : u.call(l), l.selectPage(c),
                          l._.tabs[c][0].focus()) :
                         e(c ? -1 : 1),
        o = 1;
      else if (
          c == CKEDITOR.ALT + 121 && !l._.tabBarMode && 1 < l.getPageCount())
        l._.tabBarMode = !0, l._.tabs[l._.currentTabId][0].focus(), o = 1;
      else if ((37 == c || 39 == c) && l._.tabBarMode)
        c = c == (d ? 39 : 37) ? t.call(l) : u.call(l), l.selectPage(c),
        l._.tabs[c][0].focus(), o = 1;
      else if ((13 == c || 32 == c) && l._.tabBarMode)
        this.selectPage(this._.currentTabId),
            this._.tabBarMode = !1, this._.currentFocusIndex = -1, e(1), o = 1;
      else if (13 == c) {
        c = b.data.getTarget();
        if (!c.is('a', 'button', 'select', 'textarea') &&
  ...
  var f = CKEDITOR.dialog._.dialogDefinitions[b], h = CKEDITOR.tools.clone(W),
      m = a.config.dialog_buttonsOrder || 'OS', k = a.lang.dir, i = {}, o, j;
  ('OS' == m && CKEDITOR.env.mac || 'rtl' == m && 'ltr' == k ||
   'ltr' == m && 'rtl' == k) &&
      h.buttons.reverse();
  ...
  CKEDITOR.event.call(this);
  this.definition = f =
      CKEDITOR.fire('dialogDefinition', {name: b, definition: f}, a).definition;
  ...
  this.on('cancel', function(b) {
    p(function(c) {
      if (c.isChanged())
        return !a.config.dialog_noConfirmCancel &&
                   !confirm(a.lang.common.confirmCancel) && (b.data.hide = !1),
               !0
    })
  }, this, null, 0);
  ...
  this.parts.tabs.on('click', function(a) {
    ...
    b.hasClass('cke_dialog_tab') &&
        (b = b.$.id, this.selectPage(b.substring(4, b.lastIndexOf('_'))),
         this._.tabBarMode &&
             (this._.tabBarMode = !1, this._.currentFocusIndex = -1, e(1)),
         a.data.preventDefault())
  }, this);
  k = [];
  i = CKEDITOR.dialog._.uiElementBuilders.hbox
          .build(
              this, {
                type: 'hbox',
...
CKEDITOR.dialog.prototype = {
  ...
  getSize: function() {
    ...
    return {
      width: a.$.offsetWidth || 0, height: a.$.offsetHeight || 0
    }
  },
  move: function(a, b, c) {
    ...
    if (!g || !this._.position ||
      ...
      g ||
          (g = CKEDITOR.document.getWindow().getScrollPosition(), a += g.x,
           b += g.y),
      d &&
          (g = this.getSize(),
           a = CKEDITOR.document.getWindow().getViewPaneSize().width - g.width -
               a),
      b = {top: (0 < b ? b : 0) + 'px'},
      b[d ? 'right' : 'left'] = (0 < a ? a : 0) + 'px', e.setStyles(b),
      c && (this._.moved = 1)
  },
  ...
  show: function() {
    ...
    this.resize(
        ...
        this._.contentSize && this._.contentSize.height || b.height ||
            b.minHeight);
    this.reset();
    ...
    this._.element.getFirst().setStyle(
        'z-index', CKEDITOR.dialog._.currentZIndex += 10);
    null === CKEDITOR.dialog._.currentTop ?
        (CKEDITOR.dialog._.currentTop = this, this._.parentDialog = null,
         J(this._.editor)) :
    ...
    for (var c in b.contents)
      if (b.contents[c]) {
        var a = b.contents[c], e = this._.tabs[a.id], d = a.requiredContent,
            g = 0;
        if (e) {
          for (var f in this._.contents[a.id]) {
            var h = this._.contents[a.id][f];
            'hbox' == h.type || ('vbox' == h.type || !h.getInputElement()) ||
                (h.requiredContent &&
                         !this._.editor.activeFilter.check(h.requiredContent) ?
                     h.disable() :
                     (h.enable(), g++))
          }
          !g || d && !this._.editor.activeFilter.check(d) ?
  ...
  layout: function() {
    var a = this.parts.dialog, b = this.getSize(),
  ...
  commitContent: function() {
    var a = arguments;
    this.foreach(function(b) {
      CKEDITOR.env.ie && this._.currentFocusIndex == b.focusIndex &&
    ...
    if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
      for (var b = [],
               ...
               e = CKEDITOR.dialog._.uiElementBuilders.vbox.build(
                   ...
                   b),
               d = this._.contents[a.id] = {}, g = e.getChild(), f = 0;
           e = g.shift();)
      ...
      c = CKEDITOR.dom.element.createFromHtml([
        ...
        0 < this._.pageCount ? ' cke_last' : 'cke_first', c,
        a.hidden ? ' style="display:none"' : '', ' id="', d, '"',
        e.gecko && !e.hc ? '' : ' href="javascript:void(0)"',
        ' tabIndex="-1" hidefocus="true" role="tab">', a.label, '</a>'
      ].join(''));
  ...
  selectPage: function(a) {
    if (this._.currentTabId != a &&
        ...
        !1 !==
            this.fire(
                'selectPage', {page: a, currentPage: this._.currentTabId})) {
      ...
      CKEDITOR.env.ie6Compat || CKEDITOR.env.ie7Compat ? (G(d[1]), d[1].show(),
                                                          setTimeout(
                                                              function() {
                                                                G(d[1], 1)
                                                              },
  ...
  hidePage: function(a) {
    ...
    b && (1 != this._.pageCount && b.isVisible()) &&
        (a == this._.currentTabId && this.selectPage(t.call(this)), b.hide(),
         this._.pageCount--, this.updateStyle())
  },
  showPage: function(a) {
...
CKEDITOR.ui.dialog = {
  uiElement: function(a, b, c, e, d, g, f) {
    if (!(4 > arguments.length)) {
      ...
      n = (b.style || '').split(';');
      b.align &&
          (l = b.align, k['margin-left'] = 'left' == l ? 0 : 'auto',
           k['margin-right'] = 'right' == l ? 0 : 'auto');
      for (j in k) n.push(j + ':' + k[j]);
      b.hidden && n.push('display:none');
      for (j = n.length - 1; 0 <= j; j--) '' === n[j] && n.splice(j, 1);
      0 < n.length &&
          (i.style = (i.style ? i.style + '; ' : '') + n.join('; '));
      ...
      this.accessKeyUp && (this.accessKeyDown && b.accessKey) &&
          O(this, a, 'CTRL+' + b.accessKey);
      var p = this;
      a.on('load', function() {
        var b = p.getInputElement();
        if (b) {
          var c = p.type in {checkbox: 1, ratio: 1} && CKEDITOR.env.ie &&
  ...
  hbox: function(a, b, c, e, d) {
    if (!(4 > arguments.length)) {
      this._ || (this._ = {});
      var g = this._.children = b, f = d && d.widths || null,
          h = d && d.height || null, m, k = {role: 'presentation'};
      d && d.align && (k.align = d.align);
      CKEDITOR.ui.dialog.uiElement.call(
          this, a, d || {type: 'hbox'}, e, 'table', {}, k, function() {
  ...
  vbox: function(a, b, c, e, d) {
    if (!(3 > arguments.length)) {
      this._ || (this._ = {});
      var g = this._.children = b, f = d && d.width || null,
          h = d && d.heights || null;
      CKEDITOR.ui.dialog.uiElement.call(
          this, a, d || {type: 'vbox'}, e, 'div', null, {role: 'presentation'},
          function() {
            ...
            for (var e = 0; e < c.length; e++) {
              ...
              h ? i.push('height:' + r(h[e])) :
                  d && d.expand &&
                      i.push('height:' + Math.floor(100 / c.length) + '%');
              d && void 0 != d.padding && i.push('padding:' + r(d.padding));
              CKEDITOR.env.ie && (CKEDITOR.env.quirks && g[e].align) &&
                  i.push('text-align:' + g[e].align);
...
var a = {
  build: function(a, c, e) {
    for (var d = c.children, g, f = [], h = [], m = 0;
         m < d.length && (g = d[m]); m++) {
      var k = [];
      f.push(k);
...
CKEDITOR.dialog.validate = {
  functions: function() {
    var a = arguments;
    return function() {
      var b = this && this.getValue ? this.getValue() : a[0], c = void 0,
          d = CKEDITOR.VALIDATE_AND, e = [], g;
...
CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
  openDialog: function(a, b) {
    ...
    if ('function' == typeof e)
      ...
      c = c[a] || (c[a] = new CKEDITOR.dialog(this, a)), b && b.call(c, c),
      c.show();
    else {
      if ('failed' == e)
        throw K(this),
            Error(
                '[CKEDITOR.dialog.openDialog] Dialog "' + a +
...
CKEDITOR.plugins.add('about', {
  ...
  init: function(a) {
    ...
    a.ui.addButton &&
        a.ui.addButton(
            'About',
            {label: a.lang.about.title, command: 'about', toolbar: 'about'});
    ...
    b.addCommand('a11yHelp', {
      exec: function() {
        var a = b.langCode,
            ...
            a :
            c.availableLangs[a.replace(/-.*/, '')] ? a.replace(/-.*/, '') :
                                                     'en';
        CKEDITOR.scriptLoader.load(
            CKEDITOR.getUrl(c.path + 'dialogs/lang/' + a + '.js'), function() {
...
CKEDITOR.plugins.add('basicstyles', {
  init: function(c) {
        ...
        d =
          ...
          if (a) {
            ...
            c.ui.addButton &&
                c.ui.addButton(
                    g,
                    {label: d, command: b, toolbar: 'basicstyles,' + (e += 10)})
          }
        },
        h = {
          bold: [
    ...
    c.setKeystroke([
      [CKEDITOR.CTRL + 66, 'bold'], [CKEDITOR.CTRL + 73, 'italic'],
...
var k = {
  exec: function(g) {
    var a = g.getCommand('blockquote').state, i = g.getSelection(),
        c = i && i.getRanges()[0];
    if (c) {
      ...
      if (a == CKEDITOR.TRISTATE_OFF) {
        ...
        1 > e.length &&
            (a = g.document.createElement(
             ...
             b = h.shift(), c.insertNode(a),
             a.append(new CKEDITOR.dom.text('﻿', g.document)),
             c.moveToBookmark(b), c.selectNodeContents(a), c.collapse(!0),
             b = c.createBookmark(), e.push(a), h.unshift(b));
        d = e[0].getParent();
        c = [];
        ...
        for (; 0 < c.length;)
          if (a = c.shift(), 'blockquote' == a.getName()) {
            for (b = new CKEDITOR.dom.documentFragment(g.document);
                 a.getFirst();)
        ...
        for (d = {}; a = f.getNextParagraph();) {
          ...
          c && (e && !e.getCustomData('blockquote_moveout')) &&
              (b.push(e),
        ...
        for (b = e.length - 1; 0 <= b; b--) {
          ...
          a: {
            ...
            for (
                ...
                f < k && (j = d.getChild(f));
                f++) if (j.type == CKEDITOR.NODE_ELEMENT && j.isBlockBoundary()) {
              d = !1;
              break a
            } d = !0
          } d &&
...
function v(b) {
  function a() {
    ...
    CKEDITOR.env.ie && e.on('paste', function(e) {
      q ||
          (g(), e.data.preventDefault(), u(e),
           h('paste') || b.openDialog('paste'))
    });
    CKEDITOR.env.ie &&
        (e.on('contextmenu', i, null, null, 0),
    ...
    var a;
    e.attachListener(
        CKEDITOR.env.ie ? e : b.document.getDocumentElement(), 'mouseup',
        function() {
    ...
    return {
      canUndo: !1, async: !0, exec: function(b, a) {
        var d = function(a, d) {
          ...
          b.fire(
              'afterCommandExec', {name: 'paste', command: c, returnValue: !!a})
        }, c = this;
        'string' == typeof a ? d({type: 'auto', dataValue: a}, 1) :
  ...
  function j() {
    if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
      ...
      if (e.getType() == CKEDITOR.SELECTION_ELEMENT &&
          (a = e.getSelectedElement()))
        d = e.getRanges()[0], c = b.document.createText(''), c.insertBefore(a),
        d.setStartBefore(c), d.setEndAfter(a), e.selectRanges([d]),
        setTimeout(function() {
  ...
  function l(a, d) {
    ...
    if (!c.getById('cke_pastebin')) {
      ...
      var k = new CKEDITOR.dom.element(
          (CKEDITOR.env.webkit || j.is('body')) && !CKEDITOR.env.ie ? 'body' :
                                                                      'div',
          c);
      k.setAttributes({id: 'cke_pastebin', 'data-cke-temp': '1'});
      var f = 0, c = c.getWindow();
      CKEDITOR.env.webkit ?
          (j.append(k), k.addClass('cke_editable'),
           j.is('body') ||
               (f = 'static' != j.getComputedStyle('position') ?
                    j :
                    CKEDITOR.dom.element.get(j.$.offsetParent),
                f = f.getDocumentPosition().y)) :
          j.getAscendant(CKEDITOR.env.ie ? 'body' : 'html', 1).append(k);
      k.setStyles({
        position: 'absolute',
      ...
      setTimeout(function() {
        ...
        k.remove();
        var a;
        if (CKEDITOR.env.webkit && (a = k.getFirst()) && a.is &&
  ...
  (function() {
    ...
    b.contextMenu && b.contextMenu.addListener(function(b, a) {
      ...
      return {
        cut: m('cut'), copy: m('copy'), paste: m('paste')
      }
    })
  })();
  (function() {
  ...
  b.getClipboardData = function(a, d) {
    ...
    !1 === s() &&
        (b.removeListener('paste', c),
         g && b.fire('pasteDialog', l) ?
             (b.on('pasteDialogCommit', j),
              b.on(
                  'dialogHide',
                  function(a) {
                    a.removeListener();
...
function x(b, a) {
  ...
  CKEDITOR.env.gecko && b.enterMode != CKEDITOR.ENTER_BR &&
      (CKEDITOR.env.gecko && (a = a.replace(/^<br><br>$/, '<br>')),
       -1 < a.indexOf('<br><br>') &&
           (a = '<p>' + a.replace(/(<br>){2,}/g, function(a) {
             return c(a.length / 4)
           }) + '</p>'));
  return o(b, a)
}
function y() {
  var b = new CKEDITOR.htmlParser.filter, a = {
    ...
    ul: 1
      ...
      d = {p: 1, br: 1, 'cke:br': 1}, g = CKEDITOR.dtd,
  ...
  b.addRules(
      {
        elements: {
          ...
          img: function(a) {
            ...
            a && !a.match(/(^http|\.(jpe?g|gif|png))/i) &&
                (b = ' [' + a + '] ');
...
CKEDITOR.plugins.add('clipboard', {
  ...
  init: function(b) {
    ...
    v(b);
    CKEDITOR.dialog.add(
        'paste', CKEDITOR.getUrl(this.path + 'dialogs/paste.js'));
    b.on('paste', function(a) {
      ...
      -1 < b.indexOf('Apple-') &&
          (b = b.replace(
           ...
           -1 < b.indexOf('<br class="Apple-interchange-newline">') &&
               (a.data.startsWithEOL = 1, a.data.preSniffing = 'html',
                b = b.replace(/<br class="Apple-interchange-newline">/, '')),
           b = b.replace(/(<[^>]+) class="Apple-[^"]*"/gi, '$1'));
      if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
        var i, h, f = new CKEDITOR.dom.element('div');
        for (f.setHtml(b); 1 == f.getChildCount() && (i = f.getFirst()) &&
             i.type == CKEDITOR.NODE_ELEMENT &&
             (i.hasClass('cke_editable') || i.hasClass('cke_contents'));)
          f = h = i;
      ...
      CKEDITOR.env.ie ? b = b.replace(
                        ...
                        CKEDITOR.env.webkit ? b = b.replace(
                                                  /<\/(\w+)><div><br><\/div>$/,
                                                  function(b, d) {
                                                    if (d in g) {
...
CKEDITOR.ui.panel.prototype = {
  render: function(a, b) {
        ...
        if (this.isFramed) {
          ...
          a.on('keydown', function(a) {
            ...
            this._.onKeyDown && !1 === this._.onKeyDown(b) ?
                a.data.preventDefault() :
                (27 == b || b == ('rtl' == c ? 39 : 37)) && this.onEscape &&
                    !1 === this.onEscape(b) && a.data.preventDefault()
          }, this);
          a = a.getBody();
          a.unselectable();
    ...
    if (this.isFramed) {
      var e = CKEDITOR.env.air ? 'javascript:void(0)' :
                                 CKEDITOR.env.ie ?
  ...
  showBlock: function(a) {
    var a = this._.blocks[a], b = this._.currentBlock,
        d = !this.forceIFrame || CKEDITOR.env.ie ?
        this._.holder :
...
CKEDITOR.ui.panel.block = CKEDITOR.tools.createClass({
  ...
  _: {
    markItem: function(a) {
      -1 != a &&
          (a = this.element.getElementsByTag('a').getItem(
               this._.focusIndex = a),
      ...
      switch (d) {
        case 'next':
          for (var e = this._.focusIndex,
                   d = this.element.getElementsByTag('a'), c;
               c = d.getItem(++e);)
        ...
        case 'mouseup':
          return e = this._.focusIndex,
                 (c = 0 <= e &&
                      this.element.getElementsByTag('a').getItem(e)) &&
                     (c.$[d] ? c.$[d]() : c.$['on' + d]()),
                 !1
      }
      return !0
...
function r(a, b, c, i, f) {
  var f = CKEDITOR.tools.genKey(
          b.getUniqueId(), c.getUniqueId(), a.lang.dir, a.uiColor || '',
          i.css || '', f || ''),
      h = g[f];
  h ||
      (h = g[f] = new CKEDITOR.ui.panel(b, i),
       h.element =
           c.append(CKEDITOR.dom.element.createFromHtml(h.render(a), b)),
...
CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
  $: function(a, b, c, i) {
    ...
    var h = b.getDocument(), i = r(a, h, b, c, i || 0), j = i.element,
        l = j.getFirst(), d = this;
  ...
  proto: {
    ...
    showBlock: function(a, b, c, i, f, h) {
      ...
      var d = this.element, a = this._.iframe,
          ...
          g = d.getDocument(), o = this._.parentElement.getPositionedAncestor(),
          p = b.getDocumentPosition(g),
          g = o ? o.getDocumentPosition(g) : {x: 0, y: 0},
          m = 'rtl' == this._.dir, e = p.x + (i || 0) - g.x,
          k = p.y + (f || 0) - g.y;
      if (m && (1 == c || 4 == c))
        e += b.$.offsetWidth;
      else if (!m && (2 == c || 3 == c))
           ...
           a.on(
               ...
               function(a) {
                 ...
                 this.allowBlur() &&
                     ...
                     (CKEDITOR.env.iOS ? this._.hideTimeout ||
                              (this._.hideTimeout =
                                   CKEDITOR.tools.setTimeout(q, 0, this)) :
                                         q.call(this))
               },
               this),
           a.on(
               ...
               this),
           CKEDITOR.env.iOS && (a.on('touchstart', function() {
      ...
      CKEDITOR.tools.setTimeout(function() {
        var a = CKEDITOR.tools.bind(function() {
          ...
          if (l.autoSize) {
            var a = l.element.getDocument(),
                a = (CKEDITOR.env.webkit ? l.element : a.getBody())
                        .$.scrollWidth;
            CKEDITOR.env.ie && (CKEDITOR.env.quirks && a > 0) &&
            ...
            j._.currentBlock.element.setStyle('display', 'none')
                .removeStyle('display')
          } else
            d.removeStyle('height');
          m && (e = e - d.$.offsetWidth);
          d.setStyle('left', e + 'px');
          var b = j.element.getWindow(), a = d.$.getBoundingClientRect(),
              b = b.getViewPaneSize(), c = a.width || a.right - a.left,
          ...
          m ? i < c &&
                  (e = g > c ?
                       e + c :
                       b.width > c ? e - a.left : e - a.right + b.width) :
              i < c &&
                  (e = g > c ?
                       e - c :
                       b.width > c ? e - a.right + b.width : e - a.left);
          c = a.top;
          b.height - a.top < f &&
              (k = c > f ? k - f :
                           b.height > f ? k - a.bottom + b.height : k - a.top);
          if (CKEDITOR.env.ie) {
          ...
          var a = d.getFirst(), n;
          (n = a.getCustomData('activePanel')) && n.onHide &&
      ...
      this._.activeChild == a && a._.panel._.offsetParentId == c.getId() ||
          (this.hideChild(),
           a.onHide = CKEDITOR.tools.bind(
               ...
               this),
           this._.activeChild = a, this._.focused = !1,
           a.showBlock(b, c, g, f, h), this.blur(),
    ...
    hideChild: function(a) {
      ...
      b &&
          (delete b.onHide, delete this._.activeChild, b.hide(),
           a && this.focus())
    }
  }
});
...
function g(a) {
  a.sort(function(a, c) {
    return a.group < c.group ?
        -1 :
        a.group > c.group ? 1 :
                            a.order < c.order ? -1 : a.order > c.order ? 1 : 0
  })
}
var h =
...
var h = h +
    ...
    m = CKEDITOR.addTemplate(
        'menuItem',
        h + '<span class="cke_menubutton_inner"><span class="cke_menubutton_icon"><span class="cke_button_icon cke_button__{iconName}_icon" style="{iconStyle}"></span></span><span class="cke_menubutton_label">{label}</span>{arrowHtml}</span></a></span>'),
    l = CKEDITOR.addTemplate(
        'menuArrow', '<span class="cke_menuarrow"><span>{label}</span></span>');
CKEDITOR.menu = CKEDITOR.tools.createClass({
  ...
  _: {
    onShow: function() {
      var a = this.editor.getSelection(), b = a && a.getStartElement(),
          c = this.editor.elementPath(), k = this._.listeners;
      this.removeAll();
      ...
      if (c = c.getItems && c.getItems()) {
        b ? b.removeAll() :
            (b = this._.subMenu = new CKEDITOR.menu(
                 this.editor,
                 CKEDITOR.tools.extend(
                     {}, this._.definition, {level: this._.level + 1}, !0)),
             b.parent = this,
        ...
        var j = this._.panel.getBlock(this.id).element.getDocument().getById(
            this.id + ('' + a));
        setTimeout(function() {
          b.show(j, 2)
        }, 0)
  ...
  proto: {
    ...
    show: function(a, b, c, k) {
      ...
      var b = b || ('rtl' == this.editor.lang.dir ? 2 : 1), e = this.items,
          j = this.editor, i = this._.panel, f = this._.element;
      if (!i) {
        i = this._.panel = new CKEDITOR.ui.floatPanel(
            this.editor, CKEDITOR.document.getBody(), this._.panelDefinition,
            this._.level);
        ...
        d['rtl' == j.lang.dir ? 37 : 39] =
            CKEDITOR.env.ie ? 'mouseup' : 'click';
        ...
        this._.itemOverFn = CKEDITOR.tools.addFunction(function(a) {
          ...
          this._.showSubTimeout = CKEDITOR.tools.setTimeout(
              this._.showSubMenu, j.config.menu_subMenuDelay || 400, this, [a])
        }, this);
      ...
      for (var d = j.elementPath(),
               d =
                   ['<div class="cke_menu' +
                    (d && d.direction() != j.lang.dir ?
                         ' cke_mixed_dir_content' :
                         '') +
                    '" role="presentation">'],
               h = e.length, m = h && e[0].group, l = 0;
           l < h; l++) {
        var n = e[l];
        m != n.group &&
      ...
      f.setHtml(d.join(''));
      CKEDITOR.ui.fire('ready', this);
      this.parent ? this.parent._.panel.showAsChild(i, this.id, a, b, c, k) :
...
CKEDITOR.menuItem = CKEDITOR.tools.createClass({
  $: function(a, b, c) {
    CKEDITOR.tools.extend(
        this, c, {order: 0, className: 'cke_menubutton__' + b});
  ...
  proto: {
    render: function(a, b, c) {
      var h = a.id + ('' + b),
          e = 'undefined' == typeof this.state ? CKEDITOR.TRISTATE_OFF :
                                                 this.state,
          j = '',
          i = e == CKEDITOR.TRISTATE_ON ?
          'on' :
          e == CKEDITOR.TRISTATE_DISABLED ? 'disabled' : 'off';
      ...
      a = {
        ...
        iconStyle: CKEDITOR.skin.getIconStyle(
            g, 'rtl' == this.editor.lang.dir, g == this.icon ? null : this.icon,
            this.iconOffset),
              ...
              if (CKEDITOR.env.mac && CKEDITOR.env.webkit) {
                var c = this.editor,
                    b = (new CKEDITOR.dom.elementPath(
                             a.getTarget(), c.editable()))
                            .contains(function(a) {
                              return a.hasAttribute('contenteditable')
                            }, !0);
                b && 'false' == b.getAttribute('contenteditable') &&
    ...
    if (!1 !== a.resize_enabled) {
      var c = null,
          ...
          j = function(d) {
            ...
            i &&
                (e = Math.max(
                     a.resize_minWidth, Math.min(c, a.resize_maxWidth)));
            l &&
                (m = Math.max(
                     a.resize_minHeight, Math.min(d, a.resize_maxHeight)));
            b.resize(i ? e : null, m)
          }, k = function() {
      ...
      b.on('uiSpace', function(a) {
        if ('bottom' == a.data.space) {
          ...
          var c = '<span id="' + q + '" class="cke_resizer' + e +
              ' cke_resizer_' + h + '" title="' +
              CKEDITOR.tools.htmlEncode(b.lang.common.resize) +
              '" onmousedown="CKEDITOR.tools.callFunction(' + p + ', event)">' +
              ('ltr' == h ? '◢' : '◣') + '</span>';
          'ltr' == h&& 'ltr' == e ? a.data.html += c :
                                    a.data.html = c + a.data.html
        }
      }, b, null, 100);
      b.on('maximize', function(a) {
        b.ui.space(
            'resizer')[a.data == CKEDITOR.TRISTATE_ON ? 'hide' : 'show']()
      })
    }
  }
});
...
var c = c +
    (' onkeydown="return CKEDITOR.tools.callFunction({keydownFn},event);" onfocus="return CKEDITOR.tools.callFunction({focusFn},event);" ' +
     (CKEDITOR.env.ie ? 'onclick="return false;" onmouseup' : 'onclick') +
    ...
    m = CKEDITOR.addTemplate(
        'buttonArrow',
        '<span class="cke_button_arrow">' + (CKEDITOR.env.hc ? '&#9660;' : '') +
            '</span>'),
...
CKEDITOR.ui.button.prototype = {
  render: function(a, b) {
    var c = CKEDITOR.env, i = this._.id = CKEDITOR.tools.getNextId(), e = '',
        f = this.command, k;
    this._.editor = a;
    var d = {
      id: i,
    ...
    if (this.modes) {
      var j = {}, g = function() {
        var b = a.mode;
        b &&
            (b = this.modes[b] ? void 0 != j[b] ? j[b] : CKEDITOR.TRISTATE_OFF :
                                 CKEDITOR.TRISTATE_DISABLED,
             b = a.readOnly && !this.readOnly ? CKEDITOR.TRISTATE_DISABLED : b,
             this.setState(b), this.refresh && this.refresh())
      };
      a.on('beforeModeUnload', function() {
        a.mode && this._.state != CKEDITOR.TRISTATE_DISABLED &&
            (j[a.mode] = this._.state)
      }, this);
    ...
    e = {
      ...
      style: CKEDITOR.skin.getIconStyle(
          h, 'rtl' == a.lang.dir, this.icon, this.iconOffset),
  ...
  setState: function(a) {
    ...
    return b ?
        (b.setState(a, 'cke_button'),
         a == CKEDITOR.TRISTATE_DISABLED ? b.setAttribute('aria-disabled', !0) :
                                           b.removeAttribute('aria-disabled'),
         this.hasArrow ?
             (a = a == CKEDITOR.TRISTATE_ON ?
                  this._.editor.lang.button.selectedLabel.replace(
                      /%1/g, this.label) :
                  this.label,
              CKEDITOR.document.getById(this._.id + '_label').setText(a)) :
             a == CKEDITOR.TRISTATE_ON ? b.setAttribute('aria-pressed', !0) :
  ...
  toFeature: function(a) {
    ...
    var b = this;
    !this.allowedContent && (!this.requiredContent && this.command) &&
...
function w(a) {
  function d() {
    for (var b = g(), e = CKEDITOR.tools.clone(a.config.toolbarGroups) || n(a),
             f = 0;
         f < e.length; f++) {
      var k = e[f];
      if ('/' != k) {
  ...
  function g() {
    var b = {}, c, f, e;
    for (c in a.ui.items)
      f = a.ui.items[c], e = f.toolbar || 'others', e = e.split(','), f = e[0],
      e = parseInt(e[1] || -1, 10), b[f] || (b[f] = []),
      b[f].push({name: c, order: e});
    for (f in b)
      b[f] = b[f].sort(function(b, a) {
        return b.order == a.order ?
            0 :
            0 > a.order ? -1 : 0 > b.order ? 1 : b.order < a.order ? -1 : 1
      });
    return b
  }
  function c(c, e) {
  ...
  function h(b) {
    ...
    for (e = 0; e < b.length; ++e)
      ...
      '/' == d ? a.push(d) :
                 ...
                 d.items &&
                  (c(h, CKEDITOR.tools.clone(d.items)), h.name = d.name,
                   a.push(h));
    return a
  }
...
CKEDITOR.plugins.add('toolbar', {
  ...
  init: function(a) {
    var d, g = function(c, h) {
      var b, e = 'rtl' == a.lang.dir, j = a.config.toolbarGroupCycling,
             o = e ? 37 : 39, e = e ? 39 : 37, j = void 0 === j || j;
      switch (h) {
        case 9:
        ...
        case o:
          ...
          return !1;
        case 40:
          return c.button && c.button.hasArrow ?
                     (a.once(
                          'panelShow',
                          function(b) {
    ...
    a.on('uiSpace', function(c) {
      if (c.data.space == a.config.toolbarLocation) {
        ...
        var d = CKEDITOR.tools.getNextId(),
            b =
                [
                  '<span id="', d, '" class="cke_voice_label">',
                  a.lang.toolbar.toolbars, '</span>',
                  '<span id="' + a.ui.spaceId('toolbox') +
                ...
                if (p)
                  if (p.type == CKEDITOR.UI_SEPARATOR)
                    ...
                    if (!l) {
                      ...
                      b.push(
                          '<span id="', i, '" class="cke_toolbar"',
                          r ? ' aria-labelledby="' + i + '_label"' : '',
                          ' role="toolbar">');
                      r &&
                          b.push(
                              '<span id="', i,
                              '_label" class="cke_voice_label">', r, '</span>');
        ...
        if (a.config.toolbarCanCollapse &&
          ...
          a.addCommand('toolbarCollapse', {
            ...
            exec: function(b) {
              ...
              g ? (c.show(), a.removeClass('cke_toolbox_collapser_min'),
          ...
          b.push(
              '<a title="' +
              (d ? a.lang.toolbar.toolbarCollapse :
                   a.lang.toolbar.toolbarExpand) +
              '" id="' + a.ui.spaceId('toolbar_collapser') +
    ...
    a.on('destroy', function() {
      if (this.toolbox) {
        ...
        for (a = this.toolbox.toolbars; d < a.length; d++) {
          e = a[d].items;
          for (b = 0; b < e.length; b++)
            g = e[b], g.clickFn && CKEDITOR.tools.removeFunction(g.clickFn),
...
CKEDITOR.ui.prototype.addToolbarGroup = function(a, d, g) {
  ...
  h ? c.splice(0, 0, a) :
      'number' == typeof d ? c.splice(d + 1, 0, b) : c.push(a)
}
})();
...
function n(a, c) {
  ...
  c.html += '<span id="' + m + '_label" class="cke_voice_label">' +
      a.lang.elementspath.eleLabel + '</span><span id="' + m +
      '" class="cke_path" role="group" aria-labelledby="' + m + '_label">' + o +
      '</span>';
  a.on('uiReady', function() {
  ...
  var t = CKEDITOR.tools.addFunction(j),
      u = CKEDITOR.tools.addFunction(function(d, e) {
        ...
        switch (e.getKeystroke()) {
          case b ? 39:
            37: case 9: return (b = CKEDITOR.document.getById(g + (d + 1))) ||
                (b = CKEDITOR.document.getById(g + '0')),
                b.focus(), !1;
          case b ? 37:
            39: case CKEDITOR.SHIFT +
                    9: return (b = CKEDITOR.document.getById(g + (d - 1))) ||
  ...
  a.on('selectionChange', function() {
    a.editable();
    for (var d = [], e = i.list = [], g = [], b = i.filters, c = !0,
             j = a.elementPath().elements, f, k = j.length;
         k--;) {
      var h = j[k], p = 0;
      f = h.data('cke-display-name') ?
          h.data('cke-display-name') :
          h.data('cke-real-element-type') ? h.data('cke-real-element-type') :
                                            h.getName();
    ...
    e = e.length;
    for (b = 0; b < e; b++)
      f = g[b], c = a.lang.elementspath.eleTitle.replace(/%1/, f),
      f = v.output({
        id: n + b,
        label: c,
        text: f,
...
function m(b, d, a) {
  ...
  'wysiwyg' == b.mode &&
      (d || (d = b.activeEnterMode),
       ...
       b.fire('saveSnapshot'),
       d == CKEDITOR.ENTER_BR ? p(b, d, null, a) : q(b, d, null, a),
       b.fire('saveSnapshot'))
}
function r(b) {
...
CKEDITOR.plugins.enterkey = {
  enterBlock: function(b, d, a, h) {
    if (a = a || r(b)) {
      var a = u(a), f = a.document, i = a.checkStartOfBlock(),
          k = a.checkEndOfBlock(), j = b.elementPath(a.startContainer),
          c = j.block, l = d == CKEDITOR.ENTER_DIV ? 'div' : 'p', e;
      if (i && k) {
        if (c && (c.is('li') || c.getParent().is('li'))) {
          c.is('li') || (c = c.getParent());
          a = c.getParent();
          e = a.getParent();
          var h = !c.hasPrevious(), n = !c.hasNext(), l = b.getSelection(),
              g = l.createBookmarks(), i = c.getDirection(1),
              k = c.getAttribute('class'), o = c.getAttribute('style'),
            ...
            if (b)
              if (j.block.is('li') ?
                      (e = f.createElement(d == CKEDITOR.ENTER_P ? 'p' : 'div'),
                       m && e.setAttribute('dir', i),
                       o && e.setAttribute('style', o),
                       k && e.setAttribute('class', k), c.moveChildren(e)) :
                      e = j.block,
                  h || n)
      ...
      if (i = a.splitBlock(l)) {
        ...
        if (c)
          ...
          d.breakParent(g), g = d.getNext(), a.moveToElementEditStart(g),
                            d.move(d.getPrevious());
        if (!j && !b)
          c.is('li') &&
              (e = a.clone(), e.selectNodeContents(c),
               ...
               (g = e.next()) &&
                   ...
                   (CKEDITOR.env.needsBrFiller ? f.createElement('br') :
                                                 f.createText(' '))
                       .insertBefore(g)),
          ...
          if (d) {
            ...
            c && (e = c.clone());
          e ? h && !e.is('li') && e.renameNode(l) :
              g && g.is('li') ?
              e = g :
              (e = f.createElement(l),
               d && (n = d.getDirection()) && e.setAttribute('dir', n));
          if (f = i.elementPath) {
            h = 0;
  ...
  enterBr: function(b, d, a, h) {
    if (a = a || r(b)) {
      var f = a.document, i = a.checkEndOfBlock(),
          ...
          j = k.block, c = j && k.block.getName();
      !h && 'li' == c ?
          q(b, d, a, h) :
          (!h && i && s.test(c) ?
               (i = j.getDirection()) ?
               (f = f.createElement('div'), f.setAttribute('dir', i),
                f.insertAfter(j), a.setStart(f, 0)) :
               (f.createElement('br').insertAfter(j),
                CKEDITOR.env.gecko && f.createText('').insertAfter(j),
                a.setStartAt(
                    j.getNext(),
                    CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START :
                                      CKEDITOR.POSITION_AFTER_START)) :
               (b = 'pre' == c && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ?
                    f.createText('\r') :
                    f.createElement('br'),
                a.deleteContents(), a.insertNode(b),
                CKEDITOR.env.needsBrFiller ?
                    (f.createText('﻿').insertAfter(b),
                     i && (j || k.blockLimit).appendBogus(),
                     b.getNext().$.nodeValue = '',
                     a.setStartAt(b.getNext(), CKEDITOR.POSITION_AFTER_START)) :
                    a.setStartAt(b, CKEDITOR.POSITION_AFTER_END)),
           a.collapse(!0), a.select(), a.scrollIntoView())
    }
  }
};
var t = CKEDITOR.plugins.enterkey, p = t.enterBr, q = t.enterBlock,
    s = /^h[1-6]$/
})();
(function() {
function j(a, b) {
  ...
  afterInit: function(a) {
    ...
    if (a = (a = a.dataProcessor) && a.htmlFilter) {
      ...
      var f = RegExp(f, 'g'),
          ...
          g = j('nbsp,gt,lt,amp,shy', !0), i = RegExp(g.regex, 'g'),
          k = function(a) {
            return g[a]
          };
      a.addRules(
...
function k() {
  ...
  var d = c.config['filebrowser' + i(a.getName()) + 'WindowWidth'] ||
      c.config.filebrowserWindowWidth || '80%',
      ...
      if (e = b[g],
        ...
        if ('string' == typeof e.filebrowser && (e.filebrowser = {
          ...
          f && (e.onClick = k, e.filebrowser.url = f, e.hidden = !1)
            ...
            'QuickUpload' == e.filebrowser.action && e['for'] &&
            (f = e.filebrowser.url,
             void 0 === f &&
...
(function() {
function i(a) {
  var j = a.config, m = a.fire('uiSpace', {space: 'top', html: ''}).html,
      p = function() {
        function f(a, c, e) {
          b.setStyle(c, s(e));
        ...
        return function(d) {
          if (i = a.editable())
            if (d && 'focus' == d.name && b.show(), b.removeStyle('left'),
                b.removeStyle('right'), l = b.getClientRect(),
                c = i.getClientRect(), h = g.getViewPaneSize(), n = l.height,
                r = 'pageXOffset' in g.$ ?
                    g.$.pageXOffset :
              ...
              n + o <= c.top ?
                  e('top') :
                  n + o > h.height - c.bottom ? e('pin') : e('bottom');
              var d = h.width / 2,
                  d = 0 < c.left && c.right < h.width && c.width > l.width ?
                  'rtl' == a.config.contentsLangDirection ? 'right' : 'left' :
                  d - c.left > c.right - d ? 'left' : 'right',
                  f;
              l.width > h.width ?
                  (d = 'left', f = 0) :
                  (f = 'left' == d ? 0 < c.left ? c.left : 0 :
                                     c.right < h.width ? h.width - c.right : 0,
                   f + l.width > h.width &&
  ...
  if (m) {
    var i = new CKEDITOR.template(
            ...
            CKEDITOR.env.cssClass + '" dir="{langDir}" title="' +
            (CKEDITOR.env.gecko ? ' ' : '') +
            '" lang="{langCode}" role="application" style="{style}"' +
            (a.title ? ' aria-labelledby="cke_{name}_arialbl"' : ' ') + '>' +
            (a.title ?
                 '<span id="cke_{name}_arialbl" class="cke_voice_label">{voiceLabel}</span>' :
                 ' ') +
        ...
        b = CKEDITOR.document.getBody().append(
            CKEDITOR.dom.element.createFromHtml(i.output({
              content: m,
              id: a.id,
              langDir: a.lang.dir,
              langCode: a.langCode,
  ...
  onLoad: function() {
    ...
    CKEDITOR.ui.panel.prototype.addListBlock = function(a, b) {
      return this.addBlock(
          a, new CKEDITOR.ui.listBlock(this.getHolderElement(), b))
    };
      ...
      proto: {
        add: function(a, b, c) {
          ...
          a = {
            id: d,
            val: e,
            onclick: CKEDITOR.env.ie ? 'onclick="return false;" onmouseup' :
                                       'onclick',
        ...
        showAll: function() {
          var a = this._.items, b = this._.groups,
              c = this.element.getDocument(), d;
          for (d in a) c.getById(a[d]).setStyle('display', '');
          for (var e in b)
            a = c.getById(b[e]), d = a.getNext(), a.setStyle('display', ''),
        ...
        unmark: function(a) {
          var b = this.element.getDocument(), a = this._.items[a],
              c = b.getById(a);
        ...
        focus: function(a) {
          ...
          if (a)
            for (c = this.element.getDocument()
                         .getById(this._.items[a])
                         .getFirst();
                 a = b.getItem(++d);) {
              if (a.equals(c)) {
...
(function() {
var d =
    '<span id="{id}" class="cke_combo cke_combo__{name} {cls}" role="presentation"><span id="{id}_label" class="cke_combo_label">{label}</span><a class="cke_combo_button" title="{title}" tabindex="-1"' +
    (CKEDITOR.env.gecko && !CKEDITOR.env.hc ?
         '' :
         ' href="javascript:void(\'{titleJs}\')"') +
...
var d = d +
    (' onkeydown="return CKEDITOR.tools.callFunction({keydownFn},event,this);" onfocus="return CKEDITOR.tools.callFunction({focusFn},event);" ' +
     (CKEDITOR.env.ie ? 'onclick="return false;" onmouseup' : 'onclick') +
...
CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
  $: function(a) {
    CKEDITOR.tools.extend(
        this, a,
        {canGroup: !1, title: a.label, modes: {wysiwyg: 1}, editorFocus: 1});
    a = this.panel || {};
    delete this.panel;
    this.id = CKEDITOR.tools.getNextNumber();
  ...
  proto: {
    ...
    render: function(a, b) {
      function g() {
        if (this.getState() != CKEDITOR.TRISTATE_ON) {
          var c = this.modes[a.mode] ? CKEDITOR.TRISTATE_OFF :
                                       CKEDITOR.TRISTATE_DISABLED;
      ...
      var d = CKEDITOR.env, h = 'cke_' + this.id,
    ...
    createPanel: function(a) {
      if (!this._.panel) {
        ...
        e.onHide = function(b) {
          ...
          c.setState(
              c.modes && c.modes[a.mode] ? CKEDITOR.TRISTATE_OFF :
                                           CKEDITOR.TRISTATE_DISABLED);
          c._.on = 0;
    ...
    setValue: function(a, b) {
      ...
      d &&
          (!a && !b ? (b = this.label, d.addClass('cke_combo_inlinelabel')) :
    ...
    commit: function() {
      this._.committed ||
          (this._.list.commit(), this._.committed = 1,
           CKEDITOR.ui.fire('ready', this));
      this._.committed = 1
    },
    setState: function(a) {
...
CKEDITOR.plugins.add('format', {
  ...
  init: function(a) {
    if (!a.blockless) {
      for (var f = a.config, c = a.lang.format, j = f.format_tags.split(';'),
               d = {}, k = 0, l = [], g = 0;
           g < j.length; g++) {
...
CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
  ...
  $: function() {
    ...
    for (a in CKEDITOR.tools.extend(
             {}, b.$nonBodyContent, b.$block, b.$listItem, b.$tableContent))
      this.setRules(a, {
        indent: !b[a]['#'],
        breakBeforeOpen: 1,
  ...
  proto: {
    openTag: function(b) {
      ...
      this._.afterCloser && (a && a.needsSpace && this._.needsSpace) &&
          this._.output.push('\n');
      this._.indent ?
          this.indentation() :
    ...
    closeTag: function(b) {
      ...
      a && a.indent &&
          (this._.indentation =
               this._.indentation.substr(this.indentationChars.length));
      this._.indent ?
          this.indentation() :
    ...
    lineBreak: function() {
      !this._.inPre && 0 < this._.output.length &&
      ...
      (b.getDocumentElement().addClass(b.$.compatMode),
       d.config.enterMode != CKEDITOR.ENTER_P &&
           this.attachListener(b, 'selectionchange', function() {
             var a = b.getBody(), c = d.getSelection(),
                 e = c && c.getRanges()[0];
             e &&
...
function l(a) {
    ...
    a.editable().attachListener(a, 'selectionChange', function() {
      ...
      d &&
          (c && (c.detachEvent('onresizestart', b), c = null),
           d.$.attachEvent('onresizestart', b), c = d.$)
    })
  }
  function b(a) {
    a.returnValue = !1
  ...
  if (CKEDITOR.env.gecko) try {
      ...
      c.execCommand(
          'enableInlineTableEditing', !1, !a.config.disableNativeTableHandles)
    } catch (e) {
    }
  else
    CKEDITOR.env.ie &&
...
CKEDITOR.plugins.add('wysiwygarea', {
  init: function(a) {
    ...
    a.addMode('wysiwyg', function(d) {
      ...
      f &&
          (CKEDITOR.env.ie && h && (f += ', ' + h), e.setAttribute('title', f));
      if (h) {
        var f = CKEDITOR.tools.getNextId(),
            i = CKEDITOR.dom.element.createFromHtml(
                '<span id="' + f + '" class="cke_voice_label">' + h +
                '</span>');
        g.append(i, 1);
...
var j = CKEDITOR.tools.createClass({
  ...
  proto: {
    setData: function(a, d) {
      ...
      if (d)
        ...
        var c = b.config, e = c.fullPage, g = c.docType,
            f = CKEDITOR.tools.buildStyleHtml(m()).replace(
                /<style>/, '<style data-cke-temp="1">');
        ...
        e ? (/<body[\s|>]/.test(a) || (a = '<body>' + a),
             ...
             a = a.replace(/<\/head\s*>/, f + '$&'), a = g + a) :
            a = c.docType + '<html dir="' + c.contentsLangDirection +
                '" lang="' + (c.contentsLanguage || b.langCode) +
                '"><head><title>' + this._.docTitle + '</title>' + h + f +
                '</head><body' + (c.bodyId ? ' id="' + c.bodyId + '"' : '') +
                (c.bodyClass ? ' class="' + c.bodyClass + '"' : '') + '>' + a +
                '</body></html>';
        CKEDITOR.env.gecko &&
            (a = a.replace(/<body/, '<body contenteditable="true" '),
             2E4 > CKEDITOR.env.version &&
                 (a = a.replace(
                      /<body[^>]*>/, '$&<\!-- cke-content-start --\>')));
        c = '<script id="cke_actscrpt" type="text/javascript"' +
            ...
            this._.frameLoadedHandler + ',window);wasLoaded=1;}' +
            (CKEDITOR.env.ie ?
                 'onload();' :
        ...
        h && (CKEDITOR.env.ie && 10 > CKEDITOR.env.version) &&
            (c +=
             '<script id="cke_basetagscrpt">var baseTag = document.querySelector( "base" );baseTag.href = baseTag.href;<\/script>');
    ...
    getData: function(a) {
      ...
      var a = this.editor, d = a.config, b = d.fullPage, c = b && a.docType,
          e = b && a.xmlDeclaration, g = this.getDocument(),
          b = b ? g.getDocumentElement().getOuterHtml() : g.getBody().getHtml();
      CKEDITOR.env.gecko && d.enterMode != CKEDITOR.ENTER_BR &&
    ...
    focus: function() {
      this._.isLoadingData ? this._.isPendingFocus = !0 :
  ...
  init: function(b) {
    if (!b.plugins.image2) {
      ...
      b.on('doubleclick', function(b) {
        ...
        a.is('img') && (!a.data('cke-realelement') && !a.isReadOnly()) &&
            (b.data.dialog = 'image')
      });
      ...
      for (var l = new CKEDITOR.dom.walker(f), c; c = l.next();)
        if (c.type == CKEDITOR.NODE_ELEMENT)
          if (!c.equals(j) && c.getDirection()) {
            ...
            if (d)
              for (var g = b.data.dir == 'ltr' ? ['_rtl', ''] : ['', '_rtl'],
                       h = 0;
                   h < d.length; h++)
...
CKEDITOR.plugins.indent.specificDefinition.prototype = {
  ...
  refreshJob: function(a, b, e) {
    b = this.jobs[b];
    b.state =
        a.activeFilter.checkFeature(this) ? b.refresh.call(this, a, e) : i;
    return b.state
  },
...
function s(c) {
  function f(b) {
    for (var e = d.startContainer, a = d.endContainer;
    ...
    for (var g = j.isIndent ? 1 : -1, a = e[0], e = e[e.length - 1],
             i = CKEDITOR.plugins.list.listToArray(b, n),
             l = i[e.getCustomData('listarray_index')].indent,
             a = a.getCustomData('listarray_index');
         a <= e.getCustomData('listarray_index'); a++)
      if (i[a].indent += g, 0 < g) {
        var h = i[a].parent;
        i[a].parent = new CKEDITOR.dom.element(h.getName(), h.getDocument())
      }
    for (a = e.getCustomData('listarray_index') + 1;
         a < i.length && i[a].indent > l; a++)
      i[a].indent += g;
    e = CKEDITOR.plugins.list.arrayToList(
        i, n, null, c.config.enterMode, b.getDirection());
    if (!j.isIndent) {
      var f;
      if ((f = b.getParent()) && f.is('li'))
        for (var g = e.listNode.getChildren(), o = [], k, a = g.count() - 1;
             0 <= a; a--)
    ...
    if (o && o.length)
      for (a = 0; a < o.length; a++) {
        for (k = b = o[a]; (k = k.getNext()) && k.is && k.getName() in m;)
          CKEDITOR.env.needsNbspFiller && !b.getFirst(t) &&
  ...
  for (var j = this, n = this.database, m = this.context, l = c.getSelection(),
           l = (l && l.getRanges()).createIterator(), d;
       d = l.getNextRange();) {
    for (var b = d.getCommonAncestor();
         b && !(b.type == CKEDITOR.NODE_ELEMENT && m[b.getName()]);)
      b = b.getParent();
    b ||
        (b = d.startPath().contains(m)) &&
            d.setEndAt(b, CKEDITOR.POSITION_BEFORE_END);
    if (!b) {
      var h = d.getEnclosedNode();
      h && (h.type == CKEDITOR.NODE_ELEMENT && h.getName() in m) &&
          (d.setStartAt(h, CKEDITOR.POSITION_AFTER_START),
           d.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), b = h)
    }
    b &&
        (d.startContainer.type == CKEDITOR.NODE_ELEMENT &&
         d.startContainer.getName() in m) &&
        (h = new CKEDITOR.dom.walker(d), h.evaluator = p,
...
var u = CKEDITOR.dom.walker.whitespaces(!0),
    v = CKEDITOR.dom.walker.bookmark(!1, !0), q = CKEDITOR.TRISTATE_DISABLED,
...
CKEDITOR.plugins.add('indentlist', {
  ...
  init: function(c) {
    ...
    CKEDITOR.tools.extend(
        f.prototype, j.specificDefinition.prototype, {context: {ol: 1, ul: 1}})
  }
});
...
var i = CKEDITOR.htmlParser.cssStyle, h = CKEDITOR.tools.cssLength,
    j = /^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i, k = {
      elements: {
        $: function(a) {
          var b = a.attributes;
          if ((b = (b = (b = b && b['data-cke-realelement']) &&
                        new CKEDITOR.htmlParser.fragment.fromHtml(
                            decodeURIComponent(b))) &&
                   b.children[0]) &&
              a.attributes['data-cke-resizable']) {
            var c = (new i(a)).rules, a = b.attributes, d = c.width,
                c = c.height;
...
CKEDITOR.plugins.add('fakeobjects', {
  init: function(a) {
    a.filter.allow(
        'img[!data-cke-realelement,src,alt,title](*){*}', 'fakeobjects')
  },
  afterInit: function(a) {
    (a = (a = a.dataProcessor) && a.htmlFilter) &&
        a.addRules(k, {applyToAll: !0})
  }
});
CKEDITOR.editor.prototype.createFakeElement = function(a, b, c, d) {
  ...
  d &&
      (b['data-cke-resizable'] = d, c = new i, d = a.getAttribute('width'),
       a = a.getAttribute('height'), d && (c.rules.width = h(d)),
       a && (c.rules.height = h(a)), c.populate(b));
...
CKEDITOR.editor.prototype.createFakeParserElement = function(a, b, c, d) {
  ...
  c && (b['data-cke-real-element-type'] = c);
  d &&
      (b['data-cke-resizable'] = d, d = a.attributes, a = new i, c = d.width,
       d = d.height, void 0 != c && (a.rules.width = h(c)),
       void 0 != d && (a.rules.height = h(d)), a.populate(b));
  return new CKEDITOR.htmlParser.element('img', b)
};
CKEDITOR.editor.prototype.restoreRealElement = function(a) {
  if (a.data('cke-real-node-type') != CKEDITOR.NODE_ELEMENT) return null;
  var b = CKEDITOR.dom.element.createFromHtml(
      decodeURIComponent(a.data('cke-realelement')), this.document);
...
function o(c, b) {
  ...
  for (var g = 0; g < f.length; g++)
    a = f[g].toLowerCase(), e = b[a], 0 < g && d.push(','),
...
CKEDITOR.plugins.add('link', {
  ...
  onLoad: function() {
    function c(b) {
      return a.replace(/%1/g, 'rtl' == b ? 'right' : 'left')
          .replace(/%2/g, 'cke_contents_' + b)
    }
    var b = 'background:url(' +
        CKEDITOR.getUrl(
            this.path + 'images' + (CKEDITOR.env.hidpi ? '/hidpi' : '') +
            '/anchor.png') +
        ') no-repeat %1 center;border:1px dotted #00f;background-size:16px;',
        a = '.%2 a.cke_anchor,.%2 a.cke_anchor_empty,.cke_editable.%2 a[name],.cke_editable.%2 a[data-cke-saved-name]{' +
        b + 'padding-%1:18px;cursor:auto;}.%2 img.cke_anchor{' + b +
  ...
  init: function(c) {
    ...
    c.addCommand(
        ...
        new CKEDITOR.dialogCommand(
            'link', {allowedContent: b, requiredContent: 'a[href]'}));
    c.addCommand(
        'anchor',
        new CKEDITOR.dialogCommand(
            'anchor',
    ...
    c.on('doubleclick', function(a) {
      ...
      if (!b.isReadOnly())
        if (b.is('a')) {
          a.data.dialog = b.getAttribute('name') &&
    ...
    c.on('doubleclick', function(a) {
      a.data.dialog in {link: 1, anchor: 1} && a.data.link &&
...
CKEDITOR.plugins.link = {
  ...
  getEditorAnchors: function(c) {
    for (var b = c.editable(),
             a = b.isInline() && !c.plugins.divarea ? c.document : b,
             b = a.getElementsByTag('a'), a = a.getElementsByTag('img'), f = [],
             e = 0, d;
         d = b.getItem(e++);)
  ...
  parseLinkAttributes: function(c, b) {
    ...
    a.match(p) && ('encode' == e ? a = a.replace(w, function(a, b, c) {
      ...
      if (b == f.name) {
        g.type = 'email';
        for (var a = g.email = {}, b = /(^')|('$)/g, c = c.match(/[^,\s]+/g),
                 d = c.length, e, h, i = 0;
             i < d; i++)
          e = decodeURIComponent, h = c[i].replace(b, '').replace(/\\'/g, '\''),
          h = e(h), e = f.params[i].toLowerCase(), a[e] = h;
    ...
    if (b) {
      if (a = b.getAttribute('target'))
        g.target = {type: a.match(v) ? a : 'frame', name: a};
      else if (
          a = (a = b.data('cke-pa-onclick') || b.getAttribute('onclick')) &&
              a.match(y))
        for (g.target = {type: 'popup', name: a[1]}; e = z.exec(a[2]);)
          ('yes' == e[2] || '1' == e[2]) &&
  ...
  getLinkAttributes: function(c, b) {
        ...
        switch (a) {
          ...
          case 'encode':
            var g = encodeURIComponent(d.subject || ''),
                i = encodeURIComponent(d.body || ''), d = [];
            g && d.push('subject=' + g);
            i && d.push('body=' + i);
            d = d.length ? '?' + d.join('&') : '';
            'encode' == a ?
                (a = ['javascript:void(location.href=\'mailto:\'+', n(e)],
                 d && a.push('+\'', m(d), '\''), a.push(')')) :
                a = ['mailto:', e, d];
            break;
          default:
            a = e.split('@', 2), d.name = a[0], d.domain = a[1],
            a = ['javascript:', o(c, d)]
        }
    ...
    if (b.target)
      if ('popup' == b.target.type) {
        for (
            var a =
                    [
                      'window.open(this.href, \'', b.target.name || '', '\', \''
                    ],
        ...
        'notSet' != b.target.type && b.target.name &&
    ...
    return {
      set: f, removed: CKEDITOR.tools.objectKeys(k)
    }
  }
};
...
CKEDITOR.removeAnchorCommand.prototype = {
  exec: function(c) {
    ...
    if (b && (f = b.getSelectedElement()) &&
        (!f.getChildCount() ? CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, f) :
                              f.is('a')))
      f.remove(1);
...
CKEDITOR.tools.extend(
    CKEDITOR.config, {linkShowAdvancedTab: !0, linkShowTargetTab: !0})
})();
(function() {
function E(c, j, e) {
  function b(b) {
  ...
  for (var k = CKEDITOR.plugins.list.listToArray(j.root, e), g = [], h = 0;
       h < j.contents.length; h++) {
    var f = j.contents[h];
    if ((f = f.getAscendant('li', !0)) &&
  ...
  var a = CKEDITOR.plugins.list
              .arrayToList(
                  k, e, null, c.config.enterMode, j.root.getAttribute('dir'))
              .listNode,
      d, m;
  b(!0);
  b();
...
function B(c) {
  ...
  (j = function(e) {
    ...
    b && (b.type == CKEDITOR.NODE_ELEMENT && b.is(c.getName())) &&
...
function y(c, j, e) {
  ...
  var k = j.createBookmark(),
      g = new CKEDITOR.dom.elementPath(j.startContainer), h = g.block,
  ...
  h ? (h = h.getBogus()) && h.remove() :
      f && (h = f.getPrevious(q)) && v(h) && h.remove();
  (h = b.getLast()) && (h.type == CKEDITOR.NODE_ELEMENT && h.is('br')) &&
      h.remove();
  (h = j.startContainer.getChild(j.startOffset)) ? b.insertBefore(h) :
...
function w(c) {
  return (c = c.getLast(q)) && c.type == CKEDITOR.NODE_ELEMENT &&
          c.getName() in r ?
      c :
      null
}
var r = {ol: 1, ul: 1}, G = CKEDITOR.dom.walker.whitespaces(),
    D = CKEDITOR.dom.walker.bookmark(), q = function(c) {
      return !(G(c) || D(c))
...
CKEDITOR.plugins.list = {
  listToArray: function(c, j, e, b, k) {
    ...
    for (var g = 0, h = c.getChildCount(); g < h; g++) {
      var f = c.getChild(g);
      f.type == CKEDITOR.NODE_ELEMENT && f.getName() in CKEDITOR.dtd.$list &&
      ...
      if ('li' == f.$.nodeName.toLowerCase()) {
        ...
        k ? a.grandparent = k :
            (a.grandparent = c.getParent(),
             a.grandparent && 'li' == a.grandparent.$.nodeName.toLowerCase() &&
  ...
  arrayToList: function(c, j, e, b, k) {
    ...
    for (var g, h = c[e].parent.getDocument(),
                f = new CKEDITOR.dom.documentFragment(h), a = null, d = e,
                m = Math.max(c[e].indent, 0), i = null, n, l,
      ...
      if (o.indent == m) {
        if (!a || c[d].parent.getName() != a.getName())
          a = c[d].parent.clone(!1, 1), k && a.setAttribute('dir', k),
          f.append(a);
        ...
        r[g.getName()] ? (i = o.element.clone(!1, !0),
                          n != g.getDirection(1) && i.setAttribute('dir', n)) :
                         i = new CKEDITOR.dom.documentFragment(h);
        var a = g.getDirection(1) != n, u = o.element,
            z = u.getAttribute('class'), v = u.getAttribute('style'),
            w = i.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
            (b != CKEDITOR.ENTER_BR || a || v || z),
            s, x = o.contents.length, t;
        for (g = 0; g < x; g++)
          if (s = o.contents[g], D(s) && 1 < x)
            ...
            w ? (l ||
                     (l = h.createElement(p), i.append(l),
                      a && l.setAttribute('dir', n)),
                 v && l.setAttribute('style', v),
                 z && l.setAttribute('class', z), t && (l.append(t), t = null),
                 l.append(s.clone(1, 1))) :
                i.append(s.clone(1, 1));
        t && ((l || i).append(t), t = null);
        i.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && d != c.length - 1 &&
            (CKEDITOR.env.needsBrFiller && (n = i.getLast()) &&
                 (n.type == CKEDITOR.NODE_ELEMENT && n.is('br')) && n.remove(),
             n = i.getLast(q),
             (!n ||
  ...
  exec: function(c) {
    ...
    if (this.state == CKEDITOR.TRISTATE_OFF) {
      ...
      if (k.getFirst(q)) {
        ...
        (j = g && g.getEnclosedNode()) && (j.is && this.type == j.getName()) &&
    ...
    for (var j = e.createBookmarks(!0), k = [], h = {}, b = b.createIterator(),
             f = 0;
         (g = b.getNextRange()) && ++f;) {
      var a = g.getBoundaryNodes(), d = a.startNode, m = a.endNode;
      d.type == CKEDITOR.NODE_ELEMENT && 'td' == d.getName() &&
          g.setStartAt(a.startNode, CKEDITOR.POSITION_AFTER_START);
      m.type == CKEDITOR.NODE_ELEMENT && 'td' == m.getName() &&
      ...
      for (g.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF;
        ...
        if (!a.getCustomData('list_block')) {
          ...
          for (var i = c.elementPath(a), d = i.elements, m = 0,
                   i = i.blockLimit, n, l = d.length - 1;
               0 <= l && (n = d[l]); l--)
            if (r[n.getName()] && i.contains(n)) {
              i.removeCustomData('list_group_object_' + f);
              (d = n.getCustomData('list_group_object')) ?
                  d.contents.push(a) :
                  (d = {root: n, contents: [a]}, k.push(d),
                   CKEDITOR.dom.element.setMarker(
                       h, n, 'list_group_object', d));
              m = 1;
              break
            }
          m ||
    ...
    for (n = []; 0 < k.length;)
      if (d = k.shift(), this.state == CKEDITOR.TRISTATE_OFF)
        if (r[d.root.getName()]) {
          ...
          f = [];
          1 == i.length && i[0].equals(a.root) &&
              (d = b.createElement('div'),
               i[0].moveChildren && i[0].moveChildren(d), i[0].append(d),
               i[0] = d);
        ...
        this.state == CKEDITOR.TRISTATE_ON && r[d.root.getName()] &&
            E.call(this, c, d, h);
           ...
           if (c.mode == 'wysiwyg' && e in {8: 1, 46: 1}) {
             ...
             if (b && b.collapsed) {
               ...
               if (g) {
                 ...
                 d = 0;
                 if ((a = f.next()) && a.type == CKEDITOR.NODE_ELEMENT &&
                     a.getName() in r && a.equals(k)) {
                   d = 1;
                   a = f.next()
                 } else
                 ...
                 if ((a = f.next()) && a.type == CKEDITOR.NODE_ELEMENT &&
                     a.is(r)) {
                   a = a.getFirst(q);
                   if (k.block && b.checkStartOfBlock() &&
                       b.checkEndOfBlock()) {
                     k.block.remove();
                     b.moveToElementEditStart(a);
                     b.select()
...
function J(a) {
  var c = a.element;
  if (c && m(c) && (c = c.getAscendant(a.triggers, !0)) &&
...
function ha(a) {
  var c = a.doc,
      d =
          B('<span contenteditable="false" style="' + L +
                'position:absolute;border-top:1px dashed ' + a.boxColor +
                '"></span>',
            c),
      b = CKEDITOR.getUrl(
          this.path + 'images/' + (n.hidpi ? 'hidpi/' : '') + 'icon' +
          (a.rtl ? '-rtl' : '') + '.png');
  q(d, {
    attach: function() {
    ...
    lineChildren: [
      q(B('<span title="' + a.editor.lang.magicline.title +
              '" contenteditable="false">&#8629;</span>',
          c),
        {
          base: L + 'height:17px;width:17px;' + (a.rtl ? 'left' : 'right') +
              ':17px;background:url(' + b + ') center no-repeat ' + a.boxColor +
              ';cursor:pointer;' +
              (n.hc ?
          ...
          looks: [
            ...
            'top:-17px;' +
                CKEDITOR.tools.cssVendorPrefix(
                    'border-radius', '2px 2px 0px 0px', 1),
            'top:-1px;' +
                CKEDITOR.tools.cssVendorPrefix(
                    'border-radius', '0px 0px 2px 2px', 1)
          ]
        }),
      q(B(R, c), {
    ...
    mouseNear: function() {
      ...
      return c && a.mouse.y > c.top - b && a.mouse.y < c.bottom + b &&
              a.mouse.x > c.left - b && a.mouse.x < c.right + b ?
          !0 :
          !1
    },
    place: function() {
      var b = a.view, c = a.editable, d = a.trigger, i = d.upper, h = d.lower,
          j = i || h, l = j.getParent(), k = {};
      this.trigger = d;
      i && o(a, i, !0);
      h && o(a, h, !0);
      o(a, l, !0);
      ...
      l.equals(c) ?
          ...
          (k.left = j.size.left - j.size.margin.left + b.scroll.x -
               (a.inInlineMode ? b.editable.left + b.editable.border.left : 0),
           k.width = j.size.outerWidth + j.size.margin.left +
               j.size.margin.right + b.scroll.x,
           k.right = '');
      i&& h ? k.top = i.size.margin.bottom === h.size.margin.top ?
              0 | i.size.bottom + i.size.margin.bottom / 2 :
              i.size.margin.bottom < h.size.margin.top ?
              i.size.bottom + i.size.margin.bottom :
              i.size.bottom + i.size.margin.bottom - h.size.margin.top :
              i ? h || (k.top = i.size.bottom + i.size.margin.bottom) :
                  k.top = h.size.top - h.size.margin.top;
      d.is(x) ||
              k.top > b.scroll.y - 15 &&
                  k.top<
                       b.scroll.y + 5 ?
                           (k.top = a.inInlineMode ? 0 : b.scroll.y,
                            this.look(x)) :
                           d.is(y) || k.top>b.pane.bottom -
                      5 &&
                  k.top < b.pane.bottom + 15 ?
          (k.top = a.inInlineMode ? b.editable.height + b.editable.padding.top +
          ...
          (a.inInlineMode && (k.top -= b.editable.top + b.editable.border.top),
           this.look(s));
      a.inInlineMode &&
          (k.top--, k.top += b.editable.scroll.top,
    ...
    canUndo: !0, modes: {wysiwyg: 1}, exec: function() {
      ...
      return function(b) {
        ...
        if (!W(a, b) && b && !b.equals(a.editable) && !b.contains(a.editable)) {
          ...
          e = r(a, b, !c);
          var f;
          m(e) && e.is(a.triggers) && e.is(ia) &&
                  (!r(a, e, !c) ||
                   (f = r(a, e, !c)) && m(f) && f.is(a.triggers)) ?
              d(e) :
              (f = J(a, b),
               m(f) &&
                   (r(a, f, !c) ? (b = r(a, f, !c)) &&
                            (m(b) && b.is(a.triggers)) && d(f) :
                                  d(f)))
        }
      }
    }()
...
function Y(a) {
  ...
  return !f && 0 <= c.size.top && 0 < d.y && d.y < c.size.top + e ?
      (a = a.inInlineMode || 0 === b.scroll.y ? x : s,
       new u([null, c, D, H, a])) :
      f && c.size.bottom <= b.pane.height && d.y > c.size.bottom - e &&
              d.y < b.pane.height ?
      (a = a.inInlineMode ||
               c.size.bottom > b.pane.height - e &&
...
function $(a) {
  ...
  if (h) {
    ...
    e.equals(a.editable[i ? 'getLast' : 'getFirst'](a.isRelevant)) ?
        (C(a),
         i&& c.y > e.size.bottom - b&& c.y < d.pane.height&& e.size.bottom >
                 d.pane.height - b&& e.size.bottom < d.pane.height ?
             g = y :
             0 < c.y && c.y < e.size.top + b && (g = x)) :
        g = s,
        f = [null, e][i ? 'reverse' : 'concat']().concat([
          i ? Z : D, H, g,
          e.equals(a.editable[i ? 'getLast' : 'getFirst'](a.isRelevant)) ?
              i ? y : x :
              s
...
function P(a, c, d, b) {
  for (var e =
               function() {
                 var b = n.ie ? c.$.currentStyle :
                                a.win.$.getComputedStyle(c.$, '');
           ...
           f = c.getDocumentPosition(), g = {}, i = {}, h = {}, j = {},
           l = t.length;
       l--;)
    g[t[l]] = parseInt(e('border-' + t[l] + '-width'), 10) || 0,
    h[t[l]] = parseInt(e('padding-' + t[l]), 10) || 0,
    i[t[l]] = parseInt(e('margin-' + t[l]), 10) || 0;
  (!d || b) && I(a, b);
  ...
  return q({border: g, padding: h, margin: i, ignoreScroll: d}, j, !0)
}
function o(a, c, d) {
...
function la(a, c, d, b) {
  for (var e = b, f = b, g = 0, i = !1, h = !1, j = a.view.pane.height,
           l = a.mouse;
       l.y + g < j && 0 < l.y - g;) {
    i || (i = c(e, b));
    h || (h = c(f, b));
      ...
      d.is(w.$inline) ||
          (b.inInlineMode && !X(d) &&
           ...
           d.attachListener(
               ...
               function() {
                 b.line.wrap.getParent() &&
                     (b.line.detach(), a.once('getData', function() {
                       b.line.attach()
                     }, null, null, 1E3))
               },
               null, null, 0),
           d.attachListener(
               b.inInlineMode ? h : h.getWindow().getFrame(), 'mouseout',
               function(c) {
                 if ('wysiwyg' == a.mode)
                   if (b.inInlineMode) {
           ...
           d.attachListener(
               ...
               function(c) {
                 if ('wysiwyg' == a.mode)
                   switch (c = c.data.getKeystroke(),
                           a.getSelection().getStartElement(), c) {
                     case 2228240:
                     case 16:
               ...
               function(c) {
                 ...
                 if (!('wysiwyg' != a.mode || a.readOnly || g)) {
                   ...
                   g = setTimeout(function() {
                     ...
                     g = b.trigger = null;
                     I(b);
                     if (f && !b.hiddenMode && a.focusManager.hasFocus &&
                         !b.line.mouseNear() && (b.element = ca(b, !0)))
           ...
           a.addCommand('accessNextSpace', U(b, !0)), a.setKeystroke([
...
var q = CKEDITOR.tools.extend, M = CKEDITOR.dom.element, B = M.createFromHtml,
    n = CKEDITOR.env, ea = CKEDITOR.env.ie && 9 > CKEDITOR.env.version,
    w = CKEDITOR.dtd, F = {}, D = 128, Z = 64, O = 32, H = 16, fa = 8, x = 4,
    y = 2, s = 1, E = ' ', aa = w.$listItem, ka = w.$tableContent,
...
var ca =
  ...
  return function(c, d, b) {
    ...
    return !g || !(g.type == CKEDITOR.NODE_ELEMENT && g.$) ||
            n.ie && 9 > n.version && !c.boundary.equals(g) &&
                !c.boundary.contains(g) ?
        null :
        g
  }
}(),
    z = CKEDITOR.dom.walker.whitespaces(),
    A = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_COMMENT), da = function() {
      function a(a) {
        ...
        for (var b = Number.MAX_VALUE, i, h, j, l;
          ...
          i = Math.abs(ga(a, e, h) - a.mouse.y), i < b && (b = i, j = e, l = h),
          e = h, o(a, e);
      ...
      function c(a, b) {
        return !(
            b && b.type == CKEDITOR.NODE_TEXT || A(b) || p(b) || v(a, b) ||
      ...
      return function(c) {
        ...
        if (e = b) {
          e = b.upper;
          var f = b.lower;
          e = !e || !f || p(f) || p(e) || f.equals(e) || e.equals(f) ||
                  f.contains(e) || e.contains(f) ?
              !1 :
              G(c, e) && G(c, f) && Q(c, e, f) ? !0 : !1
        }
        return e ? b : null
      }
...
function l(a) {
  ...
  for (var e = [], f = ['style', 'className'], b = 0; b < f.length; b++) {
    ...
    d &&
        (d = new CKEDITOR.dom.element(d), e.push([d, d.nextSibling]),
         d.remove())
  }
  return e
}
  ...
  if (!a.editable().isInline()) {
    ...
    for (f in e) {
      ...
      'wysiwyg' == b.mode && !b.readOnly &&
          (b = b.document.getBody(), b.setAttribute('contentEditable', !1),
...
CKEDITOR.plugins.add('maximize', {
  init: function(a) {
    ...
    if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
      var f = a.lang, b = CKEDITOR.document, d = b.getWindow(), j, k, m,
      ...
      a.addCommand('maximize', {
        ...
        exec: function() {
          ...
          if (this.state == CKEDITOR.TRISTATE_OFF) {
            ...
            h.setStyle(
                'position',
                CKEDITOR.env.gecko && CKEDITOR.env.quirks ? 'fixed' :
                                                            'absolute');
            h.$.offsetLeft;
            h.setStyles({
          ...
          this.toggleState();
          if (c = this.uiItems[0])
            g = this.state == CKEDITOR.TRISTATE_OFF ? f.maximize.maximize :
                                                      f.maximize.minimize,
            c = CKEDITOR.document.getById(c._.id), c.getChild(1).setHtml(g),
            c.setAttribute('title', g),
            c.setAttribute('href', 'javascript:void("' + g + '");');
          'wysiwyg' == a.mode ?
              j ? (CKEDITOR.env.gecko && q(a), a.getSelection().selectRanges(j),
      ...
      a.on('mode', function() {
        ...
        b.setState(
            b.state == CKEDITOR.TRISTATE_DISABLED ? CKEDITOR.TRISTATE_DISABLED :
                                                    l)
      }, null, null, 100)
    }
  }
...
var c = {
  ...
  exec: function(a) {
    a.getClipboardData({title: a.lang.pastetext.title}, function(b) {
      ...
      a.fire(
          'afterCommandExec', {name: 'pastetext', command: c, returnValue: !!b})
    })
  }
};
        ...
        var g = h(a, f, function() {
          if (g)
            a.fire('paste', e);
              ...
              !a.config.pasteFromWordPromptCleanup || d ||
...
CKEDITOR.plugins.add('removeformat', {
  init: function(a) {
    a.addCommand(
        'removeFormat', CKEDITOR.plugins.removeformat.commands.removeformat);
    ...
    removeformat: {
      exec: function(a) {
        for (var h = a._.removeFormatRegex ||
          ...
          var j = c.createBookmark(), b = j.startNode, d = j.endNode,
              i = function(b) {
                for (var c = a.elementPath(b), e = c.elements, d = 1, g;
                     (g = e[d]) && !g.equals(c.block) &&
                     !g.equals(c.blockLimit);
                     d++)
          ...
          if (d) {
            ...
            for (b = b.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT);
              ...
              if (b.isReadOnly()) {
                ...
                i = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT),
                !('img' == b.getName() && b.data('cke-realelement')) &&
                    f(a, b) &&
                    (h.test(b.getName()) ? b.remove(1) :
...
CKEDITOR.plugins.add('showborders', {
  ...
  onLoad: function() {
    ...
    a = (CKEDITOR.env.ie6Compat ?
             [
               '.%1 table.%2,', '.%1 table.%2 td, .%1 table.%2 th', '{',
    ...
    b && b.addRules({
      elements: {
        table: function(a) {
          ...
          b &&
              (a['class'] = b.replace('cke_show_border', '')
                                .replace(/\s{2}/, ' ')
                                .replace(/^\s+|\s+$/, ''))
        }
      }
...
CKEDITOR.on('dialogDefinition', function(a) {
  ...
  if ('table' == b || 'tableProperties' == b)
    if (a = a.data.definition, b = a.getContents('info').get('txtBorder'),
    ...
    if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
      ...
      a.addMode('source', function(e) {
        ...
        b.setStyles(CKEDITOR.tools.extend(
            ...
            CKEDITOR.tools.cssVendorPrefix(
                'tab-size', a.config.sourceAreaTabSize || 4)));
    ...
    a.addCommand('specialchar', {
      exec: function() {
        var b = a.langCode,
            ...
            b :
            c.availableLangs[b.replace(/-.*/, '')] ? b.replace(/-.*/, '') :
                                                     'en';
        CKEDITOR.scriptLoader.load(
            CKEDITOR.getUrl(c.path + 'dialogs/lang/' + b + '.js'), function() {
               ...
               (a.previousState = a.state,
                b ||
                    (b = a.menu = new CKEDITOR.menu(c, {
                     ...
                     b.onHide = CKEDITOR.tools.bind(
                         function() {
                           var b = this.command ?
                               c.getCommand(this.command).modes :
                               this.modes;
                           this.setState(
                               !b || b[c.mode] ? a.previousState :
                                                 CKEDITOR.TRISTATE_DISABLED);
                           a.on = 0
                         },
                         this),
                     this.onMenu && b.addListener(this.onMenu)),
                this.setState(CKEDITOR.TRISTATE_ON), a.on = 1,
                setTimeout(function() {
...
CKEDITOR.plugins.add('scayt', {
  ...
  init: function(a) {
    ...
    this.addRule(a);
    CKEDITOR.dialog.add(
        this.dialogName, CKEDITOR.getUrl(this.path + 'dialogs/options.js'));
    this.addMenuItems(a);
    ...
    a.ui.add('Scayt', CKEDITOR.UI_MENUBUTTON, {
      ...
      refresh: function() {
        ...
        a.scayt &&
            (b = d.state[a.name] ? CKEDITOR.TRISTATE_ON :
                                   CKEDITOR.TRISTATE_OFF);
      ...
      onMenu: function() {
        ...
        a.getMenuItem('scaytToggle').label =
            a.lang.scayt[b && d.state[a.name] ? 'btn_disable' : 'btn_enable'];
        b = {
    ...
    a.contextMenu && a.addMenuItems &&
        (a.contextMenu.addListener(function() {
         ...
         a.contextMenu._.onHide =
             CKEDITOR.tools.override(a.contextMenu._.onHide, function(d) {
               return function() {
                 var b = a.scayt;
                 b && b.hideBanner();
                 return d.apply(this)
  ...
  addMenuItems: function(a) {
    ...
    a.plugins.wsc && (b.WSC = {
      ...
      onClick: function() {
        ...
        (c = c.replace(/\s/g, '')) ?
            (b && (d.state[a.name] && b.setMarkupPaused) &&
                 b.setMarkupPaused(!0),
             a.lockSelection(), a.execCommand('checkspell')) :
  ...
  bindEvents: function(a) {
    ...
    var e = function() {
      ...
      d.attachListener(d, 'focus', function() {
        var d = CKEDITOR.plugins.scayt &&
            CKEDITOR.plugins.scayt.state[a.name] && a.scayt,
            c, e;
        if ((b || d) && a._.savedSelection)
          for (var d = a._.savedSelection.getSelectedElement(),
                   d = !d && a._.savedSelection.getRanges(), i = 0;
               i < d.length; i++)
            e = d[i], c = e.startContainer.getText().length,
            (c < e.startOffset || c < e.endOffset) && a.unlockSelection(!1)
      }, this, null, -10)
    }, h = function() {
      b ? (a.on('blur', e), a.on('focus', g), a.focusManager.hasFocus && g()) :
          g();
      f()
    };
    a.on('contentDom', h);
    a.on('beforeCommandExec', function(b) {
      ...
      if (b.data.name in d.options.disablingCommandExec &&
        ...
        if (c = a.scayt)
          ...
          'bold' === b.data.name || 'italic' === b.data.name ||
          'underline' === b.data.name || 'strike' === b.data.name ||
          'subscript' === b.data.name || 'superscript' === b.data.name)
        if (c = a.scayt)
      ...
      if ('source' == b.data) {
        ...
        a.document &&
            (a.document.getBody().removeAttribute('_jquid'),
             a.document.getBody().removeAttribute('dir'))
      }
    });
    a.on('afterCommandExec', function(d) {
      var b;
      if ('wysiwyg' == a.mode &&
          ('undo' == d.data.name || 'redo' == d.data.name))
      ...
      b &&
          (c = a.scayt,
           !0 === b.editor.readOnly ?
               ...
               c ?
               c.fire('startSpellCheck') :
               'wysiwyg' == b.editor.mode && !0 === d.state[b.editor.name] &&
                       (d.createScayt(a),
                        b.editor.fire(
                            'scaytButtonState', CKEDITOR.TRISTATE_ON)))
    });
  ...
  parseConfig: function(a) {
    ...
    if ('string' === typeof a.config.scayt_uiTabs &&
      ...
      a.config.scayt_uiTabs =
          null === CKEDITOR.tools.search(b, !1) ? d : [1, 1, 1]
    } else
    ...
    if (a.config.scayt_disableOptionsStorage) {
      var c = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ?
          ...
          [a.config.scayt_disableOptionsStorage] :
          void 0,
          e = 'all options lang ignore-all-caps-words ignore-domain-names ignore-words-with-mixed-cases ignore-words-with-numbers'
                  .split(' '),
          g =
              [
                'lang', 'ignore-all-caps-words', 'ignore-domain-names',
                'ignore-words-with-mixed-cases', 'ignore-words-with-numbers'
              ],
  ...
  addRule: function(a) {
    var c = a.dataProcessor, d = c && c.htmlFilter,
        b = a._.elementsPath && a._.elementsPath.filters, c = c && c.dataFilter,
        e = a.addRemoveFormatFilter, g = function(d) {
    ...
    c && c.addRules({
      elements: {
        span: function(d) {
          var b = CKEDITOR.plugins.scayt;
          b &&
              (b.state[a.name] && d.classes &&
               CKEDITOR.tools.search(
                   d.classes, b.options.misspelled_word_class)) &&
              (d.classes && d.parent.type === CKEDITOR.NODE_DOCUMENT_FRAGMENT ?
                   (delete d.attributes.style, delete d.name) :
                   delete d.classes[CKEDITOR.tools.indexOf(
                       d.classes, b.options.misspelled_word_class)]);
          return d
        }
      }
    ...
    d && d.addRules({
      elements: {
        span: function(d) {
          var b = CKEDITOR.plugins.scayt;
          b &&
              (b.state[a.name] && d.hasClass(b.options.misspelled_word_class) &&
               d.attributes[b.options.data_attribute_name]) &&
              (d.removeClass(b.options.misspelled_word_class),
               delete d.attributes[b.options.data_attribute_name],
               delete d.name);
          return d
        }
      }
  ...
  buildSuggestionMenuItems: function(a, c) {
    ...
    if (0 < c.length && 'no_any_suggestions' !== c[0])
      for (var g = 0; g < c.length; g++) {
        var f = 'scayt_suggest_' +
            CKEDITOR.plugins.scayt.suggestions[g].replace(' ', '_');
        a.addCommand(
            f, this.createCommand(CKEDITOR.plugins.scayt.suggestions[g]));
        g < a.config.scayt_maxSuggestions ?
            (a.addMenuItem(f, {
              label: c[g],
              command: f,
              group: 'scayt_suggest',
      ...
      d.no_scayt_suggest = CKEDITOR.TRISTATE_DISABLED,
  ...
  menuGenerator: function(a, c) {
    ...
    for (var f in b)
      -1 == CKEDITOR.tools.indexOf(g, f.replace('scayt_', '')) &&
              'all' != a.config.scayt_contextCommands ||
          (e[f] = CKEDITOR.TRISTATE_OFF,
           'function' === typeof b[f].verification && !b[f].verification(a) &&
               delete e[f],
           a.addCommand(f, {exec: b[f].exec}), a.addMenuItem(f, {
  ...
  createScayt: function(a) {
    ...
    this.loadScaytLibrary(a, function(a) {
      ...
      a.config.scayt_serviceHost &&
          (b.service_host = a.config.scayt_serviceHost);
      a.config.scayt_servicePort &&
          (b.service_port = a.config.scayt_servicePort);
      a.config.scayt_servicePath &&
          (b.service_path = a.config.scayt_servicePath);
...
CKEDITOR.on('scaytReady', function() {
  if (!0 === CKEDITOR.config.scayt_handleCheckDirty) {
    ...
    a.checkDirty = CKEDITOR.tools.override(a.checkDirty, function(a) {
      return function() {
        ...
        if (!CKEDITOR.plugins.scayt ||
            !CKEDITOR.plugins.scayt.state[this.name] || !this.scayt)
          b = a.call(this);
        else if (b = 'ready' == this.status)
          var g = c.removeMarkupFromString(this.getSnapshot()),
    ...
    a.resetDirty = CKEDITOR.tools.override(a.resetDirty, function(a) {
      return function() {
        var b = this.scayt;
        !CKEDITOR.plugins.scayt || !CKEDITOR.plugins.scayt.state[this.name] ||
                !this.scayt ?
            a.call(this) :
  ...
  if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
    ...
    a[c] = CKEDITOR.tools.override(a[c], function(a) {
      return function(b) {
        ...
        CKEDITOR.plugins.scayt &&
            (CKEDITOR.plugins.scayt.state[b.editor.name] && b.editor.scayt) &&
            (this.contents = c.removeMarkupFromString(g) || '',
             b.contents = c.removeMarkupFromString(f) || '');
        ...
        for (var a, h, d, e = 0, l = b.length; e < l; e++)
          if (a = b[e],
              !(c.blockless && a.element in CKEDITOR.dtd.$block) &&
                  (h = a.name, a = new CKEDITOR.style(a),
                   !c.filter.customConfig || c.filter.check(a)))
            a._name = h, a._.enterMode = j.enterMode,
            a._.type = d = a.assignedTo || a.type,
            a._.weight = e +
                1E3 *
                    (d == CKEDITOR.STYLE_OBJECT ?
                         1 :
                         d == CKEDITOR.STYLE_BLOCK ? 2 : 3),
    ...
    c.ui.addRichCombo('Styles', {
      ...
      init: function() {
        ...
        for (f = i.length; e < f; e++)
          b = i[e], a = b._name, d = b._.type,
          d != c && (this.startGroup(g['panelTitle' + d]), c = d),
          this.add(
              a, b.type == CKEDITOR.STYLE_OBJECT ? a : b.buildPreview(), a);
        this.commit()
      },
      onClick: function(b) {
        c.focus();
      ...
      onRender: function() {
        c.on('selectionChange', function(b) {
          for (var a = this.getValue(), b = b.data.path.elements, h = 0,
                   d = b.length, e;
               h < d; h++) {
            e = b[h];
            for (var g in f)
      ...
      onOpen: function() {
        ...
        a[CKEDITOR.STYLE_BLOCK] ||
            this.hideGroup(g['panelTitle' + CKEDITOR.STYLE_BLOCK]);
        a[CKEDITOR.STYLE_INLINE] ||
            this.hideGroup(g['panelTitle' + CKEDITOR.STYLE_INLINE]);
        a[CKEDITOR.STYLE_OBJECT] ||
            this.hideGroup(g['panelTitle' + CKEDITOR.STYLE_OBJECT])
      },
      refresh: function() {
        var b = c.elementPath();
        if (b) {
      ...
      if (d.editable().hasFocus) {
        ...
        if (b = (new CKEDITOR.dom.elementPath(e.getCommonAncestor(), e.root))
          ...
          if (!a && !c) {
            ...
            a = new CKEDITOR.dom.element(a), e.moveToElementEditStart(a),
...
CKEDITOR.plugins.add('tab', {
  init: function(c) {
    for (var d = !1 !== c.config.enableTabKeyTools, e = c.config.tabSpaces || 0,
             b = '';
         e--;)
      b += ' ';
    if (b)
...
CKEDITOR.dom.element.prototype.focusNext = function(i, h) {
  ...
  if (0 >= g)
    ...
    for (b = this.getDocument().getBody().getFirst();
         b = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT);) {
      if (!f)
        if (!c && b.equals(this)) {
          if (c = !0, i) {
  ...
  init: function(a) {
    function e(a) {
      return CKEDITOR.tools.extend(a || {}, {
        ...
        refresh: function(a, f) {
          this.setState(
              f.contains('table', 1) ? CKEDITOR.TRISTATE_OFF :
                                       CKEDITOR.TRISTATE_DISABLED)
        }
      })
    }
    if (!a.blockless) {
      ...
      a.ui.addButton &&
          a.ui.addButton(
              'Table',
              {label: c.toolbar, command: 'table', toolbar: 'insert,30'});
      ...
      a.contextMenu && a.contextMenu.addListener(function() {
        return {
          tabledelete: CKEDITOR.TRISTATE_OFF, table: CKEDITOR.TRISTATE_OFF
        }
      })
    }
  }
...
function p(e) {
  function d(a) {
    !(0 < b.length) &&
        (a.type == CKEDITOR.NODE_ELEMENT && y.test(a.getName()) &&
    ...
    if (f.collapsed)
      ...
      for (f.guard = d; g = f.next();)
        if (g.type != CKEDITOR.NODE_ELEMENT || !g.is(CKEDITOR.dtd.table))
          if ((g = g.getAscendant('td', !0) || g.getAscendant('th', !0)) &&
...
function o(e, d) {
  for (var b = p(e), c = b[0], a = c.getAscendant('table'), c = c.getDocument(),
           f = b[0].getParent(), g = f.$.rowIndex, b = b[b.length - 1],
           h = b.getParent().$.rowIndex + b.$.rowSpan - 1,
           b = new CKEDITOR.dom.element(a.$.rows[h]), g = d ? g : h,
           f = d ? f : b, b = CKEDITOR.tools.buildTableMap(a), a = b[g],
           g = d ? b[g - 1] : b[g + 1], b = b[0].length,
...
function q(e) {
  if (e instanceof CKEDITOR.dom.selection) {
    for (var d = p(e), b = d[0].getAscendant('table'),
             c = CKEDITOR.tools.buildTableMap(b),
             e = d[0].getParent().$.rowIndex, d = d[d.length - 1],
             a = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = [], f = e;
         f <= a; f++) {
      for (var g = c[f], h = new CKEDITOR.dom.element(b.$.rows[f]), i = 0;
           i < g.length; i++) {
        ...
        1 == j.$.rowSpan ?
            ...
            (j.$.rowSpan -= 1,
             l == f &&
                 (l = c[f + 1],
                  l[i - 1] ? j.insertAfter(new CKEDITOR.dom.element(l[i - 1])) :
                             (new CKEDITOR.dom.element(b.$.rows[f + 1]))
                                 .append(j, 1)));
        i += j.$.colSpan - 1
      }
      d.push(h)
...
function r(e, d) {
  for (var b = d ? Infinity : 0, c = 0; c < e.length; c++) {
    var a;
    a = e[c];
    for (var f = d, g = a.getParent().$.cells, h = 0, i = 0; i < g.length;
         i++) {
...
function k(e, d) {
  for (var b = p(e), c = b[0].getAscendant('table'), a = r(b, 1), b = r(b),
           a = d ? a : b, f = CKEDITOR.tools.buildTableMap(c), c = [], b = [],
           g = f.length, h = 0;
       h < g; h++)
    ...
    c[h] &&
        (1 < c[h].colSpan && b[h] == c[h] ?
             ...
             (a = (new CKEDITOR.dom.element(c[h])).clone(),
              a.removeAttribute('colSpan'), a.appendBogus(),
...
function s(e, d, b) {
  ...
  var g = CKEDITOR.tools.buildTableMap(a), h = g.length, i = g[0].length,
      j = e.getParent().$.rowIndex, l = v(g, j, e);
  if (d) {
    var n;
    try {
      var m = parseInt(e.getAttribute('rowspan'), 10) || 1;
      f = parseInt(e.getAttribute('colspan'), 10) || 1;
      n = g['up' == d ? j - m : 'down' == d ? j + m : j]
  ...
  for (var d = e.getDocument(), o = j, m = n = 0,
           q = !b && new CKEDITOR.dom.documentFragment(d), s = 0, d = 0;
       d < c.length; d++) {
    f = c[d];
    var k = f.getParent(), t = f.getFirst(), r = f.$.colSpan, u = f.$.rowSpan,
        k = k.$.rowIndex, w = v(g, k, f), s = s + r * u,
        m = Math.max(m, w - l + r);
    n = Math.max(n, k - j + u);
    if (!b) {
      r = f;
...
function w(e, d) {
  ...
  if (d) return !0;
  var b = b[0], c = b.getParent(), a = c.getAscendant('table'),
      f = CKEDITOR.tools.buildTableMap(a), g = c.$.rowIndex, h = v(f, g, b),
      i = b.$.rowSpan, j;
  if (1 < i) {
    j = Math.ceil(i / 2);
    for (var i = Math.floor(i / 2), c = g + j,
             a = new CKEDITOR.dom.element(a.$.rows[c]), f = v(f, c), l,
             c = b.clone(), g = 0;
         g < f.length; g++)
...
function x(e, d) {
  ...
  if (d) return !0;
  var b = b[0], c = b.getParent(), a = c.getAscendant('table'),
      a = CKEDITOR.tools.buildTableMap(a), f = v(a, c.$.rowIndex, b),
      g = b.$.colSpan;
  if (1 < g)
...
CKEDITOR.plugins.tabletools = {
  ...
  init: function(e) {
    function d(a) {
      return CKEDITOR.tools.extend(a || {}, {
        ...
        refresh: function(a, b) {
          this.setState(
              b.contains({td: 1, th: 1}, 1) ? CKEDITOR.TRISTATE_OFF :
                                              CKEDITOR.TRISTATE_DISABLED)
        }
      })
    }
    ...
    b('columnDelete', d({
        requiredContent: 'table',
        exec: function(a) {
          for (var a = a.getSelection(), a = p(a), b = a[0],
                   c = a[a.length - 1], a = b.getAscendant('table'),
          ...
          for (n = e; n <= j; n++)
            for (k = 0; k < d.length; k++)
              c = d[k], b = new CKEDITOR.dom.element(a.$.rows[k]),
        ...
        getItems: function() {
          ...
          return {
            tablecell_insertBefore: CKEDITOR.TRISTATE_OFF,
                ...
                CKEDITOR.TRISTATE_OFF :
                CKEDITOR.TRISTATE_DISABLED,
                tablecell_split_vertical: w(a, !0) ? CKEDITOR.TRISTATE_OFF :
                                                     CKEDITOR.TRISTATE_DISABLED,
                tablecell_split_horizontal: x(a, !0) ?
                CKEDITOR.TRISTATE_OFF :
                CKEDITOR.TRISTATE_DISABLED,
                tablecell_properties: 0 < b.length ? CKEDITOR.TRISTATE_OFF :
                                                     CKEDITOR.TRISTATE_DISABLED
          }
        }
      },
...
CKEDITOR.tools.buildTableMap = function(p) {
  for (var p = p.$.rows, o = -1, q = [], r = 0; r < p.length; r++) {
    ...
    for (var k = -1, u = 0; u < p[r].cells.length; u++) {
      var t = p[r].cells[u];
      for (k++; q[o][k];) k++;
      for (var m = isNaN(t.colSpan) ? 1 : t.colSpan,
               t = isNaN(t.rowSpan) ? 1 : t.rowSpan, v = 0;
           v < t; v++) {
        q[o + v] || (q[o + v] = []);
...
var g =
        [
          CKEDITOR.CTRL + 90, CKEDITOR.CTRL + 89,
...
CKEDITOR.plugins.add('undo', {
  init: function(a) {
    ...
    var d = a.undoManager = new e(a), j = d.editingHandler = new i(d),
        f = a.addCommand('undo', {
          exec: function() {
    ...
    a.ui.addButton &&
        (a.ui.addButton(
             'Undo',
             {label: a.lang.undo.undo, command: 'undo', toolbar: 'undo,10'}),
         a.ui.addButton(
             'Redo',
  ...
  equalsSelection: function(a) {
    ...
    if (b || a) {
      ...
      for (var c = 0; c < b.length; c++) {
        var d = b[c], e = a[c];
        if (d.startOffset != e.startOffset || d.endOffset != e.endOffset ||
...
i.prototype = {
  ...
  onKeyup: function(a) {
    var b = this.undoManager, a = a.data.getKey(),
        c = this.keyEventsStack.getTotalInputs();
    this.keyEventsStack.remove(a);
    if (!e.ieFunctionalKeysBug(a) || !this.lastKeydownImage ||
  ...
  attachListeners: function() {
    ...
    b.attachListener(
        b, CKEDITOR.env.ie ? 'keypress' : 'input', c.onInput, c, null, 999);
...
CKEDITOR.plugins.add('wsc', {
  requires: 'dialog',
  parseApi: function(a) {
    a.config.wsc_onFinish = 'function' === typeof a.config.wsc_onFinish ?
  ...
  parseConfig: function(a) {
    ...
    a.config.wsc_customLoaderScript = a.config.wsc_customLoaderScript ||
  ...
  init: function(a) {
    ...
    a.addCommand('checkspell', new CKEDITOR.dialogCommand('checkspell'))
        .modes = {
      wysiwyg: !CKEDITOR.env.opera && !CKEDITOR.env.air &&
          document.domain == window.location.hostname &&
          !(b.ie && (8 > b.version || b.quirks))
    };
    'undefined' == typeof a.plugins.scayt && a.ui.addButton &&
        a.ui.addButton('SpellChecker', {
          ...
          click: function(a) {
            var b = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ?
                a.container.getText() :
                a.document.getBody().getText();
            (b = b.replace(/\s/g, '')) ? a.execCommand('checkspell') :
                                         alert('Nothing to check!')
          },
    ...
    CKEDITOR.dialog.add(
        ...
        this.path +
            (CKEDITOR.env.ie && 7 >= CKEDITOR.env.version ?
                 'dialogs/wsc_ie.js' :
                 window.postMessage ? 'dialogs/wsc.js' : 'dialogs/wsc_ie.js'))
  }
});
