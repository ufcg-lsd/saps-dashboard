...
function RGBColor(m) {
  ...
  var d = [
    ...
    },
    {
      ...
      process: function(b) {
        return [
          parseInt(b[1] + b[1], 16), parseInt(b[2] + b[2], 16),
          parseInt(b[3] + b[3], 16)
        ]
      }
    }
  ...
  for (c = 0; c < d.length; c++) {
    ...
    if (k)
      channels = b(k), this.r = channels[0], this.g = channels[1],
      this.b = channels[2], this.ok = !0
  }
  ...
  this.toHex = function() {
    var b = this.r.toString(16), a = this.g.toString(16),
  ...
  this.getHelpXML = function() {
    ...
    for (k = 0; k < b.length; k++) try {
        var l = document.createElement('li'), o = new RGBColor(b[k]),
            n = document.createElement('div');
        n.style.cssText =
            'margin: 3px; border: 1px solid black; background:' + o.toHex() +
            '; color:' + o.toHex();
...
function m() {
    ...
    this.Length = {
      ...
      toPixels: function(d) {
        ...
        return c.match(/em$/) ?
            ...
            c.match(/%$/) ? b.numValue() * a.ViewPort.ComputeSize(d) :
                            b.numValue()
      }
    };
    this.Time = {
  ...
  a.Font = new function() {
    ...
    this.CreateFont = function(d, b, c, e, f, g) {
      g = g != null ? this.Parse(g) :
                      this.CreateFont('', '', '', '', '', a.ctx.font);
      return {
        fontFamily: f || g.fontFamily, fontSize: e || g.fontSize,
            fontStyle: d || g.fontStyle, fontWeight: c || g.fontWeight,
            fontVariant: b || g.fontVariant, toString: function() {
              return [
    ...
    this.Parse = function(d) {
      for (var b = {}, d = a.trim(a.compressSpaces(d || '')).split(' '), k = !1,
               e = !1, f = !1, g = !1, j = '', h = 0;
           h < d.length; h++)
  ...
  a.BoundingBox = function(a, d, b, k) {
    ...
    this.addQuadraticCurve = function(b, a, d, c, k, l) {
      ...
      c = a + 2 / 3 * (c - a);
      this.addBezierCurve(
          b, a, d, d + 1 / 3 * (k - b), c, c + 1 / 3 * (l - a), k, l)
    };
    this.addBezierCurve = function(b, a, d, c, k, l, o, n) {
      ...
      for (i = 0; i <= 1; i++)
        b =
            function(b) {
          return Math.pow(1 - b, 3) * q[i] + 3 * Math.pow(1 - b, 2) * b * p[i] +
              3 * (1 - b) * Math.pow(b, 2) * t[i] + Math.pow(b, 3) * m[i]
        },
        a = 6 * q[i] - 12 * p[i] + 6 * t[i],
        d = -3 * q[i] + 9 * p[i] - 9 * t[i] + 3 * m[i], c = 3 * p[i] - 3 * q[i],
        d == 0 ?
            a != 0 &&
                (a = -c / a,
                 0 < a && a < 1 &&
  ...
  a.Transform = function(c) {
    ...
    for (var c = a.trim(a.compressSpaces(c)).split(/\s(?=[a-z])/), b = 0;
         b < c.length; b++) {
  ...
  a.AspectRatio = function(c, d, b, k, e, f, g, j, h, l) {
    var d = a.compressSpaces(d), d = d.replace(/^defer\s/, ''),
        o = d.split(' ')[0] || 'xMidYMid', d = d.split(' ')[1] || 'meet',
        n = b / k, q = e / f, p = Math.min(n, q), m = Math.max(n, q);
    d == 'meet' && (k *= p, f *= p);
    d == 'slice' && (k *= m, f *= m);
  ...
  a.Element.ElementBase = function(c) {
    ...
    if (c != null && c.nodeType == 1) {
      ...
      if (this.attribute('class').hasValue())
        for (var d = a.compressSpaces(this.attribute('class').value).split(' '),
                 e = 0;
             e < d.length; e++) {
          b = a.Styles['.' + d[e]];
          if (b != null)
      ...
      if (this.attribute('style').hasValue()) {
        ...
        for (d = 0; d < b.length; d++)
          a.trim(b[d]) != '' &&
              (c = b[d].split(':'), k = a.trim(c[0]), c = a.trim(c[1]),
    ...
    this.renderChildren = function(d) {
      ...
      if (b != null) {
        ...
        if (this.style('marker-mid').Definition.isUrl())
          for (var c = this.style('marker-mid').Definition.getDefinition(),
                   e = 1;
               e < b.length - 1; e++)
  ...
  a.Element.svg = function(c) {
    ...
    this.setContext = function(d) {
      ...
      this.attribute('x').hasValue() && this.attribute('y').hasValue() &&
          d.translate(
      ...
      if (typeof this.root == 'undefined' &&
        ...
        var b = this.attribute('width').Length.toPixels('x'),
            c = this.attribute('height').Length.toPixels('y'), e = 0, f = 0;
      ...
      if (this.attribute('viewBox').hasValue()) {
        var e = a.ToNumberArray(this.attribute('viewBox').value), f = e[0],
            g = e[1], b = e[2], c = e[3];
        a.AspectRatio(
            d, this.attribute('preserveAspectRatio').value, a.ViewPort.width(),
            b, a.ViewPort.height(), c, f, g, this.attribute('refX').value,
  ...
  a.Element.rect = function(c) {
    ...
    this.path = function(d) {
      ...
      this.attribute('rx').hasValue() && !this.attribute('ry').hasValue() &&
          (j = g);
      this.attribute('ry').hasValue() && !this.attribute('rx').hasValue() &&
          (g = j);
      d != null &&
          (d.beginPath(), d.moveTo(b + g, c), d.lineTo(b + e - g, c),
           d.quadraticCurveTo(b + e, c, b + e, c + j),
           d.lineTo(b + e, c + f - j),
           d.quadraticCurveTo(b + e, c + f, b + e - g, c + f),
           d.lineTo(b + g, c + f), d.quadraticCurveTo(b, c + f, b, c + f - j),
           d.lineTo(b, c + j), d.quadraticCurveTo(b, c, b + g, c),
           d.closePath());
  ...
  a.Element.path = function(c) {
    ...
    c = c.replace(/,/gm, ' ');
    c = c.replace(
        /([MmZzLlHhVvCcSsQqTtAa])([MmZzLlHhVvCcSsQqTtAa])/gm, '$1 $2');
    c = c.replace(
        /([MmZzLlHhVvCcSsQqTtAa])([MmZzLlHhVvCcSsQqTtAa])/gm, '$1 $2');
        ...
        switch (b.nextCommand(), b.command.toUpperCase()) {
          case 'M':
            ...
            for (b.start = b.current; !b.isCommandOrEnd();)
              e = b.getAsCurrentPoint(), b.addMarker(e, b.start),
              c.addPoint(e.x, e.y), d != null && d.lineTo(e.x, e.y);
            break;
          case 'L':
          ...
          case 'H':
            for (; !b.isCommandOrEnd();)
              e = new a.Point(
                  ...
                  b.current.y),
              b.addMarker(e, b.current), b.current = e,
          ...
          case 'C':
            for (; !b.isCommandOrEnd();) {
              var g = b.current, f = b.getPoint(), j = b.getAsControlPoint(),
          ...
          case 'S':
            for (; !b.isCommandOrEnd();)
              g = b.current, f = b.getReflectedControlPoint(),
              j = b.getAsControlPoint(), e = b.getAsCurrentPoint(),
              b.addMarker(e, j, f),
              c.addBezierCurve(g.x, g.y, f.x, f.y, j.x, j.y, e.x, e.y),
              d != null && d.bezierCurveTo(f.x, f.y, j.x, j.y, e.x, e.y);
            break;
          case 'Q':
            for (; !b.isCommandOrEnd();)
              ...
              e = b.getAsCurrentPoint(), b.addMarker(e, j, j),
              c.addQuadraticCurve(g.x, g.y, j.x, j.y, e.x, e.y),
              d != null && d.quadraticCurveTo(j.x, j.y, e.x, e.y);
            break;
          case 'T':
            for (; !b.isCommandOrEnd();)
              g = b.current, j = b.getReflectedControlPoint(), b.control = j,
              e = b.getAsCurrentPoint(), b.addMarker(e, j, j),
              c.addQuadraticCurve(g.x, g.y, j.x, j.y, e.x, e.y),
              d != null && d.quadraticCurveTo(j.x, j.y, e.x, e.y);
            break;
          case 'A':
            for (; !b.isCommandOrEnd();) {
              var g = b.current, h = b.getScalar(), l = b.getScalar(),
                  f = b.getScalar() * (Math.PI / 180), o = b.getScalar(),
                  j = b.getScalar(), e = b.getAsCurrentPoint(),
                  n = new a.Point(
                      Math.cos(f) * (g.x - e.x) / 2 +
                          Math.sin(f) * (g.y - e.y) / 2,
                      -Math.sin(f) * (g.x - e.x) / 2 +
                          Math.cos(f) * (g.y - e.y) / 2),
                  q = Math.pow(n.x, 2) / Math.pow(h, 2) +
              ...
              var p = new a.Point(o * h * n.y / l, o * -l * n.x / h),
                  ...
                  s =
                      function(b, a) {
                    return (b[0] * a[1] < b[1] * a[0] ? -1 : 1) *
                        Math.acos(m(b, a))
                  },
                  o = s([1, 0], [(n.x - p.x) / h, (n.y - p.y) / l]),
                  q = [(n.x - p.x) / h, (n.y - p.y) / l],
                  p = [(-n.x - p.x) / h, (-n.y - p.y) / l], n = s(q, p);
              ...
              b.addMarkerAngle(
                  q, (o + n) / 2 + (j == 0 ? 1 : -1) * Math.PI / 2);
              b.addMarkerAngle(e, n + (j == 0 ? 1 : -1) * Math.PI / 2);
              c.addPoint(e.x, e.y);
              d != null &&
                  (m = h > l ? h : l, e = h > l ? 1 : h / l,
                   h = h > l ? l / h : 1, d.translate(g.x, g.y), d.rotate(f),
                   d.scale(e, h), d.arc(0, 0, m, o, o + n, 1 - j),
                   d.scale(1 / e, 1 / h), d.rotate(-f), d.translate(-g.x, -g.y))
            }
            break;
          case 'Z':
    ...
    this.getMarkers = function() {
      for (var a = this.PathParser.getMarkerPoints(),
               b = this.PathParser.getMarkerAngles(), c = [], e = 0;
           e < a.length; e++)
        c.push([a[e], b[e]]);
      return c
    }
  ...
  a.Element.pattern = function(c) {
    ...
    this.createPattern = function(d) {
      ...
      b.attributes.viewBox =
          new a.Property('viewBox', this.attribute('viewBox').value);
      b.attributes.x = new a.Property('x', this.attribute('x').value);
      b.attributes.y = new a.Property('y', this.attribute('y').value);
      b.attributes.width =
          new a.Property('width', this.attribute('width').value);
      b.attributes.height =
          new a.Property('height', this.attribute('height').value);
  ...
  a.Element.marker = function(c) {
    ...
    this.render = function(d, b, c) {
      ...
      e.attributes.width =
          new a.Property('width', this.attribute('markerWidth').value);
      e.attributes.height =
          new a.Property('height', this.attribute('markerHeight').value);
  ...
  a.Element.AnimateBase = function(c) {
    ...
    this.getProperty = function() {
      ...
      return a == 'CSS' ? this.parent.style(b, !0) :
    ...
    this.update = function(a) {
      ...
      if (this.duration > this.maxDuration)
        if (this.attribute('repeatCount').value == 'indefinite')
          ...
          return this.attribute('fill').valueOrDefault('remove') == 'remove' &&
                  !this.removed ?
  ...
  a.Element.animateColor = function(c) {
    ...
    this.calcValue = function() {
      ...
      if (a.ok && b.ok) {
        ...
        return 'rgb(' + parseInt(c, 10) + ',' + parseInt(e, 10) + ',' +
            parseInt(a, 10) + ')'
      }
  ...
  a.Element.font = function(c) {
    ...
    for (c = 0; c < this.children.length; c++) {
      ...
      if (d.type == 'font-face')
        ...
        d.arabicForm != '' ? (this.isArabic = this.isRTL = !0,
  ...
  a.Element.text = function(c) {
    ...
    this.renderChildren = function(b) {
      for (var a = this.style('text-anchor').valueOrDefault('start'),
               ...
               d = this.attribute('y').Length.toPixels('y'), j = 0;
           j < this.children.length; j++) {
  ...
  a.Element.TextElementBase = function(c) {
    ...
    this.measureText = function(c) {
      var b = this.parent.style('font-family').Definition.getDefinition();
      if (b != null) {
        var c = this.parent.style('font-size')
                    .numValueOrDefault(a.Font.Parse(a.ctx.font).fontSize),
            k = 0, e = this.getText();
        b.isRTL && (e = e.split('').reverse().join(''));
        for (var f = a.ToNumberArray(this.parent.attribute('dx').value), g = 0;
             g < e.length; g++) {
    ...
    this.renderChildren = function(b) {
      if (this.hasText) {
        ...
        a.Mouse.checkBoundingBox(
            this,
            new a.BoundingBox(
                this.x, this.y - c.Length.toPixels('y'),
                this.x + this.measureText(b), this.y))
      } else
        c = new a.Element.g, c.children = this.children, c.parent = this,
        c.render(b)
    };
    ...
    this.renderChildren = function(b) {
      ...
      f == 0 || g == 0 ||
          (b.save(), b.translate(c, d),
           a.AspectRatio(
               b, this.attribute('preserveAspectRatio').value, f,
               this.img.width, g, this.img.height, 0, 0),
  ...
  a.Element.symbol = function(c) {
    ...
    this.setContext = function(c) {
      ...
      if (this.attribute('viewBox').hasValue()) {
        var b = a.ToNumberArray(this.attribute('viewBox').value), k = b[0],
            e = b[1];
        width = b[2];
        height = b[3];
        a.AspectRatio(
            c, this.attribute('preserveAspectRatio').value,
            this.attribute('width').Length.toPixels('x'), width,
            this.attribute('height').Length.toPixels('y'), height, k, e);
  ...
  a.Element.style = function(c) {
    ...
    this.base(c);
    for (
        var c = c.childNodes[0].nodeValue +
            (c.childNodes.length > 1 ? c.childNodes[1].nodeValue : ''),
            c = c.replace(
                /(\/\*([^*]|[\r\n]|(\*+([^*\/]|[\r\n])))*\*+\/)|(^[\s]*\/\/.*)/gm,
                ''),
            c = a.compressSpaces(c), c = c.split('}'), d = 0;
        d < c.length; d++)
      if (a.trim(c[d]) != '')
        for (var b = c[d].split('{'), k = b[0].split(','), b = b[1].split(';'),
                 e = 0;
             e < k.length; e++) {
          var f = a.trim(k[e]);
          if (f != '') {
            for (var g = {}, j = 0; j < b.length; j++) {
              var h = b[j].indexOf(':'), l = b[j].substr(0, h),
  ...
  a.Element.filter = function(c) {
    ...
    this.base(c);
    this.apply = function(a, b) {
      var c = b.getBoundingBox(), e = this.attribute('x').Length.toPixels('x'),
      ...
      a.drawImage(
          o, 0, 0, g + 2 * h, j + 2 * l, e - h, f - l, g + 2 * h, j + 2 * l);
  ...
  a.Element.feGaussianBlur = function(c) {
      ...
      for (var j = 0; j < g; j++)
        for (var h = 0; h < f; h++)
          for (var l = a[j * f * 4 + h * 4 + 3] / 255, o = 0; o < 4; o++) {
            for (var n = d[0] * (l == 0 ? 255 : a[j * f * 4 + h * 4 + o]) *
                     (l == 0 || o == 3 ? 1 : l),
                     q = 1;
                 q < d.length; q++) {
              var p = Math.max(h - q, 0), m = a[j * f * 4 + p * 4 + 3] / 255,
                  p = Math.min(h + q, f - 1),
                  p = a[j * f * 4 + p * 4 + 3] / 255, s = d[q], r;
              m == 0 ? r = 255 :
                       (r = Math.max(h - q, 0), r = a[j * f * 4 + r * 4 + o]);
              m = r * (m == 0 || o == 3 ? 1 : m);
              p == 0 ?
                  r = 255 :
                  (r = Math.min(h + q, f - 1), r = a[j * f * 4 + r * 4 + o]);
              n += s * (m + r * (p == 0 || o == 3 ? 1 : p))
            }
            c[h * g * 4 + j * 4 + o] = n
          }
    ...
    this.apply = function(a, c, e, f, g) {
      var e = this.attribute('stdDeviation').numValue(),
          c = a.getImageData(0, 0, f, g), e = Math.max(e, 0.01),
          j = Math.ceil(e * 4) + 1;
      mask = [];
  ...
  a.CreateElement = function(c) {
    var d = c.nodeName.replace(/^[^:]+:/, ''), d = d.replace(/\-/g, ''),
        b = null,
        b = typeof a.Element[d] != 'undefined' ? new a.Element[d](c) :
  ...
  a.loadXmlDoc = function(c, d) {
    ...
    var k = a.CreateElement(d.documentElement), e = k.root = !0,
        f = function() {
          a.ViewPort.Clear();
          c.canvas.parentNode &&
          ...
          if (a.opts != null && a.opts.scaleWidth != null &&
            ...
            k.attribute('height').hasValue() &&
                (g = k.attribute('height').Length.toPixels('y') /
                     a.opts.scaleHeight);
          ...
          e &&
              (e = !1,
               a.opts != null && typeof a.opts.renderCallback == 'function' &&
    ...
    a.intervalID = setInterval(function() {
      ...
      a.opts != null && typeof a.opts.forceRedraw == 'function' &&
          a.opts.forceRedraw() == !0 && (b = !0);
  ...
  a.Mouse = new function() {
    ...
    this.checkPath = function(a, d) {
      for (var b = 0; b < this.events.length; b++) {
        var k = this.events[b];
        d.isPointInPath && d.isPointInPath(k.x, k.y) &&
...
this.canvg = function(a, c, d) {
  if (a == null && c == null && d == null)
    for (var c = document.getElementsByTagName('svg'), b = 0; b < c.length;
         b++) {
      a = c[b];
    ...
    a.svg == null ? (b = m(), a.svg = b) : (b = a.svg, b.stop()), b.opts = d,
    a = a.getContext('2d'),
...
(function(m) {
var a = m.css, c = m.CanVGRenderer, d = m.SVGRenderer, b = m.extend,
    k = m.merge, e = m.addEvent, f = m.createElement, g = m.discardElement;
...
b(c.prototype, {
  ...
  setContainer: function(a, b, c) {
    var d = a.style, e = a.parentNode, g = d.left, d = d.top, k = a.offsetWidth,
        m = a.offsetHeight, s = {visibility: 'hidden', position: 'absolute'};
    this.init.apply(this, [a, b, c]);
    this.canvas =
        f('canvas', {width: k, height: m},
          {position: 'relative', left: g, top: d}, a);
    this.ttLine = f('div', null, s, e);
    this.ttDiv = f('div', null, s, e);
    this.ttTimer = void 0;
    this.hiddenSvg = a =
        f('div', {width: k, height: m}, {visibility: 'hidden', left: g, top: d},
          e);
    a.appendChild(this.box)
  },
  configure: function(b) {
    var c = this, d = b.options.tooltip, f = d.borderWidth, g = c.ttDiv,
        m = d.style, p = c.ttLine, t = parseInt(m.padding, 10),
        m = k(m, {
          padding: t + 'px',
    ...
    e(b, 'tooltipRefresh', function(d) {
      ...
      g.innerHTML = d.text;
      k = b.tooltip.getPosition(
          g.offsetWidth, g.offsetHeight, {plotX: d.x, plotY: d.y});
      a(g, {
        visibility: 'visible',
        left: k.x + 'px',
        top: k.y + 'px',
