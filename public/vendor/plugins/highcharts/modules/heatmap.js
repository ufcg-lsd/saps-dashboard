...
*/
(function(h) {
var k = h.Axis, y = h.Chart, l = h.Color, z = h.Legend, t = h.LegendSymbolMixin,
    u = h.Series, v = h.SVGRenderer, w = h.getOptions(), i = h.each,
    r = h.extend, A = h.extendClass, m = h.merge, o = h.pick,
    x = h.numberFormat, p = h.seriesTypes, s = h.wrap, n = function() {},
...
r(q.prototype, {
  ...
  init: function(b, a) {
    ...
    d =
        m(this.defaultColorAxisOptions, {side: c ? 2 : 1, reversed: !c}, a,
          {isX: c, opposite: !c, showEmpty: !1, title: null, isColor: !0});
  ...
  tweenColors: function(b, a, c) {
    ...
    return (d ? 'rgba(' : 'rgb(') +
        Math.round(a.rgba[0] + (b.rgba[0] - a.rgba[0]) * (1 - c)) + ',' +
        Math.round(a.rgba[1] + (b.rgba[1] - a.rgba[1]) * (1 - c)) + ',' +
        Math.round(a.rgba[2] + (b.rgba[2] - a.rgba[2]) * (1 - c)) +
        (d ? ',' + (a.rgba[3] + (b.rgba[3] - a.rgba[3]) * (1 - c)) : '') + ')'
  },
    ...
    i(b.dataClasses, function(b, h) {
      ...
      if (!b.color)
        f.dataClassColor === 'category' ?
            (i = c.options.colors, b.color = i[e++],
             e === i.length && (e = 0)) :
            b.color = a.tweenColors(
                l(f.minColor), l(f.maxColor), g < 2 ? 0.5 : h / (g - 1))
    })
  },
  ...
  setAxisSize: function() {
    ...
    if (b)
      this.left = c = b.attr('x'), this.top = d = b.attr('y'),
      this.width = e = b.attr('width'), this.height = b = b.attr('height'),
      this.right = a.chartWidth - c - e, this.bottom = a.chartHeight - d - b,
      this.len = this.horiz ? e : b, this.pos = this.horiz ? c : d
  },
  toColor: function(b, a) {
    var c, d = this.stops, e, f = this.dataClasses, g, j;
    if (f)
      for (j = f.length; j--;) {
        if (g = f[j], e = g.from, d = g.to,
            (e === void 0 || b >= e) && (d === void 0 || b <= d)) {
          c = g.color;
          if (a) a.dataClass = j;
          break
        }
  ...
  getOffset: function() {
    var b = this.legendGroup, a = this.chart.axisOffset[this.side];
    if (b) {
      k.prototype.getOffset.call(this);
      if (!this.axisGroup.parentGroup)
        this.axisGroup.add(b), this.gridGroup.add(b), this.labelGroup.add(b),
            this.added = !0;
  ...
  drawLegendSymbol: function(b, a) {
    var c = b.padding, d = b.options, e = this.horiz,
        f = o(d.symbolWidth, e ? 200 : 12), g = o(d.symbolHeight, e ? 12 : 200),
        j = o(d.labelPadding, e ? 16 : 30), d = o(d.itemDistance, 10);
    this.setLegendColor();
    a.legendSymbol = this.chart.renderer.rect(0, b.baseline - 11, f, g)
                         .attr({zIndex: 1})
                         .add(a.legendGroup);
  ...
  drawCrosshair: function(b, a) {
    var c = !this.cross, d = a && a.plotX, e = a && a.plotY, f, g = this.pos,
        j = this.len;
    if (a)
      f = this.toPixels(a.value),
      f < g ? f = g - 2 : f > g + j && (f = g + j + 2), a.plotX = f,
      a.plotY = this.len - f, k.prototype.drawCrosshair.call(this, b, a),
      a.plotX = d, a.plotY = e,
      !c && this.cross &&
          this.cross.attr({fill: this.crosshair.color}).add(this.labelGroup)
  },
  getPlotLinePath: function(b, a, c, d, e) {
    return e ?
        ...
        [
          'M', this.left, e, 'L', this.left - 6, e + 6, this.left - 6, e - 6,
          'Z'
        ] :
        k.prototype.getPlotLinePath.call(this, b, a, c, d)
  },
  update: function(b, a) {
    ...
    this.legendItem &&
        (this.setLegendColor(), this.chart.legend.colorizeItem(this, !0))
  },
  getDataClassLegendSymbols: function() {
    var b = this, a = this.chart, c = this.legendItems, d = a.options.legend,
...
s(z.prototype, 'getAllItems', function(b) {
  ...
  c &&
      (c.options.dataClasses ? a = a.concat(c.getDataClassLegendSymbols()) :
                               a.push(c),
...
h = {
  ...
  translateColors: function() {
    var b = this, a = this.options.nullColor, c = this.colorAxis,
        d = this.colorKey;
    i(this.data, function(e) {
      var f = e[d];
      if (f = f === null ?
              a :
              c && f !== void 0 ? c.toColor(f, e) : e.color || b.color)
        e.color = f
    })
  }
};
  ...
  i([].slice.call(c), function(c, f) {
    ...
    f === 0 &&
        (c.setAttribute('x', a.getAttribute('x')),
         (f = a.getAttribute('y')) !== null && c.setAttribute('y', f));
    g = c.cloneNode(1);
    ...
    A(p.scatter, m(h, {
        ...
        translate: function() {
          ...
          i(this.points, function(d) {
            var e = (b.colsize || 1) / 2, f = (b.rowsize || 1) / 2,
