  ...
  function p(c) {
    ...
    c.HCExtended || Highcharts.extend(c, {
      ...
      unbind: function(c, h) {
        var f, i;
        c ? (f = this.HCEvents[c] || [],
             h ? (i = HighchartsAdapter.inArray(h, f),
    ...
    init: function(c) {
      if (!l.defaultView)
        this._getStyle = function(b, d) {
          var a;
          return b.style[d] ? b.style[d] :
                              (d === 'opacity' && (d = 'filter'),
                               a = b.currentStyle[d.replace(
                                   /\-(\w)/g,
                                   function(b, a) {
          ...
          if (a)
            return b.style.zoom = 1,
                   b[a] -
                       2 *
                           parseInt(
                               HighchartsAdapter._getStyle(b, 'padding'), 10)
        };
      ...
      if (!Array.prototype.filter)
        this.grep = function(b, d) {
          for (var a = [], c = 0, h = b.length; c < h; c++)
            d(b[c], c) && a.push(b[c]);
          return a
        };
      o = function(b, c, a) {
      ...
      o.prototype = {
        update: function() {
          ...
          if (n[this.prop])
            ...
            b && a ? d.attr('d', c.step(b[0], b[1], this.now, this.toD)) :
                     d.attr ? a && d.attr(this.prop, this.now) :
                              (b = {}, b[this.prop] = this.now + this.unit,
                               Highcharts.css(d, b));
        ...
        step: function(b) {
          ...
          a = this.options;
          var e = this.elem, h;
          if (e.stopAnimation || e.attr && !e.element)
            a = !1;
            ...
            e = c - this.startTime, this.state = e / a.duration,
      ...
      l.createEvent && (c.dispatchEvent || c.fireEvent) ?
          (e = l.createEvent('Events'), e.initEvent(b, !0, !0), e.target = c,
...
function w() {
  var a, b = arguments, c, d = {}, e = function(a, b) {
    ...
    for (d in b)
      b.hasOwnProperty(d) &&
          (c = b[d],
           a[d] = c && typeof c === 'object' &&
                   Object.prototype.toString.call(c) !== '[object Array]' &&
                   d !== 'renderTo' && typeof c.nodeType !== 'number' ?
               e(a[d] || {}, c) :
               b[d]);
    return a
  };
...
function Ba(a, b, c, d) {
  var e = K.numberFormat, f = E.lang, g = +a || 0,
      h = b === -1 ? (g.toString().split('.')[1] || '').length :
                     isNaN(b = Q(b)) ? 2 : b,
      i = c === void 0 ? f.decimalPoint : c,
      f = d === void 0 ? f.thousandsSep : d, j = g < 0 ? '-' : '',
      k = String(y(g = Q(g).toFixed(h))), l = k.length > 3 ? k.length % 3 : 0;
  return e !== Ba ? e(a, b, c, d) :
                    j + (l ? k.substr(0, l) + f : '') +
          k.substr(l).replace(/(\d{3})(?=\d)/g, '$1' + f) +
          (h ? i + Q(g - k).toFixed(h).slice(2) : '')
}
function Ia(a, b) {
...
function Ja(a, b) {
  for (var c = '{', d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1;) {
    ...
    if (d) {
      ...
      if (f.length)
        f = f.join(':'), g = /\.([0-9])/, h = E.lang, i = void 0,
...
var u, x = document, G = window, V = Math, v = V.round, U = V.floor,
       La = V.ceil, t = V.max, L = V.min, Q = V.abs, aa = V.cos, fa = V.sin,
       oa = V.PI, Ea = oa * 2 / 360, wa = navigator.userAgent, Hb = G.opera,
       Aa = /msie/i.test(wa) && !Hb, hb = x.documentMode === 8,
       tb = /AppleWebKit/.test(wa), Ua = /Firefox/.test(wa),
       ...
       ga = !ba && !Aa && !!x.createElement('canvas').getContext, Za, $a,
       Jb = {}, ub = 0, db, E, cb, va, vb, A, ha,
       sa =
           function() {
         return u
       },
       W = [], ab = 0, Ka = 'div', P = 'none', Pb = /^[0-9]+$/,
       Qb = 'stroke-width', Da, eb, Sa, pb, qb, rb, Xa, fb, gb, Cb, Db, sb, Eb,
       Fb, H = {}, K;
G.Highcharts ? ha(16, !0) : K = G.Highcharts = {};
cb = function(a, b, c) {
  if (!s(b) || isNaN(b)) return 'Invalid date';
  var a = p(a, '%Y-%m-%d %H:%M:%S'), d = new Da(b - Sa), e, f = d[qb](),
      g = d[rb](), h = d[Xa](), i = d[fb](), j = d[gb](), k = E.lang,
      l = k.weekdays,
      d =
          r({
            a: l[g].substr(0, 3),
...
vb = {
  init: function(a, b, c) {
    var b = b || '', d = a.shift, e = b.indexOf('C') > -1, f = e ? 7 : 3, g,
        b = b.split(' '), c = [].concat(c), h, i, j = function(a) {
          for (g = a.length; g--;)
            a[g] === 'M' &&
...
G.HighchartsAdapter = G.HighchartsAdapter || a && {
  init: function(b) {
    ...
    a.each(['cur', '_default', 'width', 'height', 'opacity'], function(b, e) {
      ...
      e === 'cur' ?
          f = c.prototype :
          e === '_default' && a.Tween && (f = a.Tween.propHooks[e], e = 'set');
      (g = f[e]) && (f[e] = function(a) {
        var c, a = b ? a : this;
        if (a.prop !== 'align')
          return c = a.elem,
                 c.attr ? c.attr(a.prop, e === 'cur' ? u : a.now) :
    ...
    a.fn.highcharts = function() {
      ...
      if (this[0]) {
        ...
        c = b[0];
        if (c !== u)
          c.chart = c.chart || {}, c.chart.renderTo = this[0],
          new K[a](c, b[1]), g = this;
...
T && T.init.call(T, vb);
var ib = M.adapterRun, Rb = M.getScript, Ma = M.inArray, q = M.each,
    wb = M.grep, Sb = M.offset, Va = M.map, N = M.addEvent, X = M.removeEvent,
    I = M.fireEvent, Tb = M.washMouseEvent, jb = M.animate, bb = M.stop, M = {
      enabled: !0,
      x: 0,
      y: 15,
...
E = {
  ...
  chart: {
    ...
    resetZoomButton:
        {theme: {zIndex: 20}, position: {align: 'right', x: -10, y: 10}}
  },
  title: {
    text: 'Chart title',
    align: 'center',
...
var Ub =
    ...
    ya = function(a) {
      ...
      return {
        get: function(c) {
          var f;
          d ? (f = w(a), f.stops = [].concat(f.stops),
               q(d,
                 function(a, b) {
                   f.stops[b] = [f.stops[b][0], a.get(c)]
                 })) :
              f = b && !isNaN(b[0]) ?
              c === 'rgb' ? 'rgb(' + b[0] + ',' + b[1] + ',' + b[2] + ')' :
                            c === 'a' ? b[3] : 'rgba(' + b.join(',') + ')' :
              a;
          return f
        }, brighten: function(a) {
...
S.prototype = {
  opacity: 1,
  textProps:
      'fontSize,fontWeight,fontFamily,color,lineHeight,width,textDecoration,textShadow,HcTextStroke'
          .split(','),
  init: function(a, b) {
  ...
  colorGradient: function(a, b, c) {
    ...
    a.linearGradient ? f = 'linearGradient' :
    ...
    if (f) {
      ...
      f === 'radialGradient' && n && !s(g.gradientUnits) &&
          (g = w(g, {
      ...
      h[o] ?
          ...
          (g.id = a = 'highcharts-' + ub++,
           h[o] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [],
           q(j, function(a) {
             a[1].indexOf('rgba') === 0 ?
  ...
  updateShadows: function(a, b) {
    for (var c = this.shadows, d = c.length; d--;)
      c[d].setAttribute(
          a,
          a === 'height' ? t(b - (c[d].cutHeight || 0), 0) :
                           a === 'd' ? this.d : b)
  },
  addClass: function(a) {
  ...
  clip: function(a) {
    return this.attr(
        'clip-path', a ? 'url(' + this.renderer.url + '#' + a.id + ')' : P)
  },
  crisp: function(a) {
  ...
  add: function(a) {
    var b = this.renderer, c = a || b, d = c.element || b.box, e = this.element,
        f = this.zIndex, g, h;
  ...
  alignSetter: function(a) {
    this.element.setAttribute(
        'text-anchor', {left: 'start', center: 'middle', right: 'end'}[a])
  },
  ...
  textSetter: function(a) {
    if (a !== this.textStr)
      delete this.bBox, this.textStr = a,
...
S.prototype.translateXSetter = S.prototype.translateYSetter =
    S.prototype.rotationSetter = S.prototype.verticalAlignSetter =
        S.prototype.scaleXSetter = S.prototype.scaleYSetter = function(a, b) {
          this[b] = a;
          this.doTransform = !0
        };
...
ta.prototype = {
  ...
  init: function(a, b, c, d, e) {
    ...
    this.boxWrapper = d;
    this.alignedObjects = [];
    this.url = (Ua || tb) && x.getElementsByTagName('base').length ?
        f.href.replace(/#.*?$/, '')
            .replace(/([\('\)])/g, '\\$1')
            .replace(/ /g, '%20') :
        '';
    this.createElement('desc').add().element.appendChild(
        x.createTextNode('Created with Highcharts 4.0.4'));
  ...
  buildText: function(a) {
    for (var b = a.element, c = this, d = c.forExport,
             e = p(a.textStr, '').toString(), f = e.indexOf('<') !== -1,
             g = b.childNodes, h, i, j = F(b, 'x'), k = a.styles,
             l = a.textWidth, n = k && k.lineHeight, m = k && k.HcTextStroke,
             o = g.length,
             Y =
                 function(a) {
                   return n ?
    ...
    !f && !m && e.indexOf(' ') === -1 ?
        ...
        (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/,
         ...
         e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">')
               ...
               if (e !== ' ') {
                 ...
                 if (l)
                   for (var e = e.replace(/([^\^])-/g, '$1- ').split(' '),
                            ...
                            q, D, s = k.HcHeight, t = [], u = Y(o), Lb = 1;
                        m && (e.length || t.length);)
                     delete a.bBox, q = a.getBBox(), D = q.width,
                                    !ba && c.forExport &&
  ...
  button: function(a, b, c, d, e, f, g, h, i) {
    var j = this.label(a, b, c, i, null, null, null, null, 'button'), k = 0, l,
        n, m, o, p, q, a = {x1: 0, y1: 0, x2: 0, y2: 1},
        e =
            w({
              'stroke-width': 1,
              stroke: '#CCCCCC',
    ...
    j.setState = function(a) {
      (j.state = k = a) ?
          a === 2 ? j.attr(g).css(p) : a === 3 && j.attr(h).css(q) :
          j.attr(e).css(m)
    };
    return j
        .on('click',
  ...
  rect: function(a, b, c, d, e, f) {
    var e = da(a) ? a.r : e, g = this.createElement('rect'),
        a = da(a) ?
        a :
        a === u ? {} : {x: a, y: b, width: t(c, 0), height: t(d, 0)};
  ...
  setSize: function(a, b, c) {
    ...
    this.width = a;
    this.height = b;
    for (this.boxWrapper[p(c, !0) ? 'animate' : 'attr']({width: a, height: b});
         e--;)
      d[e].align()
  },
  g: function(a) {
  ...
  symbol: function(a, b, c, d, e, f) {
    var g, h = this.symbols[a], h = h && h(v(b), v(c), d, e, f),
           i = /^url\((.*?)\)$/, j, k;
    if (h)
      g = this.path(h), r(g, {symbolName: a, x: b, y: c, width: d, height: e}),
      f && r(g, f);
    else if (i.test(a))
      k =
          function(a, b) {
      ...
      g = this.image(j).attr({x: b, y: c}), g.isImg = !0,
      a ? k(g, a) : (g.attr({width: 0, height: 0}), $('img', {
                       onload: function() {
  ...
  symbols: {
    circle: function(a, b, c, d) {
      var e = 0.166 * c;
      return [
        'M', a + c / 2, b, 'C', a + c + e, b, a + c + e, b + d, a + c / 2,
        b + d, 'C', a - e, b + d, a - e, b, a + c / 2, b, 'Z'
      ]
    },
    ...
    diamond: function(a, b, c, d) {
      return [
        'M', a + c / 2, b, 'L', a + c, b + d / 2, a + c / 2, b + d, a,
        b + d / 2, 'Z'
      ]
    },
    arc: function(a, b, c, d, e) {
      var f = e.start, c = e.r || c || d, g = e.end - 0.001, d = e.innerR,
          h = e.open, i = aa(f), j = fa(f), k = aa(g), g = fa(g),
          e = e.end - f < oa ? 0 : 1;
      return [
        'M',       a + c * i, b + c * j, 'A',       c,           c,
        0,         e,         1,         a + c * k, b + c * g,   h ? 'M' : 'L',
        a + d * k, b + d * g, 'A',       d,         d,           0,
        e,         0,         a + d * i, b + d * j, h ? '' : 'Z'
      ]
    },
    callout: function(a, b, c, d, e) {
      var f = L(e && e.r || 0, c, d), g = f + 6, h = e && e.anchorX,
          i = e && e.anchorY, e = v(e.strokeWidth || 0) % 2 / 2;
      a += e;
      b += e;
      e = [
        'M',       a + f, b,     'L',   a + c - f, b,         'C',   a + c,
        b,         a + c, b,     a + c, b + f,     'L',       a + c, b + d - f,
        'C',       a + c, b + d, a + c, b + d,     a + c - f, b + d, 'L',
        a + f,     b + d, 'C',   a,     b + d,     a,         b + d, a,
        b + d - f, 'L',   a,     b + f, 'C',       a,         b,     a,
        b,         a + f, b
      ];
      h && h > c && i > b + g &&
              i<b + d - g ? e.splice(
                                13, 3, 'L', a + c, i - 6, a + c + 6, i, a + c,
                                i + 6, a + c, b + d - f) :
                            h && h<0 && i>b + g &&
                        i<b + d - g ? e.splice(
                                          33, 3, 'L', a, i + 6, a - 6, i, a,
                                          i - 6, a, b + f) :
                                      i && i>d &&
                        h>a +
                  g &&
              h < a + c - g ?
          e.splice(
              23, 3, 'L', h + 6, b + d, h, b + d + 6, h - 6, b + d, a + f,
              b + d) :
          i && i<0 && h>a + g && h < a + c - g &&
  ...
  label: function(a, b, c, d, e, f, g, h, i) {
    function j() {
      var a, b;
      a = o.element.style;
      D = (t === void 0 || xb === void 0 || m.styles.textAlign) && o.textStr &&
          o.getBBox();
      ...
      if (y) {
        if (!p)
          a = v(-J * C), b = h ? -R : 0,
          m.box = p = d ? n.symbol(d, a, b, m.width, m.height, z) :
    ...
    var n = this, m = n.g(i), o = n.text('', 0, 0, g).attr({zIndex: 1}), p, D,
        J = 0, C = 3, kb = 0, t, xb, yb, x, Kb = 0, z = {}, R, y;
    m.onAdd = function() {
      o.add(m);
    ...
    return r(m, {
      ...
      getBBox: function() {
        return {
          width: D.width + 2 * C, height: D.height + 2 * C, x: D.x - C,
              y: D.y - C
        }
      },
      shadow: function(a) {
...
r(S.prototype, {
  ...
  htmlUpdateTransform: function() {
    if (this.added) {
      var a = this.renderer, b = this.element, c = this.translateX || 0,
          d = this.translateY || 0, e = this.x || 0, f = this.y || 0,
          g = this.textAlign || 'left', h = {left: 0, center: 0.5, right: 1}[g],
          i = this.shadows;
      ...
      if (b.tagName === 'SPAN') {
        var j = this.rotation, k, l = y(this.textWidth),
  ...
  setSpanRotation: function(a, b, c) {
    var d = {},
        e = Aa ? '-ms-transform' :
                 tb ? '-webkit-transform' :
                      Ua ? 'MozTransform' : Hb ? '-o-transform' : '';
        ...
        if (this.parentGroup = a) {
          if (b = a.div, !b) {
            ...
            q(j.reverse(), function(a) {
              var d;
              b = a.div = a.div ||
                  $(Ka, {className: F(a.element, 'class')}, {
                            position: 'absolute',
...
if (!ba && !ga) {
  Z = {
    ...
    setSpanRotation: function() {
      ...
      B(this.element, {
        filter: a ?
            [
              'progid:DXImageTransform.Microsoft.Matrix(M11=', b, ', M12=', -c,
              ', M21=', c, ', M22=', b, ', sizingMethod=\'auto expand\')'
            ].join('') :
            P
      })
    },
    getSpanCorrection: function(a, b, c, d, e) {
      var f = d ? aa(d * Ea) : 1, g = d ? fa(d * Ea) : 0,
          h = p(this.elemHeight, this.element.offsetHeight), i;
      this.xCorr = f < 0 && -a;
      this.yCorr = g < 0 && -h;
      i = f * g < 0;
    ...
    shadow: function(a, b, c) {
      var d = [], e, f = this.element, g = this.renderer, h, i = f.style, j,
          k = f.path, l, n, m, o;
      ...
      if (a) {
        ...
        for (e = 1; e <= 3; e++) {
          ...
          j = [
            '<shape isShadow="true" strokeweight="', l,
            '" filled="false" path="', n, '" coordsize="10 10" style="',
            f.style.cssText, '" />'
          ];
          h = $(g.prepVML(j), null, {
          ...
          if (c) h.cutOff = l + 1;
          j = [
            '<stroke color="', a.color || 'black', '" opacity="', o * e, '"/>'
          ];
    ...
    visibilitySetter: function(a, b, c) {
      ...
      c.nodeName === 'DIV' &&
          (a = a === 'hidden' ? '-999em' : 0,
           hb || (c.style[b] = a ? 'visible' : 'hidden'), b = 'top');
      c.style[b] = a
    },
  ...
  var ia = {
      ...
      return r(e, {
        ...
        getCSS: function(a) {
          var b = a.element, c = b.nodeName, a = a.inverted,
              d = this.top - (c === 'shape' ? b.offsetTop : 0), e = this.left,
              b = e + this.width, f = d + this.height, d = {
                clip: 'rect(' + v(a ? e : d) + 'px,' + v(a ? f : b) + 'px,' +
                    v(a ? b : f) + 'px,' + v(a ? d : e) + 'px)'
              };
    ...
    color: function(a, b, c, d) {
      ...
      if (i) {
        var k, l, n = a.linearGradient || a.radialGradient, m, o, p, D, J,
                  C = '', a = a.stops, t, s = [], u = function() {
                    h = [
                      '<fill colors="' + s.join(',') + '" opacity="', p,
                      '" o:opacity2="', o, '" type="', i, '" ', C,
        ...
        t[0] < 1 && a.push([1, t[1]]);
        q(a, function(a, b) {
          g.test(a[1]) ? (f = ya(a[1]), k = f.get('rgb'), l = f.get('a')) :
                         (k = a[1], l = 1);
          s.push(a[0] * 100 + '% ' + k);
          b ? (p = l, D = k) : (o = l, J = k)
        });
        if (c === 'fill')
          if (i === 'gradient')
            c = n.x1 || n[0] || 0, a = n.y1 || n[1] || 0, m = n.x2 || n[2] || 0,
            n = n.y2 || n[3] || 0,
            C = 'angle="' + (90 - V.atan((n - a) / (m - c)) * 180 / oa) + '"',
            u();
          else {
            var j = n.r, r = j * 2, v = j * 2, x = n.cx, z = n.cy,
                R = b.radialReference, w, j = function() {
                  R &&
                      (w = d.getBBox(), x += (R[0] - w.x) / w.width - 0.5,
                       z += (R[1] - w.y) / w.height - 0.5, r *= R[2] / w.width,
                       v *= R[2] / w.height);
                  C = 'src="' + E.global.VMLRadialGradientURL + '" size="' + r +
                      ',' + v + '" origin="0.5,0.5" position="' + x + ',' + z +
                      '" color2="' + J + '" ';
                  u()
                };
            d.added ? j() : d.onAdd = j;
        ...
        f = ya(a), h = ['<', c, ' opacity="', f.get('a'), '"/>'],
        $(this.prepVML(h), null, null, b), j = f.get('rgb');
      else {
    ...
    symbols: {
      arc: function(a, b, c, d, e) {
        var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = aa(f),
            i = fa(f), j = aa(g), k = fa(g);
        if (g - f === 0) return ['x'];
        f = [
          'wa', a - h, b - h, a + h, b + h, a + h * d, b + h * i, a + h * j,
          b + h * k
        ];
        e.open && !c && f.push('e', 'M', a, b);
        f.push(
            'at', a - c, b - c, a + c, b + c, a + c * j, b + c * k, a + c * d,
            b + c * i, 'x', 'e');
        f.isArc = !0;
        return f
      },
      ...
      rect: function(a, b, c, d, e) {
        return ta.prototype.symbols[!s(e) || !e.r ? 'square' : 'callout'].call(
            0, a, b, c, d, e)
      }
    }
  };
...
Ta.prototype = {
  addLabel: function() {
    var a = this.axis, b = a.options, c = a.chart, d = a.horiz,
        e = a.categories, f = a.names, g = this.pos, h = b.labels,
        i = h.rotation, j = a.tickPositions,
        d = d && e && !h.step && !h.staggerLines && !h.rotation &&
            c.plotWidth / j.length ||
        !d && (c.margin[3] || c.chartWidth * 0.33),
        k = g === j[0], l = g === j[j.length - 1], n,
        f = e ? p(e[g], f[g], g) : g, e = this.label, m = j.info;
    a.isDatetimeAxis && m &&
  ...
  getLabelSides: function() {
    var a = this.label.getBBox(), b = this.axis, c = b.horiz,
        d = b.options.labels, a = c ? a.width : a.height,
        b = c ? d.x - a * {left: 0, center: 0.5, right: 1}[b.labelAlign] : 0;
    return [b, c ? a + b : a]
  },
  handleOverflow: function(a, b) {
    var c = !0, d = this.axis, e = this.isFirst, f = this.isLast,
        g = d.horiz ? b.x : b.y, h = d.reversed, i = d.tickPositions,
        j = this.getLabelSides(), k = j[0], j = j[1], l, n, m,
        o = this.label.line;
    l = o || 0;
    n = d.labelEdge;
    ...
    if (m) {
      ...
      e && !h || f && h ? g + k < l && (g = l - k, m && g + j > d && (c = !1)) :
  ...
  getPosition: function(a, b, c, d) {
    ...
    return {
      x: a ? e.translate(b + c, null, null, d) + e.transB :
             e.left + e.offset +
              (e.opposite ?
  ...
  render: function(a, b, c) {
    var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz,
        h = this.type, i = this.label, j = this.pos, k = e.labels,
        l = this.gridLine, n = h ? h + 'Grid' : 'grid',
        m = h ? h + 'Tick' : 'tick', o = e[n + 'LineWidth'],
        q = e[n + 'LineColor'], D = e[n + 'LineDashStyle'], J = e[m + 'Length'],
        n = e[m + 'Width'] || 0, C = e[m + 'Color'], t = e[m + 'Position'],
        m = this.mark, s = k.step, r = !0, v = d.tickmarkOffset,
        w = this.getPosition(g, j, v, b), x = w.x, w = w.y,
        z = g && x === d.pos + d.len || !g && w === d.pos ? -1 : 1, c = p(c, 1);
    this.isActive = !0;
    if (o) {
    ...
    if (n && J)
      t === 'inside' && (J = -J), d.opposite && (J = -J),
          h = this.getMarkPath(x, w, J, n * z, g, f),
          m ? m.animate({d: h, opacity: c}) :
              this.mark = f.path(h)
    ...
    if (i && !isNaN(x))
      ...
      this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) ||
          ...
          r = !1 :
          !d.isRadial && !k.step && !k.rotation && !b && c !== 0 &&
              (r = this.handleOverflow(a, w)),
      s && a % s && (r = !1),
      r && !isNaN(w.y) ? (w.opacity = c, i[this.isNew ? 'attr' : 'animate'](w),
                          this.isNew = !1) :
                         i.attr('y', -9999)
  },
  destroy: function() {
...
K.PlotLineOrBand.prototype = {
  render: function() {
    var a = this, b = a.axis, c = b.horiz, d = (b.pointRange || 0) / 2,
        e = a.options, f = e.label, g = a.label, h = e.width, i = e.to,
        j = e.from, k = s(j) && s(i), l = e.value, n = e.dashStyle,
        m = a.svgElem, o = [], p, q = e.color, J = e.zIndex, C = e.events,
...
na.prototype = {
  ...
  init: function(a, b) {
    ...
    this.tickmarkOffset = this.categories &&
            d.tickmarkPlacement === 'between' && p(d.tickInterval, 1) === 1 ?
        0.5 :
        0;
    this.ticks = {};
    this.labelEdge = [];
    ...
    Ma(this, a.axes) === -1 &&
        (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) :
                                  a.axes.push(this),
  ...
  setOptions: function(a) {
    this.options =
        w(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions,
          [
  ...
  defaultLabelFormatter: function() {
    var a = this.axis, b = this.value, c = a.categories,
        d = this.dateTimeLabelFormat, e = E.lang.numericSymbols,
        f = e && e.length, g, h = a.options.labels.format,
  ...
  translate: function(a, b, c, d, e, f) {
    var g = 1, h = 0, i = d ? this.oldTransA : this.transA,
        d = d ? this.oldMin : this.min, j = this.minPixelPadding,
        e = (this.options.ordinal || this.isLog && e) && this.lin2val;
    if (!i) i = this.transA;
    if (c) g *= -1, h = this.len;
    this.reversed && (g *= -1, h -= g * (this.sector || this.len));
    b ? (a = a * g + h, a -= j, a = a / i + d, e && (a = this.lin2val(a))) :
        (e && (a = this.val2lin(a)), f === 'between' && (f = 0.5),
         a = g * (a - d) * i + h + g * j +
  ...
  getMinorTickPositions: function() {
    ...
    if (this.isLog) {
      ...
      d = d.concat(this.getTimeTicks(
          this.normalizeTimeTickInterval(c), this.min, this.max,
          a.startOfWeek)),
  ...
  adjustForMinRange: function() {
    var a = this.options, b = this.min, c = this.max, d,
        e = this.dataMax - this.dataMin >= this.minRange, f, g, h, i, j;
  ...
  setAxisTranslation: function(a) {
    var b = this, c = b.max - b.min, d = b.axisPointRange || 0, e, f = 0, g = 0,
        h = b.linkedParent, i = !!b.categories, j = b.transA;
    if (b.isXAxis || i || d)
      h ? (f = h.minPointOffset, g = h.pointRangePadding) :
          q(b.series,
            function(a) {
              var h = i ? 1 : b.isXAxis ? a.pointRange : b.axisPointRange || 0,
                  j = a.options.pointPlacement, m = a.closestPointRange;
              h > c && (h = 0);
              d = t(d, h);
              f = t(f, Ga(j) ? 0 : h / 2);
              g = t(g, j === 'on' ? 0 : h);
          ...
          b.minPointOffset = f *= h, b.pointRangePadding = g *= h,
          b.pointRange = L(d, c), b.closestPointRange = e;
    if (a) b.oldTransA = j;
  ...
  setTickPositions: function(a) {
    var b = this, c = b.chart, d = b.options, e = d.startOnTick,
        f = d.endOnTick, g = b.isLog, h = b.isDatetimeAxis, i = b.isXAxis,
        j = b.isLinked, k = b.options.tickPositioner, l = d.maxPadding,
        n = d.minPadding, m = d.tickInterval, o = d.minTickInterval,
        Y = d.tickPixelInterval, D, J = b.categories;
    j ? (b.linkedParent = c[b.coll][d.linkedTo],
         c = b.linkedParent.getExtremes(), b.min = p(c.min, c.dataMin),
    ...
    if (b.range && s(b.max))
      b.userMin = b.min = t(b.min, b.max - b.range), b.userMax = b.max,
      b.range = null;
    b.beforePadding && b.beforePadding();
    b.adjustForMinRange();
    if (!J && !b.axisPointRange && !b.usePercentage && !j && s(b.min) &&
        s(b.max) && (c = b.max - b.min)) {
      if (!s(d.min) && !s(b.userMin) && n &&
          (b.dataMin < 0 || !b.ignoreMinPadding))
        b.min -= c * n;
      if (!s(d.max) && !s(b.userMax) && l &&
    ...
    b.min === b.max || b.min === void 0 || b.max === void 0 ?
        ...
        (b.tickInterval = p(m, J ? 1 : (b.max - b.min) * Y / t(b.len, Y)),
         !s(m) && b.len < Y && !this.isRadial && !this.isLog && !J && e && f &&
    ...
    if (!h && !g && !m)
      b.tickInterval =
          nb(b.tickInterval, null, mb(b.tickInterval),
             p(d.allowDecimals,
               !(b.tickInterval > 1 && b.tickInterval < 5 && b.max > 1E3 &&
                 b.max < 9999)));
    b.minorTickInterval = d.minorTickInterval === 'auto' && b.tickInterval ?
        b.tickInterval / 5 :
        d.minorTickInterval;
    b.tickPositions = a = d.tickPositions ? [].concat(d.tickPositions) :
                                            k && k.apply(b, [b.min, b.max]);
    if (!a)
      !b.ordinalPositions &&
          (b.max - b.min) / b.tickInterval > t(2 * b.len, 200) && ha(19, !0),
          a = h ? b.getTimeTicks(
                      b.normalizeTimeTickInterval(b.tickInterval, d.units),
                      b.min, b.max, d.startOfWeek, b.ordinalPositions,
                      b.closestPointRange, !0) :
                  g ? b.getLogTickPositions(b.tickInterval, b.min, b.max) :
                      b.getLinearTickPositions(b.tickInterval, b.min, b.max),
          D && a.splice(1, a.length - 2), b.tickPositions = a;
    if (!j)
      d = a[0], g = a[a.length - 1], h = b.minPointOffset || 0,
  ...
  adjustTickAmount: function() {
    ...
    if (c && c[a] && !this.isDatetimeAxis && !this.categories &&
        !this.isLinked && this.options.alignTicks !== !1 && this.min !== u) {
  ...
  setAxisSize: function() {
    var a = this.chart, b = this.options, c = b.offsetLeft || 0, d = this.horiz,
        ...
        f = p(b.height, a.plotHeight), g = p(b.top, a.plotTop),
  ...
  getExtremes: function() {
    ...
    return {
      min: a ? ea(ka(this.min)) : this.min,
          max: a ? ea(ka(this.max)) : this.max, dataMin: this.dataMin,
          dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax
    }
  },
  getThreshold: function(a) {
    var b = this.isLog, c = b ? ka(this.min) : this.min,
  ...
  getOffset: function() {
    var a = this, b = a.chart, c = b.renderer, d = a.options,
        e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side,
        i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, n, m = 0,
        o = d.title, Y = d.labels, D = 0, J = b.axisOffset, b = b.clipOffset,
        C = [-1, 1, 1, -1][h], r, v = 1, w = p(Y.maxStaggerLines, 5), x, y, A,
        z, R;
    a.hasData = j = a.hasVisibleSeries || s(a.min) && s(a.max) && !!e;
    a.showAxis = k = j || p(d.showEmpty, !0);
    a.staggerLines = a.horiz && Y.staggerLines;
    if (!a.axisGroup)
      a.gridGroup = c.g('grid').attr({zIndex: d.gridZIndex || 1}).add(),
      a.axisGroup = c.g('axis').attr({zIndex: d.zIndex || 2}).add(),
      a.labelGroup =
          c.g('axis-labels')
      ...
      if (a.horiz && !a.staggerLines && w && !Y.rotation) {
        for (j = a.reversed ? [].concat(e).reverse() : e; v < w;) {
          ...
          for (r = 0; r < j.length; r++)
            ...
            R = r % v,
            z &&
                (A = a.translate(A), x[R] !== u && A < x[R] && (y = !0),
                 x[R] = A + z);
          if (y)
            v++;
          else
    ...
    if (o && o.text && o.enabled !== !1) {
      if (!a.axisTitle)
        ...
        a.axisTitle.isNew = !0;
      if (k)
        l = a.axisTitle.getBBox()[g ? 'height' : 'width'], n = o.offset,
  ...
  getLinePath: function(a) {
    ...
    return b.renderer.crispLine(
        [
          'M', e ? this.left : f, e ? d : this.top, 'L',
          e ? b.chartWidth - this.right : f, e ? d : b.chartHeight - this.bottom
        ],
        a)
  },
  getTitlePosition: function() {
    var a = this.horiz, b = this.left, c = this.top, d = this.len,
        e = this.options.title, f = a ? b : c, g = this.opposite,
        h = this.offset, i = y(e.style.fontSize || 12),
        d = {low: f + (a ? 0 : d),
             middle: f + d / 2,
             high: f + (a ? d : 0)}[e.align],
        b = (a ? c + this.height : b) +
  ...
  render: function() {
    var a = this, b = a.horiz, c = a.reversed, d = a.chart, e = d.renderer,
        f = a.options, g = a.isLog, h = a.isLinked, i = a.tickPositions, j,
        k = a.axisTitle, l = a.ticks, n = a.minorTicks, m = a.alternateBands,
        o = f.stackLabels, p = f.alternateGridColor, D = a.tickmarkOffset,
        J = f.lineWidth, C = d.hasRendered && s(a.oldMin) && !isNaN(a.oldMin),
        r = a.hasData, t = a.showAxis, v, w = f.labels.overflow,
        x = a.justifyLabels = b && w !== !1, A;
      ...
      if (a.minorTickInterval && !a.categories &&
          ...
          i.length &&
              (j = i.slice(), (b && c || !b && !c) && j.reverse(),
               ...
               D && a.min === 0 &&
                   (l[-1] || (l[-1] = new Ta(a, -1, null, !0)),
                    l[-1].render(-1))),
          p && q(i, function(b, c) {
            if (c % 2 === 0 && b < a.max)
              m[b] || (m[b] = new K.PlotLineOrBand(a)),
                  v = b + D, A = i[c + 1] !== u ? i[c + 1] + D : a.max,
                  m[b].options = {
                    from: g ? ka(v) : v,
                    to: g ? ka(A) : A,
                    color: p
  ...
  destroy: function(a) {
    ...
    q('stackTotalGroup,axisLine,axisTitle,axisGroup,cross,gridGroup,labelGroup'
          .split(','),
      function(a) {
        b[a] && (b[a] = b[a].destroy())
      });
  ...
  drawCrosshair: function(a, b) {
    if (this.crosshair)
      if ((s(b) || !p(this.crosshair.snap, !0)) === !1)
        ...
        p(d.snap, !0) ? s(b) &&
                (c = this.chart.inverted != this.horiz ? b.plotX :
                                                         this.len - b.plotY) :
                        c = this.horiz ? a.chartX - this.pos :
...
na.prototype.getTimeTicks = function(a, b, c, d) {
  var e = [], f = {}, g = E.global.useUTC, h, i = new Da(b - Sa),
      j = a.unitRange, k = a.count;
  if (s(b)) {
    j >= A.second &&
        (i.setMilliseconds(0),
    ...
    h = i[gb]();
    for (var d = i.getTime(), l = i[fb](), n = i[Xa](),
             m = (A.day + (g ? Sa : i.getTimezoneOffset() * 6E4)) % A.day;
         d < c;)
      e.push(d),
          j === A.year ?
          d = eb(h + b * k, 0) :
          j === A.month ? d = eb(h, l + b * k) :
                          !g && (j === A.day || j === A.week) ?
...
na.prototype.normalizeTimeTickInterval = function(a, b) {
  var c = b ||
      [
        ...
        ['second', [1, 2, 5, 10, 15, 30]], ['minute', [1, 2, 5, 10, 15, 30]],
        ['hour', [1, 2, 3, 4, 6, 8, 12]], ['day', [1, 2]], ['week', [1, 2]],
        ['month', [1, 2, 3, 4, 6]], ['year', null]
      ],
      d = c[c.length - 1], e = A[d[0]], f = d[1], g;
  for (g = 0; g < c.length; g++)
    if (d = c[g], e = A[d[0]], f = d[1],
...
na.prototype.getLogTickPositions = function(a, b, c, d) {
  ...
  if (a >= 0.5)
    ...
    for (var f = U(b), h, i, j, k, l,
             e = a > 0.3 ?
             [1, 2, 4] :
             a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9];
         f < c + 1 && !l; f++) {
      i = e.length;
      for (h = 0; h < i && !l; h++)
        j = za(ka(f) * e[h]), j > b && (!d || k <= c) && k !== u && g.push(k),
        k > c && (l = !0), k = j
    }
  else if (
      b = ka(b), c = ka(c), a = e[d ? 'minorTickInterval' : 'tickInterval'],
      a =
          p(a === 'auto' ? null : a, this._minorAutoInterval,
            (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) /
                ((d ? f / this.tickPositions.length : f) || 1)),
      a = nb(a, null, mb(a)), g = Va(this.getLinearTickPositions(a, b, c), za),
      !d)
...
Nb.prototype = {
  init: function(a, b) {
    ...
    this.label = a.renderer
                     .label(
                         '', 0, 0, b.shape || 'callout', null, null, b.useHTML,
                         null, 'tooltip')
                     .attr({
                       padding: e,
  ...
  getAnchor: function(a, b) {
    var c, d = this.chart, e = d.inverted, f = d.plotTop, g = 0, h = 0, i,
           a = ra(a);
    c = a[0].tooltipPos;
    ...
    c ||
        (q(a,
         ...
         g /= a.length, h /= a.length, c = [
           e ? d.plotWidth - h : g,
           this.shared && !e && a.length > 1 && b ? b.chartY - f :
                                                    e ? d.plotHeight - g : h
         ]);
    return Va(c, v)
  },
  getPosition: function(a, b, c) {
    var d = this.chart, e = this.distance, f = {}, g,
  ...
  refresh: function(a, b) {
    ...
    l && (!a.series || !a.series.noSharedTooltip) ?
        (c.hoverPoints = a,
         ...
         h = {x: a[0].category, y: a[0].y}, h.points = j, this.len = j.length,
         a = a[0]) :
        h = a.getLabelConfig();
    i = i.call(h, this);
    h = a.series;
    ...
    i === !1 ?
        ...
        (this.isHidden && (bb(d), d.attr('opacity', 1).show()),
         ...
         d.attr({stroke: k}),
         this.updatePosition(
             {plotX: f, plotY: g, negative: a.negative, ttBelow: a.ttBelow}),
         this.isHidden = !1);
    I(c, 'tooltipRefresh',
  ...
  tooltipHeaderFormatter: function(a) {
    var b = a.series, c = b.tooltipOptions, d = c.dateTimeLabelFormats,
        e = c.xDateFormat, f = b.xAxis,
        g = f && f.options.type === 'datetime' && ja(a.key), c = c.headerFormat,
        f = f && f.closestPointRange, h;
    if (g && !e) {
      if (f)
        for (h in A) {
...
Wa.prototype = {
  ...
  normalize: function(a, b) {
    ...
    d.pageX === u ? (c = t(a.x, a.clientX - b.left), d = a.y) :
  ...
  getIndex: function(a) {
    var b = this.chart;
    return b.inverted ? b.plotHeight + b.plotTop - a.chartY :
                        a.chartX - b.plotLeft
  },
  runPointActions: function(a) {
    var b = this.chart, c = b.series, d = b.tooltip, e, f, g = b.hoverPoint,
        h = b.hoverSeries, i, j, k = b.chartWidth, l = this.getIndex(a);
    if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
      f = [];
      i = c.length;
      for (j = 0; j < i; j++)
        if (c[j].visible && c[j].options.enableMouseTracking !== !1 &&
            !c[j].noSharedTooltip && c[j].singularTooltips !== !0 &&
            c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) &&
            e.series)
  ...
  drag: function(a) {
    var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY,
        f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop,
        j = b.plotWidth, k = b.plotHeight, l, n = this.mouseDownX,
        m = this.mouseDownY, o = c.panKey && a[c.panKey + 'Key'];
    d<h ? d = h : d>h + j && (d = h + j);
    e<i ? e = i : e>i + k && (e = i + k);
    this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(m - e, 2));
    if (this.hasDragged > 10) {
      l = b.isInsidePlot(n - h, m - i);
      if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !o &&
          !this.selectionMarker)
        this.selectionMarker =
            b.renderer.rect(h, i, f ? 1 : j, g ? 1 : k, 0)
                .attr({
                  fill: c.selectionMarkerFill || 'rgba(69,114,167,0.25)',
                  zIndex: 7
                })
                .add();
      this.selectionMarker && f &&
          (d -= n,
  ...
  drop: function(a) {
    ...
    if (this.selectionMarker) {
      var d = {xAxis: [], yAxis: [], originalEvent: a.originalEvent || a},
          e = this.selectionMarker, f = e.attr ? e.attr('x') : e.x,
          g = e.attr ? e.attr('y') : e.y,
          h = e.attr ? e.attr('width') : e.width,
          i = e.attr ? e.attr('height') : e.height, j;
      if (this.hasDragged || c)
        q(b.axes, function(b) {
          if (b.zoomEnabled) {
            var c = b.horiz, e = a.type === 'touchend' ? b.minPixelPadding : 0,
                m = b.toValue((c ? f : g) + e),
                c = b.toValue((c ? f + h : g + i) - e);
            !isNaN(m) && !isNaN(c) &&
                (d[b.coll].push({axis: b, min: L(m, c), max: t(m, c)}), j = !0)
          }
  ...
  onDocumentMouseMove: function(a) {
    ...
    c && d && !this.inClass(a.target, 'highcharts-tracker') &&
  ...
  onTrackerMouseOut: function(a) {
    ...
    if (b && !b.options.stickyTracking &&
        !this.inClass(a, 'highcharts-tooltip') && c !== b)
      b.onMouseOut()
  },
...
r(K.Pointer.prototype, {
  ...
  pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
    var i = this.chart, j = a ? 'x' : 'y', k = a ? 'X' : 'Y', l = 'chart' + k,
        n = a ? 'width' : 'height', m = i['plot' + (a ? 'Left' : 'Top')], o, p,
        q = h || 1, r = i.inverted, C = i.bounds[a ? 'h' : 'v'],
        t = b.length === 1, s = b[0][l], v = c[0][l], u = !t && b[1][l],
        w = !t && c[1][l], x, c = function() {
    ...
    x ? (v -= 0.8 * (v - g[j][0]), t || (w -= 0.8 * (w - g[j][1])), c()) :
        g[j] = [v, w];
    r || (f[j] = p - m, f[n] = o);
    f = r ? 1 / q : q;
    e[n] = o;
  ...
  pinch: function(a) {
    var b = this, c = b.chart, d = b.pinchDown, e = b.followTouchMove,
        f = a.touches, g = f.length, h = b.lastValidTouch, i = b.hasZoom,
        j = b.selectionMarker, k = {},
        l = g === 1 &&
    ...
    if (a.type === 'touchstart')
      q(f,
        function(a, b) {
          ...
          h.y = [d[0].chartY, d[1] && d[1].chartY], q(c.axes, function(a) {
            if (a.zoomEnabled) {
              var b = c.bounds[a.horiz ? 'h' : 'v'], d = a.minPixelPadding,
                  e = a.toPixels(p(a.options.min, a.dataMin)),
                  f = a.toPixels(p(a.options.max, a.dataMax)), g = L(e, f),
                  e = t(e, f);
              b.min = L(a.pos, g - d);
...
if (G.PointerEvent || G.MSPointerEvent) {
  var ua = {}, zb = !!G.PointerEvent, Xb = function() {
    ...
    for (a in ua)
      ua.hasOwnProperty(a) &&
          b.push(
              {pageX: ua[a].pageX, pageY: ua[a].pageY, target: ua[a].target});
    return b
  }, Ab = function(a, b, c, d) {
    a = a.originalEvent || a;
  ...
  r(Wa.prototype, {
    ...
    batchMSEvents: function(a) {
      ...
      a(this.chart.container, zb ? 'pointermove' : 'MSPointerMove',
...
lb.prototype = {
  init: function(a, b) {
    var c = this, d = b.itemStyle, e = p(b.padding, 8),
        f = b.itemMarginTop || 0;
    this.options = b;
    if (b.enabled)
      c.itemStyle = d, c.itemHiddenStyle = w(d, b.itemHiddenStyle),
      c.itemMarginTop = f, c.padding = e, c.initialItemX = e,
      c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0,
      c.lastLineHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [],
  ...
  colorizeItem: function(a, b) {
    var c = this.options, d = a.legendItem, e = a.legendLine,
        f = a.legendSymbol, g = this.itemHiddenStyle.color,
    ...
    if (b.text) {
      if (!this.title)
        this.title = this.chart.renderer
                         .label(
                             b.text, a - 3, a - 4, null, null, null, null, null,
                             'legend-title')
                         .attr({zIndex: 1})
                         .css(b.style)
                         .add(this.group);
  ...
  renderItem: function(a) {
    var b = this.chart, c = b.renderer, d = this.options,
        e = d.layout === 'horizontal', f = this.symbolWidth,
        g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle,
        j = this.padding, k = e ? p(d.itemDistance, 20) : 0, l = !d.rtl,
        n = d.width, m = d.itemMarginBottom || 0, o = this.itemMarginTop,
        q = this.initialItemX, r = a.legendItem,
        s = a.series && a.series.drawLegendSymbol ? a.series : a, C = s.options,
        C = this.createCheckboxForItem && C && C.showCheckbox, u = d.useHTML;
    if (!r) {
      a.legendGroup =
    ...
    if (e && this.itemX - q + f > (n || b.chartWidth - 2 * j - q - d.x))
      this.itemX = q, this.itemY += o + this.lastLineHeight + m,
  ...
  render: function() {
    var a = this, b = a.chart, c = b.renderer, d = a.group, e, f, g, h,
        i = a.box, j = a.options, k = a.padding, l = j.borderWidth,
        n = j.backgroundColor;
  ...
  handleOverflow: function(a) {
    var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y,
        f = c.spacingBox.height + (e.verticalAlign === 'top' ? -f : f) -
        this.padding,
        g = e.maxHeight, h, i = this.clipRect, j = e.navigation,
        k = p(j.animation, !0), l = j.arrowSize || 12, n = this.nav,
        m = this.pages, o, r = this.allItems;
    ...
    if (a > f && !e.useHTML) {
      ...
      if (!n)
        ...
        this.up = d.symbol('triangle', 0, 0, l, l)
                      .on('click',
                          function() {
                            b.scroll(-1, k)
                          })
        ...
        this.down = d.symbol('triangle-down', 0, 0, l, l)
                        .on('click',
                            function() {
                              b.scroll(1, k)
                            })
      ...
      i.attr({height: c.chartHeight}), n.hide(),
          this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0;
    return a
  },
  scroll: function(a, b) {
    var c = this.pages, d = c.length, e = this.currentPage + a,
        f = this.clipHeight, g = this.options.navigation, h = g.activeColor,
        g = g.inactiveColor, i = this.pager, j = this.padding;
    e > d && (e = d);
    if (e > 0)
      b !== u && Ra(b, this.chart), this.nav.attr({
        ...
        visibility: 'visible'
          ...
          this.scrollGroup.animate({translateY: c}), this.currentPage = e,
...
M = K.LegendSymbolMixin = {
  drawRectangle: function(a, b) {
    ...
    b.legendSymbol = this.chart.renderer
                         .rect(
                             0, a.baseline - 5 - c / 2, a.symbolWidth, c,
  ...
  drawLineMarker: function(a) {
    ...
    var e = this.chart.renderer, f = this.legendGroup,
        a = a.baseline -
        v(e.fontMetrics(a.options.itemStyle.fontSize, this.legendItem).b * 0.3),
        g;
    if (b.lineWidth) {
...
Ya.prototype = {
  ...
  redraw: function(a) {
    var b = this.axes, c = this.series, d = this.pointer, e = this.legend,
        f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries,
        j = this.isDirtyBox, k = c.length, l = k, n = this.renderer,
        m = n.isHidden(), o = [];
    Ra(a, this);
  ...
  layOutTitles: function(a) {
    ...
    if (c &&
        (c.css({width: (f.width || h) + 'px'})
             .align(
                 r({y: g.fontMetrics(f.style.fontSize, c).b - 3}, f), !1,
                 'spacingBox'),
  ...
  getChartSize: function() {
    ...
    this.chartHeight =
        t(0, p(a, this.containerHeight > 19 ? this.containerHeight : 400))
  },
  cloneRenderTo: function(a) {
    var b = this.renderToClone, c = this.container;
    a ? b && (this.renderTo.appendChild(c), Qa(b), delete this.renderToClone) :
  ...
  getMargins: function() {
    var a = this.spacing, b, c = this.legend, d = this.margin,
        e = this.options.legend, f = p(e.margin, 20), g = e.x, h = e.y,
        i = e.align, j = e.verticalAlign, k = this.titleOffset;
    this.resetMargins();
    b = this.axisOffset;
    if (k && !s(d[0]))
  ...
  reflow: function(a) {
    var b = this, c = b.options.chart, d = b.renderTo,
        e = c.width || ib(d, 'width'), f = c.height || ib(d, 'height'),
        c = a ? a.target : G, d = function() {
  ...
  setChartSize: function(a) {
    var b = this.inverted, c = this.renderer, d = this.chartWidth,
        e = this.chartHeight, f = this.options.chart, g = this.spacing,
  ...
  drawChartBox: function() {
    var a = this.options.chart, b = this.renderer, c = this.chartWidth,
        ...
        j = a.backgroundColor, k = a.plotBackgroundColor,
        l = a.plotBackgroundImage, n = a.plotBorderWidth || 0, m,
        o = this.plotLeft, p = this.plotTop, q = this.plotWidth,
        r = this.plotHeight, t = this.plotBox, s = this.clipRect,
        v = this.clipBox;
    m = i + (a.shadow ? 8 : 0);
    if (i || j)
      if (e)
        ...
        this.chartBackground =
            b.rect(m / 2, m / 2, c - m, d - m, a.borderRadius, i)
                .attr(e)
    ...
    if (k)
      f ? f.animate(t) :
          this.plotBackground =
              b.rect(o, p, q, r, 0).attr({fill: k}).add().shadow(a.plotShadow);
    if (l) h ? h.animate(t) : this.plotBGImage = b.image(l, o, p, q, r).add();
    s ? s.animate({width: v.width, height: v.height}) :
  ...
  renderLabels: function() {
    ...
    b.items && q(b.items, function(c) {
      var d = r(b.style, c.style), e = y(d.left) + a.plotLeft,
  ...
  destroy: function() {
    var a = this, b = a.axes, c = a.series, d = a.container, e,
        f = d && d.parentNode;
    I(a, 'destroy');
    W[a.index] = u;
    ab--;
    ...
    q('title,subtitle,chartBackground,plotBackground,plotBGImage,plotBorder,seriesGroup,clipRect,credits,pointer,scroller,rangeSelector,legend,resetZoomButton,tooltip,renderer'
          .split(','),
      function(b) {
        var c = a[b];
  ...
  splashArray: function(a, b) {
    ...
    return [
      p(b[a + 'Top'], c[0]), p(b[a + 'Right'], c[1]), p(b[a + 'Bottom'], c[2]),
      p(b[a + 'Left'], c[3])
    ]
  }
};
...
Z = K.CenteredSeriesMixin = {
  getCenter: function() {
    var a = this.options, b = this.chart, c = 2 * (a.slicedOffset || 0), d,
        e = b.plotWidth - 2 * c, f = b.plotHeight - 2 * c, b = a.center,
        a =
            [
              p(b[0], '50%'), p(b[1], '50%'), a.size || '100%', a.innerSize || 0
            ],
        g = L(e, f), h;
...
Fa.prototype = {
  ...
  optionsToObject: function(a) {
    var b = {}, c = this.series, d = c.pointArrayMap || ['y'], e = d.length,
        f = 0, g = 0;
  ...
  getLabelConfig: function() {
    return {
      x: this.category, y: this.y, key: this.name || this.category,
...
O.prototype = {
  ...
  getSegments: function() {
    ...
    if (e)
      if (this.options.connectNulls) {
        ...
        q(d, function(c, g) {
          c.y === null ? (g > a + 1 && b.push(d.slice(a + 1, g)), a = g) :
  ...
  setOptions: function(a) {
    ...
    c = w(e, c.series, a);
    this.tooltipOptions =
        w(E.tooltip, E.plotOptions[this.type].tooltip, b.tooltip,
          d.series && d.series.tooltip, d[this.type] && d[this.type].tooltip,
          a.tooltip);
  ...
  getColor: function() {
    this.options.colorByPoint ||
        this.getCyclic(
            'color', this.options.color || ca[this.type].color,
  ...
  setData: function(a, b, c, d) {
    var e = this, f = e.points, g = f && f.length || 0, h, i = e.options,
        j = e.chart, k = null, l = e.xAxis, n = l && !!l.categories,
        m = e.tooltipPoints, o = i.turboThreshold, r = this.xData,
        t = this.yData, s = (h = e.pointArrayMap) && h.length, a = a || [];
    h = a.length;
    b = p(b, !0);
        ...
        for (c = 0; c < h; c++)
          if (a[c] !== u &&
              (i = {series: e},
               ...
               e.updateParallelArrays(i, c), n && i.name))
            l.names[i.x] = i.name;
      Ga(t[0]) && ha(14, !0);
      e.data = [];
      e.options.data = a;
  ...
  processData: function(a) {
    ...
    if (l && this.sorted && (!i || d > i || this.forceCrop))
      if (b[d - 1] < m || b[0] > n)
        ...
        e = this.cropData(this.xData, this.yData, m, n), b = e.xData,
        c = e.yData, e = e.start, f = !0, k = b.length;
    for (i = b.length - 1; i >= 0; i--)
      d = b[i] - b[i - 1], !f && b[i] > m && b[i] < n && k++,
      d > 0 && (g === u || d < g) ? g = d :
  ...
  generatePoints: function() {
    var a = this.options.data, b = this.data, c, d = this.processedXData,
        e = this.processedYData, f = this.pointClass, g = d.length,
        h = this.cropStart || 0, i, j = this.hasGroupedData, k, l = [], n;
    if (!b && !j) b = [], b.length = a.length, b = this.data = b;
    for (n = 0; n < g; n++)
      i = h + n,
      j ? l[n] = (new f).init(this, [d[n]].concat(ra(e[n]))) :
          (b[i] ? k = b[i] :
  ...
  getExtremes: function(a) {
    ...
    var g = d.min, h = d.max, i, j, k, l,
        a = a || this.stackedYData || this.processedYData;
    d = a.length;
    for (l = 0; l < d; l++)
      if (j = c[l], k = a[l],
          i = k !== null && k !== u && (!b.isLog || k.length || k > 0),
          j = this.getExtremesFromAll || this.cropped ||
              (c[l + 1] || j) >= g && (c[l - 1] || j) <= h,
          i && j)
        if (i = k.length)
  ...
  translate: function() {
    ...
    for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories,
             e = this.yAxis, f = this.points, g = f.length,
             h = !!this.modifyValue, i = a.pointPlacement,
             j = i === 'between' || ja(i), k = a.threshold, a = 0;
         a < g; a++) {
      var l = f[a], n = l.x, m = l.y, o = l.low,
          q = b &&
          e.stacks[(this.negStacks && m < k ? '-' : '') + this.stackKey];
      if (e.isLog && m <= 0) l.y = m = null, ha(10);
      l.plotX = c.translate(n, 0, 0, 0, 1, i, this.type === 'flags');
      if (b && this.visible && q && q[n])
        q = q[n], m = q.points[this.index + ',' + a], o = m[0], m = m[1],
        o === 0 && (o = p(k, e.min)), e.isLog && o <= 0 && (o = null),
        l.total = l.stackTotal = q.total,
        l.percentage = q.total && l.y / q.total * 100, l.stackY = m,
        q.setOffset(this.pointXOffset || 0, this.barW || 0);
      l.yBottom = s(o) ? e.translate(o, 0, 1, 0, 1) : null;
      h && (m = this.modifyValue(m, l));
      l.plotY = typeof m === 'number' && m !== Infinity ?
    ...
    a ? (a = b[g], d = b[g + 'm'],
         a ||
             (b[g] = a = c.clipRect(r(e, {width: 0})),
              b[g + 'm'] = d = c.clipRect(
                  -99, f ? -b.plotLeft : -b.plotTop, 99,
                  f ? b.chartWidth : b.chartHeight)),
         this.group.clip(a), this.markerGroup.clip(d), this.sharedClipKey = g) :
  ...
  drawPoints: function() {
    var a, b = this.points, c = this.chart, d, e, f, g, h, i, j, k,
           l = this.options.marker, n = this.pointAttr[''], m, o, q,
           t = this.markerGroup,
           s =
               p(l.enabled,
                 !this.requireSorting ||
    ...
    if (l.enabled !== !1 || this._hasPointMarkers)
      for (f = b.length; f--;)
        if (g = b[f], d = U(g.plotX), e = g.plotY, k = g.graphic,
            m = g.marker || {}, o = !!g.marker,
            a = s && m.enabled === u || m.enabled,
            q = c.isInsidePlot(v(d), e, c.inverted),
            a && e !== u && !isNaN(e) && g.y !== null)
          if (a = g.pointAttr[g.selected ? 'select' : ''] || n, h = a.r,
              i = p(m.symbol, this.symbol), j = i.indexOf('url') === 0, k)
            ...
            if (q && (h > 0 || j))
              g.graphic =
                  c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, o ? m : l)
                      .attr(a)
                      .add(t)
          }
        else if (k)
  ...
  getAttribs: function() {
    var a = this, b = a.options, c = ca[a.type].marker ? b.marker : b,
        d = c.states, e = d.hover, f, g = a.color;
    f = {stroke: g, fill: g};
    ...
    b.marker ?
        ...
        e.color = e.color || ya(e.color || g).brighten(e.brightness).get();
  ...
  destroy: function() {
    var a = this, b = a.chart, c = /AppleWebKit\/533/.test(wa), d, e,
        f = a.data || [], g, h, i;
    I(a, 'destroy');
    X(a);
    ...
    q('area,graph,dataLabelsGroup,group,markerGroup,tracker,graphNeg,areaNeg,posClip,negClip'
          .split(','),
      function(b) {
  ...
  drawGraph: function() {
    var a = this, b = this.options, c = [['graph', b.lineColor || this.color]],
        d = b.lineWidth, e = b.dashStyle, f = b.linecap !== 'square',
        g = this.getGraphPath(), h = b.negativeColor;
    h && c.push(['graphNeg', h]);
    q(c, function(c, h) {
      var k = c[0], l = a[k];
      if (l)
        ...
        a[k] =
            a.chart.renderer.path(g).attr(l).add(a.group).shadow(!h && b.shadow)
    })
  },
  clipNeg: function() {
    var a = this.options, b = this.chart, c = b.renderer,
        d = a.negativeColor || a.negativeFillColor, e, f = this.graph,
        g = this.area, h = this.posClip, i = this.negClip;
    e = b.chartWidth;
    ...
    if (d && (f || g)) {
      ...
      h ? (h.animate(b), i.animate(e)) :
          (this.posClip = h = c.clipRect(b), this.negClip = i = c.clipRect(e),
  ...
  plotGroup: function(a, b, c, d, e) {
    var f = this[a], g = !f;
    g &&
        (this[a] = f = this.chart.renderer.g(b)
  ...
  render: function() {
    var a = this, b = a.chart, c, d = a.options,
        e = (c = d.animation) && !!a.animate && b.renderer.isSVG &&
            p(c.duration, 500) ||
        0,
        f = a.visible ? 'visible' : 'hidden', g = d.zIndex, h = a.hasRendered,
        i = b.seriesGroup;
...
Gb.prototype = {
  ...
  setOffset: function(a, b) {
    var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative,
        ...
        c = c.translate(0), c = Q(g - c), h = d.xAxis[0].translate(this.x) + a,
        i = d.plotHeight, f = {
          x: e ? f ? g : g - c : h,
    ...
    if (e = this.label)
      e.align(this.alignOptions, null, f),
          f = e.alignAttr,
          e[this.options.crop === !1 || d.isInsidePlot(f.x, f.y) ? 'show' :
                                                                   'hide'](!0)
  }
};
...
na.prototype.renderStackTotals = function() {
  var a = this.chart, b = a.renderer, c = this.stacks, d, e,
...
O.prototype.setStackedPoints = function() {
  if (this.options.stacking &&
    ...
    var a = this.processedXData, b = this.processedYData, c = [], d = b.length,
        e = this.options, f = e.threshold, g = e.stack, e = e.stacking,
        h = this.stackKey, i = '-' + h, j = this.negStacks, k = this.yAxis,
        l = k.stacks, n = k.oldStacks, m, o, p, q, r, s;
    for (q = 0; q < d; q++) {
      r = a[q];
      s = b[q];
      p = this.index + ',' + q;
      ...
      l[o] || (l[o] = {});
      if (!l[o][r])
        n[o] && n[o][r] ? (l[o][r] = n[o][r], l[o][r].total = null) :
  ...
  q([b, '-' + b], function(b) {
    ...
    for (var f = d.length, g, h; f--;)
      if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index + ',' + f],
          g = e)
        h = h.total ? 100 / h.total : 0, g[0] = ea(g[0] * h),
        g[1] = ea(g[1] * h), a.stackedYData[f] = g[1]
  })
};
r(Ya.prototype, {
  ...
  showLoading: function(a) {
    var b = this, c = b.options, d = b.loadingDiv, e = c.loading,
        f = function() {
          d && B(d, {
            left: b.plotLeft + 'px',
            top: b.plotTop + 'px',
    ...
    if (!d)
      b.loadingDiv = d =
          $(Ka, {className: 'highcharts-loading'},
            r(e.style, {zIndex: 10, display: P}), b.container),
      b.loadingSpan = $('span', null, e.labelStyle, d), N(b, 'redraw', f);
    b.loadingSpan.innerHTML = a || c.lang.loading;
    if (!b.loadingShown)
      B(d, {opacity: 0, display: ''}),
          jb(d, {opacity: e.style.opacity}, {duration: e.showDuration || 0}),
          b.loadingShown = !0;
    f()
  },
...
r(O.prototype, {
  addPoint: function(a, b, c, d) {
    var e = this.options, f = this.data, g = this.graph, h = this.area,
        i = this.chart, j = this.xAxis && this.xAxis.names,
        k = g && g.shift || 0, l = e.data, n, m = this.xData;
    Ra(d, i);
  ...
  update: function(a, b) {
    var c = this, d = this.chart, e = this.userOptions, f = this.type,
        g = H[f].prototype, h = ['group', 'markerGroup', 'dataLabelsGroup'], i;
    q(h, function(a) {
      h[a] = c[a];
      delete c[a]
    });
    a =
        w(e, {animation: !1, index: this.index, pointStart: this.xData[0]},
...
var qa = ma(O, {
  type: 'area',
  getSegments: function() {
    var a = this, b = [], c = [], d = [], e = this.xAxis, f = this.yAxis,
        g = f.stacks[this.stackKey], h = {}, i, j, k = this.points,
        l = this.options.connectNulls, n, m;
  ...
  getSegmentPath: function(a) {
    var b = O.prototype.getSegmentPath.call(this, a), c = [].concat(b), d,
        e = this.options;
    d = b.length;
  ...
  drawGraph: function() {
    ...
    var a = this, b = this.areaPath, c = this.options, d = c.negativeColor,
        e = c.negativeFillColor, f = [['area', this.color, c.fillColor]];
...
ia = ma(O, {
  ...
  getPointSpline: function(a, b, c) {
    ...
    if (f && g) {
      ...
      i += l;
      k += l;
      i > a && i > e ? (i = t(a, e), k = 2 * e - i) :
                       i < a && i < e && (i = L(a, e), k = 2 * e - i);
      k > g && k > e ? (k = t(g, e), i = 2 * e - k) :
    ...
    c ? (b =
             [
               'C', f.rightContX || f.plotX, f.rightContY || f.plotY, h || d,
               i || e, d, e
             ],
...
ia = ma(O, {
  ...
  getColumnMetrics: function() {
    var a = this, b = a.options, c = a.xAxis, d = a.yAxis, e = c.reversed, f,
        g = {}, h, i = 0;
    b.grouping === !1 ? i = 1 : q(a.chart.series, function(b) {
      var c = b.options, e = b.yAxis;
      if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos)
        c.stacking ? (f = b.stackKey, g[f] === u && (g[f] = i++), h = g[f]) :
                     c.grouping !== !1 && (h = i++),
            b.columnIndex = h
    });
    var c =
            L(Q(c.transA) *
                  (c.ordinalSlope || b.pointRange || c.closestPointRange ||
                   c.tickInterval || 1),
              c.len),
    ...
    return a.columnMetrics = {
      width: l,
      offset: b +
          (j + ((e ? i - (a.columnIndex || 0) : a.columnIndex) || 0) * k -
           c / 2) *
              (e ? -1 : 1)
    }
  },
  translate: function() {
    var a = this, b = a.chart, c = a.options,
        ...
        e = a.yAxis, f = a.translatedThreshold = e.getThreshold(c.threshold),
        g = p(c.minPointLength, 5), h = a.getColumnMetrics(), i = h.width,
        j = a.barW = t(i, 1 + 2 * d), k = a.pointXOffset = h.offset,
        l = -(d % 2 ? 0.5 : 0), n = d % 2 ? 0.5 : 1;
    ...
    q(a.points, function(c) {
      ...
      c.barX = q;
      c.pointWidth = i;
      c.tooltipPos = b.inverted ? [e.len - h, a.xAxis.len - q - r / 2] :
  ...
  drawPoints: function() {
    ...
    q(a.points, function(h) {
      ...
      if (i !== u && !isNaN(i) && h.y !== null)
        ...
        j ? (bb(j), j.attr(i)[b.pointCount < e ? 'animate' : 'attr'](w(f))) :
            h.graphic = d[h.shapeType](f).attr(g).attr(i).add(a.group).shadow(
                c.shadow, null, c.stacking && !c.borderRadius);
      else if (j)
        h.graphic = j.destroy()
    })
  },
  animate: function(a) {
    ...
    if (ba)
      a ? (e.scaleY = 0.001,
           ...
           this.group.attr(e)) :
          (e.scaleY = 1, e[d ? 'translateX' : 'translateY'] = b.pos,
           this.group.animate(e, this.options.animation), this.animate = null)
  },
  remove: function() {
    var a = this, b = a.chart;
    b.hasRendered && q(b.series, function(b) {
...
T = {
    ...
    haloPath: function(a) {
      ...
      return this.sliced || !this.visible ?
          ...
          this.series.chart.renderer.symbols.arc(
              c.plotLeft + b.x, c.plotTop + b.y, b.r + a, b.r + a,
      ...
      q(c, function(a) {
        ...
        c &&
            (c.attr({r: b.center[3] / 2, start: d, end: d}),
             c.animate(
                 {r: a.r, start: a.start, end: a.end}, b.options.animation))
      }), b.animate = null
  },
  setData: function(a, b, c, d) {
  ...
  translate: function(a) {
    this.generatePoints();
    var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f,
        g, h, i = c.startAngle || 0,
        j = this.startAngleRad = oa / 180 * (i - 90),
        i = (this.endAngleRad = oa / 180 * (p(c.endAngle, i + 360) - 90)) - j,
        k = this.points, l = c.dataLabels.distance, c = c.ignoreHiddenPoint, n,
        m = k.length, o;
    ...
    for (n = 0; n < m; n++) {
      ...
      e = L(e, l / 2);
      o.labelPos = [
        a[0] + f + aa(h) * l, a[1] + g + fa(h) * l, a[0] + f + aa(h) * e,
        a[1] + g + fa(h) * e, a[0] + f, a[1] + g,
        l < 0 ? 'center' : o.half ? 'right' : 'left', h
      ]
    }
  },
  drawGraph: null,
...
O.prototype.drawDataLabels = function() {
  var a = this, b = a.options, c = b.cursor, d = b.dataLabels, e = a.points, f,
      g, h = a.hasRendered || 0, i, j;
  if (d.enabled || a._hasPointLabels)
    a.dlProcessOptions && a.dlProcessOptions(d),
        j = a.plotGroup(
            'dataLabelsGroup', 'data-labels', d.defer ? 'hidden' : 'visible',
            d.zIndex || 6),
        p(d.defer, !0) &&
        (j.attr({opacity: +h}),
         h ||
        ...
        g = d, q(e, function(b) {
          ...
          if (h && !e)
            ...
            if (h)
              ...
              h = b.dataLabel = a.chart
                                    .renderer[e ? 'text' : 'label'](
                                        i, 0, -999, null, null, null, d.useHTML)
                                    .attr(h)
...
O.prototype.alignDataLabel = function(a, b, c, d, e) {
  ...
  if (a = this.visible &&
          (a.series.forceDL || f.isInsidePlot(h, v(i), g) ||
...
if (H.pie)
  H.pie.prototype.drawDataLabels =
    ...
    var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels,
        f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1),
        h = d.plotWidth, i = d.plotHeight, j, k, l = p(e.softConnector, !0),
        n = e.distance, m = a.center, o = m[2] / 2, r = m[1], s = n > 0, u, w,
        x, A = [[], []], y, B, I, H, z, R = [0, 0, 0, 0], N = function(a, b) {
          return b.y - a.y
        };
        ...
        this.placeDataLabels(),
            s && g && q(this.points, function(b) {
              ...
              if ((u = b.dataLabel) && u._pos)
                I = u._attr.visibility, y = u.connX, B = u.connY,
                k = l ?
                    [
                      'M', y + (x[6] === 'left' ? 5 : -5), B, 'C', y, B,
                      2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], 'L', x[4],
                      x[5]
                    ] :
                    [
                      'M', y + (x[6] === 'left' ? 5 : -5), B, 'L', x[2], x[3],
                      'L', x[4], x[5]
                    ],
                j ? (j.animate({d: k}), j.attr('visibility', I)) :
                    b.connector = j =
                        a.chart.renderer.path(k)
                            .attr({
                              'stroke-width': g,
  ...
  H.pie.prototype.placeDataLabels =
      function() {
  ...
  H.pie.prototype.verifyDataLabelOverflow = function(a) {
    var b = this.center, c = this.options, d = c.center,
        e = c = c.minSize || 80, f;
    d[0] !== null ? e = t(b[2] - t(a[1], a[3]), c) :
  ...
  H.column.prototype.alignDataLabel = function(a, b, c, d, e) {
    ...
    if (h &&
        (d = w(h), g && (d = {
         ...
         !j))
      g ? (d.x += i ? 0 : d.width, d.width = 0) :
          (d.y += i ? d.height : 0, d.height = 0);
    c.align = p(c.align, !g || j ? 'center' : i ? 'right' : 'left');
    c.verticalAlign =
        p(c.verticalAlign, g || j ? 'middle' : i ? 'top' : 'bottom');
...
T = K.TrackerMixin = {
  ...
  drawTrackerGraph: function() {
    var a = this, b = a.options, c = b.trackByArea,
        d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart,
        g = f.pointer, h = f.renderer, i = f.options.tooltip.snap,
        j = a.tracker, k = b.cursor, l = k && {cursor: k}, k = a.singlePoints,
        n, m = function() {
...
r(Ya.prototype, {
  showResetZoom: function() {
    var a = this, b = E.lang, c = a.options.chart.resetZoomButton, d = c.theme,
        e = d.states, f = c.relativeTo === 'chart' ? null : 'plotBox';
    this.resetZoomButton =
        a.renderer
            .button(
                b.resetZoom, null, null,
                function() {
                  a.zoomOut()
                },
                d, e && e.hover)
  ...
  zoom: function(a) {
    ...
    b &&
        this.redraw(
            p(this.options.chart.animation, a && a.animation,
              this.pointCount < 100))
  },
  pan: function(a, b) {
    ...
    q(b === 'xy' ? [1, 0] : [1], function(b) {
      var d = a[b ? 'chartX' : 'chartY'], h = c[b ? 'xAxis' : 'yAxis'][0],
          i = c[b ? 'mouseDownX' : 'mouseDownY'], j = (h.pointRange || 0) / 2,
          k = h.getExtremes(), l = h.toValue(i - d, !0) + j,
          i = h.toValue(i + c[b ? 'plotWidth' : 'plotHeight'] - d, !0) - j;
      h.series.length && l > L(k.dataMin, k.min) && i < t(k.dataMax, k.max) &&
...
r(Fa.prototype, {
    ...
    c.firePointEvent(a ? 'select' : 'unselect', {accumulate: b}, function() {
      ...
      b || q(e.getSelectedPoints(), function(a) {
        if (a.selected && a !== c)
          ...
          d.options.data[Ma(a, d.data)] = a.options, a.setState(''),
  ...
  setState: function(a, b) {
    var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states,
        g = ca[e.type].marker && e.options.marker, h = g && !g.enabled,
        i = g && g.states[a], j = i && i.enabled === !1,
        k = e.stateMarkerGraphic, l = this.marker || {}, n = e.chart,
        m = e.halo, o, a = a || '';
    o = this.pointAttr[a] || e.pointAttr[a];
    if (!(a === this.state && !b || this.selected && a !== 'select' ||
          f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) ||
        ...
        if (a && i)
          if (g = i.radius, l = l.symbol || e.symbol,
            ...
            e.stateMarkerGraphic = k =
                n.renderer.symbol(l, c - g, d - g, 2 * g, 2 * g)
                    .attr(o)
                    .add(e.markerGroup),
            k.currentSymbol = l;
      ...
      if ((c = f[a] && f[a].halo) && c.size) {
        ...
        m.attr(
            r({fill: ya(this.color || e.color).setOpacity(c.opacity).get()},
  ...
  haloPath: function(a) {
    ...
    return c.renderer.symbols.circle(
        ...
        d.translateY + (e ? b.xAxis.len - this.plotX : this.plotY) - a, a * 2,
        a * 2)
  }
});
r(O.prototype, {
  ...
  setState: function(a) {
    var b = this.options, c = this.graph, d = this.graphNeg, e = b.states,
        b = b.lineWidth, a = a || '';
    if (this.state !== a)
      this.state = a,
      e[a] && e[a].enabled === !1 ||
    ...
    if (!(this.options.enableMouseTracking === !1 || this.singularTooltips)) {
      ...
      for (i = 0; i < a; i++)
        if (e = b[i], c = e.x, c >= f.min && c <= f.max) {
          ...
          for (d = b[i + 1] ?
                   L(t(0,
                       U((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) /
                         2)),
                     g) :
                   g;
               c >= 0 && c <= d;)
...
var P = l.arrayMin, Q = l.arrayMax, s = l.each, F = l.extend, q = l.merge,
    R = l.map, o = l.pick, x = l.pInt, p = l.getOptions().plotOptions,
    g = l.seriesTypes, v = l.extendClass, L = l.splat, r = l.wrap, M = l.Axis,
    y = l.Tick, H = l.Point, S = l.Pointer, T = l.CenteredSeriesMixin,
    z = l.TrackerMixin, t = l.Series, w = Math, D = w.round, A = w.floor,
    N = w.max, U = l.Color, u = function() {};
F(K.prototype, {
  init: function(a, b, c) {
    ...
    O = {
      ...
      getLinePath: function(a, b) {
        ...
        return this.chart.renderer.symbols.arc(
            this.left + c[0], this.top + c[1], b, b, {
      ...
      setAxisSize: function() {
        ...
        if (this.isRadial) {
          this.center = this.pane.center =
              l.CenteredSeriesMixin.getCenter.call(this.pane);
          if (this.isCircular)
            this.sector = this.endAngleRad - this.startAngleRad;
          this.len = this.width = this.height =
              this.center[2] * o(this.sector, 1) / 2
        }
      },
      getPosition: function(a, b) {
        return this.postTranslate(
            this.isCircular ? this.translate(a) : 0,
            o(this.isCircular ? b : this.translate(a), this.center[2] / 2) -
                this.offset)
      },
      ...
      getPlotBandPath: function(a, b, c) {
        ...
        this.options.gridLineInterpolation === 'polygon' ?
            ...
            (m || (h[0] = this.translate(a), h[1] = this.translate(b)),
             ...
             c.shape === 'circle' || !m ?
                 (a = -Math.PI / 2, b = Math.PI * 1.5, k = !0) :
                 (a = e + this.translate(a), b = e + this.translate(b)),
             d = this.chart.renderer.symbols.arc(
                 this.left + d[0], this.top + d[1], h[0], h[0],
                 {start: a, end: b, innerR: o(h[1], h[0] - h[2]), open: k}));
        return d
      },
      getPlotLinePath: function(a, b) {
        var c = this, d = c.center, e = c.chart, f = c.getPosition(a), h, j, k;
        c.isCircular ?
            k = ['M', d[0] + e.plotLeft, d[1] + e.plotTop, 'L', f.x, f.y] :
            c.options.gridLineInterpolation === 'circle' ?
            (a = c.translate(a)) && (k = c.getLinePath(0, a)) :
            (s(e.xAxis,
               function(a) {
                 a.pane === c.pane && (h = a)
               }),
             k = [], a = c.translate(a), d = h.tickPositions,
      ...
      getTitlePosition: function() {
        ...
        return {
          x: b.plotLeft + a[0] + (c.x || 0),
              y: b.plotTop + a[1] -
              {high: 0.5, middle: 0.25, low: 0}[c.align] * a[2] + (c.y || 0)
        }
      }
    };
r(G, 'init', function(a, b, c) {
  ...
  if (d) {
    ...
    F(this, O),
        this.defaultRadialOptions = (j = f) ?
        this.defaultRadialXOptions :
        q(this.defaultYAxisOptions, this.defaultRadialYOptions);
  a.call(this, b, c);
  if (!h && (d || e)) {
    a = this.options;
    if (!b.panes) b.panes = [];
    this.pane =
        (i = b.panes[m] = b.panes[m] || new K(L(k.pane)[m], b, this), m = i);
    m = m.options;
    b.inverted = !1;
    k.chart.zoomType = null;
    this.startAngleRad = b = (m.startAngle - 90) * Math.PI / 180;
    this.endAngleRad = k =
        (o(m.endAngle, m.startAngle + 360) - 90) * Math.PI / 180;
...
r(y, 'getLabelPosition', function(a, b, c, d, e, f, h, j, k) {
  var m = this.axis, i = f.y, n = f.align,
      g = (m.translate(this.pos) + m.startAngleRad + Math.PI / 2) / Math.PI *
      180 % 360;
  m.isRadial ?
      (a = m.getPosition(this.pos, m.center[2] / 2 + o(f.distance, -25)),
       f.rotation === 'auto' ? d.attr({rotation: g}) :
                               i === null &&
               (i = m.chart.renderer.fontMetrics(d.styles.fontSize).b -
                    d.getBBox().height / 2),
       n === null &&
           (n = m.isCircular ? g > 20 && g < 160 ?
                               'left' :
                               g > 200 && g < 340 ? 'right' : 'center' :
                               'center',
            d.attr({align: n})),
       a.x += f.x, a.y += i) :
      a = a.call(this, b, c, d, e, f, h, j, k);
  return a
});
...
p.arearange = q(p.area, {
  ...
  trackByArea: !0,
  dataLabels:
      {align: null, verticalAlign: null, xLow: 0, xHigh: 0, yLow: 0, yHigh: 0},
  states: {hover: {halo: !1}}
});
g.arearange = v(g.area, {
  ...
  translate: function() {
    ...
    s(this.points, function(b) {
      ...
      d === null&& c === null ?
          ...
          d === null ? (b.plotLow = e, b.plotHigh = null) :
  ...
  getSegmentPath: function(a) {
    ...
    if (j)
      j === !0 && (j = 'left'),
          h.step = {left: 'right', center: 'center', right: 'left'}[j];
    c = e.call(this, c);
    h.step = j;
    h = [].concat(a, c);
    c[0] = 'L';
  ...
  drawDataLabels: function() {
    var a = this.data, b = a.length, c, d = [], e = t.prototype,
        f = this.options.dataLabels, h = f.align, j, k = this.chart.inverted;
    if (f.enabled || this._hasPointLabels) {
      for (c = b; c--;)
        if (j = a[c], j.y = j.high, j._plotY = j.plotY, j.plotY = j.plotHigh,
            d[c] = j.dataLabel, j.dataLabel = j.dataLabelUpper, j.below = !1,
            k) {
          if (!h) f.align = 'left';
          f.x = f.xHigh
        } else
      ...
      for (c = b; c--;)
        if (j = a[c], j.dataLabelUpper = j.dataLabel, j.dataLabel = d[c],
            j.y = j.low, j.plotY = j._plotY, j.below = !0, k) {
          if (!h) f.align = 'right';
          f.x = f.xLow
        } else
          f.y = f.yLow;
...
z = {
  ...
  translate: function() {
    ...
    s(this.points, function(d) {
      var e = q(b.dial, d.dial), f = x(o(e.radius, 80)) * c[2] / 200,
          h = x(o(e.baseLength, 70)) * f / 100,
          j = x(o(e.rearLength, 10)) * f / 100, k = e.baseWidth || 3,
          m = e.topWidth || 1, i = b.overshoot,
          n = a.startAngleRad + a.translate(d.y, null, null, null, !0);
      i && typeof i === 'number' ?
          (i = i / 180 * Math.PI,
           n = Math.max(a.startAngleRad - i, Math.min(a.endAngleRad + i, n))) :
          b.wrap === !1 &&
              (n = Math.max(a.startAngleRad, Math.min(a.endAngleRad, n)));
      n = n * 180 / Math.PI;
      d.shapeType = 'path';
      d.shapeArgs = {
        d: e.path ||
            [
              'M', -j, -k / 2, 'L', h, -k / 2, f, -m / 2, f, m / 2, h, k / 2,
              -j, k / 2, 'z'
            ],
        translateX: c[0],
        translateY: c[1],
  ...
  drawPoints: function() {
    ...
    c ? c.animate({translateX: b[0], translateY: b[1]}) :
        a.pivot = f.circle(0, 0, o(e.radius, 5))
                      .attr({
  ...
  render: function() {
    this.group = this.plotGroup(
        'group', 'series', this.visible ? 'visible' : 'hidden',
...
g.boxplot = v(g.column, {
  ...
  drawPoints: function() {
    var a = this, b = a.points, c = a.options, d = a.chart.renderer, e, f, h, j,
        k, m, i, n, g, l, p, I, r, q, J, u, v, t, w, x, z, y,
        E = a.doQuartiles !== !1,
    ...
    s(b, function(b) {
      ...
      y = b.color || a.color;
      if (b.plotY !== C)
        if (e = b.pointAttr[b.selected ? 'selected' : ''], v = z.width,
            t = A(z.x), w = t + v, x = D(v / 2),
            f = A(E ? b.q1Plot : b.lowPlot), h = A(E ? b.q3Plot : b.lowPlot),
            j = A(b.highPlot), k = A(b.lowPlot),
            ...
            u['stroke-linecap'] = 'round', i = p['stroke-width'] % 2 / 2,
            n = t + x + i, l = ['M', n, h, 'L', n, j, 'M', n, f, 'L', n, k],
            E &&
                (i = e['stroke-width'] % 2 / 2, n = A(n) + i, f = A(f) + i,
                 h = A(h) + i, t += i, w += i,
                 I =
                     [
                       'M', t, h, 'L', t, f, 'L', w, f, 'L', w, h, 'L', t, h,
                       'z'
                     ]),
            B &&
                (i = q['stroke-width'] % 2 / 2, j += i, k += i,
                 r =
                     [
                       'M', n - x * B, j, 'L', n + x * B, j, 'M', n - x * B, k,
                       'L', n + x * B, k
                     ]),
            i = u['stroke-width'] % 2 / 2, m = D(b.medianPlot) + i,
            J = ['M', t, m, 'L', w, m], g)
          b.stem.animate({d: l}), B && b.whiskers.animate({d: r}),
              E && b.box.animate({d: I}), b.medianShape.animate({d: J});
        else {
...
g.waterfall = v(g.column, {
  ...
  translate: function() {
    ...
    for (c = 0, b = d.length; c < b; c++) {
      ...
      e.isSum ? (f.y = a.translate(i[1], 0, 1),
                 f.height = a.translate(i[0], 0, 1) - f.y) :
                e.isIntermediateSum ?
                (f.y = a.translate(i[1], 0, 1),
                 f.height = a.translate(m, 0, 1) - f.y, m = i[1]) :
                k += h.total;
  ...
  processData: function(a) {
    ...
    for (i = 0; i < e; i++)
      ...
      m === 'sum' || d.isSum ?
          b[i] = h :
          m === 'intermediateSum' || d.isIntermediateSum ? b[i] = f :
                                                           (h += m, f += m),
      j = Math.min(h, j), k = Math.max(h, k);
  ...
  getAttribs: function() {
    ...
    var a = this.options, b = a.states, c = a.upColor || this.color,
        a = l.Color(c).brighten(0.1).get(), d = q(this.pointAttr),
        e = this.upColorProp;
    d[''][e] = c;
  ...
  getGraphPath: function() {
    var a = this.data, b = a.length,
        c = D(this.options.lineWidth + this.borderWidth) % 2 / 2, d = [], e, f,
        h;
    for (h = 1; h < b; h++)
      f = a[h].shapeArgs, e = a[h - 1].shapeArgs,
      f = ['M', e.x + e.width, e.y + c, 'L', f.x, e.y + c],
      a[h - 1].y < 0 && (f[2] += e.height, f[5] += e.height), d = d.concat(f);
    return d
  },
  getExtremes: u,
  getStack: function(a) {
...
z = v(H, {
  haloPath: function() {
    return H.prototype.haloPath.call(
        this, this.shapeArgs.r + this.series.options.states.hover.halo.size)
  }
});
g.bubble = v(g.scatter, {
  ...
  bubblePadding: !0,
  pointAttrToOptions:
      {stroke: 'lineColor', 'stroke-width': 'lineWidth', fill: 'fillColor'},
  applyOpacity: function(a) {
    var b = this.options.marker, c = o(b.fillOpacity, 0.5),
  ...
  getRadii: function(a, b, c, d) {
    ...
    for (f = 0, e = j.length; f < e; f++)
      h = b - a, h = h > 0 ? (j[f] - a) / (b - a) : 0.5,
      m && h >= 0 && (h = Math.sqrt(h)), k.push(w.ceil(c + h * (d - c)) / 2);
    this.radii = k
  },
  animate: function(a) {
  ...
  translate: function() {
    ...
    for (a = b.length; a--;)
      ...
      d >= this.minPxSize / 2 ?
          (c.shapeType = 'circle', c.shapeArgs = {x: c.plotX, y: c.plotY, r: d},
           c.dlBox =
  ...
  drawLegendSymbol: function(a, b) {
    ...
    b.legendSymbol = this.chart.renderer.circle(c, a.baseline - c, c)
                         .attr({zIndex: 3})
                         .add(b.legendGroup);
...
M.prototype.beforePadding = function() {
  var a = this, b = this.len, c = this.chart, d = 0, e = b, f = this.isXAxis,
      h = f ? 'xData' : 'yData', j = this.min, k = {},
      m = w.min(c.plotWidth, c.plotHeight), i = Number.MAX_VALUE,
      n = -Number.MAX_VALUE, g = this.max - j, l = b / g, p = [];
  this.tickPositions &&
      (s(this.series,
         function(b) {
           var h = b.options;
             ...
             if (a.allowZoomOutside = !0, p.push(b), f)
               s(['minSize', 'maxSize'],
                 function(a) {
                   ...
                   b.minPxSize = k.minSize, b = b.zData,
                   b.length &&
                   (i = o(
                        h.zMin,
                        w.min(
                            ...
                            w.max(
                                P(b),
                                h.displayNegative === !1 ? h.zThreshold :
                                                           -Number.MAX_VALUE))),
       ...
       s(p,
         function(a) {
           ...
           if (g > 0)
             for (; c--;)
               typeof b[c] === 'number' &&
                   (m = a.radii[c], d = Math.min((b[c] - j) * l - m, d),
                    e = Math.max((b[c] - j) * l + m, e))
         }),
       p.length && g > 0 && o(this.options.min, this.userMin) === C &&
           o(this.options.max, this.userMax) === C &&
           (e -= b, l *= (b + d - e) / b, this.min += d / l, this.max += e / l))
};
(function() {
function a(a, b, c) {
  a.call(this, b, c);
...
function b(a, b) {
  var c = this.chart, d = this.options.animation, e = this.group,
      i = this.markerGroup, n = this.xAxis.center, g = c.plotLeft,
      l = c.plotTop;
  if (c.polar) {
    if (c.renderer.isSVG)
      d === !0 && (d = {}),
          b ? (c = {
            ...
            scaleY: 0.001
               ...
               e.attr(c), i && i.attr(c)) :
              (c = {translateX: g, translateY: l, scaleX: 1, scaleY: 1},
...
g.spline && r(g.spline.prototype, 'getPointSpline', function(a, b, c, d) {
  ...
  if (this.chart.polar) {
    ...
    if (a && n)
      g = a.plotX, l = a.plotY, b = n.plotX, p = n.plotY,
      g = (1.5 * e + g) / 2.5, l = (1.5 * i + l) / 2.5, n = (1.5 * e + b) / 2.5,
      o = (1.5 * i + p) / 2.5,
      b = Math.sqrt(Math.pow(g - e, 2) + Math.pow(l - i, 2)),
      p = Math.sqrt(Math.pow(n - e, 2) + Math.pow(o - i, 2)),
      g = Math.atan2(l - i, g - e), l = Math.atan2(o - i, n - e),
      o = Math.PI / 2 + (g + l) / 2,
      Math.abs(g - o) > Math.PI / 2 && (o -= Math.PI), g = e + Math.cos(o) * b,
      l = i + Math.sin(o) * b, n = e + Math.cos(Math.PI + o) * p,
      o = i + Math.sin(Math.PI + o) * p, c.rightContX = n, c.rightContY = o;
    d ? (c =
             [
               'C', a.rightContX || a.plotX, a.rightContY || a.plotY, g || e,
               l || i, e, i
             ],
...
r(c, 'getSegmentPath', function(a, b) {
  ...
  if (this.chart.polar && this.options.connectEnds !== !1 &&
      b[b.length - 1] === c[c.length - 1] && c[0].y !== null)
...
if (g.column)
  e = g.column.prototype, r(e, 'animate', b), r(e, 'translate', function(a) {
    var b = this.xAxis, c = this.yAxis.len, d = b.center, e = b.startAngleRad,
        i = this.chart.renderer, g, l;
    this.preventPostTranslate = !0;
    a.call(this);
    if (b.isRadial) {
      b = this.points;
      for (l = b.length; l--;)
        g = b[l], a = g.barX + e, g.shapeType = 'path', g.shapeArgs = {
          d: i.symbols.arc(
              d[0], d[1], c - g.plotY, null,
              {start: a, end: a + g.pointWidth, innerR: c - o(g.yBottom, c)})
        },
        this.toXY(g), g.tooltipPos = [g.plotX, g.plotY],
    ...
    if (this.chart.polar) {
      ...
      if (e.align === null)
        e.align = a > 20 && a < 160 ? 'left' :
                                      a > 200 && a < 340 ? 'right' : 'center';
      if (e.verticalAlign === null)
        e.verticalAlign = a < 45 || a > 315 ?
            'bottom' :
...
r(d, 'getIndex', function(a, b) {
  ...
  d.polar ? (e = d.xAxis[0].center, c = b.chartX - e[0] - d.plotLeft,
...
r(d, 'getCoordinates', function(a, b) {
  ...
  c.polar ? s(c.axes, function(a) {
    var e = a.isXAxis, f = a.center, g = b.chartX - f[0] - c.plotLeft,
        f = b.chartY - f[1] - c.plotTop;
    d[e ? 'xAxis' : 'yAxis'].push({
      axis: a,
      value: a.translate(
          e ? Math.PI - Math.atan2(g, f) :
...
function w(f, a, b, c, e, g, d, i) {
  var h = [];
  return g > e && g - e > n / 2 + 1.0E-4 ?
      (h = h.concat(w(f, a, b, c, e, e + n / 2, d, i)),
       h = h.concat(w(f, a, b, c, e + n / 2, g, d, i))) :
      g < e && e - g > n / 2 + 1.0E-4 ?
      (h = h.concat(w(f, a, b, c, e, e - n / 2, d, i)),
       h = h.concat(w(f, a, b, c, e - n / 2, g, d, i))) :
      (h = g - e, [
        'C', f + b * m(e) - b * B * h * l(e) + d,
        a + c * l(e) + c * B * h * m(e) + i,
        f + b * m(g) + b * B * h * l(g) + d,
        a + c * l(g) - c * B * h * m(g) + i, f + b * m(g) + d, a + c * l(g) + i
      ])
}
function D(f) {
  if (this.chart.is3d()) {
    var a = this.chart.options.plotOptions.column.grouping;
    a !== void 0 && !a && this.group.zIndex !== void 0 &&
        this.group.attr({zIndex: this.group.zIndex * 10});
    var b = this.options, c = this.options.states;
    this.borderWidth = b.borderWidth = b.edgeWidth || 1;
    d.each(this.data, function(a) {
      if (a.y !== null)
        a = a.pointAttr, this.borderColor = d.pick(b.edgeColor, a[''].fill),
...
var n = Math.PI, t = n / 180, l = Math.sin, m = Math.cos, z = Math.round,
...
d.SVGRenderer.prototype.cuboid = function(f) {
  ...
  a.front =
      this.path(f[0]).attr({zIndex: f[3], 'stroke-linejoin': 'round'}).add(a);
  a.top =
      this.path(f[1]).attr({zIndex: f[4], 'stroke-linejoin': 'round'}).add(a);
  a.side =
      this.path(f[2]).attr({zIndex: f[5], 'stroke-linejoin': 'round'}).add(a);
  ...
  a.animate = function(a, c, e) {
    A(a.x) && A(a.y) ?
        (a = this.renderer.cuboidPath(a),
         this.front.attr({zIndex: a[3]}).animate({d: a[0]}, c, e),
         this.top.attr({zIndex: a[4]}).animate({d: a[1]}, c, e),
         this.side.attr({zIndex: a[5]}).animate({d: a[2]}, c, e)) :
        a.opacity ? (this.front.animate(a, c, e), this.top.animate(a, c, e),
...
d.SVGRenderer.prototype.cuboidPath = function(d) {
  var a = d.x, b = d.y, c = d.z, e = d.height, g = d.width, j = d.depth,
      i = d.alpha, h = d.beta,
      a =
          [
            {x: a, y: b, z: c}, {x: a + g, y: b, z: c},
            {x: a + g, y: b + e, z: c}, {x: a, y: b + e, z: c},
            {x: a, y: b + e, z: c + j}, {x: a + g, y: b + e, z: c + j},
            {x: a + g, y: b, z: c + j}, {x: a, y: b, z: c + j}
          ],
      a = x(a, i, h, d.origin),
      d =
          [
            'M', a[0].x, a[0].y, 'L', a[7].x, a[7].y, 'L', a[6].x, a[6].y, 'L',
            a[1].x, a[1].y, 'Z'
          ],
      b =
          [
            'M', a[3].x, a[3].y, 'L', a[2].x, a[2].y, 'L', a[5].x, a[5].y, 'L',
            a[4].x, a[4].y, 'Z'
          ],
      c =
          [
            'M', a[1].x, a[1].y, 'L', a[2].x, a[2].y, 'L', a[5].x, a[5].y, 'L',
            a[6].x, a[6].y, 'Z'
          ],
      e = [
        'M', a[0].x, a[0].y, 'L', a[7].x, a[7].y, 'L', a[4].x, a[4].y, 'L',
        a[3].x, a[3].y, 'Z'
      ];
  return [
    [
      'M', a[0].x, a[0].y, 'L', a[1].x, a[1].y, 'L', a[2].x, a[2].y, 'L',
      a[3].x, a[3].y, 'Z'
    ],
    a[7].y < a[1].y ? d : a[4].y > a[2].y ? b : [],
    a[6].x > a[1].x ? c : a[7].x < a[0].x ? e : [],
    (a[0].z + a[1].z + a[2].z + a[3].z) / 4,
    h > 0 ? (a[0].z + a[7].z + a[6].z + a[1].z) / 4 :
            (a[3].z + a[2].z + a[5].z + a[4].z) / 4,
    i > 0 ? (a[1].z + a[2].z + a[5].z + a[6].z) / 4 :
            (a[0].z + a[7].z + a[4].z + a[3].z) / 4
  ]
};
  ...
  a.animate = function(a, b, c) {
    A(a.end) || A(a.start) ?
        (this._shapeArgs = this.shapeArgs,
         d.SVGElement.prototype.animate.call(
             this, {_args: a}, {
               duration: b,
               step: function() {
                 var a = arguments[1], b = a.elem, c = b._shapeArgs, e = a.end,
                     a = a.pos, c = d.merge(c, {
                       x: c.x + (e.x - c.x) * a,
                       y: c.y + (e.y - c.y) * a,
                       r: c.r + (e.r - c.r) * a,
...
d.SVGRenderer.prototype.arc3dPath = function(d) {
  var a = d.x, b = d.y, c = d.start, e = d.end - 1.0E-5, g = d.r, j = d.innerR,
      i = d.depth, h = d.alpha, k = d.beta, o = m(c), q = l(c), d = m(e),
      y = l(e), r = g * m(k), s = g * m(h), p = j * m(k);
  j *= m(h);
  var v = i * l(k), u = i * l(h), i = ['M', a + r * o, b + s * q],
      i = i.concat(w(a, b, r, s, c, e, 0, 0)),
      i = i.concat(['L', a + p * d, b + j * y]),
      i = i.concat(w(a, b, p, j, e, c, 0, 0)), i = i.concat(['Z']),
      k = k > 0 ? n / 2 : 0, h = h > 0 ? 0 : n / 2,
      k = c > -k ? c : e > -k ? -k : c,
      t = e < n - h ? e : c < n - h ? n - h : e,
      h = ['M', a + r * m(k), b + s * l(k)],
      h = h.concat(w(a, b, r, s, k, t, 0, 0)),
      h = h.concat(['L', a + r * m(t) + v, b + s * l(t) + u]),
      h = h.concat(w(a, b, r, s, t, k, v, u)), h = h.concat(['Z']),
      k = ['M', a + p * o, b + j * q], k = k.concat(w(a, b, p, j, c, e, 0, 0)),
      k = k.concat(['L', a + p * m(e) + v, b + j * l(e) + u]),
      k = k.concat(w(a, b, p, j, e, c, v, u)), k = k.concat(['Z']),
      o =
          [
            'M', a + r * o, b + s * q, 'L', a + r * o + v, b + s * q + u, 'L',
            a + p * o + v, b + j * q + u, 'L', a + p * o, b + j * q, 'Z'
          ],
      a =
          [
            'M', a + r * d, b + s * y, 'L', a + r * d + v, b + s * y + u, 'L',
            a + p * d + v, b + j * y + u, 'L', a + p * d, b + j * y, 'Z'
          ],
      b = l((c + e) / 2), c = l(c), e = l(e);
  return {
    top: i, zTop: g, out: h, zOut: Math.max(b, c, e) * g, inn: k,
        zInn: Math.max(b, c, e) * g, side1: o, zSide1: c * g * 0.99, side2: a,
        zSide2: e * g * 0.99
  }
};
...
d.Chart.prototype.retrieveStacks = function(f, a) {
  ...
  d.each(this.series, function(a) {
    b[a.options.stack || 0] ?
        b[a.options.stack || 0].series.push(a) :
        (b[a.options.stack || 0] = {series: [a], position: c}, c++)
  });
  b.totalStacks = c + 1;
  return b
};
...
d.wrap(d.Axis.prototype, 'render', function(d) {
  d.apply(this, [].slice.call(arguments, 1));
  if (this.chart.is3d()) {
    var a = this.chart, b = a.renderer, c = a.options.chart.options3d,
        e = c.alpha, g = c.beta * (a.yAxis[0].opposite ? -1 : 1), j = c.frame,
        i = j.bottom, h = j.back, j = j.side, k = c.depth, o = this.height,
        q = this.width, l = this.left, m = this.top, c = {
    ...
    if (this.horiz)
      this.axisLine && this.axisLine.hide(), g = {
        x: l,
      ...
      this.backFrame ? this.backFrame.animate(n) :
                       this.backFrame = b.cuboid(n)
                                            .attr({fill: h.color, zIndex: -3})
                                            .css({stroke: h.color})
                                            .add();
      ...
      this.sideFrame ? this.sideFrame.animate(a) :
                       this.sideFrame = b.cuboid(a)
                                            .attr({fill: j.color, zIndex: -2})
                                            .css({stroke: j.color})
                                            .add()
    }
  }
...
d.wrap(d.Axis.prototype, 'getPlotLinePath', function(d) {
  ...
  var a =
          [
            ...
            {x: a[1], y: a[2], z: e}, {x: a[4], y: a[5], z: e},
...
d.wrap(d.Axis.prototype, 'getPlotBandPath', function(d) {
  if (this.chart.is3d()) {
    ...
    (b = this.getPlotLinePath(b)) && a ?
        b.push(a[7], a[8], a[4], a[5], a[1], a[2]) :
        b = null;
    return b
  } else
...
d.wrap(d.seriesTypes.column.prototype, 'translate', function(f) {
  f.apply(this, [].slice.call(arguments, 1));
  if (this.chart.is3d()) {
    var a = this.chart, b = this.options, c = a.options.chart.options3d,
        e = b.depth || 25, g = {
          x: a.plotWidth / 2,
          y: a.plotHeight / 2,
          z: c.depth,
        ...
        j = c.alpha, i = c.beta * (a.yAxis[0].opposite ? -1 : 1),
        h = (b.stacking ? b.stack || 0 : this._i) *
        (e + (b.groupZPadding || 1));
    b.grouping !== !1 && (h = 0);
    h += b.groupZPadding || 1;
    d.each(this.data, function(a) {
  ...
  if (this.chart.is3d()) {
    ...
    if (d.svg)
      a ? d.each(c.data, function(a) {
        if (a.y !== null &&
            (a.height = a.shapeArgs.height, a.shapey = a.shapeArgs.y,
             a.shapeArgs.height = 1, !e))
          a.shapeArgs.y = a.stackY ?
              a.plotY + b.translate(a.stackY) :
              a.plotY + (a.negative ? -a.height : a.height)
      }) : (d.each(c.data, function(a) {
        if (a.y !== null)
          a.shapeArgs.height = a.height, a.shapeArgs.y = a.shapey,
...
d.wrap(d.Series.prototype, 'alignDataLabel', function(d) {
  if (this.chart.is3d() &&
    ...
    var a = this.chart, b = a.options.chart.options3d, c = arguments[4],
        e = {x: c.x, y: c.y, z: 0},
...
d.seriesTypes.columnrange &&
    d.wrap(d.seriesTypes.columnrange.prototype, 'drawPoints', D);
...
d.wrap(d.seriesTypes.cylinder.prototype, 'translate', function(f) {
  f.apply(this, [].slice.call(arguments, 1));
  if (this.chart.is3d()) {
    var a = this.chart, b = a.options, c = b.plotOptions.cylinder,
        b = b.chart.options3d, e = c.depth || 0, g = {
...
d.wrap(d.seriesTypes.pie.prototype, 'translate', function(f) {
  f.apply(this, [].slice.call(arguments, 1));
  if (this.chart.is3d()) {
    var a = this, b = a.chart, c = a.options, e = c.depth || 0,
        g = b.options.chart.options3d,
        j = {x: b.plotWidth / 2, y: b.plotHeight / 2, z: g.depth}, i = g.alpha,
        h = g.beta, k = c.stacking ? (c.stack || 0) * e : a._i * e;
    k += e / 2;
    c.grouping !== !1 && (k = 0);
    d.each(a.data, function(b) {
      ...
      var c = b.shapeArgs;
      if (b.y)
        c.z = k, c.depth = e * 0.75, c.origin = j, c.alpha = i, c.beta = h,
        c = (c.end + c.start) / 2, b.slicedTranslation = {
...
d.wrap(
    d.seriesTypes.pie.prototype.pointClass.prototype, 'haloPath', function(d) {
      var a = arguments;
...
d.wrap(d.seriesTypes.pie.prototype, 'drawDataLabels', function(f) {
  this.chart.is3d() && d.each(this.data, function(a) {
    var b = a.shapeArgs, c = b.r, d = b.depth, f = b.alpha * t,
        b = (b.start + b.end) / 2, a = a.labelPos;
...
d.wrap(d.seriesTypes.pie.prototype, 'animate', function(f) {
  if (this.chart.is3d()) {
    ...
    if (d.svg)
      if (b === !0 && (b = {}), a) {
        if (e.oldtranslateX = e.translateX, e.oldtranslateY = e.translateY,
            a = {
              translateX: c[0],
              translateY: c[1],
              scaleX: 0.001,
            ...
            e.attr(a), g)
          g.attrSetters = e.attrSetters, g.attr(a)
      } else
        a = {
...
d.wrap(d.seriesTypes.scatter.prototype, 'translate', function(f) {
  f.apply(this, [].slice.call(arguments, 1));
  if (this.chart.is3d()) {
    var a = this.chart, b = this.chart.options.chart.options3d, c = b.alpha,
        e = b.beta, g = {
          x: a.inverted ? a.plotHeight / 2 : a.plotWidth / 2,
          y: a.inverted ? a.plotWidth / 2 : a.plotHeight / 2,
          z: b.depth,
        ...
        b = b.depth, j = a.options.zAxis || {min: 0, max: b},
        i = b / (j.max - j.min);
    d.each(this.data, function(a) {
      var b = {x: a.plotX, y: a.plotY, z: (a.z - j.min) * i},
          b = x([b], c, e, g)[0];
      a.plotXold = a.plotX;
      a.plotYold = a.plotY;
      a.plotX = b.x;
...
if (d.VMLRenderer)
  d.setOptions({animate: !1}),
      ...
      d.VMLRenderer.prototype.createElement3D =
          d.SVGRenderer.prototype.createElement3D,
      d.VMLRenderer.prototype.arc3d =
          function(f) {
...
*/
(function(f) {
var A = f.Chart, t = f.addEvent, B = f.removeEvent, l = f.createElement,
    o = f.discardElement, v = f.css, k = f.merge, r = f.each, p = f.extend,
    D = Math.max, j = document, C = window, E = f.isTouchDevice,
    F = f.Renderer.prototype.symbols, s = f.getOptions(), y;
p(s.lang, {
...
p(A.prototype, {
  getSVG: function(b) {
    ...
    p(g.chart,
      {animation: !1, renderTo: b, forExport: !0, width: c, height: h});
    ...
    return c = c.replace(/(url\(#highcharts-[0-9]+)&quot;/g, '$1')
                   .replace(/&quot;/g, '\'')
  },
  ...
  print: function() {
    var b = this, a = b.container, d = [], c = a.parentNode, f = j.body,
        h = f.childNodes;
    if (!b.isPrinting)
  ...
  contextMenu: function(b, a, d, c, f, h, g) {
    var e = this, k = e.options.navigation, q = k.menuItemStyle,
        m = e.chartWidth, n = e.chartHeight, j = 'cache-' + b, i = e[j],
        u = D(f, h), w, x, o, s = function(a) {
          e.pointer.inClass(a.target, b) || x()
        };
    if (!i)
      e[j] = i = l(
          'div', {className: b},
          {position: 'absolute', zIndex: 1E3, padding: u + 'px'}, e.container),
      w =
          l('div', null,
            p({
      ...
      e.exportDivElements.push(w, i), e.exportMenuWidth = i.offsetWidth,
  ...
  addButton: function(b) {
    var a = this, d = a.renderer, c = k(a.options.navigation.buttonOptions, b),
        j = c.onclick, h = c.menuItems, g, e,
    ...
    if (c.enabled !== !1) {
      ...
      j ? i = function() {
        j.apply(a, arguments)
            ...
            a.contextMenu(
                e.menuClassName, h, e.translateX, e.translateY, e.width,
                e.height, e);
            e.setState(2)
          });
      c.text&& c.symbol ?
      ...
      c.symbol &&
          (g = d.symbol(c.symbol, c.symbolX - q / 2, c.symbolY - q / 2, q, q)
                   .attr(
                       p(l,
                         {'stroke-width': c.symbolStrokeWidth || 1, zIndex: 1}))
                   .add(e));
      e.add().align(
          p(c, {width: e.width, x: f.pick(c.x, y)}), !0, 'spacingBox');
  ...
  destroyExport: function(b) {
    ...
    for (a = 0; a < b.exportDivElements.length; a++)
      d = b.exportDivElements[a], B(d, 'mouseleave'),
      b.exportDivElements[a] = d.onmouseout = d.onmouseover = d.ontouchstart =
          d.onclick = null,
      o(d)
  }
});
F.menu = function(b, a, d, c) {
  return [
    'M', b, a + 2.5, 'L', b + d, a + 2.5, 'M', b, a + c / 2 + 0.5, 'L', b + d,
    a + c / 2 + 0.5, 'M', b, a + c - 1.5, 'L', b + d, a + c - 1.5
  ]
};
...
*/
(function(g) {
var j = g.each, q = HighchartsAdapter.inArray, s = g.splat, l,
    n = function(a, b) {
      this.init(a, b)
    };
g.extend(n.prototype, {
  ...
  getColumnDistribution: function() {
    ...
    j(b && b.seriesMapping || [], function(b) {
      var c = new l, m, j = d[p] || f(e),
          o = g.seriesTypes
                  [((a && a.series || [])[p] || {}).type || e || 'line']
                      .prototype.pointArrayMap ||
          ['y'];
      c.addColumnReader(b.x, 'x');
      for (m in b)
        b.hasOwnProperty(m) && m !== 'x' && c.addColumnReader(b[m], m);
      for (h = 0; h < j; h++)
        c.hasReader(o[h]) || c.addColumnReader(void 0, o[h]);
      i.push(c);
      p++
    });
  ...
  parseCSV: function() {
    var a = this, b = this.options, c = b.csv, f = this.columns,
        e = b.startRow || 0, d = b.endRow || Number.MAX_VALUE,
        i = b.startColumn || 0, p = b.endColumn || Number.MAX_VALUE, h, g,
        r = 0;
    c &&
        (g = c.replace(/\r\n/g, '\n')
                 .replace(/\r/g, '\n')
                 .split(b.lineDelimiter || '\n'),
         h = b.itemDelimiter || (c.indexOf('\t') !== -1 ? '\t' : ','),
         j(g, function(b, c) {
           var g = a.trim(b), t = g.indexOf('#') === 0;
           c >= e && c <= d && !t && g !== '' &&
               (g = b.split(h), j(g, function(a, b) {
                  b >= i && b <= p &&
                      (f[b - i] || (f[b - i] = []), f[b - i][r] = a)
                }), r += 1)
         }), this.dataFound())
  },
  parseTable: function() {
    var a = this.options, b = a.table, c = this.columns, f = a.startRow || 0,
        e = a.endRow || Number.MAX_VALUE, d = a.startColumn || 0,
        i = a.endColumn || Number.MAX_VALUE;
    b &&
        (typeof b === 'string' && (b = document.getElementById(b)),
         j(b.getElementsByTagName('tr'), function(a, b) {
           b >= f && b <= e && j(a.children, function(a, e) {
             if ((a.tagName === 'TD' || a.tagName === 'TH') && e >= d && e <= i)
               c[e - d] || (c[e - d] = []), c[e - d][b - f] = a.innerHTML
           })
         }), this.dataFound())
  },
  parseGoogleSpreadsheet: function() {
    var a = this, b = this.options, c = b.googleSpreadsheetKey,
        f = this.columns, e = b.startRow || 0, d = b.endRow || Number.MAX_VALUE,
        i = b.startColumn || 0, g = b.endColumn || Number.MAX_VALUE, h, j;
    c && jQuery.ajax({
      dataType: 'json',
      url: 'https://spreadsheets.google.com/feeds/cells/' + c + '/' +
      ...
      success: function(b) {
        ...
        for (k = 0; k < l; k++)
          c = b[k], o = Math.max(o, c.gs$cell.col),
          n = Math.max(n, c.gs$cell.row);
        for (k = 0; k < o; k++)
          if (k >= i && k <= g)
            f[k - i] = [], f[k - i].length = Math.min(n, d - e);
        for (k = 0; k < l; k++)
          if (c = b[k], h = c.gs$cell.row - 1, j = c.gs$cell.col - 1,
              j >= i && j <= g && h >= e && h <= d)
            f[j - i][h - e] = c.content.$t;
        a.dataFound()
      }
    })
  },
  ...
  parseTypes: function() {
    for (var a = this.columns, b = this.rawColumns, c = a.length, f, e, d, i, g,
             h, j = [], l, m = this.chartOptions;
         c--;) {
      f = a[c].length;
      b[c] = [];
      for (l = (g = q(c, this.valueCount.xColumns) !== -1) && m && m.xAxis &&
               s(m.xAxis)[0].type === 'category';
           f--;)
        if (e = j[f] || a[c][f], d = parseFloat(e), i = b[c][f] = this.trim(e),
            l)
          a[c][f] = i;
        else if (i == d)
          a[c][f] = d, d > 31536E6 ? a[c].isDatetime = !0 : a[c].isNumeric = !0;
        else if (
            d = this.parseDate(e), g && typeof d === 'number' && !isNaN(d)) {
          if (j[f] = e, a[c][f] = d, a[c].isDatetime = !0,
              a[c][f + 1] !== void 0) {
            e = d > a[c][f + 1];
            if (e !== h && h !== void 0)
              this.alternativeFormat ?
                  (this.dateFormat = this.alternativeFormat, f = a[c].length,
                   this.alternativeFormat =
            ...
            a[c][f] = i === '' ? null : i,
            f !== 0 && (a[c].isDatetime || a[c].isNumeric))
          a[c].mixed = !0;
      g && a[c].mixed && (a[c] = b[c])
    }
    if (a[0].isDatetime && h) {
      ...
      for (c = 0; c < a.length; c++)
        a[c].reverse(), b && a[c].unshift(a[c].pop())
    }
  },
  dateFormats: {
    'YYYY-mm-dd': {
  ...
  parseDate: function(a) {
    var b = this.options.parseDate, c, f,
        e = this.options.dateFormat || this.dateFormat, d;
    b && (c = b(a));
    if (typeof a === 'string') {
      if (e)
        b = this.dateFormats[e], (d = a.match(b.regex)) && (c = b.parser(d));
      else
      ...
      d ||
          (d = Date.parse(a),
           typeof d === 'object' && d !== null&& d.getTime ?
               c = d.getTime() - d.getTimezoneOffset() * 6E4 :
               typeof d === 'number' && !isNaN(d) &&
                   (c = d - (new Date(d)).getTimezoneOffset() * 6E4))
    }
    return c
  },
  ...
  complete: function() {
    ...
    if (c.complete || c.afterComplete) {
      ...
      for (d = 0; d < this.valueCount.seriesBuilders.length; d++)
        h = this.valueCount.seriesBuilders[d],
      ...
      for (; e.length > 0;) {
        ...
        for (d = 0; d < this.valueCount.global; d++)
          h.addColumnReader(void 0, this.valueCount.globalPointArrayMap[d]);
        h.populateColumns(e) && g.push(h)
      }
      g.length > 0 && g[0].readers.length > 0 &&
          (h = a[g[0].readers[0].columnIndex],
           h !== void 0 &&
               (h.isDatetime ? b = 'datetime' :
                               h.isNumeric || (b = 'category')));
      if (b === 'category')
        for (d = 0; d < g.length; d++) {
          h = g[d];
          for (e = 0; e < h.readers.length; e++)
            if (h.readers[e].configName === 'x')
              h.readers[e].configName = 'name'
        }
      for (d = 0; d < g.length; d++) {
        h = g[d];
        e = [];
            ...
            afterComplete: function(e) {
              ...
              if (b.hasOwnProperty('series'))
                if (typeof b.series === 'object')
                  for (d = Math.max(b.series.length, e.series.length); d--;)
                    i = b.series[d] || {},
                    b.series[d] = g.merge(i, e.series[d]);
                else
                  delete b.series;
              b = g.merge(e, b);
              a.call(f, b, c)
...
l.prototype.read = function(a, b) {
  ...
  if (this.name === void 0 && this.readers.length >= 2 &&
      (e = this.getReferencedColumnIndexes(), e.length >= 2))
    e.shift(), e.sort(), this.name = a[e.shift()].name;
  return f
};
...
l.prototype.getReferencedColumnIndexes = function() {
  ...
  for (a = 0; a < this.readers.length; a += 1)
    c = this.readers[a], c.columnIndex !== void 0 && b.push(c.columnIndex);
  return b
};
