...
!function(a, b, c, d) {
  function e(b, c) {
    this.element = a(b), this.settings = a.extend({}, v, c), this._defaults = v,
    this._name = u, this.init()
  }
  function f(a) {
  ...
  function j(a) {
    if (a.settings.infoText) {
      var b = a.elements.select1.find('option').length,
          ...
          e = a.selectedElements, f = '';
      f = 0 === d ? a.settings.infoTextEmpty :
                    b === d ? i(a.settings.infoText, [b, d]) :
                              i(a.settings.infoTextFiltered, [b, d]),
      a.elements.info1.html(f),
      a.elements.box1.toggleClass('filtered', !(b === d || 0 === d)),
      f = 0 === e ? a.settings.infoTextEmpty :
                    c === e ? i(a.settings.infoText, [c, e]) :
  ...
  function k(b) {
    b.selectedElements = 0, b.elements.select1.empty(),
    b.elements.select2.empty(), b.element.find('option').each(function(c, d) {
      var e = a(d);
      e.prop('selected') ? (b.selectedElements++,
                            b.elements.select2.append(e.clone(!0).prop(
                                'selected', e.data('_selected')))) :
                           b.elements.select1.append(e.clone(!0).prop(
                               'selected', e.data('_selected')))
    }),
  ...
  function l(b, c) {
    if (b.settings.showFilterInputs) {
      ...
      var d = new RegExp(a.trim(b.elements['filterInput' + c].val()), 'gi'),
          e = b.element;
      e = 1 === c ? e.find('option').not(':selected') :
  ...
  function n(b) {
    b.find('option')
        .sort(function(b, c) {
          return a(b).data('original-index') > a(c).data('original-index') ? 1 :
                                                                             -1
        })
        .appendTo(b)
  }
  ...
  e.prototype = {
    init: function() {
      this.container =
          a('<div class="bootstrap-duallistbox-container"> <div class="box1">   <label></label>   <span class="info-container">     <span class="info"></span>     <button type="button" class="btn clear1 pull-right"></button>   </span>   <input class="filter" type="text">   <div class="btn-group buttons">     <button type="button" class="btn moveall">       <i></i>       <i></i>     </button>     <button type="button" class="btn move">       <i></i>     </button>   </div>   <select multiple="multiple"></select> </div> <div class="box2">   <label></label>   <span class="info-container">     <span class="info"></span>     <button type="button" class="btn clear2 pull-right"></button>   </span>   <input class="filter" type="text">   <div class="btn-group buttons">     <button type="button" class="btn remove">       <i></i>     </button>     <button type="button" class="btn removeall">       <i></i>       <i></i>     </button>   </div>   <select multiple="multiple"></select> </div></div>')
      ...
      var b = 'bootstrap-duallistbox-nonselected-list_' +
      ...
      return this.elements.select1.attr('id', b),
             ...
             this.selectedElements = 0, this.elementCount = 0,
             ...
             this.element.hide(), t(this), k(this), this.element
    },
    setBootstrap2Compatible: function(a, b) {
      return this.settings
                 .bootstrap2Compatible = a,
    a ? (this.container.removeClass('row').addClass('row-fluid bs2compatible'),
    ...
    setSelectOrMinimalHeight: function(a, b) {
      ...
      return this.element.height() < a && (c = a),
             this.elements.select1.height(c), this.elements.select2.height(c),
             b && k(this), this.element
    },
    setShowFilterInputs: function(a, b) {
      return a ? (this.elements.filterInput1.show(),
                  this.elements.filterInput2.show()) :
                 (this.setNonSelectedFilter(''), this.setSelectedFilter(''),
                  k(this), this.elements.filterInput1.hide(),
    ...
    setSelectedFilter: function(a, b) {
      return this.settings.showFilterInputs ?
          (this.settings.selectedFilter = a, this.elements.filterInput2.val(a),
           b && k(this), this.element) :
          void 0
    },
    ...
    destroy: function() {
      return this.container.remove(), this.element.show(),
             a.data(this, 'plugin_' + u, null), this.element
    }
  },
  a.fn[u] = function(b) {
    var c = arguments;
      ...
      return this.each(function() {
        a(this).is('select') ? a.data(this, 'plugin_' + u) ||
                a.data(this, 'plugin_' + u, new e(this, b)) :
                               a(this).find('select').each(function(c, d) {
