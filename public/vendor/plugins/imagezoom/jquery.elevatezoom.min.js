/* jQuery elevateZoom 3.0.7 - Demo's and documentation: -
 * www.elevateweb.co.uk/image-zoom - Copyright (c) 2013 Andrew Eades -
 * www.elevateweb.co.uk - Dual licensed under the LGPL licenses. -
...
var k = {
  init: function(b, a) {
    ...
    c.elem = a;
    c.$elem = d(a);
    c.imageSrc = c.$elem.data('zoom-image') ? c.$elem.data('zoom-image') :
                                              c.$elem.attr('src');
    ...
    d('#' + c.options.gallery + ' a').click(function(a) {
      c.options.galleryActiveClass &&
          (d('#' + c.options.gallery + ' a')
               .removeClass(c.options.galleryActiveClass),
           d(this).addClass(c.options.galleryActiveClass));
      a.preventDefault();
      d(this).data('zoom-image') ? c.zoomImagePre = d(this).data('zoom-image') :
  ...
  startZoom: function() {
    ...
    b.options.imageCrossfade &&
        (b.zoomWrap = b.$elem.wrap(
             '<div style="height:' + b.nzHeight + 'px;width:' + b.nzWidth +
    ...
    'window' == b.options.zoomType &&
        (b.zoomWindowStyle =
             ...
             ';width: ' + String(b.options.zoomWindowWidth) +
             'px;height: ' + String(b.options.zoomWindowHeight) +
             'px;float: left;background-size: ' +
             b.largeWidth / b.currentZoomLevel + 'px ' +
             b.largeHeight / b.currentZoomLevel +
             'px;display: none;z-index:100;border: ' +
             String(b.options.borderSize) + 'px solid ' +
             b.options.borderColour +
             ';background-repeat: no-repeat;position: absolute;');
    if ('inner' == b.options.zoomType) {
      var a = b.$elem.css('border-left-width');
      b.zoomWindowStyle = 'overflow: hidden;margin-left: ' + String(a) +
          ';margin-top: ' + String(a) +
          ';background-position: 0px 0px;width: ' + String(b.nzWidth) +
          'px;height: ' + String(b.nzHeight) +
          'px;float: left;display: none;cursor:' + b.options.cursor +
    ...
    'window' == b.options.zoomType &&
        (lensHeight = b.nzHeight < b.options.zoomWindowWidth / b.widthRatio ?
         ...
         b.lensStyle = 'background-position: 0px 0px;width: ' +
             String(b.options.zoomWindowWidth / b.widthRatio) + 'px;height: ' +
             String(b.options.zoomWindowHeight / b.heightRatio) +
             'px;float: right;display: none;overflow: hidden;z-index: 999;-webkit-transform: translateZ(0);opacity:' +
             b.options.lensOpacity +
             ';filter: alpha(opacity = ' + 100 * b.options.lensOpacity +
             '); zoom:1;width:' + lensWidth + 'px;height:' + lensHeight +
             'px;background-color:' + b.options.lensColour + ';cursor:' +
             b.options.cursor + ';border: ' + b.options.lensBorderSize +
             'px solid ' + b.options.lensBorderColour +
             ';background-repeat: no-repeat;position: absolute;');
    b.tintStyle = 'display: block;position: absolute;background-color: ' +
        b.options.tintColour +
        ';filter:alpha(opacity=0);opacity: 0;width: ' + b.nzWidth +
        'px;height: ' + b.nzHeight + 'px;';
    b.lensRound = '';
    'lens' == b.options.zoomType &&
        (b.lensStyle =
             'background-position: 0px 0px;float: left;display: none;border: ' +
             String(b.options.borderSize) + 'px solid ' +
             b.options.borderColour + ';width:' + String(b.options.lensSize) +
             'px;height:' + String(b.options.lensSize) +
             'px;background-repeat: no-repeat;position: absolute;');
    'round' == b.options.lensShape &&
        (b.lensRound = 'border-top-left-radius: ' +
    ...
    b.zoomContainer = d(
        ...
        b.nzOffset.left + 'px;top:' + b.nzOffset.top +
        'px;height:' + b.nzHeight + 'px;width:' + b.nzWidth + 'px;"></div>');
    d('body').append(b.zoomContainer);
    b.options.containLensZoom && 'lens' == b.options.zoomType &&
        b.zoomContainer.css('overflow', 'hidden');
    'inner' != b.options.zoomType &&
        (b.zoomLens = d('<div class=\'zoomLens\' style=\'' + b.lensStyle +
                        b.lensRound + '\'>&nbsp;</div>')
         ...
         b.options.tint &&
             (b.tintContainer = d('<div/>').addClass('tintContainer'),
              b.zoomTint =
                  d('<div class=\'zoomTint\' style=\'' + b.tintStyle +
                    '\'></div>'),
              b.zoomLens.wrap(b.tintContainer),
              b.zoomTintcss = b.zoomLens.after(b.zoomTint),
              b.zoomTintImage =
                  d('<img style="position: absolute; left: 0px; top: 0px; max-width: none; width: ' +
                    b.nzWidth + 'px; height: ' + b.nzHeight + 'px;" src="' +
                    b.imageSrc + '">')
                      .appendTo(b.zoomLens)
                      .click(function() {
                        b.$elem.trigger('click')
    ...
    isNaN(b.options.zoomWindowPosition) ?
        b.zoomWindow =
            d('<div style=\'z-index:999;left:' + b.windowOffsetLeft +
              'px;top:' + b.windowOffsetTop + 'px;' + b.zoomWindowStyle +
    ...
    b.options.tint && 'inner' != b.options.zoomType &&
    ...
    b.options.scrollZoom &&
        b.zoomContainer.add(b.$elem).bind(
            'mousewheel DOMMouseScroll MozMousePixelScroll', function(a) {
              b.scrollLock = !0;
              ...
              a.stopPropagation();
              a.preventDefault();
              0 < e / 120 ? b.currentZoomLevel >= b.minZoomLevel &&
                      b.changeZoomLevel(
  ...
  setPosition: function(b) {
    ...
    'window' == this.options.zoomType &&
        (this.Etoppos = this.mouseTop<
                                this.zoomLens.height() / 2,
                                this.Eboppos = this.mouseTop>this.nzHeight -
             this.zoomLens.height() / 2 - 2 * this.options.lensBorderSize,
         this.Eloppos = this.mouseLeft<
                                0 + this.zoomLens.width() / 2,
                                this.Eroppos = this.mouseLeft>this.nzWidth -
             this.zoomLens.width() / 2 - 2 * this.options.lensBorderSize);
    ...
    0 >= this.mouseLeft || 0 > this.mouseTop || this.mouseLeft > this.nzWidth ||
            this.mouseTop > this.nzHeight ?
        this.setElements('hide') :
        (this.options.showLens &&
             (this.lensLeftPos =
                  String(this.mouseLeft - this.zoomLens.width() / 2),
              this.lensTopPos =
                  String(this.mouseTop - this.zoomLens.height() / 2)),
         ...
         'window' == this.options.zoomType &&
             (this.Eboppos &&
                  (this.lensTopPos = Math.max(
                       this.nzHeight - this.zoomLens.height() -
                           2 * this.options.lensBorderSize,
                       0)),
              this.Eroppos &&
                  (this.lensLeftPos = this.nzWidth - this.zoomLens.width() -
                       2 * this.options.lensBorderSize)),
         'inner' == this.options.zoomType &&
             (this.Eboppos &&
                  (this.lensTopPos = Math.max(
                       this.nzHeight - 2 * this.options.lensBorderSize, 0)),
              this.Eroppos &&
                  (this.lensLeftPos = this.nzWidth - this.nzWidth -
                       2 * this.options.lensBorderSize)),
         'lens' == this.options.zoomType &&
             (this.windowLeftPos = String(
              ...
              this.changeBgSize &&
                  (this.nzHeight > this.nzWidth ?
                       ('lens' == this.options.zoomType && this.zoomLens.css({
                         'background-size':
                             this.largeWidth / this.newvalueheight + 'px ' +
                       ...
                       ('lens' == this.options.zoomType && this.zoomLens.css({
                         'background-size':
                             this.largeWidth / this.newvaluewidth + 'px ' +
         ...
         this.options.showLens &&
             (this.fullwidth && 'lens' != this.options.zoomType &&
                  (this.lensLeftPos = 0),
              this.zoomLens.css({
  ...
  showHideWindow: function(b) {
    'show' != b || this.isWindowActive ||
        (this.options.zoomWindowFadeIn ?
             this.zoomWindow.stop(!0, !0, !1)
                 .fadeIn(this.options.zoomWindowFadeIn) :
             this.zoomWindow.show(),
         this.isWindowActive = !0);
    'hide' == b && this.isWindowActive &&
        (this.options.zoomWindowFadeOut ? this.zoomWindow.stop(!0, !0).fadeOut(
                                              this.options.zoomWindowFadeOut) :
                                          this.zoomWindow.hide(),
         this.isWindowActive = !1)
  },
  showHideLens: function(b) {
    'show' != b || this.isLensActive ||
        (this.options.lensFadeIn ?
             this.zoomLens.stop(!0, !0, !1).fadeIn(this.options.lensFadeIn) :
             this.zoomLens.show(),
         this.isLensActive = !0);
    'hide' == b && this.isLensActive &&
  ...
  showHideTint: function(b) {
    'show' != b || this.isTintActive ||
        (this.options.zoomTintFadeIn ?
             this.zoomTint.css({opacity: this.options.tintOpacity})
                 .animate()
                 .stop(!0, !0)
                 .fadeIn('slow') :
          ...
          a.options.zoomWindowHeight > a.nzHeight &&
              (a.windowOffsetTop = a.nzHeight,
               a.windowOffsetLeft = -1 *
                   (a.options.zoomWindowWidth / 2 - a.nzWidth / 2 +
           ...
           a.loop ||
               (a.loop = setInterval(
                    function() {
                      ...
                      a.scrollingLock ?
                          (clearInterval(a.loop), a.xp = a.windowLeftPos,
                           a.yp = a.windowTopPos,
                           a.xp = -1 *
                               ((b.pageX - a.nzOffset.left) * a.widthRatio -
                                a.zoomWindow.width() / 2),
               ...
               (a.nzHeight > a.nzWidth ?
                    ('lens' == a.options.zoomType && a.zoomLens.css({
                      'background-size': a.largeWidth / a.newvalueheight +
                          'px ' + a.largeHeight / a.newvalueheight + 'px'
                    }),
                     a.zoomWindow.css({
                       'background-size': a.largeWidth / a.newvalueheight +
                           'px ' + a.largeHeight / a.newvalueheight + 'px'
  ...
  setTintPosition: function(b) {
    this.nzOffset = this.$elem.offset();
    this.tintpos =
        String(-1 * (b.pageX - this.nzOffset.left - this.zoomLens.width() / 2));
    this.tintposy =
        String(-1 * (b.pageY - this.nzOffset.top - this.zoomLens.height() / 2));
    ...
    this.Eroppos &&
        (this.tintpos = -1 *
             (this.nzWidth - this.zoomLens.width() -
              2 * this.options.lensBorderSize));
    this.options.tint &&
  ...
  swaptheimage: function(b, a) {
    ...
    c.options.loadingIcon &&
        (c.spinner = d(
             '<div style="background: url(\'' + c.options.loadingIcon +
             '\') no-repeat center;height:' + c.nzHeight +
             'px;width:' + c.nzWidth +
  ...
  swapAction: function(b, a) {
    ...
    if (c.options.imageCrossfade) {
      ...
      c.options.tint && 'inner' != c.options.zoomType &&
          (f = c.zoomTintImage, g = f.clone(), c.zoomTintImage.attr('src', a),
  ...
  changeZoomLevel: function(b) {
    ...
    'inner' == this.options.zoomType &&
        (maxheightnewvalue =
             parseFloat(this.largeHeight / this.nzHeight).toFixed(2),
         maxwidthtnewvalue =
             parseFloat(this.largeWidth / this.nzWidth).toFixed(2),
    ...
    scrcontinue &&
        (this.zoomLock = 0, this.changeZoom = !0,
