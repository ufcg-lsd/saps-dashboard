...
Plugin.prototype = {
  ...
  serialize: function() {
    ...
    step = function(level, depth) {
      ...
      items.each(function() {
        var li = $(this), item = $.extend({}, li.data()),
  ...
  dragStart: function(e) {
    var mouse = this.mouse, target = $(e.target),
    ...
    this.dragEl.css(
        {'left': e.pageX - mouse.offsetX, 'top': e.pageY - mouse.offsetY});
  ...
  dragMove: function(e) {
    ...
    var pointElRoot = this.pointEl.closest('.' + opt.rootClass),
        isNewRoot = this.dragRootEl.data('nestable-id') !==
    ...
    if (!mouse.dirAx || isNewRoot || isEmpty) {
      ...
      if (isEmpty) {
        list =
            $(document.createElement(opt.listNodeName)).addClass(opt.listClass);
        list.append(this.placeEl);
