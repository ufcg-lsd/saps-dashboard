...
'object' == typeof exports ?
    module.exports = e() :
    'function' == typeof define && define.amd ? define(e) : t.Spinner = e()
})(this, function() {
'use strict';
function t(t, e) {
...
function i(t, e, i, n) {
  ...
  return c[r] ||
             (p.insertRule(
                  '@' + l + 'keyframes ' + r + '{' +
                      '0%{opacity:' + a + '}' + o + '%{opacity:' + t + '}' +
                      (o + .01) + '%{opacity:1}' + (o + e) % 100 +
                      '%{opacity:' + t + '}' +
                      '100%{opacity:' + a + '}' +
                      '}',
                  p.cssRules.length),
...
function l() {
  function i(e, i) {
    return t(
        '<' + e + ' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">', i)
  }
  p.addRule('.spin-vml', 'behavior:url(#default#VML)'),
      s.prototype.lines = function(t, n) {
        ...
        function s(t, s, l) {
          e(p,
            e(r(o(), {rotation: 360 / n.lines * t + 'deg', left: ~~s}),
        ...
        var l, u = n.length + n.width, d = 2 * u,
        ...
        r && r.childNodes.length > e + n &&
            (r = r.childNodes[e + n], r = r && r.firstChild,
...
s.defaults = {}, o(s.prototype, {
  spin: function(e) {
    ...
    var i = this, n = i.opts,
        o = i.el =
            r(t(0, {className: n.className}),
              {position: n.position, width: 0, zIndex: n.zIndex});
    if (n.radius + n.length + n.width, r(o, {left: n.left, top: n.top}),
        e && e.insertBefore(o, e.firstChild || null),
        o.setAttribute('role', 'progressbar'), i.lines(o, i.opts), !u) {
      var a, s = 0, l = (n.lines - 1) * (1 - n.direction) / 2, d = n.fps,
             c = d / n.speed, p = (1 - n.opacity) / (c * n.trail / 100),
             f = c / n.lines;
      (function h() {
        s++;
  ...
  stop: function() {
    ...
    return t &&
               (clearTimeout(this.timeout),
                t.parentNode && t.parentNode.removeChild(t), this.el = void 0),
           this
  },
  lines: function(n, o) {
    function s(e, i) {
    ...
    for (var l, d = 0, c = (o.lines - 1) * (1 - o.direction) / 2; o.lines > d;
         d++)
      l = r(t(), {
        position: 'absolute',
        top: 1 + ~(o.width / 2) + 'px',
...
'object' == typeof exports ?
    ...
    'function' == typeof define && define.amd ? define(['spin'], e) :
                                                t.Ladda = e(t.Spinner)
})(this, function(t) {
'use strict';
function e(t) {
  ...
  var r, a = {
    start: function() {
      return e || (e = o(t)), t.setAttribute('disabled', ''),
             t.setAttribute('data-loading', ''), clearTimeout(r), e.spin(n),
    ...
    stop: function() {
      return t.removeAttribute('disabled'), t.removeAttribute('data-loading'),
             clearTimeout(r), e && (r = setTimeout(function() {
                                      e.stop()
                                    }, 1e3)), this
    },
    toggle: function() {
      ...
      0 === e && n && n.parentNode ?
          ...
          (n ||
               (n = document.createElement('div'),
                n.className = 'ladda-progress', t.appendChild(n)),
    ...
    remove: function() {
      clearTimeout(r), t.removeAttribute('disabled', ''),
          t.removeAttribute('data-loading', ''), e && (e.stop(), e = null);
