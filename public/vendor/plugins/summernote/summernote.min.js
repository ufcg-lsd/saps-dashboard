!function(a) {
  ...
  'function' != typeof Array.prototype.reduce &&
      ...
      (Array.prototype.filter = function(a) {
        ...
        for (var d = [], e = arguments.length >= 2 ? arguments[1] : void 0,
                 f = 0;
             c > f; f++)
          if (f in b) {
            var g = b[f];
  ...
  var z = function() {
    var c = a(window), d = a(document), f = a('html, body'), h = new s,
        i = new v, k = new w, l = new x, o = new y;
    ...
    var p =
      ...
      var d;
      return d = c.is('.note-editor, .note-air-editor') ?
                 c :
        ...
        q =
            function(b, c) {
          var d = b.editor(), e = b.editable(), f = e.data('callbacks'),
              g = d.data('options');
          f.onImageUpload ?
              f.onImageUpload(c, h, e) :
              a.each(c, function(a, b) {
                var c = b.name;
                g.maximumImageFileSize && g.maximumImageFileSize < b.size ?
                    f.onImageUploadError ?
                    f.onImageUploadError(
                        g.langInfo.image.maximumFileSizeError) :
                    alert(g.langInfo.image.maximumFileSizeError) :
                    m.readFileAsDataURL(b)
                        .then(function(a) {
                          h.insertImage(e, a, c)
                        })
                        .fail(function() {
        ...
        r = {
          showLinkDialog: function(a) {
            var b = a.editor(), c = a.dialog(), d = a.editable(),
                e = h.getLinkInfo(d), f = b.data('options');
            h.saveRange(d),
                o.showLinkDialog(d, c, e)
                    .then(function(b) {
                      h.restoreRange(d), h.createLink(d, b, f),
                          k.hide(a.popover())
                    })
                    .fail(function() {
                      h.restoreRange(d)
          ...
          fullscreen: function(a) {
            var b = a.editor(), d = a.toolbar(), e = a.editable(),
                g = a.codable(), h = function(a) {
                  e.css('height', a.h), g.css('height', a.h),
                      g.data('cmeditor') &&
                      g.data('cmeditor').setsize(null, a.h)
                };
            b.toggleClass('fullscreen');
            var j = b.hasClass('fullscreen');
            j ? (e.data('orgheight', e.css('height')),
                 c.on('resize',
                      function() {
                ...
                (c.off('resize'), h({h: e.data('orgheight')}),
                 f.css('overflow', 'visible')),
                i.updateFullscreen(d, j)
          },
          codeview: function(a) {
            var c, d, f = a.editor(), g = a.toolbar(), h = a.editable(),
                      m = a.codable(), n = a.popover(), o = a.handle(),
                      p = f.data('options');
            f.toggleClass('codeview');
            var q = f.hasClass('codeview');
            q ? (m.val(j.html(h, !0)), m.height(h.height()), i.deactivate(g),
                 k.hide(n), l.hide(o), m.focus(),
                 e.hasCodeMirror &&
                     (c = b.fromTextArea(m[0], p.codemirror),
                      p.codemirror.tern &&
                          (d = new b.TernServer(p.codemirror.tern),
                           c.ternServer = d,
                           c.on(
                               'cursorActivity',
                               function(a) {
                      ...
                      m.data('cmEditor', c))) :
                (e.hasCodeMirror &&
                     (c = m.data('cmEditor'), m.val(c.getValue()),
                      c.toTextArea()),
                 h.html(j.value(m) || j.emptyPara),
                 h.height(p.height ? m.height() : 'auto'), i.activate(g),
                 h.focus()),
        ...
        u = function(a) {
          ...
          if (b && b.items && b.items.length) {
            var c = p(a.currentTarget || a.target), d = c.editable(),
                e = g.head(b.items),
          ...
          if (j.isControlSizing(b.target)) {
            ...
            var c = p(b.target), e = c.handle(), f = c.popover(),
                g = c.editable(), i = c.editor(),
                m = e.find('.note-control-selection').data('target'), n = a(m),
                o = n.offset(), q = d.scrollTop(),
                r = i.data('options').airMode;
            d.on('mousemove', function(a) {
               h.resizeTo(
                   {x: a.clientX - o.left, y: a.clientY - (o.top - q)}, n,
                   !a.shiftKey),
                   l.update(e, {image: m}, r), k.update(f, {image: m}, r)
          ...
          var c = a(b.target).closest('[data-event]');
          if (c.length) {
            var d = c.attr('data-event'), e = c.attr('data-value'),
                f = c.attr('data-hide'), j = p(b.target);
            b.preventDefault();
            var l;
            if (-1 !==
                a.inArray(
                    d, ['resize', 'floatMe', 'removeMedia', 'imageShape'])) {
            ...
            if (f && c.parents('.popover').hide(), h[d]) {
              ...
              r[d] ? r[d].call(this, j) :
                     a.isFunction(a.summernote.pluginEvents[d]) &&
                      a.summernote.pluginEvents[d](j, e, l);
          ...
          d.on('mousemove', function(a) {
             ...
             d = f.maxHeight > 0 ? Math.min(d, f.maxHeight) : d, b.height(d)
           }).one('mouseup', function() {
            d.off('mousemove')
          })
        }, H = 18, I = function(b, c) {
          var d, e = a(b.target.parentNode), f = e.next(),
          ...
          h.css({width: k.c + 'em', height: k.r + 'em'}),
              ...
              3 < k.c && k.c < c.insertTableMaxSize.col &&
              i.css({width: k.c + 1 + 'em'}),
              3 < k.r && k.r < c.insertTableMaxSize.row &&
          ...
          var e = a(), f = b.dropzone,
              g = b.dropzone.find('.note-dropzone-message');
          d.on('dragenter',
               function(a) {
                 var d = b.editor.hasClass('codeview');
                 d || e.length ||
                     (b.editor.addClass('dragover'), f.width(b.editor.width()),
                      f.height(b.editor.height()),
    ...
    this.bindKeyMap = function(b, c) {
      ...
      b = p(e), e.on('keydown', function(f) {
        var g = [];
        f.metaKey && g.push('CMD'), f.ctrlKey && !f.altKey && g.push('CTRL'),
      ...
      b.shortcuts && this.bindKeyMap(a, b.keyMap[e.isMac ? 'mac' : 'pc']),
          a.editable.on('mousedown', u), a.editable.on('keyup mouseup', z),
          a.editable.on('scroll', A), a.editable.on('paste', B),
          a.handle.on('mousedown', C), a.popover.on('click', E),
          a.popover.on('mousedown', D),
          b.airMode ||
          (J(a, b), a.toolbar.on('click', E), a.toolbar.on('mousedown', D),
           b.disableResizeEditor || a.statusbar.on('mousedown', G));
      ...
      if (a.editable.data('NoteHistory', f),
          ...
          b.onToolbarClick && a.toolbar.click(b.onToolbarClick), b.onChange) {
        var g = function() {
      ...
      a.editable.off(), a.popover.off(), a.handle.off(), a.dialog.off(),
          b.airMode || (a.dropzone.off(), a.toolbar.off(), a.statusbar.off())
    }
  }, A = function() {
    var b =
            function(a, b) {
      var c = b.event, d = b.value, e = b.title, f = b.className,
          g = b.dropdown, h = b.hide;
      return '<button type="button" class="btn btn-default btn-sm btn-small' +
          ...
          (c ? ' data-event="' + c + '"' : '') +
          (d ? ' data-value=\'' + d + '\'' : '') +
          (h ? ' data-hide=\'' + h + '\'' : '') + ' tabindex="-1">' + a +
          (g ? ' <span class="caret"></span>' : '') + '</button>' + (g || '')
    },
        c =
            function(a, c) {
          var d = '<i class="' + a + '"></i>';
        ...
        g =
          ...
          return '<div class="' + a +
              ...
              (b ? '<div class="modal-header"><button type="button" class="close" aria-hidden="true" tabindex="-1">&times;</button><h4 class="modal-title">' +
                       b + '</h4></div>' :
                   '') +
              '<form class="note-modal-form"><div class="modal-body">' + c +
              '</div>' +
        ...
        h = {
          ...
          link: function(a) {
            return c(
                'fa fa-link',
                {event: 'showLinkDialog', title: a.link.link, hide: !0})
          },
          table: function(a) {
            var b =
          ...
          style: function(a, b) {
            var d = b.styleTags.reduce(function(b, c) {
              ...
              return b +
                  '<li><a data-event="formatBlock" href="#" data-value="' + c +
                  '">' +
                  ('p' === c || 'pre' === c ?
                       d :
                       '<' + c + '>' + d + '</' + c + '>') +
          ...
          fontname: function(a, c) {
            var d = c.fontNames.reduce(
                    function(a, b) {
                      return e.isFontInstalled(b) ?
                          a + '<li><a data-event="fontName" href="#" data-value="' +
                              b + '"><i class="fa fa-check"></i> ' + b +
                              '</a></li>' :
                          a
                    },
                    ''),
                f = '<span class="note-current-fontname">' + c.defaultFontName +
                '</span>';
            return b(f, {
              title: a.font.name,
              dropdown: '<ul class="dropdown-menu">' + d + '</ul>'
          ...
          color: function(a) {
            var c = '<i class="fa fa-font" style="color:black;background-color:yellow;"></i>',
                ...
                e = '<ul class="dropdown-menu"><li><div class="btn-group"><div class="note-palette-title">' +
                a.color.background +
          ...
          underline: function(a) {
            return c(
                'fa fa-underline',
                {event: 'underline', title: a.font.underline})
          },
          clear: function(a) {
            return c(
                'fa fa-eraser', {event: 'removeFormat', title: a.font.clear})
          },
          ul: function(a) {
            return c(
                'fa fa-list-ul',
                {event: 'insertUnorderedList', title: a.lists.unordered})
          },
          ol: function(a) {
            return c(
                'fa fa-list-ol',
                {event: 'insertOrderedList', title: a.lists.ordered})
          },
          paragraph: function(a) {
            var b =
                ...
                d =
                    c('fa fa-align-center',
                      {title: a.paragraph.center, event: 'justifyCenter'}),
                e =
                    c('fa fa-align-right',
                      {title: a.paragraph.right, event: 'justifyRight'}),
                f =
                    c('fa fa-align-justify',
                      {title: a.paragraph.justify, event: 'justifyFull'}),
                g =
                    c('fa fa-outdent',
                      {title: a.paragraph.outdent, event: 'outdent'}),
                h =
                    c('fa fa-indent',
                      {title: a.paragraph.indent, event: 'indent'}),
                i = '<div class="dropdown-menu"><div class="note-align btn-group">' +
                b + d + e + f + '</div><div class="note-list btn-group">' + h +
                g + '</div></div>';
            return c(
                'fa fa-align-left', {title: a.paragraph.paragraph, dropdown: i})
          },
          height: function(a, b) {
            var d = b.lineHeights.reduce(function(a, b) {
              return a +
                  '<li><a data-event="lineHeight" href="#" data-value="' +
                  parseFloat(b) + '"><i class="fa fa-check"></i> ' + b +
                  '</a></li>'
            }, '');
          ...
          fullscreen: function(a) {
            return c(
                'fa fa-arrows-alt',
                {event: 'fullscreen', title: a.options.fullscreen})
          },
          codeview: function(a) {
            return c(
                'fa fa-code', {event: 'codeview', title: a.options.codeview})
          },
          undo: function(a) {
        ...
        i =
          ...
          var f = function() {
            var b =
                    c('fa fa-edit',
                      {title: a.link.edit, event: 'showLinkDialog', hide: !0}),
                e = c('fa fa-unlink', {title: a.link.unlink, event: 'unlink'}),
                f = '<a href="http://www.google.com" target="_blank">www.google.com</a>&nbsp;&nbsp;<div class="note-insert btn-group">' +
                b + e + '</div>';
            return d('note-link-popover', f)
          }, g = function() {
            var e =
                    b('<span class="note-fontsize-10">100%</span>',
                      {title: a.image.resizeFull, event: 'resize', value: '1'}),
                f = b(
                    '<span class="note-fontsize-10">50%</span>',
                    {title: a.image.resizeHalf, event: 'resize', value: '0.5'}),
                ...
                n = c(
                    'fa fa-times',
                    {title: a.image.shapeNone, event: 'imageShape', value: ''}),
                o = c('fa fa-trash-o', {
                  title: a.image.remove,
                  event: 'removeMedia',
                  value: 'none'
                }),
                p = '<div class="btn-group">' + e + f + g +
                '</div><div class="btn-group">' + h + i + j +
                '</div><div class="btn-group">' + k + l + m + n +
                '</div><div class="btn-group">' + o + '</div>';
          ...
          return '<div class="note-popover">' + f() + g() +
              (e.airMode ? i() : '') + '</div>'
        },
        k =
            function() {
        ...
        l =
          ...
          for (var e in b)
            d.push(
                '<div class="' + c + 'key">' + b[e].kbd + '</div><div class="' +
                c + 'name">' + b[e].text + '</div>');
          return '<div class="note-shortcut-row row"><div class="' + c +
              'title col-xs-offset-6">' + a +
              '</div></div><div class="note-shortcut-row row">' +
              d.join('</div><div class="note-shortcut-row row">') + '</div>'
        },
        m =
            function(a) {
          var b = [
        ...
        r =
          ...
          var c = 'class="note-shortcut note-shortcut-col col-sm-6 col-xs-12"',
              d = [
                '<div ' + c + '>' + n(a, b) + '</div><div ' + c + '>' +
                    m(a, b) + '</div>',
                '<div ' + c + '>' + p(a, b) + '</div><div ' + c + '>' +
                    o(a, b) + '</div>'
              ];
        ...
        t = {
          image: function(a, b) {
            ...
            if (b.maximumImageFileSize) {
              var d = Math.floor(
                  ...
                  e = 1 *
                      (b.maximumImageFileSize / Math.pow(1024, d)).toFixed(2) +
                  ' ' +
                  ' KMGTP'[d] + 'B';
              c = '<small>' + a.image.maximumFileSize + ' : ' + e + '</small>'
            }
            var f = '<div class="form-group row-fluid note-group-select-from-files"><label>' +
                a.image.selectFromFiles +
                '</label><input class="note-image-input" type="file" name="files" accept="image/*" />' +
                c + '</div><div class="form-group row-fluid"><label>' +
                a.image.url +
                '</label><input class="note-image-url form-control span12" type="text" /></div>',
                h = '<button href="#" class="btn btn-primary note-image-btn disabled" disabled>' +
                a.image.insert + '</button>';
            return g('note-image-dialog', a.image.insert, f, h)
          },
          link: function(a, b) {
            var c = '<div class="form-group row-fluid"><label>' +
                ...
                (b.disableLinkTarget ?
                     ...
                     '<div class="checkbox"><label><input type="checkbox" checked> ' +
                         a.link.openInNewWindow + '</label></div>'),
                d = '<button href="#" class="btn btn-primary note-link-btn disabled" disabled>' +
          ...
          help: function(a, b) {
            var c =
                ...
                a.shortcut.close + '</a><div class="title">' +
                a.shortcut.shortcuts + '</div>' +
                (e.isMac ? r(a, b) : s(r(a, b))) +
                '<p class="text-center"><a href="//hackerwins.github.io/summernote/" target="_blank">Summernote 0.6.0</a> · <a href="//github.com/HackerWins/summernote" target="_blank">Project</a> · <a href="//github.com/HackerWins/summernote/issues" target="_blank">Issues</a></p>';
        ...
        u = function(b, c) {
          ...
          g.each(function(b, c) {
             ...
             f && d.attr('title', function(a, b) {
              ...
              .tooltip(
                  {container: 'body', trigger: 'hover', placement: d || 'top'})
              .on('click', function() {
                a(this).tooltip('hide')
              })
        }, y = function(b, c) {
          ...
          b.find('.note-color-palette').each(function() {
            for (var b = a(this), c = b.attr('data-target-event'), e = [],
                     f = 0, g = d.length;
                 g > f; f++) {
              for (var h = d[f], i = [], j = 0, k = h.length; k > j; j++) {
                ...
                i.push([
                  ...
                  l, ';" data-event="', c, '" data-value="', l, '" title="', l,
    ...
    this.createLayoutByAirMode = function(b, c) {
      var d = c.langInfo, g = c.keyMap[e.isMac ? 'mac' : 'pc'],
          h = f.uniqueId();
      b.addClass('note-air-editor note-editable'),
          b.attr({id: 'note-editor-' + h, contentEditable: !0});
      var j = document.body, l = a(i(d, c));
      l.addClass('note-air-layout'), l.attr('id', 'note-popover-' + h),
          l.appendTo(j), x(l, g), y(l, c);
      var m = a(k());
      m.addClass('note-air-layout'), m.attr('id', 'note-handle-' + h),
          m.appendTo(j);
      var n = a(u(d, c));
      n.addClass('note-air-layout'), n.attr('id', 'note-dialog-' + h),
      ...
      c.width && f.width(c.width),
          c.height > 0 &&
          a('<div class="note-statusbar">' +
            (c.disableResizeEditor ? '' : v()) + '</div>')
              .prependTo(f);
      var g = !b.is(':disabled'),
          l = a('<div class="note-editable" contentEditable="' + g + '"></div>')
                  .prependTo(f);
      ...
      B.find('button.close, a.modal-close').click(function() {
        a(this).closest('.modal').modal('hide')
          ...
          a('<div class="note-dropzone"><div class="note-dropzone-message"></div></div>')
              .prependTo(f),
          f.insertAfter(b), b.hide()
    }, this.noteEditorFromHolder = function(b) {
      return b.hasClass('note-air-editor') ?
          b :
          b.next().hasClass('note-editor') ? b.next() : a()
    }, this.createLayout = function(a, b) {
      this.noteEditorFromHolder(a).length ||
          (b.airMode ? this.createLayoutByAirMode(a, b) :
      ...
      c.airMode ? (a.removeClass('note-air-editor note-editable')
                       .removeAttr('id contentEditable'),
                   b.popover.remove(), b.handle.remove(), b.dialog.remove()) :
                  (a.html(b.editable.html()), b.editor.remove(), a.show())
    }, this.getTemplate = function() {
      return {
        button: b, iconButton: c, dialog: g
      }
      ...
      a.summernote.addPlugin = function(b) {
        ...
        summernote: function(b) {
          if (b = a.extend({}, a.summernote.options, b),
              b.langInfo = a.extend(
                  !0, {}, a.summernote.lang['en-US'],
                  a.summernote.lang[b.lang]),
