...
(function(e) {
var t, n, i, o, r, a, s,
    l = 'Close', c = 'BeforeClose', d = 'AfterClose', u = 'BeforeAppend',
    p = 'MarkupParse', f = 'Open', m = 'Change', g = 'mfp', h = '.' + g,
    v = 'mfp-ready', C = 'mfp-removing', y = 'mfp-prevent-close',
    w = function() {}, b = !!window.jQuery, I = e(window), x = function(e, n) {
      t.ev.on(g + e + h, n)
    }, k = function(t, n, i, o) {
      var r = document.createElement('div');
      return r.className = 'mfp-' + t, i && (r.innerHTML = i),
...
w
  ...
  init: function() {
    ...
    t.isAndroid = /android/gi.test(n), t.isIOS = /iphone|ipad|ipod/gi.test(n),
  ...
  open: function(n) {
    ...
    t.fixedContentPos = 'auto' === t.st.fixedContentPos ? !t.probablyMobile :
    ...
    return t.isIE7 && (C += ' mfp-ie7'), C && t._addClassToMFP(C),
           t.updateItemHTML(), T('BuildControls'), e('html').css(m),
  ...
  _close: function() {
    ...
    if (t.bgOverlay.detach(), t.wrap.detach(), t.container.empty(),
        t.st.mainClass && (n += t.st.mainClass + ' '), t._removeClassFromMFP(n),
        t.fixedContentPos) {
      var i = {marginRight: ''};
      t.isIE7 ? e('body, html').css('overflow', '') : i.overflow = '',
                                                      e('html').css(i)
    }
    o.off('keyup' + h + ' focusin' + h), t.ev.off(h),
  ...
  updateItemHTML: function() {
    ...
    var a =
        t['get' + i.charAt(0).toUpperCase() + i.slice(1)](n, t.currTemplate[i]);
    t.appendContent(a, i), n.preloaded = !0, T(m, n), r = n.type,
                           t.container.prepend(t.contentContainer),
                           T('AfterChange')
  },
  appendContent: function(e, n) {
    t.content = e,
    e ? t.st.showCloseBtn && t.st.closeBtnInside && t.currTemplate[n] === !0 ?
        t.content.find('.mfp-close').length || t.content.append(E()) :
        t.content = e :
        t.content = '',
    T(u), t.container.addClass('mfp-' + n + '-holder'),
    t.contentContainer.append(t.content)
  },
  parseEl: function(n) {
    var i, o = t.items[n];
    if (o.tagName ? o = {el: e(o)} : (i = o.type, o = {data: o, src: o.src}),
        o.el) {
  ...
  addGroup: function(e, n) {
    ...
    n.items ? (n.isObj = !0, e.off(o).on(o, i)) :
              (n.isObj = !1,
               n.delegate ? e.off(o).on(o, n.delegate, i) :
  ...
  _openClick: function(n, i, o) {
    ...
    if (r || 2 !== n.which && !n.ctrlKey && !n.metaKey) {
      var a = void 0 !== o.disableOn ? o.disableOn :
  ...
  _parseMarkup: function(t, n, i) {
    var o;
    i.data && (n = e.extend(i.data, n)), T(p, [t, n, i]),
  ...
  _getScrollbarSize: function() {
   ...
   e.magnificPopup = {
     ...
     modules: [],
     open: function(t, n) {
       return _(), t = t ? e.extend(!0, {}, t) : {}, t.isObj = !0,
...
e.magnificPopup.registerModule(H, {
  ...
  proto: {
    initAjax: function() {
      t.types.push(H), F = t.st.ajax.cursor, x(l + '.' + H, A),
                       x('BeforeChange.' + H, A)
    },
    getAjax: function(n) {
      ...
      var o = e.extend(
          {
            ...
            success: function(i, o, r) {
              var a = {data: i, xhr: r};
              T('ParseAjax', a), t.appendContent(e(a.data), H),
                  n.finished = !0, L(), t._setFocus(), setTimeout(function() {
                    t.wrap.addClass(v)
                  }, 16), t.updateStatus('ready'), T('AjaxContentAdded')
            },
            error: function() {
              L(), n.finished = n.loadError = !0,
                   t.updateStatus(
                       'error', t.st.ajax.tError.replace('%url%', n.src))
            }
          },
          t.st.ajax.settings);
...
e.magnificPopup.registerModule('image', {
  ...
  proto: {
    ...
    _onImageHasSize: function(e) {
      e.img &&
          (e.hasSize = !0, j && clearInterval(j), e.isCheckingImgSize = !1,
           T('ImageHasSize', e),
           e.imgHidden &&
    ...
    getImage: function(n, i) {
        ...
        n &&
            (n.img[0].complete ?
                 (n.img.off('.mfploader'),
                  ...
                  n.hasSize = !0, n.loaded = !0, T('ImageLoadComplete')) :
      ...
      return t._parseMarkup(i, {title: N(n), img_replaceWith: n.img}, n),
             t.resizeImage(),
             n.hasSize ?
                 (j && clearInterval(j),
                  n.loadError ?
        ...
        x('BuildControls' + i, function() {
          if (t._allowZoom()) {
            if (clearTimeout(o), t.content.css('visibility', 'hidden'),
              ...
              return d(), void 0;
            r = s(e), r.css(t._getOffset()), t.wrap.append(r),
        ...
        return o.indexOf(this.index) > -1 ?
            (this.id &&
                 (o = 'string' == typeof this.id ?
                      o.substr(
                          o.lastIndexOf(this.id) + this.id.length, o.length) :
                      this.id.call(this, o)),
  ...
  proto: {
      ...
      return t.direction = !0,
             n && n.enabled ? (a += ' mfp-gallery', x(f + i, function() {
                                 ...
                                 if (t.items.length > 1 && n.arrows &&
                                   ...
                                   var i = n.arrowMarkup,
                                       o = t.arrowLeft =
                                           e(i.replace(/%title%/gi, n.tPrev)
                                                 .replace(/%dir%/gi, 'left'))
                                               .addClass(y),
                                       a = t.arrowRight =
                                           e(i.replace(/%title%/gi, n.tNext)
    ...
    _preloadItem: function(n) {
      if (n = K(n), !t.items[n].preloaded) {
        var i = t.items[n];
        i.parsed || (i = t.parseEl(n)), T('LazyLoad', i),
            'image' === i.type &&
    ...
    initRetina: function() {
      if (window.devicePixelRatio > 1) {
        ...
        n > 1 && (x('ImageHasSize.' + U, function(e, t) {
                    t.img.css(
                        {'max-width': t.img[0].naturalWidth / n, width: '100%'})
