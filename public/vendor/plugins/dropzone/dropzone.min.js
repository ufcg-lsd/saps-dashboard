!function() {
  function a(b) {
    ...
    return 'exports' in c || 'function' != typeof c.definition ||
  ...
  a.register(
      ...
      function(a, b) {
        ...
        c.prototype.once =
          ...
          var d = this;
          return this._callbacks = this._callbacks || {}, c.fn = b,
                 this.on(a, c), this
        },
        c.prototype.off = c.prototype.removeListener =
            c.prototype.removeAllListeners = c.prototype.removeEventListener =
                function(a, b) {
  ...
  a.register(
      ...
      function(b, c) {
        (function() {
          ...
          d = 'undefined' != typeof Emitter && null !== Emitter ?
              Emitter :
          ...
          b =
            ...
            function b(a, d) {
              ...
              if (b.instances.push(this), this.element.dropzone = this,
                  e = null != (g = b.optionsForElement(this.element)) ? g : {},
                  this.options =
                      c({}, this.defaultOptions, e, null != d ? d : {}),
              ...
              this.options.acceptedMimeTypes &&
                  ...
                  (f = this.getExistingFallback()) && f.parentNode &&
                  ...
                  (this.clickableElements = this.options.clickable === !0 ?
                       [this.element] :
            ...
            b.prototype.defaultOptions = {
              ...
              fallback: function() {
                var a, c, d, e, f, g;
                for (this.element.className = '' + this.element.className +
                         ' dz-browser-not-supported',
                    g = this.element.getElementsByTagName('div'), e = 0,
                    f = g.length;
                     f > e; e++)
                  a = g[e],
                ...
                return b = {
                  ...
                  srcHeight: a.height
                       ...
                       null == b.optWidth && null == b.optHeight ?
                           ...
                           null == b.optWidth ? b.optWidth = c * b.optHeight :
                                                null == b.optHeight &&
              ...
              removedfile: function(a) {
                var b;
                return a.previewElement && null != (b = a.previewElement) &&
              ...
              uploadprogress: function(a, b) {
                var c, d, e, f, g;
                if (a.previewElement) {
                  for (f = a.previewElement.querySelectorAll(
            ...
            c =
              ...
              var a, b, c, d, e, f, g;
              for (d = arguments[0],
                  c = 2 <= arguments.length ? m.call(arguments, 1) : [], f = 0,
                  g = c.length;
                   g > f; f++) {
                b = c[f];
            ...
            b.prototype.getFilesWithStatus =
                       function(a) {
              var b, c, d, e, f;
            ...
            b.prototype.destroy =
              ...
              return this.disable(), this.removeAllFiles(!0),
                     (null != (a = this.hiddenFileInput) ? a.parentNode :
                                                           void 0) &&
            ...
            b.prototype.updateTotalUploadProgress =
                       function() {
              var a, b, c, d, e, f, g, h;
            ...
            b.prototype.getFallbackForm =
              ...
              return (a = this.getExistingFallback()) ?
                  ...
                  (d = '<div class="dz-fallback">',
                   ...
                   d += '<input type="file" name="' + this._getParamName(0) +
                       '" ' +
            ...
            b.prototype.getExistingFallback =
                       function() {
              var a, b, c, d, e, f;
              for (b = function(a) {
                     var b, c, d;
            ...
            b.prototype.setupEventListeners =
                       function() {
              var a, b, c, d, e, f, g;
            ...
            b.prototype.disable =
              ...
              for (this.clickableElements.forEach(function(a) {
                   ...
                   this.removeEventListeners(), d = this.files, e = [], b = 0,
                                                c = d.length;
                   c > b; b++)
            ...
            b.prototype.filesize =
                       function(a) {
              var b;
              return a >= 109951162777.6 ?
                         (a /= 109951162777.6, b = 'TiB') :
                         a >= 107374182.4 ?
                         (a /= 107374182.4, b = 'GiB') :
                         a >= 104857.6 ? (a /= 104857.6, b = 'MiB') :
                                         a >= 102.4 ? (a /= 102.4, b = 'KiB') :
                                                      (a = 10 * a, b = 'b'),
                     '<strong>' + Math.round(a) / 10 + '</strong> ' + b
            },
            b.prototype._updateMaxFilesReachedClass =
                       function() {
            ...
            b.prototype.drop =
              ...
              var b, c;
              a.dataTransfer &&
                  (this.emit('drop', a), b = a.dataTransfer.files,
                   b.length &&
            ...
            b.prototype._addFilesFromItems =
                       function(a) {
              var b, c, d, e, f;
              for (f = [], d = 0, e = a.length; e > d; d++)
                ...
                f.push(
                    null != c.webkitGetAsEntry && (b = c.webkitGetAsEntry()) ?
                        ...
                        b.isDirectory ? this._addFilesFromDirectory(b, b.name) :
                                        void 0 :
                        null != c.getAsFile ?
            ...
            b.prototype._addFilesFromDirectory =
                       function(a, b) {
              var c, d;
            ...
            b.prototype.accept =
              ...
              return a.size > 1024 * this.options.maxFilesize * 1024 ?
                  ...
                  (c(this.options.dictMaxFilesExceeded.replace(
            ...
            b.prototype._enqueueThumbnail = function(a) {
              ...
              return this._processingThumbnail ||
                  ...
                  (this._processingThumbnail = !0,
                   this.createThumbnail(
                       this._thumbnailQueue.shift(), function(a) {
                         return function() {
              ...
              return a.status === b.UPLOADING && this.cancelUpload(a),
                     this.files = j(this.files, a), this.emit('removedfile', a),
                     0 === this.files.length ? this.emit('reset') : void 0
            }, b.prototype.removeAllFiles = function(a) {
              var c, d, e, f;
              for (null == a && (a = !1), f = this.files.slice(), d = 0,
                                          e = f.length;
                   e > d; d++)
                  ...
                  return e = document.createElement('img'),
                         e.onload = function() {
                           ...
                           return a.width = e.width, a.height = e.height,
                                  ...
                                  f = c.getContext('2d'), c.width = g.trgWidth,
                                  c.height = g.trgHeight,
                                  h(f, e, null != (j = g.srcX) ? j : 0,
                                    null != (k = g.srcY) ? k : 0, g.srcWidth,
                                    g.srcHeight, null != (l = g.trgX) ? l : 0,
                                    null != (m = g.trgY) ? m : 0, g.trgWidth,
                                    g.trgHeight),
              ...
              if (b = this.options.parallelUploads,
                  c = this.getUploadingFiles().length, a = c,
              ...
              for (d = 0, e = a.length; e > d; d++)
                c = a[d], c.processing = !0, c.status = b.UPLOADING,
              ...
              if (a.status === b.UPLOADING) {
                for (d = this._getFilesWithXhr(a.xhr), e = 0, g = d.length;
                     g > e; e++)
              ...
              return this.options.autoProcessQueue ? this.processQueue() :
                                                     void 0
              ...
              t.open(this.options.method, this.options.url, !0),
                  t.withCredentials = !!this.options.withCredentials, q = null,
                  f =
                      function(b) {
                    return function() {
                      var c, e, f;
                  ...
                  r =
                    ...
                    return function(c) {
                      ...
                      if (null != c)
                        for (f = 100 * c.loaded / c.total, g = 0, j = a.length;
                             j > g; g++)
                          d = a[g], d.upload = {
                            progress: f,
                            total: c.total,
              ...
              if (this.options.uploadMultiple &&
                  ...
                  'FORM' === this.element.tagName)
                for (F = this.element.querySelectorAll(
                         'input, textarea, select, button'),
                    w = 0, A = F.length;
                     A > w; w++)
                  if (k = F[w], l = k.getAttribute('name'),
                    ...
                    (!m ||
                     ...
                     k.checked) &&
                        e.append(l, k.value);
              for (j = C = 0, I = a.length - 1; I >= 0 ? I >= C : C >= I;
                   j = I >= 0 ? ++C : --C)
              ...
              for (f = 0, g = a.length; g > f; f++)
                e = a[f], e.status = b.SUCCESS, this.emit('success', e, c, d),
                this.emit('complete', e);
              return this.options.uploadMultiple &&
                         (this.emit('successmultiple', a, c, d),
                          this.emit('completemultiple', a)),
                     this.options.autoProcessQueue ? this.processQueue() :
                                                     void 0
            }, b.prototype._errorProcessing = function(a, c, d) {
              var e, f, g;
              for (f = 0, g = a.length; g > f; f++)
                e = a[f], e.status = b.ERROR, this.emit('error', e, c, d),
                this.emit('complete', e);
              return this.options.uploadMultiple &&
          ...
          b.version = '3.10.2', b.options = {},
          b.optionsForElement =
              function(a) {
            return a.getAttribute('id') ? b.options[e(a.getAttribute('id'))] :
                                          void 0
          },
          b.instances = [],
          b.forElement =
          ...
          b.createElement =
              function(a) {
            var b;
            return b = document.createElement('div'), b.innerHTML = a,
                   b.childNodes[0]
          },
          b.elementInside =
              function(a, b) {
          ...
          b.getElements =
            ...
            if (a instanceof Array) {
              ...
              for (e = [], j = document.querySelectorAll(a), g = 0,
                  i = j.length;
                   i > g; g++)
                d = j[g], e.push(d);
            else
          ...
          b.isValidFile =
            ...
            var c, d, e, f, g;
            if (!b) return !0;
            for (b = b.split(','), d = a.type, c = d.replace(/\/.*$/, ''),
                f = 0, g = b.length;
                 g > f; f++)
              if (e = b[f], e = e.trim(), '.' === e.charAt(0)) {
                if (-1 !==
                    a.name.toLowerCase().indexOf(
                        e.toLowerCase(), a.name.length - e.length))
                  return !0
              } else if (/\/\*$/.test(e)) {
          ...
          'undefined' != typeof c &&null !== c ? c.exports = b :
                                                 window.Dropzone = b,
          b.ADDED = 'added', b.QUEUED = 'queued', b.ACCEPTED = b.QUEUED,
          b.UPLOADING = 'uploading', b.PROCESSING = b.UPLOADING,
          b.CANCELED = 'canceled', b.ERROR = 'error', b.SUCCESS = 'success',
          g = function(a) {
            var b, c, d, e, f, g, h, i, j, k;
            for (h = a.naturalWidth, g = a.naturalHeight,
                c = document.createElement('canvas'), c.width = 1, c.height = g,
                d = c.getContext('2d'), d.drawImage(a, 0, 0),
                e = d.getImageData(0, 0, 1, g).data, k = 0, f = g, i = g;
                 i > k;)
            ...
            if (e = !1, k = !0, d = a.document, j = d.documentElement,
