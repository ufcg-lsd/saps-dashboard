...
!function(e) {
  var t = function(t, n) {
    ...
    this.$preview.css('display') != 'inline' && r != '0px' && r != 'none' &&
  ...
  t.prototype = {
    ...
    change: function(e, t) {
      ...
      this.$hidden.val(''), this.$hidden.attr('name', ''),
    ...
    clear: function(e) {
      this.$hidden.val(''), this.$hidden.attr('name', this.name),
    ...
    reset: function(e) {
      this.clear(), this.$hidden.val(this.original.hiddenVal),
          ...
          this.original.exists ? this.$element.addClass('fileupload-exists')
                                     .removeClass('fileupload-new') :
                                 this.$element.addClass('fileupload-new')
                                     .removeClass('fileupload-exists')
    },
  ...
  e(document).on(
      'click.fileupload.data-api', '[data-provides="fileupload"]', function(t) {
        var n = e(this);
