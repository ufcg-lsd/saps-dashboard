  ...
  'bootstrap': {
    ...
    'fnUpdate': function(oSettings, fnDraw) {
      ...
      if (oPaging.iTotalPages <= 6) {
        ...
        // End
        if ($.inArray(oPaging.iTotalPages - 2, pages) === -1 &&
            oPaging.iPage < oPaging.iTotalPages - 2) {
        ...
        // Pages before
        var pagesBefore = oPaging.iPage - 2 > 0 ? oPaging.iPage - 2 : 0;
      ...
      for (i = 0, ien = an.length; i < ien; i++) {
        ...
        $.each(pages, function(i, page) {
          ...
          $('<li class="' + klass + '"><a href="">' +
            (page === null ? '&hellip;' : page + 1) + '</a></li>')
