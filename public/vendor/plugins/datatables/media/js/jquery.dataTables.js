...
var O = function(g) {
  function V(a) {
    var b, c, e = {};
    g.each(a, function(d) {
      if ((b = d.match(/^([^A-Z]+?)([A-Z])/)) &&
          -1 !== 'a aa ai ao as b fn i m o s '.indexOf(b[1] + ' '))
        c = d.replace(b[0], b[2].toLowerCase()), e[c] = d,
        'o' === b[1] && V(a[d])
    });
    a._hungarianMap = e
  }
  ...
  function Ea(a, b) {
    var c = p.defaults.column, e = a.aoColumns.length,
  ...
  function ja(a, b, c) {
    ...
    c !== l && null !== c &&
        (eb(c), G(p.defaults.column, c),
         c.mDataProp !== l && !c.mData && (c.mData = c.mDataProp),
         c.sType && (b._sManualType = c.sType),
         c.className && !c.sClass && (c.sClass = c.className), g.extend(b, c),
         D(b, c, 'sWidth', 'sWidthOrig'),
         'number' === typeof c.iDataSort && (b.aDataSort = [c.iDataSort]),
         D(b, c, 'aDataSort'));
    var h = b.mData, i = W(h), j = b.mRender ? W(b.mRender) : null,
        c = function(a) {
  ...
  function Ga(a) {
    var b = a.aoColumns, c = a.aoData, e = p.ext.type.detect, d, f, h, i, j, g,
        m, o, k;
    d = 0;
  ...
  function v(a, b, c, e) {
    var d = a.iDraw, f = a.aoColumns[c], h = a.aoData[b]._aData,
        i = f.sDefaultContent,
        c = f.fnGetData(h, e, {settings: a, row: b, col: c});
    if (c === l)
      return a.iDrawError != d && null === i &&
                 (R(a, 0,
  ...
  function Ha(a, b, c, e) {
    a.aoColumns[c].fnSetData(
        a.aoData[b]._aData, e, {settings: a, row: b, col: c})
  }
  function Ja(a) {
  ...
  function ma(a, b, c, e) {
    var d = [], f = b.firstChild, h, i = 0, j, n = a.aoColumns,
        m = a._rowReadObject, e = e || m ? {} : [], o = function(a, b) {
          if ('string' === typeof a) {
            var c = a.indexOf('@');
          ...
          if (c === l || c === i)
            h = n[i], j = g.trim(a.innerHTML),
            h && h._bAttrSrc ?
                (Q(h.mData._)(e, j), o(h.mData.sort, a), o(h.mData.type, a),
                 o(h.mData.filter, a)) :
                m ? (h._setter || (h._setter = Q(h.mData)), h._setter(e, j)) :
                    e[i] = j;
          i++
        };
    if (f)
  ...
  function ib(a) {
    var b, c, e, d, f, h = a.nTHead, i = a.nTFoot,
                       j = 0 === g('th, td', h).length, n = a.oClasses,
                       m = a.aoColumns;
    j && (d = g('<tr/>').appendTo(h));
    b = 0;
    for (c = m.length; b < c; b++)
      f = m[b], e = g(f.nTh).addClass(f.sClass), j && e.appendTo(d),
      a.oFeatures.bSort &&
          (e.addClass(f.sSortingClass),
           !1 !== f.bSortable &&
               (e.attr('tabindex', a.iTabIndex)
                    .attr('aria-controls', a.sTableId),
                Na(a, f.nTh, b))),
      f.sTitle != e.html() && e.html(f.sTitle), Oa(a, 'header')(a, e, f, n);
    j && da(a.aoHeader, h);
  ...
  function L(a) {
    ...
    if (-1 !== g.inArray(!1, b))
      ...
      var b = [], c = 0, e = a.asStripeClasses, d = e.length, f = a.oLanguage,
          h = a.iInitDisplayStart, i = 'ssp' == A(a), j = a.aiDisplay;
      a.bDrawing = !0;
      h !== l && -1 !== h &&
      ...
      if (0 !== j.length) {
        ...
        for (i = i ? 0 : h; i < f; i++) {
          ...
          if (0 !== d) {
            var k = e[c % d];
            o._sRowStripe != k &&
                (g(m).removeClass(o._sRowStripe).addClass(k), o._sRowStripe = k)
          }
      ...
      u(a, 'aoHeaderCallback', 'header',
        [g(a.nTHead).children('tr')[0], Ka(a), h, n, j]);
      u(a, 'aoFooterCallback', 'footer',
        [g(a.nTFoot).children('tr')[0], Ka(a), h, n, j]);
      e = g(a.nTBody);
      e.children().detach();
      e.append(g(b));
    ...
    for (var f = a.sDom.split(''), h, i, j, n, m, o, k = 0; k < f.length; k++) {
      ...
      if ('<' == i) {
        ...
        if ('\'' == n || '"' == n) {
          ...
          -1 != m.indexOf('.') ?
              (n = m.split('.'), j.id = n[0].substr(1, n[0].length - 1),
               j.className = n[1]) :
              '#' == m.charAt(0) ? j.id = m.substr(1, m.length - 1) :
                                   j.className = m;
          k += o
        }
        d.append(j);
  ...
  function qa(a, b, c) {
    ...
    j = {
      ...
      error: function(b, c) {
        var f = a.oApi._fnLog;
        'parsererror' == c ? f(a, 0, 'Invalid JSON response', 1) :
    ...
    a.fnServerData ?
        ...
        g.isFunction(h) ? a.jqXHR = h.call(i, b, c, a) :
  ...
  function sb(a) {
    var b = a.aoColumns, c = b.length, e = a.oFeatures, d = a.oPreviousSearch,
        f = a.aoPreSearchCols, h, i = [], j, n, m, o = T(a);
    h = a._iDisplayStart;
    ...
    for (h = 0; h < c; h++)
      n = b[h], m = f[h],
      j = 'function' == typeof n.mData ? 'function' : n.mData, l.columns.push({
        data: j,
        name: n.sName,
      ...
      k('mDataProp_' + h, j),
      e.bFilter &&
          (k('sSearch_' + h, m.sSearch), k('bRegex_' + h, m.bRegex),
  ...
  function tb(a, b) {
    var c = b.sEcho !== l ? b.sEcho : b.draw,
        ...
        d = b.iTotalDisplayRecords !== l ? b.iTotalDisplayRecords :
                                           b.recordsFiltered;
    if (c) {
  ...
  function nb(a) {
    var b = a.oClasses, c = a.sTableId, e = a.oLanguage, d = a.oPreviousSearch,
        ...
        b = g('<div/>', {id: !f.f ? c + '_filter' : null, 'class': b.sFilter})
  ...
  function fa(a, b, c) {
    ...
    Ga(a);
    if ('ssp' != A(a)) {
      ub(a, b.sSearch, c, b.bEscapeRegex !== l ? !b.bEscapeRegex : b.bRegex,
         b.bSmart, b.bCaseInsensitive);
      f(b);
      for (b = 0; b < d.length; b++)
        vb(a, d[b].sSearch, b,
           d[b].bEscapeRegex !== l ? !d[b].bEscapeRegex : d[b].bRegex,
           d[b].bSmart, d[b].bCaseInsensitive);
      wb(a)
    } else
      f(b);
    a.bFiltered = !0;
  ...
  function wb(a) {
    for (var b = p.ext.search, c = a.aiDisplay, e, d, f = 0, h = b.length;
         f < h; f++) {
  ...
  function vb(a, b, c, e, d, f) {
    if ('' !== b)
      for (var h = a.aiDisplay, e = Pa(b, e, d, f), d = h.length - 1; 0 <= d;
           d--)
        b = a.aoData[h[d]]._aFilterData[c], e.test(b) || h.splice(d, 1)
  }
  function ub(a, b, c, e, d, f) {
    var e = Pa(b, e, d, f), d = a.oPreviousSearch.sSearch,
    ...
    for (f = a.aoData.length; e < f; e++)
      if (n = a.aoData[e], !n._aFilterData) {
        ...
        for (h = b.length; d < h; d++)
          c = b[d],
          c.bSearchable ?
              (g = v(a, e, d, 'filter'), m[c.sType] && (g = m[c.sType](g)),
               null === g && (g = ''),
               'string' !== typeof g && g.toString && (g = g.toString())) :
              g = '',
          g.indexOf && -1 !== g.indexOf('&') &&
  ...
  function qb(a) {
    var b = a.sTableId, c = a.aanFeatures.i,
        e = g(
            '<div/>', {'class': a.oClasses.sInfo, id: !c ? b + '_info' : null});
    c ||
  ...
  function Ab(a) {
    ...
    if (0 !== b.length) {
      var c = a.oLanguage, e = a._iDisplayStart + 1, d = a.fnDisplayEnd(),
          f = a.fnRecordsTotal(), h = a.fnRecordsDisplay(),
  ...
  function Bb(a, b) {
    var c = a.fnFormatNumber, e = a._iDisplayStart + 1, d = a._iDisplayLength,
        f = a.fnRecordsDisplay(), h = -1 === d;
    return b.replace(/_START_/g, c.call(a, e))
  ...
  function mb(a) {
    for (var b = a.oClasses, c = a.sTableId, e = a.aLengthMenu,
             d = g.isArray(e[0]), f = d ? e[0] : e, e = d ? e[1] : e,
             d = g('<select/>', {
               name: c + '_length',
               'aria-controls': c,
  ...
  function rb(a) {
    var b = a.sPaginationType, c = p.ext.pager[b], e = 'function' === typeof c,
        d =
            function(a) {
          L(a)
        },
      ...
      fn: function(a) {
        if (e) {
          var b = a._iDisplayStart, g = a._iDisplayLength,
              n = a.fnRecordsDisplay(), m = -1 === g,
              b = m ? 0 : Math.ceil(b / g), g = m ? 1 : Math.ceil(n / g),
              n = c(b, g), o, m = 0;
  ...
  function pb(a) {
    ...
    var e = c.sX, d = c.sY, f = a.oClasses, h = b.children('caption'),
        i = h.length ? h[0]._captionSide : null, j = g(b[0].cloneNode(!1)),
        n = g(b[0].cloneNode(!1)), m = b.children('tfoot');
    c.sX && '100%' === b.attr('width') && b.removeAttr('width');
    m.length || (m = null);
    c = g('<div/>', {'class': f.sScrollWrapper})
            .append(g('<div/>', {'class': f.sScrollHead})
                        .css({
                          overflow: 'hidden',
                          position: 'relative',
                          border: 0,
                        ...
                        .append(g('<div/>', {'class': f.sScrollHeadInner})
                                    .css({
                                      'box-sizing': 'content-box',
                                      width: c.sXInner || '100%'
                                    })
                                    .append(j.removeAttr('id')
                                                .css('margin-left', 0)
                                                .append('top' === i ? h : null)
                                                .append(b.children('thead')))))
            .append(g('<div/>', {'class': f.sScrollBody})
                        .css({
                          overflow: 'auto',
                          height: !d ? null : s(d),
                          width: !e ? null : s(e)
                        ...
                        .append(b));
    m &&
        c.append(g('<div/>', {'class': f.sScrollFoot})
                     .css({
                       overflow: 'hidden',
                       border: 0,
                       width: e ? !e ? null : s(e) : '100%'
                     })
                     .append(g('<div/>', {'class': f.sScrollFootInner})
  ...
  function Y(a) {
    var b = a.oScroll, c = b.sX, e = b.sXInner, d = b.sY, f = b.iBarWidth,
        h = g(a.nScrollHead), i = h[0].style, j = h.children('div'),
        n = j[0].style, m = j.children('table'), j = a.nScrollBody, o = g(j),
        k = j.style, l = g(a.nScrollFoot).children('div'),
        p = l.children('table'), r = g(a.nTHead), q = g(a.nTable), t = q[0],
        N = t.style, J = a.nTFoot ? g(a.nTFoot) : null, u = a.oBrowser,
        w = u.bScrollOversize, y, v, x, K, z, A = [], B = [], C = [], D,
        E = function(a) {
          a = a.style;
          a.paddingTop = '0';
          a.paddingBottom = '0';
    ...
    if (q.outerWidth() < h) {
      v = j.scrollHeight > j.offsetHeight || 'scroll' == o.css('overflow-y') ?
          h + f :
          h;
      if (w &&
    ...
    d && b.bCollapse &&
        (k.height = s(d), b = c && t.offsetWidth > j.offsetWidth ? f : 0,
    ...
    n[u] = m ? f + 'px' : '0px';
    J &&
        (p[0].style.width = s(b), l[0].style.width = s(b),
    ...
    for (var e = 0, d = 0, f = b.length, h, g; d < f;) {
      ...
      for (g = c ? c[d].firstChild : null; h;)
        1 === h.nodeType && (c ? a(h, g, e) : a(h, e), e++),
            h = h.nextSibling, g = c ? g.nextSibling : null;
      d++
    }
  }
  function Fa(a) {
    var b = a.nTable, c = a.aoColumns, e = a.oScroll, d = e.sY, f = e.sX,
        h = e.sXInner, i = c.length, e = Z(a, 'bVisible'),
        j = g('th', a.nTHead), n = b.getAttribute('width'), m = b.parentNode,
        o = !1, k, l;
    ...
    if (!o && !f && !d && i == aa(a) && i == j.length)
      ...
      f && h ? i.width(h) :
               f ? (i.css('width', 'auto'),
                   ...
                   d ? i.width(m.offsetWidth) : n && i.width(n);
      Eb(a, i[0]);
      if (f) {
        for (k = h = 0; k < e.length; k++)
          l = c[e[k]], d = g(j[k]).outerWidth(),
          h += null === l.sWidthOrig ?
              d :
    ...
    n && (b.style.width = s(n));
    if ((n || f) && !a._reszEvt)
      g(Da).bind('resize.DT-' + a.sInstance, ta(function() {
                   X(a)
                 })),
          a._reszEvt = !0
  }
  ...
  function Fb(a, b) {
    for (var c, e = -1, d = -1, f = 0, h = a.aoData.length; f < h; f++)
      c = v(a, f, b, 'display') + '', c = c.replace(Zb, ''),
  ...
  function kb(a) {
    var b, c, e = [], d = p.ext.type.order, f = a.aoData, h = 0, g,
              j = a.aiDisplayMaster, n;
    Ga(a);
    n = T(a);
    b = 0;
    ...
    if ('ssp' != A(a) && 0 !== n.length) {
      ...
      h === n.length ? j.sort(function(a, b) {
        var c, d, h, g, i = n.length, j = f[a]._aSortData, l = f[b]._aSortData;
        for (h = 0; h < i; h++)
          if (g = n[h], c = j[g.col], d = l[g.col],
              c = c < d ? -1 : c > d ? 1 : 0, 0 !== c)
        ...
        return c < d ? -1 : c > d ? 1 : 0
                       ...
                       j.sort(function(a, b) {
                         var c, h, g, i, j = n.length, l = f[a]._aSortData,
                                         p = f[b]._aSortData;
                         for (g = 0; g < j; g++)
                           if (i = n[g], c = l[i.col], h = p[i.col],
                               i = d[i.type + '-' + i.dir] ||
                                   d['string-' + i.dir],
                               c = i(c, h), 0 !== c)
                             return c;
  ...
  function Ib(a) {
    for (var b, c, e = a.aoColumns, d = T(a), a = a.oLanguage.oAria, f = 0,
                   h = e.length;
         f < h; f++) {
      c = e[f];
      var g = c.asSorting;
  ...
  function Na(a, b, c, e) {
    ...
    Ua(b, {}, function(b) {
      !1 !== d.bSortable &&
          (a.oFeatures.bProcessing ? (B(a, !0), setTimeout(function() {
                                        Ta(a, c, b.shiftKey, e);
                                        'ssp' !== A(a) && B(a, !1)
  ...
  function wa(a) {
    var b = a.aLastSort, c = a.oClasses.sSortColumn, e = T(a), d = a.oFeatures,
        f, h;
  ...
  function Hb(a, b) {
    ...
    for (var f, h = p.ext.type.order[c.sType + '-pre'], g = 0,
                j = a.aoData.length;
         g < j; g++)
    ...
    if (a.oFeatures.bStateSave && !a.bDestroying) {
      var b = {
        ...
        columns: g.map(
            ...
            function(b, e) {
              return {
                visible: b.bVisible, search: yb(a.aoPreSearchCols[e])
              }
            })
      };
      ...
      b.hasOwnProperty(d) &&
          (e = b[d],
           g.isPlainObject(e) ?
               ...
               a[d] = c && 'data' !== d && 'aaData' !== d && g.isArray(e) ?
               e.slice() :
               e);
    return a
  }
  ...
  function Va(a, b) {
    ...
    b <= c ?
        c = U(0, b) :
        a <= e ? (c = U(0, c - 2), c.push('ellipsis'), c.push(b - 1)) :
                 (a >= b - 1 - e ?
                      c = U(b - (c - 2), b) :
  ...
  p = function(a) {
    ...
    this.fnDeleteRow = function(a, b, c) {
      var e = this.api(!0), a = e.rows(a), d = a.settings()[0],
          g = d.aoData[a[0][0]];
      a.remove();
      b && b.call(this, d, g);
      (c === l || c) && e.draw();
    ...
    this.fnGetData = function(a, b) {
      ...
      if (a !== l) {
        ...
        return b !== l || 'td' == e || 'th' == e ? c.cell(a, b).data() :
                                                   c.row(a).data() || null
      }
    ...
    this.each(function() {
      var d = {}, d = 1 < e ? Kb(d, a, !0) : a, h = 0, i,
          j = this.getAttribute('id'), n = !1, m = p.defaults;
      if ('table' != this.nodeName.toLowerCase())
        ...
        d.aLengthMenu && !d.iDisplayLength &&
        ...
        j = k.oClasses;
        d.bJQueryUI ? (g.extend(j, p.ext.oJUIClasses, d.oClasses),
                       d.sDom === m.sDom && 'lfrtip' === m.sDom &&
                           (k.sDom = '<"H"lfr>t<"F"ip>'),
                       k.renderer) ?
                      g.isPlainObject(k.renderer) && !k.renderer.header &&
        ...
        null !== d.iDeferLoading &&
            (k.bDeferLoading = !0, h = g.isArray(d.iDeferLoading),
        ...
        var o = [], s, h = this.getElementsByTagName('thead');
      ...
      for (g = m.length; h < g; h++) {
        ...
        if ('table' === b)
          ...
          for (n = k.length; j < n; j++)
            f = k[j],
            f = 'cell' === b ? c.call(r, m[h], f.row, f.column, h, j) :
                               c.call(r, m[h], f, h, j, o),
            f !== l && d.push(f)
        }
      }
      return d.length || e ?
          (a = new q(m, a ? d.concat.apply([], d) : d), b = a.selector,
           b.rows = p.rows, b.cols = p.cols, b.opts = p.opts, a) :
          this
    },
  ...
  q.register = r = function(a, b) {
    if (g.isArray(a))
      ...
      for (var d = a.split('.'), f = Sb, h, i, c = 0, e = d.length; c < e;
           c++) {
        h = (i = -1 !== d[c].indexOf('()')) ? d[c].replace('()', '') : d[c];
        var j;
        a: {
          j = 0; for (var n = f.length; j < n; j++) if (f[j].name === h) {
            j = f[j];
            break a
          } j = null
        } j ||
  ...
  q.registerPlural = t = function(a, b, c) {
    ...
    q.register(b, function() {
      ...
      return a === this ?
          this :
          a instanceof q ?
          a.length ? g.isArray(a[0]) ? new q(a.context, a[0]) : a[0] : l :
          a
    })
  };
  r('tables()', function(a) {
  ...
  r('page()', function(a) {
    return a === l ? this.page.info().page :
  ...
  r('page.info()', function() {
    ...
    var a = this.context[0], b = a._iDisplayStart, c = a._iDisplayLength,
        e = a.fnRecordsDisplay(), d = -1 === c;
    return {
      page: d ? 0 : Math.floor(b / c), pages: d ? 1 : Math.ceil(e / c),
          start: b, end: a.fnDisplayEnd(), length: c,
          recordsTotal: a.fnRecordsTotal(), recordsDisplay: e
    }
  });
  r('page.len()', function(a) {
    return a === l ?
        0 !== this.context.length ? this.context[0]._iDisplayLength : l :
        this.iterator('table', function(b) {
          Qa(b, a)
        })
  });
  ...
  r('ajax.url()', function(a) {
    ...
    if (a === l) {
      ...
      b = b[0];
      return b.ajax ? g.isPlainObject(b.ajax) ? b.ajax.url : b.ajax :
                      b.sAjaxSource
    }
    return this.iterator('table', function(b) {
  ...
  var Za = function(a, b) {
    ...
    for (h = a.length; f < h; f++) {
      ...
      for (j = d.length; i < j; i++)
        (e = b('string' === typeof d[i] ? g.trim(d[i]) : d[i])) && e.length &&
            c.push.apply(c, e)
    }
    return c
  }, $a = function(a) {
    ...
    return {
      search: a.search || 'none', order: a.order || 'current',
          page: a.page || 'all'
    }
  }, ab = function(a) {
    for (var b = 0, c = a.length; b < c; b++)
    ...
    if ('current' == d) {
      ...
      f = 'none' == i ? c.slice() :
                        'applied' == i ? h.slice() : g.map(c, function(a) {
  ...
  r('row.add()', function(a) {
    ...
    var b = this.iterator('table', function(b) {
      return a.nodeName && 'TR' === a.nodeName.toUpperCase() ? la(b, a)[0] :
                                                               I(b, a)
    });
    return this.row(b[0])
  });
  ...
  r('cells()', function(a, b, c) {
    ...
    if (null === b || b === l)
      return this.iterator('table', function(b) {
        var e = a, d = $a(c), f = b.aoData, h = Ba(b, d),
            d = Rb(ha(f, h, 'anCells')), i = g([].concat.apply([], d)), j,
            m = b.aoColumns.length, n, p, r, q, s, t;
          ...
          return g.isPlainObject(a) ?
              ...
              i.filter(a)
                  .map(function(a, b) {
                    ...
                    return {
                      row: j, column: g.inArray(b, f[j].anCells)
                    }
                  })
                  .toArray()
        })
      });
    var e = this.columns(b, c), d = this.rows(a, c), f, h, i, j, n,
  ...
  t('cells().indexes()', 'cell().index()', function() {
    return this.iterator('cell', function(a, b, c) {
      return {
        row: b, column: c, columnVisible: $(a, c)
      }
    }, 1)
  });
  ...
  r('search()', function(a, b, c, e) {
    var d = this.context;
    return a === l ? 0 !== d.length ? d[0].oPreviousSearch.sSearch : l :
                     this.iterator('table', function(d) {
                       d.oFeatures.bFilter &&
                           fa(d, g.extend({}, d.oPreviousSearch, {
                             sSearch: a + '',
                             bRegex: null === b ? !1 : b,
                             bSmart: null === c ? !0 : c,
  ...
  p.versionCheck = p.fnVersionCheck = function(a) {
    for (var b = p.version.split('.'), a = a.split('.'), c, e, d = 0,
             f = a.length;
         d < f; d++)
  ...
  r('destroy()', function(a) {
    a = a || !1;
    return this.iterator('table', function(b) {
      var c = b.nTableWrapper.parentNode, e = b.oClasses, d = b.nTable,
          f = b.nTBody, h = b.nTHead, i = b.nTFoot, j = g(d), f = g(f),
          l = g(b.nTableWrapper), m = g.map(b.aoData, function(a) {
            return a.nTr
          }), o;
      b.bDestroying = !0;
      ...
      g('th, td', h)
          .removeClass(
              e.sSortable + ' ' + e.sSortableAsc + ' ' + e.sSortableDesc + ' ' +
              e.sSortableNone);
      b.bJUI &&
  ...
  p.models = {};
  p.models
      .oSearch = {bCaseInsensitive: !0, sSearch: '', bRegex: !1, bSmart: !0};
  p.models.oRow = {
    nTr: null,
    anCells: null,
    _aData: [],
  ...
  p.defaults = {
    ...
    fnFormatNumber: function(a) {
      return a.toString().replace(
          /\B(?=(\d{3})+(?!\d))/g, this.oLanguage.sThousands)
    },
  ...
  p.models.oSettings = {
    ...
    fnRecordsTotal: function() {
      return 'ssp' == A(this) ? 1 * this._iRecordsTotal :
    ...
    fnDisplayEnd: function() {
      var a = this._iDisplayLength, b = this._iDisplayStart, c = b + a,
          e = this.aiDisplay.length, d = this.oFeatures, f = d.bPaginate;
      return d.bServerSide ? !1 === f || -1 === a ?
                             b + e :
  ...
  var Ca = '', Ca = '', E = Ca + 'ui-state-default',
  ...
  g.extend(!0, p.ext.renderer, {
    pageButton: {
      _: function(a, b, c, e, d, f) {
        var h = a.oClasses, i = a.oLanguage.oPaginate, j, l, m = 0,
            o = function(b, e) {
  ...
  g.extend(p.ext.type.detect, [
    ...
    function(a) {
      return H(a) || 'string' === typeof a && -1 !== a.indexOf('<') ? 'html' :
                                                                      null
    }
  ]);
  g.extend(p.ext.type.search, {
    html: function(a) {
      return H(a) ?
          a :
          'string' === typeof a ? a.replace(Nb, ' ').replace(Aa, '') : ''
    },
    string: function(a) {
    ...
    header: {
          ...
          if (a === f) {
            ...
            b.removeClass(
                ...
                .addClass(
                    g[d] == 'asc' ?
                        e.sSortAsc :
                        g[d] == 'desc' ? e.sSortDesc : c.sSortingClass)
          }
        })
      },
      jqueryui: function(a, b, c, e) {
        ...
        g(a.nTable).on('order.dt.DT', function(d, f, g, i) {
          if (a === f) {
            d = c.idx;
            b.removeClass(e.sSortAsc + ' ' + e.sSortDesc)
                .addClass(
                    i[d] == 'asc' ?
                        e.sSortAsc :
                        i[d] == 'desc' ? e.sSortDesc : c.sSortingClass);
            b.find('span.' + e.sSortIcon)
                .removeClass(
                    e.sSortJUIAsc + ' ' + e.sSortJUIDesc + ' ' + e.sSortJUI +
                    ' ' + e.sSortJUIAscAllowed + ' ' + e.sSortJUIDescAllowed)
                .addClass(
                    i[d] == 'asc' ?
                        e.sSortJUIAsc :
  ...
  p.render = {
    number: function(a, b, c, e) {
      return {
        display: function(d) {
          var f = 0 > d ? '-' : '', d = Math.abs(parseFloat(d)),
              g = parseInt(d, 10),
              d = c ? b + (d - g).toFixed(c).substring(2) : '';
          return f + (e || '') +
              g.toString().replace(/\B(?=(\d{3})+(?!\d))/g, a) + d
        }
      }
    }
  };
