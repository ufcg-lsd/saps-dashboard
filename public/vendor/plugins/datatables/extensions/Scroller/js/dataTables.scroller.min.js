  ...
  var g = function(a, b) {
    !this instanceof g ?
        ...
        ('undefined' == typeof b && (b = {}), this.s = {
         ...
         this.s.heights.row = this.s.rowHeight, this.dom = {
  ...
  g.prototype = {
    ...
    fnPixelsToRow: function(a, b, c) {
      var d = a - this.s.baseScrollTop,
          a = c ? this._domain('physicalToVirtual', a) / this.s.heights.row :
    ...
    fnScrollToRow: function(a, b) {
      ...
      0 > h && (h = 0);
      if ((f > this.s.redrawBottom || f < this.s.redrawTop) &&
          this.s.dt._iDisplayStart !== h)
        d = !0, f = this.fnRowToPixels(a, !1, !0);
      'undefined' == typeof b || b ? (this.s.ani = d,
                                      e(this.dom.scroller)
                                          .animate(
                                              {scrollTop: f},
                                              function() {
    ...
    _fnConstruct: function() {
      ...
      if (this.s.dt.oFeatures.bPaginate) {
        ...
        this.dom.scroller =
            e('div.' + this.s.dt.oClasses.sScrollBody,
        ...
        this.s.loadingIndicator &&
            (this.dom.loader = e('<div class="DTS_Loading">' +
        ...
        this.s.dt.oApi._fnCallbackReg(
            this.s.dt, 'aoStateSaveParams', function(c, d) {
        ...
        if (this.s.dt.bFiltered || this.s.dt.bSorted)
          ...
          if (c < this.s.redrawTop || c > this.s.redrawBottom) {
            ...
            Math.abs(c - this.s.lastScrollTop) > b.viewport || this.s.ani ?
                (d = parseInt(
                         this._domain('physicalToVirtual', c) / b.row, 10) -
                     f,
                 this.s.topRowFloat =
    ...
    _fnDrawCallback: function() {
      var a = this, b = this.s.heights, c = this.dom.scroller.scrollTop,
          d = e(this.s.dt.nTable).height(), f = this.s.dt._iDisplayStart,
          h = this.s.dt._iDisplayLength, g = this.s.dt.fnRecordsDisplay();
      this.s.skip = !0;
      this._fnScrollForce();
      c = 0 === f ?
      ...
      this.s.dt.oFeatures.bStateSave && null !== this.s.dt.oLoadedState &&
          ...
          ((c = (this.s.dt.sAjaxSource || a.s.dt.ajax) &&
                    !this.s.dt.oFeatures.bServerSide ?
                !0 :
                !1) &&
               2 == this.s.dt.iDraw ||
    ...
    _fnCalcRowHeight: function() {
      var a = this.s.dt, b = a.nTable, c = b.cloneNode(!1),
          d = e('<tbody/>').appendTo(c),
          f =
              e('<div class="' + a.oClasses.sWrapper + ' DTS"><div class="' +
                a.oClasses.sScrollWrapper + '"><div class="' +
      ...
      a._bInitComplete ?
          ...
          (this.s.dt.nHolding ||
               (this.s.dt.nHolding =
                    e('<div></div>').insertBefore(this.s.dt.nTable)),
    ...
    _fnInfo: function() {
      if (this.s.dt.oFeatures.bInfo) {
        var a = this.s.dt, b = a.oLanguage, c = this.dom.scroller.scrollTop,
            ...
            c = Math.ceil(this.fnPixelsToRow(
                c + this.s.heights.viewport, !1, this.s.ani)),
            c = h < c ? h : c, g = a.fnFormatNumber(d), j = a.fnFormatNumber(c),
            i = a.fnFormatNumber(f), k = a.fnFormatNumber(h),
            g = 0 === a.fnRecordsDisplay() &&
                a.fnRecordsDisplay() == a.fnRecordsTotal() ?
            b.sInfoEmpty + b.sInfoPostFix :
            0 === a.fnRecordsDisplay() ?
            b.sInfoEmpty + ' ' + b.sInfoFiltered.replace('_MAX_', i) +
                    b.sInfoPostFix :
            a.fnRecordsDisplay() == a.fnRecordsTotal() ?
            b.sInfo.replace('_START_', g)
                            .replace('_END_', j)
                            .replace('_MAX_', i)
                            .replace('_TOTAL_', k) +
                        b.sInfoPostFix :
            b.sInfo.replace('_START_', g)
                        ...
                        b.sInfoFiltered.replace(
                            '_MAX_', a.fnFormatNumber(a.fnRecordsTotal())) +
                        b.sInfoPostFix;
