 ...
 * http://datatables.net/manual/styling/foundation for further information.
 */
...
var factory = function($, DataTable) {
  ...
  $.extend(
      DataTable.ext.classes, {sWrapper: 'dataTables_wrapper dt-foundation'});
  ...
  if (DataTable.TableTools) {
    ...
    $.extend(
        true, DataTable.TableTools.DEFAULTS.oTags,
