/**
 * Update the internal data for a `dt-tag tr` element based on what is used in
 * the DOM. You will likely want to call fnDraw() after this function.
 *
...
jQuery.fn.dataTableExt.oApi.fnDataUpdate = function(
    oSettings, nRowObject, iRowIndex) {
  jQuery(nRowObject).find('TD').each(function(i) {
    ...
    oSettings.oApi._fnSetCellData(
        oSettings, iRowIndex, iColIndex, jQuery(this).html());
  });
};
