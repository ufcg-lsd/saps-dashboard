...
var l = function(e, i) {
  var h = function(d, a) {
    ...
    this.s.dt.settings()[0].responsive ||
        (a && 'string' === typeof a.details && (a.details = {type: a.details}),
         this.c = e.extend(!0, {}, h.defaults, i.defaults.responsive, a),
         d.responsive = this, this._constructor())
  };
  h.prototype = {
    ...
    _classLogic: function() {
      ...
      c.each(function(b, c) {
        for (var d = b.className.split(' '), j = !1, h = 0, l = d.length; h < l;
             h++) {
          var i = e.trim(d[h]);
          if ('all' === i) {
            j = !0;
    ...
    _detailsInit: function() {
      ...
      var b = c.target;
      e(a.table().body())
          .on('click', 'string' === typeof b ? b : 'td', function() {
            if (e(a.table().node()).hasClass('collapsed') &&
    ...
    _detailsVis: function() {
      var d = this, a = this.s.dt,
          c = a.columns().indexes().filter(function(b) {
            var c = a.column(b);
            return c.visible() ? null :
                                 e(c.header()).hasClass('never') ? null : b
          }),
          b = !0;
      if (0 === c.length || 1 === c.length && this.s.columns[c[0]].control)
        b = !1;
      b ? (e(a.table().node()).addClass('collapsed'),
           a.rows().eq(0).each(function(b) {
             b = a.row(b);
             if (b.child()) {
    ...
    _resize: function() {
      for (var d = this.s.dt, a = e(m).width(), c = this.c.breakpoints,
               b = c[0].name, f = c.length - 1;
           0 <= f; f--)
        if (a <= c[f].width) {
          b = c[f].name;
          break
    ...
    _resizeAuto: function() {
      ...
      if (this.c.auto && -1 !== e.inArray(!0, e.map(a, function(a) {
        ...
        var g = d.columns().header().to$().clone(!1).wrapAll('tr').appendTo(b),
            c = e('<div/>')
        ...
        var c =
            d.cells(a, ':hidden')
                ...
                .map(function(a) {
                  ...
                  return '<li data-dtr-index="' + a.column +
                      '"><span class="dtr-title">' + c.text() +
                      ':</span> <span class="dtr-data">' + g + '</span></li>'
                })
                .toArray()
                .join('');
  ...
  l.register('responsive.index()', function(d) {
    d = e(d);
    return {
      column: d.data('dtr-index'), row: d.parent().data('dtr-index')
    }
  });
  h.version = '1.0.2';
  ...
  e(o).on('init.dt.dtr', function(d, a) {
    if (e(a.nTable).hasClass('responsive') ||
        e(a.nTable).hasClass('dt-responsive') || a.oInit.responsive ||
...
'function' === typeof define && define.amd ?
    ...
    jQuery && !jQuery.fn.dataTable.Responsive && l(jQuery, jQuery.fn.dataTable)
})(window, document);
