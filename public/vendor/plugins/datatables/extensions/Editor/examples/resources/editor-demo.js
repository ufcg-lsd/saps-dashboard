...
$(document).ready(function() {
  ...
  $(document).off('init.dt.demoSSP').on('init.dt.demoSSP', function() {
    ...
    $.ajax({
      ...
      data: {src: table.ajax.url() || '../php/staff-array.php'},
      dataType: 'text',
      type: 'post',
      success: function(txt) {
        $('div.tabs > div.php')
            .append('<code class="multiline brush: php;">' + txt + '</code>');
