...
var p = function(m, p) {
  ...
  g.Client.prototype = {
    ...
    glue: function(a, b) {
      ...
      this.domElement &&
          (this.domElement.appendChild(this.div),
           this.div.innerHTML =
               this.getHTML(d.width, d.height).replace(/&/g, '&amp;'))
    },
    ...
    getHTML: function(a, b) {
      ...
      if (navigator.userAgent.match(/MSIE/))
        ...
        c += '<embed id="' + this.movieId + '" src="' + g.moviePath +
  ...
  TableTools = function(a, b) {
    ...
    this.s = {
      that: this,
      dt: e.fn.dataTable.Api ? (new e.fn.dataTable.Api(a)).settings()[0] :
                               a.fnSettings(),
      print: {
        saveStart: -1,
        saveLength: -1,
  ...
  TableTools.prototype = {
    ...
    fnCalcColRatios: function(a) {
      var b = this.s.dt.aoColumns, a = this._fnColumnTargets(a.mColumns),
          c = [], d = 0, f = 0, e, i;
      e = 0;
    ...
    fnResizeButtons: function() {
      for (var a in g.clients)
        if (a) {
          var b = g.clients[a];
          'undefined' != typeof b.domElement && b.domElement.parentNode &&
              b.positionElement()
        }
    },
      ...
      for (var a in g.clients)
        if (a) {
          ...
          if ('undefined' != typeof b.domElement &&
              b.domElement.parentNode == this.dom.container && !1 === b.sized)
            return !0
        }
      return !1
    },
    ...
    _fnButtonDefinations: function(a, b) {
      for (var c, d = 0, f = a.length; d < f; d++) {
        ...
        (c = this._fnCreateButton(
             c, e(b).hasClass(this.classes.collection.container))) &&
            b.appendChild(c)
      }
    },
    _fnCreateButton: function(a, b) {
      ...
      if (a.sAction.match(/flash/)) {
        ...
        'text' == a.sAction ? this._fnTextConfig(c, a) :
                              'div' == a.sAction ? this._fnTextConfig(c, a) :
                                                   'collection' == a.sAction &&
                    (this._fnTextConfig(c, a), this._fnCollectionConfig(c, a));
      if (-1 !== this.s.dt.iTabIndex)
        e(c).attr('tabindex', this.s.dt.iTabIndex)
    ...
    _fnButtonBase: function(a, b) {
      ...
      c.setAttribute(
          'id', 'ToolTables_' + this.s.dt.sInstance + '_' + e.buttonCounter);
      c.appendChild(d);
    ...
    _fnCollectionShow: function(a, b) {
      var c = this, d = e(a).offset(), f = b._collection, j = d.left,
          d = d.top + e(a).outerHeight(), i = e(n).height(), h = e(k).height(),
          o = e(n).width(), g = e(k).width();
    ...
    _fnCollectionHide: function(a, b) {
      !(null !== b && 'collection' == b.sExtends) &&
          ...
          (e(this.dom.collection.collection)
               .animate(
                   {opacity: 0}, 500,
                   function() {
                     this.style.display = 'none'
    ...
    _fnRowSelectConfig: function() {
      if (this.s.master) {
        ...
        e(b.nTBody).on(
            'click.DTTT_Select', this.s.custom.sRowSelector, function(c) {
              var d = this.nodeName.toLowerCase() === 'tr' ?
                  this :
                  e(this).parents('tr')[0],
                  f = a.s.select, j = a.s.dt.oInstance.fnGetPosition(d);
              if (d.parentNode == b.nTBody &&
                  b.oInstance.fnGetData(d) !== null) {
                if (f.type == 'os')
                  if (c.ctrlKey || c.metaKey)
                    a.fnIsSelected(d) ? a._fnRowDeselect(d, c) :
                                        a._fnRowSelect(d, c);
                  else if (c.shiftKey) {
                    var i = a.s.dt.aiDisplay.slice(),
                        h = e.inArray(f.lastRow, i), o = e.inArray(j, i);
                    ...
                    if (a.fnIsSelected(d)) {
                      ...
                      a.fnIsSelected(d) && a.fnGetSelected().length === 1)
    ...
    _fnRowSelect: function(a, b) {
      ...
      if (null === this.s.select.preRowSelect ||
      ...
      if (a.nodeName)
        ...
        for (f = a.length; d < f; d++)
          a[d].nodeName ?
              ...
              'number' === typeof a[d] ? b.push(this.s.dt.aoData[a[d]]) :
                                         b.push(a[d])
      } else
        b.push(a);
      return b
    ...
    _fnGetDataTablesData: function(a) {
      var b, c, d, f, j, i = [], h = '', g = this.s.dt, k,
      ...
      m = (d = 'none' !== this.s.select.type && d && 0 !== f.length) ?
          ...
          g.oInstance.$('tr', a.oSelectorOpts)
                  .map(function(a, b) {
      ...
      for (f = m.length; d < f; d++) {
        ...
        a.bOpenRows &&
            (b = e.grep(
             ...
             1 === b.length &&
                 (h = this._fnBoundData(
                      e('td', b[0].nTr).html(), a.sFieldBoundary, l),
                  i.push(h)))
      }
    ...
    _fnPrintStart: function(a) {
      ...
      a.bShowAll &&
          (c._iDisplayStart = 0, c._iDisplayLength = -1,
    ...
    _fnPrintScrollStart: function() {
      var a = this.s.dt;
      a.nScrollHead.getElementsByTagName('div')[0].getElementsByTagName(
          'table');
    ...
    _fnPrintHideNodes: function(a) {
      for (var b = this.dom.print.hidden, c = a.parentNode, d = c.childNodes,
        ...
        if (d[f] != a && 1 == d[f].nodeType) {
          ...
          'none' != i &&
              (b.push({node: d[f], display: i}), d[f].style.display = 'none')
        }
  ...
  TableTools.BUTTONS = {
    ...
    copy: e.extend({}, TableTools.buttonBase, {
      ...
      fnComplete: function(a, b, c, d) {
        ...
        this.fnInfo(
            '<h6>Table copied</h6><p>Copied ' + a + ' row' +
                (1 == a ? '' : 's') + ' to the clipboard.</p>',
            1500)
      }
    }),
  ...
  'function' == typeof m.fn.dataTable &&
      ...
      m.fn.dataTableExt.aoFeatures.push({
        fnInit: function(a) {
          a = new TableTools(
              a.oInstance,
              'undefined' != typeof a.oInit.oTableTools ? a.oInit.oTableTools :
                                                          {});
...
'function' === typeof define && define.amd ?
    ...
    jQuery && !jQuery.fn.dataTable.TableTools && p(jQuery, jQuery.fn.dataTable)
})(window, document);
