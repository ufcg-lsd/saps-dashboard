...
function i(i, o, n) {
  var r = this;
  r.id = n, r.table = i, r.options = o, r.breakpoints = [],
  r.breakpointNames = '', r.columns = {},
    ...
    register: function(e) {
      return r.timers[e] = new a, r.timers[e]
         ...
         r.init = function() {
           ...
           r.raise(s.initializing), i.addClass(d.loading),
           ...
           r.breakpoints.sort(function(e, t) {
             return e.width - t.width
               ...
               i.unbind(u.initialize)
                   .bind(
                       u.initialize,
                       function() {
                         i.removeData('footable_info'),
                             i.data('breakpoint', ''), i.trigger(u.resize),
           ...
           if (l.addRowToggle) {
             ...
             for (var i in r.columns) {
               ...
               if (o.toggle) {
                 a = !0;
                 var n = '> tbody > tr:not(.' + d.detail + ',.' + d.disabled +
                     ') > td:nth-child(' + (parseInt(o.index, 10) + 1) + '),' +
                     '> tbody > tr:not(.' + d.detail + ',.' + d.disabled +
                     ') > th:nth-child(' + (parseInt(o.index, 10) + 1) + ')';
                 return t.find(n)
                            .not('.' + d.detailCell)
           ...
           if (t.is(':visible')) {
             ...
             if (t.data('footable_info', a),
               ...
               var d = null === n ? 'default' : n.name,
                   f = r.hasBreakpointColumn(d), p = t.data('breakpoint');
               t.data('breakpoint', d)
           ...
           var t = e(r.table), a = t.data('breakpoint'),
               i = r.hasBreakpointColumn(a);
           t.find('> tbody > tr:not(.' + d.detail + ')')
               ...
               t.find('> tbody > tr.' + d.detailShow + ':visible')
                   .each(function() {
                     var t = e(this).next();
           ...
           a.hasClass(d.detailShow) ?
               (a.removeClass(d.detailShow), i.hasClass(d.detail) && i.hide(),
           ...
           var i = a.next();
           a.data('detail_created') === !0 && i.remove(), a.remove(),
           ...
           if (r.raise(s.rowDetailUpdating, {row: i, detail: o}),
               i.find('> td:hidden').each(function() {
                 var t = e(this).index(), a = r.getColumnFromTdIndex(t),
                     i = a.name;
                 ...
                 if (null != o && e(this).is(':empty')) {
                   var l =
                       e('.' + d.detailInnerValue + '[' +
                         'data-bind-value="' + o + '"]');
                   e(this).html(e(l).contents().detach())
                 }
                 var s;
                 return a.isEditable !== !1 &&
                            (a.isEditable ||
                        ...
                        s || (s = e(this).contents().clone(!0, !0)), n.push({
                          name: i,
           ...
           return f ||
                      (o =
                           e('<tr class="' + d.detail + '"><td class="' +
                             d.detailCell + '"><div class="' + d.detailInner +
                             '"></div></td></tr>'),
                       i.after(o)),
                  o.find('> td:first').attr('colspan', u),
                  a = o.find('.' + d.detailInner).empty(),
                  l.createDetail(
                      a, n, l.createGroupedDetail, l.detailSeparator, d),
                  i.data('detail_created', !0),
                  r.raise(s.rowDetailUpdated, {row: i, detail: o}), !f
         }, r.raise = function(t, a) {
           r.options.debug === !0 && e.isFunction(r.options.log) &&
           ...
           t.removeData('footable_info')
               ...
               t.find('> tbody > tr.' + d.detail).remove(), r.raise(s.reset)
...
t.footable = {
    ...
    createDetail: function(t, a, i, o, n) {
      ...
      for (var l in r)
        if (0 !== r[l].data.length) {
          '_none' !== l &&
              t.append(
                  '<div class="' + n.detailInnerGroup + '">' + r[l].name +
                  '</div>');
  ...
  version: {
    ...
    parse: function(e) {
      var t = /(\d+)\.?(\d+)?\.?(\d+)?/.exec(e);
      return {
        major: parseInt(t[1], 10) || 0, minor: parseInt(t[2], 10) || 0,
  ...
  plugins: {
    _validate: function(a) {
      if (!e.isFunction(a))
        return t.footable.options.debug === !0 &&
                   console.error(
      ...
      return 'string' != typeof i.name ?
          ...
          (t.footable.options.debug === !0 &&
               console.log(
                   'Validation succeeded for plugin "' + i.name + '".', i),
           !0) :
          (t.footable.options.debug === !0 &&
               console.error(
                   'Validation failed, plugin "' + i.name +
...
function a(t) {
  ...
  return e.isPlainObject(t.data) && a.data(t.data),
         ...
         t.className && a.addClass(t.className), a
}
function o(t, o) {
  var i = t.find('thead');
...
function l(e, t, a) {
  0 === e.find('tr.emptyInfo').size() &&
      e.find('tbody').append(
          '<tr class="emptyInfo"><td colspan="' + t.length + '">' + a +
          '</td></tr>')
}
function d(t, a, o, i) {
  t.find('tr:not(.' + o + ')').each(function() {
    var t = e(this), o = a.data('index'), n = parseInt(t.data('index'), 0),
        r = n + i;
...
function s() {
  ...
  a.name = 'Footable Grid', a.init = function(t) {
    var d = t.options.classes.toggle, s = t.options.classes.detail,
        f = t.options.grid;
    if (f.cols) {
      a.footable = t;
      var u = e(t.table);
      u.data('grid', a), e.isPlainObject(f.data) && u.data(f.data),
          a._items = [], r(f.cols),
          ...
          u.off('.grid')
              .on({
                ...
                'footable_redrawn.grid footable_row_removed.grid': function() {
                  0 === a.getItem().length && f.showEmptyInfo &&
              ...
              .on('click.grid', 'thead input:checkbox.checkAll', function(e) {
                ...
                t ? u.find('tbody tr').addClass(f.activeClass) :
    ...
    if (n.find('tr.emptyInfo').remove(), e.isArray(t)) {
      ...
      return a.footable.redraw(),
             a.footable.raise(
                 a.footable.options.grid.events.created, {item: t, index: o}),
             undefined
    }
      ...
      if (o === undefined || 0 > o || o > f)
        ...
        if (s = a._makeRow(t, o), 0 === o)
          ...
          a._items.splice(o, 0, t),
              u.data('detail_created') === !0 && (u = u.next()), u.after(s)
        }
        d(n, s, r, 1)
      }
      i ||
    ...
    if (e.isPlainObject(t)) {
      ...
      r.html(n.html()), a.footable.redraw(),
          a.footable.raise(
              a.footable.options.grid.events.updated, {item: t, index: o})
    }
  }, a.removeItem = function(t) {
    var o = e(a.footable.table).find('tbody'),
        i = a.footable.options.classes.detail, n = [];
    if (e.isArray(t)) {
      for (var r; r = t.pop();) n.push(a.removeItem(r));
      return a.footable.raise(
                 a.footable.options.grid.events.removed, {item: n, index: t}),
             n
    }
    if (t === undefined)
...
var f = {
  grid: {
    ...
    pagination:
        {'page-size': 20, 'pagination-class': 'pagination pagination-centered'},
...
function a() {
  ...
  e.name = 'Footable Filter', e.init = function(a) {
              ...
              .bind({
                'footable_initialized.filtering': function() {
                  var i = t(a.table), o = {
                    ...
                    disableEnter: i.data('filter-disable-enter') ||
    ...
    var i = e.footable, o = t(i.table),
        n = o.data('filter-minimum') || i.options.filter.minimum, r = !a,
    ...
    i.find('> tbody > tr:not(.footable-row-detail)')
    ...
    i.is(':visible') ||
        (n.hasClass('breakpoint') && i.hasClass('footable-detail-show') &&
...
var i = {
  filter: {
    ...
    filterFunction: function() {
      var e = t(this), a = e.parents('table:first'),
          i = a.data('current-filter').toUpperCase(), o = e.find('td').text();
      return a.data('filter-text-only') ||
...
function a(t) {
  ...
  this.limitNavigation = parseInt(
      i.limitNavigation || t.options.limitNavigation || o.limitNavigation, 10),
  ...
  this.limit = this.limitNavigation > 0, this.currentPage = i.currentPage || 0,
  this.pages = [], this.control = !1
}
function i() {
  var t = this;
  t.name = 'Footable Paginate', t.init = function(a) {
    ...
    i.pageInfo = new a(i), t.createPages(i, o), t.createNavigation(i, o),
    ...
    d.each(function(e, t) {
      r.push(t),
          e === n - 1 ? (o.pages.push(r), i++, n = i * o.pageSize, r = []) :
    ...
    var i, o,
        n = e.find('li.footable-page-arrow > a[data-page="limit-prev"]')
                .parent(),
        r = e.find('li.footable-page-arrow > a[data-page="limit-next"]')
                .parent();
    for (i = t.pages.length - 1; i >= 0; i--)
      o = t.pages[i],
      i >= a && a + t.limitNavigation > i && o.length > 0 &&
          n.after(
              '<li class="footable-page"><a data-page="' + i + '" href="#">' +
              (i + 1) + '</a></li>');
    0 === a ? n.hide() : n.show(),
    ...
    if (o.currentPage !== i) {
      ...
      t.fillPage(a, n, i), o.control.find('li').removeClass('active disabled'),
          t.setPagingClasses(o.control, o.currentPage, o.pages.length)
    }
  }, t.setPagingClasses = function(e, t, a) {
    e.find('li.footable-page > a[data-page=' + t + ']')
        .parent()
        .addClass('active'),
        t >= a - 1 &&
        (e.find('li.footable-page-arrow > a[data-page="next"]')
             .parent()
             .addClass('disabled'),
         e.find('li.footable-page-arrow > a[data-page="last"]')
             .parent()
             .addClass('disabled')),
        1 > t &&
        (e.find('li.footable-page-arrow > a[data-page="first"]')
             .parent()
             .addClass('disabled'),
         e.find('li.footable-page-arrow > a[data-page="prev"]')
             .parent()
             .addClass('disabled'))
  }, t.fillPage = function(a, i, o) {
    a.pageInfo.currentPage = o, e(a.table).data('currentPage', o),
    i.find('> tr').hide(), e(a.pageInfo.pages[o]).each(function() {
      t.showRow(this, a)
    }),
  ...
  e.name = 'Footable Sortable', e.init = function(a) {
                ...
                if (n.data('sort') !== !1) {
                  n.find(
                      ...
                      .each(function() {
                        ...
                        i.sort.ignore === !0 || e.hasClass(r.sortable) ||
                            (e.addClass(r.sortable),
                             t('<span />').addClass(r.indicator).appendTo(e))
                      }),
                      n.find(
                           '> thead > tr:last-child > th.' + r.sortable +
                           ', > thead > tr:last-child > td.' + r.sortable)
                          .unbind('click.footable')
                          .bind('click.footable', function(a) {
    ...
    if (t(o.table).data('sort') !== !1) {
      var n = t(o.table), r = n.find('> tbody'), l = o.columns[a],
          ...
          d = o.options.classes.sort, f = o.options.events.sort;
      if (i = i === undefined ? s.hasClass(d.sorted) :
                                'toggle' === i ? !s.hasClass(d.sorted) : i,
          l.sort.ignore === !0)
        return !0;
      var u = o.raise(f.sorting, {column: l, direction: i ? 'ASC' : 'DESC'});
      u && u.result === !1 ||
          (n.data('sorted', l.index),
           n.find('> thead > tr:last-child > th, > thead > tr:last-child > td')
               .not(s)
               .removeClass(d.sorted + ' ' + d.descending),
           i === undefined && (i = s.hasClass(d.sorted)),
           i ? s.removeClass(d.descending).addClass(d.sorted) :
               s.removeClass(d.sorted).addClass(d.descending),
           e.sort(o, r, l, i), o.bindToggleSelectors(),
...
function a() {
  ...
  e.name = 'Footable Striping', e.init = function(a) {
    ...
    t(e.table).find('> tbody > tr:not(.footable-row-detail)').each(function() {
      var i = t(this);
      i.removeClass(e.options.classes.striping.even)
          .removeClass(e.options.classes.striping.odd),
          0 === a % 2 ? i.addClass(e.options.classes.striping.even) :
...
function a(t, e) {
  ...
  return (e = e.replace(/^\#/, '&').match(a)) ?
      e[1] === undefined ? '' : decodeURIComponent(e[1]) :
      undefined
}
function i(e, a) {
  var i = t(e.table)
              .find('tbody')
              .find('tr:not(.footable-row-detail, .footable-filtered)')
              .length;
  ...
  var n = t(e.table).data('sorted'), r = t(e.table).find('th')[n],
  ...
  var u, p, c;
  if ('footable_row_expanded' == a.type &&
          (u = a.row,
           u &&
               (p = t(e.table).data('expanded_rows'), c = [],
                p && (c = p.split(',')), c.push(u.rowIndex),
  ...
  e.name = 'Footable LucidBookmarkable', e.init = function(e) {
    e.options.bookmarkable.enabled && t(e.table).bind({
      footable_initialized: function() {
        var i = e.table.id, o = a(i + '_f'), n = a(i + '_p'), r = a(i + '_s'),
            l = a(i + '_d'), s = a(i + '_e');
        if (o) {
      ...
      'footable_page_filled footable_redrawn footable_filtered footable_sorted footable_row_expanded footable_row_collapsed':
          function(a) {
            if (i(e, a), e.lucid_bookmark_read) {
              var o = e.table.id, n = o + '_f', r = o + '_p', l = o + '_s',
                  s = o + '_d', d = o + '_e',
