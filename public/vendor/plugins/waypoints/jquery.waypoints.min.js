...
!function() {
  ...
  window.Waypoint = t
    ...
    function() {
      ...
      function e(t) {
        this.element = t, this.Adapter = r.Adapter,
      ...
      var i = 0, o = {}, r = window.Waypoint,
          n = window.requestAnimationFrame || window.mozRequestAnimationFrame ||
      ...
      e.prototype.add = function(t) {
        ...
        for (var i in e) {
          var o = e[i], r = o.newScroll > o.oldScroll,
        ...
        return this.element === this.element.window ? r.viewportHeight() :
                                                      this.adapter.innerHeight()
      }, e.prototype.remove = function(t) {
        delete this.waypoints[t.axis][t.key], this.checkEmpty()
      }, e.prototype.innerWidth = function() {
        return this.element === this.element.window ? r.viewportWidth() :
        ...
        for (var r in t) {
          ...
          for (var s in this.waypoints[r]) {
            var a, l, h, p, u, c = this.waypoints[r][s], d = c.options.offset,
            ...
            c.element !== c.element.window &&
                ...
                c.triggerPoint = w + a - d, l = f < n.oldScroll,
                h = c.triggerPoint >= n.oldScroll, p = l && h, u = !l && !h,
                !y && p ?
                (c.queueTrigger(n.backward), o[c.group.id] = c.group) :
                !y && u ? (c.queueTrigger(n.forward), o[c.group.id] = c.group) :
                          y && n.oldScroll >= c.triggerPoint &&
