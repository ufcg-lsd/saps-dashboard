!function(a) {
  ...
  'use strict';
  var b = function(a) {
    this.value = {h: 0, s: 0, b: 0, a: 1}, this.origFormat = null,
    a &&
        (void 0 !== a.toLowerCase ? this.setColor(a) :
  ...
  b.prototype = {
    ...
    _sanitizeNumber: function(a) {
      return 'number' == typeof a ?
          ...
          1 :
          void 0 !== a.toLowerCase ? parseFloat(a) : 1
    },
    setColor: function(a) {
    ...
    stringToHSB: function(b) {
      ...
      return a.each(this.stringParsers, function(a, e) {
        var f = e.re.exec(b), g = f && e.parse.apply(c, [f]),
            h = e.format || 'rgba';
        return g ? (d = h.match(/hsla?/) ?
    ...
    toRGB: function(a, b, c, d) {
      ...
      var e, f, g, h, i;
      return a = a % 360 / 60, i = c * b, h = i * (1 - Math.abs(a % 2 - 1)),
             e = f = g = c - i, a = ~~a, e += [i, h, 0, 0, h, i][a],
             f += [h, i, i, h, 0, 0][a], g += [0, 0, h, i, i, h][a], {
        r: Math.round(255 * e), g: Math.round(255 * f), b: Math.round(255 * g),
            a: d || this.value.a
      }
    },
    ...
    toHSL: function(a, b, c, d) {
      a = a || this.value.h, b = b || this.value.s, c = c || this.value.b,
      d = d || this.value.a;
      var e = a, f = (2 - b) * c, g = b * c;
      return g /= f > 0 && 1 >= f ? f : 2 - f, f /= 2, g > 1 && (g = 1), {
        h: isNaN(e) ? 0 : e, s: isNaN(g) ? 0 : g, l: isNaN(f) ? 0 : f,
            a: isNaN(d) ? 0 : d
      }
    },
    ...
    RGBtoHSB: function(a, b, c, d) {
      a /= 255, b /= 255, c /= 255;
      var e, f, g, h;
      return g = Math.max(a, b, c), h = g - Math.min(a, b, c),
             e = 0 === h ?
                 null :
                 g === a ? (b - c) / h :
                           g === b ? (c - a) / h + 2 : (a - b) / h + 4,
    ...
    HSLtoRGB: function(a, b, c, d) {
      ...
      var e;
      e = .5 >= c ? c * (1 + b) : c + b - c * b;
      var f = 2 * c - e, g = a + 1 / 3, h = a, i = a - 1 / 3,
    ...
    toString: function(a) {
      switch (a = a || 'rgba') {
        ...
        case 'hsl':
          var c = this.toHSL();
          return 'hsl(' + Math.round(360 * c.h) + ',' + Math.round(100 * c.s) +
              '%,' + Math.round(100 * c.l) + '%)';
        case 'hsla':
          var c = this.toHSL();
          return 'hsla(' + Math.round(360 * c.h) + ',' + Math.round(100 * c.s) +
              '%,' + Math.round(100 * c.l) + '%,' + c.a + ')';
        case 'hex':
          return this.toHex();
        case 'alias':
    ...
    stringParsers: [
      ...
      },
      {
        ...
        parse: function(a) {
          return [
            parseInt(a[1] + a[1], 16), parseInt(a[2] + a[2], 16),
            parseInt(a[3] + a[3], 16), 1
          ]
        }
      },
      {
  ...
  var c = {
    ...
    template:
      ...
      d = function(d, e) {
        ...
        this.container = this.options.container === !0 ? this.element :
        ...
        this.format = this.options.format !== !1 ? this.options.format :
                                                   this.color.origFormat,
        this.picker = a(this.options.template),
        this.picker.addClass(
            this.options.inline ? 'colorpicker-inline colorpicker-visible' :
                                  'colorpicker-hidden'),
  ...
  d.version = '2.0.0-beta', d.Color = b, d.prototype = {
    ...
    reposition: function() {
      ...
      var a = this.container && this.container[0] !== document.body ?
          'position' :
          'offset',
          b = this.component ? this.component[a]() : this.element[a]();
      this.picker.css({
        top: b.top +
            (this.component ? this.component.outerHeight() :
    ...
    hide: function() {
      this.picker.addClass('colorpicker-hidden')
          ...
          a(document).off({'mousedown.colorpicker': this.hide}), this.update(),
          this.element.trigger({type: 'hidePicker', color: this.color})
    },
    updateData: function(a) {
      return a = a || this.color.toString(this.format),
             this.element.data('color', a), a
    },
    updateInput: function(a) {
      return a = a || this.color.toString(this.format),
             this.input !== !1 && this.input.prop('value', a), a
    },
    updatePicker: function(a) {
      void 0 !== a && (this.color = new b(a));
      var c = this.options.horizontal === !1 ? this.options.sliders :
    ...
    updateComponent: function(a) {
      if (a = a || this.color.toString(this.format), this.component !== !1) {
        ...
        b.length > 0 ? b.css({backgroundColor: a}) :
    ...
    mousedown: function(b) {
      ...
      var c = a(b.target), d = c.closest('div'),
          e = this.options.horizontal ? this.options.slidersHorz :
    ...
    keyup: function(a) {
      if (38 === a.keyCode)
        this.color.value.a < 1 &&
            (this.color.value.a =
                 Math.round(100 * (this.color.value.a + .01)) / 100),
            this.update(!0);
  ...
  a.colorpicker = d, a.fn.colorpicker = function(b) {
    ...
    return this.each(function() {
      var e = a(this), f = e.data('colorpicker'),
          g = 'object' == typeof b ? b : {};
      f || 'string' == typeof b ? 'string' == typeof b &&
