var CanvasBG = function(options) {
  ...
  function initHeader(options) {
    ...
    for (var i in points) {
      var c =
          new Circle(points[i], 2 + Math.random() * 2, 'rgba(255,255,255,0.3)');
      points[i].circle = c;
    }
  }
 ...
 *http://www.greensock.com/terms_of_use.html or for Club GreenSock members, the
 *software agreement that was issued with your membership.
 *
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
  ...
  _gsScope._gsDefine('easing.Back', ['easing.Ease'], function(t) {
    var e, i, s,
        r = _gsScope.GreenSockGlobals || _gsScope, n = r.com.greensock,
        a = 2 * Math.PI, o = Math.PI / 2, h = n._class, l = function(e, i) {
          var s = h('easing.' + e, function() {}, !0), r = s.prototype = new t;
          return r.constructor = s, r.getRatio = i, s
        }, _ = t.register || function() {}, u = function(t, e, i, s) {
          var r =
              h('easing.' + t,
                {easeOut: new e, easeIn: new i, easeInOut: new s}, !0);
          return _(r, t), r
        }, c = function(t, e, i) {
          this.t = t, this.v = e,
          i &&
              (this.next = i, i.prev = this, this.c = i.v - e,
               this.gap = i.t - t)
        }, p = function(e, i) {
            ...
            return new s(t)
                   ...
                   return 1 > (t *= 2) ?
                       ...
                       .5 * ((t -= 2) * t * ((this._p2 + 1) * t + this._p2) + 2)
                        ...
                        e = e || 0 === e ? e : .7,
                        null == t ? t = .7 : t > 1 && (t = 1),
                        this._p = 1 !== t ? e : 0, this._p1 = (1 - t) / 2,
                        this._p2 = t, this._p3 = this._p1 + this._p2,
                        this._calcEnd = i === !0
    ...
    return d.constructor = m,
           d.getRatio =
             ...
             var e = t + (.5 - t) * this._p;
             return this._p1 > t ?
                 this._calcEnd ? 1 - (t = 1 - t / this._p1) * t :
           ...
           e =
               h('easing.SteppedEase',
                 function(t) {
                   t = t || 1, this._p1 = 1 / t, this._p2 = t + 1
                 },
                 !0),
           d = e.prototype = new t, d.constructor = e,
           d.getRatio =
               function(t) {
           ...
           i = h(
               ...
               function(e) {
                 e = e || {};
                 for (var i, s, r, n, a, o,
                      h = e.taper || 'none', l = [], _ = 0,
                      u = 0 | (e.points || 20), p = u, f = e.randomize !== !1,
                      m = e.clamp === !0,
                      d = e.template instanceof t ? e.template : null,
                      g = 'number' == typeof e.strength ? .4 * e.strength : .4;
                      --p > -1;)
                   i = f ? Math.random() : 1 / u * p, s = d ? d.getRatio(i) : i,
                   'none' === h ?
                       r = g :
                       'out' === h ?
                       (n = 1 - i, r = n * n * g) :
                 ...
                 for (l.sort(function(t, e) {
                      ...
                      o = new c(1, 1, null), p = u;
                      --p > -1;)
                   a = l[p], o = new c(a.x, a.y, o);
                 this._prev = new c(0, 0, 0 !== o.t ? o : o.next)
               },
               !0),
           d = i.prototype = new t, d.constructor = i,
           d.getRatio =
               function(t) {
             var e = this._prev;
             if (t > e.t) {
             ...
             l('BounceOut',
               function(t) {
                 return 1 / 2.75 > t ?
                     ...
                     2.5 / 2.75 > t ? 7.5625 * (t -= 2.25 / 2.75) * t + .9375 :
           ...
           u('Circ',
             ...
             l('CircInOut',
               function(t) {
                 return 1 > (t *= 2) ? -.5 * (Math.sqrt(1 - t * t) - 1) :
                                       .5 * (Math.sqrt(1 - (t -= 2) * t) + 1)
               })),
           s =
               function(e, i, s) {
             var r = h('easing.' + e, function(t, e) {
               this._p1 = t || 1, this._p2 = e || s,
               this._p3 = this._p2 / a * (Math.asin(1 / this._p1) || 0)
             }, !0), n = r.prototype = new t;
             return n.constructor = r, n.getRatio = i,
           ...
           u('Expo',
             ...
             l('ExpoInOut',
               function(t) {
                 return 1 > (t *= 2) ? .5 * Math.pow(2, 10 * (t - 1)) :
           ...
           h('easing.EaseLookup', {
             ...
             !0),
           _(r.SlowMo, 'SlowMo', 'ease,'), _(i, 'RoughEase', 'ease,'),
           _(e, 'SteppedEase', 'ease,'), f
  }, !0)
}),
...
;
!function() {
  for (var n = 0, i = ['ms', 'moz', 'webkit', 'o'], e = 0;
       e < i.length && !window.requestAnimationFrame; ++e)
  ...
  window.requestAnimationFrame ||
      (window.requestAnimationFrame =
           function(i) {
             var e = (new Date).getTime(), a = Math.max(0, 16 - (e - n)),
...
if (!i.TweenLite) {
  var s, n, r, a, o, l = function(t) {
    ...
    this.sc = p[s] ? p[s].sc : [], p[s] = this, this.gsClass = null,
    this.func = r;
    var o = [];
    this.check = function(h) {
      for (var _, u, f, m, d = n.length, v = d; --d > -1;)
        (_ = p[n[d]] || new c(n[d], [])).gsClass ? (o[d] = _.gsClass, v--) :
                                                   h && _.sc.push(this);
      if (0 === v && r)
        for (u = ('com.greensock.' + s).split('.'), f = u.pop(),
  ...
  var g = [0, 0, 1, 1], T = [],
      y = v('easing.Ease', function(t, e, i, s) {
        this._func = t, this._type = i || 0, this._power = s || 0,
        this._params = e ? g.concat(e) : g
      }, !0), w = y.map = {}, P = y.register = function(t, e, i, s) {
        for (var n, r, a, o, l = e.split(','), _ = l.length,
                             u = (i || 'easeIn,easeOut,easeInOut').split(',');
             --_ > -1;)
          for (r = l[_], n = s ? v('easing.' + r, null, !0) : h.easing[r] || {},
              a = u.length;
               --a > -1;)
            o = u[a],
            w[r + '.' + o] = w[o + r] = n[o] = t.getRatio ? t : t[o] || new t
      };
  for (r = y.prototype, r._calcEnd = !1,
      r.getRatio =
           function(t) {
             if (this._func)
      ...
      s = ['Linear', 'Quad', 'Cubic', 'Quart', 'Quint,Strong'], n = s.length;
       --n > -1;)
    r = s[n] + ',Power' + n, P(new y(null, null, 1, n), r, 'easeOut', !0),
  ...
  var k = t.requestAnimationFrame, A = t.cancelAnimationFrame,
      S = Date.now || function() {
        return (new Date).getTime()
      }, x = S();
  for (s = ['ms', 'moz', 'webkit', 'o'], n = s.length; --n > -1 && !k;)
    k = t[s[n] + 'RequestAnimationFrame'],
    A = t[s[n] + 'CancelAnimationFrame'] ||
        t[s[n] + 'CancelRequestAnimationFrame'];
  v('Ticker',
    function(t, e) {
      var i, s, n, r, l,
          h = this, u = S(), m = e !== !1 && k, p = 500, c = 33,
          d = function(t) {
            var e, a, o = S() - x;
            o > p && (u += o - c), x += o,
                h.time = (x - u) / 1e3, e = h.time - l,
                (!i || e > 0 || t === !0) &&
                (h.frame++, l += e + (e >= r ? .004 : r - e), a = !0),
                t !== !0 && (n = s(d)), a && h.dispatchEvent('tick')
          };
      b.call(h), h.time = h.frame = 0, h.tick = function() {
        ...
        null != n &&
            (m && A ? A(n) : clearTimeout(n), s = f, n = null,
             h === a && (o = !1))
      }, h.wake = function() {
  ...
  var C = v('core.Animation', function(t, e) {
    if (this.vars = e = e || {}, this._duration = this._totalDuration = t || 0,
        this._delay = Number(e.delay) || 0, this._timeScale = 1,
        this._active = e.immediateRender === !0, this.data = e.data,
  ...
  a = C.ticker = new h.Ticker, r = C.prototype,
  r._dirty = r._gc = r._initted = r._paused = !1, r._totalTime = r._time = 0,
  r._rawPrevTime = -1,
  ...
  R(), r.play = function(t, e) {
    ...
    return !e ||
        !this._gc && !this._paused && e.isActive() && (t = e.rawTime()) >= i &&
        i + this.totalDuration() / this._timeScale > t
  }, r._enabled = function(t, e) {
    return o || a.wake(), this._gc = !t, this._active = this.isActive(),
                          e !== !0 &&
               (t && !this.timeline ?
    ...
    if ('on' === (t || '').substr(0, 2)) {
      ...
      null == e ?
          delete n[t] :
          (n[t] = e,
           n[t + 'Params'] = m(i) && -1 !== i.join('').indexOf('{self}') ?
    ...
    return arguments.length ?
        (this._duration = this._totalDuration = t, this._uncache(!0),
         this._timeline.smoothChildTiming && this._time > 0 &&
             this._time < this._duration && 0 !== t &&
    ...
    if (this._timeline) {
      if (0 > t && !i && (t += this.totalDuration()),
        ...
        if (t > s && !i && (t = s),
            this._startTime = (this._paused ? this._pauseTime : n._time) -
    ...
    return arguments.length ? this.totalTime(this.duration() * t, e) :
    ...
    if (t != this._paused && this._timeline) {
      ...
      !t && e.smoothChildTiming && (this._startTime += s, this._uncache(!1)),
          this._pauseTime = t ? i : null, this._paused = t,
          this._active = this.isActive(),
          !t && 0 !== s && this._initted && this.duration() &&
          this.render(
              e.smoothChildTiming ? this._totalTime :
  ...
  r = D.prototype = new C, r.constructor = D, r.kill()._gc = !1,
  r._first = r._last = null, r._sortChildren = !1,
  r.add = r.insert = function(t, e) {
    var i, s;
    if (t._startTime = Number(e || 0) + t._delay,
        t._paused && this !== t._timeline &&
            (t._pauseTime =
                 t._startTime + (this.rawTime() - t._startTime) / t._timeScale),
        t.timeline && t.timeline._remove(t, !0),
        t.timeline = t._timeline = this, t._gc && t._enabled(!0, !0),
        i = this._last, this._sortChildren)
      for (s = t._startTime; i && i._startTime > s;) i = i._prev;
    return i ? (t._next = i._next, i._next = t) :
               (t._next = this._first, this._first = t),
           t._next ? t._next._prev = t : this._last = t, t._prev = i,
  ...
  var I = v('TweenLite', function(e, i, s) {
    ...
    if (this._overwrite = l = null == l ? Q[I.defaultOverwrite] :
      ...
      for (this._targets = a = u(e), this._propLookup = [], this._siblings = [],
          n = 0;
           a.length > n; n++)
        r = a[n],
        r ? 'string' != typeof r ?
            ...
            (this._siblings[n] = $(r, this, !1),
             1 === l && this._siblings[n].length > 1 &&
                 K(r, this, null, 1, this._siblings[n])) :
            (r = a[n--] = I.selector(r),
             'string' == typeof r && a.splice(n + 1, 1)) :
            a.splice(n--, 1);
    else
      this._propLookup = {}, this._siblings = $(e, this, !1),
      1 === l && this._siblings.length > 1 &&
          K(e, this, null, 1, this._siblings);
    (this.vars.immediateRender ||
     0 === i && 0 === this._delay && this.vars.immediateRender !== !1) &&
        (this._time = -_, this.render(-this._delay))
  }, !0), E = function(e) {
    return e.length && e !== t && e[0] &&
        (e[0] === t || e[0].nodeType && e[0].style && !e.nodeType)
  }, z = function(t, e) {
    var i, s = {};
    for (i in t)
      G[i] ||
          i in e && 'transform' !== i && 'x' !== i && 'y' !== i &&
              'width' !== i && 'height' !== i && 'className' !== i &&
              'border' !== i ||
          !(!U[i] || U[i] && U[i]._autoCSS) || (s[i] = t[i], delete t[i]);
    t.css = s
  };
  r = I.prototype = new C, r.constructor = I, r.kill()._gc = !1, r.ratio = 0,
  r._firstPT = r._targets = r._overwrittenProps = r._startAt = null,
  r._notifyPluginsOfEnabled = r._lazy = !1, I.version = '1.13.1',
  I.defaultEase = r._ease = new y(null, null, 1, 1),
  I.defaultOverwrite = 'auto', I.ticker = a, I.autoSleep = !0,
  I.lagSmoothing = function(t, e) {
    a.lagSmoothing(t, e)
  }, I.selector = t.$ || t.jQuery || function(e) {
    var i = t.$ || t.jQuery;
    return i ? (I.selector = i, i(e)) :
  ...
  B._startTime = a.time, q._startTime = a.frame, B._active = q._active = !0,
  setTimeout(M, 1), C._updateRoot = I.render = function() {
    var t, e, i;
    if (O.length && M(),
      ...
      if (i = B._first,
          (!i || i._paused) && I.autoSleep && !q._first &&
  ...
  var $ = function(t, e, i) {
          ...
          (o._timeline !== e._timeline ?
               ...
               u >= o._startTime &&
                   ...
                   ((p || !o._initted) && 2e-10 >= u - o._startTime ||
                    (f[m++] = o)));
    for (r = m; --r > -1;)
      o = f[r], 2 === s && o._kill(i, t) && (a = !0),
      (2 !== s || !o._firstPT && o._initted) && o._enabled(!1, !1) && (a = !0);
    return a
  }, H = function(t, e, i) {
    for (var s = t._timeline, n = s._timeScale, r = t._startTime;
         s._timeline;) {
    ...
    return r /= n,
           r > e ?
               ...
               _ :
               (r += t.totalDuration() / t._timeScale / n) > e + _ ? 0 :
                                                                     r - e - _
  };
  r._init = function() {
    var t, e, i, s, n, r = this.vars, a = this._overwrittenProps,
                       o = this._duration, l = !!r.immediateRender, h = r.ease;
    if (r.startAt) {
      this._startAt && (this._startAt.render(-1, !0), this._startAt.kill()),
          n = {};
      for (s in r.startAt) n[s] = r.startAt[s];
      if (n.overwrite = !1, n.immediateRender = !0, n.lazy = l && r.lazy !== !1,
          n.startAt = n.delay = null, this._startAt = I.to(this.target, 0, n),
          l)
        if (this._time > 0)
          this._startAt = null;
        else if (0 !== o)
      ...
      if (this._startAt)
        ...
        if (i.overwrite = 0, i.data = 'isFromStart',
            i.lazy = l && r.lazy !== !1, i.immediateRender = l,
    ...
    if (this._ease = h = h ? h instanceof y ?
                             h :
                             'function' == typeof h ? new y(h, r.easeParams) :
                                                      w[h] || I.defaultEase :
                             I.defaultEase,
        r.easeParams instanceof Array && h.config &&
            (this._ease = h.config.apply(h, r.easeParams)),
        this._easeType = this._ease._type, this._easePower = this._ease._power,
        this._firstPT = null, this._targets)
      for (t = this._targets.length; --t > -1;)
        this._initProps(
            this._targets[t], this._propLookup[t] = {}, this._siblings[t],
            a ? a[t] : null) &&
            (e = !0);
    else
    ...
    L[e._gsTweenID] && M(),
        this.vars.css ||
        e.style && e !== t && e.nodeType && U.css && this.vars.autoCSS !== !1 &&
            z(this.vars, e);
    for (r in this.vars) {
      if (_ = this.vars[r], G[r])
        _ && (_ instanceof Array || _.push && m(_)) &&
        ...
        h.s = h.f ?
            e[r.indexOf('set') || 'function' != typeof e['get' + r.substr(3)] ?
                  r :
                  'get' + r.substr(3)]() :
            parseFloat(e[r]),
        h.c = 'string' == typeof _ && '=' === _.charAt(1) ?
    ...
    if (t >= l)
      ...
      0 === l && (this._initted || !this.vars.lazy || i) &&
      ...
      (1 === f || 3 === f && u >= .5) && (u = 1 - u), 3 === f && (u *= 2),
          1 === m ?
          u *= u :
          2 === m ? u *= u* u :
                    3 === m ? u *= u * u * u : 4 === m && (u *= u * u * u * u),
          this.ratio =
              1 === f ? 1 - u : 2 === f ? u : .5 > t / l ? u / 2 : 1 - u / 2
    } else
    ...
    if (this._time !== o || i) {
      if (!this._initted) {
        ...
        if (!i && this._firstPT &&
            (this.vars.lazy !== !1 && this._duration ||
             this.vars.lazy && !this._duration))
          return this._time = this._totalTime = o, this._rawPrevTime = h,
                 O.push(this), this._lazy = t, void 0;
        this._time&& !s ? this.ratio = this._ease.getRatio(this._time / l) :
                          s && this._ease._calcEnd &&
      ...
      for (this._lazy !== !1 && (this._lazy = !1),
           ...
           0 === o &&
               (this._startAt &&
                    (t >= 0 ? this._startAt.render(t, e, i) :
                              n || (n = '_dummyGS')),
                this.vars.onStart && (0 !== this._time || 0 === l) &&
                    (e ||
           ...
           r = this._firstPT;
           r;)
        r.f ? r.t[r.p](r.c * this.ratio + r.s) :
              r.t[r.p] = r.c * this.ratio + r.s,
              r = r._next;
      this._onUpdate &&
          (0 > t && this._startAt && this._startTime &&
          ...
          n && (!this._gc || i) &&
          (0 > t && this._startAt && !this._onUpdate && this._startTime &&
               this._startAt.render(t, e, i),
           s &&
    ...
    e = 'string' != typeof e ? e || this._targets || this.target :
                               I.selector(e) || e;
    var i, s, n, r, a, o, l, h;
    ...
    return this._notifyPluginsOfEnabled && I._onPluginEvent('_onDisable', this),
           this._firstPT = null, this._overwrittenProps = null,
           this._onUpdate = null, this._startAt = null,
           this._initted = this._active = this._notifyPluginsOfEnabled =
               this._lazy = !1,
  ...
  var J = v('plugins.TweenPlugin', function(t, e) {
    ...
    this._propName = this._overwriteProps[0], this._priority = e || 0,
    this._super = J.prototype
  }, !0);
  if (r = J.prototype, J.version = '1.10.1', J.API = 2, r._firstPT = null,
      r._addTween =
            ...
            for (; s;)
              null != t[s.n] &&
                  (s._next && (s._next._prev = s._prev),
                   s._prev ? (s._prev._next = s._next, s._prev = null) :
      ...
      d.plugin =
          function(t) {
            ...
            var e, i = t.propName, s = t.priority || 0, n = t.overwriteProps,
                   ...
                   a =
                       v('plugins.' + i.charAt(0).toUpperCase() + i.substr(1) +
                             'Plugin',
                         function() {
