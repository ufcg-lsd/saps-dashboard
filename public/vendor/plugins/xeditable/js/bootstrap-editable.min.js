...
!function(a) {
  ...
  var b = function(b, c) {
    ...
    this.$div = a(b), this.options.scope || (this.options.scope = this)
  };
  b.prototype = {
    constructor: b,
    initInput: function() {
    ...
    render: function() {
      ...
      this.$div.empty().append(this.$loading), this.initTemplate(),
      this.options.showbuttons ? this.initButtons() :
                                 this.$form.find('.editable-buttons').remove(),
      this.showLoading(), this.isSaving = !1,
      this.$div.triggerHandler('rendering'), this.initInput(),
      this.$form.find('div.editable-input').append(this.input.$tpl),
      this.$div.append(this.$form),
      a.when(this.input.render()).then(a.proxy(function() {
        if (this.options.showbuttons || this.input.autosubmit(),
            this.$form.find('.editable-cancel')
          ...
          this.error(!1), this.input.$input.removeAttr('disabled'),
              this.$form.find('.editable-submit').removeAttr('disabled');
          var b = null === this.value || void 0 === this.value ||
                  '' === this.value ?
    ...
    showLoading: function() {
      var a, b;
      this.$form ?
          (a = this.$form.outerWidth(), b = this.$form.outerHeight(),
           a && this.$loading.width(a), b && this.$loading.height(b),
           this.$form.hide()) :
          (a = this.$loading.parent().width(), a && this.$loading.width(a)),
          this.$loading.show()
    },
    showForm: function(a) {
      this.$loading.hide(), this.$form.show(),
          a !== !1 && this.input.activate(), this.$div.triggerHandler('show')
    },
    error: function(b) {
    ...
    submit: function(b) {
      ...
      a.when(this.save(e))
          .done(a.proxy(
              function(a) {
                this.isSaving = !1;
                var b = 'function' == typeof this.options.success ?
                ...
                return b === !1 ?
                    ...
                    (b && 'object' == typeof b &&
                         b.hasOwnProperty('newValue') && (c = b.newValue),
                     this.error(!1), this.value = c,
                     this.$div.triggerHandler(
                         'save', {newValue: c, submitValue: e, response: a}),
                     void 0)
              },
              this))
          .fail(a.proxy(function(a) {
            this.isSaving = !1;
            var b;
            b = 'function' == typeof this.options.error ?
    ...
    save: function(b) {
      ...
      var c,
          d = 'function' == typeof this.options.pk ?
    ...
    setValue: function(a, b) {
      ...
      this.$form && this.$form.is(':visible') &&
  ...
  a.fn.editableform =
    ...
    return this.each(function() {
      var e = a(this), f = e.data('editableform'),
          g = 'object' == typeof c && c;
  ...
  a.fn.editableform.engine = 'jquery'
    ...
    function(a) {
      ...
      a.fn.editableutils = {
        inherit: function(a, b) {
          ...
          a.prototype.constructor = a, a.superclass = b.prototype
        },
        setCursorPosition: function(a, b) {
          if (a.setSelectionRange)
            ...
            c.collapse(!0), c.moveEnd('character', b),
                c.moveStart('character', b), c.select()
          }
        },
        ...
        sliceObj: function(b, c, d) {
          ...
          for (var h = 0; h < c.length; h++)
            e = c[h], b.hasOwnProperty(e) && (g[e] = b[e]),
            d !== !0 &&
        ...
        createInput: function(b) {
          ...
          return 'date' === f &&
                     ('inline' === b.mode ?
                      ...
                      'date' !== f || a.fn.editabletypes.date ||
                          (f = 'combodate')),
                 'datetime' === f && 'inline' === b.mode &&
                     (f = 'datetimefield'),
        ...
        supportsTransitions: function() {
          var a = document.body || document.documentElement, b = a.style,
              c = 'transition', d = ['Moz', 'Webkit', 'Khtml', 'O', 'ms'];
    ...
    function(a) {
      ...
      b.prototype = {
        ...
        init: function(c, d) {
          ...
          this.splitOptions(), this.formOptions.scope = this.$element[0],
          this.initContainer(), this.delayedHide = !1,
          this.$element.on(
              'destroyed',
              a.proxy(
                  function() {
          ...
          a(document).data('editable-handlers-attached') ||
              (a(document).on('keyup.editable', function(b) {
                ...
                var d, e = a(c.target), f = [
                  '.editable-container', '.ui-datepicker-header', '.datepicker',
        ...
        splitOptions: function() {
          if (this.containerOptions = {}, this.formOptions = {},
              !a.fn[this.containerName])
            throw new Error(
                this.containerName +
                ' not found. Have you included corresponding js file?');
          for (var b in this.options)
            b in this.defaults ? this.containerOptions[b] = this.options[b] :
                ...
                rendered: a.proxy(
                    function() {
                      this.$element.triggerHandler(
                          'shown', a(this.options.scope).data('editable'))
                    },
                    this)
              })
              .editableform('render')
        ...
        show: function(b) {
          this.$element.addClass('editable-open'),
              b !== !1 && this.closeOthers(this.$element[0]), this.innerShow(),
              this.tip().addClass(this.containerClass), this.$form,
              this.$form = a('<div>'),
        ...
        destroy: function() {
          this.hide(), this.innerDestroy(), this.$element.off('destroyed'),
        ...
        activate: function() {
          this.tip && this.tip().is(':visible') && this.$form &&
              this.$form.data('editableform').input.activate()
        }
      },
      a.fn.editableContainer =
          function(d) {
        var e = arguments;
        return this.each(function() {
          var f = a(this), g = 'editableContainer', h = f.data(g),
              i = 'object' == typeof d && d, j = 'inline' === i.mode ? c : b;
    ...
    function(a) {
      ...
      b.prototype = {
          ...
          if (this.options.name = this.options.name || this.$element.attr('id'),
            ...
            switch (
                void 0 === this.options.value || null === this.options.value ?
                    (this.value =
                         this.input.html2value(a.trim(this.$element.html())),
                     c = !0) :
                    (this.options.value = a.fn.editableutils.tryParseJson(
                         this.options.value, !0),
                     this.value = 'string' == typeof this.options.value ?
              ...
              case 'always':
                ...
                break;
              case 'auto':
                b = !a.trim(this.$element.text()).length &&
                    null !== this.value && void 0 !== this.value && !c;
                break;
              default:
                b = !1
            }
        ...
        initLive: function() {
          ...
          this.$element.on(
              this.options.toggle + '.editable', b, a.proxy(function(b) {
                var c = a(b.target);
                c.data('editable') ||
        ...
        render: function(a) {
          return this.options.display !== !1 ?
              ...
              this.input.value2html(
                  this.value, this.$element[0], this.options.display, a) :
              'function' == typeof this.options.display ?
        ...
        disable: function() {
          this.options.disabled = !0, this.hide(),
              ...
              (this.options[b] = c,
               'disabled' === b ?
                   ...
                   ('value' === b && this.setValue(c),
                    ...
                    this.input.option && this.input.option(b, c), void 0))
        },
        handleEmpty: function(b) {
          this.options.display !== !1 &&
              (this.isEmpty = void 0 !== b ?
                   b :
        ...
        show: function(b) {
          if (!this.options.disabled) {
            if (this.container) {
              ...
              var c = a.extend(
                  {}, this.options, {value: this.value, input: this.input});
        ...
        toggle: function(a) {
          this.container && this.container.tip().is(':visible') ? this.hide() :
                                                                  this.show(a)
        },
        save: function(a, b) {
          if (this.options.unsavedclass) {
            ...
            c ? this.$element.removeClass(this.options.unsavedclass) :
          ...
          if (this.options.highlight) {
            ...
            d.css('background-color', this.options.highlight),
                setTimeout(function() {
                  'transparent' === e && (e = ''), d.css('background-color', e),
        ...
        destroy: function() {
          this.disable(), this.container && this.container.destroy(),
              this.input.destroy(),
              'manual' !== this.options.toggle &&
          ...
          case 'validate':
            return this.each(function() {
              ...
              e && (b = e.validate()) && (d[e.options.name] = b)
                   ...
                   d;
          case 'getValue':
            return 2 === arguments.length && arguments[1] === !0 ?
                       d = this.eq(0).data(f).value :
                       this.each(function() {
                         var b = a(this), c = b.data(f);
                         c && void 0 !== c.value && null !== c.value &&
            ...
            if (a.isEmptyObject(i)) {
              ...
              if (1 === h.length) {
                var k = h.data('editable'), l = {
                  ...
                  pk: 'function' == typeof k.options.pk ?
                ...
                'function' == typeof k.options.params ?
                    ...
                    (k.options.params =
                         a.fn.editableutils.tryParseJson(k.options.params, !0),
              ...
              g.data && a.extend(j.data, g.data), a.ajax(j)
            } else
    ...
    function(a) {
      ...
      b.prototype = {
        ...
        prerender: function() {
          this.$tpl = a(this.options.tpl), this.$input = this.$tpl,
          this.$clear = null, this.error = null
        },
        render: function() {},
        ...
        setAttr: function(a) {
          void 0 !== this.options[a] && null !== this.options[a] &&
          ...
          a.extend(b.prototype, {
            ...
            value2html: function(b, c, d, e) {
              var f = a.Deferred(), g = function() {
                'function' == typeof d ? d.call(c, b, this.sourceData, e) :
                                         this.value2htmlFinal(b, c),
                    f.resolve()
              };
              return null === b ? g.call(this) :
                                  this.onSourceReady(
                                      g,
                                      function() {
                                        f.resolve()
            ...
            onSourceReady: function(b, c) {
              var d;
              if (a.isFunction(this.options.source) ?
              ...
              if ('string' == typeof d) {
                if (this.options.sourceCache) {
                  ...
                  if (a(document).data(g) || a(document).data(g, {}),
                      f = a(document).data(g), f.loading === !1 && f.sourceData)
                    return this.sourceData = f.sourceData, this.doPrepend(),
                           b.call(this), void 0;
                  if (f.loading === !0)
                    return f.callbacks.push(a.proxy(function() {
                      this.sourceData = f.sourceData, this.doPrepend(),
                      b.call(this)
                ...
                this.sourceData = this.makeArray(d),
                a.isArray(this.sourceData) ? (this.doPrepend(), b.call(this)) :
                                             c.call(this)
            },
            doPrepend: function() {
                  ...
                  (a.isArray(this.prependData) ||
                       (a.isFunction(this.options.prepend) &&
                        ...
                        this.options.prepend = a.fn.editableutils.tryParseJson(
                            this.options.prepend, !0),
                        'string' == typeof this.options.prepend &&
                            (this.options.prepend = {'': this.options.prepend}),
                        this.prependData =
                            this.makeArray(this.options.prepend)),
                   a.isArray(this.prependData) && a.isArray(this.sourceData) &&
                       (this.sourceData =
            ...
            option: function(a, b) {
              this.options[a] = b, 'source' === a && (this.sourceData = null),
    ...
    function(a) {
      ...
      a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
          a.extend(b.prototype, {
            render: function() {
              this.setClass(), this.setAttr('placeholder'),
                  this.setAttr('rows'), this.$input.keydown(function(b) {
                    b.ctrlKey && 13 === b.which &&
      ...
      a.fn.editableutils.inherit(b, a.fn.editabletypes.list),
          a.extend(b.prototype, {
            renderList: function() {
              ...
              b(this.$input, this.sourceData), this.setClass(),
          ...
          b.defaults = a.extend(
              {}, a.fn.editabletypes.list.defaults, {tpl: '<select></select>'}),
              ...
              if (this.$tpl.empty(), a.isArray(this.sourceData)) {
                for (var c = 0; c < this.sourceData.length; c++)
                  b = a('<label>')
                          ...
                          .append(
                              a('<span>').text(' ' + this.sourceData[c].text)),
    ...
    function(a) {
      ...
      a.fn.editableutils.inherit(b, a.fn.editabletypes.text),
          a.extend(b.prototype, {
            render: function() {
              b.superclass.render.call(this), this.setAttr('min'),
                  this.setAttr('max'), this.setAttr('step')
            },
            postrender: function() {
    ...
    function(a) {
      ...
      a.fn.editableutils.inherit(b, a.fn.editabletypes.number),
          a.extend(b.prototype, {
            render: function() {
              this.$input = this.$tpl.filter('input'), this.setClass(),
              ...
              this.options.select2.tags ?
                  ...
                  (f = [],
                   a.each(
                       ...
                       function(a, b) {
                         f.push(
                             b && 'object' == typeof b ? g.formatSelection(b) :
                                                         b)
                       })) :
    ...
    function(a) {
      var b = function(b, c) {
        return this.$element = a(b),
               this.$element.is('input') ?
                   (this.options = a.extend(
                        {}, a.fn.combodate.defaults, c, this.$element.data()),
                    this.init(), void 0) :
      ...
      b.prototype = {
        ...
        init: function() {
          ...
          this.$widget =
              a('<span class="combodate"></span>').html(this.getTemplate()),
          this.initCombos(),
          this.$widget.on(
              'change', 'select',
              a.proxy(
        ...
        fillDay: function() {
          var a, b, c = this.fillCommon('d'),
                    d = -1 !== this.options.template.indexOf('DD'), e = 31;
        ...
        fillMonth: function() {
          ...
          for (b = 0; 11 >= b; b++)
            a = d ? moment().date(1).month(b).format('MMMM') :
                    e ? moment().date(1).month(b).format('MMM') :
                 ...
                 f ? '' :
                     (this.$ampm &&
                          (d.hour = 12 === d.hour ?
                               ...
                               'am' === this.$ampm.val() ? d.hour :
                                                           d.hour + 12),
                      c = moment(
                          [d.year, d.month, d.day, d.hour, d.minute, d.second]),
                      this.highlight(c),
                      b = void 0 === b ? this.options.format : b,
                      null === b ? c.isValid() ? c : null :
        ...
        setValue: function(b) {
          ...
          if (b) {
            var d = 'string' == typeof b ? moment(b, this.options.format) :
                                           moment(b),
                e = this, f = {};
            d.isValid() &&
                (a.each(
                 ...
                 a.each(
                     ...
                     function(a, b) {
                       e['$' + a] &&
                           ('minute' === a && e.options.minuteStep > 1 &&
                                e.options.roundTime && (b = c(e['$' + a], b)),
                            'second' === a && e.options.secondStep > 1 &&
                                e.options.roundTime && (b = c(e['$' + a], b)),
                            e['$' + a].val(b))
                     }),
      ...
      a.fn.combodate = function(c) {
        ...
        return e.shift(),
               'getValue' === c && this.length &&
                       (d = this.eq(0).data('combodate')) ?
                   d.getValue.apply(d, e) :
                   this.each(function() {
                     var d = a(this), f = d.data('combodate'),
                         g = 'object' == typeof c && c;
    ...
    function(a) {
      ...
      a.extend(a.fn.editableform.Constructor.prototype, {
        ...
        initInput: function() {
          b.apply(this);
          var c = null === this.input.options.inputclass ||
              this.input.options.inputclass === !1,
              d = 'form-control',
              e = 'text,select,textarea,password,email,url,tel,number,range,time,typeaheadjs'
                      .split(',');
          ...
          for (var f = this.$form.find('.editable-buttons'),
          ...
          a.fn.editableform.buttons =
              '<button type="submit" class="btn btn-primary editable-submit"><i class="glyphicon glyphicon-ok"></i></button><button type="button" class="btn btn-default editable-cancel"><i class="glyphicon glyphicon-remove"></i></button>',
    ...
    function(a) {
      ...
      a.extend(a.fn.editableContainer.Popup.prototype, {
        ...
        setPosition: function() {
          !function() {
            var a = this.tip(),
                b = 'function' == typeof this.options.placement ?
                this.options.placement.call(this, a[0], this.$element[0]) :
                this.options.placement,
                c = /\s?auto?\s?/i, d = c.test(b);
            d && (b = b.replace(c, '') || 'top');
            var e = this.getPosition(), f = a[0].offsetWidth,
                g = a[0].offsetHeight;
            if (d) {
              var h = this.$element.parent(), i = b,
                  j = document.documentElement.scrollTop ||
                  document.body.scrollTop,
                  k = 'body' == this.options.container ? window.innerWidth :
                                                         h.outerWidth(),
                  l = 'body' == this.options.container ? window.innerHeight :
                                                         h.outerHeight(),
                  m = 'body' == this.options.container ? 0 : h.offset().left;
              b = 'bottom' == b && e.top + e.height + g - j > l ?
                  'top' :
                  'top' == b && e.top - j - g < 0 ?
                  'bottom' :
                  'right' == b && e.right + f > k ?
    ...
    function(a) {
      ...
      var e = function(b, c) {
        this._process_options(c),
            this.element = a(b), this.isInline = !1,
            this.isInput = this.element.is('input'),
            this.component = this.element.is('.date') ?
            this.element.find('.add-on, .btn') :
            !1,
            this.hasInput = this.component && this.element.find('input').length,
            this.component && 0 === this.component.length &&
            (this.component = !1),
            this.picker = a(l.template), this._buildEvents(),
            this._attachEvents(),
            this.isInline ?
            ...
            this._allow_update = !1, this.setStartDate(this.o.startDate),
            this.setEndDate(this.o.endDate),
            this.setDaysOfWeekDisabled(this.o.daysOfWeekDisabled),
            this.fillDow(), this.fillMonths(), this._allow_update = !0,
            this.update(), this.showMode(), this.isInline && this.show()
      };
      e.prototype = {
        constructor: e,
        _process_options: function(b) {
          ...
          c.startView = Math.max(c.startView, c.minViewMode), c.weekStart %= 7,
                    ...
                    mousedown: a.proxy(
                        function(a) {
                          this.element.is(a.target) ||
                              ...
                              this.picker.find(a.target).size() || this.hide()
                        },
                        this)
                  }
                ]
        ...
        show: function(a) {
          this.isInline || this.picker.appendTo('body'), this.picker.show(),
              this.height = this.component ? this.component.outerHeight() :
                                             this.element.outerHeight(),
              this.place(), this._attachSecondaryEvents(),
              a && a.preventDefault(), this._trigger('show')
        },
        hide: function() {
          this.isInline ||
              this.picker.is(':visible') &&
                  (this.picker.hide().detach(), this._detachSecondaryEvents(),
        ...
        remove: function() {
          this.hide(), this._detachEvents(), this._detachSecondaryEvents(),
              this.picker.remove(), delete this.element.data().datepicker,
        ...
        setValue: function() {
          ...
          this.isInput ? this.element.val(a) :
        ...
        setStartDate: function(a) {
          this._process_options({startDate: a}), this.update(),
              this.updateNavArrows()
        },
        setEndDate: function(a) {
          this._process_options({endDate: a}), this.update(),
              this.updateNavArrows()
        },
        setDaysOfWeekDisabled: function(a) {
          this._process_options({daysOfWeekDisabled: a}), this.update(),
              this.updateNavArrows()
        },
        place: function() {
          if (!this.isInline) {
            var b = parseInt(this.element.parents()
                                 .filter(function() {
                                 ...
                                 .css('z-index')) +
                10,
                c = this.component ? this.component.parent().offset() :
                                     this.element.offset(),
                d = this.component ? this.component.outerHeight(!0) :
        ...
        update: function() {
          if (this._allow_update) {
            ...
            arguments && arguments.length &&
                ...
                (a = arguments[0], b = !0) :
                (a = this.isInput ? this.element.val() :
                                    this.element.data('date') ||
                         this.element.find('input').val(),
                 delete this.element.data().date),
                this.date = l.parseDate(a, this.o.format, this.o.language),
                b && this.setValue(),
                this.viewDate = this.date < this.o.startDate ?
                new Date(this.o.startDate) :
                this.date > this.o.endDate ? new Date(this.o.endDate) :
                                             new Date(this.date),
                this.fill()
          }
        },
        fillDow: function() {
          ...
          for (; a < this.o.weekStart + 7;)
            b += '<th class="dow">' + k[this.o.language].daysMin[a++ % 7] +
                '</th>';
          b += '</tr>', this.picker.find('.datepicker-days thead').append(b)
        },
        fillMonths: function() {
          for (var a = '', b = 0; 12 > b;)
            a += '<span class="month">' + k[this.o.language].monthsShort[b++] +
                '</span>';
        ...
        getClassNames: function(b) {
          var c = [], d = this.viewDate.getUTCFullYear(),
              e = this.viewDate.getUTCMonth(), f = this.date.valueOf(),
              g = new Date;
          return b.getUTCFullYear() < d ||
                 ...
                 this.o.todayHighlight &&
                     ...
                     b.getUTCDate() == g.getDate() && c.push('today'),
        ...
        fill: function() {
          var c,
              ...
              f = d.getUTCMonth(),
              g = this.o.startDate !== -1 / 0 ?
              this.o.startDate.getUTCFullYear() :
              -1 / 0,
              h = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCMonth() :
                                                -1 / 0,
              i = 1 / 0 !== this.o.endDate ? this.o.endDate.getUTCFullYear() :
                                             1 / 0,
              j = 1 / 0 !== this.o.endDate ? this.o.endDate.getUTCMonth() :
                                             1 / 0;
          ...
          for (var p, q = []; m.valueOf() < o;) {
            if (m.getUTCDay() == this.o.weekStart &&
                (q.push('<tr>'), this.o.calendarWeeks)) {
              var r = new Date(
                      +m +
                      864e5 * ((this.o.weekStart - m.getUTCDay() - 7) % 7)),
            ...
            void 0 === v ? v = {} :
                           ...
                           v.tooltip && (c = v.tooltip), p = a.unique(p),
                           q.push(
                               '<td class="' + p.join(' ') + '"' +
                               (c ? ' title="' + c + '"' : '') + '>' +
                               m.getUTCDate() + '</td>'),
          ...
          var w = this.date && this.date.getUTCFullYear(),
              x = this.picker.find('.datepicker-months')
                      .find('th:eq(1)')
                      .text(e)
                      .end()
                      .find('span')
          ...
          var y = this.picker.find('.datepicker-years')
                      .find('th:eq(1)')
                      .text(e + '-' + (e + 9))
                      .end()
                      .find('td');
          ...
          if (1 == d.length) switch (d[0].nodeName.toLowerCase()) {
              case 'th':
                switch (d[0].className) {
                  ...
                  case 'prev':
                  case 'next':
                    var e = l.modes[this.viewMode].navStep *
                  ...
                  case 'clear':
                    ...
                    this.isInput ?
                        ...
                        h && h.val('').change(), this._trigger('changeDate'),
              ...
              case 'span':
                if (!d.is('.disabled')) {
                  if (this.viewDate.setUTCDate(1), d.is('.month')) {
                    var i = 1, j = d.parent().find('span').index(d),
        ...
        _setDate: function(a, b) {
          b && 'date' != b || (this.date = new Date(a)),
              b && 'view' != b || (this.viewDate = new Date(a)), this.fill(),
              this.setValue(), this._trigger('changeDate');
          var c;
          this.isInput ? c = this.element :
                         this.component && (c = this.element.find('input')),
                         c &&
              (c.change(), !this.o.autoclose || b && 'date' != b || this.hide())
        },
        moveMonth: function(a, b) {
          if (!b) return a;
          var c, d, e = new Date(a.valueOf()), f = e.getUTCDate(),
                    g = e.getUTCMonth(), h = Math.abs(b);
          if (b = b > 0 ? 1 : -1, 1 == h)
            d = -1 == b ?
                function() {
          ...
          switch (a.keyCode) {
            ...
            case 39:
              ...
              a.ctrlKey ?
                  ...
                  a.shiftKey ? (c = this.moveMonth(this.date, b),
              ...
              this.dateWithinRange(c) &&
                  (this.date = c, this.viewDate = d, this.setValue(),
                   this.update(), a.preventDefault(), e = !0);
              break;
            case 38:
            case 40:
              if (!this.o.keyboardNavigation) break;
        ...
        showMode: function(a) {
          a &&
              (this.viewMode = Math.max(
                   this.o.minViewMode, Math.min(2, this.viewMode + a))),
      ...
      var g = a.fn.datepicker,
          h = a.fn.datepicker =
            ...
            var h;
            return this.each(function() {
              var j = a(this), k = j.data('datepicker'),
                  l = 'object' == typeof b && b;
              if (!k) {
                var m = c(this, 'date'), n = a.extend({}, i, m, l),
                    o = d(n.language), p = a.extend({}, i, o, m, l);
              ...
              return 'string' == typeof b && 'function' == typeof k[b] &&
        ...
        en: {
          ...
          l = {
            ...
            getDaysInMonth: function(a, b) {
              return [
                31, l.isLeapYear(a) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31,
                30, 31
              ][b]
            },
            ...
            parseDate: function(c, d, f) {
              ...
              if ('string' == typeof d && (d = l.parseFormat(d)),
                ...
                return b(
                    c.getUTCFullYear(), c.getUTCMonth(), c.getUTCDate(), 0, 0,
                    0)
              }
              var n, o, g,
                  j = c && c.match(this.nonpunctuation) || [], c = new Date,
            ...
            formatDate: function(b, c, d) {
              ...
              e.dd = (e.d < 10 ? '0' : '') + e.d,
              e.mm = (e.m < 10 ? '0' : '') + e.m;
              for (var b = [], f = a.extend([], c.separators), g = 0,
                       h = c.parts.length;
                   h >= g; g++)
      ...
      l.template =
          ...
          l.headTemplate + '<tbody></tbody>' + l.footTemplate + '</table>' +
          '</div>' +
          '<div class="datepicker-months">' +
          '<table class="table-condensed">' + l.headTemplate + l.contTemplate +
          l.footTemplate + '</table>' +
          '</div>' +
          ...
          a.extend(b.prototype, {
            initPicker: function(b, c) {
              this.options.viewformat ||
                  (this.options.viewformat = this.options.format),
                  b.datepicker =
                      a.fn.editableutils.tryParseJson(b.datepicker, !0),
              ...
              this.$input.bdatepicker(this.options.datepicker),
                  ...
                  (this.$clear = a('<a href="#"></a>')
                                     ...
                                     .click(a.proxy(
                                         function(a) {
                                           a.preventDefault(),
                                               a.stopPropagation(), this.clear()
                                         },
                                         this)),
                   this.$tpl.parent().append(
                       a('<div class="editable-clear">').append(this.$clear)))
            },
            value2html: function(a, c) {
              var d = a ? this.dpg.formatDate(
                              a, this.parsedViewFormat,
                              this.options.datepicker.language) :
                          '';
              b.superclass.value2html.call(this, d, c)
            },
            ...
            value2str: function(a) {
              return a ?
                  this.dpg.formatDate(
                      a, this.parsedFormat, this.options.datepicker.language) :
                  ''
            },
            str2value: function(a) {
            ...
            parseDate: function(a, b) {
              ...
              return a &&
                         (d = this.dpg.parseDate(
                              a, b, this.options.datepicker.language),
                          'string' == typeof a &&
                              (c = this.dpg.formatDate(
                                   d, b, this.options.datepicker.language),
                               a !== c && (d = null))),
                     d
            }
          }),
    ...
    function(a) {
      ...
      a.fn.editableutils.inherit(b, a.fn.editabletypes.date),
          a.extend(b.prototype, {
            render: function() {
              this.$input = this.$tpl.find('input'), this.setClass(),
          ...
          a.extend(b.prototype, {
            initPicker: function(b, c) {
              this.options.viewformat ||
                  (this.options.viewformat = this.options.format),
                  b.datetimepicker =
                      a.fn.editableutils.tryParseJson(b.datetimepicker, !0),
                  ...
                  this.parsedFormat = this.dpg.parseFormat(
                      this.options.format, this.options.formatType),
            ...
            value2html: function(a, c) {
              var d = a ? this.dpg.formatDate(
                              this.toUTC(a), this.parsedViewFormat,
                              this.options.datetimepicker.language,
            ...
            value2str: function(a) {
              return a ? this.dpg.formatDate(
                             this.toUTC(a), this.parsedFormat,
                             this.options.datetimepicker.language,
                             this.options.formatType) :
                         ''
            },
            ...
            parseDate: function(a, b) {
              ...
              return a &&
                         (d = this.dpg.parseDate(
                              a, b, this.options.datetimepicker.language,
                              this.options.formatType),
                          'string' == typeof a &&
                              (c = this.dpg.formatDate(
                                   d, b, this.options.datetimepicker.language,
                                   this.options.formatType),
                               a !== c && (d = null))),
                     d
            }
