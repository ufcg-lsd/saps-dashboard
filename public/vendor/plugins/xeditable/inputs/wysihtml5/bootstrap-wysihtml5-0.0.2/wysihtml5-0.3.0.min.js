...
window.rangy = function() {
  ...
  function g() {
    if (!o.initialized) {
      ...
      b(document, 'createRange') &&
          (a = document.createRange(), m(a, p) && x(a, n) && (d = !0),
           a.detach());
      if ((a = c(document, 'body') ?
               document.body :
      ...
      for (a = d.length; h < a; ++h) try {
          ...
          c(window, 'console') && b(window.console, 'log') &&
              window.console.log(
                  'Init listener threw an exception. Continuing.', j)
        }
    }
  }
  function i(a) {
  ...
  var h = 'object', k = 'function', j = 'undefined',
      n = 'startContainer startOffset endContainer endOffset collapsed commonAncestorContainer START_TO_START START_TO_END END_TO_START END_TO_END'
              .split(' '),
      p = 'setStart setStartBefore setStartAfter setEnd setEndBefore setEndAfter collapse selectNode selectNodeContents compareBoundaryPoints deleteContents extractContents cloneContents insertNode surroundContents cloneRange toString detach'
              .split(' '),
      q = 'boundingHeight boundingLeft boundingTop boundingWidth htmlText text'
              .split(' '),
  ...
  o.warn = function(a) {
    a = 'Rangy warning: ' + a;
    o.config.alertOnWarn ? window.alert(a) :
                           typeof window.console != j &&
            typeof window.console.log != j && window.console.log(a)
  };
  ...
  if (typeof window == j)
    ...
    return b(document, 'addEventListener') &&
...
rangy.createModule('DomUtil', function(b, c) {
  ...
  b.dom = {
    ...
    isHtmlNamespace: function(a) {
      var b;
      return typeof a.namespaceURI == p || null === (b = a.namespaceURI) ||
    ...
    getBody: function(a) {
      return q.isHostObject(a, 'body') ? a.body :
...
rangy.createModule('DomRange', function(b) {
  ...
  function g(a, b, c) {
    ...
    l.isCharacterDataNode(b) ?
        ...
        c >= b.childNodes.length ? b.appendChild(a) :
  ...
  function j(b) {
    for (var c, d = a(b.range).createDocumentFragment(), h; c = b.next();) {
      b.isPartiallySelectedSubtree() ?
          (c = c.cloneNode(!1), h = b.getSubtreeIterator(), c.appendChild(j(h)),
           h.detach(!0)) :
          b.remove();
  ...
  function p(a) {
    return '[' + ('undefined' == typeof a.getName ? 'Range' : a.getName()) +
        '(' + l.inspectNode(a.startContainer) + ':' + a.startOffset + ', ' +
    ...
    if (!a.collapsed) {
      ...
      this.sc === this.ec && l.isCharacterDataNode(this.sc) ?
          ...
          (this._first = this._next =
           ...
           this._last = this.ec === c && !l.isCharacterDataNode(this.ec) ?
  ...
  function v(a) {
    o(a);
    if (!l.arrayContains(G, a.startContainer.nodeType) &&
            !O(a.startContainer, !0) ||
        !l.arrayContains(G, a.endContainer.nodeType) &&
            !O(a.endContainer, !0) ||
        !(a.startOffset <= (l.isCharacterDataNode(a.startContainer) ?
                                a.startContainer.length :
                                a.startContainer.childNodes.length)) ||
        !(a.endOffset <= (l.isCharacterDataNode(a.endContainer) ?
  ...
  function E(a, b) {
    return function() {
      ...
      var c = this.startContainer, d = this.startOffset,
          e = this.commonAncestorContainer, j = new q(this, !0);
      c !== e &&
          (c = l.getClosestAncestorIn(c, e, !0), d = f(c), c = d.node,
           d = d.offset);
      h(j, A);
      j.reset();
      e = a(j);
    ...
    b.util.extend(a.prototype, {
      ...
      collapse: function(a) {
        ...
        a ? d(this, this.startContainer, this.startOffset, this.startContainer,
              this.startOffset) :
            d(this, this.endContainer, this.endOffset, this.endContainer,
              this.endOffset)
      },
      ...
      splitBoundaries: function() {
        ...
        var a = this.startContainer, b = this.startOffset,
            c = this.endContainer, h = this.endOffset, e = a === c;
        l.isCharacterDataNode(c) && (0 < h && h < c.length) &&
            l.splitDataNode(c, h);
        l.isCharacterDataNode(a) && (0 < b && b < a.length) &&
      ...
      normalizeBoundaries: function() {
        v(this);
        var a = this.startContainer, b = this.startOffset,
            c = this.endContainer, h = this.endOffset, e = function(a) {
              var b = a.nextSibling;
              b && b.nodeType == a.nodeType &&
                  (c = a, h = a.length, a.appendData(b.data),
        ...
        l.isCharacterDataNode(c) ? c.length == h && e(c) :
                                   (0 < h && (k = c.childNodes[h - 1]) &&
                                        l.isCharacterDataNode(k) && e(k),
                                    k = !this.collapsed);
        k ? l.isCharacterDataNode(a) ? 0 == b && j(a) :
                                       b < a.childNodes.length &&
                    (e = a.childNodes[b]) && l.isCharacterDataNode(e) && j(e) :
            (a = c, b = h);
        d(this, a, b, c, h)
      },
      collapseToPoint: function(a, b) {
        ...
        x(a, !0);
        w(a, b);
        (a !== this.startContainer || b !== this.startOffset ||
         a !== this.endContainer || b !== this.endOffset) &&
            d(this, a, b, a, b)
      }
    });
    F(a)
    ...
    next: function() {
      ...
      a &&
          (this._next = a !== this._last ? a.nextSibling : null,
           l.isCharacterDataNode(a) && this.clonePartiallySelectedTextNodes &&
               (a === this.ec &&
                    (a = a.cloneNode(!0))
                        .deleteData(this.eo, a.length - this.eo),
  ...
  var L = [1, 3, 4, 5, 7, 8, 10], G = [2, 9, 11],
      P = [1, 3, 4, 5, 7, 8, 10, 11], H = [1, 3, 4, 5, 7, 8],
      M = l.getRootContainer, O = s([9, 11]), aa = s([5, 6, 10, 12]),
      $ = s([6, 10, 12]), Z = document.createElement('style'), S = !1;
  try {
    Z.innerHTML = '<b>x</b>', S = 3 == Z.firstChild.nodeType
  } catch (ca) {
  }
  b.features.htmlParsingConforms = S;
  var T = 'startContainer startOffset endContainer endOffset collapsed commonAncestorContainer'
              .split(' '),
      Q = 0, U = 1, ba = 2, V = 3, W = 0, X = 1, Y = 2, R = 3;
  D.prototype = {
    ...
    compareBoundaryPoints: function(a, b) {
      ...
      return l.comparePoints(
          this[c + 'Container'], this[c + 'Offset'], b[d + 'Container'],
          b[d + 'Offset'])
    },
    ...
    cloneContents: function() {
      ...
      if (this.startContainer === this.endContainer &&
        ...
        return b = this.startContainer.cloneNode(!0),
               b.data = b.data.slice(this.startOffset, this.endOffset),
               c = a(this).createDocumentFragment(), c.appendChild(b), c;
      c = new q(this, !0);
      b = i(c);
      c.detach();
      return b
    ...
    comparePoint: function(a, b) {
      ...
      return 0 > l.comparePoints(a, b, this.startContainer, this.startOffset) ?
          -1 :
          0 < l.comparePoints(a, b, this.endContainer, this.endOffset) ? 1 : 0
    },
    ...
    intersectsRange: function(b, c) {
      ...
      var d = l.comparePoints(
              this.startContainer, this.startOffset, b.endContainer,
              b.endOffset),
          h = l.comparePoints(
              this.endContainer, this.endOffset, b.startContainer,
              b.startOffset);
    ...
    intersection: function(a) {
      if (this.intersectsRange(a)) {
        var b = l.comparePoints(
                this.startContainer, this.startOffset, a.startContainer,
                a.startOffset),
            c = l.comparePoints(
                this.endContainer, this.endOffset, a.endContainer, a.endOffset),
            d = this.cloneRange();
    ...
    union: function(a) {
      if (this.intersectsRange(a, !0)) {
        ...
        1 ==
                l.comparePoints(
                    a.endContainer, a.endOffset, this.endContainer,
                    this.endOffset) &&
    ...
    containsNodeContents: function(a) {
      return 0 <= this.comparePoint(a, 0) &&
    ...
    containsNodeText: function(a) {
      ...
      var c = b.getNodes([3]);
      return 0 < c.length ?
          (b.setStart(c[0], 0), a = c.pop(), b.setEnd(a, a.length),
           a = this.containsRange(b), b.detach(), a) :
...
rangy.createModule('WrappedRange', function(b) {
  function c(a, b, c, d) {
    ...
    var b = e.getDocument(i).createElement('span'), r,
    ...
    if (-1 == r && m && e.isCharacterDataNode(m)) {
      ...
      m = (d || !c) && b.previousSibling,
      i = (c = (d || c) && b.nextSibling) && e.isCharacterDataNode(c) ?
          new f(c, 0) :
          m && e.isCharacterDataNode(m) ? new f(m, m.length) :
                                          new f(i, e.getNodeIndex(b));
    b.parentNode.removeChild(b);
    return i
  }
  function a(a, b) {
    var c, d, f = a.offset, g = e.getDocument(a.node),
              i = g.body.createTextRange(), m = e.isCharacterDataNode(a.node);
  ...
  if (b.features.implementsDomRange &&
    ...
    (function() {
      ...
      c.selectNodeContents = q.startContainer == i && q.endContainer == i &&
              0 == q.startOffset && q.endOffset == i.length ?
          function(b) {
...
rangy.createModule('WrappedSelection', function(b, c) {
  ...
  function g(a) {
    ...
    a instanceof x ?
        ...
        a instanceof o ? c = a.nativeRange :
                         b.features.implementsDomRange &&
                a instanceof m.getWindow(a.startContainer).Range && (c = a);
    return c
  }
  function i(a) {
    var b = a.getNodes(), c;
  ...
  function j(a, b) {
    for (var c = a.docSelection.createRange(), d = i(b),
             e = m.getDocument(c.item(0)),
             e = m.getBody(e).createControlRange(), h = 0, j = c.length;
         h < j; ++h)
      e.add(c.item(h));
    try {
      e.add(d)
  ...
  function p(a, b) {
    for (var c = m.getDocument(b[0].startContainer),
             c = m.getBody(c).createControlRange(), d = 0, e;
         d < rangeCount; ++d) {
      e = i(b[d]);
      try {
        c.add(e)
  ...
  var m = b.dom, s = b.util, x = b.DomRange, o = b.WrappedRange,
      z = b.DOMException, w = m.DomPosition, y, A,
  ...
  var t = y(), K = b.createNativeRange(document), F = m.getBody(document),
      E = s.areHostObjects(
          t, s.areHostProperties(t, ['anchorOffset', 'focusOffset']));
  ...
  s.areHostMethods(t, ['addRange', 'getRangeAt', 'removeAllRanges']) &&
      ('number' == typeof t.rangeCount && b.features.implementsDomRange) &&
      function() {
  ...
  var l = !1, u;
  F && s.isHostMethod(F, 'createControlRange') &&
  ...
  if (!D && E && s.areHostMethods(t, ['removeAllRanges', 'addRange'])) {
    ...
    u.setRanges = function(a) {
      ...
      s.isHostMethod(t, 'empty') && s.isHostMethod(K, 'select') && l && D)
    u.removeAllRanges = function() {
      try {
  ...
  if (D)
    G = function(a) {
      ...
      a.docSelection.type == 'Control' ?
          k(a) :
          c && typeof c.text != 'undefined' ? h(a, c) : f(a)
    };
    ...
    G = function(a) {
      ...
      E && 'boolean' == typeof t.isCollapsed &&
      'boolean' == typeof K.collapsed && b.features.implementsDomRange)
    G = function(a) {
      var b;
      b = a.nativeSelection;
      if (b.anchorNode) {
  ...
  u.removeRange = l ? function(a) {
    if (this.docSelection.type == 'Control') {
      for (var b = this.docSelection.createRange(), a = i(a),
               c = m.getDocument(b.item(0)),
               c = m.getBody(c).createControlRange(), d, e = false, h = 0,
               j = b.length;
           h < j; ++h) {
        d = b.item(h);
  ...
  u.toHtml = function() {
    var a = '';
    if (this.rangeCount) {
      for (var a = x.getRangeDocument(this._ranges[0]).createElement('div'),
               b = 0, c = this._ranges.length;
           b < c; ++b)
  ...
  u.detach = function() {
    this.win = this.anchorNode = this.focusNode = this.win._rangySelection =
        null
  };
  n.inspect = r;
  b.Selection = n;
  ...
  var e = d.constructor, f = d.constructor = function() {
    if (!Base._prototyping)
      if (this._constructing || this.constructor == f)
        this._constructing = !0, e.apply(this, arguments),
  ...
  extend: function(b, c) {
    if (1 < arguments.length) {
      ...
      if (a && 'function' == typeof c &&
          (!a.valueOf || a.valueOf() != c.valueOf()) && /\bbase\b/.test(c)) {
      ...
      for (var f = {toSource: null}, g = ['constructor', 'toString', 'valueOf'],
...
wysihtml5.browser = function() {
  var b = navigator.userAgent, c = document.createElement('div'),
      ...
      e = -1 !== b.indexOf('AppleWebKit/'), f = -1 !== b.indexOf('Chrome/'),
      g = -1 !== b.indexOf('Opera/');
  return {
    USER_AGENT: b, supported: function() {
      var a = this.USER_AGENT.toLowerCase(), b = 'contentEditable' in c,
          ...
          a = this.isIos() &&
              5 > (/ipad|iphone|ipod/.test(a) &&
                       a.match(/ os (\d+).+? like mac os x/) ||
                   [, 0])[1] ||
          -1 !== a.indexOf('opera mobi') || -1 !== a.indexOf('hpwos/');
      return b && d && e && !a
      ...
      return -1 !==
          ('' + document.getElementsByClassName).indexOf('[native code]')
      ...
      return 11 <= (b.match(/Chrome\/(\d+)/) || [, 0])[1] &&
...
wysihtml5.lang.array = function(b) {
  return {
    contains: function(c) {
      ...
      for (var c = wysihtml5.lang.array(c), a = [], d = 0, e = b.length; d < e;
           d++)
...
var d = b.lang.array('CODE PRE A SCRIPT HEAD TITLE STYLE'.split(' ')),
    e = /((https?:\/\/|www\.)[^\s<]{3,})/gi, f = /([^\w\/\-](,?))$/i, g = 100,
    i = {')': '(', ']': '[', '}': '{'};
...
wysihtml5.dom.convertToList = function() {
  ...
  return function(c, a) {
    if ('UL' === c.nodeName || 'OL' === c.nodeName || 'MENU' === c.nodeName)
      return c;
    var d = c.ownerDocument, e = d.createElement(a),
        f = c.querySelectorAll('br'), g = f.length, i, h, k, j, n;
    for (n = 0; n < g; n++)
    ...
    for (n = 0; n < g; n++)
      ...
      k = 'BR' === i.nodeName,
      h ? (j = j.firstChild ? b(d, e) : j, j.appendChild(i), j = null) :
...
var c =
        [
          '-webkit-box-sizing', '-moz-box-sizing', '-ms-box-sizing',
          'box-sizing'
        ],
    a = function(a) {
      var e;
      a: for (var f = 0, g = c.length; f < g;
              f++) if ('border-box' === b.getStyle(c[f]).from(a)) {
        e = c[f];
        break a
      }
...
b.dom.delegate = function(c, a, d, e) {
  return b.dom.observe(c, d, function(d) {
    for (var g = d.target, i = b.lang.array(c.querySelectorAll(a));
         g && g !== c;) {
      if (i.contains(g)) {
        e.call(g, d);
        break
...
wysihtml5.dom.getAsDom = function() {
  var b =
      'abbr article aside audio bdi canvas command datalist details figcaption figure footer header hgroup keygen mark meter nav output progress rp rt ruby svg section source summary time track video wbr'
          .split(' ');
  return function(c, a) {
    var a = a || document, d;
...
wysihtml5.dom.getParentElement = function() {
  function b(b, a) {
    return !a || !a.length ?
        !0 :
        'string' === typeof a ? b === a : wysihtml5.lang.array(a).contains(b)
  }
  return function(c, a, d) {
    d = d || 50;
    if (a.className || a.classRegExp) {
      a: {
        for (var e = a.nodeName, f = a.className, a = a.classRegExp;
             d-- && c && 'BODY' !== c.nodeName;) {
          var g;
    ...
    a: {
      e = a.nodeName; for (f = d; f-- && c && 'BODY' !== c.nodeName;) {
    ...
    return {
      from: function(e) {
        if (e.nodeType === wysihtml5.ELEMENT_NODE) {
          var f = e.ownerDocument, g = c[a] || b(a), i = e.style,
              h = e.currentStyle, k = i[g];
          if (k) return k;
          if (h) try {
              return h[g]
            } catch (j) {
          ...
          if (g.getComputedStyle)
            return f && (n = i.overflow, i.overflow = 'hidden'),
...
wysihtml5.dom.hasElementWithTagName = function() {
  var b = {}, c = 1;
  return function(a, d) {
    var e = (a._wysihtml5_identifier || (a._wysihtml5_identifier = c++)) + ':' +
        d,
        f = b[e];
...
b.dom.hasElementWithClassName = function(d, e) {
  ...
  var f = (d._wysihtml5_identifier || (d._wysihtml5_identifier = a++)) + ':' +
      e,
      g = c[f];
...
wysihtml5.dom.insertCSS = function(b) {
  ...
  return {
    into: function(c) {
      ...
      d.type = 'text/css';
      d.styleSheet ? d.styleSheet.cssText = b :
...
wysihtml5.dom.observe = function(b, c, a) {
  for (var c = 'string' === typeof c ? [c] : c, d, e, f = 0, g = c.length;
       f < g; f++)
    e = c[f],
  ...
  return {
    stop: function() {
      for (var e, h = 0, f = c.length; h < f; h++)
        e = c[h],
        b.removeEventListener ? b.removeEventListener(e, a, !1) :
...
wysihtml5.dom.parse = function() {
  function b(c, e) {
    ...
    return e && 1 >= g.childNodes.length && g.nodeName.toLowerCase() === d &&
            !g.attributes.length ?
        g.firstChild :
        g
  }
  ...
  var a = {
    1: function(a) {
      ...
      b && 'HTML' != b && (f = b + ':' + f);
      'outerHTML' in a && !wysihtml5.browser.autoClosesUnclosedTags() &&
          ('P' === a.nodeName &&
      ...
      var i = {}, r = b.set_class, m = b.add_class, s = b.set_attributes,
          x = b.check_attributes, o = g.classes, z = 0, w = [];
      b = [];
      var y = [], A = [], t;
    ...
    3: function(a) {
      ...
      i = !wysihtml5.browser.supportsGetAttributeCorrectly(), h = {
        url: function() {
          var a = /^https?:\/\//i;
          return function(b) {
  ...
  return function(a, c, d, e) {
    ...
    for (var d = d || a.ownerDocument || document,
             c = d.createDocumentFragment(), h = 'string' === typeof a,
...
wysihtml5.dom.removeEmptyTextNodes = function(b) {
  for (var c = wysihtml5.lang.array(b.childNodes).get(), a = c.length, d = 0;
       d < a; d++)
    b = c[d],
    b.nodeType === wysihtml5.TEXT_NODE && '' === b.data &&
        b.parentNode.removeChild(b)
};
...
b.resolveList = function(a) {
  if (!('MENU' !== a.nodeName && 'UL' !== a.nodeName && 'OL' !== a.nodeName)) {
    var d = a.ownerDocument.createDocumentFragment(),
        e = a.previousElementSibling || a.previousSibling, f, g, i;
    for (e && 'block' !== b.getStyle('display').from(e) && c(d);
         i = a.firstChild;) {
      for (f = i.lastChild; e = i.firstChild;)
        g = (g = e === f) && 'block' !== b.getStyle('display').from(e) &&
            'BR' !== e.nodeName,
...
(function(b) {
var c = document,
    a = 'parent top opener frameElement frames localStorage globalStorage sessionStorage indexedDB'
            .split(' '),
...
b.dom.Sandbox = Base.extend({
  ...
  _onLoadIframe: function(f) {
    if (b.dom.contains(c.documentElement, f)) {
      var g = this, i = f.contentWindow, h = f.contentWindow.document,
          k = this._getHtml({
...
'textContent' in c ? (b.setTextContent =
                          function(a, b) {
                            a.textContent = b
                          },
                      b.getTextContent =
                     ...
                     'innerText' in c ? (b.setTextContent =
                                             function(a, b) {
                                               a.innerText = b
                                             },
                                         b.getTextContent =
...
wysihtml5.quirks.cleanPastedHTML = function() {
  ...
  return function(c, a, d) {
    var a = a || b, d = d || c.ownerDocument || document,
        e = 'string' === typeof c, f, g, i, h = 0,
  ...
  return function(d) {
    c.observe(d.element, 'keydown', function(e) {
      if (e.keyCode === b.BACKSPACE_KEY) {
        ...
        e.firstChild && b.lang.array(a).contains(e.firstChild.nodeName) &&
            (f = c.getParentElement(f, {nodeName: a})) && f == e.firstChild &&
...
b.quirks.getCorrectInnerHTML = function(c) {
  ...
  for (f = c.length; g < f; g++)
    d = c[g].href || c[g].src, e = b.lang.string(d).replace('~').by('%7E'),
    a = b.lang.string(a).replace(e).by(d);
  return a
}
})(wysihtml5);
(function(b) {
var c = b.dom, a = 'LI P H1 H2 H3 H4 H5 H6'.split(' '),
    d = ['UL', 'OL', 'MENU'];
    ...
    if (!(g.shiftKey || i !== b.ENTER_KEY && i !== b.BACKSPACE_KEY)) {
      ...
      (h = c.getParentElement(h, {nodeName: a}, 4)) ?
          ...
          setTimeout(
              ...
              0) :
          h.nodeName.match(/H[1-6]/) && i === b.ENTER_KEY &&
                  setTimeout(
                      function() {
                        f(e.selection.getSelectedNode())
                      },
                      0) :
          i === b.ENTER_KEY && !b.browser.insertsLineBreaksOnReturn() &&
...
b.Selection = Base.extend({
  ...
  selectNode: function(a) {
    var d = rangy.createRange(this.doc), e = a.nodeType === b.ELEMENT_NODE,
        ...
        g = e ? a.innerHTML : a.data, g = '' === g || g === b.INVISIBLE_SPACE,
  ...
  getSelectedNode: function(a) {
    if (a && this.doc.selection && 'Control' === this.doc.selection.type &&
        (a = this.doc.selection.createRange()) && a.length)
      return a.item(0);
    a = this.getSelection(this.doc);
    return a.focusNode === a.anchorNode ?
        a.focusNode :
        (a = this.getRange(this.doc)) ? a.commonAncestorContainer :
                                        this.doc.body
  },
  executeAndRestore: function(a, c) {
    var e = this.doc.body, f = c && e.scrollTop, g = c && e.scrollLeft,
        i = '<span class="_wysihtml5-temp-placeholder">' + b.INVISIBLE_SPACE +
        '</span>',
    ...
    if (h) {
      ...
      (caretPlaceholder =
          ...
          (h = rangy.createRange(this.doc), h.selectNode(caretPlaceholder),
           h.deleteContents(), this.setSelection(h)) :
          e.focus();
  ...
  scrollIntoView: function() {
    var a = this.doc,
        c = a.documentElement.scrollHeight > a.documentElement.offsetHeight, e;
  ...
  _selectLine_MSIE: function() {
    var a = this.doc.selection.createRange(), b = a.boundingTop,
        c = this.doc.body.scrollWidth, f;
    if (a.moveToPoint) {
      0 === b &&
          (f = this.doc.createElement('span'), this.insertNode(f),
           b = f.offsetTop, f.parentNode.removeChild(f));
      b += 1;
...
function a(a, b) {
  return c.dom.isCharacterDataNode(a) ?
      0 == b ? !!a.previousSibling : b == a.length ? !!a.nextSibling : !0 :
...
function e(a) {
  this.firstTextNode =
      (this.isElementMerge = a.nodeType == b.ELEMENT_NODE) ? a.lastChild : a;
...
e.prototype = {
  doMerge: function() {
    for (var a = [], b, c, d = 0, e = this.textNodes.length; d < e; ++d)
      b = this.textNodes[d], c = b.parentNode, a[d] = b.data,
...
f.prototype = {
  getAncestorWithClass: function(a) {
    for (var d; a;) {
      ...
      if (a.nodeType == b.ELEMENT_NODE &&
          c.dom.arrayContains(this.tagNames, a.tagName.toLowerCase()) && d)
        return a;
      a = a.parentNode
    }
    return !1
  ...
  postApply: function(a, b) {
    for (var c = a[0], d = a[a.length - 1], f = [], g, i = c, m = d, s = 0,
             x = d.length, o, z, w = 0, y = a.length;
         w < y; ++w)
      if (o = a[w], z = this.getAdjacentMergeableTextNode(o.parentNode, !1)) {
        if (g || (g = new e(z), f.push(g)), g.textNodes.push(o),
            o === c && (i = g.firstTextNode, s = i.length), o === d)
  ...
  getAdjacentMergeableTextNode: function(a, c) {
    var d = a.nodeType == b.TEXT_NODE, e = d ? a.parentNode : a,
  ...
  areElementsMergeable: function(a, b) {
    ...
    if (d = c.dom.arrayContains(this.tagNames, (a.tagName || '').toLowerCase()))
      if (d = c.dom.arrayContains(
              this.tagNames, (b.tagName || '').toLowerCase()))
  ...
  isRemovable: function(a) {
    return c.dom.arrayContains(this.tagNames, a.tagName.toLowerCase()) &&
        b.lang.string(a.className).trim() == this.cssClass
  },
  undoToTextNode: function(b, c, e) {
    c.containsNode(e) ||
        (b = c.cloneRange(), b.selectNode(e),
    ...
    this.similarClassRegExp && e.className &&
  ...
  undoToRange: function(a) {
    ...
    1 == g ? this.selectNode(a, c[0]) :
             (a.setStart(c[0], 0), d = c[c.length - 1], a.setEnd(d, d.length),
              this.normalize && this.postApply(c, a))
  },
...
wysihtml5.Commands = Base.extend({
  ...
  exec: function(b, c) {
    var a = wysihtml5.commands[b], d = wysihtml5.lang.array(arguments).get(),
        e = a && a.exec, f = null;
...
function c(c, g) {
  ...
  k = n;
  1 === h &&
      (p = e.getTextContent(n), h = !!n.querySelector('*'),
       p = '' === p || p === b.INVISIBLE_SPACE,
       !h && p &&
           (e.setTextContent(n, g.text || n.href), i = i.createTextNode(' '),
            c.selection.setAfter(n), c.selection.insertNode(i), k = i));
  ...
  exec: function(a, b, d) {
    ...
    h ? a.selection.executeAndRestore(function() {
      for (var a = h.length, b = 0, c, d, f; b < a; b++)
        c = h[b], d = e.getParentElement(c, {nodeName: 'code'}),
        f = e.getTextContent(c),
        f.match(e.autoLink.URL_REG_EXP) && !d ? e.renameElement(c, 'code') :
...
b.commands.fontSize = {
  exec: function(a, d, e) {
    return b.commands.formatInline.exec(
        a, d, 'span', 'wysiwyg-font-size-' + e, c)
  },
...
function d(a) {
  return 'BR' === a.nodeName || 'block' === g.getStyle('display').from(a) ? !0 :
                                                                            !1
}
function e(a, c, d, e) {
  if (e)
...
b.commands.formatBlock = {
  exec: function(h, k, j, n, p) {
    var q = h.doc, r = this.state(h, k, j, n, p), m,
      ...
      if (null === j || b.lang.array(i).contains(j))
        if (m = h.selection.getSelectedNode(),
          ...
          h.selection.executeAndRestoreSimple(function() {
            ...
            if (n) {
              var a = r;
              a.className ? (a.className = a.className.replace(p, ''),
                             a.className += ' ' + n) :
                            a.className = n
            }
          });
...
b.commands.formatInline = {
  ...
  state: function(d, f, g, i, h) {
    var f = d.doc, k = a[g] || g;
    if (!b.dom.hasElementWithTagName(f, g) &&
...
b.commands.insertHTML = {
  exec: function(b, a, d) {
    b.commands.support(a) ? b.doc.execCommand(a, !1, d) :
...
b.commands.insertImage = {
  exec: function(c, a, d) {
    var d = 'object' === typeof d ? d : {src: d}, e = c.doc, a = this.state(c),
        f;
    if (a)
      c.selection.setBefore(a), d = a.parentNode, d.removeChild(a),
                                b.dom.removeEmptyTextNodes(d),
                                'A' === d.nodeName && !d.firstChild &&
      ...
      b.browser.hasProblemsSettingCaretAfterImg() ?
          (d = e.createTextNode(b.INVISIBLE_SPACE), c.selection.insertNode(d),
...
b.commands.insertOrderedList = {
  exec: function(c, a) {
    var d = c.doc, e = c.selection.getSelectedNode(),
    ...
    c.commands.support(a) ?
        ...
        f ? c.selection.executeAndRestoreSimple(function() {
          b.dom.resolveList(f)
        }) :
...
b.commands.justifyCenter = {
  exec: function(a) {
    return b.commands.formatBlock.exec(
        a, 'formatBlock', null, 'wysiwyg-text-align-center', c)
  },
  state: function(a) {
...
b.commands.justifyLeft = {
  exec: function(a) {
    return b.commands.formatBlock.exec(
        a, 'formatBlock', null, 'wysiwyg-text-align-left', c)
  },
  state: function(a) {
    return b.commands.formatBlock.state(
        a, 'formatBlock', null, 'wysiwyg-text-align-left', c)
...
b.commands.justifyRight = {
  exec: function(a) {
    return b.commands.formatBlock.exec(
        a, 'formatBlock', null, 'wysiwyg-text-align-right', c)
  },
  state: function(a) {
    return b.commands.formatBlock.state(
        a, 'formatBlock', null, 'wysiwyg-text-align-right', c)
...
(function(b) {
var c = '<span id="_wysihtml5-undo" class="_wysihtml5-temp">' +
    b.INVISIBLE_SPACE + '</span>',
    a = '<span id="_wysihtml5-redo" class="_wysihtml5-temp">' +
    b.INVISIBLE_SPACE + '</span>',
    d = b.dom;
  ...
  _observe: function() {
    ...
    d.observe(this.element, 'keydown', function(a) {
      if (!(a.altKey || !a.ctrlKey && !a.metaKey)) {
        ...
        90 === b && !a.shiftKey ? (e.undo(), a.preventDefault()) :
    ...
    if (b.browser.hasUndoInContextMenu()) {
      ...
      d.observe(this.element, 'contextmenu', function() {
        ...
        h ||
            (h = !0, d.observe(document, 'mousedown', k),
  ...
  _observeViewChange: function() {
    ...
    this.parent.observe('beforeload', function() {
      b.parent.observe('change_view', function(c) {
        c === b.name ? (b.parent.currentView = b, b.show(),
                        setTimeout(
                            function() {
                              b.focus()
                            },
...
b.views.Composer = b.views.View.extend({
  ...
  clear: function() {
    this.element.innerHTML =
        a.displaysCaretInEmptyContentEditableCorrectly() ? '' : this.CARET_HACK
  },
  getValue: function(a) {
  ...
  _create: function() {
    ...
    (e = 'string' === typeof this.config.placeholder ?
  ...
  _initAutoLinking: function() {
    var d = this, e = a.canDisableAutoLinking(),
    ...
    if (this.config.autoLink) {
      ...
      var g = this.sandbox.getDocument().getElementsByTagName('a'),
          i = c.autoLink.URL_REG_EXP, h = function(a) {
  ...
  _initObjectResizing: function() {
    ...
    this.config.allowObjectResizing ? a.supportsEvent('resizeend') &&
            c.observe(
                f, 'resizeend',
                function(a) {
                  for (var a = a.target || a.srcElement, c = a.style, h = 0, k;
                       h < e; h++)
                    k = d[h],
    ...
    k = function(b) {
      if (b.setActive) try {
        ...
        var f = b.style, h = a.documentElement.scrollTop || a.body.scrollTop,
            g = a.documentElement.scrollLeft || a.body.scrollLeft, f = {
              position: f.position,
              top: f.top,
              left: f.left,
...
b.views.Composer.prototype.observe = function() {
  var e = this, f = this.getValue(), g = this.sandbox.getIframe(),
      i = this.element,
  ...
  c.observe(i, k, function(b) {
    ...
    c && a.supportsDataTransfer() &&
        (d = c.getData('text/html') || c.getData('text/plain'));
    d ? (i.focus(), e.commands.exec('insertHTML', d),
         e.parent.fire('paste').fire('paste:composer'), b.stopPropagation(),
         b.preventDefault()) :
        setTimeout(function() {
...
wysihtml5.views.Textarea = wysihtml5.views.View.extend({
  ...
  _observe: function() {
    var b = this.element, c = this.parent,
...
b.toolbar.Dialog = b.lang.Dispatcher.extend({
  ...
  _observe: function() {
    if (!this._observed) {
      ...
      c.delegate(
          this.container, '[data-wysihtml5-dialog-action=save]', 'click', d);
      c.delegate(
  ...
  _serialize: function() {
    for (var a = this.elementToChange || {},
             b = this.container.querySelectorAll(
    ...
    for (var b, c,
      ...
      b !== f && !(a && 'hidden' === b.type) &&
          (c = b.getAttribute('data-wysihtml5-dialog-field'),
           c = this.elementToChange ? this.elementToChange[c] || '' :
                                      b.defaultValue,
           b.value = c)
  },
  show: function(a) {
...
b.toolbar.Speech = function(g, i) {
  ...
  if (b.browser.supportsSpeechApiOn(h)) {
    ...
    b.lang.object(d).merge(
        {width: i.offsetWidth + 'px', height: i.offsetHeight + 'px'});
    c.insert(h).into(k);
    c.insert(k).into(i);
    c.setStyles(e).on(h);
    ...
    c.setStyles(a).on(i);
    c.observe(
        h, 'onwebkitspeechchange' in h ? 'webkitspeechchange' : 'speechchange',
        function() {
...
b.toolbar.Toolbar = Base.extend({
  constructor: function(a, c) {
    ...
    this._observe();
    this.show();
    for (var e = this.container.querySelectorAll(
  ...
  _getLinks: function(a) {
    for (var c = this[a + 'Links'] = b.lang
                                         .array(this.container.querySelectorAll(
                                             '[data-wysihtml5-' + a + ']'))
                                         .get(),
             e = c.length, f = 0, g = this[a + 'Mapping'] = {}, i, h, k, j, n;
         f < e; f++)
      i = c[f], k = i.getAttribute('data-wysihtml5-' + a),
  ...
  _getDialog: function(a, c) {
    ...
    f && (g = new b.toolbar.Dialog(a, f), g.observe('show', function() {
      ...
      e.editor.fire(
          'show:dialog', {command: c, dialogContainer: f, commandLink: a})
    }), g.observe('save', function(b) {
      i && e.composer.selection.setBookmark(i);
      e._execCommand(c, b);
      e.editor.fire(
          'save:dialog', {command: c, dialogContainer: f, commandLink: a})
    }), g.observe('cancel', function() {
      e.editor.focus(!1);
      e.editor.fire(
          'cancel:dialog', {command: c, dialogContainer: f, commandLink: a})
    }));
    return g
  },
  ...
  execAction: function(a) {
    ...
    switch (a) {
      case 'change_view':
        b.currentView === b.textarea ? b.fire('change_view', 'composer') :
                                       b.fire('change_view', 'textarea')
    }
  },
  _observe: function() {
    for (var a = this, b = this.editor, e = this.container,
             f = this.commandLinks.concat(this.actionLinks), g = f.length,
             i = 0;
         i < g; i++)
    ...
    for (e in a)
      if (g = a[e],
          this.commandsDisabled ?
              (f = !1, c.removeClass(g.link, 'wysihtml5-command-active'),
    ...
    for (e in d)
      ...
      'change_view' === a.name &&
          (a.state = this.editor.currentView === this.editor.textarea,
           a.state ? c.addClass(a.link, 'wysihtml5-action-active') :
...
b.Editor = b.lang.Dispatcher.extend({
  constructor: function(a, d) {
    ...
    if (!this._isCompatible ||
      ...
      this.currentView = this.composer =
          new b.views.Composer(this, this.textareaElement, this.config);
  ...
  parse: function(a) {
    var c = this.config.parser(
        a, this.config.parserRules, this.composer.sandbox.getDocument(), !0);
