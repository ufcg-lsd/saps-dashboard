  ...
  var tpl = {
    ...
    'link': function(locale, options) {
      ...
      return '<li>' +
          ...
          locale.link.cancel + '</a>' +
          '<a href=\'#\' class=\'btn btn-primary\' data-dismiss=\'modal\'>' +
          locale.link.insert + '</a>' +
          '</div>' +
          '</div>' +
          '<a class=\'btn' + size +
    ...
    'image': function(locale, options) {
      ...
      return '<li>' +
          ...
          '<div class=\'modal-footer\'>' +
          '<a href=\'#\' class=\'btn\' data-dismiss=\'modal\'>' +
          locale.image.cancel + '</a>' +
          '<a href=\'#\' class=\'btn btn-primary\' data-dismiss=\'modal\'>' +
          locale.image.insert + '</a>' +
          '</div>' +
          '</div>' +
          '<a class=\'btn' + size +
    ...
    'color': function(locale, options) {
      ...
      return '<li class=\'dropdown\'>' +
          ...
          '<span class=\'current-color\'>' + locale.colours.black +
  ...
  Wysihtml5.prototype = {
    ...
    initInsertImage: function(toolbar) {
      ...
      var insertImageModal =
          toolbar.find('.bootstrap-wysihtml5-insert-image-modal');
      var urlInput =
          insertImageModal.find('.bootstrap-wysihtml5-insert-image-url');
    ...
    initInsertLink: function(toolbar) {
      var self = this;
      var insertLinkModal =
          toolbar.find('.bootstrap-wysihtml5-insert-link-modal');
      var urlInput =
          insertLinkModal.find('.bootstrap-wysihtml5-insert-link-url');
      ...
      var insertLink = function() {
        ...
        self.editor.composer.commands.exec(
            'createLink', {href: url, target: '_blank', rel: 'nofollow'});
      };
  ...
  var methods = {
    resetDefaults: function() {
      $.fn.wysihtml5.defaultOptions =
          $.extend(true, {}, $.fn.wysihtml5.defaultOptionsCache);
    },
    ...
    deepExtend: function(options) {
      var settings =
          $.extend(true, {}, $.fn.wysihtml5.defaultOptions, options || {});
      var that = this;
      return methods.bypassDefaults.apply(that, [settings]);
    },
