...
var Transport = function() {
  ...
  function Transport(o) {
    ...
    this._get =
        (/^throttle$/i.test(o.rateLimitFn) ? utils.throttle : utils.debounce)(
            this._get, o.rateLimitWait || 300);
  }
  utils.mixin(Transport.prototype, {
    ...
    get: function(query, cb) {
      var that = this, encodedQuery = encodeURIComponent(query || ''), url,
          resp;
      cb = cb || utils.noop;
      url = this.replace ? this.replace(this.url, encodedQuery) :
...
var Dataset = function() {
  ...
  utils.mixin(Dataset.prototype, {
    ...
    _loadPrefetchData: function(o) {
      var that = this, thumbprint = VERSION + (o.thumbprint || ''),
          storedThumbprint, storedProtocol, storedItemHash, storedAdjacencyList,
          isExpired, deferred;
      if (this.storage) {
      ...
      if (storedItemHash && storedAdjacencyList && !isExpired) {
        this._mergeProcessedData(
            {itemHash: storedItemHash, adjacencyList: storedAdjacencyList});
    ...
    _getLocalSuggestions: function(terms) {
      var that = this, firstChars = [], lists = [], shortestList,
          suggestions = [];
    ...
    initialize: function() {
      ...
      deferred = this.prefetch ? this._loadPrefetchData(this.prefetch) :
                                 $.Deferred().resolve();
  ...
  utils.mixin(InputView.prototype, EventTarget, {
    ...
    _compareQueryToInputValue: function() {
      var inputValue = this.getInputValue(),
          ...
          isSameQueryExceptWhitespace =
              isSameQuery ? this.query.length !== inputValue.length : false;
    ...
    isCursorAtEnd: function() {
      var valueLength = this.$input.val().length,
          selectionStart = this.$input[0].selectionStart, range;
...
var DropdownView = function() {
  ...
  utils.mixin(DropdownView.prototype, EventTarget, {
    ...
    getSuggestionUnderCursor: function() {
      var $suggestion =
          this._getSuggestions().filter('.tt-is-under-cursor').first();
    ...
    renderSuggestions: function(dataset, suggestions) {
      var datasetClassName = 'tt-dataset-' + dataset.name,
          wrapper = '<div class="tt-suggestion">%body</div>', compiledHtml,
...
var TypeaheadView = function() {
  ...
  function TypeaheadView(o) {
    ...
    this.inputView =
        new InputView({input: $input, hint: $hint})
  ...
  utils.mixin(TypeaheadView.prototype, EventTarget, {
    ...
    _updateHint: function() {
      var suggestion = this.dropdownView.getFirstSuggestion(),
          ...
          inputHasOverflow = this.inputView.isOverflow(), inputValue, query,
          escapedQuery, beginsWithQuery, match;
    ...
    _closeDropdown: function(e) {
      this.dropdownView
          [e.type === 'blured' ? 'closeUnlessMouseIsOverDropdown' : 'close']();
    },
    _moveDropdownCursor: function(e) {
      var $e = e.data;
      if (!$e.shiftKey && !$e.ctrlKey && !$e.metaKey) {
        this.dropdownView
            [e.type === 'upKeyed' ? 'moveCursorUp' : 'moveCursorDown']();
      }
    },
    _handleSelection: function(e) {
      var byClick = e.type === 'suggestionSelected',
          suggestion =
              byClick ? e.data : this.dropdownView.getSuggestionUnderCursor();
      if (suggestion) {
        this.inputView.setInputValue(suggestion.value);
        byClick ? this.inputView.focus() : e.data.preventDefault();
        byClick && utils.isMsie() ? utils.defer(this.dropdownView.close) :
    ...
    _autocomplete: function(e) {
      ...
      if (hint !== '' && query !== hint) {
        ...
        this.eventBus.trigger(
            'autocompleted', suggestion.datum, suggestion.dataset);
      }
    },
  ...
  function buildDomStructure(input) {
    var $wrapper = $(html.wrapper), $dropdown = $(html.dropdown),
