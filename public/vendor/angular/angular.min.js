...
function I(b) {
  return function() {
    var a = arguments[0], c;
    c = '[' + (b ? b + ':' : '') + a + '] http://errors.angularjs.org/1.4.7/' +
        (b ? b + '/' : '') + a;
...
function Da(b) {
  ...
  return b.nodeType === pa && a ?
      !0 :
      G(b) || J(b) || 0 === a || 'number' === typeof a && 0 < a && a - 1 in b
}
function m(b, a, c) {
  var d, e;
  if (b)
...
function ha(b, a, c, d) {
  ...
  if (a) {
    ...
    if (tc.test(va.call(b)))
      ...
      return e = Object.create(rc(b)), ha(b, e, c, d);
    d && (c.push(b), d.push(a))
  }
  return a
}
...
function yc(b) {
  ...
  m((b || '').split('&'), function(b) {
    var d, e, f;
    b &&
        (e = b = b.replace(/\+/g, '%20'), d = b.indexOf('='),
         -1 !== d && (e = b.substring(0, d), f = b.substring(d + 1)), e = xc(e),
         A(e) &&
             (f = A(f) ? xc(f) : !0,
              ta.call(a, e) ? J(a[e]) ? a[e].push(f) : a[e] = [a[e], f] :
                              a[e] = f))
  });
  return a
}
...
function Sa(b, a, c) {
  ...
  qb(x(b), a,
     'not a function, got ' +
         (b && 'object' === typeof b ? b.constructor.name || 'Object' :
                                       typeof b));
  return b
}
function Ta(b, a) {
...
function rb(b) {
  for (var a = b[0], c = b[b.length - 1], d, e = 1;
       a !== c && (a = a.nextSibling); e++)
  ...
  return a(b, 'module', function() {
    ...
    return function(f, h, g) {
      ...
      return a(b, f, function() {
        ...
        var d = [], e = [], r = [], t = a('$injector', 'invoke', 'push', e),
            E = {
              _invokeQueue: d,
              _configBlocks: e,
              _runBlocks: r,
...
function R(b) {
  ...
  if (a) {
    a = X;
    var c;
    b = (c = Ef.exec(b)) ? [a.createElement(c[1])] :
                           (c = Mc(b, a)) ? c.childNodes : []
  }
  Nc(this, b)
}
function Ub(b) {
  ...
  function h(a) {
    ...
    m(a, function(a) {
      ...
      if (!n.get(a)) {
        n.put(a, !0);
        try {
          G(a) ? (c = Rb(a), b = b.concat(h(c.requires)).concat(c._runBlocks),
                  d(c._invokeQueue), d(c._configBlocks)) :
                 x(a) ? b.push(r.invoke(a)) :
                        J(a) ? b.push(r.invoke(a)) : Sa(a, 'module')
        } catch (e) {
    ...
    function(a, c, d) {
      ...
      function f(b) {
        if (b) {
          ...
          x(c) ? c = c() :
                 sc(c) ? (c = c[0],
                          c = 'fixed' !== a.getComputedStyle(c).position ?
                              0 :
...
function Kf(b, a, c, d) {
  ...
  var l = this, k = b.location, n = b.history, p = b.setTimeout,
      r = b.clearTimeout, t = {};
  l.isMock = !1;
  var E = 0, K = [];
  ...
  l.url = function(a, c, e) {
    ...
    if (a) {
      ...
      if (!d.history || g && f) {
        if (!g || ia) ia = a;
        c ? k.replace(a) :
            g ? (c = k, e = a.indexOf('#'), e = -1 === e ? '' : a.substr(e),
                 c.hash = e) :
                k.href = a;
        k.href !== a && (ia = a)
      } else
...
function We() {
  this.$get = function() {
    function b(b, d) {
      function e(a) {
        a != p &&
            (r ? r == a && (r = a.n) : r = a, f(a.n, a.p), f(a, p), p = a,
             p.n = null)
      }
      function f(a, b) {
        a != b && (a && (a.p = b), b && (b.n = a))
      ...
      var h = 0, g = P({}, d, {id: b}), l = {},
          k = d && d.capacity || Number.MAX_VALUE, n = {}, p = null, r = null;
      return a[b] = {
        put: function(a, b) {
          if (!v(b)) {
...
function Dc(b, a) {
  ...
  var e = {}, f = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/,
      h = /(([\w\-]+)(?:\:([^;]+))?;?)/, g = Wd('ngSrc,ngSrcset,src,srcset'),
      l = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, k = /^(on[a-z]+|formaction)$/;
  this.directive = function r(a, f) {
    Ta(a, 'directive');
    G(a) ?
        (d(a), qb(f, 'directiveFactory'),
         e.hasOwnProperty(a) ||
             (e[a] = [],
              b.factory(
                  a + 'Directive',
  ...
  this.aHrefSanitizationWhitelist = function(b) {
    return A(b) ? (a.aHrefSanitizationWhitelist(b), this) :
                  a.aHrefSanitizationWhitelist()
  };
  this.imgSrcSanitizationWhitelist = function(b) {
    return A(b) ? (a.imgSrcSanitizationWhitelist(b), this) :
  ...
  this.$get = [
    ...
    function(a, b, c, d, u, q, z, N, ia, O, H) {
      ...
      function W(a, b, c, d, e) {
        ...
        m(a, function(b, c) {
          b.nodeType == Pa && b.nodeValue.match(/\S+/) &&
        ...
        return function(b, c, d) {
          ...
          g ||
              (g = (d = d && d[0]) ?
                   ...
                   'html' :
                   'html');
          d = 'html' !== g ? B(Xb(g, B('<div>').append(a).html())) :
                             c ? Ra.clone.call(a) : a;
          if (h)
      ...
      function S(a, b, c, d, e, f) {
        function g(a, c, d, e) {
          ...
          for (n = h.length; r < n;)
            if (k = O[h[r++]], c = h[r++], f = h[r++], c) {
              if (c.scope) {
                if (l = a.$new(), W.$$addScopeInfo(B(k), l),
                    t = c.$$destroyBindings)
              ...
              t = c.transcludeOnThisElement ?
                  ba(a, c.transclude, e) :
                  !c.templateOnThisElement && e ? e : !e && b ? ba(a, b) : null;
              c(f, l, k, d, t, c)
            } else
        ...
        for (var h = [], k, l, r, n, q, t = 0; t < a.length; t++) {
          ...
          (f = l.length ? D(l, a[t], k, b, c, null, [], [], f) : null) &&
              f.scope && W.$$addScopeClass(k.$$element);
          k = f && f.terminal || !(r = a[t].childNodes) || !r.length ?
              null :
              S(r,
      ...
      function ca(a, b, c, d, e) {
        ...
        switch (a.nodeType) {
          case pa:
            na(b, ya(wa(a)), 'E', d, e);
            for (var l, r, n, q = a.attributes, t = 0, O = q && q.length; t < O;
                 t++) {
              var K = !1, H = !1;
              l = q[t];
              k = l.name;
              ...
              l = ya(k);
              if (n = ja.test(l))
                k = k.replace(Wc, '').substr(8).replace(
                    /_(.)/g, function(a, b) {
                      return b.toUpperCase()
                    });
              var S = l.replace(/(Start|End)$/, '');
              I(S) && l === S + 'Start' &&
                  (K = k, H = k.substr(0, k.length - 5) + 'end',
            ...
            if (G(a) && '' !== a)
              for (; k = h.exec(a);)
                l = ya(k[2]), na(b, l, 'C', d, e) && (c[l] = T(k[3])),
      ...
      function D(a, b, d, e, f, g, h, k, r) {
        ...
        function K(a, c, e, f, g, l) {
          ...
          u &&
              (W.$$addScopeInfo(
                   N, E, !0, !(L && (L === u || L === u.$$originalDirective))),
               W.$$addScopeClass(N, !0),
          ...
          if (ca) {
            ...
            Va && ca[Va.name] &&
                (q = Va.$$bindings.bindToController,
                 (H = ca[Va.name]) && H.identifier && q &&
                     (m = H, l.$$destroyBindings = Y(c, f, H.instance, q, Va)));
            for (n in ca) {
              H = ca[n];
              var D = H();
              D !== H.instance &&
                  (H.instance = D, N.data('$' + n + 'Controller', D),
                   H === m &&
                       (l.$$destroyBindings(),
          ...
          for (l = h.length; n < l; n++)
            q = h[n],
            aa(q, q.isolateScope ? E : c, N, f,
               q.require && t(q.directiveName, q.require, N, ca), z);
          var za = c;
        ...
        r = r || {};
        for (var H = -Number.MAX_VALUE, S = r.newScopeDirective,
                 ba = r.controllerDirectives, u = r.newIsolateScopeDirective,
                 L = r.templateDirective, z = r.nonTlbTranscludeDirective,
                 N = !1, m = !1, ia = r.hasElementTranscludeDirective,
                 v = d.$$element = B(b), D, y, M, Ka = e, na, I = 0,
                 F = a.length;
             I < F; I++) {
          D = a[I];
          ...
          if (M = D.scope)
            D.templateUrl ||
                (C(M) ? (Q('new/isolated scope', u || S, D, v), u = D) :
                        Q('new/isolated scope', u, D, v)),
                S = S || D;
          y = D.name;
          !D.templateUrl && D.controller &&
              (M = D.controller, ba = ba || fa(),
               Q('\'' + y + '\' controller', ba[y], D, v), ba[y] = D);
          if (M = D.transclude)
            N = !0, D.$$tlb || (Q('transclusion', z, D, v), z = D),
            'element' == M ?
                (ia = !0, H = D.priority, M = v,
                 v = d.$$element =
                     B(X.createComment(' ' + y + ': ' + d[y] + ' ')),
                 b = v[0], U(f, ua.call(M, 0), b),
                 Ka = W(M, e, H, g && g.name, {nonTlbTranscludeDirective: z})) :
                (M = B(Ub(b)).contents(), v.empty(), Ka = W(M, e));
          if (D.template)
            if (m = !0, Q('template', L, D, v), L = D,
                M = x(D.template) ? D.template(v, d) : D.template, M = ha(M),
                D.replace) {
              g = D;
              ...
              v.html(M);
          if (D.templateUrl)
            m = !0, Q('template', L, D, v), L = D, D.replace && (g = D),
      ...
      function na(b, d, f, g, h, k, l) {
        ...
        if (e.hasOwnProperty(d)) {
          ...
          for (var q = 0, t = d.length; q < t; q++) try {
              n = d[q],
              (v(g) || g > n.priority) && -1 != n.restrict.indexOf(f) &&
      ...
      Z.prototype = {
        ...
        $set: function(a, b, d, e) {
          ...
          if ('a' === f && 'href' === a || 'img' === f && 'src' === a)
            ...
            for (var f = '', g = T(b),
                     ...
                     k = /\s/.test(g) ? k : /(,)/, g = g.split(k),
                     k = Math.floor(g.length / 2), l = 0;
                 l < k; l++)
              var r = 2 * l, f = f + H(T(g[r]), !0),
                  f = f + (' ' + T(g[r + 1]));
            g = T(g[2 * l]).split(/\s/);
            f += H(T(g[0]), !0);
            2 === g.length && (f += ' ' + T(g[1]));
          ...
          !1 !== d &&
              (null === b || v(b) ? this.$$element.removeAttr(e) :
        ...
        $observe: function(a, b) {
          var c = this, d = c.$$observers || (c.$$observers = fa()),
              e = d[a] || (d[a] = []);
          e.push(b);
      ...
      var da = b.startSymbol(), ea = b.endSymbol(),
  ...
  this.$get = [
    ...
    function(c, d) {
      ...
      return function(f, h, g, l) {
        ...
        if (g)
          return g = (J(f) ? f[f.length - 1] : f).prototype,
                 k = Object.create(g || null), p && e(h, p, k, n || f.name),
                 P(function() {
...
function cf() {
  var b = this.defaults = {
    ...
    transformRequest: [function(a) {
      return C(a) && '[object File]' !== va.call(a) &&
  ...
  this.$get = [
    '$httpBackend', '$$cookieReader', '$cacheFactory', '$rootScope', '$q',
    '$injector',
    function(e, f, h, g, l, k) {
      function n(a) {
        ...
        f.headers = function(a) {
          var c = b.headers, d = P({}, a.headers), f, g, h,
        ...
        f.paramSerializer =
            G(f.paramSerializer) ? k.get(f.paramSerializer) : f.paramSerializer;
        var g =
                [
                  function(a) {
                    var c = a.headers,
                    ...
                    v(a.withCredentials) && !v(b.withCredentials) &&
      ...
      function p(c, d) {
        function h(b, c, d, e) {
          ...
          L &&
              (200 <= b && 300 > b ? L.put(ba, [b, c, bd(d), e]) :
                                     L.remove(ba));
        ...
        function k(a, b, d, e) {
          ...
          (200 <= b && 300 > b ? O.resolve : O.reject)(
              {data: a, status: b, headers: cd(d), config: c, statusText: e})
        }
        function p(a) {
        ...
        var O = l.defer(), H = O.promise, L, m, S = c.headers,
      ...
      var t = h('$http');
      b.paramSerializer =
          G(b.paramSerializer) ? k.get(b.paramSerializer) : b.paramSerializer;
      var E = [];
      m(d, function(a) {
...
function Sf(b, a, c, d, e) {
  ...
  return function(e, g, l, k, n, p, r, t) {
    ...
    if ('jsonp' == F(e)) {
      ...
      var q =
          f(g.replace('JSON_CALLBACK', 'angular.callbacks.' + u), u,
            function(a, b) {
              K(k, a, d[u].data, '', b);
              d[u] = y
            })
        ...
        for (var q, m, N = 0, s = [], O = [], H = f.length, L = [], W = [];
          ...
          if (-1 != (q = f.indexOf(b, N)) && -1 != (m = f.indexOf(a, q + l)))
            N !== q && L.push(h(f.substring(N, q))),
                N = f.substring(q + l, m), s.push(N), O.push(c(N, u)),
                N = m + k, W.push(L.length), L.push('');
          else {
...
function bf() {
  this.$get = [
    '$rootScope', '$window', '$q', '$$q',
    function(b, a, c, d) {
      function e(e, g, l, k) {
        var n = 4 < arguments.length, p = n ? ua.call(arguments, 4) : [],
            r = a.setInterval, t = a.clearInterval, E = 0, K = A(k) && !k,
            u = (K ? d : c).defer(), q = u.promise;
        l = A(l) ? l : 0;
      ...
      e.cancel = function(b) {
        return b && b.$$intervalId in f ?
            (f[b.$$intervalId].reject('canceled'),
             a.clearInterval(b.$$intervalId), delete f[b.$$intervalId], !0) :
            !1
      };
      return e
    }
...
function cc(b, a, c) {
  ...
  this.$$parse = function(d) {
    ...
    v(e) || '#' !== e.charAt(0) ?
        this.$$html5 ? f = e : (f = '', v(e) && (b = d, this.replace())) :
        (f = sa(c, e), v(f) && (f = e));
    hd(f, this);
    d = this.$$path;
    var e = b, h = /^\/[A-Z]:(\/.*)/;
...
function hf() {
  ...
  this.html5Mode = function(b) {
    return bb(b) ?
        (a.enabled = b, this) :
        C(b) ? (bb(b.enabled) && (a.enabled = b.enabled),
                bb(b.requireBase) && (a.requireBase = b.requireBase),
                bb(b.rewriteLinks) && (a.rewriteLinks = b.rewriteLinks), this) :
               a
  };
  this.$get = [
    ...
    function(c, d, e, f, h) {
      ...
      f.on('click', function(b) {
        if (a.rewriteLinks && !b.ctrlKey && !b.metaKey && !b.shiftKey &&
            2 != b.which && 2 != b.button) {
          for (var e = B(b.target); 'a' !== wa(e[0]);)
            if (e[0] === f[0] || !(e = e.parent())[0]) return;
          var g = e.prop('href'), l = e.attr('href') || e.attr('xlink:href');
          C(g) && '[object SVGAnimatedString]' === g.toString() &&
              (g = Aa(g.animVal).href);
          E.test(g) || !g || e.attr('target') || b.isDefaultPrevented() ||
              !k.$$parseLinkUrl(g, l) ||
              (b.preventDefault(),
               k.absUrl() != d.url() &&
        ...
        v(sa(t, a)) ? h.location.href = a :
                      (c.$evalAsync(function() {
                        ...
                        f = c.$broadcast('$locationChangeStart', a, d, b, e)
                                .defaultPrevented;
                        k.absUrl() === a &&
                            (f ? (k.$$parse(d), k.$$state = e, g(d, !1, e)) :
                                 (K = !1, l(d, e)))
                      }),
                       c.$$phase || c.$digest())
      });
      c.$watch(function() {
        var a = Cb(d.url()), b = Cb(k.absUrl()), f = d.state(), h = k.$$replace,
...
function Xa(b, a) {
  if ('__defineGetter__' === b || '__defineSetter__' === b ||
      '__lookupGetter__' === b || '__lookupSetter__' === b || '__proto__' === b)
    throw Z('isecfld', a);
  return b
}
function kd(b, a) {
...
function md(b, a) {
  if (b &&
      (b === (0).constructor || b === (!1).constructor ||
       b === ''.constructor || b === {}.constructor || b === [].constructor ||
...
function qd(b) {
  if (1 === b.body.length && pd(b.body[0].expression)) return {
      type: s.AssignmentExpression, left: b.body[0].expression,
          right: {type: s.NGValueParameter}, operator: '='
    }
}
function rd(b) {
...
function kf() {
  ...
  this.$get = [
    ...
    function(c) {
      ...
      var k = Fa().noUnsafeEval, n = {csp: k, expensiveChecks: !1},
          ...
          case 'string':
            ...
            m ||
                (':' === d.charAt(0) && ':' === d.charAt(1) &&
                     (u = !0, d = d.substring(2)),
                 E = E ? p : n, m = new ec(E), m = (new fc(m, c, E)).parse(d),
                 m.constant ? m.$$watchDelegate = g :
                              u ? m.$$watchDelegate = m.literal ? h : f :
  ...
  P(h.prototype, {
    resolve: function(a) {
      this.promise.$$state.status ||
          (a === this.promise ? this.$$reject(g('qcycle', a)) :
                                this.$$resolve(a))
    },
    $$resolve: function(b) {
      var d, e;
      ...
      try {
        ...
        x(d) ? (this.promise.$$state.status = -1,
               ...
               (this.promise.$$state.value = b, this.promise.$$state.status = 1,
    ...
    function(f, h, g, l) {
      ...
      n.prototype = {
        ...
        $watchCollection: function(a, b) {
          ...
          c.$stateful = !0;
          var d = this, e, f, h, k = 1 < b.length, l = 0, n = g(a, c), p = [],
              r = {}, q = !0, t = 0;
            ...
            a: do {
              if (k = m.$$watchers)
                for (n = k.length; n--;) try {
                    if (b = k[n])
                      if ((f = b.get(m)) !== (g = b.last) &&
                          !(b.eq ? ka(f, g) :
                                   'number' === typeof f &&
                                    'number' === typeof g && isNaN(f) &&
                                    isNaN(g)))
                        r = !0, d = b, b.last = b.eq ? ha(f, null) : f,
                        b.fn(f, g === E ? f : g, m),
              ...
              if (!(k = m.$$watchersCount && m.$$childHead ||
        ...
        $destroy: function() {
          if (!this.$$destroyed) {
            ...
            this.$parent = this.$$nextSibling = this.$$prevSibling =
                this.$$childHead = this.$$childTail = this.$root =
                    this.$$watchers = null
          }
        },
        $eval: function(a, b) {
      ...
      var q = new n, z = q.$$asyncQueue = [], N = q.$$postDigestQueue = [],
          w = q.$$applyAsyncQueue = [];
      return q
    }
  ]
  ...
  this.$get = [
    ...
    function(b, a) {
      var c = {},
          ...
          e = /Boxee/i.test((b.navigator || {}).userAgent), f = a[0] || {}, h,
          g = /^(Moz|webkit|ms)(?=[A-Z])/, l = f.body && f.body.style, k = !1,
          n = !1;
      if (l) {
        for (var p in l)
          if (k = g.exec(p)) {
      ...
      return {
        history: !(!b.history || !b.history.pushState || 4 > d || e),
            ...
            csp: Fa(), vendorPrefix: h, transitions: k, animations: n,
            android: d
      }
    }
  ]
      ...
      function e(f, h) {
        ...
        J(g) ? g = g.filter(function(a) {
          return a !== Zb
               ...
               g === Zb && (g = null);
        return a
            .get(f, {cache: b, transformResponse: g})['finally'](function() {
              e.totalPendingRequests--
            })
            .then(
                function(a) {
...
function uf() {
  this.$get = [
    ...
    function(b, a, c, d, e) {
      function f(f, l, k) {
        x(f) || (k = l, l = f, f = y);
        var n = ua.call(arguments, 3), p = A(k) && !k, r = (p ? d : c).defer(),
            t = r.promise, m;
        m = a.defer(function() {
          try {
      ...
      f.cancel = function(b) {
        return b && b.$$timeoutId in h ?
            (h[b.$$timeoutId].reject('canceled'), delete h[b.$$timeoutId],
  ...
  switch (f) {
    case 'object':
      ...
      if ('object' === h) {
        for (g in a)
          if (e = a[g],
              !x(e) && !v(e) && (f = '$' === g, !Ma(f ? b : b[g], e, c, f, f)))
            return !1;
        return !0
      }
      return c(b, a);
...
function zd(b) {
  ...
  return function(b, d, e) {
    ...
    return null == b ? b :
                       Dd(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, e)
                           .replace(/\u00A4/g, d)
  }
}
function Bd(b) {
...
function Dd(b, a, c, d, e) {
  ...
  if (h || k)
    ...
    var h = ('' + b).split(hc), g = h[0], h = h[1] || '', p = 0, r = a.lgSize,
        t = a.gSize;
    if (g.length >= r + t)
...
function Fd(b) {
  return function(a) {
    ...
    a = +new Date(
            a.getFullYear(), a.getMonth(), a.getDate() + (4 - a.getDay())) -
        +c;
    ...
    return a.map(function(a) {
      ...
      if (x(a))
        ...
        if ('' !== a && (g = b(a), g.constant))
          var l = g(), g = function(a) {
            return a[l]
          }
      }
      return {
        get: g, descending: d * c
      }
    })
  }
  function c(a) {
      ...
      return {
        value: a, predicateValues: h.map(function(d) {
          ...
          if (null === e)
            ...
            a: {if ('function' === typeof e.valueOf &&
                    (e = e.valueOf(), c(e))) break a;
                if (qc(e) && (e = e.toString(), c(e))) break a; e = b} return {
              value: e, type: d
            }
        })
      }
...
function kb(b, a, c, d) {
  return function(e, f, h, g, l, k, n) {
    ...
    g.$parsers.push(function(b) {
      return g.$isEmpty(b) ?
          null :
          a.test(b) ? (b = c(b, m), t && (b = Ob(b, t)), b) : w
    });
      ...
      function e(a) {
        ...
        return J(a) ?
            (m(a,
             ...
             b) :
            G(a) ? a.split(' ') : C(a) ? (m(a, function(a, c) {
          ...
          function k(b) {
            if (!0 === a || f.$index % 2 === a) {
              ...
              if (!n) {
                ...
                var s = e(n), m = d(k, s), k = d(s, k), m = l(m, 1),
                    k = l(k, -1);
...
function Hd(b) {
  ...
  var d = b.ctrl, e = b.$element, f = {}, h = b.set, g = b.unset,
      l = b.$animate;
  ...
  d.$setValidity = function(b, e, f) {
    ...
    bb(e) ? e ? (g(d.$error, b, f), h(d.$$success, b, f)) :
                (h(d.$error, b, f), g(d.$$success, b, f)) :
            (g(d.$error, b, f), g(d.$$success, b, f));
    d.$pending ? (a(Md, !0), d.$valid = d.$invalid = w, c('', null)) :
                 (a(Md, !1), d.$valid = Ld(d.$error), d.$invalid = !d.$valid,
                  c('', d.$valid));
...
var jg = /^\/(.+)\/([a-z]*)$/,
    ...
    Wa, B, ra, ua = [].slice, Nf = [].splice, kg = [].push,
    va = Object.prototype.toString, rc = Object.getPrototypeOf, Ea = I('ng'),
    da = Q.angular || (Q.angular = {}), Rb, nb = 0;
Wa = X.documentMode;
y.$inject = [];
$a.$inject = [];
var J = Array.isArray,
    ...
    Qa = ['ng-', 'data-ng-', 'ng:', 'x-ng-'], be = /[A-Z]/g, Bc = !1, Qb,
    pa = 1, Pa = 3, fe = {
      full: '1.4.7',
      major: 1,
      minor: 4,
...
var Af = /([\:\-\_]+(.))/g, Bf = /^moz([A-Z])/,
    lg = {mouseleave: 'mouseout', mouseenter: 'mouseover'}, Tb = I('jqLite'),
    Ef = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, Sb = /<|&#?\w+;/, Cf = /<([\w:-]+)/,
    Df =
...
m({
  ...
  triggerHandler: function(a, c, d) {
    ...
    if (g = (g = g && g.events) && g[h])
      ...
      c.type && (e = P(e, c)), c = ja(g), f = d ? [e].concat(d) : [e],
      m(c, function(c) {
  ...
  function(a, c) {
    R.prototype[c] = function(c, e, f) {
      for (var h, g = 0, l = this.length; g < l; g++)
        v(h) ? (h = a(this[g], c, e, f), A(h) && (h = B(h))) :
               Nc(h, a(this[g], c, e, f));
      return A(h) ? h : this
    };
...
var yf = [function() {
  this.$get = [function() {
    ...
    Uc = /^[^\(]*\(\s*([^\)]*)\)/m, mg = /,/, ng = /^\s*(_?)(\S+?)\1\s*$/,
    Tc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Ha = I('$injector');
fb.$$annotate = function(a, c, d) {
  ...
  if ('function' === typeof a) {
    ...
    J(a) ? (c = a.length - 1, Sa(a[c], 'fn'), e = a.slice(0, c)) :
           Sa(a, 'fn', !0);
  return e
};
var Nd = I('$animate'),
          ...
          return {
            enabled: y, on: y, off: y, pin: y, push: function(g, l, k, n) {
              ...
              if (k.addClass || k.removeClass)
                if (l = k.addClass, n = k.removeClass, k = a.get(g) || {},
                    l = f(k, l, !0), n = f(k, n, !1), l || n)
                  ...
                  if (e) {
                    ...
                    a: {
                      for (l = 0; l < e.length; l++) {
                        ...
                        l.parentNode || l.previousElementSibling || (e = null)
                  }
                ...
                return {
                  on: a.on, off: a.off, pin: a.pin, enabled: a.enabled,
                      cancel: function(a) {
                        ...
                        k.tempClasses =
                            ib(k.tempClasses, l || 'ng-inline-animate');
...
var Wc = /^((?:x|data)[\:\-_])/i, Of = I('$controller'),
    ...
    ad = 'application/json', $b = {'Content-Type': ad + ';charset=utf-8'},
    Qf = /^\[|^\{(?!\{)/, Rf = {'[': /]$/, '{': /}$/}, Pf = /^\)\]\}',?\n/,
...
var pg = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/,
    Tf = {http: 80, https: 443, ftp: 21}, Db = I('$location'), qg = {
      $$html5: !1,
      $$replace: !1,
      absUrl: Eb('$$absUrl'),
      url: function(a) {
...
var Z = I('$parse'), Uf = Function.prototype.call,
    Vf = Function.prototype.apply, Wf = Function.prototype.bind, Lb = fa();
m('+ - * / % === !== == != < > <= >= && || ! = |'.split(' '), function(a) {
  Lb[a] = !0
});
var rg = {n: '\n', f: '\f', r: '\r', t: '\t', v: '\v', '\'': '\'', '"': '"'},
      ...
      if ('.' == d || this.isNumber(d))
        ...
        if ('e' == d && this.isExpOperator(e))
          a += d;
            ...
            this.isExpOperator(d) && e && this.isNumber(e) &&
...
s.prototype = {
  ...
  program: function() {
    for (var a = [];;)
      if (0 < this.tokens.length && !this.peek('}', ')', ';', ']') &&
          ...
          !this.expect(';'))
        return {
          type: s.Program, body: a
        }
  },
  expressionStatement: function() {
    return {
      type: s.ExpressionStatement, expression: this.filterChain()
    }
  },
  ...
  identifier: function() {
    ...
    return {
      type: s.Identifier, name: a.text
    }
  },
  constant: function() {
    return {
      type: s.Literal, value: this.consume().value
    }
  },
  arrayDeclaration: function() {
    ...
    this.consume(']');
    return {
      type: s.ArrayExpression, elements: a
    }
  },
  object: function() {
    var a = [], c;
    ...
    this.consume('}');
    return {
      type: s.ObjectExpression, properties: a
    }
  },
  throwError: function(a, c) {
    throw Z(
        'syntax', c.text, a, c.index + 1, this.text,
...
sd.prototype = {
  compile: function(a, c) {
    ...
    this.stage = 'assign';
    if (h = qd(e))
      this.state.computing = 'assign', f = this.nextId(), this.recurse(h, f),
      this.return_(f),
    ...
    f = '"' + this.USE + ' ' + this.STRICT + '";\n' + this.filterPrefix() +
        'var fn=' + this.generateFunction('fn', 's,l,a,i') + f +
        this.watchFns() + 'return fn;';
    f = (new Function(
        '$filter', 'ensureSafeMemberName', 'ensureSafeObject',
        'ensureSafeFunction', 'getStringValue', 'ensureSafeAssignContext',
  ...
  recurse: function(a, c, d, e, f, h) {
    ...
    if (!h && A(a.watchId))
      c = c || this.nextId(),
      this.if_(
          'i', this.lazyAssign(c, this.computedMember('i', a.watchId)),
      ...
      switch (a.type) {
        ...
        case s.ConditionalExpression:
          ...
          k.recurse(a.test, c);
          k.if_(
              c, k.lazyRecurse(a.alternate, c), k.lazyRecurse(a.consequent, c));
          e(c);
          break;
        case s.Identifier:
          c = c || this.nextId();
        ...
        case s.MemberExpression:
          ...
          k.recurse(a.object, g, w, function() {
            k.if_(
                ...
                function() {
                  if (a.computed)
                    l = k.nextId(), k.recurse(a.property, l),
                    k.getStringValue(l), k.addEnsureSafeMemberName(l),
                    f && 1 !== f &&
                        k.if_(
                            k.not(k.computedMember(g, l)),
                            k.lazyAssign(k.computedMember(g, l), '{}')),
                    p = k.ensureSafeObject(k.computedMember(g, l)),
                    k.assign(c, p), d && (d.computed = !0, d.name = l);
                  else {
                    Xa(a.property.name);
                    f && 1 !== f &&
                        k.if_(
        ...
        case s.CallExpression:
          c = c || this.nextId();
          a.filter ? (l = k.filter(a.callee.name), n = [],
                      m(a.arguments,
                        function(a) {
                          var c = k.nextId();
                          k.recurse(a, c);
                            ...
                            function() {
                              ...
                              g.name ?
                                  (k.state.expensiveChecks ||
                                   ...
                                   p = k.member(g.context, g.name, g.computed) +
                                       '(' + n.join(',') + ')') :
                                  p = l + '(' + n.join(',') + ')';
                              p = k.ensureSafeObject(p);
                              k.assign(c, p)
        ...
        case s.ObjectExpression:
          ...
          m(a.properties, function(a) {
            k.recurse(a.value, k.nextId(), w, function(c) {
              n.push(
                  k.escape(
                      a.key.type === s.Identifier ? a.key.name :
                                                    '' + a.key.value) +
                  ':' + c)
            })
          });
...
td.prototype = {
  ...
  recurse: function(a, c, d) {
    ...
    switch (a.type) {
      ...
      case s.BinaryExpression:
        return e = this.recurse(a.left), f = this.recurse(a.right),
      ...
      case s.Identifier:
        return Xa(a.name, h.expression),
               h.identifier(
                   a.name, h.expensiveChecks || Fb(a.name), c, d, h.expression);
      case s.MemberExpression:
        return e = this.recurse(a.object, !1, !!d),
               a.computed ||
                   (Xa(a.property.name, h.expression), f = a.property.name),
               a.computed && (f = this.recurse(a.property)),
               a.computed ? this.computedMember(e, f, c, d, h.expression) :
                            this.nonComputedMember(
                                e, f, h.expensiveChecks, c, d, h.expression);
      case s.CallExpression:
        return g = [],
               m(a.arguments,
                 function(a) {
  ...
  computedMember: function(a, c, d, e, f) {
    return function(h, g, l, k) {
      var n = a(h, g, l, k), p, m;
      null != n &&
          (p = c(h, g, l, k), p = kd(p), Xa(p, f),
           e && 1 !== e && n && !n[p] && (n[p] = {}), m = n[p], Ba(m, f));
...
m(Bb, function(a, c) {
  ...
  if ('multiple' != a) {
    ...
    tb[e] = function() {
      return {
        restrict: 'A', priority: 100, link: f
      }
    }
  }
});
...
var Od =
  ...
  return [
    ...
    function(c, d) {
      ...
      return {
        name: 'form', restrict: a ? 'EAC' : 'E', require: ['form', '^^?form'],
            controller: Gd, compile: function(d, h) {
              ...
              return {
                pre: function(a, d, f, h) {
                  ...
                  g && (s(a, m), f.$observe(g, function(c) {
                    m.$name !== c &&
                        (s(a, w), m.$$parentForm.$$renameControl(m, c),
                         s = e(m.$name), s(a, m))
                  }));
                  d.on('$destroy', function() {
    ...
    Sd = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Td = {
      ...
      'datetime-local':
          kb('datetimelocal', Qd, Kb(Qd, 'yyyy MM dd HH mm ss sss'.split(' ')),
          ...
          kb('week', lc,
             function(a, c) {
               ...
               if (G(a)) {
                 ...
                 var d = lc.exec(a);
                 if (d) {
                   var e = +d[1], f = +d[2], h = d = 0, g = 0, l = 0, k = Ed(e),
                       f = 7 * (f - 1);
                   c &&
                       (d = c.getHours(), h = c.getMinutes(),
                        g = c.getSeconds(), l = c.getMilliseconds());
            ...
            return {
              restrict: 'E', require: ['?ngModel'], link: {
                pre:
                    function(f, h, g, l) {
                      l[0] &&
                          (Td[F(g.type)] || Td.text)(f, h, g, l[0], c, a, d, e)
                    }
              }
            }
          }
    ...
    qe = kc('', !0), se = kc('Odd', 0), re = kc('Even', 1),
    te = Na({
      compile: function(a, c) {
        c.$set('ngCloak', w);
...
m('click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste'
      .split(' '),
  function(a) {
    var c = ya('ng-' + a);
    Jc[c] = [
...
var xe =
                  ...
                  link: function(c, d, e, f, h) {
                    ...
                    c.$watch(e.ngIf, function(c) {
                      c ? l || h(function(c, f) {
                            l = f;
                            c[c.length++] =
                                X.createComment(' end ngIf: ' + e.ngIf + ' ');
                            g = {clone: c};
                          ...
                          (k && (k.remove(), k = null),
                           l && (l.$destroy(), l = null),
                           g &&
                               (k = rb(g.clone), a.leave(k).then(function() {
                                 k = null
                               }),
                                g = null))
                    })
          ...
          function(a, c, d) {
            return {
              restrict: 'ECA', priority: 400, terminal: !0,
                  transclude: 'element', controller: da.noop,
                  compile: function(e, f) {
                    var h = f.ngInclude || f.src, g = f.onload || '',
                        l = f.autoscroll;
                    return function(e, f, m, r, t) {
                      ...
                      e.$watch(h, function(h) {
                        ...
                        h ? (a(h, !0).then(
                                 ...
                                 function() {
                                   p === s &&
                                       (z(), e.$emit('$includeContentError', h))
                                 }),
    ...
    Le =
      ...
      return {
        restrict: 'A', priority: 100, require: 'ngModel',
            link: function(a, c, d, e) {
              var f = c.attr(d.$attr.ngList) || ', ', h = 'false' !== d.ngTrim,
                  g = h ? T(f) : f;
              e.$parsers.push(function(a) {
                if (!v(a)) {
                  var c = [];
    ...
    mb = 'ng-valid', Kd = 'ng-invalid', Ya = 'ng-pristine', Jb = 'ng-dirty',
    Md = 'ng-pending', lb = I('ngModel'),
    xg =
        [
          ...
          function(a, c, d, e, f, h, g, l, k, n) {
            ...
            this.$$parentForm = Ib;
            var p = f(d.ngModel), r = p.assign, t = p, s = r, K = null, u,
                q = this;
            ...
            this.$commitViewValue = function() {
              var a = q.$viewValue;
              g.cancel(K);
              if (q.$$lastCommittedViewValue !== a ||
                  '' === a && q.$$hasNativeValidators)
                q.$$lastCommittedViewValue = a, q.$pristine && this.$setDirty(),
            ...
            this.$$parseAndValidate = function() {
              ...
              V(q.$modelValue) && isNaN(q.$modelValue) &&
                  (q.$modelValue = t(a));
            ...
            this.$$debounceViewValueCommit = function(c) {
              ...
              d ? K = g(
                      ...
                      d) :
                  l.$$phase ? q.$commitViewValue() : a.$apply(function() {
                    q.$commitViewValue()
                  })
            };
            a.$watch(function() {
              ...
              if (c !== q.$modelValue &&
                ...
                for (var d = q.$formatters, e = d.length, f = c; e--;)
                  f = d[e](f);
                q.$viewValue !== f &&
                    (q.$viewValue = q.$$lastCommittedViewValue = f, q.$render(),
          ...
          function(a) {
            return {
              restrict: 'A', require: ['ngModel', '^?form', '^?ngModelOptions'],
                  controller: xg, priority: 1, compile: function(c) {
                    ...
                    return {
                      pre: function(a, c, f, h) {
                        ...
                        e.on('blur', function(e) {
                          g.$touched ||
                              (a.$$phase ? c.$evalAsync(g.$setTouched) :
          ...
          function(a, c) {
            ...
            A(this.$options.updateOn) ?
                (this.$options.updateOnDefault = !1,
                 this.$options.updateOn = T(this.$options.updateOn.replace(
                     yg,
                     function() {
    ...
    Ae = Na({terminal: !0, priority: 1E3}), zg = I('ngOptions'),
    Ag =
          ...
          function(a, c) {
            function d(a, d, e) {
              ...
              var w = a && c(a) || d, u = v && c(v),
                  ...
                  y = c(m[2] || m[1]), A = c(m[3] || ''), O = c(m[4] || ''),
                  H = c(m[8]), B = {}, x = s ? function(a, c) {
                    B[s] = c;
                    B[r] = a;
                    return B
                  } : function(a) {
              ...
              return {
                trackBy: v, getTrackByValue: z,
                    getWatchables: c(H, function(a) {
                      ...
                      for (var a = [], c = {}, d = H(e) || [], g = n(d),
                               h = g.length, m = 0;
                           m < h; m++) {
                        var p = d === g ? m : g[m], r = x(d[p], p), s = w(e, r),
                            p = q(s, r), t = y(e, r), u = A(e, r), r = O(e, r),
                            s = new f(p, s, t, u, r);
                        a.push(s);
                        c[p] = s
                      }
                      return {
                        items: a, selectValueMap: c,
              ...
              restrict: 'A', terminal: !0, require: ['select', '?ngModel'],
                  link: function(c, g, l, k) {
                            ...
                            (h = c[a.group],
                             h ||
                                 (h = p(g[0], d, 'optgroup', f),
                                  d = h.nextSibling, h.label = a.group,
                                  h = c[a.group] = {
                                    groupElement: h,
                                    currentOptionElement: h.firstChild
                                  }),
                             k =
                                 p(h.groupElement, h.currentOptionElement,
                                   'option', e),
                             n(a, k), h.currentOptionElement = k.nextSibling) :
                            (k = p(g[0], d, 'option', e), n(a, k),
                             d = k.nextSibling)
                      });
                    ...
                    if (w) {
                      var u = k[0];
                      k = l.multiple;
                      for (var q, z = 0, y = g.children(), A = y.length; z < A;
                           z++)
                        if ('' === y[z].value) {
                          q = y.eq(z);
                          break
                               ...
                               function(a) {
                                 ...
                                 a && a.forEach(function(a) {
                                   (a = x.getOptionFromViewValue(a)) &&
                                       !a.disabled && (a.element.selected = !0)
                                 })
                               },
                           u.readValue =
                               function() {
                                 var a = g.val() || [], c = [];
                                 m(a, function(a) {
                                   (a = x.selectValueMap[a]) && !a.disabled &&
                                     ...
                                     g[0].value !== c.selectValue &&
                                         (H.remove(), O || q.remove(),
                                          ...
                                          c.element.setAttribute(
                                              'selected', 'selected')) :
                                     null === a || O ?
                                     (H.remove(), O || g.prepend(q), g.val(''),
                                      q.prop('selected', !0),
                                      q.attr('selected', !0)) :
                                     (O || q.remove(), g.prepend(H), g.val('?'),
                                      H.prop('selected', !0),
                                      H.attr('selected', !0))
                               },
                           u.readValue =
                      ...
                      O ? (q.remove(), a(q)(c), q.removeClass('ng-scope')) :
                          q = B(e.cloneNode(!1));
                      v();
          ...
          function(a, c, d) {
            ...
            return {
              link: function(h, g, l) {
                ...
                var n = l.count, p = l.$attr.when && g.attr(l.$attr.when),
                    r = l.offset || 0, s = h.$eval(p) || {}, w = {},
                    A = c.startSymbol(), u = c.endSymbol(),
                    q = A + n + '-' + r + u, z = da.noop, x;
                m(l, function(a, c) {
                  var d = f.exec(c);
                  d &&
                      (d = (d[1] ? '-' : '') + F(d[2]),
                  ...
                  compile: function(f, h) {
                    ...
                    return function(a, f, h, k, n) {
                      ...
                      a.$watchCollection(p, function(h) {
                        ...
                        L = Array(C);
                        for (k = 0; k < C; k++)
                          if (G = h === I ? k : I[k], J = h[G], M = p(G, J, k),
                              s[M])
                      ...
                      (h = f.cases['!' + c] || f.cases['?']) &&
                          m(h, function(c) {
                            c.transclude(function(d, e) {
                              ...
                              var f = c.element;
                              d[d.length++] =
                                  X.createComment(' end ngSwitchWhen: ');
                              g.push({clone: d});
        ...
        [
          ...
          function(a, c, d) {
            ...
            e.removeOption = function(a) {
              var c = f.get(a);
              c &&
                  (1 === c ? (f.remove(a), '' === a && (e.emptyOption = w)) :
                             f.put(a, c - 1))
            };
    ...
    ke =
        function() {
      return {
        restrict: 'E', require: ['select', '?ngModel'], controller: Cg,
            link: function(a, c, d, e) {
              var f = e[1];
              if (f) {
                var h = e[0];
                ...
                if (d.multiple) {
                  ...
                  var g, l = NaN;
                  a.$watch(function() {
                    l !== f.$viewValue || ka(g, f.$viewValue) ||
