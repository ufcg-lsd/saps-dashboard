...
function $RouteProvider() {
   ...
   * function that returns an html template as a string which should be used by
   * {@link ngRoute.directive:ngView ngView} or {@link ng.directive:ngInclude
   ...
   * returns a path to an html template that should be used by {@link
  ...
  this.when = function(path, route) {
    ...
    routes[path] =
        angular.extend(routeCopy, path && pathRegExp(path, routeCopy));
  ...
  function pathRegExp(path, opts) {
    var insensitive = opts.caseInsensitiveMatch,
        ret = {originalPath: path, regexp: path}, keys = ret.keys = [];
  ...
  this.$get = [
    ...
    function(
      ...
      var forceReload = false, preparedRoute, preparedRouteIsUpdateOnly, $route = {
        ...
        updateParams: function(newParams) {
          if (this.current && this.current.$$route) {
            ...
            throw $routeMinErr(
                'norout', 'Tried updating route when with no current route');
          }
        }
      };
      ...
      function prepareRoute($locationEvent) {
        ...
        preparedRouteIsUpdateOnly = preparedRoute && lastRoute &&
      ...
      function commitRoute() {
        ...
        if (preparedRouteIsUpdateOnly) {
          ...
          $q.when(nextRoute)
              .then(function() {
                if (nextRoute) {
                  var locals = angular.extend({}, nextRoute.resolve), template,
                      templateUrl;
