...
p = c.module('ngRoute', ['ng']).provider('$route', function() {
  ...
  function h(a, c) {
    var b = c.caseInsensitiveMatch, d = {originalPath: a, regexp: a},
        g = d.keys = [];
    a = a.replace(/([().])/g, '\\$1')
            .replace(
                /(\/)?:(\w+)([\?\*])?/g,
    ...
    function(a, f, b, d, h, p, x) {
      function l(b) {
        ...
        (v = (n = k()) && e && n.$$route === e.$$route &&
             c.equals(n.pathParams, e.pathParams) && !n.reloadOnSearch && !w) ||
            !e && !n ||
      ...
      function m() {
        var u = s.current, e = n;
        if (v)
          u.params = e.params, c.copy(u.params, b),
          a.$broadcast('$routeUpdate', u);
        else if (e || u)
          w = !1,
          (s.current = e) && e.redirectTo &&
              (c.isString(e.redirectTo) ?
                   f.path(t(e.redirectTo, e.params))
                       .search(e.params)
                       .replace() :
                   f.url(e.redirectTo(e.pathParams, f.path(), f.search()))
                       .replace()),
          d.when(e)
              .then(function() {
                if (e) {
      ...
      function k() {
        ...
        c.forEach(g, function(d, g) {
          ...
          q &&
              (b = r(d, {params: c.extend({}, f.search(), a), pathParams: a}),
               b.$$route = d)
        });
      ...
      var w = !1, n, v, s = {
        ...
        updateParams: function(a) {
          if (this.current && this.current.$$route)
            ...
            f.path(t(this.current.$$route.originalPath, a)), f.search(a);
          else
            throw B('norout');
        }
      };
