...
angular.module(
              ...
              function(a, b, c, d) {
                ...
                return {
                  link: function(d, f, g) {
                    ...
                    function j() {
                      return f.hasClass('collapse') || f.hasClass('in') ?
                          void b.resolve(n(d)).then(function() {
                            f.css({height: f[0].scrollHeight + 'px'})
                                .removeClass('collapse')
                                .addClass('collapsing')
                                .attr('aria-expanded', !1)
                                .attr('aria-hidden', !0),
                                e ? e(f, {removeClass: 'in', to: {height: '0'}})
                                        .start()['finally'](k) :
                                    a.removeClass(f, 'in', {
                                       to: {height: '0'}
                                     }).then(k)
                    ...
                    var l = c(g.expanding), m = c(g.expanded),
                        n = c(g.collapsing), o = c(g.collapsed);
    ...
    angular.module('ui.bootstrap.accordion', ['ui.bootstrap.collapse'])
        ...
        .directive(
            ...
            function() {
              return {
                controller: 'UibAccordionController', controllerAs: 'accordion',
                    transclude: !0, templateUrl: function(a, b) {
        ...
        .directive(
            ...
            function() {
              return {
                require: '^uibAccordion', transclude: !0, replace: !0,
                    templateUrl:
                        function(a, b) {
                          return b.templateUrl ||
                              'uib/template/accordion/accordion-group.html'
        ...
        .directive(
            ...
            function() {
              return {
                transclude: !0, template: '', replace: !0,
    ...
    angular.module('ui.bootstrap.alert', [])
        .controller(
            'UibAlertController',
            [
              '$scope', '$attrs', '$interpolate', '$timeout',
              function(a, b, c, d) {
                a.closeable = !!b.close;
        ...
        .directive(
            ...
            function() {
              return {
                controller: 'UibAlertController', controllerAs: 'alert',
    ...
    angular.module('ui.bootstrap.buttons', [])
        .constant(
            'uibButtonConfig', {activeClass: 'active', toggleEvent: 'click'})
        .controller(
              ...
              function(a) {
                return {
                  require: ['uibBtnRadio', 'ngModel'],
                      ...
                      controllerAs: 'buttons', link: function(b, c, d, e) {
                        ...
                        c.find('input').css({display: 'none'}),
                            g.$render = function() {
                              c.toggleClass(
                                  f.activeClass,
                                  angular.equals(
                                      g.$modelValue, b.$eval(d.uibBtnRadio)))
            ...
            function() {
              return {
                require: ['uibBtnCheckbox', 'ngModel'],
                    controller: 'UibButtonsController', controllerAs: 'button',
                    link: function(a, b, c, d) {
                      function e() {
    ...
    angular.module('ui.bootstrap.carousel', [])
        .controller(
            ...
            [
              ...
              function(a, b, c, d, e) {
                ...
                function h(c, d, i) {
                  if (!u) {
                    if (angular.extend(c, {direction: i}),
                        angular.extend(q[s].slide || {}, {direction: i}),
                        e.enabled(b) && !a.$currentTransition && q[d].element &&
                            p.slides.length > 1) {
                          ...
                          e.on('addClass', q[d].element, function(b, c) {
                            if ('close' === c &&
                                (a.$currentTransition = null,
                                 e.off('addClass', b), t.length)) {
                              var d = t.pop().slide, g = d.index,
                ...
                var n, o, p = this, q = p.slides = a.slides = [],
                          r = 'uib-slideDirection', s = a.active, t = [],
                          u = !1;
                p.addSlide =
                    function(b, c) {
                  q.push({slide: b, element: c}), q.sort(function(a, b) {
                    return +a.slide.index - +b.slide.index
                      ...
                      (a.$currentTransition && (a.$currentTransition = null),
                       s = b.index, a.active = b.index, g(s), p.select(q[i(b)]),
                       1 === q.length && a.play())
                },
                p.getCurrentIndex =
                    function() {
                ...
                p.next = a.next =
                  ...
                  return 0 === b && a.noWrap() ? void a.pause() :
                                                 p.select(q[b], 'next')
                },
                p.prev = a.prev =
                    function() {
                  var b = p.getCurrentIndex() - 1 < 0 ? q.length - 1 :
                                                        p.getCurrentIndex() - 1;
                ...
                p.removeSlide =
                  ...
                  -1 !== d && t.splice(d, 1), q.splice(c, 1),
                      q.length > 0 && s === c ?
                      c >= q.length ?
                      (s = q.length - 1, a.active = s, g(s),
                ...
                p.select = a.select =
                  ...
                  var d = i(b.slide);
                  void 0 === c &&
                      (c = d > p.getCurrentIndex() ? 'next' : 'prev'),
                ...
                a.$watch('interval', l), a.$watchCollection('slides', k),
        ...
        .directive(
            ...
            function() {
              return {
                transclude: !0, replace: !0,
                    controller: 'UibCarouselController',
                    controllerAs: 'carousel', templateUrl: function(a, b) {
                      return b.templateUrl ||
                          'uib/template/carousel/carousel.html'
                    }, scope: {
                      active: '=',
        ...
        .directive(
            ...
            function() {
              return {
                require: '^uibCarousel', transclude: !0, replace: !0,
                    templateUrl:
                        function(a, b) {
                          return b.templateUrl ||
                              'uib/template/carousel/slide.html'
            ...
            [
              ...
              function(a, b, c, d) {
                ...
                this.filter =
                  ...
                  c = b.DATETIME_FORMATS[c] || c, b.id !== m && this.init(),
                  this.formatters[c] ||
                ...
                this.parse =
                  ...
                  d = b.DATETIME_FORMATS[d] || d, d = d.replace(o, '\\$&'),
                  b.id !== m && this.init(),
                  this.parsers[d] || (this.parsers[d] = e(d, 'apply'));
                  var h = this.parsers[d], i = h.regex, j = h.map,
                      k = c.match(i), l = !1;
                  if (k && k.length) {
                    var n, p;
                    ...
                    var t = l ? Date.prototype.setUTCFullYear :
                                Date.prototype.setFullYear,
                        u = l ? Date.prototype.setUTCHours :
                ...
                this.toTimezone = h, this.fromTimezone = i,
                this.timezoneToOffset = j, this.addDateMinutes = k,
              ...
              function(a) {
                ...
                return {
                  restrict: 'A', compile: function(d, e) {
                    function f(a, b, c) {
                      i.push(a), j.push({scope: a, element: b}),
                    ...
                    function h(a) {
                      ...
                      if (i.splice(c, 1), j.splice(c, 1), i.length) {
                        ...
                        angular.forEach(k, function(a) {
                          a.scope === b &&
                              (a.watcher =
                                   d.$watch(a.compareWithExp, a.watchFn),
                               a.scope = d)
                        })
                      } else
                        k = {}
                    }
                    var i = [], j = [], k = {}, l = e.uibIsClass.match(b),
                        m = l[2], n = l[1], o = n.split(',');
                    return f
                  }
                }
              }
    ...
    angular
        ...
        .controller(
            ...
            [
              '$scope', '$attrs', '$parse', '$interpolate', '$locale', '$log',
              'dateFilter', 'uibDatepickerConfig', '$datepickerLiteralWarning',
              ...
              function(a, b, c, d, e, f, g, h, i, j, k) {
                ...
                a.datepickerOptions || (a.datepickerOptions = {}),
                    ...
                    [
                      ...
                      'formatDay', 'formatDayHeader', 'formatDayTitle',
                      'formatMonth', 'formatMonthTitle', 'formatYear',
                      'maxDate', 'maxMode', 'minDate', 'minMode', 'showWeeks',
                      'shortcutPropagation', 'startingDay', 'yearColumns',
                      'yearRows'
                    ].forEach(function(b) {
                      switch (b) {
                        case 'customClass':
                        ...
                        case 'startingDay':
                          angular.isDefined(a.datepickerOptions.startingDay) ?
                              ...
                              m.startingDay =
                                      (e.DATETIME_FORMATS.FIRSTDAYOFWEEK + 8) %
                                      7;
                          break;
                        case 'maxDate':
                        case 'minDate':
                        ...
                        case 'minMode':
                          a.datepickerOptions[b] ?
                              a.$watch(
                                  ...
                                  function(c) {
                                    m[b] = a[b] = angular.isDefined(c) ?
                                        c :
                                        datepickerOptions[b],
                                    ('minMode' === b &&
                                         m.modes.indexOf(a.datepickerOptions
                                                             .datepickerMode) <
                                             m.modes.indexOf(m[b]) ||
                                     'maxMode' === b &&
                                         m.modes.indexOf(a.datepickerOptions
                    ...
                    a.isActive = function(b) {
                      ...
                      n = b, o = b.$options || h.ngModelOptions,
                      a.datepickerOptions.initDate ?
                          (m.activeDate =
                               k.fromTimezone(
                                   a.datepickerOptions.initDate, o.timezone) ||
                               new Date,
                           a.$watch(
                               'datepickerOptions.initDate',
                               function(a) {
                                 a &&
                                     (n.$isEmpty(n.$modelValue) ||
                                      n.$invalid) &&
                                     (m.activeDate =
                                          k.fromTimezone(a, o.timezone),
                                      m.refreshView())
                               })) :
                          m.activeDate = new Date;
                      var c =
                          n.$modelValue ? new Date(n.$modelValue) : new Date;
                      ...
                      if (n.$viewValue) {
                        ...
                        b ? this.activeDate = k.fromTimezone(a, o.timezone) :
                            j ||
                                f.error(
                      ...
                      if (this.element) {
                        a.selectedDt = null, this._refreshView(),
                      ...
                      if (a.datepickerMode === m.minMode) {
                        ...
                        c.setFullYear(
                            ...
                            c = k.toTimezone(c, o.timezone), n.$setViewValue(c),
                            n.$render()
                      } else
                        m.activeDate = b,
                      ...
                      var b = m.activeDate.getFullYear() +
                          a * (m.step.years || 0),
                          c = m.activeDate.getMonth() +
                          a * (m.step.months || 0);
            ...
            [
              ...
              function(a, b, c) {
                ...
                function e(a) {
                  ...
                  var c = b.getTime();
                  return b.setMonth(0), b.setDate(1),
                         Math.floor(Math.round((c - b) / 864e5) / 7) + 1
                }
                var f = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
                this.step = {months: 1}, this.element = b,
                this.init = function(b) {
                  angular.extend(b, this), a.showWeeks = b.showWeeks,
                                           b.refreshView()
                  ...
                  f.setFullYear(b, d, 1);
                  var g = this.startingDay - f.getDay(), h = g > 0 ? 7 - g : -g,
                      i = new Date(f);
                  h > 0 && i.setDate(-h + 1);
                  ...
                  if (a.title = c(this.activeDate, this.formatDayTitle),
                    ...
                    a.weekNumbers = [];
                    for (var m = (11 - this.startingDay) % 7, n = a.rows.length,
                             o = 0;
                         n > o; o++)
                  ...
                  return c.setFullYear(a.getFullYear()),
                         d.setFullYear(b.getFullYear()), c - d
                  ...
                  if ('left' === a)
                    ...
                    var e =
                        this.activeDate.getMonth() + ('pageup' === a ? -1 : 1);
                    this.activeDate.setMonth(e, 1),
                        c = Math.min(
                            d(this.activeDate.getFullYear(),
        ...
        .controller(
            ...
            [
              '$scope', '$element', 'dateFilter',
              function(a, b, c) {
                this.step = {years: 1}, this.element = b,
                this.init = function(a) {
                  angular.extend(a, this), a.refreshView()
                }, this._refreshView = function() {
                  for (var b, d = new Array(12),
                              e = this.activeDate.getFullYear(), f = 0;
                       12 > f; f++)
                    b = new Date(this.activeDate), b.setFullYear(e, f, 1),
                    d[f] = angular.extend(
            ...
            [
              ...
              function(a, b, c) {
                ...
                this.element = b, this.yearpickerInit = function() {
                  e = this.yearColumns, f = this.yearRows * e,
                  this.step = {years: f}
                }, this._refreshView = function() {
                  for (var b, c = new Array(f), g = 0,
                              h = d(this.activeDate.getFullYear());
                       f > g; g++)
                    b = new Date(this.activeDate), b.setFullYear(h + g, 0, 1),
                    c[g] = angular.extend(
                        this.createDateObject(b, this.formatYear),
                        {uid: a.uniqueId + '-' + g});
                  a.title = [c[0].label, c[f - 1].label].join(' - '),
                  a.rows = this.split(c, e), a.columns = e
                }, this.compare = function(a, b) {
                  ...
                  'left' === a ?
                      ...
                      'pageup' === a || 'pagedown' === a ?
                      c += ('pageup' === a ? -1 : 1)* f :
                      'home' === a ? c = d(this.activeDate.getFullYear()) :
                                     'end' === a &&
                                              (c = d(this.activeDate
                                                         .getFullYear()) +
                                                   f - 1),
            ...
            function() {
              return {
                replace: !0,
                    ...
                    link: function(a, b, c, d) {
                      var e = d[0];
                      angular.extend(e, d[1]), e.yearpickerInit(),
                          e.refreshView()
                    }
              }
            }),
              ...
              function(a, b) {
                ...
                return {
                  getRawNode: function(a) {
                    ...
                    c = this.getRawNode(c);
                    var g = d ? e.hidden : e.normal, h = a[0].documentElement,
                                ...
                                h.left += g.clientLeft - g.scrollLeft),
                    {
                      width: Math.round(
                          ...
                          height: Math.round(
                              angular.isNumber(e.height) ? e.height :
                                                           c.offsetHeight),
                    ...
                    return {
                      width: Math.round(
                          ...
                          height: Math.round(
                              angular.isNumber(d.height) ? d.height :
                                                           c.offsetHeight),
                          top: Math.round(
                              d.top +
                              (b.pageYOffset ||
                    ...
                    if (g.top = i.top + h.clientTop,
                        ...
                        g.right = g.left + h.clientWidth, e) {
                      ...
                      if (d[0] = 'top' === d[0] && m.height > k.top &&
                          ...
                          d[1] = 'top' === d[1] &&
                              ...
                              'bottom' === d[1] &&
                                      ...
                                      m.height - i.height <= k.bottom ?
                              'top' :
                              'left' === d[1] && m.width - i.width > k.right &&
                                          m.width - i.width <= k.left ?
                              'right' :
                              'right' === d[1] && m.width - i.width > k.left &&
                        ...
                        if (f.vertical.test(d[0])) {
                          ...
                          k.left + n < 0 && m.width - i.width <= k.right ?
                              d[1] = 'left' :
                              k.right + n < 0 && m.width - i.width <= k.left &&
                                  (d[1] = 'right')
                        } else {
                    ...
                    if (d) {
                      var e = angular.element(d).hasClass('tooltip-inner'),
                          g = e ? a.querySelector('.tooltip-arrow') :
                      ...
                      if (g) {
                        ...
                        var i = 'border-' + c[0] + '-width',
                            j = b.getComputedStyle(g)[i], k = 'border-';
                        k += f.vertical.test(c[0]) ? c[0] + '-' + c[1] :
                                                     c[1] + '-' + c[0],
                            k += '-radius';
            ...
            [
              ...
              function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
                ...
                function s(a, b) {
                  ...
                  return c.ngRequired || d ?
                      (angular.isNumber(d) && (d = new Date(d)),
                       d ? angular.isDate(d) && !isNaN(d) ?
                           !0 :
                           angular.isString(d) ? !isNaN(q(b)) : !1 :
                           !0) :
                      !0
                }
                function t(c) {
                  if (a.isOpen || !a.disabled) {
                    var d = H[0], e = b[0].contains(c.target),
                ...
                this.init =
                  ...
                  G ? (J = G.timezone, a.ngModelOptions = angular.copy(G),
                  ...
                  K ? F.$formatters.push(function(b) {
                    return a.date = l.fromTimezone(b, J), b
                      ...
                      (F.$$parserName = 'date', F.$validators.date = s,
                       F.$parsers.unshift(r), F.$formatters.push(function(b) {
                         return F.$isEmpty(b) ?
                             (a.date = b, b) :
                  ...
                  return angular.forEach(
                             ...
                             function(b) {
                               a.datepickerOptions[b] ?
                                   ...
                                   c[b] = l.fromTimezone(
                                       new Date(a.datepickerOptions[b]), J) :
                                   (p &&
                                        e.warn(
                                            'Literal date support has been deprecated, please switch to date object usage'),
                                    c[b] = new Date(
                                        k(a.datepickerOptions[b], 'medium'))) :
                                   c[b] = null
                             }),
                ...
                a.$watch('isOpen', function(d) {
                  d ? a.disabled ?
                      ...
                      n(
                          function() {
                            v(), z && a.$broadcast('uib:datepicker.focus'),
                                h.on('click', t);
                            var d = c.popupPlacement ? c.popupPlacement :
                                                       m.placement;
                          ...
                          0, !1) :
                      (h.off('click', t), E && E.off('scroll', v),
                       angular.element(g).off('resize', v))
    ...
    angular.module('ui.bootstrap.dropdown', ['ui.bootstrap.position'])
              ...
              function(a, b) {
                ...
                var d = function(a) {
                  ...
                  27 === a.which ?
                      ...
                      c.isKeynavEnabled() && -1 !== [38, 40].indexOf(a.which) &&
                          c.isOpen &&
        ...
        .controller(
            ...
            [
              ...
              function(a, b, c, d, e, f, g, h, i, j, k) {
                var l, m, n = this, o = a.$new(), p = e.appendToOpenClass,
                          q = e.openClass, r = angular.noop,
                          s = c.onToggle ? d(c.onToggle) : angular.noop, t = !1,
                          u = null, v = !1, w = i.find('body');
                b.addClass('dropdown'), this.init = function() {
                  if (c.isOpen &&
                          (m = d(c.isOpen), r = m.assign,
                           a.$watch(
                               m,
                               function(a) {
                                 o.isOpen = !!a
                  ...
                  v = angular.isDefined(c.keyboardNav), t && !u && (u = w),
                  u && n.dropdownMenu &&
                      (u.append(n.dropdownMenu), b.on('$destroy', function() {
                        n.dropdownMenu.remove()
                      }))
                }, this.toggle = function(a) {
                  return o.isOpen = arguments.length ? !!a : !o.isOpen,
                         angular.isFunction(r) && r(o, o.isOpen), o.isOpen
                  ...
                  if (u && n.dropdownMenu) {
                    var e, i, m,
                        v = h.positionElements(
                            b, n.dropdownMenu, 'bottom-left', !0);
                    if (e = {top: v.top + 'px', display: c ? 'block' : 'none'},
                        i = n.dropdownMenu.hasClass('dropdown-menu-right'),
                        i ? (e.left = 'auto', m = h.scrollbarWidth(!0),
                             e.right = window.innerWidth - m -
                                 (v.left + b.prop('offsetWidth')) + 'px') :
                            (e.left = v.left + 'px', e.right = 'auto'),
                        !t) {
                      var w = h.offset(u);
                      e.top = v.top - w.top + 'px',
                      i ? e.right = window.innerWidth -
                              (v.left - w.left + b.prop('offsetWidth')) + 'px' :
                  ...
                  if (y === !c &&
                          g[c ? 'addClass' : 'removeClass'](x, u ? p : q)
                              .then(function() {
        ...
        .directive(
            ...
            function() {
              return {
                restrict: 'A', require: '?^uibDropdown',
                    link: function(a, b, c, d) {
              ...
              return {
                require: '?^uibDropdown', link: function(a, b, c, d) {
                  if (d) {
                    ...
                    var e = function(e) {
                      e.preventDefault(),
                          b.hasClass('disabled') || c.disabled ||
                          a.$apply(function() {
                            d.toggle()
                          })
                    };
                    ...
                    resolve: function(a, e, f, g) {
                      ...
                      return angular.forEach(a, function(a) {
                        angular.isFunction(a) || angular.isArray(a) ?
                            ...
                            angular.isString(a) ? h.push(c.resolve(b.get(a))) :
                                                  h.push(c.resolve(a))
        ...
        .directive(
            ...
            [
              ...
              function(a, b, c) {
                ...
                return {
                  replace: !0, templateUrl: 'uib/template/modal/backdrop.html',
                          ...
                          g.modalInClass &&
                              ...
                              b.when(h).then(function() {
                                ...
                                if (b && a.modalRendered(b.key),
                                    !d[0].activeElement ||
                                        !f[0].contains(d[0].activeElement)) {
            ...
            [
              ...
              function(a, b, c, d, e, f, g, h, i) {
                  ...
                  v.remove(a),
                      ...
                      o(c.modalDomEl, c.modalScope,
                        function() {
                          ...
                          var e = w.hasKey(b);
                          d.toggleClass(b, e),
                              !e && t && t.heightOverflow && t.scrollbarWidth &&
                              (t.originalRight ?
                                   d.css(
                        ...
                        c.closedDeferred),
                      n(), b && b.focus ? b.focus() : d.focus && d.focus()
                }
                function m(a) {
                  var b;
                  v.length() > 0 &&
                ...
                function o(b, c, d, e) {
                  function g() {
                    g.done ||
                        (g.done = !0, a.leave(b).then(function() {
                ...
                function p(a) {
                  ...
                  if (b) switch (a.which) {
                      ...
                      case 9:
                        ...
                        a.shiftKey ? (x.isFocusInFirstItem(a, c) ||
                                      x.isModalFocused(a, b)) &&
                ...
                var r, s, t,
                    u = 'modal-open', v = h.createNew(), w = g.createNew(),
                    x = {NOW_CLOSING_EVENT: 'modal.stack.now-closing'}, y = 0,
                    z = null,
                ...
                return e.$watch(k, function(a) {
                  ...
                  l >= 0 && !r &&
                      (s = e.$new(!0), s.modalOptions = f, s.index = l,
                       r = angular.element(
                           '<div uib-modal-backdrop="modal-backdrop"></div>'),
                       r.attr('backdrop-class', f.backdropClass),
                       f.animation && r.attr('modal-animation', 'true'),
                       d(r)(s), a.enter(r, j), t = i.scrollbarPadding(j),
                       t.heightOverflow && t.scrollbarWidth &&
                           j.css({paddingRight: t.right + 'px'})),
                      y = z ?
                      parseInt(z.value.modalDomEl.attr('index'), 10) + 1 :
                      0;
                  ...
                  n.attr({
                     ...
                     animate: 'animate'
                      ...
                      j.addClass(h), a.enter(d(n)(f.scope), j),
                  ...
                  return c && q(c, b, !0) ?
                      (c.value.modalScope.$$uibDestructionScheduled = !0,
                       c.value.deferred.resolve(b), l(a, c.value.modalOpener),
                       !0) :
                      !c
                  ...
                  return c && q(c, b, !1) ?
                      (c.value.modalScope.$$uibDestructionScheduled = !0,
                       c.value.deferred.reject(b), l(a, c.value.modalOpener),
                       !0) :
                      !c
        ...
        .provider(
            ...
            function() {
              var a = {
                ...
                $get: [
                  '$rootScope', '$q', '$document', '$templateRequest',
                  '$controller', '$uibResolve', '$uibModalStack',
                  function(b, c, d, e, f, g, h) {
                    function i(a) {
                      return a.template ? c.when(a.template) :
                                          e(angular.isFunction(a.templateUrl) ?
                                                a.templateUrl() :
                                                a.templateUrl)
                    }
                    var j = {}, k = null;
                    return j.getPromiseChain = function() {
                      ...
                      var l = c.defer(), m = c.defer(), n = c.defer(),
                          o = c.defer(), p = {
                            result: l.promise,
                            opened: m.promise,
                            closed: n.promise,
                      ...
                      var q,
                          r = c.all(
                              [i(e), g.resolve(e.resolve, {}, null, null)]);
                      return q = k = c.all([k]).then(j, j).then(
                                 function(a) {
                                   var c = e.scope || b, d = c.$new();
                                   d.$close = p.close, d.$dismiss = p.dismiss,
                                   ...
                                   e.controller &&
                                       (j.$scope = d, j.$scope.$resolve = {},
                                        ...
                                        i =
                                            f(e.controller, j, !0,
                                              e.controllerAs),
                                        e.controllerAs && e.bindToController &&
                                            (g = i.instance,
                                             g.$close = d.$close,
                                             g.$dismiss = d.$dismiss,
                                             angular.extend(
              ...
              function(a) {
                return {
                  create: function(b, c, d) {
                    b.setNumPages =
                        d.numPages ? a(d.numPages).assign : angular.noop,
                    b.ngModelCtrl = {$setViewValue: angular.noop},
                    b._watchers = [], b.init = function(a, e) {
                      b.ngModelCtrl = a, b.config = e,
                      a.$render =
                          function() {
                        b.render()
                      },
                      d.itemsPerPage ?
                          b._watchers.push(c.$parent.$watch(
                              d.itemsPerPage,
                              function(a) {
                      ...
                      b.setNumPages(c.$parent, c.totalPages),
                          c.page > c.totalPages ? c.selectPage(c.totalPages) :
                                                  b.ngModelCtrl.$render()
                ...
                return {
                  scope: {
                    ...
                    ngDisabled: '='
                      ...
                      controller: 'UibPagerController', controllerAs: 'pager',
                      templateUrl: function(a, b) {
            ...
            [
              ...
              function(a, b, c, d, e) {
                ...
                function g(a, b) {
                  ...
                  g &&
                      (j ? (d = Math.max(a - Math.floor(i / 2), 1),
                            e = d + i - 1, e > b && (e = b, d = e - i + 1)) :
                ...
                return {
                  scope: {
                    ...
                    ngDisabled: '='
                      ...
                      controllerAs: 'pagination', templateUrl: function(a, b) {
                        return b.templateUrl ||
                            'uib/template/pagination/pagination.html'
    ...
    angular
        ...
        .provider(
            ...
            function() {
              ...
              this.$get = [
                '$window', '$compile', '$timeout', '$document', '$uibPosition',
                ...
                function(e, f, g, h, i, j, k, l, m) {
                  ...
                  return h.on('keypress', n), k.$on('$destroy', function() {
                    ...
                    var q = a(e), r = j.startSymbol(), s = j.endSymbol(),
                        t = '<div ' + q + '-popup uib-title="' + r + 'title' +
                        s + '" ' +
                        (n.useContentExp ?
                        ...
                        return function(a, b, d, f) {
                          ...
                          function v() {
                            D || (E = N.$new(), D = c(E, function(a) {
                                                  K ? h.find('body').append(a) :
                                                      b.after(a)
                                                }), z())
                          }
                          function w() {
                            s(), u(), A(), D && (D.remove(), D = null),
                                E && (E.$destroy(), E = null)
                          }
                          function x() {
                            N.title = d[k + 'Title'],
                          ...
                          N.origScope = a, N.isOpen = !1, o.add(N, {close: t}),
                          ...
                          var T = function() {
                            L.show.forEach(function(a) {
                              'outsideClick' === a ? b.off('click', j) :
                                                     (b.off(a, m), b.off(a, j))
                            }),
                                L.hide.forEach(function(a) {
                                  'outsideClick' === a ? h.off('click', B) :
                                                         b.off(a, q)
                                })
                          };
                          C();
                          ...
                          N.animation =
                              angular.isDefined(U) ? !!U : n.animation;
        ...
        .directive(
            ...
            [
              ...
              function(a) {
                return a(
                    'uibTooltipTemplate', 'tooltip', 'mouseenter',
                    {useContentExp: !0})
              }
            ])
        .directive(
        ...
        .directive(
            ...
            [
              ...
              function(a) {
                return a(
                    'uibTooltipHtml', 'tooltip', 'mouseenter',
                    {useContentExp: !0})
              }
            ]),
    angular.module('ui.bootstrap.popover', ['ui.bootstrap.tooltip'])
        ...
        .directive(
            ...
            [
              ...
              function(a) {
                return a(
                    'uibPopoverTemplate', 'popover', 'click',
                    {useContentExp: !0})
              }
            ])
        .directive(
        ...
        .directive(
            ...
            [
              ...
              function(a) {
                return a(
                    'uibPopoverHtml', 'popover', 'click', {useContentExp: !0})
              }
            ])
        .directive(
            'uibPopoverPopup',
    ...
    angular.module('ui.bootstrap.progressbar', [])
            ...
            [
              ...
              function(a, b, c) {
                ...
                this.bars = [], a.max = d(), this.addBar = function(a, b, c) {
                  f || b.css({transition: 'none'}), this.bars.push(a),
                      a.max = d(),
                      a.title = c && angular.isDefined(c.title) ? c.title :
                                                                  'progressbar',
        ...
        .directive(
            ...
            function() {
              return {
                replace: !0, transclude: !0,
                    controller: 'UibProgressController', require: 'uibProgress',
                    scope: {maxParam: '=?max'},
        ...
        .directive(
            ...
            function() {
              return {
                replace: !0, transclude: !0, require: '^uibProgress',
                    scope: {value: '=', type: '@'},
            ...
            function() {
              return {
                replace: !0, transclude: !0,
                    ...
                    link: function(a, b, c, d) {
                      d.addBar(
                          a, angular.element(b.children()[0]), {title: c.title})
                    }
              }
            }),
    angular.module('ui.bootstrap.rating', [])
        ...
        .controller(
            'UibRatingController',
            [
              '$scope', '$attrs', 'uibRatingConfig',
              function(a, b, c) {
                var d = {$setViewValue: angular.noop}, e = this;
                this.init = function(e) {
                  d = e, d.$render = this.render,
                  ...
                  var g = angular.isDefined(b.ratingStates) ?
                      ...
                      new Array(
                          angular.isDefined(b.max) ? a.$parent.$eval(b.max) :
                                                     c.max);
            ...
            function() {
              return {
                require: ['uibRating', 'ngModel'],
                    ...
                    templateUrl: 'uib/template/rating/rating.html', replace: !0,
                    link: function(a, b, c, d) {
                      var e = d[0], f = d[1];
                      e.init(f)
                    }
              ...
              function(a) {
                ...
                d.tabs = [], d.select = function(a, f) {
                  if (!e) {
                    ...
                    if (h) {
                      if (h.tab.onDeselect({$event: f, $selectedIndex: a}),
                          f && f.isDefaultPrevented())
                        return;
                      h.tab.active = !1
                    }
                    var i = d.tabs[a];
                    i ? (i.tab.onSelect({$event: f}), i.tab.active = !0,
                         d.active = i.index, c = i.index) :
                        !i && angular.isDefined(c) &&
                            (d.active = null, c = null)
                  }
                }, d.addTab = function(a) {
                  if (d.tabs.push({tab: a, index: a.index}),
                  ...
                  if (d.tabs[b].index === d.active) {
                    var e =
                        b === d.tabs.length - 1 ? b - 1 : b + 1 % d.tabs.length;
                    d.select(e)
                  }
                  d.tabs.splice(b, 1)
            ...
            function() {
              return {
                transclude: !0, replace: !0, scope: {},
                    ...
                    controller: 'UibTabsetController', controllerAs: 'tabset',
                    templateUrl: function(a, b) {
              ...
              function(a) {
                return {
                  require: '^uibTabset', replace: !0,
                      ...
                      controller: function() {}, controllerAs: 'tab',
        ...
        .controller(
            ...
            [
              ...
              function(a, b, c, d, e, f, g) {
                ...
                function m() {
                  u.$setValidity('time', !0), a.invalidHours = !1,
                                              a.invalidMinutes = !1,
                                              a.invalidSeconds = !1
                }
                function n(b) {
                  if (u.$modelValue) {
                    var c = s.getHours(), d = s.getMinutes(),
                        e = s.getSeconds();
                    ...
                    a.hours = null, a.minutes = null, a.seconds = null,
                    a.meridian = v[0]
                }
                function o(a) {
                  s = q(s, a), l()
                ...
                var s = new Date, t = [], u = {$setViewValue: angular.noop},
                    ...
                    w = angular.isDefined(c.padHours) ?
                    a.$parent.$eval(c.padHours) :
                    !0;
                a.tabindex = angular.isDefined(c.tabindex) ? c.tabindex : 0,
                b.removeAttr('tabindex'), this.init = function(b, d) {
                  u = b, u.$render = this.render,
                ...
                var x = g.hourStep;
                c.hourStep &&
                    t.push(a.$parent.$watch(d(c.hourStep), function(a) {
                      x = +a
                    }));
                var y = g.minuteStep;
                c.minuteStep &&
                    t.push(a.$parent.$watch(d(c.minuteStep), function(a) {
                      y = +a
                    }));
                var z;
                ...
                c.ngDisabled &&
                    ...
                    a.noIncrementHours = function() {
                      ...
                      return s.getHours() < 12 ? B || p(s, 720) > A :
                                                 B || p(s, -720) < z
                    };
                var C = g.secondStep;
                c.secondStep &&
                    ...
                    this.setupMousewheelEvents =
                      ...
                      b.bind('mousewheel wheel', function(b) {
                        B ||
                            a.$apply(
                                e(b) ? a.incrementHours() : a.decrementHours()),
                            b.preventDefault()
                      }), c.bind('mousewheel wheel', function(b) {
                        B ||
                            a.$apply(
                                e(b) ? a.incrementMinutes() :
                                       a.decrementMinutes()),
                            b.preventDefault()
                      }), d.bind('mousewheel wheel', function(b) {
                        B ||
                            a.$apply(
                                e(b) ? a.incrementSeconds() :
                                       a.decrementSeconds()),
                            b.preventDefault()
                      })
                    },
                    this.setupArrowkeyEvents =
                      ...
                      b.bind('keydown', function(b) {
                        ...
                        B ||
                            (38 === b.which ?
                                 (b.preventDefault(), a.incrementMinutes(),
                                  a.$apply()) :
                                 40 === b.which &&
                                     (b.preventDefault(), a.decrementMinutes(),
                                      a.$apply()))
                      }), d.bind('keydown', function(b) {
                        B ||
                            (38 === b.which ?
                                 (b.preventDefault(), a.incrementSeconds(),
                                  a.$apply()) :
                                 40 === b.which &&
                                     (b.preventDefault(), a.decrementSeconds(),
                                      a.$apply()))
                      })
                    },
                    this.setupInputEvents =
                      ...
                      var e = function(b, c, d) {
                        u.$setViewValue(null), u.$setValidity('time', !1),
                      ...
                      a.updateHours = function() {
                        ...
                        u.$setDirty(),
                            angular.isDefined(a) && angular.isDefined(b) ?
                            (s.setHours(b), s.setMinutes(a),
                             z > s || s > A ? e(void 0, !0) : l('m')) :
                            e(void 0, !0)
                      }, c.bind('blur', function(b) {
                        u.$setTouched(),
                            r() ? m() :
                                  null === a.minutes ? e(void 0, !0) :
                                                       !a.invalidMinutes &&
                                    a.minutes < 10 && a.$apply(function() {
                                      a.minutes = k(a.minutes)
                                    })
                      }), a.updateSeconds = function() {
                        var a = j();
                        u.$setDirty(),
                            angular.isDefined(a) ? (s.setSeconds(a), l('s')) :
                                                   e(void 0, void 0, !0)
                      }, d.bind('blur', function(b) {
                        r() ? m() :
                              !a.invalidSeconds && a.seconds < 10 &&
                                a.$apply(function() {
                    ...
                    this.render =
                      ...
                      isNaN(b) ?
                          ...
                          (b && (s = b),
                           z > s || s > A ?
                               (u.$setValidity('time', !1), a.invalidHours = !0,
                                a.invalidMinutes = !0) :
                               m(),
                           n())
                    },
              ...
              function(a) {
                return {
                  require: ['uibTimepicker', '?^ngModel'],
                      ...
                      controllerAs: 'timepicker', replace: !0, scope: {},
                  ...
                  parse: function(c) {
                    ...
                    if (!d)
                      throw new Error(
                          ...
                          c + '".');
                    return {
                      itemName: d[3], source: a(d[4]),
                          viewMapper: a(d[2] || d[1]), modelMapper: a(d[1])
                    }
                  }
                }
              }
            ...
            [
              ...
              function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
                ...
                var w, x,
                    ...
                    D = c.typeaheadInputFormatter ?
                    e(c.typeaheadInputFormatter) :
                    void 0,
                    E = c.typeaheadAppendToBody ?
                    a.$eval(c.typeaheadAppendToBody) :
                    !1,
                    F = c.typeaheadAppendTo ? a.$eval(c.typeaheadAppendTo) :
                                              null,
                    G = a.$eval(c.typeaheadFocusFirst) !== !1,
                    H = c.typeaheadSelectOnExact ?
                    a.$eval(c.typeaheadSelectOnExact) :
                    !1,
                    I = e(c.typeaheadIsOpen).assign || angular.noop,
                    J = a.$eval(c.typeaheadShowHint) || !1, K = e(c.ngModel),
                    L = e(c.ngModel + '($$$p)'),
                    M =
                        function(b, c) {
                      return angular.isFunction(K(a)) && q && q.$options &&
                              q.$options.getterSetter ?
                          L(b, {$$$p: c}) :
                          K.assign(b, c)
                    },
                    N = m.parse(c.uibTypeahead), O = a.$new(),
                    P = a.$on('$destroy', function() {
                      O.$destroy()
                    });
                O.$on('$destroy', P);
                var Q = 'typeahead-' + O.$id + '-' +
                    Math.floor(1e4 * Math.random());
                b.attr({
                ...
                J &&
                    (R = angular.element('<div></div>'),
                     R.css('position', 'relative'), b.after(R), S = b.clone(),
                     S.attr('placeholder', ''), S.attr('tabindex', '-1'),
                     S.val(''), S.css({
                       position: 'absolute',
                       top: '0px',
                       left: '0px',
                ...
                var U = function() {
                  ...
                  O.matches = [], O.activeIdx = -1, b.attr('aria-expanded', !1),
                  U()
                }, W = function(a) {
                  return Q + '-option-' + a
                };
                O.$watch('activeIdx', function(a) {
                  0 > a ? b.removeAttr('aria-activedescendant') :
                ...
                V(), O.assignIsOpen = function(b) {
                  ...
                  var f, h, i = {};
                  x = !0, i[N.itemName] = h = O.matches[d].model,
                  f = N.modelMapper(a, i), M(a, f),
                  ...
                  if (0 !== O.matches.length && -1 !== r.indexOf(b.which)) {
                    ...
                    switch (b.which) {
                      ...
                      case 38:
                        O.activeIdx =
                            (O.activeIdx > 0 ? O.activeIdx : O.matches.length) -
                            1,
                        O.$digest(), d = T.find('li')[O.activeIdx],
                  ...
                  B && O.matches.length && -1 !== O.activeIdx && !x &&
                      ...
                      !v && p.$error.editable &&
                      (p.$setViewValue(), p.$setValidity('editable', !0),
                       p.$setValidity('parse', !0), b.val('')),
                      w = !1, x = !1
                });
                var ba = function(c) {
                  b[0] !== c.target && 3 !== c.which &&
                      0 !== O.matches.length && (V(), j.$$phase || a.$digest())
                };
                ...
                var ca = d(T)(O);
                E ? h.find('body').append(ca) :
                    F ? angular.element(F).eq(0).append(ca) : b.after(ca),
                    this.init = function(b, c) {
                      p = b, q = c,
                      O.debounceUpdate =
                          p.$options && e(p.$options.debounce)(a),
                      p.$parsers.unshift(function(b) {
                        return w = !0,
                               0 === t || b && b.length >= t ?
                                   ...
                                   (y(a, !1), aa(), V()),
                               v ? b :
                                   b ? void p.$setValidity('editable', !1) :
                      ...
                      p.$formatters.push(function(b) {
                        ...
                        return v || p.$setValidity('editable', !0),
                               D ? (e.$model = b, D(a, e)) :
                                   (e[N.itemName] = b, c = N.viewMapper(a, e),
                                    e[N.itemName] = void 0,
                                    d = N.viewMapper(a, e), c !== d ? c : b)
                      })
                    }
              }
            ])
    ...
    angular.module('ui.bootstrap.tooltip').run(function() {
      !angular.$$csp().noInlineStyle && !angular.$$uibTooltipCss &&
          angular.element(document).find('head').prepend(
