...
+function(a) {
  ...
  if (b[0] < 2 && b[1] < 9 || 1 == b[0] && 9 == b[1] && b[2] < 1 || b[0] > 3)
    ...
    +function(a) {
      ...
      a(document).on(
          'click.bs.collapse.data-api', '[data-toggle="collapse"]',
          function(d) {
            var e = a(this);
            ...
            (this.isShown = !0, this.checkScrollbar(), this.setScrollbar(),
             ...
             this.$dialog.on('mousedown.dismiss.bs.modal', function() {
               ...
               d.$element.parent().length || d.$element.appendTo(d.$body),
                   ...
                   e && d.$element[0].offsetWidth, d.$element.addClass('in'),
                   d.enforceFocus();
      ...
      c.prototype.init = function(b, c, d) {
        ...
        for (var e = this.options.trigger.split(' '), f = e.length; f--;) {
          ...
          if ('click' == g)
            ...
            this.$element.on(
                h + '.' + this.type, this.options.selector,
                a.proxy(this.enter, this)),
                this.$element.on(
                    i + '.' + this.type, this.options.selector,
        ...
        return c ||
                   (c = new this.constructor(
                        b.currentTarget, this.getDelegateOptions()),
    ...
    +function(a) {
      ...
      function b(c, d) {
        ...
        this.$scrollElement.on(
            'scroll.bs.scrollspy', a.proxy(this.process, this)),
