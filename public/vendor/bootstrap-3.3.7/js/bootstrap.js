...
+function($) {
  ...
  $.fn.emulateTransitionEnd =
      function(duration) {
    var called = false
    var $el = this $(this).one('bsTransitionEnd', function() {
      called = true
    })
...
+function($) {
  ...
  var Button =
    ...
    this.$element = $(element) this.options =
        $.extend({}, Button.DEFAULTS, options) this.isLoading = false
  }
    ...
    if ($parent.length) {
      ...
      if ($input.prop('type') == 'radio') {
        if ($input.prop('checked')) changed = false
          $parent.find('.active').removeClass('active') this.$element.addClass(
              'active')
      }
      ...
      $(document)
          .on('click.bs.button.data-api', '[data-toggle^="button"]',
              function(e) {
                ...
                if (!($(e.target).is(
                  ...
                  else $btn.find('input:visible,button:visible')
                      .first()
                      .trigger('focus')
                }
              })
          .on('focus.bs.button.data-api blur.bs.button.data-api',
              '[data-toggle^="button"]', function(e) {
                $(e.target).closest('.btn').toggleClass(
...
+function($) {
  ...
  var Carousel =
    ...
    this.$element = $(element) this.$indicators =
        ...
        this.$element
                .on('keydown.bs.carousel', $.proxy(this.keydown, this))

                    this.options.pause == 'hover' &&
        !('ontouchstart' in document.documentElement) &&
        this.$element.on('mouseenter.bs.carousel', $.proxy(this.pause, this))
  ...
  Carousel
      .DEFAULTS = {interval: 5000, pause: 'hover', wrap: true, keyboard: true}

                  Carousel.prototype.keydown =
      function(e) {
    ...
    return this
          ...
          Carousel.prototype.getItemIndex =
              function(item) {
    this.$items = item.parent().children('.item')
    return this.$items.index(item || this.$active)
  }

              Carousel.prototype.getItemForDirection =
                  function(direction, active) {
    ...
    return this.$items.eq(itemIndex)
                  ...
                  Carousel.prototype.to =
                      function(pos) {
    var that = this var activeIndex =
        this.getItemIndex(this.$active = this.$element.find('.item.active'))
    ...
    var relatedTarget = $next[0] var slideEvent =
        $.Event(
             'slide.bs.carousel',
             {relatedTarget: relatedTarget,
              direction: direction}) this.$element.trigger(slideEvent)
  ...
  var clickHandler =
    ...
    if (!$target.hasClass('carousel')) return var options =
...
+function($) {
  ...
  var Collapse =
      function(element, options) {
    this.$element = $(element) this.options =
        $.extend({}, Collapse.DEFAULTS, options) this.$trigger =
  ...
  Collapse.DEFAULTS = {toggle: true}
    ...
    var startEvent =
        $.Event('show.bs.collapse') this.$element.trigger(startEvent)
    ...
    var complete =
      ...
      this.$element.removeClass('collapsing')
          .addClass('collapse in')[dimension]('') this.transitioning =
    ...
    var scrollSize =
        $.camelCase(['scroll', dimension].join('-'))
    ...
    if (this.transitioning || !this.$element.hasClass('in'))
      return
          ...
          var startEvent =
              $.Event('hide.bs.collapse') this.$element.trigger(startEvent)
      if (startEvent.isDefaultPrevented()) return
    ...
    return $(this.options.parent)
        ...
        .each($.proxy(
            function(i, element) {
              var $element = $(element) this.addAriaAndCollapsedClass(
  ...
  $.fn.collapse.noConflict =
    ...
    return this
      ...
      $(document)
          .on('click.bs.collapse.data-api', '[data-toggle="collapse"]',
              function(e) {
                var $this = $(this)
...
+function($) {
  ...
  Dropdown.prototype.toggle =
    ...
    if (!isActive) {
      ...
      var relatedTarget = {relatedTarget: this} $parent.trigger(
...
+function($) {
  ...
  var Modal =
      function(element, options) {
    this.options = options this.$body = $(document.body) this.$element =
        $(element) this.$dialog =
            this.$element.find('.modal-dialog') this.$backdrop =
                null this.isShown = null this.originalBodyPad =
                    null this.scrollbarWidth = 0 this.ignoreBackdropClick =
                        false
  ...
  Modal.DEFAULTS = {backdrop: true, keyboard: true, show: true}
    ...
    if (this.isShown || e.isDefaultPrevented()) return
        ...
        this.checkScrollbar() this.setScrollbar() this.$body
            .addClass('modal-open')
            ...
            .resize()
                ...
                this.$element
            .on('click.dismiss.bs.modal', '[data-dismiss="modal"]',
                ...
                this.backdrop(function() {
                  ...
                  if (!that.$element.parent().length) {
                    that.$element.appendTo(
                        that.$body)  // don't move modals dom position
                  }
                  ...
                  this.$element.on(
                      'click.dismiss.bs.modal', $.proxy(function(e) {
                        ...
                        if (e.target !== e.currentTarget)
                          return this.options.backdrop == 'static' ?
    ...
    this.bodyIsOverflowing = document.body.clientWidth <
        fullWindowWidth this.scrollbarWidth = this.measureScrollbar()
  }
    ...
    var bodyPad =
        parseInt(
            (this.$body.css('padding-right') || 0), 10) this.originalBodyPad =
    ...
    var scrollbarWidth = scrollDiv.offsetWidth -
        scrollDiv.clientWidth this.$body[0].removeChild(scrollDiv)
      ...
      $(document)
          .on('click.bs.modal.data-api', '[data-toggle="modal"]', function(e) {
            ...
            var option = $target.data('bs.modal') ?
                'toggle' :
                $.extend(
                    {remote: !/#/.test(href) && href}, $target.data(),
                    $this.data())
...
+function($) {
  ...
  Tooltip.DEFAULTS = {
    ...
    this.enabled = true this.type = type this.$element =
        $(element) this.options = this.getOptions(options) this.$viewport =
    ...
    for (var i = triggers.length; i--;) {
      var trigger = triggers[i]
          ...
          if (trigger == 'click') {
        this.$element.on(
            'click.' + this.type, this.options.selector,
    ...
    self.timeout = setTimeout(function() {
      if (self.hoverState == 'in') self.show()
                      ...
                      Tooltip.prototype.isInStateTrue =
                          function() {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      if (e.isDefaultPrevented() || !inDom) return var that = this
      ...
      var tipId = this.getUID(this.type)
                      ...
                      this.setContent()
      $tip.attr('id', tipId) this.$element.attr('aria-describedby', tipId)
      ...
      $tip.detach()
          ...
          $tip.insertAfter(this.$element) this.$element.trigger(
        ...
        $.extend(
            {
              using: function(props) {
                $tip.css(
                    {top: Math.round(props.top), left: Math.round(props.left)})
              }
            },
            offset),
        0)
    ...
    $tip.offset(offset) this.replaceArrow(
        arrowDelta, $tip[0][arrowOffsetPosition], isVertical)
  }

                                      Tooltip.prototype.replaceArrow =
                                          function(
                                              delta, dimension, isVertical) {
    this.arrow()
    ...
    var elOffset =
        isBody ? {top: 0, left: 0} : (isSvg ? null : $element.offset())
    var scroll = {
      scroll: isBody ?
          document.documentElement.scrollTop || document.body.scrollTop :
          $element.scrollTop()
    } var outerDims =
        isBody ? {width: $(window).width(), height: $(window).height()} : null
                               ...
                               left: pos.left + pos.width
                                                                  ...
                                                                  Tooltip
                                                                      ...
                                                                      function(
                                                                          ...
                                                                          actualWidth,
                                                                          actualHeight) {
    var delta = {top: 0, left: 0} if (!this.$viewport) return delta
    ...
    if (/right|left/.test(placement)) {
      ...
      if (topEdgeOffset < viewportDimensions.top) {  // top overflow
        delta.top = viewportDimensions.top - topEdgeOffset
          ...
          bottomEdgeOffset > viewportDimensions.top +
...
+function($) {
  ...
  function ScrollSpy(element, options) {
    this.$body = $(document.body) this.$scrollElement =
  ...
  ScrollSpy.DEFAULTS = {offset: 10}
    ...
    return this.$scrollElement[0].scrollHeight ||
      ...
      ScrollSpy.prototype.refresh =
          function() {
    var that = this var offsetMethod = 'offset'
    var offsetBase = 0
      ...
      if (showEvent.isDefaultPrevented() ||
          ...
          var $target =
              $(selector)
                  ...
                  this.activate($this.closest('li'), $ul) this.activate(
                      $target, $target.parent(), function() {
                        $previous.trigger(
                            {type: 'hidden.bs.tab', relatedTarget: $this[0]})
                        $this.trigger(
...
+function($) {
  ...
  Affix.DEFAULTS = {offset: 0, target: window}
    ...
    if (this.pinnedOffset)
      return this.pinnedOffset this.$element.removeClass(Affix.RESET)
          .addClass('affix')
      var scrollTop = this.$target.scrollTop()
      var position = this.$element.offset()
    ...
    if (!this.$element.is(':visible'))
      ...
      var scrollHeight =
          Math.max($(document).height(), $(document.body).height())
