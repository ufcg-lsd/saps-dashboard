  ...
  var lnItemsListApi = {
    ...
    'NLItemsList': function(config) {
      ...
      /*Config:
      {
              ...
              valueValidator: funtion to return true or false after validate de
      value for the item.
      }
      */
      var newItemsList =
      ...
      var addInputElement =
        ...
        itemsListElement.append(
            '<input id="' + ID_INPUT + '" class="' + CLASS_INPUT +
            '" type="text"></input>');
      ...
      var addItem =
          function(lnilItem, inputId) {
        var buttonRemoveId = lnilItem.htmlId + ID_REMOVE_POSFIX;

        var stringNewItem = '<div id="' + lnilItem.htmlId + '" class="' +
            CLASS_LNIL_ITEM + '" value="' + lnilItem.item.value + '">' +
            lnilItem.item.value + '</div>';
        ...
        newItemElement.append(
            '&nbsp;<button type="button" id="' + buttonRemoveId + '" class="' +
            CLASS_LNIL_ITEM_REMOVER +
      ...
      var handleEditItemEvent =
        ...
        var inputEditHtml = '<input id=' + ID_INPUT_EDIT + ' class="' +
            CLASS_INPUT_EDIT + '" type="text"></input>';
      ...
      var resizeInput =
        ...
        var minSize = lnilConfig.options.permanentInput ? inputMinSize :
                                                          hiddenInputMinSize;
