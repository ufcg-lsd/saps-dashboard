 ...
 * menu.js, progressbar.js, resizable.js, selectable.js, selectmenu.js,
...
function t(t, s) {
  ...
  return 'area' === r ? (n = t.parentNode, a = n.name,
...
function r(e) {
  return function() {
    ...
    e.apply(this, arguments), this._refresh(),
  ...
  keyCode: {
    ...
    e.fn.extend({
      scrollParent: function() {
        var t = this.css('position'), i = 'absolute' === t,
            s = this.parents()
                    .filter(function() {
                      var t = e(this);
    ...
    e.each(
        ...
        function(t, i) {
          ...
          e.fn['inner' + i] = function(t) {
            return void 0 === t ? o['inner' + i].call(this) :
                                  this.each(function() {
    ...
    (e.fn.removeData =
         function(t) {
           return function(i) {
             return arguments.length ? t.call(this, e.camelCase(i)) :
                                       t.call(this)
           }
         }(e.fn.removeData)),
  ...
  return function(i) {
    ...
    e.widget =
      ...
      return t = t.split('.')[1], n = l + '-' + t, s || (s = i, i = e.Widget),
             ...
             r = new i, r.options = e.widget.extend({}, r.options),
             e.each(
                 s,
                 function(t, s) {
                   return e.isFunction(s) ? (h[t] = function() {
                     ...
                     return function() {
                       ...
                       return this._super = e, this._superApply = n,
                              t = s.apply(this, arguments), this._super = i,
                              this._superApply = a, t
                     }
                   }(), void 0) : (h[t] = s, void 0)
                 }),
             o.prototype = e.widget.extend(
                 r, {widgetEventPrefix: a ? r.widgetEventPrefix || t : t}, h, {
                   constructor: o,
                   namespace: l,
                   widgetName: t,
                   widgetFullName: n
      ...
      for (var i, s, n = l.call(arguments, 1), a = 0, o = n.length; o > a; a++)
        for (i in n[a])
          ...
          n[a].hasOwnProperty(i) && void 0 !== s &&
              (t[i] = e.isPlainObject(s) ? e.isPlainObject(t[i]) ?
                 ...
                 return 'instance' === n ?
                     ...
                     (i = a[n].apply(a, o),
                      i !== a && void 0 !== i ?
                          ...
                          void 0) :
                     e.error(
                         'no such method \'' + n + '\' for ' + t +
                         ' widget instance') :
                     e.error(
                         'cannot call methods on ' + t +
                         ' prior to initialization; ' +
                         'attempted to call method \'' + n + '\'')
               }) :
                   this.each(function() {
                     var t = e.data(this, s);
                     t ? (t.option(n || {}), t._init && t._init()) :
    ...
    e.Widget.prototype = {
      ...
      _createWidget: function(t, i) {
        i = e(i || this.defaultElement || this)[0], this.element = e(i),
        this.uuid = h++,
        this.eventNamespace = '.' + this.widgetName + this.uuid,
        this.options =
            e.widget.extend({}, this.options, this._getCreateOptions(), t),
        ...
        return this.options[e] = t,
               'disabled' === e &&
                   (this.widget().toggleClass(
                        this.widgetFullName + '-disabled', !!t),
                    t &&
                        (this.hoverable.removeClass('ui-state-hover'),
                         this.focusable.removeClass('ui-state-focus'))),
               this
      ...
      _on: function(t, i, s) {
        ...
        'boolean' != typeof t && (s = i, i = t, t = !1),
            s ? (i = n = e(i), this.bindings = this.bindings.add(i)) :
        ...
        if (s = s || {}, i = e.Event(i),
            i.type =
                (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t)
                    .toLowerCase(),
            i.target = this.element[0], a = i.originalEvent)
    ...
    e.each({show: 'fadeIn', hide: 'fadeOut'}, function(t, i) {
      e.Widget.prototype['_' + t] = function(s, n, a) {
        ...
        o && e.effects && e.effects.effect[r] ?
            s[t](n) :
            r !== t && s[r] ? s[r](n.duration, n.easing, a) :
                              s.queue(function(i) {
  ...
  u = !1
        ...
        this.element
            ...
            .bind(
                ...
                function(i) {
                  return !0 ===
                          e.data(
                              i.target, t.widgetName + '.preventClickEvent') ?
                      (e.removeData(
                           i.target, t.widgetName + '.preventClickEvent'),
    ...
    function() {
      ...
      e.position = {
        scrollbarWidth: function() {
          ...
          return e('body').append(s),
                 ...
                 i = a.offsetWidth, t === i && (i = s[0].clientWidth),
                 s.remove(), n = t - i
        },
      ...
      e.fn.position =
        ...
        return b = s(_), _[0].preventDefault && (n.at = 'left top'),
               m = b.width, g = b.height, v = b.offset, y = e.extend({}, v),
               e.each(
                   ['my', 'at'],
                   function() {
                     ...
                     1 === i.length &&
                         (i = l.test(i[0]) ?
                              i.concat(['center']) :
                              u.test(i[0]) ? ['center'].concat(i) :
                                             ['center', 'center']),
                         i[0] = l.test(i[0]) ? i[0] : 'center',
                         i[1] = u.test(i[1]) ? i[1] : 'center',
                         e = d.exec(i[0]), t = d.exec(i[1]),
                         T[this] = [e ? e[0] : 0, t ? t[0] : 0],
                         n[this] = [c.exec(i[0])[0], c.exec(i[1])[0]]
                   }),
               1 === k.length && (k[1] = k[0]),
               'right' === n.at[0] ? y.left += m :
                                     'center' === n.at[0] && (y.left += m / 2),
               'bottom' === n.at[1] ? y.top += g :
                                      'center' === n.at[1] && (y.top += g / 2),
               p = t(T.at, m, g), y.left += p[0], y.top += p[1],
               this.each(function() {
                     ...
                     e.each(['left', 'top'], function(t, i) {
                       e.ui.position[k[t]] && e.ui.position[k[t]][i](M, {
                         ...
                         elem: u
                           ...
                           var t = v.left - M.left, i = t + m - d,
                               s = v.top - M.top, a = s + g - c, h = {
                                 target: {
                                   element: _,
                                   left: v.left,
                                   top: v.top,
      ...
      e.ui.position = {
        ...
        flip: {
          left: function(e, t) {
            var i, s,
                n = t.within, a = n.offset.left + n.scrollLeft, o = n.width,
                h = n.isWindow ? n.scrollLeft : n.offset.left,
                l = e.left - t.collisionPosition.marginLeft, u = l - h,
                d = l + t.collisionWidth - o - h,
                c = 'left' === t.my[0] ? -t.elemWidth :
            ...
            0 > u ? (i = e.left + c + p + f + t.collisionWidth - o - a,
                    ...
                    d > 0 &&
                    (s = e.left - t.collisionPosition.marginLeft + c + p + f -
                         h,
                     (s > 0 || d > r(s)) && (e.left += c + p + f))
          },
          top: function(e, t) {
            var i, s,
                n = t.within, a = n.offset.top + n.scrollTop, o = n.height,
            ...
            0 > u ? (s = e.top + p + f + m + t.collisionHeight - o - a,
                     e.top + p + f + m > u && (0 > s || r(u) > s) &&
                         (e.top += p + f + m)) :
                    d > 0 &&
                    (i = e.top - t.collisionPosition.marginTop + p + f + m - h,
                     e.top + p + f + m > d && (i > 0 || d > r(i)) &&
                         (e.top += p + f + m))
          }
        },
        flipfit: {
      ...
      function() {
        ...
        r &&
            e.extend(
                s, {position: 'absolute', left: '-1000px', top: '-1000px'});
        for (o in s) t.style[o] = s[o];
        t.appendChild(h),
            i = r || document.documentElement, i.insertBefore(t, i.firstChild),
            h.style.cssText = 'position: absolute; left: 10.7432222px;',
            n = e(h).offset().left, a = n > 10 && 11 > n, t.innerHTML = '',
            i.removeChild(t)
      }()
    }(),
    e.ui.position, e.widget('ui.accordion', {
        ...
        return 'active' === e ?
            ...
            ('event' === e &&
                 (this.options.event &&
                  ...
                  this._setupEvents(t)),
             this._super(e, t),
             'collapsible' !== e || t || this.options.active !== !1 ||
                 this._activate(0),
      ...
      _keydown: function(t) {
        if (!t.altKey && !t.ctrlKey) {
          ...
          a &&
              (e(t.target).attr('tabIndex', -1), e(a).attr('tabIndex', 0),
      ...
      _refresh: function() {
        ...
        'fill' === s ?
            (t = n.height(), this.element.siblings(':visible').each(function() {
             ...
             this.headers.next()
                 .each(function() {
                   e(this).height(Math.max(
                       0, t - e(this).innerHeight() + e(this).height()))
                 })
                 .css('overflow', 'auto')) :
            'auto' === s &&
                (t = 0,
      ...
      _eventHandler: function(t) {
        ...
        t.preventDefault(),
            ...
            (i.active = o ? !1 : this.headers.index(n),
             this.active = a ? e() : n, this._toggle(l),
      ...
      _animate: function(e, t, i) {
        ...
        return 'number' == typeof u && (a = u), 'string' == typeof u && (n = u),
               n = n || u.easing || l.easing, a = a || u.duration || l.duration,
               t.length ?
                   e.length ?
    ...
    e.widget('ui.menu', {
          ...
          'click .ui-menu-item': function(t) {
            ...
            !this.mouseHandled && i.not('.ui-state-disabled').length &&
                (this.select(t),
                 ...
                 i.has('.ui-menu').length ? this.expand(t) :
      ...
      _keydown: function(t) {
        ...
        switch (t.keyCode) {
          ...
          default:
            ...
            a = String.fromCharCode(t.keyCode), o = !1,
            clearTimeout(this.filterTimer), a === n ? o = !0 : a = n + a,
            r = RegExp('^' + i(a), 'i'),
            s = this.activeMenu.find(this.options.items).filter(function() {
              return r.test(e(this).text())
            }),
            s = o && -1 !== s.index(this.active.next()) ?
                this.active.nextAll('.ui-menu-item') :
                s,
            s.length ||
                (a = String.fromCharCode(t.keyCode),
                 r = RegExp('^' + i(a), 'i'),
                 s = this.activeMenu.find(this.options.items)
                         .filter(function() {
                           return r.test(e(this).text())
                         })),
      ...
      _activate: function(e) {
        this.active.is('.ui-state-disabled') ||
            (this.active.is('[aria-haspopup=\'true\']') ? this.expand(e) :
                                                          this.select(e))
      },
      refresh: function() {
        ...
        this.element.toggleClass(
            ...
            t = a.add(this.element), i = t.find(this.options.items),
      ...
      focus: function(e, t) {
        var i, s;
        this.blur(e, e && 'focus' === e.type), this._scrollIntoView(t),
            this.active = t.first(),
            s = this.active.addClass('ui-state-focus')
      ...
      _scrollIntoView: function(t) {
        ...
        this._hasScroll() &&
            (i = parseFloat(e.css(this.activeMenu[0], 'borderTopWidth')) || 0,
             ...
             a = this.activeMenu.scrollTop(), o = this.activeMenu.height(),
             r = t.outerHeight(),
             0 > n ? this.activeMenu.scrollTop(a + n) :
                     n + r > o && this.activeMenu.scrollTop(a + n - o + r))
      },
      blur: function(e, t) {
        t || clearTimeout(this.timer),
            this.active &&
            (this.active.removeClass('ui-state-focus'), this.active = null,
            ...
            (this.isFirstItem() ||
                 (this._hasScroll() ?
                      (s = this.active.offset().top, n = this.element.height(),
                       ...
                       this.focus(t, i)) :
                      this.focus(
                          t, this.activeMenu.find(this.options.items).first())),
             void 0) :
            (this.next(t), void 0)
      },
      _hasScroll: function() {
    ...
    e.widget('ui.autocomplete', {
      ...
      _create: function() {
        ...
        this.isMultiLine =
            a ? !0 : o ? !1 : this.element.prop('isContentEditable'),
        ...
        this._on(this.element, {
          ...
          input: function(e) {
            return s ? (s = !1, e.preventDefault(), void 0) :
        ...
        this._on(this.menu.element, {
            ...
            e(t.target).closest('.ui-menu-item').length ||
                this._delay(function() {
                  ...
                  this.document.one('mousedown', function(s) {
                    s.target === t.element[0] || s.target === i ||
                        e.contains(i, s.target) || t.close()
                  })
                })
          },
          ...
          menuselect: function(e, t) {
            ...
            this.element[0] !== this.document[0].activeElement &&
                (this.element.focus(), this.previous = s,
                 this._delay(function() {
                   this.previous = s, this.selectedItem = i
                 })),
                !1 !== this._trigger('select', e, {item: i}) &&
                this._value(i.value),
                this.term = this._value(), this.close(e), this.selectedItem = i
          }
        }),
      ...
      _setOption: function(e, t) {
        this._super(e, t), 'source' === e && this._initSource(),
      ...
      search: function(e, t) {
        return e = null != e ? e : this._value(), this.term = this._value(),
      ...
      _normalize: function(t) {
        return t.length && t[0].label && t[0].value ? t : e.map(t, function(t) {
          return 'string' == typeof t ?
              {label: t, value: t} :
              e.extend(
                  {}, t, {label: t.label || t.value, value: t.value || t.label})
        })
      },
      _suggest: function(t) {
    ...
    e.widget('ui.autocomplete', e.ui.autocomplete, {
      ...
      __response: function(t) {
        ...
        this._superApply(arguments),
            ...
            (i = t && t.length ? this.options.messages.results(t.length) :
...
var d,
    ...
    f = function() {
      ...
      return i &&
                 (i = i.replace(/'/g, '\\\''),
                  n = s ? e(s).find('[name=\'' + i + '\'][type=radio]') :
                          e('[name=\'' + i + '\'][type=radio]', t.ownerDocument)
                              .filter(function() {
                                return !this.form
                              })),
             n
...
e.widget('ui.button', {
  ...
  _create: function() {
    ...
    var t = this, i = this.options,
        ...
        n = s ? '' : 'ui-state-active';
    null === i.label &&
        (i.label = 'input' === this.type ? this.buttonElement.val() :
                                           this.buttonElement.html()),
        this._hoverable(this.buttonElement),
        this.buttonElement.addClass(c)
            .attr('role', 'button')
            .bind(
                'mouseenter' + this.eventNamespace,
                function() {
                  i.disabled ||
                      this === d && e(this).addClass('ui-state-active')
                })
            .bind(
        ...
        (this.buttonElement
             .bind(
                 ...
                 function() {
                   return i.disabled ?
                       !1 :
                       (e(this).addClass('ui-state-active'), d = this,
  ...
  _destroy: function() {
    this.element.removeClass('ui-helper-hidden-accessible'),
        this.buttonElement.removeClass(c + ' ui-state-active ' + p)
            .removeAttr('role')
  ...
  _resetButton: function() {
    ...
    e.widget('ui.buttonset', {
      ...
      refresh: function() {
        ...
        i.not(':ui-button').button(), s.button('refresh'),
            this.buttons =
                i.map(function() {
                   return e(this).button('widget')[0]
                 })
...
e.effects = {
  effect: {}
               ...
               f(h,
                 function(e, a) {
                   var o, r = a.re.exec(i), h = r && a.parse(r),
                          l = a.space || 'rgba';
                   return h ? (o = s[l](h), s[u[l].cache] = o[u[l].cache],
                               n = s._rgba = o._rgba, !1) :
                              t
                 }),
               n.length ?
          ...
          h =
              [
                ...
                },
                {
                  ...
                  parse: function(e) {
                    return [
                      parseInt(e[1] + e[1], 16), parseInt(e[2] + e[2], 16),
                      parseInt(e[3] + e[3], 16)
                    ]
                  }
                },
       ...
       return o !== t && (n = [n, o, r, h], c = 'array'),
              'string' === c ?
                  ...
                  (f(u.rgba.props,
                   ...
                   this) :
                  'object' === c ? (n instanceof l ? f(u, function(e, t) {
                                      n[t.cache] &&
   ...
   u.hsla.from =
     ...
     return [
       Math.round(255 * n(r, o, t + 1 / 3)), Math.round(255 * n(r, o, t)),
   ...
   a = e.Color.names = {
            ...
            toggleClass: function(t) {
              return function(i, s, n, a, o) {
                return 'boolean' == typeof s || void 0 === s ?
                    n ? e.effects.animateClass.call(
                            this, s ? {add: i} : {remove: i}, n, a, o) :
                        t.apply(this, arguments) :
      ...
      function t(t, i, s, n) {
        return e.isPlainObject(t) && (i = t, t = t.effect),
               ...
               ('number' == typeof i || e.fx.speeds[i]) &&
                   (n = s, s = i, i = {}),
               e.isFunction(s) && (n = s, s = null), i && e.extend(t, i),
               s = s || i.duration,
               t.duration = e.fx.off ?
                   0 :
                   'number' == typeof s ?
                   s :
                   s in e.fx.speeds ? e.fx.speeds[s] : e.fx.speeds._default,
      ...
      e.extend(e.effects, {
        ...
        restore: function(e, t) {
          ...
          for (s = 0; t.length > s; s++)
            null !== t[s] &&
                (i = e.data(v + t[s]), void 0 === i && (i = ''), e.css(t[s], i))
        },
        ...
        setTransition: function(t, i, s, n) {
          ...
          e.fn.extend({
            effect: function() {
              ...
              return e.fx.off || !o ?
                  n ? this[n](s.duration, s.complete) : this.each(function() {
    ...
    e.effects.effect
      ...
      o.parent().is('.ui-effects-wrapper') ? e.effects.save(o.parent(), l) :
                                             e.effects.save(o, l),
          o.show(), s = e.effects.createWrapper(o).css({overflow: 'hidden'}),
                    n = s[p](), a = parseFloat(s.css(f)) || 0, g[p] = v ? n : 0,
                    m ||
          (o.css(c ? 'bottom' : 'right', 0)
               .css(c ? 'top' : 'left', 'auto')
           ...
           g[f] = v ? a : n + a),
                    v && (s.css(p, 0), m || s.css(f, a + n)), s.animate(g, {
                      ...
                      queue: !1,
                      complete: function() {
                        'hide' === u && o.hide(), e.effects.restore(o, l),
 ...
 e.effects.effect.bounce =
   ...
   for ((u || l) && r.push('opacity'), e.effects.save(o, r), o.show(),
 ...
 e.effects.effect.clip =
   ...
   e.effects.save(o, r), o.show(),
       s = e.effects.createWrapper(o).css({overflow: 'hidden'}),
       n = 'IMG' === o[0].tagName ? s : o, a = n[c](),
       l && (n.css(c, 0), n.css(p, a / 2)), f[c] = l ? a : 0,
       f[p] = l ? 0 : a / 2, n.animate(f, {
         queue: !1,
         duration: t.duration,
         easing: t.easing,
         complete: function() {
           l || o.hide(), e.effects.restore(o, r), e.effects.removeWrapper(o),
               i()
         }
       })
 },
 e.effects.effect.drop =
   ...
   var s, n = e(this),
          ...
          d = {opacity: r ? 1 : 0};
   e.effects.save(n, a), n.show(), e.effects.createWrapper(n),
       ...
       n.animate(d, {
         ...
         easing: t.easing,
         complete: function() {
           'hide' === o && n.hide(), e.effects.restore(n, a),
 ...
 e.effects.effect.explode =
   ...
   var a, o, r, h, l, u,
       d = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, c = d, p = e(this),
 ...
 e.effects.effect.highlight =
   ...
   'hide' === a && (o.opacity = 0), e.effects.save(s, n),
       s.show()
           .css(
 ...
 e.effects.effect.size =
   ...
   var s, n, a,
       ...
       y = f ? r : h, b = {height: 0, width: 0, outerHeight: 0, outerWidth: 0};
   'show' === p && o.show(),
       s = {
         height: o.height(),
         width: o.width(),
       ...
       (d = d.concat(['marginTop', 'marginBottom']).concat(u),
        c = c.concat(['marginLeft', 'marginRight']), l = r.concat(d).concat(c),
       ...
       o.animate(o.to, {
         ...
         complete: function() {
           0 === o.to.opacity && o.css('opacity', o.from.opacity),
               'hide' === p && o.hide(), e.effects.restore(o, y),
               f ||
               ('static' === v ? o.css({
                 position: 'relative',
                 top: o.to.top,
 ...
 e.effects.effect.scale =
   ...
   n.from = t.from ||
       ('show' === a ? {height: 0, width: 0, outerHeight: 0, outerWidth: 0} :
                       l),
   n.to = {
     height: l.height * u.y,
     width: l.width * u.x,
 ...
 e.effects.effect.puff =
   ...
   var s = e(this), n = e.effects.setMode(s, t.mode || 'hide'),
       a = 'hide' === n, o = parseInt(t.percent, 10) || 150, r = o / 100, h = {
         height: s.height(),
         width: s.width(),
         outerHeight: s.outerHeight(),
         outerWidth: s.outerWidth()
 ...
 e.effects.effect.shake =
   ...
   for (e.effects.save(n, a), n.show(), e.effects.createWrapper(n),
        f[c] = (p ? '-=' : '+=') + h, m[c] = (p ? '+=' : '-=') + 2 * h,
        g[c] = (p ? '-=' : '+=') + 2 * h, n.animate(f, d, t.easing), s = 1;
        l > s; s++)
 ...
 e.effects.effect.transfer =
   ...
   var s = e(this), n = e(t.to), a = 'fixed' === n.css('position'),
       o = e('body'), r = a ? o.scrollTop() : 0, h = a ? o.scrollLeft() : 0,
       l = n.offset(), u = {
         top: l.top - r,
         left: l.left - h,
 ...
 e.widget('ui.progressbar', {
   ...
   _create: function() {
     ...
     this.valueDiv =
         e('<div class=\'ui-progressbar-value ui-widget-header ui-corner-left\'></div>')
   ...
   _constrainedValue: function(e) {
     return void 0 === e && (e = this.options.value),
            this.indeterminate = e === !1, 'number' != typeof e && (e = 0),
            this.indeterminate ?
                !1 :
   ...
   _refreshValue: function() {
     ...
     this.valueDiv.toggle(this.indeterminate || t > this.min)
         ...
         (this.element.removeAttr('aria-valuenow'),
          this.overlayDiv ||
              (this.overlayDiv =
                   e('<div class=\'ui-progressbar-overlay\'></div>')
 ...
 e.widget('ui.selectable', e.ui.mouse, {
   ...
   _create: function() {
     ...
     this.element.addClass('ui-selectable'),
         ...
         this.refresh =
             function() {
           t = e(i.options.filter, i.element[0]), t.addClass('ui-selectee'),
           t.each(function() {
   ...
   _mouseStart: function(t) {
     ...
     this.options.disabled ||
         (this.selectees = e(s.filter, this.element[0]),
          this._trigger('start', t), e(s.appendTo).append(this.helper),
          ...
          e(t.target).parents().addBack().each(function() {
            ...
            return n ?
                (s = !t.metaKey && !t.ctrlKey ||
                 ...
                 s ? i._trigger('selecting', t, {selecting: n.element}) :
                     ...
                     l ? (i.selected &&
                          ...
                          i.selecting ||
                              (i.$element.addClass('ui-selecting'),
                               i.selecting = !0,
                               s._trigger(
                                   'selecting', t, {selecting: i.element}))) :
                         (i.selecting &&
 ...
 e.widget('ui.selectmenu', {
   ...
   _drawButton: function() {
     ...
     this.buttonText =
         e('<span>', {'class': 'ui-selectmenu-text'}).appendTo(this.button),
     this._setText(
         this.buttonText, this.element.find('option:selected').text()),
   ...
   _refreshMenu: function() {
     ...
     t.length &&
         (this._parseOptions(t), this._renderMenu(this.menu, this.items),
          this.menuInstance.refresh(),
          this.menuItems = this.menu.find('li').not('.ui-selectmenu-optgroup'),
          e = this._getSelectedItem(), this.menuInstance.focus(null, e),
   ...
   open: function(e) {
     this.options.disabled ||
         (this.menuItems ?
          ...
          this._position(), this._on(this.document, this._documentClick),
   ...
   close: function(e) {
     this.isOpen &&
         (this.isOpen = !1, this._toggleAttr(), this._off(this.document),
          this._trigger('close', e))
   },
   widget: function() {
     return this.button
   ...
   _renderItem: function(t, i) {
     ...
     return i.disabled && s.addClass('ui-state-disabled'),
            this._setText(s, i.label), s.appendTo(t)
   },
   ...
   _select: function(e, t) {
     ...
     this._setText(this.buttonText, e.label), this._setAria(e),
     this._trigger('select', t, {item: e}),
     e.index !== i && this._trigger('change', t, {item: e}), this.close(t)
   },
   _setAria: function(e) {
   ...
   _setOption: function(e, t) {
     'icons' === e &&
         ...
         (this.menuInstance.option('disabled', t),
          this.button.toggleClass('ui-state-disabled', t)
              .attr('aria-disabled', t),
          this.element.prop('disabled', t),
   ...
   _destroy: function() {
     this.menuWrap.remove(), this.button.remove(), this.element.show(),
         this.element.removeUniqueId(), this.label.attr('for', this.ids.element)
   }
 }),
 e.widget('ui.slider', e.ui.mouse, {
   ...
   _createHandles: function() {
     ...
     for (i = s.values && s.values.length || 1,
         n.length > i && (n.slice(i).remove(), n = n.slice(0, i)), t = n.length;
          i > t; t++)
       o.push(a);
   ...
   _mouseCapture: function(t) {
     ...
     return d.disabled ?
         ...
         (this.elementSize = {
          ...
          i = {x: t.pageX, y: t.pageY}, s = this._normValueFromMouse(i),
          ...
          r === !1 ?
              !1 :
              (this._mouseSliding = !0, this._handleIndex = o,
               a.addClass('ui-state-active').focus(), h = a.offset(),
   ...
   _mouseStop: function(e) {
     return this.handles.removeClass('ui-state-active'),
            ...
            this._change(e, this._handleIndex), this._handleIndex = null,
   ...
   _normValueFromMouse: function(e) {
     ...
     return 'horizontal' === this.orientation ?
                (t = this.elementSize.width,
                 i = e.x - this.elementOffset.left -
                     (this._clickOffset ? this._clickOffset.left : 0)) :
                (t = this.elementSize.height,
                 i = e.y - this.elementOffset.top -
                     (this._clickOffset ? this._clickOffset.top : 0)),
            s = i / t, s > 1 && (s = 1), 0 > s && (s = 0),
     ...
     this.options.values && this.options.values.length ?
         (s = this.values(t ? 0 : 1),
          ...
          i !== this.values(t) &&
              (n = this.values(), n[t] = i,
               a = this._trigger(
                   'slide', e, {handle: this.handles[t], value: i, values: n}),
               s = this.values(t ? 0 : 1), a !== !1 && this.values(t, i))) :
         i !== this.value() &&
             (a = this._trigger(
                  'slide', e, {handle: this.handles[t], value: i}),
              a !== !1 && this.value(i))
   },
   _stop: function(e, t) {
     var i = {handle: this.handles[t], value: this.value()};
   ...
   value: function(e) {
     return arguments.length ?
         (this.options.value = this._trimAlignValue(e), this._refreshValue(),
   ...
   values: function(t, i) {
     ...
     if (!e.isArray(arguments[0]))
       return this.options.values && this.options.values.length ?
           this._values(t) :
           this.value();
     for (s = this.options.values, n = arguments[0], a = 0; s.length > a;
          a += 1)
         ...
         (s = this.value(), n = this._valueMin(), a = this._valueMax(),
          ...
          'min' === o && 'horizontal' === this.orientation &&
              this.range.stop(1, 1)[l ? 'animate' : 'css'](
                  {width: i + '%'}, r.animate),
          'max' === o && 'horizontal' === this.orientation &&
   ...
   _handleEvents: {
     ...
     keyup: function(t) {
       ...
       this._keySliding &&
           (this._keySliding = !1, this._stop(t, i), this._change(t, i),
 ...
 e.widget('ui.sortable', e.ui.mouse, {
   ...
   _mouseStart: function(t, i, s) {
     ...
     if (this.currentContainer = this, this.refreshPositions(),
         ...
         o.cursor && 'auto' !== o.cursor &&
             (a = this.document.find('body'),
              this.storedCursor = a.css('cursor'), a.css('cursor', o.cursor),
              this.storedStylesheet =
                  e('<style>*{ cursor: ' + o.cursor + ' !important; }</style>')
                      .appendTo(a)),
         o.opacity &&
     ...
     return e.ui.ddmanager && (e.ui.ddmanager.current = this),
            e.ui.ddmanager && !o.dropBehaviour &&
   ...
   _mouseDrag: function(t) {
     ...
     for (this.position = this._generatePosition(t),
         ...
         this.options.scroll &&
              (this.scrollParent[0] !== document &&
                   ...
                   (this.overflowOffset.top +
                                this.scrollParent[0].offsetHeight - t.pageY <
                            o.scrollSensitivity ?
                        ...
                        this.overflowOffset.left +
                                this.scrollParent[0].offsetWidth - t.pageX <
                            o.scrollSensitivity ?
                   ...
                   (t.pageY - e(document).scrollTop() < o.scrollSensitivity ?
                        ...
                        e(window).width() -
                            ...
                            (r = e(document).scrollLeft(
                                 e(document).scrollLeft() + o.scrollSpeed))),
               r !== !1 && e.ui.ddmanager && !o.dropBehaviour &&
                   e.ui.ddmanager.prepareOffsets(this, t)),
         this.positionAbs = this._convertPositionTo('absolute'),
       ...
       if (s = this.items[i], n = s.item[0], a = this._intersectsWithPointer(s),
           a && s.instance === this.currentContainer &&
   ...
   _intersectsWithSides: function(e) {
     var t = this._isOverAxis(
             this.positionAbs.top + this.offset.click.top, e.top + e.height / 2,
             e.height),
         i = this._isOverAxis(
             this.positionAbs.left + this.offset.click.left,
             e.left + e.width / 2, e.width),
   ...
   refresh: function(e) {
     return this._refreshItems(e), this._setHandleClassName(),
            this.refreshPositions(), this
   },
   _connectWith: function() {
     var e = this.options;
     return e.connectWith.constructor === String ? [e.connectWith] :
                                                   e.connectWith
   },
   ...
   _refreshItems: function(t) {
     ...
     var i, s, n, a, o, r, h, l,
         ...
         d = [[
           e.isFunction(this.options.items) ?
               this.options.items.call(
                   this.element[0], t, {item: this.currentItem}) :
               e(this.options.items, this.element),
           this
         ]],
         c = this._connectWith();
               ...
               (d.push([
                 e.isFunction(a.options.items) ?
                     a.options.items.call(
                         a.element[0], t, {item: this.currentItem}) :
     ...
     for (i = d.length - 1; i >= 0; i--)
       for (o = d[i][1], r = d[i][0], s = 0, l = r.length; l > s; s++)
         h = e(r[s]), h.data(this.widgetName + '-item', o),
   ...
   _createPlaceholder: function(t) {
     ...
     s.placeholder && s.placeholder.constructor !== String ||
             ...
             (!i || s.forcePlaceholderSize) &&
                 (n.height() ||
                      n.height(
                          ...
                          parseInt(
                              t.currentItem.css('paddingBottom') || 0, 10)),
                  n.width() ||
                      n.width(
         ...
         t.placeholder =
             e(s.placeholder.element.call(t.element, t.currentItem)),
     ...
     if (c)
       if (1 === this.containers.length)
         ...
         for (n = 1e4, a = null,
             ...
             o = u ? 'left' : 'top', r = u ? 'width' : 'height',
             d = u ? 'clientX' : 'clientY', s = this.items.length - 1;
              s >= 0; s--)
           e.contains(this.containers[p].element[0], this.items[s].item[0]) &&
               this.items[s].item[0] !== this.currentItem[0] &&
               (h = this.items[s].item.offset()[o], l = !1,
                t[d] - h > this.items[s][r] / 2 && (l = !0),
                n > Math.abs(t[d] - h) &&
                    (n = Math.abs(t[d] - h), a = this.items[s],
                     this.direction = l ? 'up' : 'down'));
         if (!a && !this.options.dropOnEmpty) return;
         if (this.currentContainer === this.containers[p]) return;
         a ? this._rearrange(t, a, null, !0) :
   ...
   _createHelper: function(t) {
     ...
     return s.parents('body').length ||
                e('parent' !== i.appendTo ? i.appendTo :
   ...
   _generatePosition: function(t) {
                          ...
                          s)),
     {
       top: o - this.offset.click.top - this.offset.relative.top -
           ...
           ('fixed' === this.cssPosition ? -this.scrollParent.scrollTop() :
                                           h ? 0 : r.scrollTop()),
           left: a - this.offset.click.left - this.offset.relative.left -
   ...
   _clear: function(e, t) {
     ...
     if (this.storedCursor &&
       ...
       if (!t) {
         for (this._trigger('beforeStop', e, this._uiHash()), s = 0;
              n.length > s; s++)
           n[s].call(this, e);
   ...
   _uiHash: function(t) {
     var i = t || this;
     return {
       helper: i.helper, placeholder: i.placeholder || e([]),
 ...
 e.widget('ui.spinner', {
   ...
   _events: {
     ...
     'mousedown .ui-spinner-button': function(t) {
       ...
       s = this.element[0] === this.document[0].activeElement ?
           this.previous :
           this.element.val(),
       t.preventDefault(), i.call(this), this.cancelBlur = !0,
       this._delay(function() {
         delete this.cancelBlur, i.call(this)
       }),
       this._start(t) !== !1 &&
           this._repeat(
               null, e(t.currentTarget).hasClass('ui-spinner-up') ? 1 : -1, t)
     },
   ...
   _draw: function() {
     ...
     this.element.attr('role', 'spinbutton'),
         this.buttons = e.find('.ui-spinner-button')
                            .attr('tabIndex', -1)
                            .button()
                            .removeClass('ui-corner-all'),
         this.buttons.height() > Math.ceil(.5 * e.height()) && e.height() > 0 &&
         e.height(e.height()),
         this.options.disabled && this.disable()
   },
   _keydown: function(t) {
   ...
   _repeat: function(e, t, i) {
     e = e || 500, clearTimeout(this.timer),
     this.timer = this._delay(function() {
       this._repeat(40, t, i)
   ...
   _adjustValue: function(e) {
     ...
     return t = null !== s.min ? s.min : 0, i = e - t,
            i = Math.round(i / s.step) * s.step, e = t + i,
   ...
   value: function(e) {
     return arguments.length ? (r(this._value).call(this, e), void 0) :
 ...
 e.widget('ui.tabs', {
   ...
   _isLocal: function() {
     ...
     return function(t) {
       var i, s;
       t = t.cloneNode(!1), i = t.href.replace(e, ''),
   ...
   _create: function() {
     ...
     e.isArray(i.disabled) &&
         (i.disabled = e.unique(i.disabled.concat(e.map(
   ...
   _eventHandler: function(t) {
     ...
     t.preventDefault(),
         a.hasClass('ui-state-disabled') || a.hasClass('ui-tabs-loading') ||
         this.running || o && !i.collapsible ||
         this._trigger('beforeActivate', t, u) === !1 ||
         (i.active = r ? !1 : this.tabs.index(a), this.active = o ? e() : a,
   ...
   _toggle: function(t, i) {
     ...
     function n() {
       i.newTab.closest('li').addClass('ui-tabs-active ui-state-active'),
           o.length && a.options.show ? a._show(o, a.options.show, s) :
                                        (o.show(), s())
     }
     ...
     o.length && r.length ? i.oldTab.attr('tabIndex', -1) :
                            o.length &&
             this.tabs
                 .filter(function() {
                   return 0 === e(this).attr('tabIndex')
     ...
     this._isLocal(a[0]) ||
         (this.xhr = e.ajax(this._ajaxSettings(a, i, r)),
          this.xhr && 'canceled' !== this.xhr.statusText &&
              (n.addClass('ui-tabs-loading'), o.attr('aria-busy', 'true'),
               this.xhr
                   .success(function(e) {
                     setTimeout(function() {
   ...
   _ajaxSettings: function(t, i, s) {
     ...
     return {
       url: t.attr('href'), beforeSend: function(t, a) {
         return n._trigger(
             'beforeLoad', i, e.extend({jqXHR: t, ajaxSettings: a}, s))
       }
     }
   },
 ...
 e.widget('ui.tooltip', {
   ...
   _removeDescribedBy: function(t) {
     var i = t.data('ui-tooltip-id'),
         ...
         n = e.inArray(i, s);
     -1 !== n && s.splice(n, 1), t.removeData('ui-tooltip-id'),
         s = e.trim(s.join(' ')),
         ...
         (s.attr('title') && s.data('ui-tooltip-title', s.attr('title')),
          ...
          t && 'mouseover' === t.type && s.parents().each(function() {
            ...
            s.data('ui-tooltip-open') &&
                (t = e.Event('blur'), t.target = t.currentTarget = this,
                 i.close(t, !0)),
                s.attr('title') &&
                (s.uniqueId(),
   ...
   _open: function(t, i, s) {
     ...
     if (s) {
       ...
       i.is('[title]') &&
           (t && 'mouseover' === t.type ? i.attr('title', '') :
                                          i.removeAttr('title')),
           a = this._tooltip(i), this._addDescribedBy(i, a.attr('id')),
   ...
   close: function(t) {
     ...
     this.closing ||
         (clearInterval(this.delayedShow),
          ...
          this._removeDescribedBy(s), n.stop(!0),
          this._hide(
              n, this.options.hide,
              function() {
          ...
          this.closing = !0, this._trigger('close', t, {tooltip: n}),
          this.closing = !1)
   },
   _tooltip: function(t) {
     var i = e('<div>')
     ...
     return e('<div>').addClass('ui-tooltip-content').appendTo(i),
            i.appendTo(this.document[0].body), this.tooltips[s] = t, i
   },
   _find: function(t) {
     var i = t.data('ui-tooltip-id');
     return i ? e('#' + i) : e()
   ...
   _destroy: function() {
     ...
     e.each(this.tooltips, function(i, s) {
       var n = e.Event('blur');
       n.target = n.currentTarget = s[0], t.close(n, !0), e('#' + i).remove(),
