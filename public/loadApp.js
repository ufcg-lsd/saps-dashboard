...
var scripts = [
  ...
  'vendor/angular/angular-resource.min.js', '/lang/lang_loader.js',
  '/dashboardApp.js', '/controllers/dashboardControllers.js',
  '/services/dashboardServices.js'
] var next = 0;

function loadScript(script) {
  console.log('Loading ' + script)
  $.when($.getScript(script)).done(function(scriptLoaded, textStatus) {
